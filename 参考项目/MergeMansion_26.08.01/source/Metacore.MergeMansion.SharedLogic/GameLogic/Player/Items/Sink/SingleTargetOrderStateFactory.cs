...
namespace GameLogic.Player.Items.Sink
{
	...
	public class SingleTargetOrderStateFactory : IOrderStateFactory
	{
		...
		public SingleTargetOrderStateFactory()
		{
		}

		public SingleTargetOrderStateFactory(MetaDictionary<int, int> scores, MetaDictionary<int, int> rewards, string activationType)
		{
		}
