...
namespace GameLogic.Player.Items.Sink
{
	...
	public class SimpleSinkStateFactory : ISinkStateFactory
	{
		...
		public sealed class _003CGetAcceptedItems_003Ed__16 : IEnumerable<int>, IEnumerable, IEnumerator<int>, IEnumerator, IDisposable
		{
			...
			public SimpleSinkStateFactory _003C_003E4__this;
		...
		public SimpleSinkStateFactory()
		{
		}

		public SimpleSinkStateFactory(List<(int itemId, int target)> scores, int scoreTarget, int rewardId)
		{
		}
