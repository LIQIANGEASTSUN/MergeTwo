...
namespace GameLogic.Player.Items.Order
{
	...
	public class SingleTargetOrderState : OrderState
	{
		...
		public SingleTargetOrderState(MetaDictionary<int, int> takeIn, List<int> rewardItems, List<int> rewardAmounts, string activationType, IGenerationContext context)
		{
		}
