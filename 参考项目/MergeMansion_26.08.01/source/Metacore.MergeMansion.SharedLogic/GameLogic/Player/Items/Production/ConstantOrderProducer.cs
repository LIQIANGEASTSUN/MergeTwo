...
namespace GameLogic.Player.Items.Production
{
	...
	public class ConstantOrderProducer : IOrderSpawner, IOrderProducer
	{
		...
		public sealed class _003CGetSpawnOrder_003Ed__18 : IEnumerable<OrderRequirementsId>, IEnumerable, IEnumerator<OrderRequirementsId>, IEnumerator, IDisposable
		{
			...
			public ConstantOrderProducer _003C_003E4__this;
		...
		public ConstantOrderProducer()
		{
		}

		public ConstantOrderProducer(RollHistoryType rollType, int itemType, IEnumerable<(OrderRequirementsId, int)> pairs)
		{
		}
