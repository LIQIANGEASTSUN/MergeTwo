 ...
 * Cpp2IL method: System.Collections.Generic.IEnumerable`1<System.ValueTuple`2<GameLogic.Player.Board.Coordinate, GameLogic.Player.Items.MergeItem>> FindAllBoosterItems(GameLogic.Player.Board.IBoard mergeBoard, GameLogic.Player.IPlayer player)
 * Ghidra function entry: 0376e4e4
