 ...
 * Cpp2IL method: System.Void add_OnMergeActProcessed(System.Action`1<GameLogic.Merge.MergeBoardAct> value)
 * Ghidra function entry: 0333b568
 * Generated Ghidra pseudocode; not original C# source. */


/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0333b568(long param_1,undefined8 param_2)

{
  ...
  if ((bRam0000000005e2c065 & 1) == 0) {
    func_0x0249f8e4(&DAT_059c16f0);
    bRam0000000005e2c065 = 1;
  }
    ...
    if (lVar3 == 0) {
      ...
      if (lVar4 == 0) {
        ...
        do {
          ...
          lVar3 = func_0x024d8ac4(auVar6._0_8_ + 0x308,lVar4,lVar5);
          bVar2 = lVar3 == lVar5;
          lVar5 = lVar3;
          if (bVar2) {
            return;
