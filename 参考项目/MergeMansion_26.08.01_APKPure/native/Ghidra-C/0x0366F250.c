 ...
 * Cpp2IL method: System.Collections.Generic.IEnumerable`1<System.ValueTuple`2<GameLogic.Player.Board.Coordinate, GameLogic.Player.Items.MergeItem>> FindItems(GameLogic.Player.Board.IBoard mergeBoard, System.Predicate`1<GameLogic.Player.Items.MergeItem> predicate)
 * Ghidra function entry: 0376f250
 * Generated Ghidra pseudocode; not original C# source. */


/* WARNING: Possible PIC construction at 0x0376f2c4: Changing call to branch */
...
/* WARNING: Removing unreachable block (ram,0x0376f2c8) */
/* WARNING: Removing unreachable block (ram,0x0376f340) */
/* WARNING: Removing unreachable block (ram,0x0376f2cc) */
...
void FUN_0376f250(void)

{
  if ((bRam0000000005e2df3f & 1) == 0) {
    func_0x0249f8e4(&DAT_05a44708);
    func_0x0249f8e4(&DAT_059c59a8);
    func_0x0249f8e4(&DAT_05a5faf8);
    func_0x0249f8e4(&DAT_059eb120);
    bRam0000000005e2df3f = 1;
  }
  func_0x0249fb80(_DAT_059eb120);
  return;
}
