...
namespace GameLogic.Player.Items.Production
{
	...
	public class ControlledMixedSequenceProducer : IItemSpawner, IItemProducer
	{
		...
		public sealed class _003CProduce_003Ed__22 : IEnumerable<IItemDefinition>, IEnumerable, IEnumerator<IItemDefinition>, IEnumerator, IDisposable
		{
			...
			public ControlledMixedSequenceProducer _003C_003E4__this;
			...
			[NonSerialized]
			public IReadOnlyList<IItemOdds> _003CoddsList_003E5__2;

			[NonSerialized]
			public int _003CtotalOdds_003E5__3;
		...
		public ControlledMixedSequenceProducer()
		{
		}

		public ControlledMixedSequenceProducer(RollHistoryType rollType, int itemId, List<(int, int)> oddsList)
		{
		}
