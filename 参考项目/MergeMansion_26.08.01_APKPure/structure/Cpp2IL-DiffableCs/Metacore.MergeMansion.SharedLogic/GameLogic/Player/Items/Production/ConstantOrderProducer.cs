...
public class ConstantOrderProducer : IOrderSpawner, IOrderProducer
{
	...
	private sealed class <GetSpawnOrder>d__18 : IEnumerable<OrderRequirementsId>, IEnumerable, IEnumerator<OrderRequirementsId>, IEnumerator, IDisposable
	{
		...
		public ConstantOrderProducer <>4__this; //Field offset: 0x28
	...
	public ConstantOrderProducer(RollHistoryType rollType, int itemType, IEnumerable<ValueTuple`2<OrderRequirementsId, Int32>> pairs) { }
