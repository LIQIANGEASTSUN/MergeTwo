...
public class MultiTargetSinkStateFactory : ISinkStateFactory
{
	...
	private sealed class <>c
	{
		...
		public static Func<ValueTuple`2<Int32, Int32>, Int32> <>9__9_0; //Field offset: 0x8
		[TupleElementNames(new IL2CPP_TYPE_STRING[] {"itemId", "target"})]
		public static Func<ValueTuple`2<Int32, Int32>, Int32> <>9__9_1; //Field offset: 0x10

		private static <>c() { }

		public <>c() { }

		internal int <.ctor>b__9_0(ValueTuple<Int32, Int32> score) { }

		internal int <.ctor>b__9_1(ValueTuple<Int32, Int32> score) { }

	}

	[CompilerGenerated]
	private sealed class <GetAcceptedItems>d__12 : IEnumerable<Int32>, IEnumerable, IEnumerator<Int32>, IEnumerator, IDisposable
	{
		private int <>1__state; //Field offset: 0x10
		private int <>2__current; //Field offset: 0x14
		private int <>l__initialThreadId; //Field offset: 0x18
		public MultiTargetSinkStateFactory <>4__this; //Field offset: 0x20
		...
		[DebuggerHidden]
		public <GetAcceptedItems>d__12(int <>1__state) { }
	...
	[CompilerGenerated]
	private sealed class <GetSinkProducts>d__10 : IEnumerable<ValueTuple`2<IItemDefinition, Int32>>, IEnumerable, IEnumerator<ValueTuple`2<IItemDefinition, Int32>>, IEnumerator, IDisposable
	{
		private int <>1__state; //Field offset: 0x10
		private ValueTuple<IItemDefinition, Int32> <>2__current; //Field offset: 0x18
		private int <>l__initialThreadId; //Field offset: 0x28
		public MultiTargetSinkStateFactory <>4__this; //Field offset: 0x30
		...
		[DebuggerHidden]
		public <GetSinkProducts>d__10(int <>1__state) { }
	...
	[CompilerGenerated]
	private MetaDictionary<Int32, Int32> <ScoreTargets>k__BackingField; //Field offset: 0x10
	[CompilerGenerated]
	private ItemDef <RewardDef>k__BackingField; //Field offset: 0x18
	...
	public MetaDictionary<Int32, Int32> ScoreTargets
	{
		[CompilerGenerated]
		 get { } //Length: 8
		[CompilerGenerated]
	...
	public MultiTargetSinkStateFactory(List<ValueTuple`2<Int32, Int32>> scores, int rewardId) { }
	...
	[CompilerGenerated]
	public MetaDictionary<Int32, Int32> get_ScoreTargets() { }

	[IteratorStateMachine(typeof(<GetAcceptedItems>d__12))]
	public override IEnumerable<Int32> GetAcceptedItems(IMergeMansionGameConfig config) { }

	[IteratorStateMachine(typeof(<GetSinkProducts>d__10))]
	...
	[CompilerGenerated]
	public void set_ScoreTargets(MetaDictionary<Int32, Int32> value) { }
