...
public class SimpleSinkState : ISinkState
{
	...
	public SimpleSinkState(MetaDictionary<Int32, Int32> takeIn, int scoreTarget, ItemDef rewardDef) { }
	...
	public static ISinkState NewState(MetaDictionary<Int32, Int32> scores, int scoreTarget, ItemDef rewardDef) { }
