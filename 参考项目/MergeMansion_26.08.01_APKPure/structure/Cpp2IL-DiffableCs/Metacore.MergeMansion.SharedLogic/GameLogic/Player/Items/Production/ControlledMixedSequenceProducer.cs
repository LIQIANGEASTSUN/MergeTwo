...
public class ControlledMixedSequenceProducer : IItemSpawner, IItemProducer
{
	...
	private sealed class <Produce>d__22 : IEnumerable<IItemDefinition>, IEnumerable, IEnumerator<IItemDefinition>, IEnumerator, IDisposable
	{
		...
		private IEnumerable<IItemDefinition> allowedItems; //Field offset: 0x28
		public IEnumerable<IItemDefinition> <>3__allowedItems; //Field offset: 0x30
		public ControlledMixedSequenceProducer <>4__this; //Field offset: 0x38
		private IGenerationContext context; //Field offset: 0x40
		public IGenerationContext <>3__context; //Field offset: 0x48
		private int quantity; //Field offset: 0x50
		public int <>3__quantity; //Field offset: 0x54
		private IReadOnlyList<IItemOdds> <oddsList>5__2; //Field offset: 0x58
		private int <totalOdds>5__3; //Field offset: 0x60
		private int <itemsFound>5__4; //Field offset: 0x64
		private int <tries>5__5; //Field offset: 0x68
	...
	public ControlledMixedSequenceProducer(RollHistoryType rollType, int itemId, List<ValueTuple`2<Int32, Int32>> oddsList) { }
