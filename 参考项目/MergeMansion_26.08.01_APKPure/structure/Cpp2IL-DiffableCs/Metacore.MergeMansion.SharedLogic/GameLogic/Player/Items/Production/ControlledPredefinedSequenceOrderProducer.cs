...
{
	[CompilerGenerated]
	private sealed class <GetSpawnOrder>d__20 : IEnumerable<OrderRequirementsId>, IEnumerable, IEnumerator<OrderRequirementsId>, IEnumerator, IDisposable
	{
		private int <>1__state; //Field offset: 0x10
		private OrderRequirementsId <>2__current; //Field offset: 0x18
		private int <>l__initialThreadId; //Field offset: 0x20
		public ControlledPredefinedSequenceOrderProducer <>4__this; //Field offset: 0x28
		...
		[DebuggerHidden]
		public <GetSpawnOrder>d__20(int <>1__state) { }
	...
	private ControlledPredefinedSequenceOrderProducer() { }

	public ControlledPredefinedSequenceOrderProducer(RollHistoryType rollType, int itemType, IEnumerable<ValueTuple`2<OrderRequirementsId, Int32>> pairs) { }
	...
	[IteratorStateMachine(typeof(<GetSpawnOrder>d__20))]
