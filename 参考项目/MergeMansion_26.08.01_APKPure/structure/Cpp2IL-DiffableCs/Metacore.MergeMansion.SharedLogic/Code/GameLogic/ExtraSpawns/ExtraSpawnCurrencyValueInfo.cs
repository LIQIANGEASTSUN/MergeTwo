...
{
	[CompilerGenerated]
	private Currencies <ConfigKey>k__BackingField; //Field offset: 0x10
	[CompilerGenerated]
	private F32 <Value>k__BackingField; //Field offset: 0x14
	[CompilerGenerated]
	private MetaDictionary<Currencies, F32> <CustomValuesByCurrency>k__BackingField; //Field offset: 0x18
	[CompilerGenerated]
	private MetaDictionary<CoreSupportEventTokenId, F32> <CustomValuesByCoreSupportEventTokenId>k__BackingField; //Field offset: 0x20
	[CompilerGenerated]
	private int <ExperimentPriority>k__BackingField; //Field offset: 0x28

	[MetaMember(1, MetaMemberFlags::None (0))]
	public private override Currencies ConfigKey
	{
		[CompilerGenerated]
		 get { } //Length: 8
		[CompilerGenerated]
	...
	[CompilerGenerated]
	public override Currencies get_ConfigKey() { }
	...
	[CompilerGenerated]
	private void set_ConfigKey(Currencies value) { }
