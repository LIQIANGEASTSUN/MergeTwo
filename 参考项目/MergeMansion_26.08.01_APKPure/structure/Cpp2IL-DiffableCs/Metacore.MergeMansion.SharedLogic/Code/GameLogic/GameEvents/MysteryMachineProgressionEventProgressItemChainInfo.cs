...
{
	[CompilerGenerated]
	private MysteryMachineProgressionEventProgressItemChainId <ConfigKey>k__BackingField; //Field offset: 0x10
	[CompilerGenerated]
	private List<MetaRef`1<MysteryMachineProgressionEventProgressItemInfo>> <ItemRefs>k__BackingField; //Field offset: 0x18
	[CompilerGenerated]
	...
	public private List<MetaRef`1<MysteryMachineProgressionEventProgressItemInfo>> ItemRefs
	{
		[CompilerGenerated]
		 get { } //Length: 8
		[CompilerGenerated]
	...
	public MysteryMachineProgressionEventProgressItemChainInfo(MysteryMachineProgressionEventProgressItemChainId configKey, List<MetaRef`1<MysteryMachineProgressionEventProgressItemInfo>> itemRefs, int experimentPriority) { }
	...
	[CompilerGenerated]
	public List<MetaRef`1<MysteryMachineProgressionEventProgressItemInfo>> get_ItemRefs() { }
	...
	[CompilerGenerated]
	private void set_ItemRefs(List<MetaRef`1<MysteryMachineProgressionEventProgressItemInfo>> value) { }
