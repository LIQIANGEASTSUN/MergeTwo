...
{
	[CompilerGenerated]
	private MysteryMachineCurrencyItemChainId <ConfigKey>k__BackingField; //Field offset: 0x10
	[CompilerGenerated]
	private List<MetaRef`1<MysteryMachineCurrencyItemInfo>> <ItemRefs>k__BackingField; //Field offset: 0x18
	[CompilerGenerated]
	...
	public private List<MetaRef`1<MysteryMachineCurrencyItemInfo>> ItemRefs
	{
		[CompilerGenerated]
		 get { } //Length: 8
		[CompilerGenerated]
	...
	public MysteryMachineCurrencyItemChainInfo(MysteryMachineCurrencyItemChainId configKey, List<MetaRef`1<MysteryMachineCurrencyItemInfo>> itemRefs, int experimentPriority) { }
	...
	[CompilerGenerated]
	public List<MetaRef`1<MysteryMachineCurrencyItemInfo>> get_ItemRefs() { }
	...
	[CompilerGenerated]
	private void set_ItemRefs(List<MetaRef`1<MysteryMachineCurrencyItemInfo>> value) { }
