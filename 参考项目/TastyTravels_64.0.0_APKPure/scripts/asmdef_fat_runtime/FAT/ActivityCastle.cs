...
namespace FAT
{
	...
	{
		[CompilerGenerated]
		public sealed class _003CResEnumerate_003Ed__37 : IEnumerable<(string, AssetTag)>, IEnumerable, IEnumerator<(string, AssetTag)>, IEnumerator, IDisposable
		{
			[NonSerialized]
			...
			public ActivityCastle _003C_003E4__this;
			...
			[DebuggerHidden]
			public _003CResEnumerate_003Ed__37(int _003C_003E1__state)
			{
			}
		...
		public VisualPopup VisualBegin { get; }
		...
		[IteratorStateMachine(typeof(_003CResEnumerate_003Ed__37))]
