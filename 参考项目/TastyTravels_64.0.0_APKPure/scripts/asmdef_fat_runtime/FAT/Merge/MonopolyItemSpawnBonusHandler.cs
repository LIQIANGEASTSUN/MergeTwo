...
namespace FAT.Merge
{
	public class MonopolyItemSpawnBonusHandler : BaseItemSpawnBonusHandler
	{
		[NonSerialized]
		public readonly ActivityMonopolyBoard _act;
		...
		public MonopolyItemSpawnBonusHandler(ActivityMonopolyBoard act)
		{
		}
