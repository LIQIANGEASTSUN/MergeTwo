...
namespace FAT.Merge
{
	public class FishingBoardItemSpawnBonusHandler : BaseItemSpawnBonusHandler
	{
		[NonSerialized]
		public ActivityFishing _actInst;

		public FishingBoardItemSpawnBonusHandler(ActivityFishing act)
		{
		}
