...
namespace FAT.Merge
{
	public class AreaBoardItemSpawnBonusHandler : BaseItemSpawnBonusHandler
	{
		[NonSerialized]
		public AreaBoardActivity _act;
		...
		public AreaBoardItemSpawnBonusHandler(AreaBoardActivity act)
		{
		}
