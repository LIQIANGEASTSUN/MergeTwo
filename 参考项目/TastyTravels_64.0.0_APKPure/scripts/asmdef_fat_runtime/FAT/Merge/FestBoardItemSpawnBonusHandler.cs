...
namespace FAT.Merge
{
	public class FestBoardItemSpawnBonusHandler : BaseItemSpawnBonusHandler
	{
		[NonSerialized]
		public FestBoardActivity _act;

		public FestBoardItemSpawnBonusHandler(FestBoardActivity act_)
		{
		}
