...
namespace FAT.Merge
{
	public class ScoreBoardItemSpawnBonusHandler : BaseItemSpawnBonusHandler
	{
		[NonSerialized]
		public readonly ScoreBoardActivity _act;

		public ScoreBoardItemSpawnBonusHandler(ScoreBoardActivity act)
		{
		}
