...
namespace FAT
{
	public class MiniBoardActivityHandler : ActivityGroup
	{
		...
		public (bool, string) _TryCreateAct(LiteInfo lite_, EventType type_, out MiniBoardActivity miniBoardAct)
		{
			miniBoardAct = null;
			return default((bool, string));
		}

		public void _TryCreateMiniBoardData(MiniBoardActivity activity, bool isNew)
		{
		}
