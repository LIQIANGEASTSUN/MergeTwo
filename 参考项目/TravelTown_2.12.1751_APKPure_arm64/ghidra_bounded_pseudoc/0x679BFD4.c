/* Ghidra 12.1.2 bounded pseudocode; RVA 0x679BFD4; bound 24 bytes; MergeEngine.ECS.Systems.Items.Producers.ProduceSystem.ShouldProduceRngItem; status ok */
...

{
  ...
  pcStack_50 = MergeEngine_ECS_Systems_Items_Producers_ProduceSystem__FireAnalyticsSignal;
...
LAB_0689c0a8:
  puVar31 = PTR_DAT_07810930;
  uVar8 = (*(code *)*puVar11)(plVar30,param_3,puVar11[1]);
  ...
  lVar12 = func_0x03280ca0(*(undefined8 *)puVar31);
  func_0x060f3c08(lVar12,param_3,uVar8,param_4,auVar35._8_8_,param_5 & 0xffffffff,0);
  ...
  if (lVar23 == 0) {
    ...
    puVar31 = (undefined *)((long)&pppppppuStack_a0 + lVar13);
    if (*(char *)(unaff_x22 + 0x50) == '\0') {
      ...
      lVar23 = func_0x072869d0(unaff_x22,uVar10,uVar28,1,0);
      ...
      lVar12 = func_0x03280b94(*(undefined8 *)(unaff_x20 + 8),puVar31);
      if (lVar23 != 0) {
        pcStack_50 = (code *)&UNK_03ea52d0;
        unaff_x21 = lVar23;
        unaff_x24 = puVar31;
    ...
    *(undefined **)((long)alStack_1a0 + lVar13 + 0xe0) = &SUB_03ea5304;
    ...
    *(undefined **)((long)alStack_1a0 + lVar13 + 0xd0) = puVar31;
    ...
    *(undefined **)((long)alStack_1a0 + lVar13 + 0x80) = &UNK_03ea5530;
    ...
    *(undefined8 *)((long)alStack_1a0 + lVar13 + 0xb8) = 0;
    ...
    if (lVar12 != 0) {
      plVar30 = (long *)(lVar12 + 0x10);
      *plVar30 = (long)puVar31;
      puVar14 = puVar31;
      goto code_r0x032809c4;
    }
    auVar35 = func_0x03280cac();
    *(undefined **)((long)alStack_1a0 + lVar13 + 0x40) = &UNK_03ea5644;
    *(undefined8 *)((long)alStack_1a0 + lVar13 + 0x50) = 0;
    *(undefined8 ********)((long)alStack_1a0 + lVar13 + 0x58) = unaff_x23;
    *(undefined **)((long)alStack_1a0 + lVar13 + 0x60) = puVar31;
    ...
    *(long *)((long)alStack_1a0 + lVar13 + 0x78) = auVar33._8_8_;
    ...
    auVar33 = func_0x03280cac();
    *(undefined **)((long)alStack_1a0 + lVar13) = &UNK_03ea575c;
    ...
    *(undefined **)((long)alStack_1d0 + lVar13 + 0x10) = &UNK_03ea5874;
...
code_r0x03ea5b18:
    ...
    puVar31 = (undefined *)((long)alStack_1a0 + lVar13);
    pcStack_50 = *(code **)((long)alStack_1d0 + lVar13);
...
code_r0x072852e4:
  lVar20 = 0;
  puVar7 = puVar31 + -0x30;
  *(code **)(puVar31 + -0x30) = pcStack_50;
  *(long *)(puVar31 + -0x20) = unaff_x22;
  *(long *)(puVar31 + -0x18) = unaff_x21;
  *(long *)(puVar31 + -0x10) = unaff_x20;
  *(undefined8 ********)(puVar31 + -8) = pppppppuVar16;
  ...
  if (lVar12 != 0) {
    ...
    uVar9 = func_0x0727e0ec(uVar28,puVar27);
...
code_r0x072855b0:
  ...
  lVar23 = auVar35._0_8_;
  *(undefined **)(puVar31 + -0x70) = &UNK_072855d4;
  *(undefined8 *)(puVar31 + -0x68) = unaff_x25;
  *(undefined **)(puVar31 + -0x60) = unaff_x24;
  *(undefined8 ********)(puVar31 + -0x58) = unaff_x23;
  *(long *)(puVar31 + -0x50) = unaff_x22;
  *(undefined8 *)(puVar31 + -0x48) = uVar28;
  *(undefined8 *)(puVar31 + -0x40) = 0;
  *(undefined8 *)(puVar31 + -0x38) = 0x7e34000;
    ...
    if (lVar13 != 0) {
      if (0 < *(int *)(lVar13 + 0x18)) {
        ...
        do {
          ...
          unaff_x24 = puVar14;
          if (*(long *)(lVar23 + 0x10) == 0) goto code_r0x07285808;
          ...
          uVar9 = (int)plVar29 + 1;
          plVar29 = (long *)(ulong)uVar9;
        } while ((int)uVar9 < *(int *)(lVar13 + 0x18));
      }
      return auVar35;
    }
code_r0x07285808:
...
code_r0x0728580c:
    ...
    if (*(int *)(lVar23 + 0x30) != 2) {
      if (*(int *)(lVar23 + 0x30) != 1) goto code_r0x07285770;
...
code_r0x032809c4:
  ...
  *(undefined **)(puVar31 + -0x80) = &UNK_0728581c;
  ...
  lVar12 = auVar35._0_8_;
  puVar7 = puVar31 + -0xc0;
  *(undefined **)(puVar31 + -0xc0) = &UNK_07285840;
  *(undefined **)(puVar31 + -0xb0) = unaff_x24;
  *(undefined **)(puVar31 + -0xa8) = puVar14;
  *(long **)(puVar31 + -0xa0) = plVar30;
  *(long *)(puVar31 + -0x98) = lVar23;
  *(long *)(puVar31 + -0x90) = lVar13;
  *(long *)(puVar31 + -0x88) = lVar20;
  lVar23 = 0x7e34000;
...
code_r0x0727dc78:
  ...
  *(undefined **)(puVar7 + -0x18) = puVar27;
  ...
  auVar37._0_8_ = func_0x03280ca0(*(undefined8 *)puVar31);
