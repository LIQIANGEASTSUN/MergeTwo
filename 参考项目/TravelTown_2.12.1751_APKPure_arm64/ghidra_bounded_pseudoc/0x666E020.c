/* Ghidra 12.1.2 bounded pseudocode; RVA 0x666E020; bound 204 bytes; MergeEngine.ECS.Systems.Board.MergeSystem.PerformTryCombineItems; status ok */
...

{
  ...
  if ((param_2 != 0) &&
    ...
    uVar5 = func_0x0676e1a8(param_1,uVar3,uVar4,*(undefined8 *)(param_3 + 0x30));
    if ((uVar5 & 1) == 0) {
      uVar12 = 0;
    }
    else if (param_4 == 0) {
  ...
  uVar5 = MergeEngine_ECS_Systems_Board_MergeSystem__GetAnyItemOnlyResult();
  if ((uVar5 != 0) ||
     (uVar5 = MergeEngine_ECS_Systems_Board_MergeSystem__GetSameItemResult(lVar10,lVar9,lVar6),
     uVar5 != 0)) {
    return uVar5;
  }
