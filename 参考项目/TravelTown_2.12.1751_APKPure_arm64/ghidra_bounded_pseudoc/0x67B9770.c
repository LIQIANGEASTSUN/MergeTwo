/* Ghidra 12.1.2 bounded pseudocode; RVA 0x67B9770; bound 236 bytes; Merger.Services.Backend.WebSocket.OperationTrackingSystem.TrackSellItemOperation; status ok */


void Merger_Services_Backend_WebSocket_OperationTrackingSystem__TrackSellItemOperation
...

{
  ...
  if (plVar6 == (long *)0x0) {
    ...
    plVar6 = *(long **)(auVar10._0_8_ + 0x40);
    if (plVar6 == (long *)0x0) {
      auVar10 = func_0x03280cac();
      ...
      if (lVar3 != 0) {
        *(undefined8 *)(lVar3 + 0x30) = param_3;
        func_0x032809c4((undefined8 *)(lVar3 + 0x30),param_3);
          ...
          if (uVar4 != 0) {
            ...
            do {
              if (*(long *)(piVar5 + -2) == *(long *)(lVar9 + 0x20)) {
                lVar8 = lVar8 + (long)(int)(*piVar5 + (uint)*(ushort *)(lVar9 + 0x50)) * 0x10 +
                        0x138;
                goto code_r0x068b9a48;
              }
              uVar4 = uVar4 - 1;
              piVar5 = piVar5 + 4;
            } while (uVar4 != 0);
...
code_r0x068b9a48:
          ...
          (**(code **)(lVar8 + 8))(plVar6,uVar7,auVar10._8_8_,0,lVar3,lVar8);
          return;
        }
      }
      auVar10 = func_0x03280cac();
...
code_r0x068b9f38:
            lVar3 = func_0x03280b88(*(undefined8 *)(lVar3 + 8),lVar8);
                    ...
                    /* WARNING: Treating indirect jump as call */
            (**(code **)(lVar3 + 8))(plVar6,uVar7,auVar10._8_8_,0,0,lVar3);
            return;
          }
          lVar3 = *plVar6;
...
code_r0x068b9e50:
          lVar3 = func_0x03280b88(*(undefined8 *)(lVar3 + 8),lVar8);
                    ...
                    /* WARNING: Treating indirect jump as call */
          (**(code **)(lVar3 + 8))(plVar6,uVar7,auVar10._8_8_,0,lVar3);
          return;
        }
        lVar3 = *plVar6;
        lVar8 = *(long *)PTR_DAT_07802f60;
...
LAB_068b9820:
  lVar3 = func_0x03280b88(*(undefined8 *)(lVar3 + 8),lVar8);
                    ...
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(lVar3 + 8))(plVar6,uVar7,param_2,0,0,lVar3);
  return;
}
