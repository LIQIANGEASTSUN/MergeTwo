/* Ghidra 12.1.2 bounded pseudocode; RVA 0x665F378; bound 112 bytes; MergeEngine.ECS.Systems.Board.BoardInteractionSystem.HideLastDraggedItemParticles; status ok */
