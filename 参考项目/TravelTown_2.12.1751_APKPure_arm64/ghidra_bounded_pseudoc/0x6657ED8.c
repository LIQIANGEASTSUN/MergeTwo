/* Ghidra 12.1.2 bounded pseudocode; RVA 0x6657ED8; bound 176 bytes; MergeEngine.ECS.Systems.Board.BoardInteractionSystem.add_ItemTapped; status ok */
...
void MergeEngine_ECS_Systems_Board_BoardInteractionSystem__add_ItemTapped
...

{
  ...
  if ((bRam0000000007e2806c & 1) == 0) {
    func_0x03280a18(PTR_DAT_077f1500);
    bRam0000000007e2806c = 1;
  }
  puVar18 = PTR_DAT_077f1500;
  lVar7 = *(long *)(param_1 + 0x80);
  do {
    lVar4 = func_0x057ddb20(lVar7,param_2,0);
    if (lVar4 == 0) {
      lVar5 = 0;
    }
    else {
      uVar16 = *(undefined8 *)puVar18;
      lVar5 = func_0x03280b90(lVar4,uVar16);
      if (lVar5 == 0) {
        auVar25 = func_0x03281048(lVar4,uVar16);
        if ((bRam0000000007e2806e & 1) == 0) {
          func_0x03280a18(PTR_DAT_077f1500);
          bRam0000000007e2806e = 1;
        }
        puVar18 = PTR_DAT_077f1500;
    ...
    lVar4 = func_0x032dd140((long *)(param_1 + 0x80),lVar5,lVar7);
    bVar3 = lVar7 == lVar4;
    lVar7 = lVar4;
    if (bVar3) {
      return;
...
LAB_06757fcc:
  lVar4 = func_0x057ddb20(lVar7,auVar25._8_8_,0);
  if (lVar4 == 0) {
    lVar5 = 0;
  }
  else {
    ...
    if (lVar5 == 0) {
      auVar25 = func_0x03281048(lVar4,uVar16);
      if ((bRam0000000007e28070 & 1) == 0) {
        func_0x03280a18(PTR_DAT_077f1510);
        bRam0000000007e28070 = 1;
      }
  ...
  lVar4 = func_0x032dd140(plVar14,lVar5,lVar7);
  bVar3 = lVar7 == lVar4;
  lVar7 = lVar4;
  if (bVar3) {
    return;
...
LAB_0675807c:
  ...
  if (lVar4 == 0) {
    ...
    if (lVar5 == 0) {
      ...
      lVar7 = *plVar14;
      while ((plVar6 = (long *)func_0x057ddb20(lVar7,auVar25._8_8_,0), plVar6 == (long *)0x0 ||
             (*plVar6 == *(long *)puVar18))) {
        lVar4 = func_0x032dd140(plVar14,plVar6,lVar7);
        bVar3 = lVar7 == lVar4;
        lVar7 = lVar4;
        if (bVar3) {
          return;
      ...
      do {
        ...
        if (lVar4 == 0) {
          ...
          puVar17 = *(undefined **)puVar18;
          lVar5 = func_0x03280b90(lVar4,puVar17);
          if (lVar5 == 0) {
            lVar7 = func_0x03281048(lVar4,puVar17);
            puVar23 = PTR_DAT_07807700;
            puVar24 = PTR_DAT_077f1500;
            puStack_170 = &UNK_06758234;
            ...
            uVar16 = func_0x03280ca0(*(undefined8 *)puVar24);
            auVar25._8_8_ = uVar16;
            auVar25._0_8_ = lVar4;
            func_0x0541dfd8(uVar16,lVar7,*(undefined8 *)puVar23,0);
            if (lVar4 == 0) {
              puVar23 = &UNK_0675890c;
              auVar25 = func_0x03280cac();
            }
            else {
              puVar23 = &UNK_06758424;
              puVar17 = PTR_DAT_07807730;
            }
  ...
  goto LAB_0675807c;
code_r0x06758950:
  lVar4 = func_0x057ddd18(lVar7,uVar10,0);
  if (lVar4 == 0) {
    lVar5 = 0;
  }
  else {
  ...
  goto code_r0x06758950;
code_r0x06758a00:
  lVar4 = func_0x057ddd18(lVar7,uVar11,0);
  if (lVar4 == 0) {
    lVar5 = 0;
  }
  else {
...
code_r0x06758ab0:
  ...
  if (lVar4 == 0) {
    ...
    if (lVar5 == 0) {
      ...
      plVar14 = (long *)(auVar25._0_8_ + 0xf0);
      lVar7 = *plVar14;
      while ((plVar6 = (long *)func_0x057ddd18(lVar7,uVar11,0), plVar6 == (long *)0x0 ||
             (*plVar6 == *(long *)puVar17))) {
        lVar4 = func_0x032dd140(plVar14,plVar6,lVar7);
        bVar3 = lVar7 == lVar4;
        lVar7 = lVar4;
      ...
      auVar25 = func_0x03281048(plVar6);
      lVar4 = auVar25._8_8_;
      apcStack_2a0[0] = MergeEngine_ECS_Systems_Board_MergeSystem__remove_ItemMerged;
      puStack_290 = puVar18;
      puStack_280 = puVar17;
      uStack_288 = uVar16;
      lStack_278 = lVar7;
      ...
      lVar7 = *plVar14;
      do {
        lVar5 = func_0x057ddd18(lVar7,lVar4,0);
        if (lVar5 == 0) {
          lVar8 = 0;
        }
        else {
          puVar17 = *(undefined **)puVar18;
          lVar8 = func_0x03280b90(lVar5,puVar17);
          if (lVar8 == 0) {
            auVar26 = func_0x03281048(lVar5,puVar17);
            lVar8 = auVar26._0_8_;
            ppcVar2 = (code **)apuStack_2b0;
            apuStack_2b0[0] = &UNK_06758c68;
            if (auVar26._8_4_ == 0) {
        ...
        lVar5 = func_0x032dd140(plVar14,lVar8,lVar7);
        bVar3 = lVar7 == lVar5;
        lVar7 = lVar5;
        if (bVar3) {
          return;
...
code_r0x06758ca8:
  ...
  *(undefined1 *)(lVar4 + 0x28) = 0;
  lVar4 = func_0x03eb6ac8(lVar8,*(undefined8 *)puVar24);
  if (lVar4 == 0) goto code_r0x0675904c;
...
code_r0x06758dac:
  do {
    do {
      ...
      puVar9 = (undefined8 *)func_0x03256b10(plVar14,*(long *)puVar23,0);
code_r0x06758df8:
      ...
      if (uVar12 != 0) {
        piVar13 = (int *)(*(long *)(lVar7 + 0xb0) + 8);
        do {
          if (*(long *)(piVar13 + -2) == *(long *)puVar19) {
            puVar9 = (undefined8 *)(lVar7 + (long)*piVar13 * 0x10 + 0x138);
      ...
      puVar9 = (undefined8 *)func_0x03256b10(plVar14,*(long *)puVar19,0);
code_r0x06758e54:
      lVar7 = (*(code *)*puVar9)(plVar14,puVar9[1]);
      if (lVar7 == 0) {
        func_0x03280cac();
    ...
    *(undefined2 *)(lVar7 + 0x65) = 0;
    lVar4 = func_0x03ced81c(lVar7,*(undefined8 *)puVar20);
  } while (((*(char *)(lVar7 + 0x67) != '\0') ||
           (lVar5 = func_0x03ced81c(lVar7,*(undefined8 *)puVar21), lVar4 == 0)) || (lVar5 != 0));
  ...
  if (plVar6 != (long *)0x0) {
    ...
    if (uVar12 != 0) {
      piVar13 = (int *)(*(long *)(lVar7 + 0xb0) + 8);
      do {
        if (*(long *)(piVar13 + -2) == *(long *)puVar22) {
          puVar9 = (undefined8 *)(lVar7 + (long)(*piVar13 + 0x23) * 0x10 + 0x138);
    ...
    puVar9 = (undefined8 *)func_0x03256b10(plVar6,*(long *)puVar22,0x23);
code_r0x06758f18:
    (*(code *)*puVar9)(plVar6,uVar16,puVar9[1]);
...
code_r0x06758f38:
        ...
        if (uVar12 != 0) {
          ...
          do {
            if (*(long *)(piVar13 + -2) == *(long *)PTR_DAT_0774e8c8) {
              puVar9 = (undefined8 *)(lVar4 + (long)*piVar13 * 0x10 + 0x138);
        ...
        puVar9 = (undefined8 *)func_0x03256b10(plVar14,*(long *)PTR_DAT_0774e8c8,0);
code_r0x06758f8c:
...
code_r0x06758f98:
    ...
    if (*(long *)(lVar8 + 0x40) != 0) {
      plVar6 = *(long **)(*(long *)(lVar8 + 0x40) + 0x40);
      lVar8 = 0;
      if (plVar6 != (long *)0x0) {
        lVar7 = *plVar6;
        uVar12 = (ulong)*(ushort *)(lVar7 + 0x12e);
...
code_r0x06758fd8:
    if (*(long *)(piVar13 + -2) == *(long *)PTR_DAT_07807800) {
      puVar9 = (undefined8 *)(lVar7 + (long)(*piVar13 + 3) * 0x10 + 0x138);
      goto code_r0x06759028;
    }
  }
code_r0x06758ff0:
  puVar9 = (undefined8 *)func_0x03256b10(plVar6,*(long *)PTR_DAT_07807800,3);
code_r0x06759028:
