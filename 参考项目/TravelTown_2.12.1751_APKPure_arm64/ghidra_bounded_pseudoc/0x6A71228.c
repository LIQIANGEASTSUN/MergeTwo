/* Ghidra 12.1.2 bounded pseudocode; RVA 0x6A71228; bound 1252 bytes; Merger.MergeBoard.Systems.MergeSystem.Tick; status ok */


void Merger_MergeBoard_Systems_MergeSystem__Tick
...
LAB_06b713f4:
      ...
      puVar18 = PTR_DAT_07830a00;
      puVar19 = PTR_DAT_0774e8e0;
      if (plVar14 == (long *)0x0) goto LAB_06b71640;
...
LAB_06b714e4:
      ...
      if (*(long *)(param_1 + 0x20) != 0) {
        ...
        if ((uVar6 & 1) != 0) {
          ...
          param_4 = &uStack_2b0;
          Merger_MergeBoard_Systems_MergeSystem__PerformMerge(param_1,&uStack_240);
        }
        goto LAB_06b7143c;
      }
      func_0x03280cac();
...
LAB_06b71644:
  ...
  do {
    ...
    plVar7 = (long *)func_0x072ce910(uVar16);
...
LAB_06b716f4:
  ...
  puVar8 = auVar20._8_8_;
  lVar11 = auVar20._0_8_;
  pcStack_328 = Merger_MergeBoard_Systems_MergeSystem__PerformMerge;
  uStack_2e0 = 0;
  puStack_330 = puVar19;
  puStack_320 = puVar18;
    ...
    if (uVar6 != 0) {
      ...
      do {
        if (*(long *)(piVar13 + -2) == *(long *)PTR_DAT_0777a498) {
          puVar9 = (undefined8 *)(lVar12 + (long)(*piVar13 + 0xd) * 0x10 + 0x138);
          goto LAB_06b71820;
        }
        uVar6 = uVar6 - 1;
        piVar13 = piVar13 + 4;
...
LAB_06b71820:
    plVar14 = (long *)(*(code *)*puVar9)(plVar14,uVar16,puVar9[1]);
    if (plVar14 == (long *)0x0) {
      uVar16 = 0;
    }
    else {
...
LAB_06b71894:
      uVar16 = (*(code *)*puVar9)(plVar14,puVar9[1]);
    }
    puVar2 = PTR_DAT_07830a20;
    puVar18 = PTR_DAT_07808148;
    auVar20._8_8_ = auStack_360._8_8_;
    auVar20._0_8_ = auStack_360._0_8_;
...
LAB_06b71918:
      uVar16 = (*(code *)*puVar9)(plVar14,uVar16,uVar1,2,0,0,puVar9[1]);
      ...
      func_0x03ec5690(&uStack_350,uVar16,0,*(undefined8 *)puVar2);
      uStack_398 = param_4[1];
      uStack_3a0 = *param_4;
      uStack_388 = param_4[3];
      uStack_390 = param_4[2];
      func_0x06b98e60(&uStack_3a0,uVar16,0,0);
      ...
      uVar10 = func_0x06ba3134(uVar16,*(undefined8 *)(lVar11 + 0x10),*(undefined8 *)puVar18,
      ...
      if (plVar14 != (long *)0x0) {
        ...
        puVar9 = (undefined8 *)func_0x03256b10(plVar14,*(long *)puVar19,0x19);
LAB_06b71a30:
        uVar5 = (*(code *)*puVar9)(plVar14,uVar17,puVar9[1]);
        lVar12 = param_4[2];
        lVar11 = func_0x03280ca0(*(undefined8 *)puVar18);
        func_0x06b9a9dc(lVar11,0);
        auStack_360 = func_0x0578e2a8(0);
        uVar17 = func_0x0579043c(auStack_360,0);
        auVar20 = auStack_360;
        if (lVar11 != 0) {
          ...
          *(undefined8 *)(lVar11 + 0x28) = uVar16;
          func_0x032809c4((undefined8 *)(lVar11 + 0x28),uVar16);
          *(undefined4 *)(lVar11 + 0x30) = uVar1;
          *(undefined4 *)(lVar11 + 0x40) = uVar5;
          puVar19 = PTR_DAT_0782fe78;
          auVar20 = auStack_360;
          if (lVar12 != 0) {
            func_0x03ec33e4(lVar12,lVar11,*(undefined8 *)PTR_DAT_07830a18);
            lVar11 = param_4[2];
            uVar17 = func_0x03280ca0(*(undefined8 *)puVar19);
            func_0x06b9a828(uVar17,uVar16,uVar10,0);
            auVar20 = auStack_360;
            if (lVar11 != 0) {
              func_0x03ec33e4(lVar11,uVar17,*(undefined8 *)PTR_DAT_0782fea8);
              return;
            }
          }
        }
