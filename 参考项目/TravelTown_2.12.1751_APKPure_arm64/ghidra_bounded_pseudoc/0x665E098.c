/* Ghidra 12.1.2 bounded pseudocode; RVA 0x665E098; bound 256 bytes; MergeEngine.ECS.Systems.Board.BoardInteractionSystem.TryGuess; status ok */
...
undefined8 MergeEngine_ECS_Systems_Board_BoardInteractionSystem__TryGuess(long param_1,long param_2)

{
  ...
  if (*(long *)(param_1 + 0x68) != 0) {
    uVar4 = func_0x06a04f00(*(long *)(param_1 + 0x68) + 0x30,param_2,0);
    if (((uVar4 & 1) != 0) ||
       (uVar4 = func_0x060e8460(param_2,*(undefined8 *)(param_1 + 0x58),0), (uVar4 & 1) == 0)) {
LAB_0675e17c:
      MergeEngine_ECS_Systems_Board_BoardInteractionSystem__ResetInteractionAnimation(param_1);
      return 0;
    }
    lVar7 = *(long *)(param_1 + 0x58);
    if (lVar7 != 0) {
      iVar8 = *(int *)(lVar7 + 0x28) + -1;
      iVar9 = (int)param_2;
      iVar2 = *(int *)(lVar7 + 0x2c) + -1;
      if (iVar9 <= iVar8) {
        iVar8 = iVar9;
      }
      iVar1 = 0;
      ...
      func_0x069fdc94(&lStack_18,iVar1,iVar8,0);
      if ((*(long *)(param_1 + 0x68) != 0) && (*(long *)(param_1 + 0x58) != 0)) {
        lVar7 = func_0x06a02444(*(long *)(param_1 + 0x58),
                                *(undefined8 *)(*(long *)(param_1 + 0x68) + 0x30),0);
        if (*(long *)(param_1 + 0x58) != 0) {
          lVar5 = func_0x06a02444(*(long *)(param_1 + 0x58),lStack_18,0);
          if (((lVar7 != 0) && (lVar5 != 0)) &&
             (uVar4 = MergeEngine_ECS_Systems_Board_BoardInteractionSystem__CanCombineItems
                                (param_1,lVar7,lVar5,lStack_18), (uVar4 & 1) != 0)) {
            return 1;
          }
          goto LAB_0675e17c;
        }
