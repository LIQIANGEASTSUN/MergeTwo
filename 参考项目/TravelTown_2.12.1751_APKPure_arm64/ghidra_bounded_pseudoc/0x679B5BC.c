/* Ghidra 12.1.2 bounded pseudocode; RVA 0x679B5BC; bound 164 bytes; MergeEngine.ECS.Systems.Items.Producers.ProduceSystem.OrderProducers; status ok */


undefined8
MergeEngine_ECS_Systems_Items_Producers_ProduceSystem__OrderProducers
...

{
  ...
  if ((*(byte *)(*(long *)(lVar7 + 0x10) + 0x135) & 1) == 0) {
    func_0x0325681c();
  }
  uVar4 = func_0x03280ca0();
  func_0x04438914(uVar4,param_2,uVar5,0,0,*(undefined8 *)(*(long *)(lVar6 + 0x38) + 0x18),in_x6,
                  in_x7,unaff_x30,unaff_x21,unaff_x20,unaff_x19);
  return uVar4;
}
