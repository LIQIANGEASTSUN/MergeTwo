/* Ghidra 12.1.2 bounded pseudocode; RVA 0x665E198; bound 1508 bytes; MergeEngine.ECS.Systems.Board.BoardInteractionSystem.BoardItemDragEnded; status ok */
...
void MergeEngine_ECS_Systems_Board_BoardInteractionSystem__BoardItemDragEnded(void)

{
  undefined *puVar1;
  
  puVar1 = PTR_DAT_078079c8;
