/* Ghidra 12.1.2 bounded pseudocode; RVA 0x66589BC; bound 176 bytes; MergeEngine.ECS.Systems.Board.BoardInteractionSystem.remove_ItemDragStarted; status ok */
...
void MergeEngine_ECS_Systems_Board_BoardInteractionSystem__remove_ItemDragStarted
  ...
  do {
    ...
    if (lVar4 == 0) {
      ...
      if (lVar5 == 0) {
        ...
        uVar9 = auVar25._8_8_;
        pcStack_80 = MergeEngine_ECS_Systems_Board_BoardInteractionSystem__remove_ItemDragEnded;
        puStack_70 = puVar19;
        uStack_68 = uVar16;
        lStack_60 = lVar4;
        lStack_58 = lVar11;
...
LAB_06758ab0:
  ...
  if (lVar4 == 0) {
    ...
    if (lVar5 == 0) {
      ...
      lVar11 = *plVar14;
      while ((plVar6 = (long *)func_0x057ddd18(lVar11,uVar10,0), plVar6 == (long *)0x0 ||
             (*plVar6 == *(long *)puVar17))) {
      ...
      lVar4 = auVar25._8_8_;
      apcStack_f0[0] = MergeEngine_ECS_Systems_Board_MergeSystem__remove_ItemMerged;
      puStack_e0 = puVar19;
      puStack_d0 = puVar17;
      uStack_d8 = uVar16;
      lStack_c8 = lVar11;
      ...
      do {
        ...
        if (lVar5 == 0) {
          ...
          if (lVar7 == 0) {
            ...
            lVar7 = auVar26._0_8_;
            ppcVar2 = (code **)apuStack_100;
            apuStack_100[0] = &UNK_06758c68;
            if (auVar26._8_4_ == 0) {
