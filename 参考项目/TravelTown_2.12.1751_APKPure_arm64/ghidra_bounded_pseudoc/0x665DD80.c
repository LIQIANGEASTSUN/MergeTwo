/* Ghidra 12.1.2 bounded pseudocode; RVA 0x665DD80; bound 792 bytes; MergeEngine.ECS.Systems.Board.BoardInteractionSystem.BoardItemBeingDragged; status ok */


/* WARNING: Possible PIC construction at 0x0675df84: Changing call to branch */
...
/* WARNING: Possible PIC construction at 0x0675e748: Changing call to branch */
...
/* WARNING: Removing unreachable block (ram,0x0675df88) */
...
/* WARNING: Removing unreachable block (ram,0x0675e74c) */
/* WARNING: Removing unreachable block (ram,0x0675e75c) */

undefined8
MergeEngine_ECS_Systems_Board_BoardInteractionSystem__BoardItemBeingDragged
...
LAB_0675e094:
    ...
    if (uVar10 != 0) {
      ...
      do {
        if (*(long *)(piVar12 + -2) == *(long *)PTR_DAT_077cc678) {
    ...
    puVar6 = (undefined8 *)func_0x03256b10(plVar14,*(long *)PTR_DAT_077cc678,0xd);
LAB_0675de34:
    uVar15 = (*(code *)*puVar6)(plVar14,puVar6[1]);
    lVar8 = *(long *)(param_3 + 0x58);
    if (lVar8 == 0) goto LAB_0675e094;
    iVar11 = *(int *)(lVar8 + 0x2c);
    fVar17 = (float)uVar15;
    param_1 = param_1 + fVar17 * (float)*(int *)(lVar8 + 0x28) * 0.5;
    if (cRam0000000007e136d7 == '\0') {
      func_0x03280a18(PTR_DAT_0774ee08);
      cRam0000000007e136d7 = '\x01';
    }
    puVar4 = PTR_DAT_0774ee08;
    fVar16 = param_1 / fVar17;
    if (*(int *)(*(long *)PTR_DAT_0774ee08 + 0xe0) == 0) {
      func_0x03280b8c();
      bVar5 = cRam0000000007e136d7 == '\0';
    }
    else {
      bVar5 = false;
    }
    ...
    param_2 = fVar17 * (float)iVar11 * 0.5 - param_2;
    if (bVar5) {
      func_0x03280a18(PTR_DAT_0774ee08);
      cRam0000000007e136d7 = '\x01';
    }
    ...
    func_0x072ce9d0(param_1,uVar15);
    func_0x072ce9d0(param_2,uVar15);
    func_0x069fdc94(&lStack_28,plVar14,iVar11,0);
    if (*(long *)(param_3 + 0x58) == 0) goto LAB_0675e094;
    lVar8 = param_3;
    lVar7 = lStack_28;
    if (*(char *)(*(long *)(param_3 + 0x58) + 0x30) != '\0') {
      func_0x0675dcbc(param_3);
      lVar7 = lStack_28;
    }
  }
  lStack_78 = lVar7;
  ...
  if (*(long *)(lVar8 + 0x68) != 0) {
    uVar10 = func_0x06a04f00(*(long *)(lVar8 + 0x68) + 0x30,lVar7,0);
    if (((uVar10 & 1) != 0) ||
       (uVar10 = func_0x060e8460(lVar7,*(undefined8 *)(lVar8 + 0x58),0), (uVar10 & 1) == 0)) {
code_r0x0675e17c:
      func_0x0675e83c(lVar8);
      return 0;
    }
    lVar9 = *(long *)(lVar8 + 0x58);
    if (lVar9 != 0) {
      iVar11 = *(int *)(lVar9 + 0x28) + -1;
      iVar13 = (int)lVar7;
      iVar3 = *(int *)(lVar9 + 0x2c) + -1;
      if (iVar13 <= iVar11) {
        iVar11 = iVar13;
      }
      iVar2 = 0;
      ...
      func_0x069fdc94(&lStack_78,iVar2,iVar11,0);
      if ((*(long *)(lVar8 + 0x68) != 0) && (*(long *)(lVar8 + 0x58) != 0)) {
        lVar7 = func_0x06a02444(*(long *)(lVar8 + 0x58),
                                *(undefined8 *)(*(long *)(lVar8 + 0x68) + 0x30),0);
        if (*(long *)(lVar8 + 0x58) != 0) {
          lVar9 = func_0x06a02444(*(long *)(lVar8 + 0x58),lStack_78,0);
          if (((lVar7 != 0) && (lVar9 != 0)) &&
             (uVar10 = func_0x0675f06c(lVar8,lVar7,lVar9,lStack_78), (uVar10 & 1) != 0)) {
            return 1;
          }
          goto code_r0x0675e17c;
        }
      }
    }
  }
  func_0x03280cac();
  puVar4 = PTR_DAT_078079c8;
  if ((bRam0000000007e28083 & 1) == 0) {
    func_0x03280a18(PTR_DAT_0774e758);
    func_0x03280a18(PTR_DAT_077e6500);
    func_0x03280a18(PTR_DAT_0777e638);
    func_0x03280a18(PTR_DAT_077d7588);
    func_0x03280a18(PTR_DAT_078079d0);
    func_0x03280a18(PTR_DAT_078079d8);
    func_0x03280a18(PTR_DAT_077cc678);
    func_0x03280a18(PTR_DAT_078079e0);
    func_0x03280a18(PTR_DAT_077d77a0);
    func_0x03280a18(PTR_DAT_078079e8);
    func_0x03280a18(PTR_DAT_078079f0);
    func_0x03280a18(PTR_DAT_078079c8);
    bRam0000000007e28083 = 1;
  }
