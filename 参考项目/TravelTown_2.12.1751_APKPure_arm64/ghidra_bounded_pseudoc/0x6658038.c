/* Ghidra 12.1.2 bounded pseudocode; RVA 0x6658038; bound 176 bytes; MergeEngine.ECS.Systems.Board.BoardInteractionSystem.add_ItemDragEnded; status ok */
...
void MergeEngine_ECS_Systems_Board_BoardInteractionSystem__add_ItemDragEnded
...
LAB_0675807c:
  ...
  lVar4 = func_0x032dd140((long *)(param_1 + 0x90),lVar5,lVar7);
  bVar3 = lVar7 == lVar4;
  lVar7 = lVar4;
  if (bVar3) {
    return;
...
code_r0x06758ab0:
  ...
  if (lVar4 == 0) {
    ...
    if (lVar5 == 0) {
      ...
      auVar25 = func_0x03281048(plVar6);
      lVar4 = auVar25._8_8_;
      apcStack_220[0] = MergeEngine_ECS_Systems_Board_MergeSystem__remove_ItemMerged;
      puStack_210 = puVar18;
      puStack_200 = puVar17;
      uStack_208 = uVar16;
      lStack_1f8 = lVar7;
      ...
      do {
        ...
        if (lVar5 == 0) {
          ...
          if (lVar8 == 0) {
            ...
            lVar8 = auVar26._0_8_;
            ppcVar2 = (code **)apuStack_230;
            apuStack_230[0] = &UNK_06758c68;
            if (auVar26._8_4_ == 0) {
