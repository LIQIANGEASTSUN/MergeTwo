/* Ghidra 12.1.2 bounded pseudocode; RVA 0x628C9C4; bound 320 bytes; MergeEngine.ECS.Systems.PersistenceSystem.DeserializeEntity; status ok */


/* WARNING: Possible PIC construction at 0x0638ca4c: Changing call to branch */
/* WARNING: Possible PIC construction at 0x0638c930: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x0638ca50) */
/* WARNING: Removing unreachable block (ram,0x0638cb00) */
/* WARNING: Removing unreachable block (ram,0x0638ca54) */
/* WARNING: Removing unreachable block (ram,0x0638cae8) */
/* WARNING: Removing unreachable block (ram,0x0638cac8) */
/* WARNING: Removing unreachable block (ram,0x0638c8b4) */
/* WARNING: Removing unreachable block (ram,0x0638c8dc) */
/* WARNING: Removing unreachable block (ram,0x0638c920) */
...

{
  ...
  puVar1 = PTR_DAT_077e76c8;
  if ((bRam0000000007e25514 & 1) == 0) {
    func_0x03280a18(PTR_DAT_077e76d0);
    func_0x03280a18(PTR_DAT_077e76d8);
    func_0x03280a18(PTR_DAT_077e7650);
    func_0x03280a18(PTR_DAT_077e76e0);
    func_0x03280a18(PTR_DAT_077e76c8);
    bRam0000000007e25514 = 1;
  }
