/* Ghidra 12.1.2 bounded pseudocode; RVA 0x665E83C; bound 436 bytes; MergeEngine.ECS.Systems.Board.BoardInteractionSystem.ResetInteractionAnimation; status ok */
    ...
    if (*(long *)(param_1 + 0xd8) != 0) {
      ...
      while( true ) {
        ...
        if (uVar8 != 0) {
          ...
          do {
            if (*(long *)(piVar18 + -2) == *(long *)puVar11) {
...
LAB_0675e944:
    ...
    if (auVar32._8_4_ == 1) {
      plVar20 = (long *)func_0x072ce910(uVar12);
      lVar13 = *plVar20;
      func_0x072ce920();
    ...
    *(undefined8 *)((long)register0x00000008 + -0x58) = uVar12;
    ...
    param_4 = 1;
    param_3 = plVar20;
    MergeEngine_ECS_Systems_Board_BoardInteractionSystem__MoveItem(param_1,plVar20);
    if ((*(long *)(param_1 + 0x60) == 0) ||
    ...
    *(undefined1 *)(lVar13 + 0x67) = 0;
    ...
    MergeEngine_ECS_Systems_Board_BoardInteractionSystem__ResetGuess(param_1);
  ...
  *(undefined **)((long)register0x00000008 + -0x80) = &UNK_0675eaa4;
  ...
  if (lVar13 == 0) {
    ...
    puVar29 = *(undefined **)((long)register0x00000008 + -0x80);
  }
  ...
  *(ulong *)(puVar6 + -8) = param_1;
  ...
  if (*(long *)(uVar8 + 0x88) != 0) {
    puVar29 = (undefined *)func_0x06a02444(*(long *)(uVar8 + 0x88),uVar12,0);
    if (*(long *)(uVar8 + 0x88) != 0) {
      lVar10 = func_0x06a02444(*(long *)(uVar8 + 0x88),param_3,0);
...
code_r0x0675ebe4:
        puVar11 = (undefined *)(*(code *)*puVar9)(plVar20,puVar29,puVar9[1]);
...
code_r0x0675ec50:
          plVar20 = (long *)(*(code *)*puVar9)(unaff_x24,lVar10,puVar9[1]);
          unaff_x25 = puVar11;
          if (*(long *)(uVar8 + 0x88) != 0) {
            param_4 = 0;
            func_0x06a0249c(*(long *)(uVar8 + 0x88),param_3,puVar29);
            unaff_x24 = plVar20;
            if (*(long *)(uVar8 + 0x88) != 0) {
              param_4 = 0;
              func_0x06a0249c(*(long *)(uVar8 + 0x88),uVar12,lVar10);
...
code_r0x0675ecf8:
                param_4 = puVar9[1];
                (*(code *)*puVar9)(plVar27,uVar12,param_3);
...
code_r0x0675ed7c:
                  plVar27 = (long *)(*(code *)*puVar9)(param_3,unaff_x23,puVar11,param_4,0,puVar9[1]
                                                      );
                  puVar11 = PTR_DAT_077e71c8;
...
code_r0x0675ee0c:
                      lVar10 = puVar9[1];
                      uVar16 = 0;
                      uVar12 = (*(code *)*puVar9)(plVar22,unaff_x23,plVar20,param_4,0);
                      ...
                      lVar13 = func_0x03280ca0(*(undefined8 *)puVar11);
                      func_0x04143c38(lVar13,*(undefined8 *)puVar29);
  ...
  *(undefined8 *)(puVar6 + -0x58) = *(undefined8 *)(puVar6 + -0x58);
  ...
  if (plVar20 != (long *)0x0) {
    ...
    puVar9 = (undefined8 *)func_0x03256b10(plVar20,*(long *)PTR_DAT_0777a498,0x14);
code_r0x0676ad7c:
    uVar12 = (*(code *)*puVar9)(plVar20,param_4,puVar9[1]);
...
code_r0x0676ae10:
      lVar10 = puVar9[1];
      uVar16 = 0;
      uVar12 = (*(code *)*puVar9)(plVar20,uVar24,uVar12,param_4,0);
              ...
              if (lVar15 != 0) {
                ...
                if (plVar20 != (long *)0x0) {
                  ...
                  if (uVar8 != 0) {
                    piVar18 = (int *)(*(long *)(lVar13 + 0xb0) + 8);
                    do {
                      if (*(long *)(piVar18 + -2) == *(long *)(lVar10 + 0x20)) {
                        lVar13 = lVar13 + (long)(int)(*piVar18 + (uint)*(ushort *)(lVar10 + 0x50)) *
                                          0x10 + 0x138;
...
code_r0x03e40f1c:
                  ...
                  uVar8 = (**(code **)(lVar13 + 8))(plVar20,uVar12,auVar31._8_8_,lVar15,lVar13);
                  return uVar8;
                }
              }
              ...
              *(long *)(puVar7 + -0x68) = auVar31._8_8_;
              ...
              uVar12 = (*(code *)**(undefined8 **)(*(long *)(lVar10 + 0x38) + 0x10))
                                 (auVar30._8_8_,lVar13,**(undefined8 **)(lVar15 + 0xb8));
              uVar8 = func_0x03280ca0(*(undefined8 *)PTR_DAT_0777ab48);
              func_0x05a85e88(uVar8,auVar30._0_8_,lVar14,uVar16 & 0xffffffff,uVar12,0);
              return uVar8;
            }
            lVar10 = *plVar20;
            ...
            if (uVar8 != 0) {
              ...
              do {
                if (*(long *)(piVar18 + -2) == *(long *)(lVar14 + 0x20)) {
                  lVar10 = lVar10 + (long)(int)(*piVar18 + (uint)*(ushort *)(lVar14 + 0x50)) * 0x10
                           + 0x138;
...
code_r0x03e40dbc:
            lVar10 = func_0x03280b88(*(undefined8 *)(lVar10 + 8),lVar14);
                    ...
                    /* WARNING: Treating indirect jump as call */
            uVar8 = (**(code **)(lVar10 + 8))(plVar20,uVar12,lVar13,0,lVar10);
            return uVar8;
          }
        }
      }
