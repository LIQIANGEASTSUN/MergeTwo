/* Ghidra 12.1.2 bounded pseudocode; RVA 0x665BCA0; bound 1476 bytes; MergeEngine.ECS.Systems.Board.BoardInteractionSystem.BoardViewChanged; status ok */
...
void MergeEngine_ECS_Systems_Board_BoardInteractionSystem__BoardViewChanged
...

{
  ...
  puVar18 = PTR_DAT_077cc678;
  if (param_2 == 0) {
    *(undefined8 *)(param_1 + 0xd0) = 0;
LAB_0675bdc8:
    puVar9 = (undefined8 *)(param_1 + 0xd0);
  }
  else {
    uVar14 = *(undefined8 *)PTR_DAT_077cc678;
    lVar8 = func_0x03280b90(param_2,uVar14);
    if (lVar8 == 0) {
      func_0x03281048(param_2,uVar14);
    }
    else {
      *(long *)(param_1 + 0xd0) = lVar8;
      unaff_x22 = *(undefined8 *)puVar18;
      lVar8 = func_0x03280b90(param_2,unaff_x22);
      if (lVar8 != 0) goto LAB_0675bdc8;
    }
    lVar8 = func_0x03281048(param_2,unaff_x22);
    puVar5 = PTR_DAT_07807988;
    puVar17 = PTR_DAT_07807960;
    puStack_90 = &UNK_0675c264;
    ...
    plVar15 = *(long **)(lVar8 + 0xd0);
    uVar14 = func_0x03280ca0(*(undefined8 *)puVar17);
    func_0x0542d8c0(uVar14,lVar8,*(undefined8 *)puVar5,0);
    puVar4 = PTR_DAT_07807980;
      ...
      if (uVar12 != 0) {
        ...
        do {
          if (*(long *)(piVar13 + -2) == *(long *)PTR_DAT_077cc678) {
            ...
            goto code_r0x0675c3c4;
          }
          uVar12 = uVar12 - 1;
          piVar13 = piVar13 + 4;
        } while (uVar12 != 0);
      }
      puVar9 = (undefined8 *)func_0x03256b10(plVar15,*(long *)PTR_DAT_077cc678,1);
code_r0x0675c3c4:
      (*(code *)*puVar9)(plVar15,uVar14,puVar9[1]);
      plVar15 = *(long **)(lVar8 + 0xd0);
      uVar14 = func_0x03280ca0(*(undefined8 *)puVar6);
      func_0x0541dfd8(uVar14,lVar8,*(undefined8 *)puVar4,0);
        ...
        if (uVar12 != 0) {
          ...
          do {
            if (*(long *)(piVar13 + -2) == *(long *)puVar5) {
              ...
              goto code_r0x0675c458;
            }
            uVar12 = uVar12 - 1;
            piVar13 = piVar13 + 4;
          } while (uVar12 != 0);
        }
        puVar9 = (undefined8 *)func_0x03256b10(plVar15,*(long *)puVar5,3);
code_r0x0675c458:
        (*(code *)*puVar9)(plVar15,uVar14,puVar9[1]);
        plVar15 = *(long **)(lVar8 + 0xd0);
        uVar14 = func_0x03280ca0(*(undefined8 *)puVar4);
        func_0x05426724(uVar14,lVar8,*(undefined8 *)puVar7,0);
          ...
          if (uVar12 != 0) {
            ...
            do {
              if (*(long *)(piVar13 + -2) == *(long *)puVar5) {
                ...
                goto code_r0x0675c4ec;
              }
              uVar12 = uVar12 - 1;
              piVar13 = piVar13 + 4;
            } while (uVar12 != 0);
          }
          puVar9 = (undefined8 *)func_0x03256b10(plVar15,*(long *)puVar5,5);
code_r0x0675c4ec:
          (*(code *)*puVar9)(plVar15,uVar14,puVar9[1]);
          plVar15 = *(long **)(lVar8 + 0xd0);
          uVar14 = func_0x03280ca0(*(undefined8 *)puVar4);
          func_0x04059d3c(uVar14,lVar8,*(undefined8 *)puVar7,0);
            ...
            if (uVar12 != 0) {
              ...
              do {
                if (*(long *)(piVar13 + -2) == *(long *)puVar5) {
                  ...
                  goto code_r0x0675c580;
                }
                uVar12 = uVar12 - 1;
                piVar13 = piVar13 + 4;
              } while (uVar12 != 0);
            }
            puVar9 = (undefined8 *)func_0x03256b10(plVar15,*(long *)puVar5,7);
code_r0x0675c580:
            (*(code *)*puVar9)(plVar15,uVar14,puVar9[1]);
            plVar15 = *(long **)(lVar8 + 0xd0);
            uVar14 = func_0x03280ca0(*(undefined8 *)puVar4);
            func_0x056ed730(uVar14,lVar8,*(undefined8 *)puVar7,0);
              ...
              if (uVar12 != 0) {
                ...
                do {
                  if (*(long *)(piVar13 + -2) == *(long *)puVar5) {
                    ...
                    goto code_r0x0675c60c;
                  }
                  uVar12 = uVar12 - 1;
                  piVar13 = piVar13 + 4;
                } while (uVar12 != 0);
              }
              puVar9 = (undefined8 *)func_0x03256b10(plVar15,*(long *)puVar5,9);
code_r0x0675c60c:
              (*(code *)*puVar9)(plVar15,uVar14,puVar9[1]);
              plVar15 = (long *)func_0x0675b4d8(lVar8);
              uVar14 = func_0x03280ca0(*(undefined8 *)puVar6);
              func_0x0541dfd8(uVar14,lVar8,*(undefined8 *)puVar4,0);
              puVar18 = puVar4;
              if (plVar15 != (long *)0x0) {
                ...
                if (uVar12 != 0) {
                  ...
                  do {
                    if (*(long *)(piVar13 + -2) == *(long *)PTR_DAT_07807800) {
                      ...
                      goto code_r0x0675c6a4;
                    }
                    uVar12 = uVar12 - 1;
                    piVar13 = piVar13 + 4;
                  } while (uVar12 != 0);
                }
                puVar9 = (undefined8 *)func_0x03256b10(plVar15,*(long *)PTR_DAT_07807800,1);
code_r0x0675c6a4:
    ...
    puVar6 = PTR_DAT_07807910;
    puVar5 = PTR_DAT_078078f0;
    puStack_c0 = &UNK_0675c6c8;
    puStack_b8 = puVar18;
    puStack_b0 = puVar17;
    uStack_a8 = uVar14;
    uStack_a0 = 0;
    ...
    lVar8 = *(long *)(lVar11 + 0xa0);
    uVar14 = func_0x03280ca0(*(undefined8 *)puVar5);
    func_0x054221d4(uVar14,lVar11,*(undefined8 *)puVar6,0);
    puVar18 = PTR_DAT_0774e758;
    puStack_d0 = (undefined *)lVar8;
    lStack_c8 = lVar11;
    if (lVar8 != 0) {
      lVar11 = *(long *)PTR_DAT_078079b0;
      puStack_e0 = &UNK_0675c7b4;
      ...
      uStack_e8 = 0;
      func_0x072a6c4c(&puStack_f0,uVar16,0,0,1,0);
      func_0x07286e40(lVar8,puStack_f0,uStack_e8,uVar14,1);
      return;
    }
    lVar11 = func_0x03280cac();
    puStack_d0 = &UNK_0675c84c;
