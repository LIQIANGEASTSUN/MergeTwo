/* Ghidra 12.1.2 bounded pseudocode; RVA 0x665DAC4; bound 504 bytes; MergeEngine.ECS.Systems.Board.BoardInteractionSystem.BoardItemDragStarted; status ok */
...
/* WARNING: Removing unreachable block (ram,0x0675da6c) */
