/* Ghidra 12.1.2 bounded pseudocode; RVA 0x6A636D8; bound 372 bytes; Merger.MergeBoardSkipCooldownCapability.Logic.SkipCooldownProvider.CalculatePriceWithCoefficents; status ok */
