/* Ghidra 12.1.2 native pseudocode; RVA 0x6A1D9C4; MergeEngine.Configuration.Orders.Difficulty.MergeItemUtils.IsSplitterItem; status ok */


ulong MergeEngine_Configuration_Orders_Difficulty_MergeItemUtils__IsSplitterItem(long *param_1)

{
  ...
  if (param_1 != (long *)0x0) {
    ...
    puVar4 = (undefined8 *)func_0x03256b10(param_1,*(long *)PTR_DAT_0777e548,0x10);
LAB_06b1da4c:
    ...
    if (lVar9 != 0) {
      if (*(char *)(lVar9 + 0x10) == '\0') {
        ...
        puVar4 = (undefined8 *)func_0x03256b10(param_1,*(long *)puVar1,7);
LAB_06b1dabc:
        lVar9 = (*(code *)*puVar4)(param_1,puVar4[1]);
...
LAB_06b1dc54:
  ...
  if (plVar5 != (long *)0x0) {
    ...
    uStack_64 = *(undefined4 *)(lVar9 + 0x18);
    uVar8 = func_0x03280b94(*(undefined8 *)puVar1,&uStack_64);
