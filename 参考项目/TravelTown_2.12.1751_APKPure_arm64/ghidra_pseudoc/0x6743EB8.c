/* Ghidra 12.1.2 native pseudocode; RVA 0x6743EB8; Merger.Game.Views.Board.BoardQueueView2.LateUpdate; status ok */
...
undefined1  [16]
Merger_Game_Views_Board_BoardQueueView2__LateUpdate(long param_1,undefined8 param_2)

{
  ...
  if ((bRam0000000007e28a78 & 1) == 0) {
    auVar41 = func_0x03280a18(PTR_DAT_07772cf0);
  ...
  lVar17 = func_0x06842f08(param_1);
  ...
  if ((**(long **)(lVar18 + 0xb8) == 0) ||
    ...
    auVar42._8_8_ = 1;
    auVar42._0_8_ = plVar19;
    uVar35 = 0x7247728;
    plVar28 = plVar19;
  }
  puVar20 = auVar42._0_8_;
  ...
  if ((bRam0000000007e3393b & 1) == 0) {
    ...
    auVar42 = func_0x03280a18(PTR_DAT_0785cc08);
        ...
        if (lVar26 != 0) {
          ...
          do {
            ...
            *(long *)(puVar9 + -8) = lVar17;
            ...
            auVar41 = func_0x06fe04ec(plVar32,0,0);
...
LAB_072480b8:
              ...
              *(undefined1 (*) [16])(puVar9 + -0xb0) = auVar41;
              ...
              auVar41 = func_0x06fe04ec(uVar29,0,0);
              ...
              if ((**(long **)(lVar17 + 0xb8) != 0) &&
                ...
                auVar41 = func_0x070d7e10(unaff_x22,0);
                if ((auVar41._0_8_ & 1) != 0) {
                  return auVar41;
                }
                lVar17 = *(long *)puVar20;
...
LAB_07248200:
  do {
    ...
    auVar41 = func_0x06fdeb74(plVar28,0,0);
    uVar29 = auVar41._8_8_;
    if (((auVar41._0_8_ & 1) != 0) && (plVar28 != (long *)0x0)) {
      bVar1 = *(byte *)(*(long *)puVar20 + 0x130);
      if ((bVar1 <= *(byte *)(*plVar28 + 0x130)) &&
         (*(long *)(*(long *)(*plVar28 + 200) + (ulong)bVar1 * 8 + -8) == *(long *)puVar20)) {
        auVar41 = func_0x06fdb3e4(plVar28,0);
        uVar29 = auVar41._8_8_;
        if ((auVar41._0_8_ & 1) != 0) {
          uVar35 = 1;
          goto LAB_07248290;
...
LAB_04145ae0:
  ...
  *(long **)(puVar10 + -0xa8) = plVar19;
  auVar41 = func_0x03f898d4(*(undefined8 *)(lVar17 + 0x10),auVar41._8_8_,0,
                            *(undefined4 *)(lVar17 + 0x18),
                            *(undefined8 *)
                             (*(long *)(*(long *)(*(long *)(*(long *)(plVar28[4] + 0xc0) + 0xd0) +
                                                 0x20) + 0xc0) + 0x158));
  uVar35 = auVar41._8_8_;
  if (-1 < (int)auVar41._0_4_) {
    func_0x04145da4(lVar17,auVar41._0_8_ & 0xffffffff);
    uVar35 = extraout_x1_01;
  }
  auVar38._4_4_ = 0;
  auVar38._0_4_ = ~auVar41._0_4_ >> 0x1f;
...
LAB_044222c4:
  ...
  *(undefined8 *)(puVar10 + -8) = uVar31;
  ...
  auVar39._0_8_ = *(long *)(lVar17 + 0x10);
  if (auVar39._0_8_ == 0) {
LAB_044223b4:
    uVar35 = 0x44223b8;
...
LAB_044223b8:
    ...
    *(undefined8 *)(puVar9 + -0x40) = 0;
    ...
    do {
      ...
      lVar26 = lVar17;
      do {
        auVar44 = func_0x03280ca4(lVar18);
        puVar30 = auVar44._0_8_;
        if (auVar44._8_4_ != 1) {
          lVar18 = 0;
          ...
          uVar35 = 0x4422528;
          auVar41 = func_0x02f09514();
          auVar40._8_8_ = *(undefined8 *)(*(long *)(*(long *)(auVar41._8_8_ + 0x20) + 0xc0) + 0xd8);
        ...
        iVar11 = 0;
LAB_0442244c:
        auVar40 = func_0x051159b0(puVar9 + -0x50,
                                  *(undefined8 *)(*(long *)(*(long *)(lVar26 + 0x20) + 0xc0) + 200))
        ;
      } while (lVar18 != 0);
      lVar17 = lVar26;
...
LAB_04422470:
      ...
      if (lVar26 != 0) {
        ...
        *(int *)(lVar26 + 0x1c) = *(int *)(lVar26 + 0x1c) + 1;
        if (0 < iVar11) {
          auVar40 = func_0x057b9c7c(*(undefined8 *)(lVar26 + 0x10),0,iVar11,0);
        }
  ...
  *(int *)(auVar39._0_8_ + 0x1c) = *(int *)(auVar39._0_8_ + 0x1c) + 1;
  if (lVar26 == 0) goto LAB_044223b4;
  if (uVar4 < *(uint *)(lVar26 + 0x18)) {
    *(uint *)(auVar39._0_8_ + 0x18) = uVar4 + 1;
  ...
  *(undefined8 *)(puVar10 + -8) = *(undefined8 *)(puVar10 + -8);
  uVar3 = *(uint *)(auVar39._0_8_ + 0x18);
  uVar4 = uVar3 + 1;
  lVar17 = *(long *)(*(long *)(*(long *)(lVar17 + 0x20) + 0xc0) + 0x78);
  func_0x04144aa0(auVar39._0_8_,(ulong)uVar4);
  lVar18 = *(long *)(auVar39._0_8_ + 0x10);
  *(uint *)(auVar39._0_8_ + 0x18) = uVar4;
  if (lVar18 == 0) {
    func_0x03280cac();
  }
  ...
  *(long *)(puVar10 + -0x40) = auVar39._0_8_;
...
LAB_041445ac:
    auVar37._4_4_ = 0;
    auVar37._0_4_ = *(int *)(lVar18 + 0x18) - 1;
    auVar37._8_8_ = uVar35;
    return auVar37;
  }
  auVar44 = func_0x03280cac();
  uVar35 = auVar44._0_8_;
  if (auVar44._8_4_ == 1) {
...
LAB_04145868:
        ...
        if (plVar32 != (long *)0x0) {
          do {
            ...
            puVar12 = (undefined8 *)func_0x03256b10(plVar32);
LAB_041458d0:
            auVar41 = (*(code *)*puVar12)(plVar32,puVar12[1]);
            if ((auVar41._0_8_ & 1) == 0) {
              uVar13 = 0;
              iVar11 = 5;
...
LAB_04145948:
      ...
      func_0x03280cac();
      do {
        auVar44 = func_0x03280ca4(uVar13);
        if (auVar44._8_4_ != 1) {
        ...
        puVar16 = (ulong *)func_0x072ce910(auVar44._0_8_);
        uVar13 = *puVar16;
        auVar41 = func_0x072ce920();
        iVar11 = 0;
        if (plVar32 != (long *)0x0) {
LAB_04145988:
          lVar17 = *plVar32;
...
LAB_041459e8:
    ...
    auVar41 = func_0x041462cc(plVar19,plVar21,
...
LAB_04145728:
    auVar41 = (*(code *)*puVar12)(plVar15,puVar12[1]);
    iVar11 = auVar41._0_4_;
    if (0 < iVar11) {
      ...
      if (plVar19 == plVar15) {
        ...
        auVar41 = func_0x057b9f30(plVar19[2],iVar11 + uVar4,plVar19[2],uVar4 << 1,
...
LAB_04145838:
        auVar41 = (*(code *)*puVar12)(plVar15,lVar18,uVar4,puVar12[1]);
      }
