/* Ghidra 12.1.2 native pseudocode; RVA 0x67CB20C; Merger.Services.Backend.Sync.Implementations.SyncBoardService.GetFreeBubbleBurstRemains; status ok */


undefined4
Merger_Services_Backend_Sync_Implementations_SyncBoardService__GetFreeBubbleBurstRemains
...

{
  ...
  if (param_2 != 0) {
    Merger_Services_Backend_Sync_Implementations_SyncBoardService__GetEventFreeBubbleBurst();
    return 0;
  }
