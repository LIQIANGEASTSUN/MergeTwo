/* Ghidra 12.1.2 native pseudocode; RVA 0x6A1D910; MergeEngine.Configuration.Orders.Difficulty.MergeItemUtils.IsJokerItem; status ok */


ulong MergeEngine_Configuration_Orders_Difficulty_MergeItemUtils__IsJokerItem(long *param_1)

{
  ...
  if (param_1 != (long *)0x0) {
    ...
    puVar4 = (undefined8 *)func_0x03256b10(param_1,*(long *)PTR_DAT_0777e548,7);
LAB_06b1d998:
...
LAB_06b1dc54:
  ...
  if (plVar5 != (long *)0x0) {
    ...
    uStack_84 = *(undefined4 *)(lVar9 + 0x18);
    uVar8 = func_0x03280b94(*(undefined8 *)puVar1,&uStack_84);
