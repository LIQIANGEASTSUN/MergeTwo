/* Ghidra 12.1.2 native pseudocode; RVA 0x6281150; MergeEngine.ECS.Systems.InventorySystem.GetItemCountInInventory; status ok */
...
undefined8 *
MergeEngine_ECS_Systems_InventorySystem__GetItemCountInInventory(ulong param_1,long param_2)

{
  ...
  puVar4 = PTR_DAT_077e6f90;
  puVar3 = PTR_DAT_077e6f88;
  puVar19 = PTR_DAT_0777a920;
  uStack_48 = 0;
  uStack_40 = 0;
  lStack_38 = 0;
  if ((*(long *)(param_1 + 0x40) == 0) ||
     (lVar8 = *(long *)(*(long *)(param_1 + 0x40) + 0x28), lVar8 == 0)) {
    func_0x03280cac();
  }
  else {
    func_0x04145068(&uStack_48,lVar8,*(undefined8 *)PTR_DAT_077e6fa0);
    param_1 = 0;
    do {
      uVar9 = func_0x051159b4(&uStack_48,*(undefined8 *)puVar4);
      if ((uVar9 & 1) == 0) {
        func_0x051159b0(&uStack_48,*(undefined8 *)puVar3);
        goto LAB_0638124c;
      }
    } while (lStack_38 == 0);
    lVar8 = func_0x03d20d84(lStack_38,*(undefined8 *)puVar19);
    unaff_x22 = puVar4;
    unaff_x23 = puVar19;
    if (lVar8 != 0) {
      ...
      if (lVar8 == param_2) {
        ...
        uVar16 = 0;
        if ((lVar8 != 0) && (param_2 != 0)) {
          if (*(int *)(lVar8 + 0x10) == *(int *)(param_2 + 0x10)) {
            lVar13 = lVar8 + 0x14;
            param_2 = param_2 + 0x14;
            lVar8 = (long)*(int *)(lVar8 + 0x10) << 1;
            uStack_90 = 0x6381234;
            if (lVar13 != param_2) {
              lVar6 = func_0x057e39f8(0,0,lVar8,0);
              uVar11 = func_0x057e3a04(lVar8,0);
              uVar9 = func_0x057e3a10(uVar11,0);
              if (7 < uVar9) {
                lVar8 = func_0x057e3a24(uVar11,8,0);
                while( true ) {
                  uVar9 = func_0x057e3a10(lVar8,0);
                  uVar7 = func_0x057e3a10(lVar6,0);
                  if (uVar9 <= uVar7) {
                    return (undefined8 *)
                           (ulong)(*(long *)(lVar13 + lVar8) == *(long *)(param_2 + lVar8));
                  }
                  uVar9 = func_0x057f2854(*(undefined8 *)(lVar13 + lVar6),
              ...
              if (uVar7 < uVar9) {
                do {
                  bVar5 = *(char *)(lVar13 + lVar6) == *(char *)(param_2 + lVar6);
                  puVar12 = (undefined8 *)(ulong)bVar5;
                  if (!bVar5) {
                    return puVar12;
                  }
      ...
      return (undefined8 *)(ulong)uVar16;
    }
  }
  auVar21 = func_0x03280cac();
  if (auVar21._8_4_ == 1) {
    plVar10 = (long *)func_0x072ce910(auVar21._0_8_);
    lVar8 = *plVar10;
    func_0x072ce920();
    func_0x051159b0(&uStack_48,*(undefined8 *)PTR_DAT_077e6f88);
    if (lVar8 == 0) {
LAB_0638124c:
      return (undefined8 *)(param_1 & 0xffffffff);
    }
  ...
  puVar19 = PTR_DAT_07780378;
  if (*(long *)(lVar8 + 0x58) != 0) {
    func_0x0729fe1c(*(long *)(lVar8 + 0x58),*(undefined8 *)(lVar8 + 0x108),0);
    uVar11 = func_0x03eb68fc(lVar8,*(undefined8 *)puVar19);
  ...
  puVar3 = PTR_DAT_077e6fb8;
  puVar19 = PTR_DAT_077e6fb0;
  uStack_c0 = 0x638176c;
  uStack_a8 = 0;
  uStack_a0 = 0x7e25000;
  ...
  lVar8 = func_0x03280ca0(*(undefined8 *)puVar19);
  func_0x054221d4(lVar8,lVar13,*(undefined8 *)puVar3,0);
  puVar3 = PTR_DAT_0774e758;
  if (lVar6 != 0) {
    lVar15 = *(long *)PTR_DAT_077e7020;
    puStack_e0 = (undefined *)0x63818c4;
    ...
    uStack_f0 = puStack_e0;
    puStack_e0 = puVar3;
    puVar12 = *(undefined8 **)(lVar13 + 0x38);
    ...
    puStack_e0 = (undefined *)uStack_f0;
    uStack_f0 = 0;
    uStack_e8 = 0;
    func_0x072a6c4c(&uStack_f0,uVar11,0,0,1,0);
    puVar12 = (undefined8 *)func_0x07286e40(lVar6,uStack_f0,uStack_e8,lVar8,1);
    return puVar12;
  }
  uVar20 = 0x6381b10;
  ...
  puVar12 = &uStack_c0;
  do {
    *(undefined8 *)((long)puVar12 + -0x30) = uVar20;
    *(undefined **)((long)puVar12 + -0x20) = puVar19;
    *(long *)((long)puVar12 + -0x18) = lVar8;
    *(undefined8 *)((long)puVar12 + -0x10) = uVar11;
    *(long *)((long)puVar12 + -8) = lVar13;
    ...
    if (plVar10 != (long *)0x0) {
      lVar15 = *plVar10;
      lVar8 = *(long *)PTR_DAT_07772080;
      puVar19 = *(undefined **)(lVar6 + 0x48);
      lVar13 = *(long *)PTR_DAT_077e7028;
      uVar9 = (ulong)*(ushort *)(lVar15 + 0x12e);
      if (uVar9 != 0) {
        piVar18 = (int *)(*(long *)(lVar15 + 0xb0) + 8);
        do {
          if (*(long *)(piVar18 + -2) == *(long *)(lVar8 + 0x20)) {
            lVar6 = lVar15 + (long)(int)(*piVar18 + (uint)*(ushort *)(lVar8 + 0x50)) * 0x10 + 0x138;
            goto LAB_06381bc0;
          }
          uVar9 = uVar9 - 1;
          piVar18 = piVar18 + 4;
...
LAB_06381bc0:
      ...
      puVar14 = (undefined8 *)(**(code **)(lVar6 + 8))(plVar10,lVar13,1,lVar6);
      if (puVar19 != (undefined *)0x0) {
        puVar19[0x28] = (byte)puVar14 & 1;
        return puVar14;
      }
    }
    lVar6 = func_0x03280cac();
    *(undefined8 *)((long)puVar12 + -0x50) = 0x6381c04;
    *(long *)((long)puVar12 + -0x40) = lVar13;
    *(long **)((long)puVar12 + -0x38) = plVar10;
    uVar11 = 0x7e25000;
    ...
    func_0x064a7320(lVar6,0);
    uVar20 = 0x6381c50;
    puVar12 = (undefined8 *)((long)puVar12 + -0x50);
    lVar13 = lVar6;
  } while( true );
}
