/* Ghidra 12.1.2 native pseudocode; RVA 0x66246B0; Merger.Game.ViewModel.BoardViewModel.SubscribeToCurrentBoardTypeChanged; status ok */
...
long * Merger_Game_ViewModel_BoardViewModel__SubscribeToCurrentBoardTypeChanged
...

{
  ...
  if ((bRam0000000007e27dcd & 1) == 0) {
    func_0x03280a18(PTR_DAT_0777fac0);
    func_0x03280a18(PTR_DAT_077726c0);
    bRam0000000007e27dcd = 1;
  }
  plVar23 = *(long **)(param_1 + 0xf0);
  if (plVar23 != (long *)0x0) {
    lVar18 = *plVar23;
    ...
    if (uVar19 != 0) {
      ...
      do {
        if (*(long *)(piVar20 + -2) == *(long *)PTR_DAT_077726c0) {
          puVar9 = (undefined8 *)(lVar18 + (long)(*piVar20 + 5) * 0x10 + 0x138);
          goto LAB_0672474c;
        }
        uVar19 = uVar19 - 1;
        piVar20 = piVar20 + 4;
    ...
    puVar9 = (undefined8 *)func_0x03256b10(plVar23,*(long *)PTR_DAT_077726c0,5);
LAB_0672474c:
    lVar18 = (*(code *)*puVar9)(plVar23,puVar9[1]);
    if (lVar18 != 0) {
      lVar15 = *(long *)(*(long *)(*(long *)(*(long *)PTR_DAT_0777fac0 + 0x20) + 0xc0) + 0x28);
      func_0x04d0e8e0();
      if (param_2 != 0) {
                    /* WARNING: Could not recover jumptable at 0x04d0ec24. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        plVar23 = (long *)(**(code **)(param_2 + 0x18))
                                    (*(undefined8 *)(param_2 + 0x40),*(undefined4 *)(lVar18 + 0x20),
  ...
  auVar28 = func_0x03280cac();
  if ((bRam0000000007e27dce & 1) == 0) {
    func_0x03280a18(PTR_DAT_0777fac8);
    func_0x03280a18(PTR_DAT_077726c0);
    bRam0000000007e27dce = 1;
  }
  plVar23 = *(long **)(auVar28._0_8_ + 0xf0);
  if (plVar23 != (long *)0x0) {
    lVar18 = *plVar23;
    uVar19 = (ulong)*(ushort *)(lVar18 + 0x12e);
    if (uVar19 != 0) {
...
LAB_06724818:
    ...
    if (lVar18 != 0) {
      lVar15 = *(long *)PTR_DAT_0777fac8;
LAB_04d0e98c:
      uVar10 = auVar28._8_8_;
      lVar18 = *(long *)(*(long *)(*(long *)(lVar15 + 0x20) + 0xc0) + 0x30);
      plVar22 = (long *)(auVar28._0_8_ + 0x10);
      plVar23 = (long *)*plVar22;
      do {
        lVar15 = func_0x057ddd18(plVar23,uVar10,0);
        lVar24 = *(long *)(*(long *)(*(long *)(lVar18 + 0x20) + 0xc0) + 8);
        ...
        if (lVar15 == 0) {
          ...
          lVar7 = func_0x03280b90(lVar15,lVar24);
          if (lVar7 == 0) {
            auVar28 = func_0x03281048(lVar15,lVar24);
            uVar13 = auVar28._8_8_;
            lStack_90 = 0x4d0ea38;
            plStack_80 = plVar23;
            uStack_78 = uVar10;
            ...
            plVar22 = (long *)(auVar28._0_8_ + 0x18);
            plVar23 = (long *)*plVar22;
            while ((plVar8 = (long *)func_0x057ddb20(plVar23,uVar13,0), plVar8 == (long *)0x0 ||
                   (*plVar8 == *(long *)puVar25))) {
              plVar8 = (long *)func_0x032dd140(plVar22,plVar8,plVar23);
              bVar4 = plVar23 == plVar8;
              plVar23 = plVar8;
              if (bVar4) {
                return plVar8;
              }
            }
            auVar28 = func_0x03281048(plVar8);
            uStack_c0 = 0x4d0ead4;
            puStack_b0 = puVar25;
            plStack_a8 = plVar23;
            plStack_a0 = plVar22;
            ...
            plVar22 = (long *)(auVar28._0_8_ + 0x18);
            plVar23 = (long *)*plVar22;
            while ((plVar8 = (long *)func_0x057ddd18(plVar23,auVar28._8_8_,0), plVar8 == (long *)0x0
                   || (*plVar8 == *(long *)puVar25))) {
              plVar8 = (long *)func_0x032dd140(plVar22,plVar8,plVar23);
              bVar4 = plVar23 == plVar8;
              plVar23 = plVar8;
            ...
            lVar18 = func_0x03281048(plVar8);
            return (long *)(ulong)*(uint *)(lVar18 + 0x20);
          }
        }
        plVar8 = (long *)func_0x032dd140(plVar22,lVar7,plVar23);
        bVar4 = plVar23 != plVar8;
        plVar23 = plVar8;
      } while (bVar4);
      return plVar8;
  ...
  puVar21 = PTR_DAT_078067f0;
  puVar25 = PTR_DAT_0774e758;
  if ((bRam0000000007e27dcf & 1) == 0) {
    func_0x03280a18(PTR_DAT_078067f8);
    func_0x03280a18(PTR_DAT_0774e758);
    func_0x03280a18(PTR_DAT_07806800);
    func_0x03280a18(PTR_DAT_078067f0);
    func_0x03280a18(PTR_DAT_07806808);
    func_0x03280a18(PTR_DAT_07806810);
    bRam0000000007e27dcf = 1;
  }
  lVar15 = *(long *)(lVar18 + 0x20);
  uVar10 = func_0x03280ca0(*(undefined8 *)puVar25);
  func_0x056ed730(uVar10,lVar18,*(undefined8 *)puVar21,0);
  puVar21 = PTR_DAT_07806800;
  puVar25 = PTR_DAT_078067f8;
  if (lVar15 == 0) {
LAB_06724958:
    ...
    if (lVar18 != 0) {
                    ...
                    /* WARNING: Treating indirect jump as call */
      plVar23 = (long *)(**(code **)(lVar18 + 0x18))
                                  (*(undefined8 *)(lVar18 + 0x40),*(undefined8 *)(lVar18 + 0x28));
      return plVar23;
    }
    return plVar23;
  }
  func_0x03ea5348(lVar15,uVar10,*(undefined8 *)PTR_DAT_07806808);
  lVar24 = *(long *)(lVar18 + 0x20);
  lVar15 = func_0x03280ca0(*(undefined8 *)puVar25);
  func_0x054221d4(lVar15,lVar18,*(undefined8 *)puVar21,0);
  if (lVar24 == 0) goto LAB_06724958;
  lVar18 = *(long *)PTR_DAT_07806810;
  lVar7 = *(long *)(lVar18 + 0x38);
  if (lVar7 == 0) {
    func_0x03256878(lVar18);
    lVar7 = *(long *)(lVar18 + 0x38);
  }
  lVar16 = *(long *)(lVar7 + 8);
  plVar23 = *(long **)(lVar16 + 0x38);
  lVar18 = lVar15;
  lVar7 = lVar16;
  plStack_80 = (long *)0x6724848;
  if (plVar23 == (long *)0x0) {
  ...
  func_0x04053df4(lVar6,*(undefined8 *)(*(long *)(lVar16 + 0x38) + 8));
  if (lVar6 != 0) {
    plVar23 = (long *)(lVar6 + 0x10);
    *plVar23 = lVar15;
    goto SUB_032809c4;
  }
  auVar28 = func_0x03280cac();
  uStack_c0 = 0x3ea5530;
  uStack_88 = 0;
  plVar23 = *(long **)(lVar7 + 0x38);
  lVar14 = lVar18;
  lVar17 = lVar7;
  puStack_b0 = (undefined *)lVar6;
  plStack_a0 = (long *)lVar15;
  lStack_98 = lVar16;
  lStack_90 = lVar24;
  if (plVar23 == (long *)0x0) {
    func_0x03280a18(PTR_DAT_07750ac8);
  ...
  func_0x0404e308(lVar15,*(undefined8 *)(*(long *)(lVar7 + 0x38) + 8));
  if (lVar15 != 0) {
  ...
  if (lVar18 != 0) {
    plVar23 = (long *)(lVar18 + 0x10);
    *plVar23 = lVar14;
    goto SUB_032809c4;
  }
  auVar28 = func_0x03280cac();
  uStack_140 = 0x3ea575c;
  plVar23 = *(long **)(lVar16 + 0x38);
  lStack_130 = lVar18;
  lStack_120 = lVar14;
  lStack_118 = lVar17;
  ...
  if (*(long *)(lVar18 + 0x38) == 0) {
    ...
    if (*(long *)(lVar18 + 0x38) == 0) {
      plVar22 = (long *)func_0x03256878(lVar18);
    }
  }
  ...
  lVar15 = func_0x072869d0(plVar23,uVar10,0,0,0);
  if (lVar15 == 0) {
    return (long *)0x0;
  }
  uVar10 = **(undefined8 **)(lVar18 + 0x38);
...
LAB_03ea5b18:
    ...
    lVar7 = func_0x03280b90(lVar24,lVar18);
    if (lVar7 == 0) {
  ...
  if (lVar7 != 0) {
    uVar10 = func_0x057dadc4(lVar7,0);
    puVar21 = *(undefined **)(lVar15 + 0x20);
    if (*(int *)(*(long *)puVar25 + 0xe0) == 0) {
      func_0x03280b8c(*(long *)puVar25);
    }
    uVar5 = func_0x0727e0ec(uVar10,puVar21);
    plVar23 = (long *)(ulong)(uVar5 & 1);
    uVar10 = 0x728539c;
    goto SUB_0727dc78;
  }
  func_0x03280cac();
  ...
  while( true ) {
    ...
    plVar23 = (long *)func_0x072ce910(auVar29._0_8_);
    lVar15 = *plVar23;
    func_0x072ce920();
    ...
    if (uVar19 != 0) {
      ...
      do {
        if (*(long *)(piVar20 + -2) == *(long *)PTR_DAT_0774e8c8) {
          puVar9 = (undefined8 *)(lRam0000000007e34000 + (long)*piVar20 * 0x10 + 0x138);
          goto LAB_072854e8;
        }
        uVar19 = uVar19 - 1;
        piVar20 = piVar20 + 4;
...
LAB_072854e8:
    plVar23 = (long *)(*(code *)*puVar9)(0x7e34000,puVar9[1]);
    if (lVar15 == 0) {
      return plVar23;
    }
  }
...
LAB_072855b0:
  ...
  lVar24 = auVar28._0_8_;
  uStack_1b0 = 0x72855d4;
  plVar22 = (long *)0x7e34000;
  ...
  plVar23 = (long *)func_0x03e0c264(lVar16,*(undefined8 *)puVar25);
  puVar11 = PTR_DAT_0785df00;
  puVar21 = PTR_DAT_0785ded8;
...
LAB_07285770:
    if (lVar16 != 0) {
      if (0 < *(int *)(lVar16 + 0x18)) {
        plVar22 = (long *)0x0;
        do {
          puVar12 = (undefined *)func_0x0414419c(lVar16,plVar22,*(undefined8 *)puVar21);
          puVar26 = puVar21;
          if (*(long *)(lVar24 + 0x10) == 0) goto LAB_07285808;
          plVar23 = (long *)func_0x041447fc(*(long *)(lVar24 + 0x10),puVar12,*(undefined8 *)puVar11)
          ;
          puVar25 = puVar12;
          if (((ulong)plVar23 & 1) != 0) {
            if ((puVar12 == (undefined *)0x0) || (lVar15 = *(long *)(puVar12 + 0x18), lVar15 == 0))
            goto LAB_07285808;
            plVar23 = (long *)(**(code **)(lVar15 + 0x18))
                                        (*(undefined8 *)(lVar15 + 0x40),lVar18,
                                         *(undefined8 *)(lVar15 + 0x28));
          }
          uVar5 = (int)plVar22 + 1;
          plVar22 = (long *)(ulong)uVar5;
        } while ((int)uVar5 < *(int *)(lVar16 + 0x18));
      }
      return plVar23;
    }
LAB_07285808:
...
LAB_0728580c:
    ...
    if (*(int *)(lVar24 + 0x30) != 2) {
      ...
      lVar16 = func_0x03280afc(uVar10,1);
      func_0x02f0b18c(lVar18);
      uVar10 = func_0x057dadc4(lVar18,0);
      func_0x02f0b18c(lVar16);
      func_0x02f176b4(lVar16,uVar10);
      func_0x02f0965c(lVar16,0,uVar10);
      uVar10 = func_0x03280a2c(PTR_DAT_0785df08);
      lVar18 = func_0x0727df38(uVar10,lVar16);
      uVar10 = func_0x03280a2c(PTR_DAT_0785df10);
      func_0x03280b7c(lVar18,uVar10);
    }
    plVar23 = (long *)func_0x03280afc(*(undefined8 *)PTR_DAT_0774e5a0,1);
    if (lVar18 == 0) goto LAB_07285808;
    puVar11 = (undefined *)func_0x057dadc4(lVar18,0);
    plVar22 = plVar23;
    if (plVar23 == (long *)0x0) goto LAB_07285808;
...
SUB_032809c4:
    ...
    lVar15 = func_0x03280b90(puVar11,*(undefined8 *)(*plVar23 + 0x40));
    if (lVar15 != 0) goto LAB_07285744;
  }
  uVar10 = func_0x03280cd0();
  auVar28 = func_0x03280b7c(uVar10,0);
  uStack_1c0 = 0x728581c;
  lVar15 = *(long *)(auVar28._0_8_ + 0x18);
  if (lVar15 != 0) {
                    /* WARNING: Could not recover jumptable at 0x07285838. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    plVar23 = (long *)(**(code **)(lVar15 + 0x18))
                                (*(undefined8 *)(lVar15 + 0x40),auVar28._8_8_,
                                 *(undefined8 *)(lVar15 + 0x28));
    return plVar23;
  }
  ...
  plVar23 = (long *)(ulong)*(byte *)(lVar7 + 0x34);
  uVar10 = 0x72858f0;
SUB_0727dc78:
  if (((ulong)plVar23 & 1) != 0) {
    return plVar23;
  }
  *(undefined8 *)((long)puVar3 + -0x10) = uVar10;
  *(undefined **)((long)puVar3 + -8) = puVar21;
  uVar10 = func_0x03280a2c(PTR_DAT_0785dbe8);
  puVar25 = PTR_DAT_0777c990;
  *(undefined8 *)((long)puVar3 + -0x30) = 0x727dc94;
  *(long *)((long)puVar3 + -0x28) = lVar15;
  *(long *)((long)puVar3 + -0x20) = lVar7;
  *(undefined **)((long)puVar3 + -0x18) = puVar21;
  ...
  func_0x072c77f8(plVar23,uVar10,0);
  return plVar23;
}
