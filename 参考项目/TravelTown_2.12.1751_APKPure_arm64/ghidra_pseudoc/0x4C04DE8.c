/* Ghidra 12.1.2 native pseudocode; RVA 0x4C04DE8; MergeEngine.ECS.Systems.Items.BaseToolAnalysisSystem<T>.GenerateRandomToolFromWeights; status ok */
...

{
  ...
  if ((param_4 & 1) != 0) {
    param_2 = MergeEngine_ECS_Systems_Items_BaseToolAnalysisSystem_T___FilterToolLevelsByChainProgress
  ...
  lVar10 = func_0x03f372e4(param_2,lVar10,lVar11,*(undefined8 *)puVar1);
    ...
    if (0 < *(int *)(lVar10 + 0x18)) {
      ...
      do {
        ...
        if ((auVar21._0_8_ & 1) != 0) {
          fVar20 = (float)func_0x04d03610(uVar19);
...
LAB_04d05364:
  ...
  *(undefined8 *)(auVar22._0_8_ + 0x78) = uVar19;
  func_0x032809c4((undefined8 *)(auVar22._0_8_ + 0x78),uVar19);
  uVar19 = func_0x03280ca0(*(undefined8 *)puVar5);
  func_0x04f610a8(uVar19,*(undefined8 *)puVar6);
  *(undefined8 *)(auVar22._0_8_ + 0x80) = uVar19;
  func_0x032809c4((undefined8 *)(auVar22._0_8_ + 0x80),uVar19);
  uVar19 = func_0x03280ca0(*(undefined8 *)puVar2);
  func_0x04f2ad28(uVar19,*(undefined8 *)puVar1);
  *(undefined8 *)(auVar22._0_8_ + 0x88) = uVar19;
  func_0x032809c4((undefined8 *)(auVar22._0_8_ + 0x88),uVar19);
  uVar19 = func_0x03280ca0(*(undefined8 *)puVar7);
  func_0x06898a68(uVar19,0);
  *(undefined8 *)(auVar22._0_8_ + 0x90) = uVar19;
  func_0x032809c4((undefined8 *)(auVar22._0_8_ + 0x90),uVar19);
  auVar22._8_8_ = 0;
  return auVar22;
}
