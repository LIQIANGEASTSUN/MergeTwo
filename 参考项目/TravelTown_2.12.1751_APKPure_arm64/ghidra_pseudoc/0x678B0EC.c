/* Ghidra 12.1.2 native pseudocode; RVA 0x678B0EC; MergeEngine.ECS.Systems.Items.CollectSystem.OnWillProcessComponents; status ok */


long MergeEngine_ECS_Systems_Items_CollectSystem__OnWillProcessComponents
...

{
  ...
  puVar10 = PTR_DAT_07810300;
  if ((bRam0000000007e28d40 & 1) == 0) {
    func_0x03280a18(PTR_DAT_07810308);
    func_0x03280a18(PTR_DAT_07810310);
    func_0x03280a18(PTR_DAT_077cd7d0);
    func_0x03280a18(PTR_DAT_07810318);
    func_0x03280a18(PTR_DAT_07810300);
    bRam0000000007e28d40 = 1;
  }
  lVar11 = *(long *)puVar10;
  ...
  puVar3 = PTR_DAT_07810310;
  puVar2 = PTR_DAT_07810308;
  ...
  if (lVar16 == 0) {
    ...
    lVar16 = func_0x03280ca0(*(undefined8 *)PTR_DAT_077cd7d0);
    param_4 = 0;
    func_0x05355fbc(lVar16,uVar17,*(undefined8 *)PTR_DAT_07810318);
