/* Ghidra 12.1.2 native pseudocode; RVA 0x6A9B490; Merger.MergeBoard.Controller.BoardController.MoveItem; status ok */
...
void Merger_MergeBoard_Controller_BoardController__MoveItem(void)
