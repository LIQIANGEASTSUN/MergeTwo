/* Ghidra 12.1.2 native pseudocode; RVA 0x6A32CA4; Merger.MergeBoard.ViewModel.MergeBoardViewModel.IsItemGateway; status ok */


undefined1  [16]
Merger_MergeBoard_ViewModel_MergeBoardViewModel__IsItemGateway(long param_1,undefined8 param_2)

{
  ...
  lVar3 = Merger_MergeBoard_ViewModel_MergeBoardViewModel__GetMergeItem(param_1,param_2);
  if (lVar3 == 0) {
LAB_06b32d20:
    lVar4 = 0;
  }
  ...
  if (plVar8 != (long *)0x0) {
    ...
    if (uVar6 != 0) {
      ...
      do {
        if (*(long *)(piVar7 + -2) == *(long *)PTR_DAT_0777a498) {
          puVar5 = (undefined8 *)(lVar3 + (long)(*piVar7 + 0x23) * 0x10 + 0x138);
          goto LAB_06b32d84;
        }
        uVar6 = uVar6 - 1;
        piVar7 = piVar7 + 4;
    ...
    puVar5 = (undefined8 *)func_0x03256b10(plVar8,*(long *)PTR_DAT_0777a498,0x23);
LAB_06b32d84:
  ...
  lVar3 = Merger_MergeBoard_ViewModel_MergeBoardViewModel__GetMergeItem(auVar10._0_8_,auVar10._8_8_)
  ;
  if (lVar3 != 0) {
    uVar9 = *(undefined8 *)PTR_DAT_0777e548;
    lVar4 = func_0x03280b90(lVar3,uVar9);
  ...
  lVar4 = 0;
LAB_06b32e24:
  plVar8 = *(long **)(auVar10._0_8_ + 0x88);
  if (plVar8 == (long *)0x0) {
