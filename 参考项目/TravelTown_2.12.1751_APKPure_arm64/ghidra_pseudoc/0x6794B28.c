/* Ghidra 12.1.2 native pseudocode; RVA 0x6794B28; MergeEngine.ECS.Systems.Items.TimeLimitedActivationSystem.EntityCreated; status ok */
...
undefined8 *
MergeEngine_ECS_Systems_Items_TimeLimitedActivationSystem__EntityCreated
...
LAB_068955e8:
    ...
    lVar8 = func_0x03ced81c(extraout_x1,*(undefined8 *)PTR_DAT_0777e638);
    if (lVar8 == 0) {
    ...
    if ((((*(char *)(lVar8 + 0x30) == '\0') && (*(char *)(lVar8 + 0x33) == '\0')) &&
       ...
       (((*(char *)(lVar8 + 0x31) == '\0' && (*(char *)(lVar8 + 0x78) == '\0')) &&
        (*(char *)(lVar8 + 0x79) == '\0')))) {
      return (undefined8 *)(ulong)(*(char *)(lVar8 + 0x32) != '\0');
    }
    return (undefined8 *)0x1;
  }
  lVar8 = func_0x03d20d84(param_2,*(undefined8 *)PTR_DAT_0777a950);
  if ((lVar8 == 0) ||
     (puVar9 = (undefined8 *)func_0x03d20d84(param_2,*(undefined8 *)puVar5),
     puVar9 == (undefined8 *)0x0)) {
    lVar8 = func_0x03d20d84(param_2,*(undefined8 *)PTR_DAT_0777a918);
    puVar9 = (undefined8 *)0x0;
    if ((lVar8 != 0) && (puVar9 = (undefined8 *)func_0x069fc1c8(lVar8,0), ((ulong)puVar9 & 1) != 0))
    {
      lVar8 = *(long *)(lVar8 + 0x58);
      if (lVar8 != 0) {
        iVar2 = *(int *)(lVar8 + 0x10);
        if (*(int *)(lVar8 + 0x14) == 2) {
          lVar8 = func_0x03280ca0(*(undefined8 *)PTR_DAT_077e6488);
          func_0x061118e4(lVar8,0);
          if (lVar8 != 0) {
            *(double *)(lVar8 + 0x18) = (double)iVar2;
            lVar8 = func_0x03d21b68(param_2,lVar8,*(undefined8 *)PTR_DAT_077e6480);
            if (lVar8 != 0) {
              *(undefined1 *)(lVar8 + 0x31) = 0;
              uVar10 = func_0x06894a24(iVar2,0,*(undefined8 *)PTR_DAT_07800ab8,
                                       *(undefined8 *)PTR_DAT_078105c0,0);
              lVar8 = func_0x03d20d84(param_2,*(undefined8 *)puVar5);
              if (lVar8 != 0) {
            ...
            *(double *)(lVar8 + 0x18) = (double)iVar2;
            ...
            if (lVar8 != 0) {
              *(undefined1 *)(lVar8 + 0x30) = 1;
              uVar10 = func_0x06894a24(iVar2,1,*(undefined8 *)puVar6,*(undefined8 *)puVar7,0);
              lVar8 = func_0x03d20d84(param_2,*(undefined8 *)puVar5);
              if (lVar8 != 0) {
                puVar9 = (undefined8 *)(lVar8 + 0x40);
                *puVar9 = uVar10;
