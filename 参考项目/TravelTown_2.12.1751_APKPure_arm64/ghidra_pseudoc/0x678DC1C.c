/* Ghidra 12.1.2 native pseudocode; RVA 0x678DC1C; MergeEngine.ECS.Systems.Items.ExpendableSystem.SetExpendableTrackingDataWithoutSpawn; status ok */
...
void MergeEngine_ECS_Systems_Items_ExpendableSystem__SetExpendableTrackingDataWithoutSpawn
...

{
  ...
  if ((lVar5 != 0) && (*(undefined1 *)(lVar5 + 0x18) = 1, param_2 != 0)) {
    uStack_28 = 0;
    func_0x0437b6e0(&uStack_28,*(undefined4 *)(param_2 + 0x30),*(undefined8 *)PTR_DAT_07750da0);
    *(undefined8 *)(lVar5 + 0x1c) = uStack_28;
    if ((*(long *)(param_1 + 0x88) != 0) &&
       (lVar6 = *(long *)(*(long *)(param_1 + 0x88) + 0x30), lVar6 != 0)) {
