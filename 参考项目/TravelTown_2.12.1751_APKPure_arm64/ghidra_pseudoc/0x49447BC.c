/* Ghidra 12.1.2 native pseudocode; RVA 0x49447BC; MergeEngine.Util.WeightedItemList<TItem>.get_PlainItems; status ok */
...

{
  ...
  if (lVar8 == 0) {
    ...
    func_0x05356780(lVar8,uVar15,*(undefined8 *)(lVar12 + 0x28));
  ...
  lVar8 = func_0x03d507a0(uVar14,lVar8);
  ...
  if (lVar8 != 0) {
    ...
    func_0x0411bf8c(lVar13,lVar8,*(undefined8 *)(*(long *)(lVar12 + 0x38) + 0x10));
    return lVar13;
  }
  ...
  if (auVar16._0_8_ != 0) {
    ...
    func_0x04132280(lVar12,auVar16._0_8_,*(undefined8 *)(*(long *)(lVar8 + 0x38) + 0x10));
    return lVar12;
  }
  uVar14 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar14 = func_0x05ac7464(uVar14,0);
  ...
  if (auVar17._0_8_ != 0) {
    ...
    lVar12 = func_0x03280ca0();
    func_0x04135278(lVar12,auVar17._0_8_,*(undefined8 *)(*(long *)(lVar8 + 0x38) + 0x10));
    return lVar12;
  }
  uVar14 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar14 = func_0x05ac7464(uVar14,0);
  ...
  if (auVar16._0_8_ != 0) {
    ...
    lVar12 = func_0x03280ca0();
    func_0x04143d60(lVar12,auVar16._0_8_,*(undefined8 *)(*(long *)(lVar8 + 0x38) + 0x10));
    return lVar12;
  }
  uVar14 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar14 = func_0x05ac7464(uVar14,0);
  ...
  if (auVar17._0_8_ != 0) {
    ...
    lVar12 = func_0x03280ca0();
    func_0x0419ce74(lVar12,auVar17._0_8_,*(undefined8 *)(*(long *)(lVar8 + 0x38) + 0x10));
    return lVar12;
  }
  uVar14 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar14 = func_0x05ac7464(uVar14,0);
  ...
  if (auVar16._0_8_ != 0) {
    ...
    lVar12 = func_0x03280ca0();
    func_0x041c2810(lVar12,auVar16._0_8_,*(undefined8 *)(*(long *)(lVar8 + 0x38) + 0x10));
    return lVar12;
  }
  uVar14 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar14 = func_0x05ac7464(uVar14,0);
  ...
  if (auVar17._0_8_ != 0) {
    ...
    lVar12 = func_0x03280ca0();
    func_0x041ddb58(lVar12,auVar17._0_8_,*(undefined8 *)(*(long *)(lVar8 + 0x38) + 0x10));
    return lVar12;
  }
  uVar14 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar14 = func_0x05ac7464(uVar14,0);
  ...
  if (auVar16._0_8_ != 0) {
    ...
    lVar12 = func_0x03280ca0();
    func_0x041e617c(lVar12,auVar16._0_8_,*(undefined8 *)(*(long *)(lVar8 + 0x38) + 0x10));
    return lVar12;
  }
  uVar14 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar14 = func_0x05ac7464(uVar14,0);
  ...
  if (auVar17._0_8_ != 0) {
    ...
    lVar12 = func_0x03280ca0();
    func_0x041e8ba0(lVar12,auVar17._0_8_,*(undefined8 *)(*(long *)(lVar8 + 0x38) + 0x10));
    return lVar12;
  }
  uVar14 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar14 = func_0x05ac7464(uVar14,0);
  ...
  if (auVar16._0_8_ != 0) {
    ...
    lVar12 = func_0x03280ca0();
    (*(code *)**(undefined8 **)(*(long *)(lVar8 + 0x38) + 0x10))(lVar12,auVar16._0_8_);
    return lVar12;
  }
  uVar14 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar14 = func_0x05ac7464(uVar14,0);
  ...
  if (auVar17._0_8_ != 0) {
    ...
    lVar12 = func_0x03280ca0();
    func_0x0420cec8(lVar12,auVar17._0_8_,*(undefined8 *)(*(long *)(lVar8 + 0x38) + 0x10));
    return lVar12;
  }
  uVar14 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar14 = func_0x05ac7464(uVar14,0);
  ...
  if ((auVar16._0_8_ == 0) || (puVar7 = PTR_DAT_07779d18, auVar16._8_8_ == 0)) {
    ...
    if ((auVar16._0_8_ == 0) || (puVar7 = PTR_DAT_07779d18, auVar16._8_8_ == 0)) {
      uVar14 = func_0x03280a2c(puVar7);
      uVar14 = func_0x05ac7464(uVar14,0);
      auStack_1f8 = func_0x03280b7c(uVar14,lVar12);
      ...
      puVar7 = PTR_DAT_07779d10;
      if ((auStack_1f8._0_8_ != 0) && (puVar7 = PTR_DAT_07779d18, auStack_1f8._8_8_ != 0)) {
...
LAB_03d6068c:
    ...
    *(long *)((long)puVar2 + -0x18) = lStack_178;
    *(undefined1 (*) [16])((long)puVar2 + -0x10) = auVar17;
    ...
    if (lVar5 != 0) {
      *(undefined8 *)(lVar5 + 0x38) = auVar16._0_8_;
      func_0x032809c4((undefined8 *)(lVar5 + 0x38),auVar16._0_8_);
      *(undefined8 *)(lVar5 + 0x48) = auVar16._8_8_;
      func_0x032809c4((undefined8 *)(lVar5 + 0x48),auVar16._8_8_);
...
LAB_03d60730:
    ...
    *(undefined1 (*) [16])((long)puVar3 + -0x18) = auVar16;
  ...
  *(undefined1 (*) [16])((long)puVar4 + -0x18) = auVar17;
  *(long *)((long)puVar4 + -8) = lVar13;
  ...
  if (lVar13 != 0) {
    *(undefined8 *)(lVar13 + 0x40) = auVar16._0_8_;
    func_0x032809c4((undefined8 *)(lVar13 + 0x40),auVar16._0_8_);
    *(undefined8 *)(lVar13 + 0x50) = auVar16._8_8_;
    func_0x032809c4((undefined8 *)(lVar13 + 0x50),auVar16._8_8_);
  ...
  *(undefined1 (*) [16])((long)puVar4 + -0x48) = auVar16;
  *(long *)((long)puVar4 + -0x38) = lVar5;
  ...
  if (lVar13 != 0) {
    ...
    func_0x02f17738(lVar13,*(long *)(**(long **)(lVar12 + 0x38) + 0x80) + 0x100,auVar17._8_8_);
  ...
  *(undefined1 (*) [16])((long)puVar4 + -0x80) = auVar17;
...
LAB_03d60c04:
  ...
  auVar17 = func_0x03281048(plVar11,lVar12);
  ...
  *(undefined1 (*) [16])((long)puVar4 + -0xa0) = auVar16;
  if (puVar10[7] == 0) {
...
LAB_03d60ee0:
  ...
  *(undefined1 (*) [16])((long)puVar4 + -0xd0) = auVar17;
