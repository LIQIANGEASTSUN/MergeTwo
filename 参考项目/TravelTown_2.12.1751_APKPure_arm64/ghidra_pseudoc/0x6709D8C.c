/* Ghidra 12.1.2 native pseudocode; RVA 0x6709D8C; Merger.Game.Views.Inventory.InventoryProducerView.ShowInventory; status ok */


void Merger_Game_Views_Inventory_InventoryProducerView__ShowInventory(long param_1)
