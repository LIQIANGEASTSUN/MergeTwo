/* Ghidra 12.1.2 native pseudocode; RVA 0x6668918; MergeEngine.ECS.Systems.Board.BoardSystem.SetProduceCost; status ok */
...
void MergeEngine_ECS_Systems_Board_BoardSystem__SetProduceCost(long param_1)

{
  ...
  lVar6 = func_0x03eb6ac8(param_1,*(undefined8 *)puVar1);
  plVar13 = (long *)PTR_DAT_0774e8c8;
  if (lVar6 != 0) {
    plVar12 = (long *)func_0x04545bc8(lVar6,*(undefined8 *)PTR_DAT_077f0180);
    puVar4 = PTR_DAT_077e6760;
    puVar3 = PTR_DAT_077d75a0;
    ...
    if (plVar12 != (long *)0x0) {
      do {
        ...
        puVar7 = (undefined8 *)func_0x03256b10(plVar12,*(long *)puVar1,0);
LAB_06768a40:
        ...
        puVar7 = (undefined8 *)func_0x03256b10(plVar12,*(long *)puVar3,0);
LAB_06768a9c:
        lVar6 = (*(code *)*puVar7)(plVar12,puVar7[1]);
        if (lVar6 == 0) goto LAB_06768b74;
        lVar8 = func_0x03ced81c(lVar6,*(undefined8 *)puVar2);
        lVar6 = func_0x03ced81c(lVar6,*(undefined8 *)puVar4);
        if (lVar8 == 0) goto LAB_06768b78;
        uVar5 = MergeEngine_ECS_Systems_Board_BoardSystem__GetProduceCost
                          (param_1,*(undefined1 *)(lVar8 + 200),lVar6);
        if (lVar6 == 0) goto LAB_06768b70;
        *(undefined4 *)(lVar6 + 0x4c) = uVar5;
      } while( true );
    }
    goto LAB_06768b80;
  }
...
LAB_06768af4:
    if (plVar12 != (long *)0x0) {
      ...
      puVar7 = (undefined8 *)func_0x03256b10(plVar12,*plVar13,0);
LAB_06768b44:
