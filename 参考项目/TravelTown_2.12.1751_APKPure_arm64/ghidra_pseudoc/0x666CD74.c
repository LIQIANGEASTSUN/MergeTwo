/* Ghidra 12.1.2 native pseudocode; RVA 0x666CD74; MergeEngine.ECS.Systems.Board.InteractionTrackingSystem.ProcessComponents; status ok */
...
undefined1  [16]
MergeEngine_ECS_Systems_Board_InteractionTrackingSystem__ProcessComponents(long param_1)

{
  ...
  if (lVar8 != 0) {
    auVar11 = MergeEngine_ECS_Components_InteractionTracking_InteractionTrackingComponent__PrepareData
                        (lVar8,uVar6,0);
