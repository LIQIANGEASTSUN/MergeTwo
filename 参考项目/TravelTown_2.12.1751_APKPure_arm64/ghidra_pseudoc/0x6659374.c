/* Ghidra 12.1.2 native pseudocode; RVA 0x6659374; MergeEngine.ECS.Systems.Board.BoardIdleHintSystem.EntityRemoved; status ok */
...
void MergeEngine_ECS_Systems_Board_BoardIdleHintSystem__EntityRemoved(long param_1)
  ...
  if (*(char *)(lVar10 + 0x28) == '\0') {
    *(undefined8 *)(lVar10 + 0x20) = 0;
    ...
    if (iVar3 < 2) {
      ...
      lVar10 = *(long *)((long)register0x00000008 + -0x18);
      uVar15 = *(undefined8 *)((long)register0x00000008 + -0x40);
      puVar2 = (undefined1 *)register0x00000008;
      lVar13 = *(long *)((long)register0x00000008 + -8);
