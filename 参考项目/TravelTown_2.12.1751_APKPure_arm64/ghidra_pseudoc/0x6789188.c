/* Ghidra 12.1.2 native pseudocode; RVA 0x6789188; MergeEngine.ECS.Systems.Board.UndoSellAbuseSystem.BlockSpawnerAnalytics; status ok */
...
void MergeEngine_ECS_Systems_Board_UndoSellAbuseSystem__BlockSpawnerAnalytics
...

{
  ...
  if ((bRam0000000007e28d30 & 1) == 0) {
    func_0x03280a18(PTR_DAT_07810248);
