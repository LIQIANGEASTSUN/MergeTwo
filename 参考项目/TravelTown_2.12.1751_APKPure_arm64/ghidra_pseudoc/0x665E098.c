/* Ghidra 12.1.2 native pseudocode; RVA 0x665E098; MergeEngine.ECS.Systems.Board.BoardInteractionSystem.TryGuess; status ok */
    ...
    if (lVar7 != 0) {
      ...
      if ((*(long *)(param_1 + 0x68) != 0) && (*(long *)(param_1 + 0x58) != 0)) {
        ...
        if (*(long *)(param_1 + 0x58) != 0) {
          ...
          if (((lVar7 != 0) && (lVar5 != 0)) &&
             (uVar4 = func_0x0675f06c(param_1,lVar7,lVar5,lStack_18), (uVar4 & 1) != 0)) {
            return 1;
          }
          goto LAB_0675e17c;
        }
