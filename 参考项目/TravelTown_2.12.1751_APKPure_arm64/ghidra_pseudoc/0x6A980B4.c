/* Ghidra 12.1.2 native pseudocode; RVA 0x6A980B4; Merger.MergeBoard.Extensions.EntityLockExtension.FixedPosition; status ok */
...
long * Merger_MergeBoard_Extensions_EntityLockExtension__FixedPosition
...

{
  ...
  uVar11 = func_0x06b868e4(param_1);
  if (param_1 != 0) {
    uVar12 = func_0x03d1baa0(param_1,*(undefined8 *)PTR_DAT_07832580);
    ...
    if (lVar17 == 0) {
      ...
      if (lVar17 == 0) {
        ...
        if (((lVar17 != 0) &&
          ...
          func_0x04fe31ac(&uStack_e0,lVar17,*(undefined8 *)PTR_DAT_077c3a50);
          while( true ) {
            ...
            lVar17 = *(long *)(auVar36._0_8_ + 0x10);
            if (lVar17 == 0) break;
            func_0x04fe2d68(lVar17,uStack_d0,uStack_c8,*(undefined8 *)puVar7);
          }
          func_0x03280cac();
        }
          ...
          if (uVar21 < uVar12) {
            ...
            *(ulong *)((long)puVar22 + -0x70) = (ulong)uVar21;
            while( true ) {
              ...
              unaff_x26 = *(undefined **)(lVar19 + 0x18);
              unaff_x23 = plVar32;
...
LAB_04fe4490:
                ...
                if ((uVar27 & 1) != 0) {
                  ...
                  *(uint *)(lVar19 + 0x24) = uVar12;
                  *(ulong *)(lVar19 + 0x28) =
                       CONCAT44((int)((ulong)*(undefined8 *)(lVar19 + 0x28) >> 0x20) + 1,
                                (int)*(undefined8 *)(lVar19 + 0x28) + 1);
                  return (long *)0x1;
                }
              }
...
LAB_04fe48a8:
          ...
          lVar19 = *(long *)(*(long *)(*(long *)(*(long *)((long)puVar22 + -0xd8) + 0x20) + 0xc0) +
                            8);
          ...
          puVar15 = (undefined8 *)func_0x03256b10(puVar33,lVar19,1);
LAB_04fe4654:
          plVar20 = (long *)puVar15[1];
          uVar11 = (*(code *)*puVar15)(puVar33,plVar32);
LAB_04fe4664:
          lVar19 = *(long *)(lVar17 + 0x10);
          if (lVar19 == 0) goto LAB_04fe48a8;
          ...
          uVar21 = uVar11 - iVar4 * uVar12;
          if (uVar21 < uVar12) {
            iVar4 = *(int *)(lVar19 + (ulong)uVar21 * 4 + 0x20);
            ...
            while( true ) {
              ...
              if (*unaff_x28 == uVar11) {
                ...
                if (puVar33 == (uint *)0x0) {
                  ...
                  lVar19 = *(long *)(*(long *)(*(long *)(*(long *)((long)puVar22 + -0xd8) + 0x20) +
                                              0xc0) + 8);
                  ...
                  puVar15 = (undefined8 *)func_0x03256b10(puVar33,lVar19,0);
LAB_04fe47a0:
                  param_4 = puVar15[1];
                  plVar20 = plVar32;
                ...
                if ((uVar27 & 1) != 0) {
                  ...
                  if ((int)(uint)unaff_x26 < 0) {
                    lVar19 = *(long *)(lVar17 + 0x10);
                    if (lVar19 == 0) break;
                    if (*(uint *)(lVar19 + 0x18) <= (uint)*(long *)((long)puVar22 + -0xe8))
                    goto LAB_04fe48ac;
                    *(int *)(lVar19 + *(long *)((long)puVar22 + -0xe8) * 4 + 0x20) =
                         *(int *)(unaff_x27 + unaff_x25 * 0x18 + 0x24) + 1;
                  }
                  else {
                    lVar19 = *(long *)(lVar17 + 0x18);
                    if (lVar19 == 0) break;
                    if (*(uint *)(lVar19 + 0x18) <= (uint)unaff_x26) goto LAB_04fe48ac;
                    *(undefined4 *)(lVar19 + (long)unaff_x26 * 0x18 + 0x24) =
...
LAB_04fe48ac:
        ...
        *(long *)((long)puVar22 + -0x128) = lVar19;
                  ...
                  if (uVar12 < uVar21) {
                    *(undefined4 *)((long)puVar22 + -0x174) = 0;
                    ...
                    do {
                      ...
                      plVar30 = plVar31;
                      if (*(uint *)(lVar19 + (long)(int)uVar21 * 0x18 + 0x20) == uVar11) {
                        if (plVar31 == (long *)0x0) goto LAB_04fe3c74;
                        puVar33 = puVar34;
                        uVar26 = (**(code **)(*plVar31 + 0x1b8))
                                           (plVar31,*(undefined8 *)
                                                     (lVar19 + (long)plVar20 * 0x18 + 0x28),puVar34,
                        ...
                        if ((uVar26 & 1) != 0) {
                          ...
                          if (*(uint *)(lVar19 + 0x18) <= uVar21) goto LAB_04fe3c70;
                          plVar20 = (long *)(lVar19 + (long)plVar20 * 0x18 + 0x30);
                      ...
                      uVar1 = *(uint *)(lVar19 + (long)plVar20 * 0x18 + 0x24);
                ...
                if (uVar12 < uVar21) {
                  ...
                  *(uint **)((long)puVar22 + -0x180) = unaff_x29;
                  ...
                  do {
                    ...
                    if (*(uint *)(lVar19 + (long)(int)uVar21 * 0x18 + 0x20) == uVar11) {
                      lVar25 = *(long *)(*(long *)(*(long *)(uVar18 + 0x20) + 0xc0) + 8);
                      unaff_x25 = *(ulong *)(lVar19 + (long)plVar20 * 0x18 + 0x28);
                      if ((*(byte *)(lVar25 + 0x135) & 1) == 0) {
                        lVar25 = func_0x0325681c(lVar25);
                      }
                      lVar24 = *plVar30;
...
LAB_04fe3ad4:
                ...
                if (*(int *)(lVar17 + 0x28) < 1) {
                  ...
                  if (lVar19 == 0) goto LAB_04fe3c74;
                  if (*(uint *)(lVar19 + 0x18) <= uVar12) goto LAB_04fe3c70;
                  ...
                  *(int *)(lVar17 + 0x28) = *(int *)(lVar17 + 0x28) + -1;
                  ...
                  if (*(uint *)(lVar19 + 0x18) <= uVar12) goto LAB_04fe3c70;
                  lVar25 = (long)(int)uVar12;
                  *(undefined4 *)(lVar17 + 0x24) = *(undefined4 *)(lVar19 + lVar25 * 0x18 + 0x24);
                }
                lVar19 = lVar19 + lVar25 * 0x18;
                *(uint *)(lVar19 + 0x20) = uVar11;
                *(uint *)(lVar19 + 0x24) = *unaff_x28 - 1;
...
LAB_04fe3c74:
        ...
        *(long *)((long)puVar22 + -0x1c0) = lVar19;
        ...
        *(undefined8 *)((long)puVar22 + -0x1d8) = 0;
        ...
        if (lVar17 != 0) {
          ...
          if (*(long *)((long)puVar22 + -0x1d8) != 0) {
            ...
            lVar17 = *(long *)puVar7;
            lVar19 = *(long *)((long)puVar22 + -0x1d8);
            ...
            unaff_x27 = puVar7;
            if (lVar19 != 0) {
              lVar17 = func_0x05690f88(lVar19,*(undefined8 *)PTR_DAT_0777e440,uVar29,0);
              lVar19 = *(long *)(*(long *)(*(long *)(puVar33 + 8) + 0xc0) + 8);
              if ((*(byte *)(lVar19 + 0x135) & 1) == 0) {
                lVar19 = func_0x0325681c(lVar19);
              }
              if (lVar17 == 0) {
LAB_04fe3e2c:
                ...
                lVar24 = func_0x03280b90(lVar17,lVar19);
                if (lVar24 == 0) {
                  func_0x03281048(lVar17,lVar19);
                  goto LAB_04fe3e2c;
                }
              }
              ...
              *plVar20 = lVar24;
              ...
              if ((lVar17 != 0) && (lVar25 = func_0x03280b90(lVar17,lVar19), lVar25 == 0)) {
                func_0x03281048(lVar17,lVar19);
              }
              goto SUB_032809c4;
            }
        ...
        *(long *)((long)puVar22 + -0x1e8) = lVar25;
        ...
        uVar18 = (ulong)uVar11;
        lVar19 = *(long *)(*(long *)(*(long *)(auVar36._8_8_ + 0x20) + 0xc0) + 0x1c8);
        ...
        *(undefined8 *)((long)puVar22 + -0x1e8) = *(undefined8 *)((long)puVar22 + -0x1e8);
        ...
        lVar19 = *(long *)(*(long *)(*(long *)(lVar19 + 0x20) + 0xc0) + 0x1b0);
        if ((*(byte *)(lVar19 + 0x135) & 1) == 0) {
          lVar19 = func_0x0325681c(lVar19);
        }
        unaff_x23 = (long *)func_0x03280afc(lVar19,uVar18);
        ...
        if (unaff_x23 != (long *)0x0) {
          ...
          while (puVar33 < (uint *)(ulong)uVar12) {
            ...
            if (-1 < iVar4) {
              ...
              lVar19 = unaff_x21 + (ulong)uVar21 * 4;
              *(int *)((long)unaff_x23 + (long)puVar33 * 0x18 + 0x24) = *(int *)(lVar19 + 0x20) + -1
              ;
              *(int *)(lVar19 + 0x20) = (int)puVar33 + 1;
            }
...
LAB_04fe4274:
  ...
  *(undefined8 *)((long)puVar10 + -0x10) = uVar29;
  uVar11 = func_0x04fe343c(lVar17,uVar13,
                           *(undefined8 *)(*(long *)(*(long *)(lVar19 + 0x20) + 0xc0) + 0x110));
  return (long *)(ulong)(~uVar11 >> 0x1f);
}
