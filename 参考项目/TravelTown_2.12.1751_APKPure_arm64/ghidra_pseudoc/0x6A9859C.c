/* Ghidra 12.1.2 native pseudocode; RVA 0x6A9859C; Merger.MergeBoard.Extensions.InteractionComponentExtensions.FindReadyItemToConsume; status ok */


/* WARNING: Possible PIC construction at 0x06b98610: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x06b98614) */
/* WARNING: Removing unreachable block (ram,0x06b98680) */
/* WARNING: Removing unreachable block (ram,0x06b98618) */
...
void Merger_MergeBoard_Extensions_InteractionComponentExtensions__FindReadyItemToConsume(void)

{
  undefined *puVar1;
  
  puVar1 = PTR_DAT_078325a0;
  if ((bRam0000000007e2a824 & 1) == 0) {
    func_0x03280a18(PTR_DAT_077cdb40);
    func_0x03280a18(PTR_DAT_077cdb48);
    func_0x03280a18(PTR_DAT_078325a8);
    func_0x03280a18(PTR_DAT_078325a0);
    bRam0000000007e2a824 = 1;
  }
