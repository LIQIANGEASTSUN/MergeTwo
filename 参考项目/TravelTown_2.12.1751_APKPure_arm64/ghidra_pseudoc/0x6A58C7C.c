/* Ghidra 12.1.2 native pseudocode; RVA 0x6A58C7C; Merger.MergeBoardQueue.Models.BoardQueueModel.ExtractItem; status ok */
...
void Merger_MergeBoardQueue_Models_BoardQueueModel__ExtractItem(long param_1,long param_2)

{
  ...
  if (*(long *)(param_1 + 0x28) != 0) {
    uVar7 = func_0x054f0d40(*(long *)(param_1 + 0x28),param_2,*(undefined8 *)PTR_DAT_07830388);
    if ((uVar7 & 1) == 0) {
      if (*(long *)(param_1 + 0x30) == 0) goto LAB_06b58d44;
      func_0x054f0d40(*(long *)(param_1 + 0x30),param_2,*(undefined8 *)puVar4);
    }
    if ((param_2 != 0) && (*(long *)(param_1 + 0x38) != 0)) {
      func_0x053c1024(*(long *)(param_1 + 0x38),*(undefined8 *)(param_2 + 0x20),
                      *(undefined8 *)PTR_DAT_07752c80);
      if (*(long *)(param_1 + 0x68) != 0) {
        func_0x04145af8(*(long *)(param_1 + 0x68),param_2,*(undefined8 *)PTR_DAT_07830380);
