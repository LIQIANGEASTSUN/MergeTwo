/* Ghidra 12.1.2 native pseudocode; RVA 0x668ED80; Merger.Game.Views.BoardItemViewBase.CancelDrag; status ok */


void Merger_Game_Views_BoardItemViewBase__CancelDrag(long param_1)

{
  ...
  *(undefined1 *)(param_1 + 0x70) = 0;
  ...
  if (lVar4 != 0) {
                    /* WARNING: Could not recover jumptable at 0x0678ee1c. Too many branches */
