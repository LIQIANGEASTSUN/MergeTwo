/* Ghidra 12.1.2 native pseudocode; RVA 0x4C06B18; MergeEngine.ECS.Systems.Items.BaseToolAnalysisSystem<T>.ApplyToolFiltering; status ok */
...
LAB_04d06f58:
  ...
  if ((uVar12 & 1) != 0) {
    uVar11 = (*(code *)**(undefined8 **)(*(long *)(*(long *)(param_6 + 0x20) + 0xc0) + 0x110))
                       (auVar23._0_8_,uVar11,param_5 & 0xffffffff,plVar21);
  }
  ...
  lVar13 = *(long *)puVar1;
  lVar16 = func_0x03f372e4(uVar11,lVar16);
  plVar20 = *(long **)(auVar23._0_8_ + 0x60);
  if (plVar20 != (long *)0x0) {
    lVar17 = *plVar20;
