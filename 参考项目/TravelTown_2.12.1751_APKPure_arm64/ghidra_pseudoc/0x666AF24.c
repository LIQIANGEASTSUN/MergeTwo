/* Ghidra 12.1.2 native pseudocode; RVA 0x666AF24; MergeEngine.ECS.Systems.Board.BoardSystem.GetUnlockedItemById; status ok */

/* WARNING: Possible PIC construction at 0x0676afa4: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x0676afa8) */
/* WARNING: Removing unreachable block (ram,0x0676b02c) */
/* WARNING: Removing unreachable block (ram,0x0676afac) */
...
void MergeEngine_ECS_Systems_Board_BoardSystem__GetUnlockedItemById(void)

{
  undefined *puVar1;
  
  puVar1 = PTR_DAT_07807f10;
  if ((bRam0000000007e280de & 1) == 0) {
    func_0x03280a18(PTR_DAT_0777f908);
    func_0x03280a18(PTR_DAT_0777f910);
    func_0x03280a18(PTR_DAT_077803f8);
    func_0x03280a18(PTR_DAT_07807f18);
    func_0x03280a18(PTR_DAT_07807f10);
    bRam0000000007e280de = 1;
  }
