/* Ghidra 12.1.2 native pseudocode; RVA 0x6A328E8; Merger.MergeBoard.ViewModel.MergeBoardViewModel.MoveItem; status ok */
...
undefined1  [16]
Merger_MergeBoard_ViewModel_MergeBoardViewModel__MoveItem
...

{
  ...
  puVar3 = PTR_DAT_07832758;
  puVar2 = PTR_DAT_07779710;
  if (*(long *)(param_1 + 0x68) == 0) {
    auVar15 = func_0x03280cac();
    if (*(long *)(auVar15._0_8_ + 0x68) == 0) {
      auVar15 = func_0x03280cac();
      plVar7 = param_3;
      ...
      lVar12 = *(long *)(auVar15._0_8_ + 0x70);
      if (lVar12 == 0) {
LAB_06b32a5c:
        func_0x03280cac();
        ...
        lVar12 = func_0x03280b90(extraout_x1_00,*(undefined8 *)puVar2);
        if (lVar12 == 0) {
          lVar8 = 0;
          *plVar7 = 0;
        }
      ...
      if (0 < (int)uVar1) {
        ...
        do {
          ...
          plVar11 = *(long **)(lVar12 + (long)(int)uVar13 * 8 + 0x20);
          if (plVar11 == (long *)0x0) goto LAB_06b32a5c;
          lVar8 = *plVar11;
          ...
          puVar4 = (undefined8 *)func_0x03256b10(plVar11,*(long *)puVar2,0);
LAB_06b329f0:
          plVar7 = param_3;
          uVar9 = (*(code *)*puVar4)(plVar11,auVar15._8_8_,param_3,puVar4[1]);
          if ((uVar9 & 1) != 0) {
            *param_4 = plVar11;
            goto LAB_06b32a38;
          }
