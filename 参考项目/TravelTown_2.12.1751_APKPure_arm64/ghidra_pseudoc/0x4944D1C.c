/* Ghidra 12.1.2 native pseudocode; RVA 0x4944D1C; MergeEngine.Util.WeightedItemList<TItem>.AddItem; status ok */
...
undefined1  [16]
MergeEngine_Util_WeightedItemList_TItem___AddItem(long param_1,long param_2,long param_3)

{
  ...
  if (param_2 != 0) {
    ...
    *(undefined4 *)(param_1 + 0x18) = *(undefined4 *)(param_2 + 0x1c);
    if (lVar16 != 0) {
      ...
      *(int *)(lVar16 + 0x1c) = *(int *)(lVar16 + 0x1c) + 1;
      if (lVar20 != 0) {
        ...
        *(uint *)(lVar16 + 0x18) = uVar2 + 1;
        ...
        else if (uVar2 < *(uint *)(lVar20 + 0x18)) {
          plVar21 = (long *)(lVar20 + (long)(int)uVar2 * 8 + 0x20);
          *plVar21 = param_2;
          goto SUB_032809c4;
        }
        ...
        lVar20 = *(long *)(*(long *)(*(long *)(lVar27 + 0x20) + 0xc0) + 0x48);
...
LAB_0414454c:
          ...
          param_2 = func_0x03280b90(lVar19,lVar20);
          if (param_2 == 0) {
...
LAB_041445ac:
        ...
        if (auVar39._8_4_ == 1) {
          ...
          if ((uVar12 & 1) != 0) {
            func_0x072ce920();
            uVar11 = *(undefined8 *)(*(long *)(*(long *)(lVar27 + 0x20) + 0xc0) + 0x68);
            lVar27 = func_0x03280a2c(PTR_DAT_0774e558);
        ...
        uVar2 = *(uint *)(plVar8 + 3);
        lVar16 = *(long *)(*(long *)(*(long *)(lVar18 + 0x20) + 0xc0) + 0x90);
        uVar12 = (ulong)uVar2;
        ...
        lVar27 = *(long *)(*(long *)(*(long *)(lVar16 + 0x20) + 0xc0) + 0x28);
        if ((*(byte *)(lVar27 + 0x135) & 1) == 0) {
          lVar27 = func_0x0325681c(lVar27);
        }
        plVar14 = (long *)func_0x03280b90(plVar17,lVar27);
        if (plVar14 == (long *)0x0) {
          if ((int)uVar2 < (int)plVar8[3]) {
            if (plVar17 == (long *)0x0) {
              ...
              lVar27 = *(long *)(*(long *)(*(long *)(lVar16 + 0x20) + 0xc0) + 0x20);
              if ((*(byte *)(lVar27 + 0x135) & 1) == 0) {
                lVar27 = func_0x0325681c(lVar27);
              }
              lVar20 = *plVar17;
              ...
              if (uVar26 != 0) {
                ...
                do {
                  if (*(long *)(piVar28 + -2) == lVar27) {
                    puVar10 = (undefined8 *)(lVar20 + (long)*piVar28 * 0x10 + 0x138);
                    goto LAB_04145868;
                  }
                  uVar26 = uVar26 - 1;
                  piVar28 = piVar28 + 4;
...
LAB_041458d0:
                  ...
                  lVar27 = *(long *)(*(long *)(*(long *)(lVar16 + 0x20) + 0xc0) + 0x148);
                  if ((*(byte *)(lVar27 + 0x135) & 1) == 0) {
                    lVar27 = func_0x0325681c(lVar27);
                  }
                  lVar20 = *plVar29;
                  ...
                  puVar10 = (undefined8 *)func_0x03256b10(plVar29,lVar27,0);
LAB_04145948:
                  plVar21 = (long *)(*(code *)*puVar10)(plVar29,puVar10[1]);
                  func_0x04145380(plVar8,uVar12,plVar21,
                                  *(undefined8 *)
                                   (*(long *)(*(long *)(lVar16 + 0x20) + 0xc0) + 0x160));
...
LAB_041459e8:
          ...
          auVar37 = func_0x041462cc(plVar8,plVar17,
                                    *(undefined8 *)
                                     (*(long *)(*(long *)(lVar16 + 0x20) + 0xc0) + 0x40));
        }
        else {
          lVar27 = *(long *)(*(long *)(*(long *)(lVar16 + 0x20) + 0xc0) + 0x28);
          if ((*(byte *)(lVar27 + 0x135) & 1) == 0) {
          ...
          puVar10 = (undefined8 *)func_0x03256b10(plVar14,lVar27,0);
LAB_04145728:
          auVar37 = (*(code *)*puVar10)(plVar14,puVar10[1]);
          iVar6 = auVar37._0_4_;
          if (0 < iVar6) {
            func_0x04144aa0(plVar8,(int)plVar8[3] + iVar6,
                            *(undefined8 *)(*(long *)(*(long *)(lVar16 + 0x20) + 0xc0) + 0x78));
            ...
            if (plVar8 == plVar14) {
              ...
              lVar27 = plVar8[2];
              lVar16 = *(long *)(*(long *)(*(long *)(lVar16 + 0x20) + 0xc0) + 0x28);
              ...
              if (uVar12 != 0) {
                ...
                do {
                  if (*(long *)(piVar28 + -2) == lVar16) {
                    puVar10 = (undefined8 *)(lVar20 + (long)(*piVar28 + 5) * 0x10 + 0x138);
                    goto LAB_04145838;
                  }
                  uVar12 = uVar12 - 1;
                  piVar28 = piVar28 + 4;
              ...
              puVar10 = (undefined8 *)func_0x03256b10(plVar14,lVar16,5);
LAB_04145838:
              auVar37 = (*(code *)*puVar10)(plVar14,lVar27,uVar2,puVar10[1]);
            }
...
LAB_04145a10:
  ...
  lVar16 = *(long *)(*(long *)(*(long *)(param_3 + 0x20) + 0xc0) + 0x88);
  if ((*(byte *)(lVar16 + 0x135) & 1) == 0) {
    lVar16 = func_0x0325681c(lVar16);
  }
...
LAB_03e0f478:
        ...
        lVar27 = *(long *)(*(long *)(uVar12 + 0x38) + 0x10);
        if ((*(byte *)(lVar27 + 0x135) & 1) == 0) {
          lVar27 = func_0x0325681c(lVar27);
        }
        lVar20 = *unaff_x20;
...
LAB_03e0f4ec:
        uVar11 = (*(code *)*puVar10)(unaff_x20,puVar10[1]);
        if (lVar16 == 0) goto LAB_03e0f5a4;
        iVar6 = (int)uVar22;
        (**(code **)(lVar16 + 0x18))
                  (*(undefined8 *)(lVar16 + 0x40),uVar11,uVar22,*(undefined8 *)(lVar16 + 0x28));
        uVar26 = uVar22;
    ...
    if (uVar24 != 0) {
      ...
      do {
        if (*(long *)(piVar28 + -2) == lVar20) {
          puVar7 = (undefined8 *)(lVar19 + (long)*piVar28 * 0x10 + 0x138);
          goto LAB_03e0f784;
        }
        uVar24 = uVar24 - 1;
        piVar28 = piVar28 + 4;
...
LAB_03e0f7ec:
        ...
        lVar20 = *(long *)(*(long *)(uVar26 + 0x38) + 0x10);
        if ((*(byte *)(lVar20 + 0x135) & 1) == 0) {
          lVar20 = func_0x0325681c(lVar20);
        }
        lVar19 = *plVar21;
        ...
        if (uVar22 != 0) {
          ...
          do {
            if (*(long *)(piVar28 + -2) == lVar20) {
              lVar20 = lVar19 + (long)*piVar28 * 0x10 + 0x138;
              goto LAB_03e0f860;
            }
            uVar22 = uVar22 - 1;
            piVar28 = piVar28 + 4;
        ...
        lVar20 = func_0x03256b10(plVar21,lVar20,0);
LAB_03e0f860:
        lVar20 = *(long *)(lVar20 + 8);
        puStack_f0 = puVar10;
        (**(code **)(lVar20 + 0x10))(*(undefined8 *)(lVar20 + 8),lVar20,plVar21,&puStack_f0,puVar10)
        ;
        func_0x072ce970(lVar27,puVar10,uVar23);
        uVar22 = uVar23;
        func_0x072ce970(puVar13,lVar27);
...
LAB_03e0fa30:
  ...
  auVar37 = func_0x02f09514();
  plVar8 = auVar37._0_8_;
  *(undefined1 **)(lVar27 + -0x60) = &stack0xffffffffffffff20;
  *(undefined8 *)(lVar27 + -0x58) = 0x3e0fa48;
  *(undefined **)(lVar27 + -0x50) = puVar30;
  *(long *)(lVar27 + -0x48) = lVar16;
  *(long *)(lVar27 + -0x40) = lVar27;
  *(undefined8 **)(lVar27 + -0x38) = puVar13;
  *(undefined8 **)(lVar27 + -0x30) = puVar10;
  *(ulong *)(lVar27 + -0x28) = uVar23;
  *(undefined8 *)(lVar27 + -0x20) = uVar11;
  *(undefined8 *)(lVar27 + -0x18) = 0;
  *(long **)(lVar27 + -0x10) = plVar21;
  *(long **)(lVar27 + -8) = auVar33._0_8_;
  lVar16 = tpidr_el0;
  *(long *)(lVar27 + -0x88) = lVar16;
  *(undefined8 *)(lVar27 + -0x68) = *(undefined8 *)(lVar16 + 0x28);
  ...
  lVar16 = (lVar27 + -0x90) - uVar12;
  puVar10 = (undefined8 *)(lVar16 - uVar12);
  lVar20 = (long)puVar10 - uVar12;
  func_0x072ce9a0(lVar20,0,uVar26);
  plVar29 = (long *)0x0;
  if (plVar8 != (long *)0x0) {
    lVar19 = *plVar21;
    ...
    puVar13 = (undefined8 *)func_0x03256b10(plVar8,lVar19,0);
LAB_03e0fb60:
    pcVar1 = (code *)*puVar13;
    uVar11 = puVar13[1];
    *(long **)(lVar27 + -0x90) = plVar8;
    plVar29 = (long *)(*pcVar1)(plVar8,uVar11);
    puVar30 = PTR_DAT_0774e8e0;
    if (plVar29 != (long *)0x0) {
      iVar6 = 0;
      plVar21 = (long *)(lVar27 + -0x6c);
      do {
        lVar19 = *plVar29;
...
LAB_03e0fbd4:
        ...
        lVar19 = *(long *)(*(long *)(uVar22 + 0x38) + 0x10);
        if ((*(byte *)(lVar19 + 0x135) & 1) == 0) {
          lVar19 = func_0x0325681c(lVar19);
        }
        lVar18 = *plVar29;
        ...
        if (uVar12 != 0) {
          ...
          do {
            if (*(long *)(piVar28 + -2) == lVar19) {
              lVar19 = lVar18 + (long)*piVar28 * 0x10 + 0x138;
              goto LAB_03e0fc48;
            }
            uVar12 = uVar12 - 1;
            piVar28 = piVar28 + 4;
        ...
        lVar19 = func_0x03256b10(plVar29,lVar19,0);
LAB_03e0fc48:
        *(long *)(lVar27 + -0x80) = lVar16;
        lVar19 = *(long *)(lVar19 + 8);
        (**(code **)(lVar19 + 0x10))
                  (*(undefined8 *)(lVar19 + 8),lVar19,plVar29,lVar27 + -0x80,lVar16);
        func_0x072ce970(lVar20,lVar16,uVar26);
        func_0x072ce970(puVar10,lVar20,uVar26);
        ...
        uVar11 = *puVar7;
        *(int *)(lVar27 + -0x6c) = iVar6;
        *(undefined8 **)(lVar27 + -0x80) = puVar13;
        *(long **)(lVar27 + -0x78) = plVar21;
        (*(code *)puVar7[2])(uVar11,puVar7,auVar37._8_8_,lVar27 + -0x80,lVar27 + -0x6c);
        iVar6 = iVar6 + 1;
      } while( true );
    }
    goto LAB_03e0fd74;
...
LAB_04145ae0:
  ...
  auVar37 = func_0x02f09514();
  lVar16 = auVar37._0_8_;
  auVar37 = func_0x03f898d4(*(undefined8 *)(lVar16 + 0x10),auVar37._8_8_,0,
  ...
  if (-1 < (int)auVar37._0_4_) {
    func_0x04145da4(lVar16,auVar37._0_8_ & 0xffffffff);
...
LAB_03e0fe24:
  ...
  plVar8 = auVar37._0_8_;
  *(undefined8 *)(lVar20 + -0x20) = 0x3e0fe3c;
  *(long **)(lVar20 + -0x10) = plVar29;
  *(long **)(lVar20 + -8) = plVar21;
  lVar16 = lVar27;
  if (*(long *)(lVar27 + 0x38) == 0) {
    func_0x03256878(lVar27);
    lVar16 = extraout_x1_07;
  }
  if (plVar8 == (long *)0x0) {
    uVar12 = 1;
  }
    ...
    puVar10 = (undefined8 *)func_0x03256b10(plVar8,lVar16,0);
LAB_03e0fed0:
    iVar6 = (*(code *)*puVar10)(plVar8,puVar10[1]);
    uVar12 = (ulong)(iVar6 == 0);
    lVar16 = extraout_x1_08;
  }
  auVar36._8_8_ = lVar16;
