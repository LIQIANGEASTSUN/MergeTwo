/* Ghidra 12.1.2 native pseudocode; RVA 0x4653F20; MergeEngine.Util.TwoDArray<T>.get_EmptyPositions; status ok */


ulong MergeEngine_Util_TwoDArray_T___get_EmptyPositions
...

{
  ...
  lVar8 = auVar22._0_8_;
  pcStack_70 = MergeEngine_Util_TwoDArray_T____ctor;
                  ...
                  *(undefined8 *)(lVar16 + 0x30) = uStack_a0;
                  ...
                  if (3 < *(uint *)(lVar16 + 0x18)) {
                    *(undefined8 *)(lVar16 + 0x38) = uStack_a8;
                    uStack_b0 = 0;
                    func_0x069fdc94(&uStack_b0,0xffffffff,0xffffffff,0);
                    if (4 < *(uint *)(lVar16 + 0x18)) {
                      *(undefined8 *)(lVar16 + 0x40) = uStack_b0;
                      uStack_b8 = 0;
                      func_0x069fdc94(&uStack_b8,0xffffffff,1,0);
                      if (5 < *(uint *)(lVar16 + 0x18)) {
                        *(undefined8 *)(lVar16 + 0x48) = uStack_b8;
                        uStack_c0 = 0;
                        func_0x069fdc94(&uStack_c0,1,1,0);
                        if (6 < *(uint *)(lVar16 + 0x18)) {
                          *(undefined8 *)(lVar16 + 0x50) = uStack_c0;
                          uStack_c8 = 0;
                          func_0x069fdc94(&uStack_c8,1,0xffffffff,0);
                          if (7 < *(uint *)(lVar16 + 0x18)) {
                            *(undefined8 *)(lVar16 + 0x58) = uStack_c8;
...
LAB_047542a8:
  ...
  pcStack_100 = MergeEngine_Util_TwoDArray_T___FillEmptyPositions;
  uVar11 = uVar10;
  lStack_f8 = lVar16;
  uStack_f0 = uVar7;
    ...
    do {
      if (0 < iVar18) {
        ...
        do {
          ...
          uStack_108 = 0;
          uVar14 = uVar7;
          uVar11 = func_0x069fdc94(&uStack_108,uVar20,uVar7,0);
          if (lVar8 == 0) {
LAB_047543b0:
            auVar22 = func_0x03280cac();
            lVar16 = auVar22._0_8_;
            pcStack_150 = MergeEngine_Util_TwoDArray_T___CreateArray;
            puStack_140 = puVar6;
            puStack_138 = puVar5;
          ...
          *(int *)(lVar8 + 0x1c) = *(int *)(lVar8 + 0x1c) + 1;
          ...
          if (uVar3 < *(uint *)(lVar16 + 0x18)) {
            ...
            *(undefined8 *)(lVar16 + (long)(int)uVar3 * 8 + 0x20) = uStack_108;
          }
          else {
            uVar11 = func_0x040cec28(lVar8,uStack_108,
                                     *(undefined8 *)
...
LAB_047544ac:
    ...
    pcStack_160 = MergeEngine_Util_TwoDArray_T___GetItem;
...
LAB_04754504:
    ...
    pcStack_190 = MergeEngine_Util_TwoDArray_T___SetItem;
    uVar10 = uVar14;
    uStack_180 = uVar7;
    uStack_178 = uVar11;
    auStack_170 = auVar22;
...
LAB_04754660:
    ...
    lVar16 = auVar22._0_8_;
    puStack_1d0 = puVar4;
    uStack_1c8 = 0x7e19000;
    uStack_1b0 = 0x7e19000;
    plStack_1c0 = plVar21;
    lStack_1b8 = lVar8;
    uStack_1a8 = uVar14;
    auStack_1a0 = auVar23;
...
LAB_047547f0:
  ...
  func_0x069fdc94(&lStack_1d8,*piVar1 + auVar22._8_4_,piVar1[1] + auVar22._12_4_,0);
  if ((((-1 < (int)lStack_1d8) && (-1 < lStack_1d8)) && ((int)lStack_1d8 < *(int *)(lVar16 + 0x10)))
     && ((int)((ulong)lStack_1d8 >> 0x20) < *(int *)(lVar16 + 0x14))) {
    ...
    *(int *)(uVar7 + 0x1c) = *(int *)(uVar7 + 0x1c) + 1;
    ...
    if (uVar3 < *(uint *)(lVar13 + 0x18)) {
      ...
      *(long *)(lVar13 + (long)(int)uVar3 * 8 + 0x20) = lStack_1d8;
    }
    else {
      func_0x040cec28(uVar7,lStack_1d8,
