/* Ghidra 12.1.2 native pseudocode; RVA 0x4944D00; MergeEngine.Util.WeightedItemList<TItem>.get_Count; status ok */
...

{
  ...
  if (lVar19 != 0) {
    ...
    *(undefined4 *)(auVar32._0_8_ + 0x18) = *(undefined4 *)(lVar19 + 0x1c);
    if (lVar16 != 0) {
