/* Ghidra 12.1.2 native pseudocode; RVA 0x664BE28; Merger.Game.ViewModel.Board.BoardQueueViewModel.ShouldSlideOnCoreBoard; status ok */
...
ulong Merger_Game_ViewModel_Board_BoardQueueViewModel__ShouldSlideOnCoreBoard
...

{
  ...
  if (param_2 != 0) {
    ...
    if ((param_3 >> 0x20 == 1) && ((param_3 & 0xff) != 0)) {
      return 0;
    }
  ...
  if (extraout_x1 != 0) {
    if (*(long **)(extraout_x1 + 0x10) != (long *)0x0) {
    ...
    if ((uVar6 >> 0x20 == 2) && ((uVar6 & 0xff) != 0)) {
      return 0;
    }
    if (*(char *)(extraout_x1 + 0x20) == '\0') {
      return 0;
    }
    if ((uVar8 & 1) == 0) {
      return (ulong)(*(char *)(extraout_x1 + 0x48) != '\0');
    }
    return (ulong)(*(char *)(extraout_x1 + 0x20) != '\0');
  }
...
LAB_055f9920:
    ...
    puVar4 = (ulong *)auStack_3a0;
    uStack_1a0 = uVar24;
    puStack_198 = puVar17;
    func_0x072ce9a0(puVar4,0,0x200);
    uVar10 = *(undefined8 *)puVar20;
    uVar12 = 0x80;
    func_0x0482a804(&lStack_190,puVar4);
    ...
    if (-1 < (int)uVar23) {
      ...
      do {
        ...
        unaff_x28 = (long)(int)(uint)uStack_178;
        if ((*(byte *)(*(long *)(puVar20 + 0x10) + 0x135) & 1) == 0) {
          func_0x0325681c();
        }
        if ((int)(uint)uStack_188 <= (int)uVar1) {
          lVar16 = *(long *)(puVar20 + 0x10);
          if ((*(byte *)(lVar16 + 0x135) & 1) == 0) {
            lVar16 = func_0x0325681c();
          }
          func_0x0482aa14(&lStack_190,*(undefined8 *)(*(long *)(lVar16 + 0xc0) + 0x28));
        }
        if ((uint)uStack_188 <= uVar1) {
          func_0x03280cb4();
          puVar21 = puVar20;
          goto LAB_055f9890;
        }
        *(int *)(lStack_190 + unaff_x28 * 4) = iVar22;
        uStack_178 = CONCAT44(uStack_178._4_4_,uVar1 + 1);
...
LAB_055f97f4:
    ...
    if ((uint)uStack_178 == 0) {
      puVar5 = puVar17;
      if (*(long *)(puStack_198 + 0x28) == lStack_168) {
        return uVar8;
      }
      goto LAB_055f9920;
    }
    ...
    auVar28 = func_0x0482a8a4(&lStack_190,*(undefined8 *)PTR_DAT_077884a0);
    uVar27 = 0x55f9844;
    uVar12 = uStack_1a0;
  }
  lVar16 = auVar30._0_8_;
  piVar13 = auVar28._0_8_;
  *(undefined1 **)((long)puVar4 + -0x60) = &stack0xfffffffffffffea0;
