/* Ghidra 12.1.2 native pseudocode; RVA 0x6A7C7FC; Merger.MergeBoard.Models.ItemsDiscoveryModel.IsItemCollected; status ok */
...
ulong Merger_MergeBoard_Models_ItemsDiscoveryModel__IsItemCollected(long param_1,undefined8 param_2)

{
  ...
  if (*(long *)(param_1 + 0x28) != 0) {
    ...
    if (lStack_28 != 0) {
      return (ulong)(*(int *)(lStack_28 + 0x10) != 0);
    }
  }
  func_0x03280cac();
  uStack_40 = 0x6b7c888;
  ...
  if (lVar4 != 0) {
    ...
    if (alStack_68[0] != 0) {
      return (ulong)((*(uint *)(alStack_68[0] + 0x10) & 0xfffffffe) == 2);
    }
  }
  func_0x03280cac();
  uStack_80 = 0x6b7c938;
  ...
  if (lVar4 != 0) {
    ...
    if (alStack_a8[0] != 0) {
      return (ulong)(*(int *)(alStack_a8[0] + 0x10) == 2);
    }
  }
  func_0x03280cac();
  uStack_c0 = 0x6b7c9e8;
  ...
  auVar10 = func_0x03280cac();
  alStack_e8[1] = 0x6b7ca08;
  alStack_e8[2] = 0x7e2a000;
  auStack_d0 = auVar11;
  ...
  lVar4 = *(long *)(auVar10._0_8_ + 0x28);
  if (lVar4 != 0) {
    uVar3 = func_0x04fe48b0(lVar4,auVar10._8_8_,alStack_e8,*(undefined8 *)PTR_DAT_078318e0);
    if ((uVar3 & 1) == 0) {
      return 0;
    }
    if (alStack_e8[0] != 0) {
      return (ulong)(*(int *)(alStack_e8[0] + 0x10) == 3);
    }
  }
  func_0x03280cac();
  if (extraout_x1_02 != 0) {
...
LAB_06b7cb84:
    ...
    if (lVar9 != 0) {
      uVar3 = func_0x04fe48b0(lVar9,uVar6,&lStack_128,*(undefined8 *)PTR_DAT_078318e0);
      puVar2 = PTR_DAT_078318f0;
      if ((uVar3 & 1) != 0) {
        if (lStack_128 == 0) goto LAB_06b7cd6c;
        if (*(int *)(lStack_128 + 0x10) != 0) {
          return 0;
        }
      }
      lVar4 = *plVar7;
