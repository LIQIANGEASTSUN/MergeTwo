/* Ghidra 12.1.2 native pseudocode; RVA 0x44E7DEC; MergeEngine.ECS.Components.SerializableComponent<TSerializable>.MergeEngine.ECS.Components.ISerializableComponent.Deserialize; status ok */


undefined8
MergeEngine_ECS_Components_SerializableComponent_TSerializable___MergeEngine_ECS_Components_ISerializableComponent_Deserialize
...

{
  ...
  if ((bRam0000000007e18ff1 & 1) == 0) {
    func_0x03280a18(PTR_DAT_0777b110);
    bRam0000000007e18ff1 = 1;
  }
...
LAB_045e7e90:
  ...
  *plVar6 = lVar3;
  ...
  func_0x03e6e2e8(lVar3,0,*(undefined8 *)(*(long *)(*(long *)(param_3 + 0x20) + 0xc0) + 0x18));
                    /* WARNING: Could not recover jumptable at 0x045e7f40. Too many branches */
