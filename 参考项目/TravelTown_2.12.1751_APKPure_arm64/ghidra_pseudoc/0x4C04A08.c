/* Ghidra 12.1.2 native pseudocode; RVA 0x4C04A08; MergeEngine.ECS.Systems.Items.BaseToolAnalysisSystem<T>.CreateChainBasedFilter; status ok */


ulong MergeEngine_ECS_Systems_Items_BaseToolAnalysisSystem_T___CreateChainBasedFilter
                (undefined8 param_1,undefined8 param_2,long param_3,undefined8 param_4,ulong param_5
                ,long param_6)

{
  ...
  if ((*(byte *)(*(long *)(*(long *)(*(long *)(param_3 + 0x20) + 0xc0) + 0xe8) + 0x135) & 1) == 0) {
    func_0x0325681c();
  }
  lVar11 = func_0x03280ca0();
  func_0x04054968(lVar11,*(undefined8 *)(*(long *)(*(long *)(param_3 + 0x20) + 0xc0) + 0xf0));
  puVar1 = PTR_DAT_077800b8;
  if (lVar11 != 0) {
    *(undefined8 *)(lVar11 + 0x10) = param_2;
    func_0x032809c4((undefined8 *)(lVar11 + 0x10),param_2);
    uVar12 = func_0x03280ca0(*(undefined8 *)puVar1);
    func_0x0535aa98(uVar12,lVar11,
                    *(undefined8 *)(*(long *)(*(long *)(param_3 + 0x20) + 0xc0) + 0xf8),0);
    return uVar12;
  }
  ...
  if (lVar11 == 0) {
    ...
    *(long *)(*(long *)(lVar13 + 0xb8) + 0x18) = lVar11;
    lVar13 = *(long *)(lVar16 + 0x20);
    if ((*(byte *)(lVar13 + 0x135) & 1) == 0) {
      lVar13 = func_0x0325681c();
    }
    func_0x032809c4(*(long *)(lVar13 + 0xb8) + 0x18,lVar11);
  }
  ...
  uVar12 = *(ulong *)puVar1;
  lVar14 = func_0x03f36e88(auVar23._8_8_,lVar11);
...
LAB_04d04dac:
    ...
    if (lVar14 != 0) {
      ...
      lVar11 = *(long *)(*(long *)(*(long *)(lVar13 + 0x20) + 0xc0) + 0xa0);
      if ((*(byte *)(lVar11 + 0x135) & 1) == 0) {
        lVar11 = func_0x0325681c(lVar11);
      }
      lVar11 = func_0x03280ca0(lVar11);
      func_0x04c1b8d8(lVar11,*(undefined8 *)(*(long *)(*(long *)(lVar13 + 0x20) + 0xc0) + 0xa8));
      if ((plVar19 != (long *)0x0) &&
         (iVar8 = (**(code **)(*plVar19 + 0x1a8))
                            (plVar19,*(undefined4 *)(lVar14 + 0x18),
                             *(undefined8 *)(*plVar19 + 0x1b0)), lVar11 != 0)) {
        *(int *)(lVar11 + 0x10) = iVar8 + 1;
        ...
        lVar14 = *(long *)(*(long *)(lVar13 + 0x20) + 0xc0);
        func_0x05355fbc(uVar10,lVar11,*(undefined8 *)(lVar14 + 0xb0),*(undefined8 *)(lVar14 + 0xc0))
        ;
        lVar14 = func_0x03d4294c(uVar20,uVar10,
                                 *(undefined8 *)(*(long *)(*(long *)(lVar13 + 0x20) + 0xc0) + 200));
        if (lVar14 != 0) {
          return (ulong)*(uint *)(lVar14 + 0x10);
        }
      }
      auVar23 = func_0x03280cac();
      lVar14 = *(long *)(*(long *)(*(long *)(auVar23._8_8_ + 0x20) + 0xc0) + 8);
      if ((*(byte *)(lVar14 + 0x135) & 1) == 0) {
        lVar14 = func_0x0325681c(lVar14);
      }
      uVar20 = func_0x03280ca0(lVar14);
      func_0x04143c38(uVar20,*(undefined8 *)
                              (*(long *)(*(long *)(auVar23._8_8_ + 0x20) + 0xc0) + 0xe0));
      puVar15 = (undefined8 *)(auVar23._0_8_ + 0x10);
      *puVar15 = uVar20;
      func_0x032809c4(puVar15,uVar20);
      return auVar23._0_8_;
    }
  }
  auVar23 = func_0x03280cac();
  uVar20 = auVar23._8_8_;
  auStack_d0[2] = 0x4d04de8;
  ...
  if ((uVar12 & 1) != 0) {
    uVar20 = func_0x04d046ec(auVar23._0_8_,uVar20,param_5 & 0xffffffff,plVar21,
  ...
  if (lVar14 == 0) {
    ...
    *(long *)(*(long *)(lVar11 + 0xb8) + 0x28) = lVar14;
    lVar11 = *(long *)(lVar13 + 0x20);
    if ((*(byte *)(lVar11 + 0x135) & 1) == 0) {
      lVar11 = func_0x0325681c();
    }
    func_0x032809c4(*(long *)(lVar11 + 0xb8) + 0x28,lVar14);
  }
  ...
  if (lVar11 == 0) {
    ...
    *(long *)(*(long *)(lVar13 + 0xb8) + 0x30) = lVar11;
    lVar13 = *(long *)(lVar16 + 0x20);
    if ((*(byte *)(lVar13 + 0x135) & 1) == 0) {
      lVar13 = func_0x0325681c();
    }
    func_0x032809c4(*(long *)(lVar13 + 0xb8) + 0x30,lVar11);
  }
  lVar14 = func_0x03f372e4(uVar20,lVar14,lVar11,*(undefined8 *)puVar1);
  plVar19 = *(long **)(auVar23._0_8_ + 0x60);
  if (plVar19 != (long *)0x0) {
    lVar13 = *plVar19;
    ...
    puVar15 = (undefined8 *)func_0x03256b10(plVar19);
LAB_04d05124:
    uVar20 = (*(code *)*puVar15)(plVar19,puVar15[1]);
    if (lVar14 != 0) {
      lVar11 = *(long *)PTR_DAT_077800f8;
      iVar8 = func_0x04a44654(lVar14,uVar20);
      if (plVar21 != (long *)0x0) {
        lVar14 = *plVar21;
...
LAB_04d051a8:
        lVar14 = (*(code *)*puVar15)(plVar21,puVar15[1]);
        puVar1 = PTR_DAT_077800f0;
        if (lVar14 != 0) {
          uVar20 = func_0x0414419c(lVar14,iVar8 + -1,*(undefined8 *)PTR_DAT_0777e510);
          auStack_d0[0] = 0;
          auStack_d0[1] = 0;
          func_0x048c959c(auStack_d0,uVar20,iVar8,*(undefined8 *)puVar1);
          return auStack_d0[0];
        }
      }
    }
...
LAB_04d05364:
    ...
    *(undefined8 *)(uVar12 + 0x78) = uVar20;
    func_0x032809c4((undefined8 *)(uVar12 + 0x78),uVar20);
    uVar20 = func_0x03280ca0(*(undefined8 *)puVar5);
    func_0x04f610a8(uVar20,*(undefined8 *)puVar6);
    *(undefined8 *)(uVar12 + 0x80) = uVar20;
    func_0x032809c4((undefined8 *)(uVar12 + 0x80),uVar20);
    uVar20 = func_0x03280ca0(*(undefined8 *)puVar2);
    func_0x04f2ad28(uVar20,*(undefined8 *)puVar1);
    *(undefined8 *)(uVar12 + 0x88) = uVar20;
    func_0x032809c4((undefined8 *)(uVar12 + 0x88),uVar20);
    uVar20 = func_0x03280ca0(*(undefined8 *)puVar7);
    func_0x06898a68(uVar20,0);
    *(undefined8 *)(uVar12 + 0x90) = uVar20;
    func_0x032809c4((undefined8 *)(uVar12 + 0x90),uVar20);
    return uVar12;
  }
  if (0 < *(int *)(lVar14 + 0x18)) {
    iVar8 = 0;
    do {
      uVar12 = func_0x041e65b8(lVar14,iVar8,*(undefined8 *)puVar2);
      if (lVar11 == 0) goto LAB_04d05364;
      uVar12 = func_0x053bbf78(lVar11,uVar12 >> 0x20,*(undefined8 *)puVar1);
      if ((uVar12 & 1) != 0) {
        fVar22 = (float)func_0x04d03610(auVar23._0_8_);
        iVar9 = func_0x041e65b8(lVar14,iVar8,*(undefined8 *)puVar2);
        uVar17 = func_0x041e65b8(lVar14,iVar8,*(undefined8 *)puVar2);
        uVar12 = 0x80000000;
        if (fVar22 * (float)iVar9 != INFINITY) {
          uVar12 = (ulong)(uint)(int)(fVar22 * (float)iVar9);
        }
        uVar12 = func_0x041e660c(lVar14,iVar8,uVar12 | uVar17 & 0xffffffff00000000,
                                 *(undefined8 *)puVar3);
      }
      iVar8 = iVar8 + 1;
