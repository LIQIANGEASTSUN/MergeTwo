/* Ghidra 12.1.2 native pseudocode; RVA 0x662BE34; Merger.Game.ViewModel.InventoryProducerViewModel.TryRemoveItem; status ok */
...
long * Merger_Game_ViewModel_InventoryProducerViewModel__TryRemoveItem
...

{
  ...
  func_0x060f4108(lVar9,param_2,1,0);
  if (plVar26 == (long *)0x0) {
    ...
    plVar26 = *(long **)(auVar30._0_8_ + 0xd0);
    if (plVar26 != (long *)0x0) {
      lVar9 = *plVar26;
      ...
      if (uVar22 != 0) {
        ...
        do {
          if (*(long *)(piVar23 + -2) == *(long *)PTR_DAT_07806898) {
            puVar10 = (undefined8 *)(lVar9 + (long)(*piVar23 + 6) * 0x10 + 0x138);
            goto LAB_0672bf58;
          }
          uVar22 = uVar22 - 1;
          piVar23 = piVar23 + 4;
...
LAB_0672bf58:
  ...
  if (lVar16 == 0) {
    auVar30 = func_0x03280cac();
    uVar27 = auVar30._8_8_;
    unaff_x22 = auVar30._0_8_;
    lVar9 = tpidr_el0;
    ...
    *(long *)((long)alStack_190 + lVar11 + 0xb0) = auVar30._0_8_;
    ...
    *(long *)((long)alStack_190 + lVar11 + 0x70) = auVar29._0_8_;
    *(long *)((long)alStack_190 + lVar11 + 0x78) = auVar29._8_8_;
    ppppuVar21 = pppppuVar17[7];
    lVar16 = lVar9;
    pppppuVar18 = pppppuVar17;
    if (ppppuVar21 == (undefined8 ****)0x0) {
    ...
    *(long *)((long)alStack_190 + lVar11 + 0x30) = auVar30._0_8_;
    *(long *)((long)alStack_190 + lVar11 + 0x38) = auVar30._8_8_;
    ppppuVar21 = pppppuVar18[7];
    if (ppppuVar21 == (undefined8 ****)0x0) {
      func_0x03280a18(PTR_DAT_07750ac8);
      func_0x03280a18(PTR_DAT_0774e558);
    ...
    *(long *)((long)alStack_1c0 + lVar11 + 0x20) = auVar29._0_8_;
    *(long *)((long)alStack_1c0 + lVar11 + 0x28) = auVar29._8_8_;
