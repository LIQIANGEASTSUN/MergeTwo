/* Ghidra 12.1.2 native pseudocode; RVA 0x6791FF0; MergeEngine.ECS.Systems.Items.TimeCycleSystem.OnWillProcessComponents; status ok */


long MergeEngine_ECS_Systems_Items_TimeCycleSystem__OnWillProcessComponents
...

{
  ...
  puVar10 = PTR_DAT_07810550;
  if ((bRam0000000007e28d70 & 1) == 0) {
    func_0x03280a18(PTR_DAT_07810558);
    func_0x03280a18(PTR_DAT_07810560);
    func_0x03280a18(PTR_DAT_077cd758);
    func_0x03280a18(PTR_DAT_07810568);
    func_0x03280a18(PTR_DAT_07810550);
    bRam0000000007e28d70 = 1;
  }
  lVar11 = *(long *)puVar10;
  ...
  puVar3 = PTR_DAT_07810560;
  puVar2 = PTR_DAT_07810558;
  ...
  if (lVar16 == 0) {
    ...
    lVar16 = func_0x03280ca0(*(undefined8 *)PTR_DAT_077cd758);
    param_4 = 0;
    func_0x05355fbc(lVar16,uVar17,*(undefined8 *)PTR_DAT_07810568);
    plVar12 = (long *)(*(long *)(*(long *)puVar10 + 0xb8) + 8);
    *plVar12 = lVar16;
    func_0x032809c4(plVar12,lVar16);
  }
  lVar15 = *(long *)puVar3;
  lVar11 = func_0x03d872a8(param_2,lVar16);
  lVar16 = *(long *)puVar2;
  ...
  if (lVar11 != 0) {
    ...
    func_0x04143d60(lVar15,lVar11,*(undefined8 *)(*(long *)(lVar16 + 0x38) + 0x10));
    return lVar15;
  }
  uVar17 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar17 = func_0x05ac7464(uVar17,0);
  auVar18 = func_0x03280b7c(uVar17,lVar16);
  ...
  if (auVar18._0_8_ != 0) {
    ...
    func_0x0419ce74(lVar16,auVar18._0_8_,*(undefined8 *)(*(long *)(lVar11 + 0x38) + 0x10));
    return lVar16;
  }
  uVar17 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar17 = func_0x05ac7464(uVar17,0);
  auVar19 = func_0x03280b7c(uVar17,lVar11);
  ...
  if (auVar19._0_8_ != 0) {
    ...
    lVar16 = func_0x03280ca0();
    func_0x041c2810(lVar16,auVar19._0_8_,*(undefined8 *)(*(long *)(lVar11 + 0x38) + 0x10));
    return lVar16;
  }
  uVar17 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar17 = func_0x05ac7464(uVar17,0);
  auVar18 = func_0x03280b7c(uVar17,lVar11);
  lVar11 = auVar18._8_8_;
  uStack_80 = 0x3d60144;
  auStack_70 = auVar19;
  if (*(long *)(lVar11 + 0x38) == 0) {
  ...
  if (auVar18._0_8_ != 0) {
    ...
    lVar16 = func_0x03280ca0();
    func_0x041ddb58(lVar16,auVar18._0_8_,*(undefined8 *)(*(long *)(lVar11 + 0x38) + 0x10));
    return lVar16;
  }
  uVar17 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar17 = func_0x05ac7464(uVar17,0);
  ...
  if (auVar19._0_8_ != 0) {
    ...
    lVar16 = func_0x03280ca0();
    func_0x041e617c(lVar16,auVar19._0_8_,*(undefined8 *)(*(long *)(lVar11 + 0x38) + 0x10));
    return lVar16;
  }
  uVar17 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar17 = func_0x05ac7464(uVar17,0);
  ...
  if (auVar18._0_8_ != 0) {
    ...
    lVar16 = func_0x03280ca0();
    func_0x041e8ba0(lVar16,auVar18._0_8_,*(undefined8 *)(*(long *)(lVar11 + 0x38) + 0x10));
    return lVar16;
  }
  uVar17 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar17 = func_0x05ac7464(uVar17,0);
  ...
  if (auVar19._0_8_ != 0) {
    ...
    lVar16 = func_0x03280ca0();
    (*(code *)**(undefined8 **)(*(long *)(lVar11 + 0x38) + 0x10))(lVar16,auVar19._0_8_);
    return lVar16;
  }
  uVar17 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar17 = func_0x05ac7464(uVar17,0);
  ...
  if (auVar18._0_8_ != 0) {
    ...
    lVar16 = func_0x03280ca0();
    func_0x0420cec8(lVar16,auVar18._0_8_,*(undefined8 *)(*(long *)(lVar11 + 0x38) + 0x10));
    return lVar16;
  }
  uVar17 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar17 = func_0x05ac7464(uVar17,0);
  ...
  if ((auVar19._0_8_ == 0) || (puVar10 = PTR_DAT_07779d18, auVar19._8_8_ == 0)) {
    uVar17 = func_0x03280a2c(puVar10);
    uVar17 = func_0x05ac7464(uVar17,0);
    auVar18 = func_0x03280b7c(uVar17,lVar15);
    ...
    if ((auVar19._0_8_ == 0) || (puVar10 = PTR_DAT_07779d18, auVar19._8_8_ == 0)) {
      uVar17 = func_0x03280a2c(puVar10);
      uVar17 = func_0x05ac7464(uVar17,0);
      auStack_198 = func_0x03280b7c(uVar17,lVar16);
      ...
      uVar17 = func_0x03280a2c(puVar10);
      uVar17 = func_0x05ac7464(uVar17,0);
      auVar19 = func_0x03280b7c(uVar17,lVar15);
      ...
      if ((auVar19._0_8_ == 0) || (puVar10 = PTR_DAT_07779d18, auVar19._8_8_ == 0)) {
        uVar17 = func_0x03280a2c(puVar10);
        uVar17 = func_0x05ac7464(uVar17,0);
        auVar20 = func_0x03280b7c(uVar17,param_4);
        auVar18._8_8_ = lVar9;
        ...
        uVar17 = func_0x03280a2c(puVar10);
        uVar7 = func_0x05ac7464(uVar17,0);
        uVar17 = 0x3d6068c;
...
LAB_03d60730:
  ...
  *(undefined8 *)((long)puVar6 + -0x30) = uVar17;
  ...
  *(long *)((long)puVar6 + -8) = lVar15;
  ...
  lVar15 = func_0x03280ca0();
  uVar17 = *(undefined8 *)(*(long *)(lVar11 + 0x38) + 8);
  func_0x0531ec78(lVar15,0xfffffffe);
  if (lVar15 != 0) {
    *(undefined8 *)(lVar15 + 0x40) = auVar19._0_8_;
    func_0x032809c4((undefined8 *)(lVar15 + 0x40),auVar19._0_8_);
    *(undefined8 *)(lVar15 + 0x50) = auVar19._8_8_;
    func_0x032809c4((undefined8 *)(lVar15 + 0x50),auVar19._8_8_);
  ...
  *(long *)((long)puVar6 + -0x38) = lVar8;
  ...
  lVar15 = func_0x03280ca0();
  puVar13 = *(undefined8 **)(*(long *)(lVar16 + 0x38) + 8);
  (*(code *)*puVar13)(lVar15,0xfffffffe);
  if (lVar15 != 0) {
    func_0x02f17738(lVar15,*(long *)(**(long **)(lVar16 + 0x38) + 0x80) + 0xc0,lVar11);
    func_0x02f17738(lVar15,*(long *)(**(long **)(lVar16 + 0x38) + 0x80) + 0x100,auVar18._8_8_);
    func_0x02f17738(lVar15,*(long *)(**(long **)(lVar16 + 0x38) + 0x80) + 0x80,uVar17);
    return lVar15;
  }
  auVar19 = func_0x03280cac();
  ...
  *(undefined8 *)((long)puVar6 + -0x68) = uVar17;
  puVar14 = puVar13;
  if (puVar13[7] == 0) {
    func_0x03256878(puVar13);
  }
  puVar10 = PTR_DAT_07774b08;
  if ((plVar12 == (long *)0x0) || (puVar10 = PTR_DAT_077799b8, lVar15 == 0)) {
    uVar17 = func_0x03280a2c(puVar10);
    uVar17 = func_0x05ac7464(uVar17,0);
    func_0x03280b7c(uVar17,puVar13);
LAB_03d60c04:
    ...
    if ((*(byte *)(lVar16 + 0x130) <= bVar1) &&
       (*(long *)(*(long *)(lVar8 + 200) + (ulong)*(byte *)(lVar16 + 0x130) * 8 + -8) == lVar16)) {
      lVar16 = *(long *)(puVar13[7] + 0x10);
      if ((*(byte *)(lVar16 + 0x135) & 1) == 0) {
         ...
         (*(long *)(*(long *)(lVar8 + 200) + (ulong)*(byte *)(lVar16 + 0x130) * 8 + -8) == lVar16))
      {
        ...
        if ((*(byte *)(lVar16 + 0x130) <= bVar1) &&
           (*(long *)(*(long *)(lVar8 + 200) + (ulong)*(byte *)(lVar16 + 0x130) * 8 + -8) == lVar16)
                    ...
                    /* WARNING: Treating indirect jump as call */
          lVar11 = (**(code **)(lVar8 + 0x228))(plVar12,lVar15,*(undefined8 *)(lVar8 + 0x230));
          return lVar11;
        }
      }
      goto LAB_03d60c04;
    ...
    lVar11 = func_0x03280b90(plVar12,lVar11);
    if (lVar11 == 0) {
      ...
      if ((*(byte *)(*plVar12 + 0x130) < *(byte *)(lVar11 + 0x130)) ||
        ...
        func_0x04b68fa4(lVar11,plVar12,lVar15,*(undefined8 *)(puVar13[7] + 0x58));
        return lVar11;
      }
      ...
      if ((*(byte *)(lVar16 + 0x130) <= *(byte *)(*plVar12 + 0x130)) &&
         (*(long *)(*(long *)(*plVar12 + 200) + (ulong)*(byte *)(lVar16 + 0x130) * 8 + -8) == lVar16
         )) {
        func_0x04b713b0(lVar11,plVar12,lVar15,*(undefined8 *)(puVar13[7] + 0x48));
        return lVar11;
      }
      goto LAB_03d60c04;
    }
  ...
  *(undefined1 (*) [16])((long)puVar6 + -0xa0) = auVar19;
  ...
  if ((plVar12 == (long *)0x0) || (puVar10 = PTR_DAT_077799b8, lVar15 == 0)) {
    uVar17 = func_0x03280a2c(puVar10);
    uVar17 = func_0x05ac7464(uVar17,0);
    func_0x03280b7c(uVar17,puVar14);
  }
  else {
    ...
    if ((bVar1 < *(byte *)(lVar11 + 0x130)) ||
      ...
      if ((*(byte *)(*plVar12 + 0x130) < *(byte *)(lVar11 + 0x130)) ||
        ...
        lVar11 = func_0x03280ca0();
        func_0x04b693d0(lVar11,plVar12,lVar15,*(undefined8 *)(puVar14[7] + 0x58));
        return lVar11;
      }
      ...
      {
        func_0x04b715c8(lVar11,plVar12,lVar15,*(undefined8 *)(puVar14[7] + 0x48));
        return lVar11;
      }
    }
    else {
  ...
  func_0x03281048(plVar12);
LAB_03d60ee0:
  lVar11 = func_0x03281048(plVar12,lVar16);
  ...
  *(undefined1 (*) [16])((long)puVar6 + -0xd0) = auVar18;
  ...
  if (lVar16 == 0) {
    ...
    **(long **)(lVar15 + 0xb8) = lVar16;
    ...
    func_0x032809c4(*(undefined8 *)(lVar11 + 0xb8),lVar16);
  }
  return lVar16;
}
