/* Ghidra 12.1.2 native pseudocode; RVA 0x666AC9C; MergeEngine.ECS.Systems.Board.BoardSystem.TrackMoveItemNotificationData; status ok */

ulong MergeEngine_ECS_Systems_Board_BoardSystem__TrackMoveItemNotificationData
...
LAB_0676ad7c:
    uVar6 = (*(code *)*puVar5)(plVar15,param_2,puVar5[1]);
    puVar3 = PTR_DAT_077e71c8;
    puVar2 = PTR_DAT_077e71c0;
    if ((param_2 != 0) && (plVar15 = *(long **)(param_1 + 0x70), plVar15 != (long *)0x0)) {
      lVar9 = *plVar15;
