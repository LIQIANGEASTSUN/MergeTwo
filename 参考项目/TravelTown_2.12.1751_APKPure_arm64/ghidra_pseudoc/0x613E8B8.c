/* Ghidra 12.1.2 native pseudocode; RVA 0x613E8B8; MergeEngine.Model.Configuration.MergingConfigurationModel.GetNextItemFromGraph; status ok */
...
void MergeEngine_Model_Configuration_MergingConfigurationModel__GetNextItemFromGraph
