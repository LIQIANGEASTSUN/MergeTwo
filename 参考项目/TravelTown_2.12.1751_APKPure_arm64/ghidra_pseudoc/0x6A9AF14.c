/* Ghidra 12.1.2 native pseudocode; RVA 0x6A9AF14; Merger.MergeBoard.Controller.BoardController.InitializeSystems; status ok */

void Merger_MergeBoard_Controller_BoardController__InitializeSystems(long param_1)
