/* Ghidra 12.1.2 native pseudocode; RVA 0x4C04AC4; MergeEngine.ECS.Systems.Items.BaseToolAnalysisSystem<T>.SelectRandomWeightedTool; status ok */
...
LAB_04d04dac:
  ...
  if ((uVar14 & 1) != 0) {
    uVar20 = MergeEngine_ECS_Systems_Items_BaseToolAnalysisSystem_T___FilterToolLevelsByChainProgress
  ...
  lVar11 = func_0x03f372e4(uVar20,lVar11,lVar12,*(undefined8 *)puVar1);
...
LAB_04d05364:
    ...
    *(undefined8 *)(uVar14 + 0x78) = uVar20;
    func_0x032809c4((undefined8 *)(uVar14 + 0x78),uVar20);
    uVar20 = func_0x03280ca0(*(undefined8 *)puVar5);
    func_0x04f610a8(uVar20,*(undefined8 *)puVar6);
    *(undefined8 *)(uVar14 + 0x80) = uVar20;
    func_0x032809c4((undefined8 *)(uVar14 + 0x80),uVar20);
    uVar20 = func_0x03280ca0(*(undefined8 *)puVar2);
    func_0x04f2ad28(uVar20,*(undefined8 *)puVar1);
    *(undefined8 *)(uVar14 + 0x88) = uVar20;
    func_0x032809c4((undefined8 *)(uVar14 + 0x88),uVar20);
    uVar20 = func_0x03280ca0(*(undefined8 *)puVar7);
    func_0x06898a68(uVar20,0);
    *(undefined8 *)(uVar14 + 0x90) = uVar20;
    func_0x032809c4((undefined8 *)(uVar14 + 0x90),uVar20);
    return uVar14;
  }
