/* Ghidra 12.1.2 native pseudocode; RVA 0x6A27FCC; MergeEngine.Configuration.Definitions.Reward.Equals; status ok */
...

{
  ...
  if (((lVar7 != 0) && (param_2 != 0)) && (*(long *)(param_2 + 0x18) != 0)) {
    iVar21 = *(int *)(lVar7 + 0x18);
    if (iVar21 == *(int *)(*(long *)(param_2 + 0x18) + 0x18)) {
      ...
      if (0 < iVar21) {
        ...
        do {
          ...
          if ((*(long *)(param_2 + 0x18) == 0) ||
             (uVar4 = func_0x0414419c(*(long *)(param_2 + 0x18),iVar21,*(undefined8 *)puVar24),
