/* Ghidra 12.1.2 native pseudocode; RVA 0x6A58B90; Merger.MergeBoardQueue.Models.BoardQueueModel.Dequeue; status ok */


/* WARNING: Possible PIC construction at 0x06b58c5c: Changing call to branch */
/* WARNING: Possible PIC construction at 0x06b58e08: Changing call to branch */
/* WARNING: Possible PIC construction at 0x06b58f18: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x06b58c60) */
/* WARNING: Removing unreachable block (ram,0x06b58e0c) */
/* WARNING: Removing unreachable block (ram,0x06b58f48) */
/* WARNING: Removing unreachable block (ram,0x06b58e10) */
/* WARNING: Removing unreachable block (ram,0x06b58e98) */
/* WARNING: Removing unreachable block (ram,0x06b58ea4) */
/* WARNING: Removing unreachable block (ram,0x06b58f1c) */
...
/* WARNING: Removing unreachable block (ram,0x06b58ec0) */
/* WARNING: Removing unreachable block (ram,0x06b58ec8) */
/* WARNING: Removing unreachable block (ram,0x06b58ed4) */

void Merger_MergeBoardQueue_Models_BoardQueueModel__Dequeue(long param_1)

{
  ...
  if ((bRam0000000007e2a60e & 1) == 0) {
    func_0x03280a18(PTR_DAT_07752c80);
    func_0x03280a18(PTR_DAT_07830370);
    func_0x03280a18(PTR_DAT_07830358);
    func_0x03280a18(PTR_DAT_07830378);
    func_0x03280a18(PTR_DAT_07830380);
    bRam0000000007e2a60e = 1;
  }
  lVar7 = func_0x06b58af0(param_1);
  if (lVar7 == 0) {
    return;
  }
  if (*(long *)(lVar7 + 0x10) != 0) {
    func_0x054f0d94(*(long *)(lVar7 + 0x10),lVar7,*(undefined8 *)PTR_DAT_07830378);
    if ((*(long *)(lVar7 + 0x28) != 0) && (*(long *)(param_1 + 0x38) != 0)) {
      func_0x053c1024(*(long *)(param_1 + 0x38),*(undefined8 *)(*(long *)(lVar7 + 0x28) + 0x20),
                      *(undefined8 *)PTR_DAT_07752c80);
      if (*(long *)(param_1 + 0x68) != 0) {
        func_0x04145af8(*(long *)(param_1 + 0x68),*(undefined8 *)(lVar7 + 0x28),
                        *(undefined8 *)PTR_DAT_07830380);
        goto SUB_032809c4;
      }
    }
  }
  ...
  if ((bRam0000000007e2a60f & 1) == 0) {
    func_0x03280a18(PTR_DAT_07752c80);
    func_0x03280a18(PTR_DAT_07830388);
    func_0x03280a18(PTR_DAT_07830380);
    bRam0000000007e2a60f = 1;
  }
  puVar4 = PTR_DAT_07830388;
  if (*(long *)(param_1 + 0x28) != 0) {
    uVar8 = func_0x054f0d40(*(long *)(param_1 + 0x28),lVar7,*(undefined8 *)PTR_DAT_07830388);
    if ((uVar8 & 1) == 0) {
      if (*(long *)(param_1 + 0x30) == 0) goto LAB_06b58d44;
      func_0x054f0d40(*(long *)(param_1 + 0x30),lVar7,*(undefined8 *)puVar4);
    }
    if ((lVar7 != 0) && (*(long *)(param_1 + 0x38) != 0)) {
      func_0x053c1024(*(long *)(param_1 + 0x38),*(undefined8 *)(lVar7 + 0x20),
                      *(undefined8 *)PTR_DAT_07752c80);
      if (*(long *)(param_1 + 0x68) != 0) {
        func_0x04145af8(*(long *)(param_1 + 0x68),lVar7,*(undefined8 *)PTR_DAT_07830380);
SUB_032809c4:
        uVar5 = func_0x06b585fc();
        *(undefined4 *)(param_1 + 0x4c) = uVar5;
        uVar6 = Merger_MergeBoardQueue_Models_BoardQueueModel__Peek(param_1);
...
LAB_06b58d44:
  func_0x03280cac();
  puVar4 = PTR_DAT_07830390;
  if ((bRam0000000007e2a610 & 1) == 0) {
    func_0x03280a18(PTR_DAT_07830398);
    func_0x03280a18(PTR_DAT_078303a0);
    func_0x03280a18(PTR_DAT_078303a8);
    func_0x03280a18(PTR_DAT_078303b0);
    func_0x03280a18(PTR_DAT_078303b8);
    func_0x03280a18(PTR_DAT_078303c0);
    func_0x03280a18(PTR_DAT_078303c8);
    func_0x03280a18(PTR_DAT_078303d0);
    func_0x03280a18(PTR_DAT_07830390);
    func_0x03280a18(PTR_DAT_078303d8);
    bRam0000000007e2a610 = 1;
  }
