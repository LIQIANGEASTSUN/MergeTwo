/* Ghidra 12.1.2 native pseudocode; RVA 0x666F98C; MergeEngine.ECS.Systems.Board.MergeSystem.TrySpawnConsumable; status ok */
...
void MergeEngine_ECS_Systems_Board_MergeSystem__TrySpawnConsumable
