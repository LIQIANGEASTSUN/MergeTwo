/* Ghidra 12.1.2 native pseudocode; RVA 0x665AC88; MergeEngine.ECS.Systems.Board.BoardIdleHintSystem.GetItemOnBoard; status ok */
...
void MergeEngine_ECS_Systems_Board_BoardIdleHintSystem__GetItemOnBoard(void)

{
  undefined *puVar1;
  
  puVar1 = PTR_DAT_078078a0;
  if ((bRam0000000007e28061 & 1) == 0) {
    func_0x03280a18(PTR_DAT_0777f908);
    func_0x03280a18(PTR_DAT_0777f910);
    func_0x03280a18(PTR_DAT_077cd808);
    func_0x03280a18(PTR_DAT_078078a8);
    func_0x03280a18(PTR_DAT_078078a0);
    bRam0000000007e28061 = 1;
  }
