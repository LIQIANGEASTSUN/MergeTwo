/* Ghidra 12.1.2 native pseudocode; RVA 0x6A63460; Merger.MergeBoardSkipCooldownCapability.Logic.SkipCooldownProvider.GetSkipCooldownPrice; status ok */
...
LAB_06b63504:
    ...
    dVar13 = (double)Merger_MergeBoardSkipCooldownCapability_Logic_SkipCooldownProvider__GetTimeLeft
                               (param_1,param_2);
...
LAB_06b63590:
    ...
    dVar14 = dVar13;
    if ((lVar6 != 0) && ((uVar8 & 1) != 0)) goto LAB_06b635e0;
  }
