/* Ghidra 12.1.2 native pseudocode; RVA 0x67898E0; MergeEngine.ECS.Systems.Items.BoardTileLevelUnlockSystem.add_UnlockCompleted; status ok */
...
void MergeEngine_ECS_Systems_Items_BoardTileLevelUnlockSystem__add_UnlockCompleted
...

{
  ...
  if ((bRam0000000007e28d32 & 1) == 0) {
    func_0x03280a18(PTR_DAT_0774e758);
    bRam0000000007e28d32 = 1;
  }
  puVar3 = PTR_DAT_0774e758;
  lVar8 = *(long *)(param_1 + 0x90);
  while ((plVar5 = (long *)func_0x057ddb20(lVar8,param_2,0), plVar5 == (long *)0x0 ||
         (*plVar5 == *(long *)puVar3))) {
    lVar6 = func_0x032dd140((long *)(param_1 + 0x90),plVar5,lVar8);
    bVar4 = lVar8 == lVar6;
    lVar8 = lVar6;
    if (bVar4) {
      return;
  ...
  auVar11 = func_0x03281048(plVar5);
  if ((bRam0000000007e28d33 & 1) == 0) {
    func_0x03280a18(PTR_DAT_0774e758);
    bRam0000000007e28d33 = 1;
  }
  puVar3 = PTR_DAT_0774e758;
  plVar5 = (long *)(auVar11._0_8_ + 0x90);
  lVar8 = *plVar5;
  while ((plVar7 = (long *)func_0x057ddd18(lVar8,auVar11._8_8_,0), plVar7 == (long *)0x0 ||
         (*plVar7 == *(long *)puVar3))) {
    lVar6 = func_0x032dd140(plVar5,plVar7,lVar8);
    bVar4 = lVar8 == lVar6;
    lVar8 = lVar6;
    if (bVar4) {
      return;
  ...
  lVar8 = func_0x03281048(plVar7);
  puVar3 = PTR_DAT_077e6ad0;
  ...
  uVar9 = func_0x03eb6c18(lVar8,*(undefined8 *)puVar3);
  puVar10 = (undefined8 *)(lVar8 + 0x78);
  *puVar10 = uVar9;
