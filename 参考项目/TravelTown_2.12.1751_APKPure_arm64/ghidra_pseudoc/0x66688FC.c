/* Ghidra 12.1.2 native pseudocode; RVA 0x66688FC; MergeEngine.ECS.Systems.Board.BoardSystem.OnBoardSwitchComplete; status ok */
...
void MergeEngine_ECS_Systems_Board_BoardSystem__OnBoardSwitchComplete(long param_1)

{
  ...
  puVar6 = PTR_DAT_077803f8;
  *(undefined8 *)(puVar1 + -0x50) = unaff_x30;
  *(undefined **)(puVar1 + -0x48) = unaff_x27;
  *(undefined **)(puVar1 + -0x40) = unaff_x26;
  *(undefined **)(puVar1 + -0x38) = unaff_x25;
  *(undefined **)(puVar1 + -0x30) = unaff_x24;
  *(long **)(puVar1 + -0x28) = unaff_x23;
  *(long *)(puVar1 + -0x20) = unaff_x22;
  ...
  *(undefined8 *)(puVar1 + -8) = unaff_x19;
  ...
  lVar3 = func_0x03eb6ac8(param_1,*(undefined8 *)puVar6);
  ...
  puVar15 = unaff_x27;
  if (lVar3 != 0) {
    plVar10 = (long *)func_0x04545bc8(lVar3,*(undefined8 *)PTR_DAT_077f0180);
    puVar15 = PTR_DAT_077e6760;
    puVar13 = PTR_DAT_077d75a0;
    puVar14 = PTR_DAT_077d7588;
    ...
    if (plVar10 != (long *)0x0) {
      do {
        ...
        puVar4 = (undefined8 *)func_0x03256b10(plVar10,*(long *)puVar12,0);
LAB_06768a40:
        ...
        puVar4 = (undefined8 *)func_0x03256b10(plVar10,*(long *)puVar13,0);
LAB_06768a9c:
        puVar5 = (undefined *)(*(code *)*puVar4)(plVar10,puVar4[1]);
        puVar6 = puVar5;
        if (puVar5 == (undefined *)0x0) goto LAB_06768b74;
        unaff_x22 = func_0x03ced81c(puVar5,*(undefined8 *)puVar14);
        puVar6 = (undefined *)func_0x03ced81c(puVar5,*(undefined8 *)puVar15);
        if (unaff_x22 == 0) goto LAB_06768b78;
        uVar2 = func_0x06769f80(param_1,*(undefined1 *)(unaff_x22 + 200),puVar6);
        if (puVar6 == (undefined *)0x0) goto LAB_06768b70;
        *(undefined4 *)(puVar6 + 0x4c) = uVar2;
      } while( true );
    }
    goto LAB_06768b80;
  }
...
LAB_06768b80:
  ...
  func_0x03280cac();
  while( true ) {
    auVar16 = func_0x03280ca4(param_1);
...
LAB_06768af4:
    if (plVar10 != (long *)0x0) {
      ...
      puVar4 = (undefined8 *)func_0x03256b10(plVar10,*plVar11,0);
LAB_06768b44:
  ...
  *(long *)(puVar1 + -0x58) = auVar16._0_8_;
  if (plVar10 != (long *)0x0) {
    lVar3 = *plVar10;
    uVar8 = (ulong)*(ushort *)(lVar3 + 0x12e);
    if (uVar8 != 0) {
...
LAB_06768c24:
  ...
  func_0x03365958(*(undefined8 *)(puVar1 + -0x58));
  func_0x03280ca4(0);
  func_0x02f09514();
  puVar5 = PTR_DAT_07807da0;
  *(undefined8 *)(puVar1 + -0xc0) = unaff_x29;
  *(undefined8 *)(puVar1 + -0xb8) = 0x6768c48;
  *(undefined8 *)(puVar1 + -0xb0) = unaff_x28;
  *(undefined **)(puVar1 + -0xa8) = puVar15;
  *(undefined **)(puVar1 + -0xa0) = puVar14;
  *(undefined **)(puVar1 + -0x98) = puVar13;
  *(undefined **)(puVar1 + -0x90) = puVar12;
  *(long **)(puVar1 + -0x88) = plVar11;
  *(long *)(puVar1 + -0x80) = unaff_x22;
  *(undefined **)(puVar1 + -0x78) = puVar6;
  *(undefined8 *)(puVar1 + -0x70) = 0;
  *(long **)(puVar1 + -0x68) = plVar10;
  ...
  func_0x03280ca0(*(undefined8 *)puVar5);
  return;
}
