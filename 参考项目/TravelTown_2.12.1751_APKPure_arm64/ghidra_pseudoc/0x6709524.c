/* Ghidra 12.1.2 native pseudocode; RVA 0x6709524; Merger.Game.Views.Inventory.InventoryProducerSlotView.Awake; status ok */
...
long * Merger_Game_Views_Inventory_InventoryProducerSlotView__Awake(long param_1)

{
  ...
  puVar5 = PTR_DAT_0780c658;
  lStack_48 = lVar20;
  pcStack_40 = (code *)lVar29;
  lStack_38 = param_1;
  if (lVar29 == 0) {
    lVar20 = func_0x03280cac();
    pcStack_40 = Merger_Game_Views_Inventory_InventoryProducerSlotView__ActivateNewBanner;
    lVar20 = *(long *)(lVar20 + 0x70);
    if (lVar20 != 0) {
      pcStack_50 = Merger_Game_Views_Inventory_InventoryProducerSlotView__ActivateNewBanner;
      pcStack_40 = (code *)lVar29;
      ...
      plVar24 = (long *)(*pcRam0000000007e2fbf0)(lVar20,1);
      return plVar24;
    }
...
LAB_069bab24:
    ...
    auVar37._8_8_ = lStack_58;
    auVar37._0_8_ = lStack_60;
    lVar20 = *(long *)(auVar35._0_8_ + 0x128);
    ...
    lVar21 = *(long *)(auVar36._0_8_ + 0x130);
    if (lVar21 != 0) {
    ...
    lVar20 = *(long *)(auVar35._0_8_ + 0x130);
    auVar36._8_8_ = auVar35._8_8_;
    auVar36._0_8_ = lVar20;
    if (lVar20 != 0) {
      plVar24 = *(long **)PTR_DAT_077eba08;
    ...
    lVar21 = *(long *)(auVar37._0_8_ + 0x138);
    if (lVar21 != 0) {
      lVar29 = *(long *)(lVar21 + 0x10);
      lVar23 = *(long *)PTR_DAT_0776a610;
      *(int *)(lVar21 + 0x1c) = *(int *)(lVar21 + 0x1c) + 1;
    ...
    lVar20 = *(long *)(auVar35._0_8_ + 0x138);
    auVar36._8_8_ = auVar35._8_8_;
    auVar36._0_8_ = lVar20;
    if (lVar20 == 0) {
      lVar20 = func_0x03280cac();
      ...
      if ((((uVar14 & 1) != 0) || (*(char *)(lVar20 + 0x192) != '\0')) ||
        ...
        fVar33 = *(float *)(lVar20 + 0x154);
        fVar34 = *(float *)(lVar20 + 0x158);
        plVar24 = *(long **)PTR_DAT_0774ee08;
        if ((int)plVar24[0x1c] == 0) {
          plVar24 = (long *)func_0x03280b8c();
        }
        if (50.0 < SQRT(fVar33 * fVar33 + fVar34 * fVar34)) {
          return plVar24;
        }
      }
...
SUB_04145af8:
    ...
    *(undefined8 *)((long)ppcVar8 + -0x20) = uVar13;
    *(undefined1 (*) [16])((long)ppcVar8 + -0x10) = auVar37;
    uVar10 = func_0x03f898d4(*(undefined8 *)(lVar20 + 0x10),auVar36._8_8_,0,
  ...
  *(int *)(lVar21 + 0x1c) = *(int *)(lVar21 + 0x1c) + 1;
  ...
  pcVar32 = pcStack_50;
SUB_0414446c:
  *(code **)((long)puVar7 + -0x30) = pcVar32;
  *(undefined8 **)((long)puVar7 + -0x20) = puVar12;
  *(long *)((long)puVar7 + -0x18) = lVar29;
  *(long *)((long)puVar7 + -0x10) = auVar35._0_8_;
...
LAB_041445ac:
  ...
  plVar22 = auVar35._8_8_;
  plVar16 = auVar35._0_8_;
  uVar10 = *(uint *)(plVar16 + 3);
  lVar20 = *(long *)(*(long *)(*(long *)(lVar21 + 0x20) + 0xc0) + 0x90);
  auVar37._8_8_ = plVar16;
  auVar37._0_8_ = lVar20;
  uVar14 = (ulong)uVar10;
  ppcVar8 = (code **)((long)puVar7 + -0xa0);
...
LAB_04145948:
      ...
      func_0x03280cac();
      do {
        auVar38 = func_0x03280ca4(uVar14);
        if (auVar38._8_4_ != 1) {
        ...
        puVar19 = (ulong *)func_0x072ce910(auVar38._0_8_);
        uVar14 = *puVar19;
