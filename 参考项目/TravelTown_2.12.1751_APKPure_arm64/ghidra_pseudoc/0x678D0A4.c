/* Ghidra 12.1.2 native pseudocode; RVA 0x678D0A4; MergeEngine.ECS.Systems.Items.ExpendableSystem.OnWillProcessComponents; status ok */


long MergeEngine_ECS_Systems_Items_ExpendableSystem__OnWillProcessComponents
...

{
  ...
  puVar10 = PTR_DAT_07810358;
  if ((bRam0000000007e28d50 & 1) == 0) {
    func_0x03280a18(PTR_DAT_07810360);
    func_0x03280a18(PTR_DAT_07810368);
    func_0x03280a18(PTR_DAT_07810370);
    func_0x03280a18(PTR_DAT_07810378);
    func_0x03280a18(PTR_DAT_07810358);
    bRam0000000007e28d50 = 1;
  }
  lVar11 = *(long *)puVar10;
  ...
  puVar3 = PTR_DAT_07810368;
  puVar2 = PTR_DAT_07810360;
  ...
  if (lVar16 == 0) {
    ...
    lVar16 = func_0x03280ca0(*(undefined8 *)PTR_DAT_07810370);
    param_4 = 0;
    func_0x05355fbc(lVar16,uVar17,*(undefined8 *)PTR_DAT_07810378);
