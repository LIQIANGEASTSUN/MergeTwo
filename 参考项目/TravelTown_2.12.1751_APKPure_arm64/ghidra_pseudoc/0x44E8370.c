/* Ghidra 12.1.2 native pseudocode; RVA 0x44E8370; MergeEngine.ECS.Components.SerializableComponent<TSerializable>.Serialize; status ok */
...

{
  ...
  if ((bRam0000000007e18ff5 & 1) == 0) {
    func_0x03280a18(PTR_DAT_0777b110);
    bRam0000000007e18ff5 = 1;
  }
  plVar6 = param_1 + 5;
  if (*plVar6 == 0) {
  ...
  if (plVar6 == (long *)0x0) {
    ...
    plVar6 = auVar8._0_8_;
    if ((bRam0000000007e18ff6 & 1) == 0) {
      func_0x03280a18(PTR_DAT_0777b110);
      bRam0000000007e18ff6 = 1;
    }
    plVar7 = plVar6 + 5;
    if (*plVar7 == 0) {
...
LAB_045e8478:
  lVar1 = func_0x03280b88(*(undefined8 *)(lVar1 + 8),lVar5);
                    /* WARNING: Could not recover jumptable at 0x045e849c. Too many branches */
