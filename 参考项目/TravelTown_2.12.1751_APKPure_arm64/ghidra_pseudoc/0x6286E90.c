/* Ghidra 12.1.2 native pseudocode; RVA 0x6286E90; MergeEngine.ECS.Systems.InventorySystem.UpdateSlots; status ok */

/* WARNING: Removing unreachable block (ram,0x063885ac) */

void MergeEngine_ECS_Systems_InventorySystem__UpdateSlots(long param_1,undefined8 param_2)

{
  ...
  func_0x0638771c();
  func_0x06387af8(param_1,param_2);
  func_0x06387fe8(param_1,param_2);
