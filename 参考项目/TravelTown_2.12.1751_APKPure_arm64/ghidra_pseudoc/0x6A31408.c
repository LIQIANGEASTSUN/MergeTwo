/* Ghidra 12.1.2 native pseudocode; RVA 0x6A31408; Merger.MergeBoard.ViewModel.ImmediateToolsGrantViewModel.GetToolResource; status ok */


undefined1  [16]
Merger_MergeBoard_ViewModel_ImmediateToolsGrantViewModel__GetToolResource
          (long param_1,undefined8 param_2,ulong param_3,uint param_4,ulong param_5,uint param_6)
...
LAB_06b314a4:
    param_3 = puVar3[1];
    uVar4 = (*(code *)*puVar3)(plVar8,param_2);
...
LAB_06b31514:
      ...
      auVar9 = (*(code *)*puVar3)(plVar8,uVar4,puVar3[1]);
      return auVar9;
    }
  }
...
LAB_06b31754:
                    ...
                    /* WARNING: Treating indirect jump as call */
      auVar9 = (*(code *)*puVar3)(extraout_d0,plVar8,extraout_x1 & 0xffffffff,puVar3[1]);
      return auVar9;
    }
    lVar5 = *plVar8;
    uVar6 = (ulong)*(ushort *)(lVar5 + 0x12e);
...
LAB_06b31684:
                    ...
                    /* WARNING: Treating indirect jump as call */
    auVar9 = (*(code *)*puVar3)(plVar8,auVar9._8_8_,param_3 & 0xffffffff,param_4 & 1,
...
LAB_06b315c0:
                    ...
                    /* WARNING: Treating indirect jump as call */
  auVar9 = (*(code *)*puVar3)(plVar8,auVar9._8_8_ & 0xffffffff,puVar3[1]);
  return auVar9;
}
