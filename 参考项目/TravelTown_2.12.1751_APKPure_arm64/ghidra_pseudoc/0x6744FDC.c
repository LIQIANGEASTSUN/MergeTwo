/* Ghidra 12.1.2 native pseudocode; RVA 0x6744FDC; Merger.Game.Views.Board.BoardQueueView2.ResetRewardTargets; status ok */


void Merger_Game_Views_Board_BoardQueueView2__ResetRewardTargets(long param_1)
