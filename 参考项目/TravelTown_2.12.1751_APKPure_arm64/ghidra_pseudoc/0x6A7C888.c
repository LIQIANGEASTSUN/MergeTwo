/* Ghidra 12.1.2 native pseudocode; RVA 0x6A7C888; Merger.MergeBoard.Models.ItemsDiscoveryModel.IsItemDiscovered; status ok */
...
ulong Merger_MergeBoard_Models_ItemsDiscoveryModel__IsItemDiscovered
...

{
  ...
  if (param_2 != 0) {
    return (ulong)(*(int *)(param_2 + 0x10) != 0);
  }
  auVar10 = func_0x03280cac();
  pcStack_30 = Merger_MergeBoard_Models_ItemsDiscoveryModel__IsItemCreated;
  ...
  if (lVar3 != 0) {
    ...
    if (lStack_38 != 0) {
      return (ulong)((*(uint *)(lStack_38 + 0x10) & 0xfffffffe) == 2);
    }
  }
  func_0x03280cac();
  pcStack_50 = Merger_MergeBoard_Models_ItemsDiscoveryModel__IsItemCreated;
  if (extraout_x1 != 0) {
    return (ulong)((*(uint *)(extraout_x1 + 0x10) & 0xfffffffe) == 2);
  }
  auVar11 = func_0x03280cac();
  alStack_78[1] = 0x6b7c95c;
  ...
  if (lVar3 != 0) {
    ...
    if (alStack_78[0] != 0) {
      return (ulong)(*(int *)(alStack_78[0] + 0x10) == 2);
    }
  }
  func_0x03280cac();
  uStack_90 = 0x6b7c9e8;
  ...
  auVar10 = func_0x03280cac();
  alStack_b8[1] = 0x6b7ca08;
  alStack_b8[2] = 0x7e2a000;
  auStack_a0 = auVar11;
  ...
  lVar3 = *(long *)(auVar10._0_8_ + 0x28);
  if (lVar3 != 0) {
    uVar4 = func_0x04fe48b0(lVar3,auVar10._8_8_,alStack_b8,*(undefined8 *)PTR_DAT_078318e0);
    if ((uVar4 & 1) == 0) {
      return 0;
    }
    if (alStack_b8[0] != 0) {
      return (ulong)(*(int *)(alStack_b8[0] + 0x10) == 3);
    }
  }
  func_0x03280cac();
  if (extraout_x1_01 != 0) {
...
LAB_06b7cb84:
    ...
    if (lVar9 != 0) {
      uVar4 = func_0x04fe48b0(lVar9,uVar6,&lStack_f8,*(undefined8 *)PTR_DAT_078318e0);
      puVar2 = PTR_DAT_078318f0;
      if ((uVar4 & 1) != 0) {
        if (lStack_f8 == 0) goto LAB_06b7cd6c;
