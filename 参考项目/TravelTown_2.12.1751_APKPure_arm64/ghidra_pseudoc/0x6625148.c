/* Ghidra 12.1.2 native pseudocode; RVA 0x6625148; Merger.Game.ViewModel.BoardViewModel.GetBehaviourDataByType; status ok */


undefined1  [16] Merger_Game_ViewModel_BoardViewModel__GetBehaviourDataByType(long param_1)
