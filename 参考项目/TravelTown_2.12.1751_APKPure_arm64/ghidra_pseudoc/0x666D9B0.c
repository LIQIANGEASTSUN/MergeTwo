/* Ghidra 12.1.2 native pseudocode; RVA 0x666D9B0; MergeEngine.ECS.Systems.Board.MergeSystem.CanCombineItems; status ok */
...

{
  ...
  if ((param_2 == 0) ||
     ...
     param_3 == 0)) {
    unaff_x22 = puVar6;
    unaff_x30 = MergeEngine_ECS_Systems_Board_MergeSystem__CanMerge;
...
LAB_0636f4ac:
      ...
      *(undefined8 *)(puVar7 + -0x50) = 0x636f4cc;
