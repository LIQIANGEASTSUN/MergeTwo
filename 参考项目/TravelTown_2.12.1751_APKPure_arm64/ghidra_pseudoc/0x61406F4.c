/* Ghidra 12.1.2 native pseudocode; RVA 0x61406F4; MergeEngine.Model.Configuration.MergingConfigurationModel.IsPrimaryProducer; status ok */
...

{
  ...
  if (param_2 != (long *)0x0) {
    ...
    puVar4 = (undefined8 *)func_0x03256b10(param_2,*(long *)PTR_DAT_0777c248,0xf);
LAB_06b1d880:
    ...
    if (iVar3 == 4) {
      ...
      puVar4 = (undefined8 *)func_0x03256b10(param_2,*(long *)puVar1,0xf);
LAB_06b1d8ec:
      iVar3 = (*(code *)*puVar4)(param_2,puVar4[1]);
