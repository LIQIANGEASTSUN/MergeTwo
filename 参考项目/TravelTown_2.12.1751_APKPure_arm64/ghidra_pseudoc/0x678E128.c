/* Ghidra 12.1.2 native pseudocode; RVA 0x678E128; MergeEngine.ECS.Systems.Items.ExpendableSystem.TrySpawnItems; status ok */
...
void MergeEngine_ECS_Systems_Items_ExpendableSystem__TrySpawnItems(void)

{
  undefined *puVar1;
  
  puVar1 = PTR_DAT_07810410;
  if ((bRam0000000007e28d52 & 1) == 0) {
    ...
    func_0x03280a18(PTR_DAT_07810418);
    func_0x03280a18(PTR_DAT_07810410);
    bRam0000000007e28d52 = 1;
  }
