/* Ghidra 12.1.2 native pseudocode; RVA 0x465482C; MergeEngine.Util.TwoDArray<T>.ForEach; status ok */
...
undefined8 *
MergeEngine_Util_TwoDArray_T___ForEach(undefined8 param_1,undefined8 param_2,long param_3)

{
  ...
  lVar9 = *(long *)(*(long *)(*(long *)(param_3 + 0x20) + 0xc0) + 0x40);
  if ((*(byte *)(lVar9 + 0x135) & 1) == 0) {
    lVar9 = func_0x0325681c(lVar9);
  }
  lVar9 = func_0x03280ca0(lVar9);
  func_0x0403f7a0(lVar9,*(undefined8 *)(*(long *)(*(long *)(param_3 + 0x20) + 0xc0) + 0x48));
  if (lVar9 != 0) {
  ...
  if (*(long *)(lVar9 + 0x10) == 0) {
    ...
    if (plVar13 != (long *)0x0) {
      ...
      if (uVar11 != 0) {
        ...
        do {
          if (*(long *)(piVar12 + -2) == *(long *)PTR_DAT_0777ecf8) {
      ...
      puVar6 = (undefined8 *)func_0x03256b10(plVar13,*(long *)PTR_DAT_0777ecf8,0);
LAB_04754990:
      ...
      if (plVar13 == (long *)0x0) {
        ...
        puVar4 = PTR_DAT_0777ade8;
        lVar9 = auVar14._8_8_;
        if ((bRam0000000007e196de & 1) == 0) {
          func_0x03280a18(PTR_DAT_0777ade8);
          bRam0000000007e196de = 1;
        }
        func_0x057da5fc(auVar14._0_8_,0);
        if (*(int *)(*(long *)puVar4 + 0xe0) == 0) {
          func_0x03280b8c();
        }
        uVar7 = func_0x03e5fe58(*(undefined8 *)(*(long *)(*(long *)(lVar9 + 0x20) + 0xc0) + 0x18));
        lVar10 = *(long *)(*(long *)(*(long *)(lVar9 + 0x20) + 0xc0) + 0x10);
        if ((*(byte *)(lVar10 + 0x135) & 1) == 0) {
          lVar10 = func_0x0325681c(lVar10);
        }
        uVar8 = func_0x03280b90(uVar7,lVar10);
        puVar6 = (undefined8 *)(auVar14._0_8_ + 0x20);
        *puVar6 = uVar8;
        lVar9 = *(long *)(*(long *)(*(long *)(lVar9 + 0x20) + 0xc0) + 0x10);
        if ((*(byte *)(lVar9 + 0x135) & 1) == 0) {
          lVar9 = func_0x0325681c(lVar9);
        }
        func_0x03280b90(uVar7,lVar9);
        goto SUB_032809c4;
      }
      lVar10 = *plVar13;
      uVar11 = (ulong)*(ushort *)(lVar10 + 0x12e);
      ...
      puVar6 = (undefined8 *)func_0x03256b10(plVar13,*(long *)puVar4,0);
LAB_04754a00:
      puVar6 = (undefined8 *)(*(code *)*puVar6)(plVar13,puVar6[1]);
      if ((int)puVar6 == 1) {
        return puVar6;
      }
    }
    puVar6 = (undefined8 *)(ulong)(*(long *)(lVar9 + 0x18) != 0);
  }
  else {
