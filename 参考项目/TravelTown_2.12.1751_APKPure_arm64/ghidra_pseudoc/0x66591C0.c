/* Ghidra 12.1.2 native pseudocode; RVA 0x66591C0; MergeEngine.ECS.Systems.Board.BoardIdleHintSystem.ItemProduced; status ok */
...
void MergeEngine_ECS_Systems_Board_BoardIdleHintSystem__ItemProduced(long param_1)
