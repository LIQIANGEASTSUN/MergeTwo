/* Ghidra 12.1.2 native pseudocode; RVA 0x662B038; Merger.Game.ViewModel.InventoryItemsViewModel.GetItem; status ok */
...
long * Merger_Game_ViewModel_InventoryItemsViewModel__GetItem
...

{
  ...
  if (plVar14 != (long *)0x0) {
    ...
    puVar5 = (undefined8 *)func_0x03256b10(plVar14,*(long *)PTR_DAT_07806898,6);
LAB_0672b0c8:
...
LAB_0672b178:
                    ...
                    /* WARNING: Treating indirect jump as call */
    plVar14 = (long *)(*(code *)*puVar5)(plVar14,auVar15._8_8_ & 0xffffffff,0,puVar5[1]);
    return plVar14;
  }
