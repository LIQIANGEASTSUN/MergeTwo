/* Ghidra 12.1.2 native pseudocode; RVA 0x68FDEBC; MergeEngine.ECS.Components.Items.StackingComponent.IncrementStackSize; status ok */


void MergeEngine_ECS_Components_Items_StackingComponent__IncrementStackSize
