/* Ghidra 12.1.2 native pseudocode; RVA 0x613B650; MergeEngine.Model.Configuration.DynamicMergeItemConfigurationModel.GetDynamicMergeItemFromComponent; status ok */


/* WARNING: Possible PIC construction at 0x0623b800: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x0623b804) */
/* WARNING: Removing unreachable block (ram,0x0623b808) */
/* WARNING: Removing unreachable block (ram,0x0623b840) */
/* WARNING: Removing unreachable block (ram,0x0623b8b0) */
/* WARNING: Removing unreachable block (ram,0x0623b848) */
...
/* WARNING: Removing unreachable block (ram,0x0623b82c) */

undefined8
MergeEngine_Model_Configuration_DynamicMergeItemConfigurationModel__GetDynamicMergeItemFromComponent
...

{
  ...
  if ((bRam0000000007e2458e & 1) == 0) {
    func_0x03280a18(PTR_DAT_077db140);
    func_0x03280a18(PTR_DAT_077db148);
    bRam0000000007e2458e = 1;
  }
  uStack_28 = 0;
  if (param_2 == (long *)0x0) {
LAB_0623b780:
    func_0x03280cac();
    puVar1 = PTR_DAT_077db150;
    if ((bRam0000000007e2458f & 1) == 0) {
      func_0x03280a18(PTR_DAT_077db158);
      func_0x03280a18(PTR_DAT_077db160);
      func_0x03280a18(PTR_DAT_07780058);
      func_0x03280a18(PTR_DAT_077db168);
      func_0x03280a18(PTR_DAT_077db150);
      bRam0000000007e2458f = 1;
    }
    uVar2 = func_0x03280ca0(*(undefined8 *)puVar1);
    return uVar2;
  }
  lVar3 = *param_2;
  lVar6 = *(long *)PTR_DAT_077db148;
  ...
  lVar3 = func_0x03256b10(param_2);
LAB_0623b6f4:
  lVar3 = func_0x03280b88(*(undefined8 *)(lVar3 + 8),lVar6);
  lVar3 = (**(code **)(lVar3 + 8))(param_2,lVar3);
  uVar2 = 0;
  if (lVar3 != 0) {
    uVar2 = func_0x069fc058(lVar3,0);
    uVar4 = func_0x055f7aac(uVar2,0);
    uVar2 = 0;
    if ((uVar4 & 1) == 0) {
      lVar6 = *(long *)(param_1 + 0x28);
      uVar2 = func_0x069fc058(lVar3,0);
      if (lVar6 == 0) goto LAB_0623b780;
      uVar4 = func_0x04fe48b0(lVar6,uVar2,&uStack_28,*(undefined8 *)PTR_DAT_077db140);
      uVar2 = uStack_28;
      if ((uVar4 & 1) == 0) {
        uVar2 = 0;
      }
