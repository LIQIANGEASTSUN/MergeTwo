/* Ghidra 12.1.2 native pseudocode; RVA 0x6731040; Merger.Game.Views.BoardItem.BoardItemView2.OnEnable; status ok */

void Merger_Game_Views_BoardItem_BoardItemView2__OnEnable(long *param_1)
