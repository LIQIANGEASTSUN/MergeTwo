/* Ghidra 12.1.2 native pseudocode; RVA 0x666DBEC; MergeEngine.ECS.Systems.Board.MergeSystem.ShouldVerifyMerge; status ok */

/* WARNING: Possible PIC construction at 0x0676dd90: Changing call to branch */
/* WARNING: Possible PIC construction at 0x06b1dd70: Changing call to branch */
/* WARNING: Possible PIC construction at 0x0676df88: Changing call to branch */
...
/* WARNING: Removing unreachable block (ram,0x0676df8c) */
/* WARNING: Removing unreachable block (ram,0x0676dfe8) */
...
/* WARNING: Removing unreachable block (ram,0x0676dd94) */
/* WARNING: Removing unreachable block (ram,0x0676ddb0) */
/* WARNING: Removing unreachable block (ram,0x06770360) */
/* WARNING: Removing unreachable block (ram,0x06770364) */

undefined8 *
MergeEngine_ECS_Systems_Board_MergeSystem__ShouldVerifyMerge
...

{
  ...
  plVar18 = param_3;
  if ((bRam0000000007e28110 & 1) == 0) {
    func_0x03280a18(PTR_DAT_0777a498);
    func_0x03280a18(PTR_DAT_0777a750);
    bRam0000000007e28110 = 1;
  }
  ...
  if (plVar24 != (long *)0x0) {
    ...
    if (uVar22 != 0) {
      ...
      do {
        if (*(long *)(piVar23 + -2) == *(long *)PTR_DAT_0777a750) {
          puVar11 = (undefined8 *)(lVar19 + (long)(*piVar23 + 0x22) * 0x10 + 0x138);
          goto LAB_0676dc94;
        }
        uVar22 = uVar22 - 1;
        piVar23 = piVar23 + 4;
...
LAB_0676dc94:
    uVar8 = (*(code *)*puVar11)(plVar24,puVar11[1]);
    puVar4 = PTR_DAT_0777a498;
    if ((uVar8 & 1) == 0) {
      return (undefined8 *)(ulong)(uVar8 & 1);
    }
    ...
    if (unaff_x23 != (long *)0x0) {
      ...
      if (uVar22 != 0) {
        ...
        do {
          if (*(long *)(piVar23 + -2) == *(long *)PTR_DAT_0777a498) {
            puVar11 = (undefined8 *)(lVar19 + (long)(*piVar23 + 0x14) * 0x10 + 0x138);
            goto LAB_0676dd08;
          }
          uVar22 = uVar22 - 1;
          piVar23 = piVar23 + 4;
      ...
      puVar11 = (undefined8 *)func_0x03256b10(unaff_x23,*(long *)PTR_DAT_0777a498,0x14);
LAB_0676dd08:
      plVar18 = (long *)puVar11[1];
      plVar12 = (long *)(*(code *)*puVar11)(unaff_x23,param_2);
      ...
      if (plVar24 != (long *)0x0) {
        ...
        if (uVar22 != 0) {
          ...
          do {
            if (*(long *)(piVar23 + -2) == lVar19) {
              puVar11 = (undefined8 *)(lVar20 + (long)(*piVar23 + 0x14) * 0x10 + 0x138);
              goto LAB_0676dd74;
            }
            uVar22 = uVar22 - 1;
            piVar23 = piVar23 + 4;
        ...
        puVar11 = (undefined8 *)func_0x03256b10(plVar24,lVar19,0x14);
LAB_0676dd74:
        (*(code *)*puVar11)(plVar24,param_3,puVar11[1]);
        ...
        if (plVar12 != (long *)0x0) {
          ...
          if (uVar22 != 0) {
            ...
            do {
              if (*(long *)(piVar23 + -2) == *(long *)PTR_DAT_0777e548) {
                puVar11 = (undefined8 *)(lVar19 + (long)(*piVar23 + 7) * 0x10 + 0x138);
                goto LAB_06b1d998;
              }
              uVar22 = uVar22 - 1;
              piVar23 = piVar23 + 4;
          ...
          puVar11 = (undefined8 *)func_0x03256b10(plVar12,*(long *)PTR_DAT_0777e548,7);
LAB_06b1d998:
          lVar19 = (*(code *)*puVar11)(plVar12,puVar11[1]);
          if (lVar19 != 0) {
            return (undefined8 *)(ulong)(*(int *)(lVar19 + 0x14) == 1);
          }
        }
        ...
        if (plVar18 != (long *)0x0) {
          ...
          if (uVar22 != 0) {
            ...
            do {
              if (*(long *)(piVar23 + -2) == *(long *)PTR_DAT_0777e548) {
                puVar11 = (undefined8 *)(lVar19 + (long)(*piVar23 + 0x10) * 0x10 + 0x138);
                goto LAB_06b1da4c;
              }
              uVar22 = uVar22 - 1;
              piVar23 = piVar23 + 4;
          ...
          puVar11 = (undefined8 *)func_0x03256b10(plVar18,*(long *)PTR_DAT_0777e548,0x10);
LAB_06b1da4c:
          lVar19 = (*(code *)*puVar11)(plVar18,puVar11[1]);
          if (lVar19 != 0) {
            if (*(char *)(lVar19 + 0x10) == '\0') {
              ...
              puVar11 = (undefined8 *)func_0x03256b10(plVar18,*(long *)puVar4,7);
LAB_06b1dabc:
              lVar19 = (*(code *)*puVar11)(plVar18,puVar11[1]);
              if (lVar19 == 0) goto LAB_06b1dae4;
              puVar11 = (undefined8 *)(ulong)(*(int *)(lVar19 + 0x14) == 4);
            }
            return puVar11;
          }
        }
LAB_06b1dae4:
        ...
        if (plVar18 != (long *)0x0) {
          ...
          if (uVar22 != 0) {
            ...
            do {
              if (*(long *)(piVar23 + -2) == *(long *)PTR_DAT_0777e548) {
                puVar11 = (undefined8 *)(lVar19 + (long)(*piVar23 + 0x1b) * 0x10 + 0x138);
                goto LAB_06b1db7c;
              }
              uVar22 = uVar22 - 1;
              piVar23 = piVar23 + 4;
          ...
          puVar11 = (undefined8 *)func_0x03256b10(plVar18,*(long *)PTR_DAT_0777e548,0x1b);
LAB_06b1db7c:
          ...
          if (plVar12 != (long *)0x0) {
            ...
            if (uVar22 != 0) {
              piVar23 = (int *)(*(long *)(lVar19 + 0xb0) + 8);
              do {
                if (*(long *)(piVar23 + -2) == *(long *)PTR_DAT_0777c248) {
                  puVar11 = (undefined8 *)(lVar19 + (long)(*piVar23 + 0xf) * 0x10 + 0x138);
                  goto LAB_06b1dbe8;
                }
                uVar22 = uVar22 - 1;
                piVar23 = piVar23 + 4;
            ...
            puVar11 = (undefined8 *)func_0x03256b10(plVar12,*(long *)PTR_DAT_0777c248,0xf);
LAB_06b1dbe8:
            ...
            if (iVar9 == 8) {
              ...
              if (uVar22 != 0) {
                ...
                do {
                  if (*(long *)(piVar23 + -2) == lVar19) {
                    puVar11 = (undefined8 *)(lVar20 + (long)(*piVar23 + 0x1a) * 0x10 + 0x138);
                    goto LAB_06b1dc54;
                  }
                  uVar22 = uVar22 - 1;
                  piVar23 = piVar23 + 4;
              ...
              puVar11 = (undefined8 *)func_0x03256b10(plVar18,lVar19,0x1a);
LAB_06b1dc54:
              lVar19 = (*(code *)*puVar11)(plVar18,puVar11[1]);
              puVar11 = (undefined8 *)(ulong)(lVar19 != 0);
            }
            else {
              puVar11 = (undefined8 *)0x0;
            }
        ...
        plStack_d0 = (long *)0x6b1dc78;
        uStack_b0 = 0x7e2a000;
        auStack_c8._8_8_ = (ulong)uVar8;
        plStack_b8 = plVar24;
        plStack_a8 = plVar18;
        ...
        puVar5 = PTR_DAT_0782ea90;
        puVar4 = PTR_DAT_0774f828;
        plVar18 = *(long **)(lVar19 + 0x10);
        if (plVar18 == (long *)0x0) {
          lVar20 = func_0x03280cac();
          puVar4 = PTR_DAT_0777e4f0;
          uStack_e0 = 0x7e2a000;
          plStack_d8 = (long *)lVar19;
          ...
          func_0x061049d8(uVar16,0);
          puVar11 = (undefined8 *)(lVar20 + 0x10);
          *puVar11 = uVar16;
          if (iRam00000000080486b8 != 0) {
            puVar2 = (ulong *)(((ulong)puVar11 >> 0x12 & 0x7fff) * 8 + 0x7e7c690);
            do {
              cVar3 = '\x01';
              bVar7 = (bool)ExclusiveMonitorPass(puVar2,0x10);
              if (bVar7) {
                *puVar2 = *puVar2 | 1L << ((ulong)puVar11 >> 0xc & 0x3f);
        ...
        uVar16 = (**(code **)(*plVar18 + 0x1c8))(plVar18,*(undefined8 *)(*plVar18 + 0x1d0));
        auStack_c8._4_4_ = *(undefined4 *)(lVar19 + 0x18);
        uVar17 = func_0x03280b94(*(undefined8 *)puVar4,auStack_c8 + 4);
        puVar11 = (undefined8 *)func_0x055f7edc(*(undefined8 *)puVar5,uVar16,uVar17,0);
        return puVar11;
      }
    }
  }
  ...
  uStack_a0 = 0x676ddd0;
  plVar24 = plVar18;
  if ((bRam0000000007e28111 & 1) == 0) {
    func_0x03280a18(PTR_DAT_077f1510);
    func_0x03280a18(PTR_DAT_077e6888);
    func_0x03280a18(PTR_DAT_0777a498);
    func_0x03280a18(PTR_DAT_078080d0);
    func_0x03280a18(PTR_DAT_078080d8);
    func_0x03280a18(PTR_DAT_078080e0);
    bRam0000000007e28111 = 1;
  }
  puVar4 = PTR_DAT_077e6888;
  plVar12 = (long *)0x7e28000;
  if (lVar20 != 0) {
    plVar13 = (long *)func_0x03ced81c(lVar20,*(undefined8 *)PTR_DAT_077e6888);
    auVar27._8_8_ = plVar13;
    auVar27._0_8_ = lVar19;
    unaff_x23 = (long *)puVar4;
    if (plVar18 != (long *)0x0) {
      plVar14 = (long *)func_0x03ced81c(plVar18,*(undefined8 *)puVar4);
      puVar4 = PTR_DAT_0777a498;
      unaff_x24 = *(long **)(lVar19 + 0x40);
      plVar12 = plVar13;
      if (unaff_x24 != (long *)0x0) {
        ...
        puVar11 = (undefined8 *)func_0x03256b10(unaff_x24,*(long *)PTR_DAT_0777a498,0x14);
LAB_0676dee4:
        plVar24 = (long *)puVar11[1];
        plVar15 = (long *)(*(code *)*puVar11)(unaff_x24,lVar20);
        ...
        if (plVar25 != (long *)0x0) {
          ...
          puVar11 = (undefined8 *)func_0x03256b10(plVar25,*(long *)puVar4,0x14);
LAB_0676df68:
          (*(code *)*puVar11)(plVar25,plVar18,puVar11[1]);
          uVar16 = 0x676df8c;
          param_4 = plVar18;
          plVar18 = plVar14;
          goto SUB_0676e0ec;
  ...
  if (auVar27._8_8_ != 0) {
    uVar16 = func_0x03ced81c(auVar27._8_8_,*(undefined8 *)PTR_DAT_077e6888);
    plVar18 = (long *)puVar4;
    if (plVar24 != (long *)0x0) {
      uVar17 = func_0x03ced81c(plVar24,*(undefined8 *)puVar4);
      uVar22 = MergeEngine_ECS_Systems_Board_MergeSystem__TryMergeItems
                         (auVar27._0_8_,uVar16,uVar17,plVar24[6]);
      if ((uVar22 & 1) == 0) {
        uVar8 = 0;
      }
        ...
        uVar8 = 1;
        (*(code *)param_4[3])(param_4[8],1,1,0,param_4[5]);
      }
...
SUB_0676e0ec:
  lVar19 = auVar26._0_8_;
  *(undefined8 *)((long)puVar6 + -0x20) = uVar16;
  *(long *)((long)puVar6 + -0x18) = auVar27._0_8_;
  *(long *)((long)puVar6 + -0x10) = auVar26._8_8_;
  *(long **)((long)puVar6 + -8) = param_4;
  puVar11 = (undefined8 *)func_0x06770014();
  if ((puVar11 != (undefined8 *)0x0) ||
     (puVar11 = (undefined8 *)func_0x06770128(lVar19,plVar13,plVar14), puVar11 != (undefined8 *)0x0)
     ) {
    return puVar11;
  }
  *(undefined8 *)((long)puVar6 + -0x30) = *(undefined8 *)((long)puVar6 + -0x20);
  *(long *)((long)puVar6 + -0x20) = auVar27._8_8_;
  *(undefined8 *)((long)puVar6 + -0x18) = *(undefined8 *)((long)puVar6 + -0x18);
  *(undefined8 *)((long)puVar6 + -0x10) = *(undefined8 *)((long)puVar6 + -0x10);
  *(undefined8 *)((long)puVar6 + -8) = *(undefined8 *)((long)puVar6 + -8);
  ...
  uVar22 = func_0x0636f334(plVar13,plVar14,*(undefined8 *)(lVar19 + 0x40),0);
  if ((uVar22 & 1) == 0) {
  ...
  if (plVar13 != (long *)0x0) {
    ...
    if (((plVar14 != (long *)0x0) &&
        (lVar20 = func_0x03ced81c(plVar14,*(undefined8 *)PTR_DAT_0777bf98), lVar20 != 0)) &&
       (plVar12 = *(long **)(lVar19 + 0x40), plVar12 != (long *)0x0)) {
      lVar19 = *plVar12;
      ...
      if (uVar22 != 0) {
        ...
        do {
          if (*(long *)(piVar23 + -2) == *(long *)PTR_DAT_0777a498) {
            puVar11 = (undefined8 *)(lVar19 + (long)(*piVar23 + 0xd) * 0x10 + 0x138);
            goto LAB_06770338;
          }
          uVar22 = uVar22 - 1;
          piVar23 = piVar23 + 4;
      ...
      puVar11 = (undefined8 *)func_0x03256b10(plVar12,*(long *)PTR_DAT_0777a498,0xd);
LAB_06770338:
      uVar17 = (*(code *)*puVar11)(plVar12,uVar16,puVar11[1]);
      if (plVar24 != (long *)0x0) {
        ...
        if (lVar21 == lVar19) {
          ...
          uVar8 = 0;
          if ((lVar21 != 0) && (lVar19 != 0)) {
            if (*(int *)(lVar21 + 0x10) == *(int *)(lVar19 + 0x10)) {
              lVar1 = lVar21 + 0x14;
              lVar19 = lVar19 + 0x14;
              lVar21 = (long)*(int *)(lVar21 + 0x10) << 1;
              *(undefined8 *)((long)puVar6 + -0x70) = 0x6770360;
              *(long **)((long)puVar6 + -0x60) = plVar15;
              *(long **)((long)puVar6 + -0x58) = plVar18;
              *(long **)((long)puVar6 + -0x50) = plVar24;
              *(undefined8 *)((long)puVar6 + -0x48) = uVar16;
              *(undefined8 *)((long)puVar6 + -0x40) = uVar17;
              *(long *)((long)puVar6 + -0x38) = lVar20;
              if (lVar1 != lVar19) {
                lVar20 = func_0x057e39f8(0,0,lVar21,0);
                uVar16 = func_0x057e3a04(lVar21,0);
                uVar22 = func_0x057e3a10(uVar16,0);
                if (7 < uVar22) {
                  lVar21 = func_0x057e3a24(uVar16,8,0);
                  while( true ) {
                    uVar22 = func_0x057e3a10(lVar21,0);
                    uVar10 = func_0x057e3a10(lVar20,0);
                    if (uVar22 <= uVar10) {
                      return (undefined8 *)
                             (ulong)(*(long *)(lVar1 + lVar21) == *(long *)(lVar19 + lVar21));
                    }
                    uVar22 = func_0x057f2854(*(undefined8 *)(lVar1 + lVar20),
                                             *(undefined8 *)(lVar19 + lVar20),0);
                    if ((uVar22 & 1) != 0) break;
                    lVar20 = func_0x057e3a1c(lVar20,8,0);
                  }
                  return (undefined8 *)0x0;
                }
                uVar22 = func_0x057e3a10(uVar16,0);
                ...
                if (uVar10 < uVar22) {
                  do {
                    bVar7 = *(char *)(lVar1 + lVar20) == *(char *)(lVar19 + lVar20);
                    puVar11 = (undefined8 *)(ulong)bVar7;
                    if (!bVar7) {
                      return puVar11;
                    }
                    lVar20 = func_0x057e3a1c(lVar20,1,0);
                    uVar22 = func_0x057e3a10(uVar16,0);
                    uVar10 = func_0x057e3a10(lVar20,0);
                  } while (uVar10 < uVar22);
                  return puVar11;
