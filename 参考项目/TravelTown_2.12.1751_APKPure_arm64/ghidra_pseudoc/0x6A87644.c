/* Ghidra 12.1.2 native pseudocode; RVA 0x6A87644; Merger.MergeBoard.Logic.CombineValidators.MergeItemCombinerValidator.CanCombineItems; status ok */

uint Merger_MergeBoard_Logic_CombineValidators_MergeItemCombinerValidator__CanCombineItems
