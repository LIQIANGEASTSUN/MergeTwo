/* Ghidra 12.1.2 native pseudocode; RVA 0x4944654; MergeEngine.Util.WeightedItemList<TItem>.GetItem; status ok */
...

{
  ...
  func_0x04c1b8ac(lVar4,*(undefined8 *)(*(long *)(*(long *)(param_3 + 0x20) + 0xc0) + 0xa8));
  if (param_2 != (long *)0x0) {
