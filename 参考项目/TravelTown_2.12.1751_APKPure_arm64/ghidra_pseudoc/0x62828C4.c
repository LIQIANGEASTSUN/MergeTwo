/* Ghidra 12.1.2 native pseudocode; RVA 0x62828C4; MergeEngine.ECS.Systems.InventorySystem.OnBoardTypeChanged; status ok */
...
long * MergeEngine_ECS_Systems_InventorySystem__OnBoardTypeChanged(long param_1)

{
  ...
  do {
    ...
    *(undefined8 *)((long)register0x00000008 + -8) = *(undefined8 *)((long)register0x00000008 + -8);
    ...
    puVar24 = PTR_DAT_077726c0;
    unaff_x20 = *(long **)(param_1 + 0x80);
    unaff_x19 = param_1;
    if (unaff_x20 != (long *)0x0) {
      ...
      if (uVar20 != 0) {
        ...
        do {
          if (*(long *)(piVar21 + -2) == *(long *)PTR_DAT_077726c0) {
            puVar11 = (undefined8 *)(lVar19 + (long)(*piVar21 + 3) * 0x10 + 0x138);
            goto LAB_063826d8;
          }
          uVar20 = uVar20 - 1;
          piVar21 = piVar21 + 4;
      ...
      puVar11 = (undefined8 *)func_0x03256b10(unaff_x20,*(long *)PTR_DAT_077726c0,3);
LAB_063826d8:
      lVar19 = (*(code *)*puVar11)(unaff_x20,puVar11[1]);
      unaff_x21 = puVar24;
      if (lVar19 != 0) {
        if (*(int *)(lVar19 + 0x20) == 1) {
LAB_06382768:
...
LAB_0638276c:
          ...
          if (unaff_x20 != (long *)0x0) {
            ...
            puVar11 = (undefined8 *)func_0x03256b10(unaff_x20,*(long *)puVar24,3);
LAB_063827c4:
            plVar12 = (long *)(*(code *)*puVar11)(unaff_x20,puVar11[1]);
            if (plVar12 != (long *)0x0) {
              if ((int)plVar12[4] != 0) {
                return plVar12;
              }
              ...
              if (unaff_x20 != (long *)0x0) {
                ...
                if (uVar20 != 0) {
                  ...
                  do {
                    if (*(long *)(piVar21 + -2) == *(long *)puVar24) {
                      puVar11 = (undefined8 *)(lVar19 + (long)(*piVar21 + 5) * 0x10 + 0x138);
                      goto LAB_06382840;
                    }
                    uVar20 = uVar20 - 1;
                    piVar21 = piVar21 + 4;
                ...
                puVar11 = (undefined8 *)func_0x03256b10(unaff_x20,*(long *)puVar24,5);
LAB_06382840:
                plVar12 = (long *)(*(code *)*puVar11)(unaff_x20,puVar11[1]);
                if (plVar12 != (long *)0x0) {
                  if ((int)plVar12[4] != 0) {
                  ...
                  plVar12 = (long *)func_0x063828dc(param_1);
                  if ((int)plVar12 < 1) {
                    return plVar12;
                  }
                  *(undefined1 *)(param_1 + 0x100) = 1;
                  plVar12 = *(long **)(param_1 + 0x28);
                  unaff_x19 = func_0x03280ca0(*(undefined8 *)PTR_DAT_077e7090);
                  func_0x0686c2f0(unaff_x19,0);
                  unaff_x20 = (long *)0x0;
...
LAB_0638274c:
            plVar12 = (long *)(*(code *)*puVar11)(unaff_x20,puVar11[1]);
            if (plVar12 != (long *)0x0) {
              if ((int)plVar12[4] == 1) goto LAB_06382768;
    ...
    unaff_x30 = MergeEngine_ECS_Systems_InventorySystem__OnBoardTypeChanged;
    param_1 = func_0x03280cac();
    register0x00000008 = (BADSPACEBASE *)((long)register0x00000008 + -0x20);
  } while( true );
  lVar19 = *(long *)PTR_DAT_077e7098;
  *(undefined8 *)((long)register0x00000008 + -0x20) =
       *(undefined8 *)((long)register0x00000008 + -0x20);
  ...
  *(undefined8 *)((long)register0x00000008 + -8) = *(undefined8 *)((long)register0x00000008 + -8);
  ...
  if ((*(long *)(lVar19 + 0x38) == 0) &&
     (plVar8 = (long *)func_0x03280a18(PTR_DAT_0774e558), *(long *)(lVar19 + 0x38) == 0)) {
    plVar8 = (long *)func_0x03256878(lVar19);
  }
  ...
  uVar9 = func_0x057a51c4(uVar23,0);
  lVar19 = 1;
  puVar16 = (undefined1 *)0x0;
  lVar18 = func_0x072869d0(plVar12,uVar9,0,1,0);
  if (lVar18 == 0) {
    auVar27 = func_0x03280cac();
    uVar9 = auVar27._8_8_;
    plVar8 = auVar27._0_8_;
    ...
    *(long **)((long)register0x00000008 + -0x48) = plVar12;
    *(undefined8 *)((long)register0x00000008 + -0x40) = 0;
    *(long *)((long)register0x00000008 + -0x38) = unaff_x19;
    lVar18 = tpidr_el0;
    *(undefined8 *)((long)register0x00000008 + -0x88) = *(undefined8 *)(lVar18 + 0x28);
    *(undefined1 **)((long)register0x00000008 + -0x90) = puVar16;
    ...
    if ((char)plVar8[10] == '\0') {
      ...
      lVar18 = func_0x072869d0(plVar8,uVar23,uVar9,1,0);
      ...
      unaff_x19 = func_0x03280b94(*(undefined8 *)(lVar19 + 8),unaff_x24);
      if (lVar18 != 0) {
        uVar23 = 0x3ea52d0;
        puVar5 = unaff_x24;
        lVar14 = lVar18;
    ...
    else if (*(long *)(lVar18 + 0x28) == *(long *)((long)register0x00000008 + -0x88)) {
      return plVar12;
    }
    ...
    *(undefined1 **)(unaff_x24 + -8) = puVar16;
    lVar19 = *(long *)(puVar5 + 0x38);
    if (lVar19 == 0) {
    ...
    *(undefined8 *)(unaff_x24 + -0x48) = 0;
    ...
    lVar10 = func_0x03280ca0();
    func_0x0404e308(lVar10,*(undefined8 *)(*(long *)(lVar14 + 0x38) + 8));
    if (lVar10 != 0) {
      plVar12 = (long *)(lVar10 + 0x10);
      *plVar12 = lVar19;
      goto SUB_032809c4;
    ...
    *(undefined8 *)(unaff_x24 + -0x108) = *(undefined8 *)(unaff_x24 + -0x108);
    ...
    lVar18 = func_0x072869d0(plVar12,uVar23,0,0,0);
    if (lVar18 == 0) {
      return (long *)0x0;
    }
    uVar23 = **(undefined8 **)(lVar17 + 0x38);
    ...
    uVar23 = func_0x057a51c4(uVar23,0);
    lVar19 = func_0x057c1ad4(uVar23,0);
...
LAB_03ea5b18:
      ...
      unaff_x19 = func_0x03280b90(lVar19,lVar14);
      if (unaff_x19 == 0) {
        func_0x03281048(lVar19,lVar14);
        goto LAB_03ea5b18;
      }
    }
    lVar19 = *(long *)(unaff_x24 + -0x110);
    puVar16 = *(undefined1 **)(unaff_x24 + -0x108);
    plVar8 = *(long **)(unaff_x24 + -0x120);
    lVar14 = *(long *)(unaff_x24 + -0x118);
    puVar5 = unaff_x24 + -0x100;
    uVar23 = *(undefined8 *)(unaff_x24 + -0x130);
    unaff_x23 = *(undefined1 **)(unaff_x24 + -0x128);
    unaff_x24 = (undefined *)0x0;
  }
  else {
    lVar19 = *(long *)((long)register0x00000008 + -0x10);
    puVar16 = *(undefined1 **)((long)register0x00000008 + -8);
    plVar8 = *(long **)((long)register0x00000008 + -0x20);
    uVar23 = *(undefined8 *)((long)register0x00000008 + -0x30);
    puVar5 = (undefined1 *)register0x00000008;
    lVar14 = *(long *)((long)register0x00000008 + -0x18);
  }
SUB_072852e4:
  lVar17 = 0;
  puVar6 = puVar5 + -0x30;
  *(undefined8 *)(puVar5 + -0x30) = uVar23;
  *(long **)(puVar5 + -0x20) = plVar8;
  *(long *)(puVar5 + -0x18) = lVar14;
  *(long *)(puVar5 + -0x10) = lVar19;
  *(undefined1 **)(puVar5 + -8) = puVar16;
  ...
  if (unaff_x19 != 0) {
    uVar23 = func_0x057dadc4(unaff_x19,0);
    puVar22 = *(undefined **)(lVar18 + 0x20);
    if (*(int *)(*(long *)puVar24 + 0xe0) == 0) {
      func_0x03280b8c(*(long *)puVar24);
    }
    uVar7 = func_0x0727e0ec(uVar23,puVar22);
    plVar12 = (long *)(ulong)(uVar7 & 1);
    uVar23 = 0x728539c;
    goto SUB_0727dc78;
  }
  func_0x03280cac();
  ...
  while( true ) {
    ...
    plVar12 = (long *)func_0x072ce910(uVar23);
    lVar19 = *plVar12;
    func_0x072ce920();
...
LAB_072854e8:
    plVar12 = (long *)(*(code *)*puVar11)(0x7e34000,puVar11[1]);
    if (lVar19 == 0) {
      return plVar12;
    }
  }
...
LAB_072855b0:
  ...
  *(undefined1 **)(puVar5 + -0x58) = unaff_x23;
  ...
  *(undefined8 *)(puVar5 + -0x38) = 0x7e34000;
  ...
  plVar12 = (long *)func_0x03e0c264(lVar18,*(undefined8 *)puVar24);
...
LAB_07285770:
    if (lVar18 != 0) {
      if (0 < *(int *)(lVar18 + 0x18)) {
        plVar8 = (long *)0x0;
        do {
          puVar15 = (undefined *)func_0x0414419c(lVar18,plVar8,*(undefined8 *)puVar22);
          unaff_x24 = puVar22;
          if (*(long *)(lVar19 + 0x10) == 0) goto LAB_07285808;
          plVar12 = (long *)func_0x041447fc(*(long *)(lVar19 + 0x10),puVar15,*(undefined8 *)puVar13)
          ;
          puVar24 = puVar15;
          if (((ulong)plVar12 & 1) != 0) {
            if ((puVar15 == (undefined *)0x0) || (lVar14 = *(long *)(puVar15 + 0x18), lVar14 == 0))
            goto LAB_07285808;
            plVar12 = (long *)(**(code **)(lVar14 + 0x18))
                                        (*(undefined8 *)(lVar14 + 0x40),lVar17,
                                         *(undefined8 *)(lVar14 + 0x28));
          }
          uVar7 = (int)plVar8 + 1;
          plVar8 = (long *)(ulong)uVar7;
        } while ((int)uVar7 < *(int *)(lVar18 + 0x18));
      }
      return plVar12;
    }
LAB_07285808:
...
LAB_0728580c:
    ...
    if (*(int *)(lVar19 + 0x30) != 2) {
      ...
      lVar18 = func_0x03280afc(uVar23,1);
      func_0x02f0b18c(lVar17);
      uVar23 = func_0x057dadc4(lVar17,0);
      func_0x02f0b18c(lVar18);
      func_0x02f176b4(lVar18,uVar23);
      func_0x02f0965c(lVar18,0,uVar23);
      uVar23 = func_0x03280a2c(PTR_DAT_0785df08);
      lVar17 = func_0x0727df38(uVar23,lVar18);
      uVar23 = func_0x03280a2c(PTR_DAT_0785df10);
      func_0x03280b7c(lVar17,uVar23);
    }
    plVar12 = (long *)func_0x03280afc(*(undefined8 *)PTR_DAT_0774e5a0,1);
    if ((lVar17 == 0) ||
       (puVar13 = (undefined *)func_0x057dadc4(lVar17,0), plVar8 = plVar12, plVar12 == (long *)0x0))
    goto LAB_07285808;
    if ((puVar13 == (undefined *)0x0) ||
       (lVar14 = func_0x03280b90(puVar13,*(undefined8 *)(*plVar12 + 0x40)), lVar14 != 0)) {
      if ((int)plVar12[3] != 0) {
        plVar12 = plVar12 + 4;
...
SUB_032809c4:
  ...
  *(undefined **)(puVar5 + -0xa8) = puVar13;
  *(long **)(puVar5 + -0xa0) = plVar12;
  *(long *)(puVar5 + -0x98) = lVar19;
  ...
  *(long *)(puVar5 + -0x88) = lVar17;
  ...
  plVar12 = (long *)(ulong)*(byte *)(unaff_x19 + 0x34);
  uVar23 = 0x72858f0;
SUB_0727dc78:
  if (((ulong)plVar12 & 1) == 0) {
