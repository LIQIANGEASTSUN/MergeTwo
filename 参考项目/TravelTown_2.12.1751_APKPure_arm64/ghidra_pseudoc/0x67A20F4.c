/* Ghidra 12.1.2 native pseudocode; RVA 0x67A20F4; MergeEngine.ECS.Systems.Items.ImmidateToolsSystem.ImmediateToolsSystem.EntityCreated; status ok */
...
long * MergeEngine_ECS_Systems_Items_ImmidateToolsSystem_ImmediateToolsSystem__EntityCreated
...

{
  ...
  while( true ) {
    ...
    *(undefined8 *)((long)register0x00000008 + -0x40) = 0x68a2180;
