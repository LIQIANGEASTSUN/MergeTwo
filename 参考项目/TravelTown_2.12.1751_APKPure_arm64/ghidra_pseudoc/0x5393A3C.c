/* Ghidra 12.1.2 native pseudocode; RVA 0x5393A3C; MergeEngine.ECS.Components.Items.Producers.ItemSpawningComponent<TCapability>.LoadComponent; status ok */


/* WARNING: Possible PIC construction at 0x05493c28: Changing call to branch */
/* WARNING: Possible PIC construction at 0x05493c68: Changing call to branch */
/* WARNING: Possible PIC construction at 0x05493c8c: Changing call to branch */
/* WARNING: Possible PIC construction at 0x05493cb0: Changing call to branch */
/* WARNING: Possible PIC construction at 0x05493cd0: Changing call to branch */
/* WARNING: Possible PIC construction at 0x05493d18: Changing call to branch */
...
/* WARNING: Possible PIC construction at 0x05493e20: Changing call to branch */
/* WARNING: Possible PIC construction at 0x05493f88: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x05493e24) */
/* WARNING: Removing unreachable block (ram,0x05493e50) */
...
/* WARNING: Removing unreachable block (ram,0x05493d1c) */
/* WARNING: Removing unreachable block (ram,0x05493d48) */
/* WARNING: Removing unreachable block (ram,0x05493cd4) */
/* WARNING: Removing unreachable block (ram,0x05493d78) */
/* WARNING: Removing unreachable block (ram,0x05493da4) */
/* WARNING: Removing unreachable block (ram,0x05493ddc) */
/* WARNING: Removing unreachable block (ram,0x05493e74) */
/* WARNING: Removing unreachable block (ram,0x05493e94) */
/* WARNING: Removing unreachable block (ram,0x05493ea8) */
/* WARNING: Removing unreachable block (ram,0x05493ec8) */
/* WARNING: Removing unreachable block (ram,0x05493eac) */
/* WARNING: Removing unreachable block (ram,0x05493ed0) */
/* WARNING: Removing unreachable block (ram,0x05493f00) */
/* WARNING: Removing unreachable block (ram,0x05493f2c) */
/* WARNING: Removing unreachable block (ram,0x05493f58) */
/* WARNING: Removing unreachable block (ram,0x05493f5c) */
/* WARNING: Removing unreachable block (ram,0x05493eb4) */
/* WARNING: Removing unreachable block (ram,0x05493e04) */
/* WARNING: Removing unreachable block (ram,0x03ea6208) */
/* WARNING: Removing unreachable block (ram,0x03ea6220) */
/* WARNING: Removing unreachable block (ram,0x03ea6230) */
/* WARNING: Removing unreachable block (ram,0x03ea6320) */
/* WARNING: Removing unreachable block (ram,0x03ea6340) */
/* WARNING: Removing unreachable block (ram,0x03ea6358) */
/* WARNING: Removing unreachable block (ram,0x03ea6364) */
/* WARNING: Removing unreachable block (ram,0x03ea637c) */
/* WARNING: Removing unreachable block (ram,0x03ea6380) */
/* WARNING: Removing unreachable block (ram,0x07286c4c) */
/* WARNING: Removing unreachable block (ram,0x05493cfc) */
...
/* WARNING: Removing unreachable block (ram,0x05493cb4) */
/* WARNING: Removing unreachable block (ram,0x05493c90) */
/* WARNING: Removing unreachable block (ram,0x05493c6c) */
/* WARNING: Removing unreachable block (ram,0x05493c2c) */
/* WARNING: Removing unreachable block (ram,0x05493c40) */
/* WARNING: Removing unreachable block (ram,0x05493c44) */
/* WARNING: Removing unreachable block (ram,0x05493f8c) */

void MergeEngine_ECS_Components_Items_Producers_ItemSpawningComponent_TCapability___LoadComponent
...

{
  ...
  if ((bRam0000000007e1c3a5 & 1) == 0) {
    func_0x03280a18(PTR_DAT_07782d28);
    bRam0000000007e1c3a5 = 1;
  }
  if ((param_1 == 0) ||
     (func_0x046f06ec(param_1,param_2,
                      *(undefined8 *)(*(long *)(*(long *)(param_3 + 0x20) + 0xc0) + 0x68)),
     puVar7 = PTR_DAT_07782d28, param_2 == 0)) {
    auVar14 = func_0x03280cac();
    lVar10 = auVar14._0_8_;
    if (lVar10 != 0) {
      func_0x046f07b8(lVar10,*(undefined8 *)
                              (*(long *)(*(long *)(auVar14._8_8_ + 0x20) + 0xc0) + 0x70));
      lVar11 = *(long *)(lVar10 + 0x28);
      if (lVar11 != 0) {
        *(undefined4 *)(lVar11 + 0x48) = *(undefined4 *)(lVar10 + 0x78);
        if (*(long *)(lVar10 + 0x80) != 0) {
          *(undefined4 *)(lVar11 + 0x4c) = *(undefined4 *)(*(long *)(lVar10 + 0x80) + 0x34);
          return;
        }
      }
    }
    lVar10 = func_0x03280cac();
    puVar8 = PTR_DAT_07782d38;
    puVar7 = PTR_DAT_07782d30;
    if ((bRam0000000007e1c3a6 & 1) == 0) {
      func_0x03280a18(PTR_DAT_0776f070);
      func_0x03280a18(PTR_DAT_0776f910);
      func_0x03280a18(PTR_DAT_07772cc0);
      func_0x03280a18(PTR_DAT_07782d38);
      func_0x03280a18(PTR_DAT_07772cb8);
      func_0x03280a18(PTR_DAT_07782d30);
      func_0x03280a18(PTR_DAT_0776f920);
      func_0x03280a18(PTR_DAT_0776f090);
      bRam0000000007e1c3a6 = 1;
    }
    uVar9 = func_0x03280ca0(*(undefined8 *)puVar7);
    func_0x04fe1fa4(uVar9,*(undefined8 *)puVar8);
    ...
    *(int *)(param_1 + 0x78) = iVar2;
    ...
    uVar9 = func_0x03280ca0(*(undefined8 *)puVar7);
    func_0x060e89c8(uVar9,uVar13,iVar3 + iVar2,uVar4,0);
