/* Ghidra 12.1.2 native pseudocode; RVA 0x613E5F8; MergeEngine.Model.Configuration.MergingConfigurationModel.GetNextItemOnGraph; status ok */
...
void MergeEngine_Model_Configuration_MergingConfigurationModel__GetNextItemOnGraph(void)

{
  undefined *puVar1;
  
  puVar1 = PTR_DAT_077db350;
