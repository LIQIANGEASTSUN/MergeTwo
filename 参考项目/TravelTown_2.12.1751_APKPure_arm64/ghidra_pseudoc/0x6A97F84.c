/* Ghidra 12.1.2 native pseudocode; RVA 0x6A97F84; Merger.MergeBoard.Extensions.EntityLockExtension.IsBoxed; status ok */
...
long * Merger_MergeBoard_Extensions_EntityLockExtension__IsBoxed
...

{
  ...
  if ((bRam0000000007e2a81c & 1) == 0) {
    func_0x03280a18(PTR_DAT_0777a520);
    bRam0000000007e2a81c = 1;
  }
  uStack_38 = 0;
  uStack_30 = 0;
  uStack_28 = 0;
  if (param_1 != 0) {
    uVar11 = func_0x03d1e508(param_1,&uStack_38,*(undefined8 *)PTR_DAT_0777a520);
    return (long *)(ulong)(uVar11 & (char)uStack_38 != '\0');
  }
  lVar17 = func_0x03280cac();
  uStack_60 = 0x6b97ffc;
  uStack_50 = 0x7e2a000;
  lStack_48 = param_1;
  if ((bRam0000000007e2a81e & 1) == 0) {
    func_0x03280a18(PTR_DAT_0777a520);
    func_0x03280a18(PTR_DAT_0777a528);
    bRam0000000007e2a81e = 1;
  }
  puVar6 = PTR_DAT_0777a520;
  acStack_58[0] = '\0';
  uStack_78 = 0;
  uStack_70 = 0;
  uStack_68 = 0;
  if (lVar17 != 0) {
    uVar11 = func_0x03d1f470(lVar17,acStack_58,*(undefined8 *)PTR_DAT_0777a528);
    bVar10 = acStack_58[0] != '\0';
    uVar12 = func_0x03d1e508(lVar17,&uStack_78,*(undefined8 *)puVar6);
    return (long *)(ulong)(uVar11 & bVar10 & (uVar12 ^ 1 | (uint)((char)uStack_78 == '\0')));
  }
  lVar18 = func_0x03280cac();
  apcStack_a0[0] = Merger_MergeBoard_Extensions_EntityLockExtension__FixedPosition;
  uStack_90 = 0x7e2a000;
  lStack_88 = lVar17;
  ...
  uVar11 = func_0x06b868e4(lVar18);
  if (lVar18 != 0) {
    uVar12 = func_0x03d1baa0(lVar18,*(undefined8 *)PTR_DAT_07832580);
    return (long *)(ulong)((uVar11 | uVar12) & 1);
  }
  lVar17 = func_0x03280cac();
  ppcVar9 = (code **)auStack_c0;
  auStack_c0[0] = 0x6b9811c;
  uStack_b0 = 0x7e2a000;
  lStack_a8 = lVar18;
  ...
  uVar19 = func_0x03d1be30(lVar17,*(undefined8 *)PTR_DAT_07831028);
  if (((uVar19 & 1) != 0) ||
     (uVar19 = func_0x03d1bec8(lVar17,*(undefined8 *)PTR_DAT_07831030), (uVar19 & 1) != 0)) {
    return (long *)0x1;
  }
  lVar18 = *(long *)PTR_DAT_07832588;
  puVar22 = *(undefined8 **)(lVar18 + 0x38);
  ...
  if (lVar17 == 0) {
    ...
    uVar13 = func_0x057a51c4(uVar19,0);
    if (lVar17 == 0) {
      auVar36 = func_0x03280cac();
      ...
      if (lVar17 == 0) {
        ...
        lVar17 = *(long *)(auVar36._0_8_ + 0x10);
        if (((lVar17 != 0) &&
            (func_0x04fe2f04(lVar17,*(undefined8 *)PTR_DAT_077c3a88), puVar8 = PTR_DAT_077c3a60,
            puVar7 = PTR_DAT_077c3a58, puVar6 = PTR_DAT_07779c58, auVar36._8_8_ != 0)) &&
           (lVar17 = *(long *)(auVar36._8_8_ + 0x10), lVar17 != 0)) {
          func_0x04fe31ac(&uStack_160,lVar17,*(undefined8 *)PTR_DAT_077c3a50);
          while( true ) {
            uVar19 = func_0x0515fbd0(&uStack_160,*(undefined8 *)puVar8);
            if ((uVar19 & 1) == 0) {
              plVar20 = (long *)func_0x0515fcf0(&uStack_160,*(undefined8 *)puVar7);
              return plVar20;
            }
            lVar17 = *(long *)(auVar36._0_8_ + 0x10);
            if (lVar17 == 0) break;
            func_0x04fe2d68(lVar17,uStack_150,uStack_148,*(undefined8 *)puVar6);
          }
          func_0x03280cac();
        }
        ...
        if (auVar37._8_4_ == 1) {
          ...
          lVar17 = *plVar20;
          func_0x072ce920();
          plVar20 = (long *)func_0x0515fcf0(&uStack_160,*(undefined8 *)PTR_DAT_077c3a58);
          if (lVar17 == 0) {
            return plVar20;
          }
          func_0x03280ca4(lVar17);
        }
        func_0x0515fcf0(&uStack_160,*(undefined8 *)PTR_DAT_077c3a58);
      ...
      do {
        ...
        *(undefined8 *)((long)puVar22 + -0x58) = uStack_100;
        ...
        *(ulong *)((long)puVar22 + -0x10) = uVar19;
...
LAB_04fe4580:
          ...
          puVar15 = (undefined8 *)func_0x03256b10(plVar31,lVar17,1);
LAB_04fe4344:
...
LAB_04fe4354:
          ...
          if (uVar21 < uVar12) {
            uVar12 = *(int *)(lVar17 + (ulong)uVar21 * 4 + 0x20) - 1;
            if ((int)uVar12 < 0) {
              return (long *)0x0;
            }
            plVar32 = (long *)0x0;
            ...
            while( true ) {
              ...
              if (*unaff_x29 == uVar11) {
                ...
                if (plVar31 == (long *)0x0) {
                  ...
                  puVar15 = (undefined8 *)func_0x03256b10(plVar31,lVar17,0);
LAB_04fe4490:
                  param_4 = puVar15[1];
                  plVar20 = plVar30;
...
LAB_04fe4584:
        ...
        *(ulong *)((long)puVar22 + -0x80) = uVar19;
...
LAB_04fe48a8:
          ...
          puVar15 = (undefined8 *)func_0x03256b10(puVar33,lVar18,1);
LAB_04fe4654:
          plVar20 = (long *)puVar15[1];
...
LAB_04fe4664:
          ...
          uVar21 = uVar11 - iVar4 * uVar12;
          if (uVar21 < uVar12) {
            iVar4 = *(int *)(lVar18 + (ulong)uVar21 * 4 + 0x20);
            ...
            while( true ) {
              ...
              if (*unaff_x28 == uVar11) {
                ...
                if (puVar33 == (uint *)0x0) {
                  ...
                  puVar15 = (undefined8 *)func_0x03256b10(puVar33,lVar18,0);
LAB_04fe47a0:
                  param_4 = puVar15[1];
                  plVar20 = plVar32;
...
LAB_04fe48ac:
        ...
        *(ulong *)((long)puVar22 + -0x100) = uVar19;
        *(long *)((long)puVar22 + -0xf8) = lVar17;
        ...
        if (lVar17 == 0) {
          ...
          *plVar20 = *(long *)(lVar17 + (ulong)uVar11 * 0x18 + 0x30);
          goto SUB_032809c4;
        }
        auVar36 = func_0x03280cb4();
        puVar34 = auVar36._8_8_;
        lVar17 = auVar36._0_8_;
        uVar19 = *(ulong *)(*(long *)(*(long *)(param_4 + 0x20) + 0xc0) + 0x118);
        ...
        *(int *)(lVar17 + 0x2c) = *(int *)(lVar17 + 0x2c) + 1;
        if (*(long *)(lVar17 + 0x10) == 0) {
          puVar33 = *(uint **)(*(long *)(*(long *)(uVar19 + 0x20) + 0xc0) + 0x10);
        ...
        if (plVar30 == (long *)0x0) {
          ...
          lVar25 = *(long *)(*(long *)(*(long *)(uVar19 + 0x20) + 0xc0) + 8);
                  ...
                  if (uVar12 < uVar21) {
                    *(undefined4 *)((long)puVar22 + -0x174) = 0;
                    ...
                    do {
                      ...
                      plVar30 = plVar31;
                      if (*(uint *)(lVar18 + (long)(int)uVar21 * 0x18 + 0x20) == uVar11) {
                        if (plVar31 == (long *)0x0) goto LAB_04fe3c74;
                        puVar33 = puVar34;
                        uVar26 = (**(code **)(*plVar31 + 0x1b8))
                                           (plVar31,*(undefined8 *)
                                                     (lVar18 + (long)plVar20 * 0x18 + 0x28),puVar34,
                        ...
                        if ((uVar26 & 1) != 0) {
                          ...
                          plVar20 = (long *)(lVar18 + (long)plVar20 * 0x18 + 0x30);
                      ...
                      uVar1 = *(uint *)(lVar18 + (long)plVar20 * 0x18 + 0x24);
                ...
                if (uVar12 < uVar21) {
                  ...
                  *(uint **)((long)puVar22 + -0x180) = unaff_x29;
                  ...
                  do {
                    ...
                    if (*(uint *)(lVar18 + (long)(int)uVar21 * 0x18 + 0x20) == uVar11) {
                      lVar25 = *(long *)(*(long *)(*(long *)(uVar19 + 0x20) + 0xc0) + 8);
                      unaff_x25 = *(ulong *)(lVar18 + (long)plVar20 * 0x18 + 0x28);
                      if ((*(byte *)(lVar25 + 0x135) & 1) == 0) {
                        lVar25 = func_0x0325681c(lVar25);
                      }
                      lVar24 = *plVar30;
...
LAB_04fe3ad4:
                ...
                if (*(int *)(lVar17 + 0x28) < 1) {
                  ...
                  if (*(uint *)(lVar18 + 0x18) <= uVar12) goto LAB_04fe3c70;
                  lVar25 = (long)(int)uVar12;
                }
                else {
                  *(int *)(lVar17 + 0x28) = *(int *)(lVar17 + 0x28) + -1;
                  uVar12 = *(uint *)(lVar17 + 0x24);
                  plVar20 = (long *)(ulong)uVar12;
                  if (*(uint *)(lVar18 + 0x18) <= uVar12) goto LAB_04fe3c70;
                  lVar25 = (long)(int)uVar12;
...
LAB_04fe3c74:
        ...
        *(ulong *)((long)puVar22 + -0x1a0) = uVar19;
        ...
        *(undefined8 *)((long)puVar22 + -0x1d8) = 0;
        ...
        if (lVar17 != 0) {
          ...
          if (*(long *)((long)puVar22 + -0x1d8) != 0) {
            ...
            uVar19 = func_0x056933d8(*(long *)((long)puVar22 + -0x1d8),
...
LAB_04fe3e2c:
        ...
        *(ulong *)((long)puVar22 + -0x200) = uVar19;
        ...
        *(undefined8 *)((long)puVar22 + -0x1e8) = *(undefined8 *)((long)puVar22 + -0x1e8);
        ...
        unaff_x21 = func_0x03280afc(*(undefined8 *)puVar6,uVar19);
        lVar18 = *(long *)(*(long *)(*(long *)(lVar18 + 0x20) + 0xc0) + 0x1b0);
        if ((*(byte *)(lVar18 + 0x135) & 1) == 0) {
          lVar18 = func_0x0325681c(lVar18);
        }
        unaff_x23 = (long *)func_0x03280afc(lVar18,uVar19);
...
SUB_032809c4:
          if (iRam00000000080486b8 != 0) {
            ...
            do {
              cVar5 = '\x01';
              bVar10 = (bool)ExclusiveMonitorPass(puVar23,0x10);
              if (bVar10) {
        ...
        if (unaff_x23 != (long *)0x0) {
          ...
          while (puVar33 < (uint *)(ulong)uVar12) {
            ...
            if (-1 < iVar4) {
              ...
              lVar18 = unaff_x21 + (ulong)uVar21 * 4;
...
LAB_04fe4274:
  ...
  *(undefined8 *)((long)ppcVar9 + -0x10) = uVar29;
  uVar11 = func_0x04fe343c(lVar17,uVar13,
