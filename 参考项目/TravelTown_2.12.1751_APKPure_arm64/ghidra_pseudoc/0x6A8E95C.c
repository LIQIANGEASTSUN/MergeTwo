/* Ghidra 12.1.2 native pseudocode; RVA 0x6A8E95C; Merger.MergeBoard.Logic.BoardOperations.BoardReplaceItemOperationDataCreator.CreateOperationData; status ok */


void Merger_MergeBoard_Logic_BoardOperations_BoardReplaceItemOperationDataCreator__CreateOperationData
...

{
  ...
  lVar8 = 0x7e2a000;
  if ((bRam0000000007e2a7d2 & 1) == 0) {
    func_0x03280a18(PTR_DAT_078304b0);
    func_0x03280a18(PTR_DAT_0774e8c8);
    func_0x03280a18(PTR_DAT_0782fd00);
    func_0x03280a18(PTR_DAT_0782fd08);
    func_0x03280a18(PTR_DAT_0774e8e0);
    func_0x03280a18(PTR_DAT_0782fd10);
    bRam0000000007e2a7d2 = 1;
  }
  if ((param_2 != (long *)0x0) &&
     (plVar3 = (long *)func_0x03ec4400(param_2,*(undefined8 *)PTR_DAT_0782fd10),
     plVar3 != (long *)0x0)) {
    lVar5 = *plVar3;
    ...
    if (uVar6 != 0) {
      ...
      do {
        if (*(long *)(piVar7 + -2) == *(long *)PTR_DAT_0782fd00) {
...
LAB_06b8eb24:
      ...
      if (lVar8 == 0) goto LAB_06b8ecf8;
      plVar3 = *(long **)(param_1 + 0x10);
      if (plVar3 == (long *)0x0) goto LAB_06b8ecfc;
      lVar5 = *plVar3;
...
LAB_06b8eb94:
      ...
      if (plVar3 == (long *)0x0) goto LAB_06b8ecf4;
      lVar5 = *plVar3;
...
LAB_06b8ed04:
    ...
    do {
      ...
      if (auVar10._8_4_ != 1) {
        if (param_2 == (long *)0x0) goto LAB_06b8edb0;
        lVar8 = *param_2;
        uVar6 = (ulong)*(ushort *)(lVar8 + 0x12e);
        if (uVar6 == 0) goto LAB_06b8ed88;
        piVar7 = (int *)(*(long *)(lVar8 + 0xb0) + 8);
        goto LAB_06b8ed70;
      }
...
LAB_06b8ecd4:
                    /* WARNING: Could not recover jumptable at 0x06b8ecf0. Too many branches */
