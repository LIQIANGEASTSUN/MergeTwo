/* Ghidra 12.1.2 native pseudocode; RVA 0x6A73634; Merger.MergeBoard.Systems.ProducerSystem.TryProduceItem; status ok */

ulong Merger_MergeBoard_Systems_ProducerSystem__TryProduceItem
