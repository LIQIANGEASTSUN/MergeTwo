/* Ghidra 12.1.2 native pseudocode; RVA 0x6692470; Merger.Game.Views.BoardView.OnPlayStackingAnimation; status ok */
...
void Merger_Game_Views_BoardView__OnPlayStackingAnimation(undefined8 param_1,long param_2)

{
  ...
  *(undefined8 *)(puVar2 + -8) = unaff_x19;
  if ((bRam0000000007e282ed & 1) == 0) {
    func_0x03280a18(PTR_DAT_0776e340,uVar3);
