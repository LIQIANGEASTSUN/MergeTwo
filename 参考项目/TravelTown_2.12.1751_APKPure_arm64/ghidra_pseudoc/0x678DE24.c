/* Ghidra 12.1.2 native pseudocode; RVA 0x678DE24; MergeEngine.ECS.Systems.Items.ExpendableSystem.TryTransformItem; status ok */
...
void MergeEngine_ECS_Systems_Items_ExpendableSystem__TryTransformItem(void)

{
  undefined *puVar1;
  
  puVar1 = PTR_DAT_078103e0;
  if ((bRam0000000007e28d58 & 1) == 0) {
    func_0x03280a18(PTR_DAT_077e6760);
    func_0x03280a18(PTR_DAT_077d75b8);
    func_0x03280a18(PTR_DAT_078103e8);
    func_0x03280a18(PTR_DAT_077e6dd8);
    func_0x03280a18(PTR_DAT_077cd998);
    func_0x03280a18(PTR_DAT_078103b0);
    func_0x03280a18(PTR_DAT_077cd9a8);
    func_0x03280a18(PTR_DAT_078103f0);
    func_0x03280a18(PTR_DAT_078103f8);
    func_0x03280a18(PTR_DAT_07810400);
    func_0x03280a18(PTR_DAT_07810408);
    func_0x03280a18(PTR_DAT_078103e0);
    bRam0000000007e28d58 = 1;
  }
