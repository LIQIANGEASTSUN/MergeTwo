/* Ghidra 12.1.2 native pseudocode; RVA 0x6668C48; MergeEngine.ECS.Systems.Board.BoardSystem.OnGameStarted; status ok */
...
void MergeEngine_ECS_Systems_Board_BoardSystem__OnGameStarted(void)
