/* Ghidra 12.1.2 native pseudocode; RVA 0x6A7C778; Merger.MergeBoard.Models.ItemsDiscoveryModel.GetItemState; status ok */
...
ulong Merger_MergeBoard_Models_ItemsDiscoveryModel__GetItemState(long param_1,undefined8 param_2)

{
  ...
  if ((bRam0000000007e2a737 & 1) == 0) {
    func_0x03280a18(PTR_DAT_078318e0);
    bRam0000000007e2a737 = 1;
  }
  lStack_28 = 0;
  if (*(long *)(param_1 + 0x28) != 0) {
    ...
    if (lStack_28 != 0) {
      return (ulong)*(uint *)(lStack_28 + 0x10);
    }
  }
  auVar10 = func_0x03280cac();
  alStack_58[1] = 0x6b7c7fc;
  alStack_58[2] = 0x7e2a000;
  alStack_58[3] = param_1;
  uStack_38 = param_2;
  if ((bRam0000000007e2a738 & 1) == 0) {
    func_0x03280a18(PTR_DAT_078318e0);
    bRam0000000007e2a738 = 1;
  }
  alStack_58[0] = 0;
  lVar4 = *(long *)(auVar10._0_8_ + 0x28);
  if (lVar4 != 0) {
    uVar3 = func_0x04fe48b0(lVar4,auVar10._8_8_,alStack_58,*(undefined8 *)PTR_DAT_078318e0);
    if ((uVar3 & 1) == 0) {
      return 0;
    }
    if (alStack_58[0] != 0) {
      return (ulong)(*(int *)(alStack_58[0] + 0x10) != 0);
    }
  }
  func_0x03280cac();
  uStack_70 = 0x6b7c888;
  if (extraout_x1 != 0) {
    return (ulong)(*(int *)(extraout_x1 + 0x10) != 0);
  }
  auVar11 = func_0x03280cac();
  alStack_98[1] = 0x6b7c8a8;
  alStack_98[2] = 0x7e2a000;
  auStack_80 = auVar10;
  ...
  if (lVar4 != 0) {
    uVar3 = func_0x04fe48b0(lVar4,auVar11._8_8_,alStack_98,*(undefined8 *)PTR_DAT_078318e0);
    if ((uVar3 & 1) == 0) {
      return 0;
    }
    if (alStack_98[0] != 0) {
      return (ulong)((*(uint *)(alStack_98[0] + 0x10) & 0xfffffffe) == 2);
    }
  }
  func_0x03280cac();
  uStack_b0 = 0x6b7c938;
  if (extraout_x1_00 != 0) {
    return (ulong)((*(uint *)(extraout_x1_00 + 0x10) & 0xfffffffe) == 2);
  }
  auVar10 = func_0x03280cac();
  alStack_d8[1] = 0x6b7c95c;
  alStack_d8[2] = 0x7e2a000;
  auStack_c0 = auVar11;
  ...
  lVar4 = *(long *)(auVar10._0_8_ + 0x28);
  if (lVar4 != 0) {
    uVar3 = func_0x04fe48b0(lVar4,auVar10._8_8_,alStack_d8,*(undefined8 *)PTR_DAT_078318e0);
    if ((uVar3 & 1) == 0) {
      return 0;
    }
    if (alStack_d8[0] != 0) {
      return (ulong)(*(int *)(alStack_d8[0] + 0x10) == 2);
    }
  }
  func_0x03280cac();
  uStack_f0 = 0x6b7c9e8;
  if (extraout_x1_01 != 0) {
    return (ulong)(*(int *)(extraout_x1_01 + 0x10) == 2);
  }
  auVar11 = func_0x03280cac();
  alStack_118[1] = 0x6b7ca08;
  alStack_118[2] = 0x7e2a000;
  auStack_100 = auVar10;
  ...
  lVar4 = *(long *)(auVar11._0_8_ + 0x28);
  if (lVar4 != 0) {
    uVar3 = func_0x04fe48b0(lVar4,auVar11._8_8_,alStack_118,*(undefined8 *)PTR_DAT_078318e0);
    if ((uVar3 & 1) == 0) {
      return 0;
    }
    if (alStack_118[0] != 0) {
      return (ulong)(*(int *)(alStack_118[0] + 0x10) == 3);
    }
  }
  func_0x03280cac();
  if (extraout_x1_02 != 0) {
    return (ulong)(*(int *)(extraout_x1_02 + 0x10) == 3);
  }
  auVar10 = func_0x03280cac();
...
LAB_06b7cb84:
    ...
    if (lVar9 != 0) {
      uVar3 = func_0x04fe48b0(lVar9,uVar6,&lStack_158,*(undefined8 *)PTR_DAT_078318e0);
      puVar2 = PTR_DAT_078318f0;
      if ((uVar3 & 1) != 0) {
        if (lStack_158 == 0) goto LAB_06b7cd6c;
        if (*(int *)(lStack_158 + 0x10) != 0) {
          return 0;
        }
      }
      lVar4 = *plVar7;
