/* Ghidra 12.1.2 native pseudocode; RVA 0x4944BA0; MergeEngine.Util.WeightedItemList<TItem>.get_PlainItems; status ok */
...

{
  ...
  if (lVar8 == 0) {
    ...
    func_0x053569b8(lVar8,uVar15,*(undefined8 *)(lVar12 + 0x28));
  ...
  lVar8 = func_0x03d50a94(uVar14,lVar8);
  ...
  if (lVar8 != 0) {
    ...
    func_0x04143d60(lVar13,lVar8,*(undefined8 *)(*(long *)(lVar12 + 0x38) + 0x10));
    return lVar13;
  }
  ...
  if ((auVar17._0_8_ == 0) || (puVar7 = PTR_DAT_07779d18, auVar17._8_8_ == 0)) {
    ...
    if ((auVar17._0_8_ == 0) || (puVar7 = PTR_DAT_07779d18, auVar17._8_8_ == 0)) {
      uVar14 = func_0x03280a2c(puVar7);
      uVar14 = func_0x05ac7464(uVar14,0);
      auStack_198 = func_0x03280b7c(uVar14,lVar12);
      ...
      puVar7 = PTR_DAT_07779d10;
      if ((auStack_198._0_8_ != 0) && (puVar7 = PTR_DAT_07779d18, auStack_198._8_8_ != 0)) {
      ...
      if ((auVar17._0_8_ == 0) || (puVar7 = PTR_DAT_07779d18, auVar17._8_8_ == 0)) {
        ...
        puVar7 = PTR_DAT_07779d10;
        if ((unaff_x22 != 0) && (puVar7 = PTR_DAT_07779d18, lStack_118 != 0)) {
