/* Ghidra 12.1.2 native pseudocode; RVA 0x66591BC; MergeEngine.ECS.Systems.Board.BoardIdleHintSystem.ItemMerged; status ok */
...
void MergeEngine_ECS_Systems_Board_BoardIdleHintSystem__ItemMerged(long param_1)
