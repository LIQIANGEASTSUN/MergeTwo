/* Ghidra 12.1.2 native pseudocode; RVA 0x6784A48; MergeEngine.ECS.Systems.Board.SplitSystem.TryCombineItems; status ok */


/* WARNING: Possible PIC construction at 0x06884a78: Changing call to branch */
/* WARNING: Possible PIC construction at 0x06884ab0: Changing call to branch */
...
/* WARNING: Removing unreachable block (ram,0x06884ab4) */
/* WARNING: Removing unreachable block (ram,0x06884a7c) */
/* WARNING: Removing unreachable block (ram,0x06884ad0) */
/* WARNING: Removing unreachable block (ram,0x06884a80) */
/* WARNING: Removing unreachable block (ram,0x06884af0) */
/* WARNING: Removing unreachable block (ram,0x06884a84) */
...
undefined8 *
MergeEngine_ECS_Systems_Board_SplitSystem__TryCombineItems
...

{
  ...
  uVar11 = MergeEngine_ECS_Systems_Board_SplitSystem__CanCombineItems();
  if ((uVar11 & 1) == 0) {
    ...
    if (uVar11 != 0) {
      ...
      do {
        if (*(long *)(piVar24 + -2) == *(long *)PTR_DAT_0777a750) {
          puVar12 = (undefined8 *)(lVar21 + (long)(*piVar24 + 0x22) * 0x10 + 0x138);
          goto LAB_06884b9c;
        }
        uVar11 = uVar11 - 1;
        piVar24 = piVar24 + 4;
...
LAB_06884b9c:
    uVar9 = (*(code *)*puVar12)(plVar26,puVar12[1]);
    puVar5 = PTR_DAT_0777a498;
    if ((uVar9 & 1) == 0) {
      return (undefined8 *)(ulong)(uVar9 & 1);
    }
    ...
    if (unaff_x23 != (long *)0x0) {
      ...
      if (uVar11 != 0) {
        ...
        do {
          if (*(long *)(piVar24 + -2) == *(long *)PTR_DAT_0777a498) {
            puVar12 = (undefined8 *)(lVar21 + (long)(*piVar24 + 0x14) * 0x10 + 0x138);
            goto LAB_06884c10;
          }
          uVar11 = uVar11 - 1;
          piVar24 = piVar24 + 4;
      ...
      puVar12 = (undefined8 *)func_0x03256b10(unaff_x23,*(long *)PTR_DAT_0777a498,0x14);
LAB_06884c10:
      plVar16 = (long *)puVar12[1];
      plVar13 = (long *)(*(code *)*puVar12)(unaff_x23,param_2);
      ...
      if (plVar26 != (long *)0x0) {
        ...
        puVar12 = (undefined8 *)func_0x03256b10(plVar26,lVar21,0x14);
LAB_06884c7c:
        (*(code *)*puVar12)(plVar26,param_3,puVar12[1]);
        ...
        if (plVar13 != (long *)0x0) {
          ...
          if (uVar11 != 0) {
            ...
            do {
              if (*(long *)(piVar24 + -2) == *(long *)PTR_DAT_0777e548) {
                puVar12 = (undefined8 *)(lVar21 + (long)(*piVar24 + 0x10) * 0x10 + 0x138);
                goto LAB_06b1da4c;
              }
              uVar11 = uVar11 - 1;
              piVar24 = piVar24 + 4;
          ...
          puVar12 = (undefined8 *)func_0x03256b10(plVar13,*(long *)PTR_DAT_0777e548,0x10);
LAB_06b1da4c:
          lVar21 = (*(code *)*puVar12)(plVar13,puVar12[1]);
          if (lVar21 != 0) {
            if (*(char *)(lVar21 + 0x10) == '\0') {
              ...
              if (uVar11 != 0) {
                ...
                do {
                  if (*(long *)(piVar24 + -2) == *(long *)puVar5) {
                    puVar12 = (undefined8 *)(lVar21 + (long)(*piVar24 + 7) * 0x10 + 0x138);
                    goto LAB_06b1dabc;
                  }
                  uVar11 = uVar11 - 1;
                  piVar24 = piVar24 + 4;
              ...
              puVar12 = (undefined8 *)func_0x03256b10(plVar13,*(long *)puVar5,7);
LAB_06b1dabc:
              lVar21 = (*(code *)*puVar12)(plVar13,puVar12[1]);
              if (lVar21 == 0) goto LAB_06b1dae4;
              puVar12 = (undefined8 *)(ulong)(*(int *)(lVar21 + 0x14) == 4);
            }
            return puVar12;
          }
        }
LAB_06b1dae4:
        ...
        if (plVar16 != (long *)0x0) {
          ...
          if (uVar11 != 0) {
            ...
            do {
              if (*(long *)(piVar24 + -2) == *(long *)PTR_DAT_0777e548) {
                puVar12 = (undefined8 *)(lVar21 + (long)(*piVar24 + 0x1b) * 0x10 + 0x138);
                goto LAB_06b1db7c;
              }
              uVar11 = uVar11 - 1;
              piVar24 = piVar24 + 4;
          ...
          puVar12 = (undefined8 *)func_0x03256b10(plVar16,*(long *)PTR_DAT_0777e548,0x1b);
LAB_06b1db7c:
          plVar13 = (long *)(*(code *)*puVar12)(plVar16,puVar12[1]);
          plVar26 = (long *)puVar5;
          if (plVar13 != (long *)0x0) {
            lVar21 = *plVar13;
            uVar11 = (ulong)*(ushort *)(lVar21 + 0x12e);
            if (uVar11 != 0) {
              ...
              do {
                if (*(long *)(piVar24 + -2) == *(long *)PTR_DAT_0777c248) {
                  puVar12 = (undefined8 *)(lVar21 + (long)(*piVar24 + 0xf) * 0x10 + 0x138);
                  goto LAB_06b1dbe8;
                }
                uVar11 = uVar11 - 1;
                piVar24 = piVar24 + 4;
            ...
            puVar12 = (undefined8 *)func_0x03256b10(plVar13,*(long *)PTR_DAT_0777c248,0xf);
LAB_06b1dbe8:
            iVar10 = (*(code *)*puVar12)(plVar13,puVar12[1]);
            if (iVar10 == 8) {
              lVar22 = *plVar16;
              lVar21 = *(long *)puVar5;
              uVar11 = (ulong)*(ushort *)(lVar22 + 0x12e);
              if (uVar11 != 0) {
                ...
                do {
                  if (*(long *)(piVar24 + -2) == lVar21) {
                    puVar12 = (undefined8 *)(lVar22 + (long)(*piVar24 + 0x1a) * 0x10 + 0x138);
                    goto LAB_06b1dc54;
                  }
                  uVar11 = uVar11 - 1;
                  piVar24 = piVar24 + 4;
              ...
              puVar12 = (undefined8 *)func_0x03256b10(plVar16,lVar21,0x1a);
LAB_06b1dc54:
              lVar21 = (*(code *)*puVar12)(plVar16,puVar12[1]);
              puVar12 = (undefined8 *)(ulong)(lVar21 != 0);
            }
            else {
              puVar12 = (undefined8 *)0x0;
            }
        ...
        puVar5 = PTR_DAT_0774f828;
        plVar16 = *(long **)(lVar21 + 0x10);
        if (plVar16 == (long *)0x0) {
          lVar21 = func_0x03280cac();
          puVar5 = PTR_DAT_0777e4f0;
        ...
        uStack_d4 = *(undefined4 *)(lVar21 + 0x18);
        uVar15 = func_0x03280b94(*(undefined8 *)puVar5,&uStack_d4);
        puVar12 = (undefined8 *)func_0x055f7edc(*(undefined8 *)puVar27,uVar14,uVar15,0);
        return puVar12;
      }
    }
  }
  ...
  puVar5 = PTR_DAT_0777a498;
  plVar13 = *(long **)(auVar28._0_8_ + 0x40);
  if (plVar13 != (long *)0x0) {
    lVar21 = *plVar13;
    uVar11 = (ulong)*(ushort *)(lVar21 + 0x12e);
    if (uVar11 != 0) {
    ...
    puVar12 = (undefined8 *)func_0x03256b10(plVar13,*(long *)PTR_DAT_0777a498,0x14);
LAB_06884dac:
    plVar26 = (long *)puVar12[1];
    uVar14 = (*(code *)*puVar12)(plVar13,auVar28._8_8_);
    puVar27 = PTR_DAT_077f1510;
    auVar29._8_8_ = uVar14;
    auVar29._0_8_ = plVar16;
    unaff_x23 = *(long **)(auVar28._0_8_ + 0x40);
    unaff_x24 = puVar5;
    if (unaff_x23 != (long *)0x0) {
      lVar22 = *unaff_x23;
      uVar11 = (ulong)*(ushort *)(lVar22 + 0x12e);
      ...
      puVar12 = (undefined8 *)func_0x03256b10(unaff_x23,lVar21,0x14);
LAB_06884e30:
      unaff_x24 = (undefined *)(*(code *)*puVar12)(unaff_x23,plVar16,puVar12[1]);
      uVar14 = 0x6884e54;
      auVar4 = auVar28;
      goto SUB_06884f94;
    }
  ...
  do {
    ...
    puVar8 = (undefined1 *)((long)puVar6 + -0x40);
    puVar7 = (ulong *)((long)puVar6 + -0x40);
    *(undefined8 *)((long)puVar6 + -0x30) = uVar14;
    *(undefined8 *)((long)puVar6 + -0x28) = 0;
    *(long **)((long)puVar6 + -0x20) = plVar13;
    *(undefined1 (*) [16])((long)puVar6 + -0x18) = auVar28;
    *(long **)((long)puVar6 + -8) = plVar16;
    *(undefined8 *)((long)puVar6 + -0x40) = 0;
    *(undefined8 *)((long)puVar6 + -0x38) = 0;
    plVar16 = plVar26;
    uVar11 = func_0x0688459c();
    if ((uVar11 & 1) == 0) {
      return (undefined8 *)0x0;
    }
    if ((auVar29._8_8_ != 0) && (plVar26 != (long *)0x0)) {
      uVar14 = *(undefined8 *)((long)puVar6 + -0x28);
      puVar20 = *(undefined1 **)((long)puVar6 + -0x40);
      plVar17 = *(long **)((long)puVar6 + -0x38);
      puVar18 = *(undefined1 **)(auVar29._8_8_ + 0x30);
      puVar19 = (undefined1 *)plVar26[6];
      uVar15 = 0x6884f3c;
      goto SUB_06885154;
    }
    uVar14 = 0x6884f94;
    auVar28 = func_0x03280cac();
SUB_06884f94:
    lVar22 = auVar28._0_8_;
    puVar20 = (undefined1 *)((long)puVar7 + -0x40);
    puVar6 = (ulong *)((long)puVar7 + -0x40);
    *(undefined8 *)((long)puVar7 + -0x30) = uVar14;
    *(long *)((long)puVar7 + -0x20) = auVar29._8_8_;
    *(undefined1 (*) [16])((long)puVar7 + -0x18) = auVar4;
    *(long *)((long)puVar7 + -8) = auVar29._0_8_;
    lVar21 = lVar22;
    if ((bRam0000000007e28d1a & 1) == 0) {
      lVar21 = func_0x03280a18(PTR_DAT_0777a498);
      bRam0000000007e28d1a = 1;
    }
    puVar18 = (undefined1 *)((long)puVar7 + -0x38);
    puVar19 = (undefined1 *)((long)puVar7 + -0x28);
    *(undefined8 *)((long)puVar7 + -0x28) = 0;
    *(undefined8 *)((long)puVar7 + -0x40) = 0;
    *(undefined8 *)((long)puVar7 + -0x38) = 0;
    uVar11 = func_0x0688459c(lVar21,auVar28._8_8_,plVar16,puVar18,puVar19,
                             (undefined1 *)((long)puVar7 + -0x40));
    puVar5 = PTR_DAT_0777a498;
    lVar21 = 0;
    if ((uVar11 & 1) == 0) {
      return (undefined8 *)0x0;
    }
    param_4 = *(long **)(lVar22 + 0x40);
    plVar13 = (long *)0x7e28000;
    if (param_4 != (long *)0x0) {
      lVar21 = *param_4;
      uVar25 = *(ulong *)((long)puVar7 + -0x28);
      uVar11 = (ulong)*(ushort *)(lVar21 + 0x12e);
      if (uVar11 != 0) {
        piVar24 = (int *)(*(long *)(lVar21 + 0xb0) + 8);
        do {
      ...
      puVar12 = (undefined8 *)func_0x03256b10(param_4,*(long *)PTR_DAT_0777a498,0x14);
LAB_06885060:
      plVar16 = (long *)puVar12[1];
      lVar21 = (*(code *)*puVar12)(param_4,uVar25);
      if (lVar21 == 0) {
        return (undefined8 *)0x0;
      }
      plVar26 = *(long **)(lVar22 + 0x40);
      auVar28._8_8_ = 0;
      ...
      if (plVar26 != (long *)0x0) {
        ...
        if (uVar11 == 0) goto LAB_068850b0;
        piVar24 = (int *)(*(long *)(lVar23 + 0xb0) + 8);
        break;
      }
    }
    plVar26 = auVar28._8_8_;
    auVar29 = func_0x03280cac(lVar21);
    lVar21 = auVar29._0_8_;
    puVar8 = (undefined1 *)((long)puVar7 + -0x60);
    *(undefined8 *)((long)puVar7 + -0x60) = 0x68850f8;
    *(long **)((long)puVar7 + -0x58) = plVar26;
    *(long **)((long)puVar7 + -0x50) = param_4;
    *(long *)((long)puVar7 + -0x48) = auVar28._0_8_;
    plVar17 = plVar16;
...
LAB_06885150:
      ...
      auVar29._8_8_ = plVar13;
      auVar29._0_8_ = auVar28._0_8_;
SUB_06885154:
      *(undefined8 *)(puVar8 + -0x40) = uVar15;
      *(undefined **)(puVar8 + -0x38) = puVar27;
      *(undefined **)(puVar8 + -0x30) = unaff_x24;
      *(long **)(puVar8 + -0x28) = unaff_x23;
      *(long *)(puVar8 + -0x20) = auVar29._8_8_;
      *(long **)(puVar8 + -0x18) = plVar26;
      *(long **)(puVar8 + -0x10) = param_4;
      *(long *)(puVar8 + -8) = lVar21;
      uVar9 = func_0x068846b4(auVar29._0_8_,plVar17);
      if ((uVar9 & 1) != 0) {
        func_0x068851c4(auVar29._0_8_,uVar14,plVar17,puVar18,puVar19,puVar20);
      }
      return (undefined8 *)(ulong)(uVar9 & 1);
    }
    plVar17 = (long *)0x0;
    uVar14 = func_0x06760834(*(long *)(lVar21 + 0x58),auVar29._8_8_,0);
    auVar29._8_8_ = uVar14;
    auVar29._0_8_ = lVar21;
    param_4 = plVar16;
    if (*(long *)(lVar21 + 0x58) == 0) goto LAB_06885150;
    plVar26 = (long *)func_0x06760834(*(long *)(lVar21 + 0x58),plVar16,0);
    plVar16 = *(long **)((long)puVar7 + -0x48);
    param_4 = (long *)0x0;
    uVar14 = *(undefined8 *)((long)puVar7 + -0x60);
    auVar28 = *(undefined1 (*) [16])((long)puVar7 + -0x58);
  } while( true );
  while( true ) {
    uVar11 = uVar11 - 1;
    piVar24 = piVar24 + 4;
    ...
    if (*(long *)(piVar24 + -2) == lVar22) {
      puVar12 = (undefined8 *)(lVar23 + (long)(*piVar24 + 0x10) * 0x10 + 0x138);
      goto LAB_068850d0;
    }
  }
LAB_068850b0:
  puVar12 = (undefined8 *)func_0x03256b10(plVar26,lVar22,0x10);
LAB_068850d0:
  puVar12 = (undefined8 *)(*(code *)*puVar12)(plVar26,lVar21,puVar12[1]);
  return puVar12;
}
