/* Ghidra 12.1.2 native pseudocode; RVA 0x6658CA8; MergeEngine.ECS.Systems.Board.BoardIdleHintSystem.FinishHinting; status ok */


void MergeEngine_ECS_Systems_Board_BoardIdleHintSystem__FinishHinting(long param_1)
...
LAB_06759120:
  ...
  *(long *)((long)register0x00000008 + -0x78) = param_1;
  MergeEngine_ECS_Systems_Board_BoardIdleHintSystem__FinishHinting();
  if (*(long *)(unaff_x19 + 0x88) != 0) {
    *(undefined1 *)(*(long *)(unaff_x19 + 0x88) + 0x29) = 1;
    return;
  }
  lVar7 = func_0x03280cac();
  puVar3 = (undefined8 *)((long)register0x00000008 + -0x90);
  register0x00000008 = (BADSPACEBASE *)((long)register0x00000008 + -0x90);
  *puVar3 = MergeEngine_ECS_Systems_Board_BoardIdleHintSystem__ItemDragEnded;
  ...
  unaff_x30 = MergeEngine_ECS_Systems_Board_BoardIdleHintSystem__ItemMerged;
