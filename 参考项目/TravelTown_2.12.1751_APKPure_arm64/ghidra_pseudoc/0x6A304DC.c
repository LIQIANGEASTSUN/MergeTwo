/* Ghidra 12.1.2 native pseudocode; RVA 0x6A304DC; Merger.MergeBoard.ViewModel.BoardItemBehavioursHandlerViewModel.PrepareBehaviours; status ok */
...
ulong Merger_MergeBoard_ViewModel_BoardItemBehavioursHandlerViewModel__PrepareBehaviours
