/* Ghidra 12.1.2 native pseudocode; RVA 0x6659170; MergeEngine.ECS.Systems.Board.BoardIdleHintSystem.ItemDragStarted; status ok */
...
void MergeEngine_ECS_Systems_Board_BoardIdleHintSystem__ItemDragStarted(long param_1)
...
SUB_06758ca8:
  ...
  *(undefined8 *)((long)register0x00000008 + -0x60) = 0x675917c;
...
LAB_06759120:
  ...
  *puVar3 = MergeEngine_ECS_Systems_Board_BoardIdleHintSystem__ItemTapped;
  if (*(long *)(lVar7 + 0x88) != 0) {
    *(undefined8 *)(*(long *)(lVar7 + 0x88) + 0x20) = 0;
    return;
  }
  unaff_x30 = MergeEngine_ECS_Systems_Board_BoardIdleHintSystem__ItemDragStarted;
