/* Ghidra 12.1.2 native pseudocode; RVA 0x6A97448; Merger.MergeBoard.Factories.MergeBoardItemsEntityFactory.CreateTimeCycleComponent; status ok */
...

{
  ...
  uVar4 = _UNK_017806e8;
  if (extraout_x1 != 0) {
    uVar10 = *(undefined8 *)(extraout_x1 + 0x1c);
    uVar9 = *(undefined8 *)(extraout_x1 + 0x14);
    uVar2 = *(undefined4 *)(extraout_x1 + 0x24);
    uVar3 = *(undefined4 *)(extraout_x1 + 0x2c);
    *(undefined1 *)((long)extraout_x8 + 0x14) = *(undefined1 *)(extraout_x1 + 0x28);
    ...
    *(undefined1 *)((long)extraout_x8 + 0x4f) = 0;
    extraout_x8[7] = uVar4;
    extraout_x8[5] = (double)(int)uVar10;
  ...
  if (extraout_x1_00 != (long *)0x0) {
    ...
    puVar5 = (undefined8 *)func_0x03256b10(extraout_x1_00,*(long *)PTR_DAT_0777e548,6);
LAB_06b97600:
    ...
    if (lVar6 != 0) {
      ...
      *(undefined1 *)((long)extraout_x8_00 + 0x13) = 0;
      *(undefined4 *)((long)extraout_x8_00 + 0x14) = uVar2;
      *(undefined4 *)(extraout_x8_00 + 3) = 0x100;
      *(undefined2 *)((long)extraout_x8_00 + 0x11) = 0;
      *(undefined4 *)((long)extraout_x8_00 + 0x1c) = uVar3;
      *extraout_x8_00 = (double)iVar1;
      extraout_x8_00[1] = (double)iVar1;
  ...
  if ((extraout_x1_01 != 0) && (*(long *)(extraout_x1_01 + 0x18) != 0)) {
    if (*(char *)(*(long *)(extraout_x1_01 + 0x18) + 0x10) != '\0') {
      func_0x03280ca0(*(undefined8 *)PTR_DAT_07832570);
      return;
    }
    if (*(long *)(extraout_x1_01 + 0x20) != 0) {
      if (*(char *)(*(long *)(extraout_x1_01 + 0x20) + 0x10) != '\0') {
