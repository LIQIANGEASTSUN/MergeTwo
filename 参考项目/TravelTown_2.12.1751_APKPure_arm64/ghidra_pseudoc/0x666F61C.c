/* Ghidra 12.1.2 native pseudocode; RVA 0x666F61C; MergeEngine.ECS.Systems.Board.MergeSystem.HandleStackingJokers; status ok */
...
void MergeEngine_ECS_Systems_Board_MergeSystem__HandleStackingJokers
               (byte *param_1,long param_2,long param_3,byte *param_4,long param_5,
...

{
  ...
  if (param_3 != 0) {
    lVar8 = func_0x03ced81c(param_3,*(undefined8 *)PTR_DAT_077e69c8);
    if (param_5 != 0) {
      lVar9 = func_0x03ced81c(param_5,*(undefined8 *)puVar4);
      if ((lVar8 == 0) || (uVar10 = func_0x06b1d910(param_4,0), (uVar10 & 1) == 0)) {
        uVar7 = 0;
      }
      else {
        uVar7 = func_0x069fded4(lVar8,0);
        uVar7 = uVar7 & 1;
      }
      if ((lVar9 == 0) || (uVar10 = func_0x06b1d910(param_6,0), (uVar10 & 1) == 0)) {
        bVar6 = 0;
      }
      else {
        bVar6 = func_0x069fded4(lVar9,0);
      }
      puVar5 = PTR_DAT_07808158;
      puVar4 = PTR_DAT_077d75b8;
      if (uVar7 == 0) {
        if ((bVar6 & 1) == 0) {
LAB_0676f820:
          bVar19 = 0;
          puVar12 = (undefined8 *)PTR_DAT_0776b160;
LAB_0676f82c:
...
LAB_0676f8a8:
            uVar16 = (*(code *)*puVar12)(plVar17,uVar18,param_4,uVar16,0,puVar12[1]);
            puVar5 = PTR_DAT_07808150;
            plVar17 = *(long **)(param_2 + 0x50);
            pbVar13 = param_4;
            if (plVar17 != (long *)0x0) {
              lVar8 = *plVar17;
...
LAB_0676f928:
              ...
              (*(code *)*puVar12)(plVar17,uVar11,param_6,uVar18,0,puVar12[1]);
          ...
          lVar8 = func_0x03ced81c(param_3,*(undefined8 *)PTR_DAT_077d75b8);
          if (lVar8 != 0) {
            *param_7 = *(undefined8 *)(lVar8 + 0x30);
            if (lVar9 != 0) {
              pbVar13 = (byte *)0x0;
              func_0x069fdec8(lVar9,1);
              plVar17 = *(long **)(param_2 + 0x68);
              uVar11 = func_0x03ced81c(param_3,*(undefined8 *)puVar4);
              if (plVar17 != (long *)0x0) {
                pbVar13 = *(byte **)puVar5;
                (**(code **)(*plVar17 + 0x218))
                          (plVar17,uVar11,pbVar13,1,1,*(undefined8 *)(*plVar17 + 0x220));
                goto LAB_0676f820;
              }
            }
          }
        ...
        pbVar13 = (byte *)0x0;
        func_0x069fdec8(lVar8,1);
        plVar17 = *(long **)(param_2 + 0x68);
        uVar11 = func_0x03ced81c(param_5,*(undefined8 *)puVar4);
        if (plVar17 != (long *)0x0) {
          pbVar13 = *(byte **)puVar5;
          bVar19 = 1;
          (**(code **)(*plVar17 + 0x218))
                    (plVar17,uVar11,pbVar13,1,1,*(undefined8 *)(*plVar17 + 0x220));
          puVar12 = (undefined8 *)PTR_DAT_07778fa0;
          goto LAB_0676f82c;
        }
      }
    }
...
SUB_032809c4:
  if (iRam00000000080486b8 != 0) {
    puVar1 = (ulong *)(((ulong)pbVar13 >> 0x12 & 0x7fff) * 8 + 0x7e7c690);
    do {
      cVar2 = '\x01';
      bVar3 = (bool)ExclusiveMonitorPass(puVar1,0x10);
      if (bVar3) {
        *puVar1 = *puVar1 | 1L << ((ulong)pbVar13 >> 0xc & 0x3f);
