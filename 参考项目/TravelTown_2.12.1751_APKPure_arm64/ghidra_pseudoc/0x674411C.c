/* Ghidra 12.1.2 native pseudocode; RVA 0x674411C; Merger.Game.Views.Board.BoardQueueView2.MoveToFront; status ok */
...
ulong Merger_Game_Views_Board_BoardQueueView2__MoveToFront(ulong param_1)

{
  ...
  if ((*(long *)(param_1 + 0x78) != 0) &&
     (lVar11 = func_0x06fdbed0(*(long *)(param_1 + 0x78),0), lVar11 != 0)) {
  ...
  UNRECOVERED_JUMPTABLE = Merger_Game_Views_Board_BoardQueueView2__MoveToBack;
