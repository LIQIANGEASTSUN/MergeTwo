/* Ghidra 12.1.2 native pseudocode; RVA 0x665AAC8; MergeEngine.ECS.Systems.Board.BoardIdleHintSystem.PlayItemHintAnimation; status ok */
...
void MergeEngine_ECS_Systems_Board_BoardIdleHintSystem__PlayItemHintAnimation(void)

{
  undefined *puVar1;
  
  puVar1 = PTR_DAT_07807890;
  if ((bRam0000000007e28063 & 1) == 0) {
    func_0x03280a18(PTR_DAT_077d7588);
    func_0x03280a18(PTR_DAT_07782de0);
    func_0x03280a18(PTR_DAT_07782de8);
    func_0x03280a18(PTR_DAT_07801a70);
    func_0x03280a18(PTR_DAT_07807898);
    func_0x03280a18(PTR_DAT_07807890);
    bRam0000000007e28063 = 1;
  }
