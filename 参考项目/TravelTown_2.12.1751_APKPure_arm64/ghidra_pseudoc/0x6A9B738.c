/* Ghidra 12.1.2 native pseudocode; RVA 0x6A9B738; Merger.MergeBoard.Controller.BoardController.HandleTap; status ok */
...
void Merger_MergeBoard_Controller_BoardController__HandleTap
...

{
  ...
  if ((bRam0000000007e2a83b & 1) == 0) {
    func_0x03280a18(PTR_DAT_07832778);
    func_0x03280a18(PTR_DAT_07832780);
    func_0x03280a18(PTR_DAT_07779710);
    bRam0000000007e2a83b = 1;
  }
  puVar1 = PTR_DAT_07832778;
  if (param_3 == 0) {
    uVar2 = func_0x03280ca0(*(undefined8 *)PTR_DAT_07779710);
    func_0x060157bc(uVar2,0);
  }
