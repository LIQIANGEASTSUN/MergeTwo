/* Ghidra 12.1.2 native pseudocode; RVA 0x6789B54; MergeEngine.ECS.Systems.Items.BoardTileLevelUnlockSystem.BoardViewOnLayoutInitialized; status ok */
...
void MergeEngine_ECS_Systems_Items_BoardTileLevelUnlockSystem__BoardViewOnLayoutInitialized
...

{
  ...
  uVar9 = 0x7e28000;
  if ((bRam0000000007e28d35 & 1) == 0) {
    func_0x03280a18(PTR_DAT_0776f1f8);
    func_0x03280a18(PTR_DAT_07773068);
    bRam0000000007e28d35 = 1;
  }
  puVar10 = unaff_x21;
  if (*(long *)(param_1 + 0x70) != 0) {
    lVar4 = func_0x06603648(*(long *)(param_1 + 0x70),0);
    puVar1 = PTR_DAT_0776f1f8;
    if (lVar4 == 0) {
      plVar5 = *(long **)(param_1 + 0x78);
      if (plVar5 != (long *)0x0) {
        lVar4 = (**(code **)(*plVar5 + 0x238))(plVar5,*(undefined8 *)(*plVar5 + 0x240));
        if ((lVar4 != 0) && (plVar5 = *(long **)(param_1 + 0x78), plVar5 != (long *)0x0)) {
          uVar9 = (ulong)*(uint *)(lVar4 + 0x20);
          lVar4 = (**(code **)(*plVar5 + 0x238))(plVar5,*(undefined8 *)(*plVar5 + 0x240));
          if (lVar4 != 0) {
      ...
      if (plVar5 != (long *)0x0) {
        ...
        uVar7 = func_0x04d0e88c(uVar6,*(undefined8 *)puVar1);
        plVar5 = *(long **)(param_1 + 0x70);
        puVar10 = puVar1;
        if (plVar5 != (long *)0x0) {
          uVar9 = uVar7 & 0xffffffff;
          uVar6 = (**(code **)(*plVar5 + 0x238))(plVar5,*(undefined8 *)(*plVar5 + 0x240));
          uVar3 = func_0x04d0e88c(uVar6,*(undefined8 *)puVar1);
          if (*(long *)(param_1 + 0x70) != 0) {
            func_0x06603648(*(long *)(param_1 + 0x70),0);
LAB_06889c74:
...
LAB_06889c84:
  ...
  *(undefined8 *)(puVar2 + -0x40) = unaff_x26;
  ...
  *(ulong *)(puVar2 + -0x10) = uVar9;
  *(long *)(puVar2 + -8) = param_1;
  *(undefined4 *)(puVar2 + -0x70) = uVar3;
  *(undefined4 *)(puVar2 + -0x6c) = uVar8;
  if ((bRam0000000007e28d39 & 1) == 0) {
    func_0x03280a18(PTR_DAT_0776f318);
    func_0x03280a18(PTR_DAT_0774e758);
    func_0x03280a18(PTR_DAT_0777afb0);
    func_0x03280a18(PTR_DAT_077d75b8);
    func_0x03280a18(PTR_DAT_077d7588);
    func_0x03280a18(PTR_DAT_078102a0);
    func_0x03280a18(PTR_DAT_078102a8);
    func_0x03280a18(PTR_DAT_0774e8c8);
    func_0x03280a18(PTR_DAT_078102b0);
    func_0x03280a18(PTR_DAT_07800360);
    ...
    func_0x03280a18(PTR_DAT_078102b8);
    func_0x03280a18(PTR_DAT_077803f8);
    func_0x03280a18(PTR_DAT_078102c0);
    func_0x03280a18(PTR_DAT_07810298);
    func_0x03280a18(PTR_DAT_078102c8);
    func_0x03280a18(PTR_DAT_078102d0);
    func_0x03280a18(PTR_DAT_078102d8);
    func_0x03280a18(PTR_DAT_078102e0);
    func_0x03280a18(PTR_DAT_078102e8);
    bRam0000000007e28d39 = 1;
  }
