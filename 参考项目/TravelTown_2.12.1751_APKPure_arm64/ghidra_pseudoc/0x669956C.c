/* Ghidra 12.1.2 native pseudocode; RVA 0x669956C; Merger.Game.Views.BoardView.LoadBoardSpritesFired; status ok */
...
undefined8 * Merger_Game_Views_BoardView__LoadBoardSpritesFired(long param_1)

{
  ...
  puVar4 = PTR_DAT_07809650;
  puVar16 = PTR_DAT_07809120;
  if ((bRam0000000007e282ea & 1) == 0) {
    func_0x03280a18(PTR_DAT_07809120);
    func_0x03280a18(PTR_DAT_07809650);
    func_0x03280a18(PTR_DAT_07809250);
    bRam0000000007e282ea = 1;
  }
  lVar15 = *(long *)(param_1 + 0x130);
  uVar8 = func_0x03280ca0(*(undefined8 *)puVar16);
  func_0x054221d4(uVar8,param_1,*(undefined8 *)puVar4,0);
  if (lVar15 == 0) {
    lVar10 = func_0x03280cac();
    puVar5 = PTR_DAT_07809658;
    puVar4 = PTR_DAT_07809120;
    if ((bRam0000000007e282eb & 1) == 0) {
      func_0x03280a18(PTR_DAT_07809120);
      func_0x03280a18(PTR_DAT_07809658);
      func_0x03280a18(PTR_DAT_07809250);
      bRam0000000007e282eb = 1;
    }
    lVar15 = *(long *)(lVar10 + 0x130);
    uVar9 = func_0x03280ca0(*(undefined8 *)puVar4);
    func_0x054221d4(uVar9,lVar10,*(undefined8 *)puVar5,0);
    if (lVar15 == 0) {
      puVar7 = (undefined8 *)func_0x03280cac();
      return puVar7;
    }
    lVar10 = *(long *)PTR_DAT_07809250;
  ...
  *(undefined **)((long)register0x00000008 + -0x20) = puVar16;
  *(undefined8 *)((long)register0x00000008 + -0x18) = uVar8;
  *(undefined8 *)((long)register0x00000008 + -0x10) = unaff_x20;
  *(long *)((long)register0x00000008 + -8) = param_1;
  lVar11 = *(long *)(*(long *)(*(long *)(lVar10 + 0x20) + 0xc0) + 0x40);
  if ((*(byte *)(lVar11 + 0x135) & 1) == 0) {
    lVar11 = func_0x0325681c(lVar11);
  }
  lVar11 = func_0x03280ca0(lVar11);
  func_0x0403f7a0(lVar11,*(undefined8 *)(*(long *)(*(long *)(lVar10 + 0x20) + 0xc0) + 0x48));
  if (lVar11 != 0) {
  ...
  *(long *)((long)register0x00000008 + -0x38) = lVar10;
  ...
  puVar16 = PTR_DAT_0777ecf8;
  if (*(long *)(lVar11 + 0x10) == 0) {
    plVar14 = *(long **)(lVar11 + 0x20);
    if (plVar14 != (long *)0x0) {
      lVar15 = *plVar14;
      ...
      if (uVar12 != 0) {
        ...
        do {
          if (*(long *)(piVar13 + -2) == *(long *)PTR_DAT_0777ecf8) {
      ...
      puVar7 = (undefined8 *)func_0x03256b10(plVar14,*(long *)PTR_DAT_0777ecf8,0);
LAB_04754990:
      ...
      if (plVar14 == (long *)0x0) {
        ...
        *(undefined **)((long)register0x00000008 + -0x68) = puVar16;
      ...
      puVar7 = (undefined8 *)func_0x03256b10(plVar14,lVar15,0);
LAB_04754a00:
      puVar7 = (undefined8 *)(*(code *)*puVar7)(plVar14,puVar7[1]);
      if ((int)puVar7 == 1) {
        return puVar7;
      }
    }
    puVar7 = (undefined8 *)(ulong)(*(long *)(lVar11 + 0x18) != 0);
  }
  else {
