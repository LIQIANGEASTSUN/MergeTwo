/* Ghidra 12.1.2 native pseudocode; RVA 0x4944A38; MergeEngine.Util.WeightedItemList<TItem>.GetItem; status ok */


ulong MergeEngine_Util_WeightedItemList_TItem___GetItem(long param_1,long *param_2,long param_3)

{
  ...
  func_0x04c1b8d8(lVar4,*(undefined8 *)(*(long *)(*(long *)(param_3 + 0x20) + 0xc0) + 0xa8));
  if (param_2 != (long *)0x0) {
