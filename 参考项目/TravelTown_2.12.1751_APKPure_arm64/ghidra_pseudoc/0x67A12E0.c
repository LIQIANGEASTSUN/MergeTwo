/* Ghidra 12.1.2 native pseudocode; RVA 0x67A12E0; MergeEngine.ECS.Systems.Items.ImmidateToolsSystem.ImmediateToolCollectSystem.AnimateToolsToInventorySequence; status ok */
...
void MergeEngine_ECS_Systems_Items_ImmidateToolsSystem_ImmediateToolCollectSystem__AnimateToolsToInventorySequence
               (void)

{
  undefined *puVar1;
  
  puVar1 = PTR_DAT_07810a90;
