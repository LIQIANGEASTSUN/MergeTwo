/* Ghidra 12.1.2 native pseudocode; RVA 0x6A4E9D8; Merger.MergeBoard.Utils.SpawningItemsUtils.GetItemFromQueue; status ok */


long Merger_MergeBoard_Utils_SpawningItemsUtils__GetItemFromQueue
