/* Ghidra 12.1.2 native pseudocode; RVA 0x453657C; MergeEngine.ECS.Systems.Items.Producers.SpawningItemsSystem<object>.OnItemBoosted; status ok */
...
void MergeEngine_ECS_Systems_Items_Producers_SpawningItemsSystem_object___OnItemBoosted
...

{
  ...
  if ((*(byte *)(*(long *)(*(long *)(*(long *)(param_4 + 0x20) + 0xc0) + 0x98) + 0x135) & 1) == 0) {
    func_0x0325681c();
  }
  lVar4 = func_0x03280ca0();
  func_0x0404e744(lVar4,*(undefined8 *)(*(long *)(*(long *)(param_4 + 0x20) + 0xc0) + 0xa0));
  if (lVar4 == 0) {
    func_0x03280cac();
