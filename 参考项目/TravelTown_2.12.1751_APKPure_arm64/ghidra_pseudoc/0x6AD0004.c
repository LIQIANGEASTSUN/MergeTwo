/* Ghidra 12.1.2 native pseudocode; RVA 0x6AD0004; Merger.MergeBoard.PowerBoost.Services.PowerBoostModesCalculator.OnEnergyChanged; status ok */
...
/* WARNING: Removing unreachable block (ram,0x03d5fde0) */
...
void Merger_MergeBoard_PowerBoost_Services_PowerBoostModesCalculator__OnEnergyChanged(long param_1)

{
  ...
  if (plVar6 == (long *)0x0) {
    ...
    if (uVar4 != 0) {
      ...
      do {
        if (*(long *)(piVar5 + -2) == *(long *)PTR_DAT_07833e20) {
    ...
    puVar2 = (undefined8 *)func_0x03256b10(plVar6,*(long *)PTR_DAT_07833e20,5);
LAB_06bd0090:
    uVar4 = (*(code *)*puVar2)(plVar6,puVar2[1]);
    puVar1 = PTR_DAT_07834128;
    if ((uVar4 & 1) == 0) {
      return;
    }
