/* Ghidra 12.1.2 native pseudocode; RVA 0x6624D98; Merger.Game.ViewModel.BoardViewModel.ChangeGameStateToOther; status ok */
...
void Merger_Game_ViewModel_BoardViewModel__ChangeGameStateToOther
...

{
  ...
  if ((bRam0000000007e27dd4 & 1) == 0) {
    func_0x03280a18(PTR_DAT_077726c0);
    func_0x03280a18(PTR_DAT_077731f8);
    bRam0000000007e27dd4 = 1;
  }
  plVar12 = *(long **)(param_3 + 0xf0);
  if (plVar12 != (long *)0x0) {
    lVar9 = *plVar12;
    ...
    if (uVar10 != 0) {
      ...
      do {
        if (*(long *)(piVar11 + -2) == *(long *)PTR_DAT_077726c0) {
...
LAB_06724e30:
    ...
    if (lVar9 != 0) {
      lVar8 = *(long *)PTR_DAT_077731f8;
      plVar12 = (long *)func_0x03c56c24(*(undefined8 *)
                                         (*(long *)(*(long *)(lVar8 + 0x20) + 0xc0) + 0x20));
      if (plVar12 == (long *)0x0) {
        unaff_x30 = 0x43218d0;
        auVar15 = func_0x03280cac();
        lVar9 = auVar15._0_8_;
        *(int *)(lVar9 + 0x20) = auVar15._8_4_;
      }
      else {
        uVar10 = (**(code **)(*plVar12 + 0x1b8))
                           (plVar12,*(undefined4 *)(lVar9 + 0x20),2,
      ...
      *(undefined8 *)(puVar6 + -0x10) = unaff_x30;
      *(long *)(puVar6 + -8) = lVar8;
      lVar8 = *(long *)(lVar9 + 0x10);
      if (lVar8 != 0) {
        (**(code **)(lVar8 + 0x18))
                  (*(undefined8 *)(lVar8 + 0x40),*(undefined4 *)(lVar9 + 0x20),
                   *(undefined8 *)(lVar8 + 0x28));
      }
      lVar9 = *(long *)(lVar9 + 0x18);
      if (lVar9 != 0) {
                    /* WARNING: Could not recover jumptable at 0x04d0ebdc. Too many branches */
  ...
  if ((bRam0000000007e27dd5 & 1) == 0) {
    func_0x03280a18(PTR_DAT_07806838);
    bRam0000000007e27dd5 = 1;
  }
  plVar12 = *(long **)(auVar14._0_8_ + 0xe8);
  if (plVar12 == (long *)0x0) {
    uVar13 = func_0x03280cac();
    puVar4 = PTR_DAT_07802d78;
    if ((bRam0000000007e27dd6 & 1) == 0) {
      func_0x03280a18(PTR_DAT_07802d78);
      func_0x03280a18(PTR_DAT_07802d80);
      bRam0000000007e27dd6 = 1;
    }
    lVar9 = func_0x03280ca0(*(undefined8 *)puVar4);
    func_0x066b9ba8(uVar13,param_2,lVar9,extraout_x1,param_5,0);
    if (lVar9 == 0) {
      auVar14 = func_0x03280cac();
      ...
      plVar12 = *(long **)(auVar14._0_8_ + 0xf8);
      if (plVar12 != (long *)0x0) {
        lVar9 = *plVar12;
        uVar10 = (ulong)*(ushort *)(lVar9 + 0x12e);
        if (uVar10 != 0) {
          piVar11 = (int *)(*(long *)(lVar9 + 0xb0) + 8);
          do {
            if (*(long *)(piVar11 + -2) == *(long *)PTR_DAT_07806840) {
        ...
        puVar7 = (undefined8 *)func_0x03256b10(plVar12,*(long *)PTR_DAT_07806840,0);
LAB_06725084:
                    /* WARNING: Could not recover jumptable at 0x067250a0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (*(code *)*puVar7)(plVar12,auVar14._8_8_,param_5,puVar7[1]);
        return;
      }
      ...
      if (plVar12 != (long *)0x0) {
        ...
        if (uVar10 != 0) {
          piVar11 = (int *)(*(long *)(lVar9 + 0xb0) + 8);
          do {
            if (*(long *)(piVar11 + -2) == *(long *)PTR_DAT_078067e0) {
              puVar7 = (undefined8 *)(lVar9 + (long)*piVar11 * 0x10 + 0x138);
              goto LAB_06725130;
            }
            uVar10 = uVar10 - 1;
        ...
        puVar7 = (undefined8 *)func_0x03256b10(plVar12,*(long *)PTR_DAT_078067e0,0);
LAB_06725130:
      ...
      if (plVar12 != (long *)0x0) {
        ...
        puVar7 = (undefined8 *)func_0x03256b10(plVar12,*(long *)PTR_DAT_078067e0,1);
LAB_067251d4:
      ...
      lVar9 = func_0x03280cac();
      puVar5 = PTR_DAT_077730a0;
      puVar4 = PTR_DAT_07773098;
      ...
      func_0x04321630(uVar13,1,*(undefined8 *)puVar5);
      puVar7 = (undefined8 *)(lVar9 + 0x118);
      *(undefined8 *)(lVar9 + 0x118) = uVar13;
    }
    else {
  ...
  lVar9 = func_0x03256b10(plVar12);
LAB_06724ef4:
  lVar9 = func_0x03280b88(*(undefined8 *)(lVar9 + 8),lVar8);
                    /* WARNING: Could not recover jumptable at 0x06724f18. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(lVar9 + 8))(plVar12,auVar14._8_8_,lVar9);
  return;
}
