/* Ghidra 12.1.2 native pseudocode; RVA 0x3D3FCAC; Merger.Services.Backend.WebSocket.OperationTrackingSystem.TrackCollectToolboxOperation<object>; status ok */


undefined8
Merger_Services_Backend_WebSocket_OperationTrackingSystem__TrackCollectToolboxOperation_object_
...

{
  ...
  if ((*(long *)(param_3 + 0x38) == 0) &&
     (func_0x03280a18(PTR_DAT_0777aa88), *(long *)(param_3 + 0x38) == 0)) {
...
LAB_03e3fd54:
  ...
  *(long *)(lVar5 + 0x30) = lVar9;
  func_0x032809c4((long *)(lVar5 + 0x30),lVar9);
  ...
  *(long *)(lVar17 + 0x20) = lVar5;
  ...
  func_0x04143c38(lVar9,*(undefined8 *)(*(long *)(param_7 + 0x38) + 0x10));
  if (lVar9 == 0) goto LAB_03e402a8;
    ...
    *(int *)(lVar9 + 0x1c) = *(int *)(lVar9 + 0x1c) + 1;
    ...
    if (uVar4 < *(uint *)(lVar5 + 0x18)) {
      ...
      *plVar6 = (long)param_4;
      ...
      lVar19 = *(long *)(*(long *)(*(long *)(lVar12 + 0x20) + 0xc0) + 0x70);
      func_0x0414446c(lVar9,param_4);
    }
...
LAB_03e40028:
    ...
    if (lVar5 != 0) {
      lVar19 = *(long *)(*(long *)(param_7 + 0x38) + 0x28);
      ...
      if (lVar19 == 0) {
        ...
        lVar19 = func_0x03280ca0(*(undefined8 *)PTR_DAT_0777aaa0);
        plVar14 = (long *)0x0;
        func_0x053569b8(lVar19,uVar16,*(undefined8 *)(*(long *)(param_7 + 0x38) + 0x30));
        lVar12 = *(long *)(*(long *)(param_7 + 0x38) + 0x28);
        if ((*(byte *)(lVar12 + 0x135) & 1) == 0) {
          lVar12 = func_0x0325681c();
        }
        *(long *)(*(long *)(lVar12 + 0xb8) + 8) = lVar19;
        lVar12 = *(long *)(*(long *)(param_7 + 0x38) + 0x28);
        if ((*(byte *)(lVar12 + 0x135) & 1) == 0) {
          lVar12 = func_0x0325681c();
        }
        func_0x032809c4(*(long *)(lVar12 + 0xb8) + 8,lVar19);
      }
      uVar16 = func_0x03d50a94(lVar5,lVar19,*(undefined8 *)PTR_DAT_0777aa90);
      uVar4 = func_0x03d37bc0(uVar16,param_5,*(undefined8 *)PTR_DAT_0776aeb0);
      auStack_84[0] = 0;
      lVar19 = *(long *)PTR_DAT_07751420;
      func_0x04377614(auStack_84,uVar4 & 1);
      if ((param_6 != (long *)0x0) && (0xff < auStack_84[0])) {
        lVar5 = *param_6;
        uVar10 = (ulong)*(ushort *)(lVar5 + 0x12e);
        if (uVar10 != 0) {
          piVar13 = (int *)(*(long *)(lVar5 + 0xb0) + 8);
    ...
    if (uVar11 != 0) {
      ...
      do {
        if (*(long *)(piVar13 + -2) == *(long *)(lVar17 + 0x20)) {
          lVar19 = lVar19 + (long)(int)(*piVar13 + (uint)*(ushort *)(lVar17 + 0x50)) * 0x10 + 0x138;
          goto LAB_03e40264;
        }
        uVar11 = uVar11 - 1;
        piVar13 = piVar13 + 4;
...
LAB_03e40264:
    lVar19 = func_0x03280b88(*(undefined8 *)(lVar19 + 8),lVar17);
    uVar16 = (**(code **)(lVar19 + 8))(plVar6,uVar16,lVar9,0,lVar19);
    return uVar16;
  }
LAB_03e402a8:
  auVar20 = func_0x03280cac();
  ...
  if ((*(long *)(lVar19 + 0x38) == 0) &&
     (func_0x03280a18(PTR_DAT_0777aac0), *(long *)(lVar19 + 0x38) == 0)) {
  ...
  if (plVar6 == (long *)0x0) {
    ...
    if ((*(long *)(lVar9 + 0x38) == 0) &&
       (func_0x03280a18(PTR_DAT_0777aac8), *(long *)(lVar9 + 0x38) == 0)) {
    ...
    if (plVar6 == (long *)0x0) {
      ...
      lVar9 = lVar19;
      if ((*(long *)(lVar19 + 0x38) == 0) &&
         (func_0x03280a18(PTR_DAT_0777aad0), *(long *)(lVar19 + 0x38) == 0)) {
        func_0x03256878(lVar19);
      }
      plVar6 = *(long **)(auVar20._0_8_ + 0x40);
      if (plVar6 == (long *)0x0) {
        ...
        lVar19 = lVar9;
        if ((*(long *)(lVar9 + 0x38) == 0) &&
           (func_0x03280a18(PTR_DAT_0777aad8), *(long *)(lVar9 + 0x38) == 0)) {
          func_0x03256878(lVar9);
        }
        plVar6 = *(long **)(auVar20._0_8_ + 0x40);
        if (plVar6 == (long *)0x0) {
          ...
          lVar9 = lVar19;
          if ((*(long *)(lVar19 + 0x38) == 0) &&
             (func_0x03280a18(PTR_DAT_0777aae0), *(long *)(lVar19 + 0x38) == 0)) {
            func_0x03256878(lVar19);
          }
          plVar6 = *(long **)(auVar20._0_8_ + 0x40);
          if (plVar6 == (long *)0x0) {
            ...
            lVar19 = lVar9;
            if ((*(long *)(lVar9 + 0x38) == 0) &&
               (func_0x03280a18(PTR_DAT_0777aae8), *(long *)(lVar9 + 0x38) == 0)) {
              func_0x03256878(lVar9);
            }
            plVar6 = *(long **)(auVar20._0_8_ + 0x40);
            if (plVar6 == (long *)0x0) {
              ...
              lVar9 = lVar19;
              if ((*(long *)(lVar19 + 0x38) == 0) &&
                 (func_0x03280a18(PTR_DAT_0777aaf0), *(long *)(lVar19 + 0x38) == 0)) {
                func_0x03256878(lVar19);
              }
              plVar6 = *(long **)(auVar20._0_8_ + 0x40);
              if (plVar6 == (long *)0x0) {
                ...
                if (plVar6 == (long *)0x0) {
                  ...
                  lVar19 = lVar9;
                  if ((*(long *)(lVar9 + 0x38) == 0) &&
                     (func_0x03280a18(PTR_DAT_0777ab18), *(long *)(lVar9 + 0x38) == 0)) {
                    func_0x03256878(lVar9);
                  }
                  plVar6 = *(long **)(auVar20._0_8_ + 0x40);
                  if (plVar6 == (long *)0x0) {
                    ...
                    lVar9 = lVar19;
                    if ((*(long *)(lVar19 + 0x38) == 0) &&
                       (func_0x03280a18(PTR_DAT_0777ab20), *(long *)(lVar19 + 0x38) == 0)) {
                      func_0x03256878(lVar19);
                    }
                    plVar6 = *(long **)(auVar20._0_8_ + 0x40);
                    if (plVar6 == (long *)0x0) {
...
LAB_03e40cdc:
                    ...
                    /* WARNING: Treating indirect jump as call */
                      ...
                      lVar9 = lVar19;
                      if ((*(long *)(lVar19 + 0x38) == 0) &&
                         (func_0x03280a18(PTR_DAT_0777ab30), *(long *)(lVar19 + 0x38) == 0)) {
                        func_0x03256878(lVar19);
                      }
                      ...
                      if (plVar14 == (long *)0x0) {
                        ...
                        if (lVar17 != 0) {
                          ...
                          func_0x04fe2d7c(lVar17,*(undefined8 *)PTR_DAT_07779e90,lVar9,plVar14);
                          lVar19 = lVar9;
                          if (plVar15 != (long *)0x0) {
                            lVar9 = *plVar15;
...
LAB_03e40f1c:
                    ...
                    /* WARNING: Treating indirect jump as call */
                        ...
                        lVar9 = *(long *)(*(long *)(lVar17 + 0x38) + 0x10);
                        if ((*(byte *)(lVar9 + 0x135) & 1) == 0) {
                          lVar9 = func_0x0325681c();
                        }
                        uVar16 = (*(code *)**(undefined8 **)(plVar8[7] + 0x10))
                                           (auVar20._8_8_,lVar19,**(undefined8 **)(lVar9 + 0xb8));
