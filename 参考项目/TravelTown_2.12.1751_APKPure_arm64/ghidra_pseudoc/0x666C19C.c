/* Ghidra 12.1.2 native pseudocode; RVA 0x666C19C; MergeEngine.ECS.Systems.Board.ChargableSystem.OnWillProcessComponents; status ok */


long MergeEngine_ECS_Systems_Board_ChargableSystem__OnWillProcessComponents
...

{
  ...
  puVar3 = PTR_DAT_07807fc8;
  puVar2 = PTR_DAT_07807fc0;
  ...
  if (lVar16 == 0) {
    ...
    lVar16 = func_0x03280ca0(*(undefined8 *)PTR_DAT_07807fd0);
    param_4 = 0;
    func_0x05355fbc(lVar16,uVar17,*(undefined8 *)PTR_DAT_07807fd8);
