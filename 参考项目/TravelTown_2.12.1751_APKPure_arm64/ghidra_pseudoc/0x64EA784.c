/* Ghidra 12.1.2 native pseudocode; RVA 0x64EA784; MergeEngine.ECS.Systems.State.Board.BoardProducerInventoryStateSystem.GetExistingEntityIds; status ok */


long MergeEngine_ECS_Systems_State_Board_BoardProducerInventoryStateSystem__GetExistingEntityIds
...

{
  ...
  puVar3 = PTR_DAT_077fb9d0;
  puVar9 = PTR_DAT_077803b0;
  ...
  uVar10 = func_0x03eb6ac8(param_1,*(undefined8 *)puVar9);
  lVar15 = *(long *)puVar3;
  ...
  if (lVar16 == 0) {
    ...
    lVar16 = func_0x03280ca0(*(undefined8 *)PTR_DAT_077803a0);
    param_4 = 0;
    func_0x05355fbc(lVar16,uVar17,*(undefined8 *)PTR_DAT_077fba30);
    plVar11 = (long *)(*(long *)(*(long *)puVar3 + 0xb8) + 0x10);
    *plVar11 = lVar16;
    func_0x032809c4(plVar11,lVar16);
  }
  uVar10 = func_0x03d872a8(uVar10,lVar16,*(undefined8 *)puVar9);
  lVar15 = *(long *)puVar3;
  if (*(int *)(lVar15 + 0xe0) == 0) {
    func_0x03280b8c(lVar15);
    lVar15 = *(long *)puVar3;
  ...
  lVar16 = *(long *)(*(long *)(lVar15 + 0xb8) + 0x18);
  if (lVar16 == 0) {
    if (*(int *)(lVar15 + 0xe0) == 0) {
      func_0x03280b8c(lVar15);
      lVar15 = *(long *)puVar3;
    ...
    uVar17 = **(undefined8 **)(lVar15 + 0xb8);
    lVar16 = func_0x03280ca0(*(undefined8 *)PTR_DAT_077803a8);
    param_4 = 0;
    func_0x053569b8(lVar16,uVar17,*(undefined8 *)PTR_DAT_077fba38);
    plVar11 = (long *)(*(long *)(*(long *)puVar3 + 0xb8) + 0x18);
    *plVar11 = lVar16;
    func_0x032809c4(plVar11,lVar16);
  }
  lVar14 = *(long *)puVar9;
  lVar15 = func_0x03d50a94(uVar10,lVar16);
  lVar16 = *(long *)puVar2;
  ...
  if (lVar15 != 0) {
    ...
    func_0x04143d60(lVar14,lVar15,*(undefined8 *)(*(long *)(lVar16 + 0x38) + 0x10));
    return lVar14;
  }
  uVar10 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar10 = func_0x05ac7464(uVar10,0);
  auVar18 = func_0x03280b7c(uVar10,lVar16);
  ...
  if (auVar18._0_8_ != 0) {
    ...
    func_0x0419ce74(lVar16,auVar18._0_8_,*(undefined8 *)(*(long *)(lVar15 + 0x38) + 0x10));
    return lVar16;
  }
  uVar10 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar10 = func_0x05ac7464(uVar10,0);
  auVar19 = func_0x03280b7c(uVar10,lVar15);
  ...
  if (auVar19._0_8_ != 0) {
    ...
    lVar16 = func_0x03280ca0();
    func_0x041c2810(lVar16,auVar19._0_8_,*(undefined8 *)(*(long *)(lVar15 + 0x38) + 0x10));
    return lVar16;
  }
  uVar10 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar10 = func_0x05ac7464(uVar10,0);
  auVar18 = func_0x03280b7c(uVar10,lVar15);
  lVar15 = auVar18._8_8_;
  uStack_80 = 0x3d60144;
  auStack_70 = auVar19;
  if (*(long *)(lVar15 + 0x38) == 0) {
  ...
  if (auVar18._0_8_ != 0) {
    ...
    lVar16 = func_0x03280ca0();
    func_0x041ddb58(lVar16,auVar18._0_8_,*(undefined8 *)(*(long *)(lVar15 + 0x38) + 0x10));
    return lVar16;
  }
  uVar10 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar10 = func_0x05ac7464(uVar10,0);
  ...
  if (auVar19._0_8_ != 0) {
    ...
    lVar16 = func_0x03280ca0();
    func_0x041e617c(lVar16,auVar19._0_8_,*(undefined8 *)(*(long *)(lVar15 + 0x38) + 0x10));
    return lVar16;
  }
  uVar10 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar10 = func_0x05ac7464(uVar10,0);
  ...
  if (auVar18._0_8_ != 0) {
    ...
    lVar16 = func_0x03280ca0();
    func_0x041e8ba0(lVar16,auVar18._0_8_,*(undefined8 *)(*(long *)(lVar15 + 0x38) + 0x10));
    return lVar16;
  }
  uVar10 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar10 = func_0x05ac7464(uVar10,0);
  ...
  if (auVar19._0_8_ != 0) {
    ...
    lVar16 = func_0x03280ca0();
    (*(code *)**(undefined8 **)(*(long *)(lVar15 + 0x38) + 0x10))(lVar16,auVar19._0_8_);
    return lVar16;
  }
  uVar10 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar10 = func_0x05ac7464(uVar10,0);
  ...
  if (auVar18._0_8_ != 0) {
    ...
    lVar16 = func_0x03280ca0();
    func_0x0420cec8(lVar16,auVar18._0_8_,*(undefined8 *)(*(long *)(lVar15 + 0x38) + 0x10));
    return lVar16;
  }
  uVar10 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar10 = func_0x05ac7464(uVar10,0);
  ...
  if ((auVar19._0_8_ == 0) || (puVar9 = PTR_DAT_07779d18, auVar19._8_8_ == 0)) {
    ...
    uVar10 = func_0x05ac7464(uVar10,0);
    auVar18 = func_0x03280b7c(uVar10,lVar14);
    ...
    if ((auVar19._0_8_ == 0) || (puVar9 = PTR_DAT_07779d18, auVar19._8_8_ == 0)) {
      uVar10 = func_0x03280a2c(puVar9);
      uVar10 = func_0x05ac7464(uVar10,0);
      auStack_198 = func_0x03280b7c(uVar10,lVar16);
      ...
      if ((auStack_198._0_8_ != 0) && (puVar9 = PTR_DAT_07779d18, auStack_198._8_8_ != 0)) {
        ...
        lVar15 = (*(code *)**(undefined8 **)(*(long *)(lVar14 + 0x38) + 8))
                           (auStack_198._0_8_,auStack_198._8_8_,0);
        return lVar15;
      }
      uVar10 = func_0x03280a2c(puVar9);
      uVar10 = func_0x05ac7464(uVar10,0);
      auVar19 = func_0x03280b7c(uVar10,lVar14);
      ...
      if ((auVar19._0_8_ == 0) || (puVar9 = PTR_DAT_07779d18, auVar19._8_8_ == 0)) {
        uVar10 = func_0x03280a2c(puVar9);
        uVar10 = func_0x05ac7464(uVar10,0);
        auVar20 = func_0x03280b7c(uVar10,param_4);
        auVar18._8_8_ = lVar8;
        ...
        if ((unaff_x22 != 0) && (puVar9 = PTR_DAT_07779d18, lStack_118 != 0)) {
                    ...
                    /* WARNING: Treating indirect jump as call */
          lVar15 = (*(code *)**(undefined8 **)(*(long *)(lVar8 + 0x38) + 0x10))
                             (unaff_x22,lStack_118,lVar16);
          return lVar15;
        }
        uVar10 = func_0x03280a2c(puVar9);
        uVar17 = func_0x05ac7464(uVar10,0);
        uVar10 = 0x3d6068c;
    ...
    *(undefined1 (*) [16])((long)puVar4 + -0x10) = auVar18;
    ...
    if (lVar7 != 0) {
      ...
      *(long *)(lVar7 + 0x28) = lVar15;
      func_0x032809c4((long *)(lVar7 + 0x28),lVar15);
      return lVar7;
    }
...
LAB_03d60730:
    ...
    *(undefined8 *)((long)puVar5 + -0x30) = uVar10;
  ...
  *(long *)((long)puVar6 + -8) = lVar14;
  ...
  lVar14 = func_0x03280ca0();
  uVar10 = *(undefined8 *)(*(long *)(lVar15 + 0x38) + 8);
  ...
  *(long *)((long)puVar6 + -0x38) = lVar7;
  ...
  if (lVar14 != 0) {
    func_0x02f17738(lVar14,*(long *)(**(long **)(lVar16 + 0x38) + 0x80) + 0xc0,lVar15);
    func_0x02f17738(lVar14,*(long *)(**(long **)(lVar16 + 0x38) + 0x80) + 0x100,auVar18._8_8_);
    func_0x02f17738(lVar14,*(long *)(**(long **)(lVar16 + 0x38) + 0x80) + 0x80,uVar10);
    return lVar14;
  }
  auVar19 = func_0x03280cac();
  ...
  *(undefined8 *)((long)puVar6 + -0x68) = uVar10;
  puVar13 = puVar12;
  if (puVar12[7] == 0) {
  ...
  if ((plVar11 == (long *)0x0) || (puVar9 = PTR_DAT_077799b8, lVar14 == 0)) {
    uVar10 = func_0x03280a2c(puVar9);
    uVar10 = func_0x05ac7464(uVar10,0);
    func_0x03280b7c(uVar10,puVar12);
LAB_03d60c04:
         ...
         (*(long *)(*(long *)(lVar7 + 200) + (ulong)*(byte *)(lVar16 + 0x130) * 8 + -8) == lVar16))
      {
        ...
        if ((*(byte *)(lVar16 + 0x130) <= bVar1) &&
           (*(long *)(*(long *)(lVar7 + 200) + (ulong)*(byte *)(lVar16 + 0x130) * 8 + -8) == lVar16)
                    ...
                    /* WARNING: Treating indirect jump as call */
          lVar15 = (**(code **)(lVar7 + 0x228))(plVar11,lVar14,*(undefined8 *)(lVar7 + 0x230));
          return lVar15;
        }
      }
      goto LAB_03d60c04;
    ...
    if (lVar15 == 0) {
      ...
      if ((*(byte *)(*plVar11 + 0x130) < *(byte *)(lVar15 + 0x130)) ||
        ...
        func_0x04b68fa4(lVar15,plVar11,lVar14,*(undefined8 *)(puVar12[7] + 0x58));
        return lVar15;
      }
      ...
      if ((*(byte *)(lVar16 + 0x130) <= *(byte *)(*plVar11 + 0x130)) &&
        ...
        func_0x04b713b0(lVar15,plVar11,lVar14,*(undefined8 *)(puVar12[7] + 0x48));
        return lVar15;
      }
      goto LAB_03d60c04;
    }
    ...
    if (lVar7 != 0) {
      func_0x04b66610(lVar15,lVar7,lVar14,*(undefined8 *)(puVar12[7] + 0x30));
      return lVar15;
    }
  }
  ...
  *(undefined1 (*) [16])((long)puVar6 + -0xa0) = auVar19;
  ...
  if ((plVar11 == (long *)0x0) || (puVar9 = PTR_DAT_077799b8, lVar14 == 0)) {
    ...
    if ((bVar1 < *(byte *)(lVar15 + 0x130)) ||
       (*(long *)(*(long *)(lVar7 + 200) + (ulong)*(byte *)(lVar15 + 0x130) * 8 + -8) != lVar15)) {
      ...
      if (lVar15 != 0) {
        ...
        lVar7 = func_0x03280b90(plVar11,lVar16);
        if (lVar7 != 0) {
          func_0x04b667e0(lVar15,lVar7,lVar14,*(undefined8 *)(puVar13[7] + 0x30));
          return lVar15;
        }
        goto LAB_03d60ee0;
      }
      lVar15 = *(long *)(puVar13[7] + 0x38);
      if ((*(byte *)(lVar15 + 0x135) & 1) == 0) {
        lVar15 = func_0x0325681c();
      }
      if ((*(byte *)(*plVar11 + 0x130) < *(byte *)(lVar15 + 0x130)) ||
        ...
        lVar15 = func_0x03280ca0();
        func_0x04b693d0(lVar15,plVar11,lVar14,*(undefined8 *)(puVar13[7] + 0x58));
        return lVar15;
      }
      ...
      {
        func_0x04b715c8(lVar15,plVar11,lVar14,*(undefined8 *)(puVar13[7] + 0x48));
        return lVar15;
      }
    }
    else {
  ...
  func_0x03281048(plVar11);
LAB_03d60ee0:
  lVar15 = func_0x03281048(plVar11,lVar16);
  ...
  *(undefined1 (*) [16])((long)puVar6 + -0xd0) = auVar18;
  ...
  if (lVar16 == 0) {
    ...
    **(long **)(lVar14 + 0xb8) = lVar16;
    ...
    func_0x032809c4(*(undefined8 *)(lVar15 + 0xb8),lVar16);
  }
  return lVar16;
}
