/* Ghidra 12.1.2 native pseudocode; RVA 0x3D4070C; Merger.Services.Backend.WebSocket.OperationTrackingSystem.TrackItemAddedToInventoryOperation<object>; status ok */


undefined8
Merger_Services_Backend_WebSocket_OperationTrackingSystem__TrackItemAddedToInventoryOperation_object_
...
LAB_03e40cdc:
            ...
            if (plVar9 == (long *)0x0) {
              ...
              if (lVar4 != 0) {
                ...
                func_0x04fe2d7c(lVar4,*(undefined8 *)PTR_DAT_07779e90,lVar12,lVar3);
                lVar6 = lVar12;
                if (plVar9 != (long *)0x0) {
                  lVar6 = *plVar9;
...
LAB_03e40f1c:
                  lVar6 = func_0x03280b88(*(undefined8 *)(lVar6 + 8),lVar12);
                    ...
                    /* WARNING: Treating indirect jump as call */
                  uVar10 = (**(code **)(lVar6 + 8))(plVar9,uVar10,auVar13._8_8_,lVar4,lVar6);
                  return uVar10;
                }
              }
              auVar13 = func_0x03280cac();
              ...
              lVar12 = *(long *)(*(long *)(lVar5 + 0x38) + 0x10);
              if ((*(byte *)(lVar12 + 0x135) & 1) == 0) {
                lVar12 = func_0x0325681c();
              }
              uVar10 = (*(code *)**(undefined8 **)(*(long *)(param_6 + 0x38) + 0x10))
                                 (auVar13._8_8_,lVar6,**(undefined8 **)(lVar12 + 0xb8));
