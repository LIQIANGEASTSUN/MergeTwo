/* Ghidra 12.1.2 native pseudocode; RVA 0x668F734; Merger.Game.Views.BoardUIView.Start; status ok */


ulong Merger_Game_Views_BoardUIView__Start(long param_1)

{
  ...
  if ((*(long *)(param_1 + 0x68) != 0) &&
     (lVar6 = func_0x06fdbed0(*(long *)(param_1 + 0x68),0), lVar6 != 0)) {
    ...
    uVar9 = (*pcRam0000000007e2fbf0)(lVar6,0);
    return uVar9;
  }
        ...
        do {
          ...
          if (lVar7 == 0) {
            ...
            if (lVar3 == 0) {
              ...
              uVar9 = *puVar10;
              while ((plVar4 = (long *)func_0x057ddb20(uVar9,auVar13._8_8_,0), plVar4 == (long *)0x0
                     || (*plVar4 == *(long *)puVar1))) {
              ...
              puVar10 = (ulong *)(auVar13._0_8_ + 0x18);
              uVar9 = *puVar10;
              while ((plVar4 = (long *)func_0x057ddd18(uVar9,auVar13._8_8_,0), plVar4 == (long *)0x0
                     || (*plVar4 == *(long *)puVar1))) {
                uVar5 = func_0x032dd140(puVar10,plVar4,uVar9);
                bVar2 = uVar9 == uVar5;
                uVar9 = uVar5;
