/* Ghidra 12.1.2 native pseudocode; RVA 0x6698B28; Merger.Game.Views.BoardView.GetTileCoordinatesGlobal; status ok */
...
undefined1  [16] Merger_Game_Views_BoardView__GetTileCoordinatesGlobal(long param_1,long param_2)

{
  ...
  if (*(long *)(param_1 + 0x120) == 0) {
    ...
    puVar9 = (ulong *)(lVar10 + 0x140);
    uVar12 = 0;
    *(undefined1 *)(lVar10 + 0x170) = 0;
    *(undefined8 *)(lVar10 + 0x140) = 0;
    goto SUB_032809c4;
  }
  uVar12 = *(ulong *)PTR_DAT_07809280;
  lVar10 = *(long *)(*(long *)(param_1 + 0x120) + 0x18);
  if (lVar10 == 0) {
LAB_04754504:
    func_0x03280cac();
  }
  else if ((uint)((ulong)param_2 >> 0x20) < *(uint *)(lVar10 + 0x18)) {
    lVar10 = *(long *)(lVar10 + (param_2 >> 0x20) * 8 + 0x20);
    if (lVar10 == 0) goto LAB_04754504;
    if ((uint)param_2 < *(uint *)(lVar10 + 0x18)) {
      auVar18._0_8_ = *(undefined8 *)(lVar10 + ((param_2 << 0x20) >> 0x1d) + 0x20);
  ...
  lVar10 = *(long *)(auVar19._0_8_ + 0x18);
  if (lVar10 != 0) {
    if (*(uint *)(lVar10 + 0x18) <= auVar19._12_4_) goto LAB_04754660;
    lVar10 = *(long *)(lVar10 + (auVar19._8_8_ >> 0x20) * 8 + 0x20);
    if (lVar10 != 0) {
      if (auVar19._8_4_ < *(uint *)(lVar10 + 0x18)) {
        puVar9 = (ulong *)(lVar10 + ((auVar19._8_8_ << 0x20) >> 0x1d) + 0x20);
        *puVar9 = uVar12;
SUB_032809c4:
...
LAB_04754660:
  ...
  lStack_a8 = 0;
  auVar20._0_8_ = func_0x03280ca0(*(undefined8 *)puVar7);
  func_0x040ce3d4(auVar20._0_8_,*(undefined8 *)puVar8);
  puVar7 = PTR_DAT_0777ece0;
  lVar16 = 0x30;
  if ((uVar13 & 1) == 0) {
    lVar16 = 0x28;
  }
  lVar16 = *(long *)(lVar10 + lVar16);
  if (lVar16 != 0) {
    lVar11 = extraout_x1;
    if (0 < (int)*(ulong *)(lVar16 + 0x18)) {
      ...
      do {
        ...
        piVar2 = (int *)(lVar16 + 0x20 + uVar12 * 8);
        func_0x069fdc94(&lStack_a8,*piVar2 + auVar19._8_4_,piVar2[1] + auVar19._12_4_,0);
        lVar11 = lStack_a8;
        if ((((-1 < (int)lStack_a8) && (-1 < lStack_a8)) &&
            ((int)lStack_a8 < *(int *)(lVar10 + 0x10))) &&
           ((int)((ulong)lStack_a8 >> 0x20) < *(int *)(lVar10 + 0x14))) {
          if (auVar20._0_8_ == 0) goto LAB_047547f0;
          lVar14 = *(long *)(auVar20._0_8_ + 0x10);
          lVar15 = *(long *)puVar7;
          *(int *)(auVar20._0_8_ + 0x1c) = *(int *)(auVar20._0_8_ + 0x1c) + 1;
          if (lVar14 == 0) goto LAB_047547f0;
          uVar3 = *(uint *)(auVar20._0_8_ + 0x18);
          if (uVar3 < *(uint *)(lVar14 + 0x18)) {
            *(uint *)(auVar20._0_8_ + 0x18) = uVar3 + 1;
            *(long *)(lVar14 + (long)(int)uVar3 * 8 + 0x20) = lStack_a8;
          }
          else {
            func_0x040cec28(auVar20._0_8_,lStack_a8,
        ...
        uVar12 = uVar12 + 1;
      } while ((long)uVar12 < (long)(int)*(uint *)(lVar16 + 0x18));
    }
    auVar20._8_8_ = lVar11;
    return auVar20;
  }
LAB_047547f0:
  ...
  if (-1 < auVar19._8_4_) {
    uVar12 = 0;
    if ((-1 < (long)auVar19._8_8_) && (auVar19._8_4_ < *(int *)(auVar19._0_8_ + 0x10))) {
      uVar12 = (ulong)(auVar19._12_4_ < *(int *)(auVar19._0_8_ + 0x14));
    }
    auVar19._0_8_ = uVar12;
    return auVar19;
  }
  auVar6._8_8_ = 0;
  auVar6._0_8_ = auVar19._8_8_;
  return auVar6 << 0x40;
}
