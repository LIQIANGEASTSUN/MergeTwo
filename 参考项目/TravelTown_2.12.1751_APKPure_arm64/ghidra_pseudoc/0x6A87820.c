/* Ghidra 12.1.2 native pseudocode; RVA 0x6A87820; Merger.MergeBoard.Logic.CombineValidators.MergeItemCombinerValidator.CanMergeSame; status ok */

ulong Merger_MergeBoard_Logic_CombineValidators_MergeItemCombinerValidator__CanMergeSame
