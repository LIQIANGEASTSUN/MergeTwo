/* Ghidra 12.1.2 native pseudocode; RVA 0x6624E60; Merger.Game.ViewModel.BoardViewModel.UnregisterView; status ok */
...
void Merger_Game_ViewModel_BoardViewModel__UnregisterView
...

{
  ...
  if (plVar10 == (long *)0x0) {
    ...
    func_0x066b9ba8(uVar12,param_2,lVar7,extraout_x1,param_5,0);
    if (lVar7 == 0) {
      ...
      plVar10 = *(long **)(auVar13._0_8_ + 0xf8);
      if (plVar10 != (long *)0x0) {
        lVar7 = *plVar10;
        ...
        if (uVar8 != 0) {
          ...
          do {
            if (*(long *)(piVar9 + -2) == *(long *)PTR_DAT_07806840) {
        ...
        puVar6 = (undefined8 *)func_0x03256b10(plVar10,*(long *)PTR_DAT_07806840,0);
LAB_06725084:
                    /* WARNING: Could not recover jumptable at 0x067250a0. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        (*(code *)*puVar6)(plVar10,auVar13._8_8_,param_5,puVar6[1]);
        return;
      }
      ...
      if (plVar10 != (long *)0x0) {
        ...
        if (uVar8 != 0) {
          piVar9 = (int *)(*(long *)(lVar7 + 0xb0) + 8);
          do {
            if (*(long *)(piVar9 + -2) == *(long *)PTR_DAT_078067e0) {
              puVar6 = (undefined8 *)(lVar7 + (long)*piVar9 * 0x10 + 0x138);
              goto LAB_06725130;
            }
            uVar8 = uVar8 - 1;
        ...
        puVar6 = (undefined8 *)func_0x03256b10(plVar10,*(long *)PTR_DAT_078067e0,0);
LAB_06725130:
      ...
      if (plVar10 != (long *)0x0) {
        ...
        puVar6 = (undefined8 *)func_0x03256b10(plVar10,*(long *)PTR_DAT_078067e0,1);
LAB_067251d4:
      ...
      func_0x04321630(uVar12,1,*(undefined8 *)puVar5);
      puVar6 = (undefined8 *)(lVar7 + 0x118);
      *(undefined8 *)(lVar7 + 0x118) = uVar12;
    }
    else {
...
LAB_06724ef4:
  lVar7 = func_0x03280b88(*(undefined8 *)(lVar7 + 8),lVar11);
                    ...
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(lVar7 + 8))(plVar10,param_4,lVar7);
  return;
}
