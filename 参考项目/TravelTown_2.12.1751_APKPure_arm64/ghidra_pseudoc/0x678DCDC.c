/* Ghidra 12.1.2 native pseudocode; RVA 0x678DCDC; MergeEngine.ECS.Systems.Items.ExpendableSystem.TrySpawnParticles; status ok */
...
void MergeEngine_ECS_Systems_Items_ExpendableSystem__TrySpawnParticles(void)

{
  undefined *puVar1;
  
  puVar1 = PTR_DAT_078103c8;
