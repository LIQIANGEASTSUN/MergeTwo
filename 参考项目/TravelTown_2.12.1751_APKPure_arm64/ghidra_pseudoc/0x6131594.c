/* Ghidra 12.1.2 native pseudocode; RVA 0x6131594; MergeEngine.Model.RemoteSpawning.RemoteSpawningModel.SendProducerChainRenewedAnalytic; status ok */
...
/* WARNING: Removing unreachable block (ram,0x06231848) */
/* WARNING: Removing unreachable block (ram,0x06231868) */
/* WARNING: Removing unreachable block (ram,0x0623186c) */
/* WARNING: Removing unreachable block (ram,0x06231874) */
/* WARNING: Removing unreachable block (ram,0x06231898) */
/* WARNING: Removing unreachable block (ram,0x06231904) */
/* WARNING: Removing unreachable block (ram,0x062318a8) */
/* WARNING: Removing unreachable block (ram,0x062318bc) */
/* WARNING: Removing unreachable block (ram,0x062318d0) */
/* WARNING: Removing unreachable block (ram,0x062318d8) */
/* WARNING: Removing unreachable block (ram,0x062318ec) */
/* WARNING: Type propagation algorithm not settling */

long * MergeEngine_Model_RemoteSpawning_RemoteSpawningModel__SendProducerChainRenewedAnalytic
...

{
  ...
  puVar28 = PTR_DAT_077da920;
  if ((bRam0000000007e2451d & 1) == 0) {
    func_0x03280a18(PTR_DAT_077da920);
    func_0x03280a18(PTR_DAT_077da928);
    bRam0000000007e2451d = 1;
  }
  plVar26 = *(long **)(param_1 + 0x20);
  lVar9 = func_0x03280ca0(*(undefined8 *)puVar28);
  func_0x068c4860(lVar9,param_2,param_3,0);
  if (plVar26 == (long *)0x0) {
    auVar31 = func_0x03280cac();
    plVar26 = auVar31._8_8_;
    ...
    puVar28 = PTR_DAT_07779820;
    pppppppuStack_90 = (undefined8 *******)0x0;
    lStack_88 = 0;
    if (plVar26 != (long *)0x0) {
      lVar9 = *plVar26;
      plVar7 = *(long **)(auVar31._0_8_ + 0x40);
      uVar22 = (ulong)*(ushort *)(lVar9 + 0x12e);
      if (uVar22 != 0) {
        piVar23 = (int *)(*(long *)(lVar9 + 0xb0) + 8);
        do {
          if (*(long *)(piVar23 + -2) == *(long *)PTR_DAT_07779820) {
            puVar10 = (undefined8 *)(lVar9 + (long)*piVar23 * 0x10 + 0x138);
            goto LAB_06231734;
          }
          uVar22 = uVar22 - 1;
          piVar23 = piVar23 + 4;
      ...
      puVar10 = (undefined8 *)func_0x03256b10(plVar26,*(long *)PTR_DAT_07779820,0);
LAB_06231734:
      uVar27 = (*(code *)*puVar10)(plVar26,puVar10[1]);
      if (plVar7 != (long *)0x0) {
        lVar9 = *plVar7;
        uVar22 = (ulong)*(ushort *)(lVar9 + 0x12e);
        if (uVar22 != 0) {
          piVar23 = (int *)(*(long *)(lVar9 + 0xb0) + 8);
          do {
            if (*(long *)(piVar23 + -2) == *(long *)PTR_DAT_077da8e8) {
              puVar10 = (undefined8 *)(lVar9 + (long)(*piVar23 + 3) * 0x10 + 0x138);
              goto LAB_062317a0;
            }
            uVar22 = uVar22 - 1;
            piVar23 = piVar23 + 4;
        ...
        puVar10 = (undefined8 *)func_0x03256b10(plVar7,*(long *)PTR_DAT_077da8e8,3);
LAB_062317a0:
        plVar7 = (long *)(*(code *)*puVar10)(plVar7,uVar27,puVar10[1]);
        uVar22 = func_0x055f7aac(plVar7,0);
        if ((uVar22 & 1) == 0) {
          return plVar7;
        }
        lVar9 = *plVar26;
        lVar16 = *(long *)(auVar31._0_8_ + 0x48);
        uVar22 = (ulong)*(ushort *)(lVar9 + 0x12e);
        if (uVar22 != 0) {
          piVar23 = (int *)(*(long *)(lVar9 + 0xb0) + 8);
          do {
        ...
        puVar10 = (undefined8 *)func_0x03256b10(plVar26,*(long *)puVar28,0);
LAB_06231810:
        uVar27 = (*(code *)*puVar10)(plVar26,puVar10[1]);
        if ((lVar16 != 0) &&
           (uVar22 = func_0x04fe48b0(lVar16,uVar27,&stack0xffffffffffffff98,
                                     *(undefined8 *)PTR_DAT_077da908), (uVar22 & 1) == 0))
        goto LAB_06231918;
      }
    }
    func_0x03280cac();
    ...
    if (auVar29._8_4_ == 1) {
      plVar26 = (long *)func_0x072ce910(uVar27);
      lVar9 = *plVar26;
      func_0x072ce920();
      func_0x05115db0(&pppppppuStack_90,*(undefined8 *)PTR_DAT_077da930);
      if (lVar9 == 0) {
LAB_06231918:
    ...
    func_0x03280ca4(0);
    func_0x02f09514();
    apcStack_a0[0] = MergeEngine_Model_RemoteSpawning_RemoteSpawningModel__IsTimestampPast;
    apcStack_a0[1] = (code *)uVar27;
    lVar9 = func_0x0622fba4();
    return (long *)(ulong)(extraout_x1 < lVar9);
  }
  lVar16 = *(long *)PTR_DAT_077da928;
  ...
  if ((*(long *)(lVar16 + 0x38) == 0) &&
     (plVar7 = (long *)func_0x03280a18(PTR_DAT_0774e558), *(long *)(lVar16 + 0x38) == 0)) {
    plVar7 = (long *)func_0x03256878(lVar16);
  }
  ...
  lVar16 = func_0x072869d0(plVar26,uVar27,0,1,0);
  if (lVar16 == 0) {
    auVar31 = func_0x03280cac();
    uVar27 = auVar31._8_8_;
    unaff_x22 = auVar31._0_8_;
    lVar9 = tpidr_el0;
    lStack_88 = *(long *)(lVar9 + 0x28);
    puVar10 = *(undefined8 **)(lVar19 + 0x38);
    plVar26 = unaff_x22;
    pppppppuVar15 = pppppppuVar14;
    pppppppuStack_90 = pppppppuVar14;
    if (puVar10 == (undefined8 *)0x0) {
      plVar26 = (long *)func_0x03280a18(PTR_DAT_0774e558);
      puVar10 = *(undefined8 **)(lVar19 + 0x38);
      if (puVar10 == (undefined8 *)0x0) {
        plVar26 = (long *)func_0x03256878(lVar19);
        puVar10 = *(undefined8 **)(lVar19 + 0x38);
      }
    }
    unaff_x23 = (undefined8 *******)(ulong)*(uint *)(puVar10[1] + 0xfc);
    ...
    if ((char)unaff_x22[10] == '\0') {
      ...
      lVar16 = func_0x072869d0(unaff_x22,uVar8,uVar27,1,0);
      unaff_x20 = *(long *)(lVar19 + 0x38);
      pppppppuVar2 = pppppppuVar14;
      if (-1 < *(int *)(*(long *)(unaff_x20 + 8) + 0x28)) {
        pppppppuVar2 = &pppppppuStack_90;
      }
      pppppppuVar15 = unaff_x23;
      func_0x072ce970(unaff_x24,pppppppuVar2);
      lVar9 = func_0x03280b94(*(undefined8 *)(unaff_x20 + 8),unaff_x24);
      if (lVar16 != 0) {
        unaff_x30 = 0x3ea52d0;
        register0x00000008 = (BADSPACEBASE *)unaff_x24;
        unaff_x19 = pppppppuVar14;
        unaff_x21 = lVar16;
        goto SUB_072852e4;
      }
      func_0x03280cac();
    ...
    *(undefined8 *)((long)alStack_190 + lVar11 + 0xe8) = uVar27;
    *(long *)((long)apcStack_a0 + lVar11) = unaff_x20;
    *(undefined8 ********)((long)apcStack_a0 + lVar11 + 8) = pppppppuVar14;
    ppppppuVar20 = pppppppuVar15[7];
    if (ppppppuVar20 == (undefined8 ******)0x0) {
      func_0x03256878(pppppppuVar15);
      ppppppuVar20 = pppppppuVar15[7];
    }
    pppppuVar17 = ppppppuVar20[1];
    uVar27 = *(undefined8 *)((long)apcStack_a0 + lVar11);
    uVar8 = *(undefined8 *)((long)apcStack_a0 + lVar11 + 8);
    ...
    *(long **)((long)alStack_190 + lVar11 + 0xe0) = unaff_x22;
    *(undefined8 *)((long)alStack_190 + lVar11 + 0xe8) =
         *(undefined8 *)((long)alStack_190 + lVar11 + 0xe8);
    *(undefined8 *)((long)apcStack_a0 + lVar11) = uVar27;
    *(undefined8 *)((long)apcStack_a0 + lVar11 + 8) = uVar8;
    ppppuVar21 = pppppuVar17[7];
    lVar16 = lVar9;
    ...
    if (ppppuVar21 == (undefined8 ****)0x0) {
      ...
      ppppuVar21 = pppppuVar17[7];
      if (ppppuVar21 == (undefined8 ****)0x0) {
        func_0x03256878(pppppuVar17);
        ppppuVar21 = pppppuVar17[7];
      }
    }
    if ((*(byte *)((long)*ppppuVar21 + 0x135) & 1) == 0) {
      func_0x0325681c();
    }
    lVar19 = func_0x03280ca0();
    func_0x04053df4(lVar19,pppppuVar17[7][1]);
    if (lVar19 != 0) {
      plVar26 = (long *)(lVar19 + 0x10);
      *plVar26 = lVar9;
      goto SUB_032809c4;
    }
    ...
    *(long *)((long)alStack_190 + lVar11 + 0xa0) = lVar9;
    *(undefined8 ******)((long)alStack_190 + lVar11 + 0xa8) = pppppuVar17;
    *(long *)((long)alStack_190 + lVar11 + 0xb0) = auVar31._0_8_;
    *(undefined8 *)((long)alStack_190 + lVar11 + 0xb8) = 0;
    ppppuVar21 = pppppuVar18[7];
    lVar9 = lVar16;
    ...
    lVar19 = func_0x03280ca0();
    func_0x0404e308(lVar19,pppppuVar18[7][1]);
    if (lVar19 != 0) {
      plVar26 = (long *)(lVar19 + 0x10);
      *plVar26 = lVar16;
      goto SUB_032809c4;
    ...
    *(long *)((long)alStack_190 + lVar11 + 0x60) = lVar16;
    *(undefined8 ******)((long)alStack_190 + lVar11 + 0x68) = pppppuVar18;
    *(long *)((long)alStack_190 + lVar11 + 0x70) = auVar30._0_8_;
    *(long *)((long)alStack_190 + lVar11 + 0x78) = auVar30._8_8_;
    ppppuVar21 = pppppuVar17[7];
    lVar16 = lVar9;
    pppppuVar18 = pppppuVar17;
    if (ppppuVar21 == (undefined8 ****)0x0) {
    ...
    *(long *)((long)alStack_190 + lVar11 + 0x20) = lVar9;
    *(undefined8 ******)((long)alStack_190 + lVar11 + 0x28) = pppppuVar17;
    *(long *)((long)alStack_190 + lVar11 + 0x30) = auVar31._0_8_;
    *(long *)((long)alStack_190 + lVar11 + 0x38) = auVar31._8_8_;
    ppppuVar21 = pppppuVar18[7];
    if (ppppuVar21 == (undefined8 ****)0x0) {
      func_0x03280a18(PTR_DAT_07750ac8);
      func_0x03280a18(PTR_DAT_0774e558);
    ...
    if (lVar9 != 0) {
      plVar26 = (long *)(lVar9 + 0x10);
      *plVar26 = lVar16;
      goto SUB_032809c4;
    }
    auVar31 = func_0x03280cac();
    lVar9 = auVar31._8_8_;
    plVar26 = auVar31._0_8_;
    *(undefined8 *)((long)alStack_1c0 + lVar11 + 0x10) = 0x3ea5874;
    *(long *)((long)alStack_1c0 + lVar11 + 0x20) = auVar30._0_8_;
    *(long *)((long)alStack_1c0 + lVar11 + 0x28) = auVar30._8_8_;
    ...
    lVar9 = *plVar7;
    *(undefined8 *)((long)alStack_1c0 + lVar11) = *(undefined8 *)((long)alStack_1c0 + lVar11 + 0x10)
    ;
    *(undefined8 ********)((long)alStack_1c0 + lVar11 + 8) = unaff_x23;
    *(long *)((long)alStack_1c0 + lVar11 + 0x10) = lVar16;
    *(undefined8 ******)((long)alStack_1c0 + lVar11 + 0x18) = pppppuVar18;
    ...
    *(undefined8 *)((long)alStack_1c0 + lVar11 + 0x28) =
    ...
    if ((*(long *)(lVar9 + 0x38) == 0) &&
       (plVar7 = (long *)func_0x03280a18(PTR_DAT_0774e558), *(long *)(lVar9 + 0x38) == 0)) {
      plVar7 = (long *)func_0x03256878(lVar9);
    }
    puVar28 = PTR_DAT_0774e558;
    if ((char)plVar26[10] != '\0') {
      return plVar7;
    }
    uVar27 = **(undefined8 **)(lVar9 + 0x38);
    if (*(int *)(*(long *)PTR_DAT_0774e558 + 0xe0) == 0) {
      func_0x03280b8c();
    }
    uVar27 = func_0x057a51c4(uVar27,0);
    lVar16 = func_0x072869d0(plVar26,uVar27,0,0,0);
    if (lVar16 == 0) {
      return (long *)0x0;
    }
    uVar27 = **(undefined8 **)(lVar9 + 0x38);
    ...
    uVar27 = func_0x057a51c4(uVar27,0);
    lVar19 = func_0x057c1ad4(uVar27,0);
    lVar24 = *(long *)(*(long *)(lVar9 + 0x38) + 8);
...
LAB_03ea5b18:
      ...
      lVar9 = func_0x03280b90(lVar19,lVar24);
      if (lVar9 == 0) {
    ...
    unaff_x22 = *(long **)((long)alStack_1c0 + lVar11 + 0x10);
...
SUB_072852e4:
  ...
  *(undefined8 ********)((long)register0x00000008 + -8) = unaff_x19;
  ...
  if (lVar9 != 0) {
    uVar27 = func_0x057dadc4(lVar9,0);
    puVar25 = *(undefined **)(lVar16 + 0x20);
    if (*(int *)(*(long *)puVar28 + 0xe0) == 0) {
      func_0x03280b8c(*(long *)puVar28);
    }
    uVar6 = func_0x0727e0ec(uVar27,puVar25);
    plVar26 = (long *)(ulong)(uVar6 & 1);
    uVar27 = 0x728539c;
    goto SUB_0727dc78;
  }
  func_0x03280cac();
    ...
    if (uVar22 != 0) {
      ...
      do {
        if (*(long *)(piVar23 + -2) == *(long *)PTR_DAT_0774e8c8) {
          puVar10 = (undefined8 *)(lRam0000000007e34000 + (long)*piVar23 * 0x10 + 0x138);
          goto LAB_072854e8;
        }
        uVar22 = uVar22 - 1;
        piVar23 = piVar23 + 4;
...
LAB_072854e8:
    plVar26 = (long *)(*(code *)*puVar10)(0x7e34000,puVar10[1]);
    if (lVar9 == 0) {
      return plVar26;
    }
  }
...
LAB_072855b0:
  ...
  *(undefined8 *)((long)register0x00000008 + -0x48) = uVar27;
  ...
  *(undefined8 *)((long)register0x00000008 + -0x38) = 0x7e34000;
  ...
  plVar26 = (long *)func_0x03e0c264(lVar11,*(undefined8 *)puVar28);
  puVar12 = PTR_DAT_0785df00;
...
LAB_07285770:
    if (lVar11 != 0) {
      if (0 < *(int *)(lVar11 + 0x18)) {
        plVar7 = (long *)0x0;
        do {
          puVar13 = (undefined *)func_0x0414419c(lVar11,plVar7,*(undefined8 *)puVar25);
          unaff_x24 = puVar25;
          if (*(long *)(lVar16 + 0x10) == 0) goto LAB_07285808;
          plVar26 = (long *)func_0x041447fc(*(long *)(lVar16 + 0x10),puVar13,*(undefined8 *)puVar12)
          ;
          puVar28 = puVar13;
          if (((ulong)plVar26 & 1) != 0) {
            if ((puVar13 == (undefined *)0x0) || (lVar9 = *(long *)(puVar13 + 0x18), lVar9 == 0))
            goto LAB_07285808;
            plVar26 = (long *)(**(code **)(lVar9 + 0x18))
                                        (*(undefined8 *)(lVar9 + 0x40),lVar19,
                                         *(undefined8 *)(lVar9 + 0x28));
          }
          uVar6 = (int)plVar7 + 1;
          plVar7 = (long *)(ulong)uVar6;
        } while ((int)uVar6 < *(int *)(lVar11 + 0x18));
      }
      return plVar26;
    }
LAB_07285808:
...
LAB_0728580c:
    ...
    if (*(int *)(lVar16 + 0x30) != 2) {
      ...
      lVar11 = func_0x03280afc(uVar27,1);
      func_0x02f0b18c(lVar19);
      uVar27 = func_0x057dadc4(lVar19,0);
      func_0x02f0b18c(lVar11);
      func_0x02f176b4(lVar11,uVar27);
      func_0x02f0965c(lVar11,0,uVar27);
      uVar27 = func_0x03280a2c(PTR_DAT_0785df08);
      lVar19 = func_0x0727df38(uVar27,lVar11);
      uVar27 = func_0x03280a2c(PTR_DAT_0785df10);
      func_0x03280b7c(lVar19,uVar27);
    }
    plVar26 = (long *)func_0x03280afc(*(undefined8 *)PTR_DAT_0774e5a0,1);
    if ((lVar19 == 0) ||
       (puVar12 = (undefined *)func_0x057dadc4(lVar19,0), plVar7 = plVar26, plVar26 == (long *)0x0))
    goto LAB_07285808;
    if ((puVar12 == (undefined *)0x0) ||
       (lVar9 = func_0x03280b90(puVar12,*(undefined8 *)(*plVar26 + 0x40)), lVar9 != 0)) {
      if ((int)plVar26[3] != 0) {
        plVar26 = plVar26 + 4;
...
SUB_032809c4:
  ...
  auVar31 = func_0x03280b7c(uVar27,0);
  ...
  *(undefined **)((long)register0x00000008 + -0xa8) = puVar12;
  *(long **)((long)register0x00000008 + -0xa0) = plVar26;
  ...
  *(long *)((long)register0x00000008 + -0x88) = lVar19;
  ...
  plVar26 = (long *)(ulong)*(byte *)(lVar9 + 0x34);
  uVar27 = 0x72858f0;
SUB_0727dc78:
  if (((ulong)plVar26 & 1) != 0) {
    return plVar26;
  }
  *(undefined8 *)(puVar5 + -0x10) = uVar27;
  *(undefined **)(puVar5 + -8) = puVar25;
  uVar27 = func_0x03280a2c(PTR_DAT_0785dbe8);
  puVar28 = PTR_DAT_0777c990;
  *(undefined8 *)(puVar5 + -0x30) = 0x727dc94;
  *(long *)(puVar5 + -0x28) = lVar16;
  *(long *)(puVar5 + -0x20) = lVar9;
  *(undefined **)(puVar5 + -0x18) = puVar25;
  if ((bRam0000000007e34146 & 1) == 0) {
    func_0x03280a18(PTR_DAT_0777c990);
    bRam0000000007e34146 = 1;
  }
  plVar26 = (long *)func_0x03280ca0(*(undefined8 *)puVar28);
  func_0x072c77f8(plVar26,uVar27,0);
  return plVar26;
}
