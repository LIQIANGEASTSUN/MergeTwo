/* Ghidra 12.1.2 native pseudocode; RVA 0x44E7FB8; MergeEngine.ECS.Components.SerializableComponent<TSerializable>.Serialize; status ok */


long MergeEngine_ECS_Components_SerializableComponent_TSerializable___Serialize
...

{
  ...
  if ((bRam0000000007e18ff2 & 1) == 0) {
    func_0x03280a18(PTR_DAT_0777b110);
    bRam0000000007e18ff2 = 1;
  }
  plVar6 = param_1 + 5;
  if (*plVar6 == 0) {
    ...
    *plVar6 = lVar1;
    ...
    func_0x03e6e2e8(lVar1,0,*(undefined8 *)(*(long *)(*(long *)(param_2 + 0x20) + 0xc0) + 0x30));
  }
  ...
  if (plVar6 == (long *)0x0) {
    ...
    plVar6 = auVar8._0_8_;
    if ((bRam0000000007e18ff3 & 1) == 0) {
      func_0x03280a18(PTR_DAT_0777b110);
      bRam0000000007e18ff3 = 1;
    }
    plVar7 = plVar6 + 5;
    if (*plVar7 == 0) {
      ...
      *plVar7 = lVar1;
      ...
      func_0x03e6e2e8(lVar1,0,*(undefined8 *)
                               (*(long *)(*(long *)(auVar8._8_8_ + 0x20) + 0xc0) + 0x30));
    }
  ...
  lVar4 = param_1[5];
  lVar1 = *plVar6;
  lVar5 = *(long *)(*(long *)(*(long *)(param_2 + 0x20) + 0xc0) + 0x48);
...
LAB_045e80c0:
  lVar1 = func_0x03280b88(*(undefined8 *)(lVar1 + 8),lVar5);
                    /* WARNING: Could not recover jumptable at 0x045e80e4. Too many branches */
