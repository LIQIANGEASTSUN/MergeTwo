/* Ghidra 12.1.2 native pseudocode; RVA 0x6624848; Merger.Game.ViewModel.BoardViewModel.SubscribeToSignals; status ok */
...
long * Merger_Game_ViewModel_BoardViewModel__SubscribeToSignals(long param_1)

{
  ...
  uVar7 = func_0x03280ca0(*(undefined8 *)puVar23);
  func_0x056ed730(uVar7,param_1,*(undefined8 *)puVar20,0);
  puVar20 = PTR_DAT_07806800;
  puVar23 = PTR_DAT_078067f8;
  if (lVar21 == 0) {
LAB_06724958:
  ...
  func_0x03ea5348(lVar21,uVar7,*(undefined8 *)PTR_DAT_07806808);
  lVar22 = *(long *)(param_1 + 0x20);
  lVar21 = func_0x03280ca0(*(undefined8 *)puVar23);
  func_0x054221d4(lVar21,param_1,*(undefined8 *)puVar20,0);
  if (lVar22 == 0) goto LAB_06724958;
  lVar12 = *(long *)PTR_DAT_07806810;
  ...
  func_0x04053df4(lVar6,*(undefined8 *)(*(long *)(lVar13 + 0x38) + 8));
  if (lVar6 != 0) {
  ...
  func_0x0404e308(lVar21,*(undefined8 *)(*(long *)(lVar15 + 0x38) + 8));
  if (lVar21 != 0) {
  ...
  lVar21 = func_0x03280ca0();
  (*(code *)**(undefined8 **)(*(long *)(lVar13 + 0x38) + 8))();
  if (lVar21 != 0) {
    plVar16 = (long *)(lVar21 + 0x10);
    *plVar16 = lVar22;
    goto SUB_032809c4;
  ...
  puVar23 = PTR_DAT_0774e558;
  if ((char)plVar16[10] != '\0') {
    return plVar17;
  }
  uVar7 = **(undefined8 **)(lVar21 + 0x38);
  if (*(int *)(*(long *)PTR_DAT_0774e558 + 0xe0) == 0) {
    func_0x03280b8c();
  }
  uVar7 = func_0x057a51c4(uVar7,0);
  lVar22 = func_0x072869d0(plVar16,uVar7,0,0,0);
  if (lVar22 == 0) {
    return (long *)0x0;
  }
  uVar7 = **(undefined8 **)(lVar21 + 0x38);
  ...
  uVar7 = func_0x057a51c4(uVar7,0);
  lVar12 = func_0x057c1ad4(uVar7,0);
...
LAB_03ea5b18:
    ...
    lVar15 = func_0x03280b90(lVar12,lVar21);
    if (lVar15 == 0) {
      func_0x03281048(lVar12,lVar21);
      goto LAB_03ea5b18;
    }
  }
  lVar21 = 0;
  ...
  puVar23 = PTR_DAT_07779590;
  if (lVar15 != 0) {
    uVar7 = func_0x057dadc4(lVar15,0);
    puVar20 = *(undefined **)(lVar22 + 0x20);
    if (*(int *)(*(long *)puVar23 + 0xe0) == 0) {
      func_0x03280b8c(*(long *)puVar23);
    }
    uVar5 = func_0x0727e0ec(uVar7,puVar20);
  ...
  while( true ) {
    ...
    plVar16 = (long *)func_0x072ce910(auVar27._0_8_);
    lVar22 = *plVar16;
    func_0x072ce920();
    ...
    if (uVar18 != 0) {
      ...
      do {
        if (*(long *)(piVar19 + -2) == *(long *)PTR_DAT_0774e8c8) {
          puVar8 = (undefined8 *)(lRam0000000007e34000 + (long)*piVar19 * 0x10 + 0x138);
          goto LAB_072854e8;
        }
        uVar18 = uVar18 - 1;
        piVar19 = piVar19 + 4;
    ...
    lVar21 = 0;
    puVar8 = (undefined8 *)func_0x03256b10(0x7e34000);
LAB_072854e8:
    plVar16 = (long *)(*(code *)*puVar8)(0x7e34000,puVar8[1]);
    if (lVar22 == 0) {
      return plVar16;
    }
  }
  ...
  puVar8 = (undefined8 *)func_0x03256b10(0x7e34000);
LAB_072855b0:
  (*(code *)*puVar8)(0x7e34000,puVar8[1]);
  func_0x03365958(auVar27._0_8_);
  func_0x03280ca4(0);
  auVar25 = func_0x02f09514();
  puVar23 = PTR_DAT_0785dec8;
  ...
  plVar16 = (long *)func_0x03e0c264(lVar13,*(undefined8 *)puVar23);
  puVar9 = PTR_DAT_0785df00;
...
LAB_07285770:
    if (lVar13 != 0) {
      if (0 < *(int *)(lVar13 + 0x18)) {
        plVar17 = (long *)0x0;
        do {
          puVar10 = (undefined *)func_0x0414419c(lVar13,plVar17,*(undefined8 *)puVar20);
          puVar24 = puVar20;
          if (*(long *)(lVar12 + 0x10) == 0) goto LAB_07285808;
          plVar16 = (long *)func_0x041447fc(*(long *)(lVar12 + 0x10),puVar10,*(undefined8 *)puVar9);
          puVar23 = puVar10;
          if (((ulong)plVar16 & 1) != 0) {
            if ((puVar10 == (undefined *)0x0) || (lVar22 = *(long *)(puVar10 + 0x18), lVar22 == 0))
            goto LAB_07285808;
        ...
        } while ((int)uVar5 < *(int *)(lVar13 + 0x18));
      }
      return plVar16;
    }
LAB_07285808:
...
LAB_0728580c:
    ...
    if (*(int *)(lVar12 + 0x30) != 2) {
      if (*(int *)(lVar12 + 0x30) != 1) goto LAB_07285770;
      uVar7 = func_0x03280a2c(PTR_DAT_0774e5a0);
      lVar13 = func_0x03280afc(uVar7,1);
      func_0x02f0b18c(lVar21);
      uVar7 = func_0x057dadc4(lVar21,0);
      func_0x02f0b18c(lVar13);
      func_0x02f176b4(lVar13,uVar7);
      func_0x02f0965c(lVar13,0,uVar7);
      uVar7 = func_0x03280a2c(PTR_DAT_0785df08);
      lVar21 = func_0x0727df38(uVar7,lVar13);
      uVar7 = func_0x03280a2c(PTR_DAT_0785df10);
      func_0x03280b7c(lVar21,uVar7);
    }
    plVar16 = (long *)func_0x03280afc(*(undefined8 *)PTR_DAT_0774e5a0,1);
    if (lVar21 == 0) goto LAB_07285808;
    puVar9 = (undefined *)func_0x057dadc4(lVar21,0);
    plVar17 = plVar16;
...
SUB_032809c4:
    ...
    lVar22 = func_0x03280b90(puVar9,*(undefined8 *)(*plVar16 + 0x40));
    if (lVar22 != 0) goto LAB_07285744;
  }
  uVar7 = func_0x03280cd0();
  auVar25 = func_0x03280b7c(uVar7,0);
  uStack_180 = 0x728581c;
  lVar22 = *(long *)(auVar25._0_8_ + 0x18);
  if (lVar22 != 0) {
                    /* WARNING: Could not recover jumptable at 0x07285838. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    plVar16 = (long *)(**(code **)(lVar22 + 0x18))
                                (*(undefined8 *)(lVar22 + 0x40),auVar25._8_8_,
                                 *(undefined8 *)(lVar22 + 0x28));
    return plVar16;
  }
  ...
  plVar16 = (long *)(ulong)*(byte *)(lVar15 + 0x34);
  uVar7 = 0x72858f0;
SUB_0727dc78:
  if (((ulong)plVar16 & 1) != 0) {
    return plVar16;
