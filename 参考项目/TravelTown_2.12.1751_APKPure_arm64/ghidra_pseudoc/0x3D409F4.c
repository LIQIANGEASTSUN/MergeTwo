/* Ghidra 12.1.2 native pseudocode; RVA 0x3D409F4; Merger.Services.Backend.WebSocket.OperationTrackingSystem.TrackItemRestoredFromInventoryOperation<object>; status ok */


undefined8
Merger_Services_Backend_WebSocket_OperationTrackingSystem__TrackItemRestoredFromInventoryOperation_object_
...
LAB_03e40cdc:
      ...
      if (plVar8 == (long *)0x0) {
        ...
        if (lVar2 != 0) {
          ...
          func_0x04fe2d7c(lVar2,*(undefined8 *)PTR_DAT_07779e90,lVar10,lVar1);
          lVar5 = lVar10;
          if (plVar8 != (long *)0x0) {
            lVar5 = *plVar8;
...
LAB_03e40f1c:
        ...
        lVar10 = *(long *)(*(long *)(lVar4 + 0x38) + 0x10);
        if ((*(byte *)(lVar10 + 0x135) & 1) == 0) {
          lVar10 = func_0x0325681c();
        }
        uVar9 = (*(code *)**(undefined8 **)(*(long *)(param_6 + 0x38) + 0x10))
                          (auVar11._8_8_,lVar5,**(undefined8 **)(lVar10 + 0xb8));
      ...
      if (uVar6 != 0) {
        ...
        do {
          if (*(long *)(piVar7 + -2) == *(long *)(lVar5 + 0x20)) {
            lVar10 = lVar10 + (long)(int)(*piVar7 + (uint)*(ushort *)(lVar5 + 0x50)) * 0x10 + 0x138;
            goto LAB_03e40dbc;
          }
          uVar6 = uVar6 - 1;
          piVar7 = piVar7 + 4;
...
LAB_03e40dbc:
      lVar5 = func_0x03280b88(*(undefined8 *)(lVar10 + 8),lVar5);
...
LAB_03e40b7c:
  ...
  uVar9 = *(undefined8 *)PTR_DAT_0777ab18;
  uVar6 = (ulong)*(ushort *)(lVar5 + 0x12e);
  if (uVar6 != 0) {
    piVar7 = (int *)(*(long *)(lVar5 + 0xb0) + 8);
    do {
