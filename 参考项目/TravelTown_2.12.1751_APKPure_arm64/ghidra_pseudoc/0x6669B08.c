/* Ghidra 12.1.2 native pseudocode; RVA 0x6669B08; MergeEngine.ECS.Systems.Board.BoardSystem.OnAllSystemsInitialized; status ok */
...
long * MergeEngine_ECS_Systems_Board_BoardSystem__OnAllSystemsInitialized(long *param_1)

{
  ...
  if (param_1[0x11] != 0) {
    *(undefined1 *)(param_1[0x11] + 0x3c) = 0;
    return param_1;
  }
  ...
  if (*(long *)(lVar7 + 0xa0) == 0) {
    ...
    plVar8 = (long *)func_0x03280ca0(*(undefined8 *)puVar22);
    return plVar8;
  }
  plVar8 = (long *)func_0x064b1070(*(long *)(lVar7 + 0xa0),0);
  if (((ulong)plVar8 & 1) != 0) {
    return plVar8;
  }
  plVar8 = (long *)func_0x03eb6ac8(lVar7,*(undefined8 *)PTR_DAT_077803f8);
  puVar22 = PTR_DAT_07807de8;
  if (plVar8 == (long *)0x0) {
    return (long *)0x0;
  }
  lVar7 = *(long *)PTR_DAT_07807de8;
  if (*(int *)(lVar7 + 0xe0) == 0) {
    func_0x03280b8c();
    lVar7 = *(long *)puVar22;
  }
  lVar19 = *(long *)(*(long *)(lVar7 + 0xb8) + 0x10);
  if (lVar19 == 0) {
    if (*(int *)(lVar7 + 0xe0) == 0) {
      func_0x03280b8c();
      lVar7 = *(long *)puVar22;
  ...
  uVar10 = 0;
  puVar3 = (undefined8 *)func_0x03256b10(plVar8);
LAB_03e0f108:
  unaff_x20 = (long *)(*(code *)*puVar3)(plVar8,puVar3[1]);
      ...
      if (uVar15 != 0) {
        ...
        do {
          if (*(long *)(piVar18 + -2) == *(long *)puVar22) {
            puVar3 = (undefined8 *)(lVar7 + (long)*piVar18 * 0x10 + 0x138);
            goto LAB_03e0f170;
          }
          uVar15 = uVar15 - 1;
          piVar18 = piVar18 + 4;
...
LAB_03e0f170:
      ...
      lVar7 = *(long *)(*(long *)(uVar11 + 0x38) + 0x10);
      if ((*(byte *)(lVar7 + 0x135) & 1) == 0) {
        lVar7 = func_0x0325681c(lVar7);
      }
      lVar12 = *unaff_x20;
...
LAB_03e0f4ec:
        uVar20 = (*(code *)*puVar3)(unaff_x20,puVar3[1]);
        if (lVar7 == 0) goto LAB_03e0f5a4;
        iVar2 = (int)uVar15;
        (**(code **)(lVar7 + 0x18))
                  (*(undefined8 *)(lVar7 + 0x40),uVar20,uVar15,*(undefined8 *)(lVar7 + 0x28));
        uVar11 = uVar15;
...
LAB_03e0f64c:
  ...
  puVar3 = (undefined8 *)((long)&puStack_f0 - uVar15);
...
LAB_03e0f860:
        ...
        puStack_f0 = puVar3;
        (**(code **)(lVar12 + 0x10))(*(undefined8 *)(lVar12 + 8),lVar12,plVar9,&puStack_f0,puVar3);
        ...
        if (-1 < *(int *)(*(long *)(*(long *)(uVar11 + 0x38) + 0x20) + 0x28)) {
          puStack_f0 = (undefined8 *)*puVar21;
        }
        puVar5 = *(undefined8 **)(*(long *)(uVar11 + 0x38) + 0x30);
        uVar15 = uVar10;
        (*(code *)puVar5[2])(*puVar5,puVar5,uVar10,&puStack_f0);
      } while( true );
    }
  }
  puVar22 = unaff_x28;
...
LAB_03e0fa30:
  ...
  *(undefined1 **)(lVar19 + -0x60) = &stack0xffffffffffffff20;
  *(undefined8 *)(lVar19 + -0x58) = 0x3e0fa48;
  *(undefined **)(lVar19 + -0x50) = puVar22;
  *(long *)(lVar19 + -0x48) = lVar7;
  ...
  *(long **)(lVar19 + -8) = plVar8;
  lVar7 = tpidr_el0;
  *(long *)(lVar19 + -0x88) = lVar7;
  *(undefined8 *)(lVar19 + -0x68) = *(undefined8 *)(lVar7 + 0x28);
  plVar8 = *(long **)(uVar15 + 0x38);
  if (plVar8 == (long *)0x0) {
    func_0x03280a18(PTR_DAT_0774e8c8);
    func_0x03280a18(PTR_DAT_0774e8e0);
    plVar8 = *(long **)(uVar15 + 0x38);
  ...
  lVar7 = (lVar19 + -0x90) - uVar10;
  puVar3 = (undefined8 *)(lVar7 - uVar10);
...
LAB_03e0fc48:
        *(long *)(lVar19 + -0x80) = lVar7;
        lVar13 = *(long *)(lVar13 + 8);
        (**(code **)(lVar13 + 0x10))(*(undefined8 *)(lVar13 + 8),lVar13,plVar9,lVar19 + -0x80,lVar7)
        ;
        func_0x072ce970(lVar12,lVar7,uVar11);
...
LAB_03e0fe24:
  ...
  *(long **)(lVar12 + -8) = plVar8;
  ...
  if (plVar6 == (long *)0x0) {
    ...
    puVar3 = (undefined8 *)func_0x03256b10(plVar6,lVar7,0);
LAB_03e0fed0:
    iVar2 = (*(code *)*puVar3)(plVar6,puVar3[1]);
    plVar8 = (long *)(ulong)(iVar2 == 0);
  }
  return plVar8;
}
