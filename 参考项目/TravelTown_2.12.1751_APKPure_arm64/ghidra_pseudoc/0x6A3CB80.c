/* Ghidra 12.1.2 native pseudocode; RVA 0x6A3CB80; Merger.MergeBoard.View.MergeBoardView.ClearBoardContent; status ok */


/* WARNING: Possible PIC construction at 0x06b3cadc: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x06b3cae0) */

ulong Merger_MergeBoard_View_MergeBoardView__ClearBoardContent
...
LAB_06b3cafc:
    ...
    while (auVar15 = func_0x03280cac(), unaff_x19 = auVar15._0_8_, auVar15._8_4_ == 1) {
...
LAB_06b3cad0:
    ...
    *(undefined8 *)((long)register0x00000008 + -0x58) = 0;
    ...
    unaff_x30 = Merger_MergeBoard_View_MergeBoardView__ClearBoardContent;
