/* Ghidra 12.1.2 native pseudocode; RVA 0x66250A8; Merger.Game.ViewModel.BoardViewModel.GetBehaviourInstantiationTypeByData; status ok */


undefined1  [16]
Merger_Game_ViewModel_BoardViewModel__GetBehaviourInstantiationTypeByData(long param_1)
