/* Ghidra 12.1.2 native pseudocode; RVA 0x6A9B64C; Merger.MergeBoard.Controller.BoardController.ExtractItemFromFeedingCombination; status ok */
...
void Merger_MergeBoard_Controller_BoardController__ExtractItemFromFeedingCombination(void)
