/* Ghidra 12.1.2 native pseudocode; RVA 0x665E9F0; MergeEngine.ECS.Systems.Board.BoardInteractionSystem.BoardItemDragCancelled; status ok */
...

{
  ...
  while( true ) {
    ...
    *(undefined8 *)((long)register0x00000008 + -8) = *(undefined8 *)((long)register0x00000008 + -8);
    ...
    puVar13 = PTR_DAT_07807a10;
    puVar4 = PTR_DAT_07807a00;
    puVar11 = PTR_DAT_078079f8;
    ...
    if (*(long *)(param_1 + 0xd8) != 0) {
      ...
      while( true ) {
        ...
        if (uVar9 != 0) {
          ...
          do {
            if (*(long *)(piVar18 + -2) == *(long *)puVar13) {
...
LAB_0675e944:
  ...
  *(undefined8 *)((long)register0x00000008 + -0x30) = 0x675eaa4;
  ...
  *(ulong *)(puVar6 + -8) = param_1;
  ...
  if (*(long *)(uVar9 + 0x88) != 0) {
    puVar11 = (undefined *)func_0x06a02444(*(long *)(uVar9 + 0x88),uVar24,0);
    if (*(long *)(uVar9 + 0x88) != 0) {
      lVar12 = func_0x06a02444(*(long *)(uVar9 + 0x88),param_3,0);
...
LAB_0675ebe4:
        puVar13 = (undefined *)(*(code *)*puVar8)(plVar20,puVar11,puVar8[1]);
...
LAB_0675ec50:
          plVar20 = (long *)(*(code *)*puVar8)(unaff_x24,lVar12,puVar8[1]);
          unaff_x25 = puVar13;
          if (*(long *)(uVar9 + 0x88) != 0) {
            param_4 = 0;
            func_0x06a0249c(*(long *)(uVar9 + 0x88),param_3,puVar11);
            unaff_x24 = plVar20;
            if (*(long *)(uVar9 + 0x88) != 0) {
              param_4 = 0;
              func_0x06a0249c(*(long *)(uVar9 + 0x88),uVar24,lVar12);
...
LAB_0675ed7c:
                  plVar27 = (long *)(*(code *)*puVar8)(param_3,unaff_x23,puVar13,param_4,0,puVar8[1]
                                                      );
                  puVar13 = PTR_DAT_077e71c8;
                  puVar11 = PTR_DAT_077e71c0;
                  if (lVar12 != 0) {
                    plVar22 = *(long **)(uVar9 + 0x70);
                    auVar31._8_8_ = 0;
                    if (plVar22 != (long *)0x0) {
                      lVar10 = *plVar22;
                      param_4 = *(long *)(lVar12 + 0x10);
                      uVar16 = (ulong)*(ushort *)(lVar10 + 0x12e);
...
LAB_0675ee0c:
                      lVar12 = puVar8[1];
                      uVar16 = 0;
                      uVar29 = (*(code *)*puVar8)(plVar22,unaff_x23,plVar20,param_4,0);
                      ...
                      func_0x04143c38(lVar10,*(undefined8 *)puVar11);
                          ...
                          if (lVar15 != 0) {
                            ...
                            if (uVar1 < *(uint *)(lVar15 + 0x18)) {
                              *(uint *)(lVar10 + 0x18) = uVar1 + 1;
                              puVar8 = (undefined8 *)(lVar15 + (long)(int)uVar1 * 8 + 0x20);
                              *puVar8 = uVar29;
                              func_0x032809c4(puVar8,uVar29);
                            }
                            else {
                              func_0x0414446c(lVar10,uVar29,
                                              *(undefined8 *)
                                               (*(long *)(*(long *)(lVar17 + 0x20) + 0xc0) + 0x70));
                            }
                            auVar31 = auVar3;
  ...
  *(undefined8 *)(puVar6 + -0x58) = *(undefined8 *)(puVar6 + -0x58);
  ...
  if (plVar20 != (long *)0x0) {
    ...
    puVar8 = (undefined8 *)func_0x03256b10(plVar20,*(long *)PTR_DAT_0777a498,0x14);
LAB_0676ad7c:
    uVar29 = (*(code *)*puVar8)(plVar20,param_4,puVar8[1]);
...
LAB_0676ae10:
      lVar12 = puVar8[1];
      uVar16 = 0;
      uVar29 = (*(code *)*puVar8)(plVar20,uVar24,uVar29,param_4,0);
              ...
              if (lVar15 != 0) {
                ...
                if (plVar20 != (long *)0x0) {
                  ...
                  if (uVar9 != 0) {
                    piVar18 = (int *)(*(long *)(lVar10 + 0xb0) + 8);
                    do {
                      if (*(long *)(piVar18 + -2) == *(long *)(lVar12 + 0x20)) {
                        lVar10 = lVar10 + (long)(int)(*piVar18 + (uint)*(ushort *)(lVar12 + 0x50)) *
                                          0x10 + 0x138;
                        goto LAB_03e40f1c;
                      }
                      uVar9 = uVar9 - 1;
...
LAB_03e40f1c:
                  lVar10 = func_0x03280b88(*(undefined8 *)(lVar10 + 8),lVar12);
                    /* WARNING: Could not recover jumptable at 0x03e40f4c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
                  uVar9 = (**(code **)(lVar10 + 8))(plVar20,uVar29,auVar31._8_8_,lVar15,lVar10);
                  return uVar9;
                }
              }
              ...
              *(long *)(puVar7 + -0x68) = auVar31._8_8_;
              ...
              uVar29 = (*(code *)**(undefined8 **)(*(long *)(lVar12 + 0x38) + 0x10))
                                 (auVar30._8_8_,lVar10,**(undefined8 **)(lVar15 + 0xb8));
              uVar9 = func_0x03280ca0(*(undefined8 *)PTR_DAT_0777ab48);
              func_0x05a85e88(uVar9,auVar30._0_8_,lVar14,uVar16 & 0xffffffff,uVar29,0);
              return uVar9;
            }
            lVar12 = *plVar20;
            ...
            if (uVar9 != 0) {
              ...
              do {
                if (*(long *)(piVar18 + -2) == *(long *)(lVar14 + 0x20)) {
                  lVar12 = lVar12 + (long)(int)(*piVar18 + (uint)*(ushort *)(lVar14 + 0x50)) * 0x10
                           + 0x138;
                  goto LAB_03e40dbc;
                }
                uVar9 = uVar9 - 1;
