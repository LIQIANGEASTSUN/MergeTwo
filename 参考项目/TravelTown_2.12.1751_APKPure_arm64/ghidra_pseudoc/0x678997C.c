/* Ghidra 12.1.2 native pseudocode; RVA 0x678997C; MergeEngine.ECS.Systems.Items.BoardTileLevelUnlockSystem.remove_UnlockCompleted; status ok */
...
void MergeEngine_ECS_Systems_Items_BoardTileLevelUnlockSystem__remove_UnlockCompleted
...

{
  ...
  while ((plVar5 = (long *)func_0x057ddd18(lVar7,param_2,0), plVar5 == (long *)0x0 ||
         (*plVar5 == *(long *)puVar3))) {
    lVar6 = func_0x032dd140((long *)(param_1 + 0x90),plVar5,lVar7);
    bVar4 = lVar7 == lVar6;
    lVar7 = lVar6;
    if (bVar4) {
      return;
  ...
  uVar8 = func_0x03eb6c18(lVar7,*(undefined8 *)puVar3);
  puVar9 = (undefined8 *)(lVar7 + 0x78);
  *puVar9 = uVar8;
