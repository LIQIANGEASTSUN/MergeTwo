/* Ghidra 12.1.2 native pseudocode; RVA 0x679E2FC; MergeEngine.ECS.Systems.Items.Producers.LowLevelItemProduce.LowLevelProduceStrategyBase.get_BoardSystem; status ok */


long MergeEngine_ECS_Systems_Items_Producers_LowLevelItemProduce_LowLevelProduceStrategyBase__get_BoardSystem
               (long param_1)

{
  ...
  if ((bRam0000000007e28dcd & 1) == 0) {
    func_0x03280a18(PTR_DAT_077cc660);
    bRam0000000007e28dcd = 1;
  }
...
LAB_0689e478:
        ...
        lVar6 = (**(code **)(lVar5 + 8))(plVar4,lVar5);
        *plVar3 = lVar6;
        func_0x032809c4(plVar3,lVar6);
      }
      return lVar6;
    }
    lVar5 = *plVar4;
    lVar6 = *(long *)PTR_DAT_077cc660;
    uVar1 = (ulong)*(ushort *)(lVar5 + 0x12e);
    if (uVar1 != 0) {
      piVar2 = (int *)(*(long *)(lVar5 + 0xb0) + 8);
      do {
