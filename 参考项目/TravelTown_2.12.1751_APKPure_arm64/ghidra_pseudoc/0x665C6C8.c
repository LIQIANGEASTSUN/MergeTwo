/* Ghidra 12.1.2 native pseudocode; RVA 0x665C6C8; MergeEngine.ECS.Systems.Board.BoardInteractionSystem.DisposeSystem; status ok */
...

{
  ...
  if ((uVar7 & 1) != 0) {
    puStack_50 = (undefined *)lStack_40;
