/* Ghidra 12.1.2 native pseudocode; RVA 0x6A97FFC; Merger.MergeBoard.Extensions.EntityLockExtension.OnlyMovementLock; status ok */
...
long * Merger_MergeBoard_Extensions_EntityLockExtension__OnlyMovementLock
...

{
  ...
  uStack_28 = 0;
  if (param_1 != 0) {
    uVar11 = func_0x03d1f470(param_1,acStack_18,*(undefined8 *)PTR_DAT_0777a528);
    bVar10 = acStack_18[0] != '\0';
    uVar12 = func_0x03d1e508(param_1,&uStack_38,*(undefined8 *)puVar6);
    return (long *)(ulong)(uVar11 & bVar10 & (uVar12 ^ 1 | (uint)((char)uStack_38 == '\0')));
  }
  lVar17 = func_0x03280cac();
  apcStack_60[0] = Merger_MergeBoard_Extensions_EntityLockExtension__FixedPosition;
  uStack_50 = 0x7e2a000;
  lStack_48 = param_1;
  ...
  uVar11 = func_0x06b868e4(lVar17);
  if (lVar17 != 0) {
    uVar12 = func_0x03d1baa0(lVar17,*(undefined8 *)PTR_DAT_07832580);
    return (long *)(ulong)((uVar11 | uVar12) & 1);
  }
  lVar18 = func_0x03280cac();
  ppcVar9 = (code **)auStack_80;
  auStack_80[0] = 0x6b9811c;
  uStack_70 = 0x7e2a000;
  lStack_68 = lVar17;
  ...
  uVar19 = func_0x03d1be30(lVar18,*(undefined8 *)PTR_DAT_07831028);
  if (((uVar19 & 1) != 0) ||
     (uVar19 = func_0x03d1bec8(lVar18,*(undefined8 *)PTR_DAT_07831030), (uVar19 & 1) != 0)) {
    return (long *)0x1;
  }
    ...
    if (lVar17 == 0) {
      ...
      if (lVar17 == 0) {
        ...
        if (((lVar17 != 0) &&
          ...
          func_0x04fe31ac(&uStack_120,lVar17,*(undefined8 *)PTR_DAT_077c3a50);
          while( true ) {
            uVar19 = func_0x0515fbd0(&uStack_120,*(undefined8 *)puVar8);
            if ((uVar19 & 1) == 0) {
              plVar20 = (long *)func_0x0515fcf0(&uStack_120,*(undefined8 *)puVar7);
              return plVar20;
            }
            lVar17 = *(long *)(auVar36._0_8_ + 0x10);
            if (lVar17 == 0) break;
            func_0x04fe2d68(lVar17,uStack_110,uStack_108,*(undefined8 *)puVar6);
          }
          func_0x03280cac();
        }
        ...
        if (auVar37._8_4_ == 1) {
          ...
          lVar17 = *plVar20;
          func_0x072ce920();
          plVar20 = (long *)func_0x0515fcf0(&uStack_120,*(undefined8 *)PTR_DAT_077c3a58);
          if (lVar17 == 0) {
            return plVar20;
          }
          func_0x03280ca4(lVar17);
        }
        func_0x0515fcf0(&uStack_120,*(undefined8 *)PTR_DAT_077c3a58);
      ...
      do {
        ...
        *(undefined8 *)((long)puVar22 + -0x58) = uStack_c0;
