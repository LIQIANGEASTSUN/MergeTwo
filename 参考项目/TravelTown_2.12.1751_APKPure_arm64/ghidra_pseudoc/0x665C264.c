/* Ghidra 12.1.2 native pseudocode; RVA 0x665C264; MergeEngine.ECS.Systems.Board.BoardInteractionSystem.BoardViewDestroyed; status ok */
...
LAB_0675c6a4:
  ...
  if (lVar15 != 0) {
    ...
    puStack_90 = (undefined *)0x675c7b4;
    ...
    puStack_90 = (undefined *)uStack_a0;
    uStack_a0 = 0;
    uStack_98 = 0;
    func_0x072a6c4c(&uStack_a0,uVar16,0,0,1,0);
    func_0x07286e40(lVar15,uStack_a0,uStack_98,uVar8,1);
    return;
  }
  lVar11 = func_0x03280cac();
  lStack_80 = 0x675c84c;
  ...
  if ((uVar12 & 1) != 0) {
    puStack_90 = (undefined *)lStack_80;
