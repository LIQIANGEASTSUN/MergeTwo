/* Ghidra 12.1.2 native pseudocode; RVA 0x67089F0; Merger.Game.Views.Inventory.InventoryItemsView.InventoryStateUpdated; status ok */
...
long * Merger_Game_Views_Inventory_InventoryItemsView__InventoryStateUpdated(long param_1)
