/* Ghidra 12.1.2 native pseudocode; RVA 0x6799140; MergeEngine.ECS.Systems.Items.UndoSystem.InitializeSystem; status ok */


/* WARNING: Possible PIC construction at 0x06899294: Changing call to branch */
/* WARNING: Possible PIC construction at 0x068992e0: Changing call to branch */
...
/* WARNING: Possible PIC construction at 0x0689960c: Changing call to branch */
...
/* WARNING: Possible PIC construction at 0x068998ac: Changing call to branch */
/* WARNING: Possible PIC construction at 0x068998e4: Changing call to branch */
/* WARNING: Possible PIC construction at 0x06899ac8: Changing call to branch */
/* WARNING: Possible PIC construction at 0x06899af0: Changing call to branch */
/* WARNING: Possible PIC construction at 0x06899b18: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x06899af4) */
/* WARNING: Removing unreachable block (ram,0x06899acc) */
/* WARNING: Removing unreachable block (ram,0x068998e8) */
/* WARNING: Removing unreachable block (ram,0x068998f0) */
/* WARNING: Removing unreachable block (ram,0x068998b0) */
/* WARNING: Removing unreachable block (ram,0x068998b8) */
/* WARNING: Removing unreachable block (ram,0x0689990c) */
/* WARNING: Removing unreachable block (ram,0x0689992c) */
/* WARNING: Removing unreachable block (ram,0x06899940) */
/* WARNING: Removing unreachable block (ram,0x06899948) */
/* WARNING: Removing unreachable block (ram,0x0689994c) */
/* WARNING: Removing unreachable block (ram,0x06899954) */
/* WARNING: Removing unreachable block (ram,0x0689995c) */
/* WARNING: Removing unreachable block (ram,0x068999fc) */
/* WARNING: Removing unreachable block (ram,0x06899a54) */
/* WARNING: Removing unreachable block (ram,0x06899aa4) */
/* WARNING: Removing unreachable block (ram,0x06899970) */
/* WARNING: Removing unreachable block (ram,0x0689998c) */
/* WARNING: Removing unreachable block (ram,0x06899994) */
/* WARNING: Removing unreachable block (ram,0x068999bc) */
/* WARNING: Removing unreachable block (ram,0x068999a0) */
/* WARNING: Removing unreachable block (ram,0x068999ac) */
/* WARNING: Removing unreachable block (ram,0x068999cc) */
/* WARNING: Removing unreachable block (ram,0x068999f0) */
/* WARNING: Removing unreachable block (ram,0x068999e0) */
...
/* WARNING: Removing unreachable block (ram,0x06899610) */
/* WARNING: Removing unreachable block (ram,0x06899618) */
/* WARNING: Removing unreachable block (ram,0x06899634) */
/* WARNING: Removing unreachable block (ram,0x0689963c) */
/* WARNING: Removing unreachable block (ram,0x06899664) */
/* WARNING: Removing unreachable block (ram,0x06899648) */
/* WARNING: Removing unreachable block (ram,0x06899654) */
/* WARNING: Removing unreachable block (ram,0x06899674) */
/* WARNING: Removing unreachable block (ram,0x06899684) */
...
/* WARNING: Removing unreachable block (ram,0x068992e4) */
/* WARNING: Removing unreachable block (ram,0x06899308) */
/* WARNING: Removing unreachable block (ram,0x06899344) */
/* WARNING: Removing unreachable block (ram,0x06899298) */
/* WARNING: Removing unreachable block (ram,0x068992bc) */
/* WARNING: Removing unreachable block (ram,0x06899b1c) */
...
long * MergeEngine_ECS_Systems_Items_UndoSystem__InitializeSystem(long param_1)

{
  ...
  puVar20 = PTR_DAT_078107c8;
  puVar24 = PTR_DAT_078107c0;
  if ((bRam0000000007e28da3 & 1) == 0) {
    func_0x03280a18(PTR_DAT_078107c0);
    func_0x03280a18(PTR_DAT_077ccef8);
    func_0x03280a18(PTR_DAT_0774e758);
    func_0x03280a18(PTR_DAT_077ccf08);
    func_0x03280a18(PTR_DAT_077f15b8);
    func_0x03280a18(PTR_DAT_07780500);
    func_0x03280a18(PTR_DAT_078107d0);
    func_0x03280a18(PTR_DAT_078107d8);
    ...
    bRam0000000007e28da3 = 1;
  }
  lVar21 = *(long *)(param_1 + 0x28);
  uVar8 = func_0x03280ca0(*(undefined8 *)puVar24);
  func_0x054221d4(uVar8,param_1,*(undefined8 *)puVar20,0);
  puVar20 = PTR_DAT_078107f0;
  puVar24 = PTR_DAT_0774e758;
  if (lVar21 != 0) {
    func_0x03ea5304(lVar21,uVar8,*(undefined8 *)PTR_DAT_078107d0);
    lVar22 = *(long *)(param_1 + 0x28);
    lVar21 = func_0x03280ca0(*(undefined8 *)puVar24);
    func_0x056ed730(lVar21,param_1,*(undefined8 *)puVar20,0);
    puVar24 = PTR_DAT_078107e0;
    if (lVar22 != 0) {
      lVar13 = *(long *)PTR_DAT_077f15b8;
      ...
      func_0x0404e308(lVar6,*(undefined8 *)(*(long *)(lVar14 + 0x38) + 8));
      if (lVar6 != 0) {
      ...
      puStack_a8 = puVar24;
      lStack_88 = 0;
      plVar16 = *(long **)(lVar7 + 0x38);
      lVar12 = lVar13;
      lVar15 = lVar7;
      lStack_b0 = lVar6;
      puStack_a0 = (undefined *)lVar21;
      lStack_98 = lVar14;
      lStack_90 = lVar22;
      if (plVar16 == (long *)0x0) {
        func_0x03280a18(PTR_DAT_07750ac8);
      ...
      (*(code *)**(undefined8 **)(*(long *)(lVar7 + 0x38) + 8))();
      if (lVar21 != 0) {
      ...
      plVar16 = auVar26._0_8_;
      lStack_120 = 0x3ea5874;
      ...
      lVar21 = *plVar17;
      uStack_130 = lStack_120;
      puStack_128 = puVar24;
      plVar17 = plVar16;
      lStack_120 = lVar12;
      lStack_118 = lVar15;
      if (*(long *)(lVar21 + 0x38) == 0) {
        plVar17 = (long *)func_0x03280a18(PTR_DAT_0774e558);
        if (*(long *)(lVar21 + 0x38) == 0) {
          plVar17 = (long *)func_0x03256878(lVar21);
        }
      }
      ...
      uVar8 = **(undefined8 **)(lVar21 + 0x38);
      if (*(int *)(*(long *)PTR_DAT_0774e558 + 0xe0) == 0) {
        func_0x03280b8c();
      }
      uVar8 = func_0x057a51c4(uVar8,0);
      lVar22 = func_0x072869d0(plVar16,uVar8,0,0,0);
      if (lVar22 == 0) {
        return (long *)0x0;
      }
      uVar8 = **(undefined8 **)(lVar21 + 0x38);
      ...
      uVar8 = func_0x057a51c4(uVar8,0);
      lVar13 = func_0x057c1ad4(uVar8,0);
...
LAB_03ea5b18:
        ...
        lVar7 = func_0x03280b90(lVar13,lVar21);
        if (lVar7 == 0) {
          func_0x03281048(lVar13,lVar21);
          goto LAB_03ea5b18;
        }
      }
      lVar21 = 0;
      ...
      if (lVar7 != 0) {
        uVar8 = func_0x057dadc4(lVar7,0);
        puVar20 = *(undefined **)(lVar22 + 0x20);
        if (*(int *)(*(long *)puVar24 + 0xe0) == 0) {
          func_0x03280b8c(*(long *)puVar24);
        }
        uVar5 = func_0x0727e0ec(uVar8,puVar20);
        plVar16 = (long *)(ulong)(uVar5 & 1);
        uVar8 = 0x728539c;
        goto SUB_0727dc78;
      }
      func_0x03280cac();
      ...
      while( true ) {
        ...
        plVar16 = (long *)func_0x072ce910(auVar28._0_8_);
        lVar22 = *plVar16;
        func_0x072ce920();
        uVar18 = (ulong)*(ushort *)(lRam0000000007e34000 + 0x12e);
        if (uVar18 != 0) {
          piVar19 = (int *)(*(long *)(lRam0000000007e34000 + 0xb0) + 8);
          do {
            if (*(long *)(piVar19 + -2) == *(long *)PTR_DAT_0774e8c8) {
              puVar9 = (undefined8 *)(lRam0000000007e34000 + (long)*piVar19 * 0x10 + 0x138);
              goto LAB_072854e8;
            }
            uVar18 = uVar18 - 1;
            piVar19 = piVar19 + 4;
...
LAB_072854e8:
        plVar16 = (long *)(*(code *)*puVar9)(0x7e34000,puVar9[1]);
        if (lVar22 == 0) {
          return plVar16;
        }
      }
...
LAB_072855b0:
      ...
      uStack_170 = 0x72855d4;
      plVar17 = (long *)0x7e34000;
      ...
      plVar16 = (long *)func_0x03e0c264(lVar14,*(undefined8 *)puVar24);
      puVar10 = PTR_DAT_0785df00;
      puVar20 = PTR_DAT_0785ded8;
...
LAB_07285770:
        if (lVar14 != 0) {
          if (0 < *(int *)(lVar14 + 0x18)) {
            plVar17 = (long *)0x0;
            do {
              puVar11 = (undefined *)func_0x0414419c(lVar14,plVar17,*(undefined8 *)puVar20);
              puVar25 = puVar20;
              if (*(long *)(lVar13 + 0x10) == 0) goto LAB_07285808;
              plVar16 = (long *)func_0x041447fc(*(long *)(lVar13 + 0x10),puVar11,
                                                *(undefined8 *)puVar10);
              puVar24 = puVar11;
              if (((ulong)plVar16 & 1) != 0) {
                if ((puVar11 == (undefined *)0x0) ||
                   (lVar22 = *(long *)(puVar11 + 0x18), lVar22 == 0)) goto LAB_07285808;
                plVar16 = (long *)(**(code **)(lVar22 + 0x18))
                                            (*(undefined8 *)(lVar22 + 0x40),lVar21,
                                             *(undefined8 *)(lVar22 + 0x28));
              }
              uVar5 = (int)plVar17 + 1;
              plVar17 = (long *)(ulong)uVar5;
            } while ((int)uVar5 < *(int *)(lVar14 + 0x18));
          }
          return plVar16;
        }
LAB_07285808:
...
LAB_0728580c:
        ...
        if (*(int *)(lVar13 + 0x30) != 2) {
          ...
          uVar8 = func_0x03280a2c(PTR_DAT_0774e5a0);
          lVar14 = func_0x03280afc(uVar8,1);
          func_0x02f0b18c(lVar21);
          uVar8 = func_0x057dadc4(lVar21,0);
          func_0x02f0b18c(lVar14);
          func_0x02f176b4(lVar14,uVar8);
          func_0x02f0965c(lVar14,0,uVar8);
          uVar8 = func_0x03280a2c(PTR_DAT_0785df08);
          lVar21 = func_0x0727df38(uVar8,lVar14);
          uVar8 = func_0x03280a2c(PTR_DAT_0785df10);
          func_0x03280b7c(lVar21,uVar8);
        }
        plVar16 = (long *)func_0x03280afc(*(undefined8 *)PTR_DAT_0774e5a0,1);
        if (lVar21 == 0) goto LAB_07285808;
        puVar10 = (undefined *)func_0x057dadc4(lVar21,0);
        plVar17 = plVar16;
        if (plVar16 == (long *)0x0) goto LAB_07285808;
...
LAB_07285744:
        ...
        lVar22 = func_0x03280b90(puVar10,*(undefined8 *)(*plVar16 + 0x40));
        if (lVar22 != 0) goto LAB_07285744;
      }
      uVar8 = func_0x03280cd0();
      auVar26 = func_0x03280b7c(uVar8,0);
      uStack_180 = 0x728581c;
      lVar22 = *(long *)(auVar26._0_8_ + 0x18);
      if (lVar22 != 0) {
                    /* WARNING: Could not recover jumptable at 0x07285838. Too many branches */
                    /* WARNING: Treating indirect jump as call */
        plVar16 = (long *)(**(code **)(lVar22 + 0x18))
                                    (*(undefined8 *)(lVar22 + 0x40),auVar26._8_8_,
                                     *(undefined8 *)(lVar22 + 0x28));
        return plVar16;
      }
      lVar7 = func_0x03280cac();
      puVar20 = PTR_DAT_0785df18;
      puVar4 = auStack_1c0;
      auStack_1c0[0] = 0x7285840;
      lVar22 = 0x7e34000;
      puStack_1b0 = puVar25;
      puStack_1a8 = puVar10;
      plStack_1a0 = plVar16;
      ...
      plVar16 = (long *)(ulong)*(byte *)(lVar7 + 0x34);
      uVar8 = 0x72858f0;
SUB_0727dc78:
      if (((ulong)plVar16 & 1) == 0) {
        *(undefined8 *)((long)puVar4 + -0x10) = uVar8;
        *(undefined **)((long)puVar4 + -8) = puVar20;
        uVar8 = func_0x03280a2c(PTR_DAT_0785dbe8);
        puVar24 = PTR_DAT_0777c990;
        *(undefined8 *)((long)puVar4 + -0x30) = 0x727dc94;
        *(long *)((long)puVar4 + -0x28) = lVar22;
        *(long *)((long)puVar4 + -0x20) = lVar7;
        *(undefined **)((long)puVar4 + -0x18) = puVar20;
        if ((bRam0000000007e34146 & 1) == 0) {
          func_0x03280a18(PTR_DAT_0777c990);
          bRam0000000007e34146 = 1;
        }
        plVar16 = (long *)func_0x03280ca0(*(undefined8 *)puVar24);
        func_0x072c77f8(plVar16,uVar8,0);
        return plVar16;
      }
      return plVar16;
    }
  ...
  lVar22 = *(long *)(lVar21 + 0x28);
  uVar8 = func_0x03280ca0(*(undefined8 *)puVar24);
  func_0x054221d4(uVar8,lVar21,*(undefined8 *)puVar20,0);
  puVar25 = PTR_DAT_078107f0;
  puVar20 = PTR_DAT_0774e758;
  lStack_88 = lVar21;
  if (lVar22 != 0) {
    func_0x03ea6208(lVar22,uVar8,*(undefined8 *)PTR_DAT_07810800);
    lVar22 = *(long *)(lVar21 + 0x28);
    uVar8 = func_0x03280ca0(*(undefined8 *)puVar20);
    func_0x056ed730(uVar8,lVar21,*(undefined8 *)puVar25,0);
    puVar24 = puVar20;
    if (lVar22 != 0) {
      lVar21 = *(long *)PTR_DAT_077f1660;
      puStack_a0 = (undefined *)0x68994c8;
      plVar16 = *(long **)(lVar21 + 0x38);
      lStack_98 = uVar8;
      lStack_90 = lVar22;
      if (plVar16 == (long *)0x0) {
        func_0x03256878(lVar21);
      ...
      lVar21 = *plVar16;
      lStack_b0 = (long)puStack_a0;
      puStack_a0 = puVar20;
      puVar9 = *(undefined8 **)(lVar21 + 0x38);
      ...
      puStack_a0 = (undefined *)lStack_b0;
      lStack_b0 = 0;
      puStack_a8 = (undefined *)0x0;
      func_0x072a6c4c(&lStack_b0,uVar23,0,0);
      plVar16 = (long *)func_0x07286e40(lVar22,lStack_b0,puStack_a8,uVar8,1);
      return plVar16;
    }
  }
  auVar26 = func_0x03280cac();
  ...
  if (lVar21 == 0) {
    ...
    auStack_d0._0_8_ = 0x68997b4;
    if ((bRam0000000007e28da6 & 1) == 0) {
      lStack_c0 = lVar21;
      lStack_b8 = auVar26._0_8_;
      func_0x03280a18(PTR_DAT_07810810);
      auVar26._8_8_ = lStack_c0;
      auVar26._0_8_ = lStack_b8;
      bRam0000000007e28da6 = 1;
    }
    lStack_c0 = auVar26._8_8_;
    lStack_b8 = auVar26._0_8_;
    plVar16 = *(long **)(lVar22 + 0x48);
    if (plVar16 != (long *)0x0) {
      lVar21 = *plVar16;
      ...
      if (uVar18 != 0) {
        ...
        do {
          if (*(long *)(piVar19 + -2) == *(long *)PTR_DAT_07810810) {
            puVar9 = (undefined8 *)(lVar21 + (long)*piVar19 * 0x10 + 0x138);
            goto LAB_0689983c;
          }
          uVar18 = uVar18 - 1;
          piVar19 = piVar19 + 4;
      ...
      puVar9 = (undefined8 *)func_0x03256b10(plVar16,*(long *)PTR_DAT_07810810,0);
      auVar26._8_8_ = lStack_c0;
      auVar26._0_8_ = lStack_b8;
LAB_0689983c:
      lStack_c0 = auVar26._8_8_;
    ...
    *plVar16 = 0;
    ...
    plVar16 = (long *)(auVar26._0_8_ + 0x48);
    *plVar16 = *(long *)(lVar21 + 0x10);
  }
SUB_032809c4:
