/* Ghidra 12.1.2 native pseudocode; RVA 0x665EAA4; MergeEngine.ECS.Systems.Board.BoardInteractionSystem.SwapItems; status ok */
...
LAB_03e40d14:
            ...
            *(undefined8 *)(puVar4 + -8) = uVar15;
            ...
            if (plVar23 == (long *)0x0) {
              auVar27 = func_0x03280cac();
              *(undefined8 *)(puVar4 + -0x60) = 0x3e40df4;
...
LAB_03e40f1c:
              ...
              *(undefined8 *)(puVar4 + -0xa0) = 0x3e40f54;
...
LAB_03e40dbc:
  ...
  auVar27 = func_0x03280cac();
  *(undefined8 *)((long)register0x00000008 + -0xa0) = 0x676aee4;
  lVar6 = *(long *)(auVar27._0_8_ + 0x88);
  if (lVar6 == 0) {
    func_0x03280cac();
    *(undefined8 *)((long)register0x00000008 + -0xb0) = 0x676af0c;
