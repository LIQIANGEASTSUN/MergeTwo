/* Ghidra 12.1.2 native pseudocode; RVA 0x613F28C; MergeEngine.Model.Configuration.MergingConfigurationModel.GetPreviousItemOnGraph; status ok */
  ...
  do {
    ...
    *(long **)((long)register0x00000008 + -8) = unaff_x19;
    ...
    if (plVar7 != (long *)0x0) {
      ...
      puVar5 = (undefined8 *)func_0x03256b10(plVar7,*(long *)PTR_DAT_0777e548,0x1b);
LAB_0623f0a0:
      lVar11 = (*(code *)*puVar5)(plVar7,puVar5[1]);
      if (lVar11 == 0) {
        return 0;
      }
      lVar11 = *plVar7;
      ...
      puVar5 = (undefined8 *)func_0x03256b10(plVar7,*(long *)puVar3,0x1b);
LAB_0623f100:
...
LAB_0623f168:
        ...
        unaff_x22 = puVar2;
        if (lVar11 != 0) {
          iVar4 = func_0x04145210(lVar11,plVar7,*(undefined8 *)PTR_DAT_077db338);
          uVar8 = iVar4 - 1;
...
LAB_0623f1f8:
          ...
          if (plVar7 != (long *)0x0) {
            ...
            puVar5 = (undefined8 *)func_0x03256b10(plVar7,*(long *)puVar2,0);
LAB_0623f258:
            lVar11 = (*(code *)*puVar5)(plVar7,puVar5[1]);
            unaff_x19 = plVar7;
            if (lVar11 != 0) {
              ...
              *(long **)((long)register0x00000008 + -0x28) = unaff_x20;
              ...
              if (lVar11 == 0) {
                ...
                puVar5 = (undefined8 *)(lVar11 + (long)(int)uVar8 * 8 + 0x20);
                *puVar5 = uVar9;
                uVar12 = func_0x032809c4(puVar5,uVar9);
    ...
    unaff_x30 = MergeEngine_Model_Configuration_MergingConfigurationModel__GetPreviousItemOnGraph;
