/* Ghidra 12.1.2 native pseudocode; RVA 0x6698BA4; Merger.Game.Views.BoardView.ForceDeselectItem; status ok */
...
void Merger_Game_Views_BoardView__ForceDeselectItem(long param_1)
