/* Ghidra 12.1.2 native pseudocode; RVA 0x6A635E0; Merger.MergeBoardSkipCooldownCapability.Logic.SkipCooldownProvider.CalculatePriceWithSkipCooldownSettings; status ok */
