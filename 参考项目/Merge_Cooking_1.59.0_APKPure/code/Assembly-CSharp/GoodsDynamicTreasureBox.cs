...
public class GoodsDynamicTreasureBox : GameGoodsBase
{
	public GoodsDynamicTreasureBox(GameGoodsVo goodsVo, GameLevelGrid grid)
		: base(GameGoodsType.DynamicTreasureBox, goodsVo, grid)
	{
	...
	public override void Use()
	{
		...
		else if (mGoodsVo.GoodsState == GameGoodsState.BoxWaitOpen)
		{
		...
		else if (mGoodsVo.GoodsState == GameGoodsState.CoolDown)
		{
			EventManager.GetInstance().DispatchEvent(202123, VibrateManager.VibrateType.Intense);
		}
	}
