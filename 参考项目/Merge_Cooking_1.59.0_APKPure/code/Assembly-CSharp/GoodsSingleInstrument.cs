...
public class GoodsSingleInstrument : GameGoodsBase
{
	public GoodsSingleInstrument(GameGoodsVo goodsVo, GameLevelGrid grid)
		: base(GameGoodsType.SingleMaterialInstrument, goodsVo, grid)
	{
