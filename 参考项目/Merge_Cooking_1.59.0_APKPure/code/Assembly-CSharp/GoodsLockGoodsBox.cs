...
public class GoodsLockGoodsBox : GameGoodsBase
{
	public GoodsLockGoodsBox(GameGoodsVo goodsVo, GameLevelGrid grid)
		: base(GameGoodsType.LockGoodsBox, goodsVo, grid)
	{
