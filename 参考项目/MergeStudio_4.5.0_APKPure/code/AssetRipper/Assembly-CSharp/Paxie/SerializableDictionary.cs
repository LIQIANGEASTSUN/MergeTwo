...
namespace Paxie
{
	...
	public class SerializableDictionary<TKey, TValue> : SerializableDictionary, ISerializationCallbackReceiver, IDictionary<TKey, TValue>, ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable
	{
		...
		[SerializeField]
		public List<SerializableKeyValuePair> list;

		[NonSerialized]
		public Lazy<Dictionary<TKey, uint>> _keyPositions;

		public Dictionary<TKey, uint> KeyPositions => null;
		...
		public Dictionary<TKey, uint> MakeKeyPositions()
		{
			return null;
		}
