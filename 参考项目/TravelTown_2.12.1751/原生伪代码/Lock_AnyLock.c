...
ulong target_Lock_AnyLock(long param_1,undefined8 param_2,undefined8 param_3,long param_4)

{
  ...
  uStack_28 = 0;
  if (lVar16 != 0) {
    uVar9 = func_0x03d1f470(lVar16,acStack_18,*(undefined8 *)PTR_DAT_0777a528);
    bVar8 = acStack_18[0] != '\0';
    uVar10 = func_0x03d1e508(lVar16,&uStack_38,*(undefined8 *)puVar14);
  ...
  if (lVar22 == 0) {
    ...
    plVar15 = (long *)(*(long *)(*(long *)puVar14 + 0xb8) + 8);
    *plVar15 = lVar22;
    func_0x032809c4(plVar15,lVar22);
  }
  lVar20 = *(long *)puVar4;
  lVar16 = func_0x03d50a94(extraout_x1,lVar22);
  lVar22 = *(long *)puVar3;
  ...
  if (lVar16 != 0) {
    ...
    func_0x04143d60(uVar11,lVar16,*(undefined8 *)(*(long *)(lVar22 + 0x38) + 0x10));
    return uVar11;
  }
  ...
  if (auVar24._0_8_ != 0) {
    ...
    uVar11 = func_0x03280ca0();
    func_0x0419ce74(uVar11,auVar24._0_8_,*(undefined8 *)(*(long *)(lVar16 + 0x38) + 0x10));
    return uVar11;
  }
  uVar23 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar23 = func_0x05ac7464(uVar23,0);
  auVar25 = func_0x03280b7c(uVar23,lVar16);
  ...
  if (auVar25._0_8_ != 0) {
    ...
    uVar11 = func_0x03280ca0();
    func_0x041c2810(uVar11,auVar25._0_8_,*(undefined8 *)(*(long *)(lVar16 + 0x38) + 0x10));
    return uVar11;
  }
  uVar23 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar23 = func_0x05ac7464(uVar23,0);
  auVar24 = func_0x03280b7c(uVar23,lVar16);
  lVar16 = auVar24._8_8_;
  ...
  if (auVar24._0_8_ != 0) {
    ...
    uVar11 = func_0x03280ca0();
    func_0x041ddb58(uVar11,auVar24._0_8_,*(undefined8 *)(*(long *)(lVar16 + 0x38) + 0x10));
    return uVar11;
  }
  uVar23 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar23 = func_0x05ac7464(uVar23,0);
  ...
  if (auVar25._0_8_ != 0) {
    ...
    uVar11 = func_0x03280ca0();
    func_0x041e617c(uVar11,auVar25._0_8_,*(undefined8 *)(*(long *)(lVar16 + 0x38) + 0x10));
    return uVar11;
  }
  uVar23 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar23 = func_0x05ac7464(uVar23,0);
  ...
  if (auVar24._0_8_ != 0) {
    ...
    uVar11 = func_0x03280ca0();
    func_0x041e8ba0(uVar11,auVar24._0_8_,*(undefined8 *)(*(long *)(lVar16 + 0x38) + 0x10));
    return uVar11;
  }
  uVar23 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar23 = func_0x05ac7464(uVar23,0);
  ...
  if (auVar25._0_8_ != 0) {
    ...
    uVar11 = func_0x03280ca0();
    (*(code *)**(undefined8 **)(*(long *)(lVar16 + 0x38) + 0x10))(uVar11,auVar25._0_8_);
    return uVar11;
  }
  uVar23 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar23 = func_0x05ac7464(uVar23,0);
  ...
  if (auVar24._0_8_ != 0) {
    ...
    uVar11 = func_0x03280ca0();
    func_0x0420cec8(uVar11,auVar24._0_8_,*(undefined8 *)(*(long *)(lVar16 + 0x38) + 0x10));
    return uVar11;
  }
  uVar23 = func_0x03280a2c(PTR_DAT_07774b08);
  uVar23 = func_0x05ac7464(uVar23,0);
...
LAB_03d6068c:
    ...
    *(undefined1 (*) [16])((long)puVar5 + -0x10) = auVar2;
    ...
    if (uVar11 != 0) {
      ...
      *(long *)(uVar11 + 0x28) = lVar16;
      func_0x032809c4((long *)(uVar11 + 0x28),lVar16);
      return uVar11;
    }
...
LAB_03d60730:
  ...
  *(undefined8 *)((long)puVar7 + -0x68) = uVar23;
  ...
  if ((plVar15 == (long *)0x0) || (puVar14 = PTR_DAT_077799b8, lVar16 == 0)) {
    uVar23 = func_0x03280a2c(puVar14);
    uVar23 = func_0x05ac7464(uVar23,0);
...
LAB_03d60c04:
         ...
         (*(long *)(*(long *)(lVar20 + 200) + (ulong)*(byte *)(lVar22 + 0x130) * 8 + -8) == lVar22))
      {
        ...
        if ((*(byte *)(lVar22 + 0x130) <= bVar1) &&
           (*(long *)(*(long *)(lVar20 + 200) + (ulong)*(byte *)(lVar22 + 0x130) * 8 + -8) == lVar22
                    ...
                    /* WARNING: Treating indirect jump as call */
          uVar11 = (**(code **)(lVar20 + 0x228))(plVar15,lVar16,*(undefined8 *)(lVar20 + 0x230));
          return uVar11;
        }
      }
      goto LAB_03d60c04;
    ...
    if (lVar22 == 0) {
      ...
      if ((*(byte *)(*plVar15 + 0x130) < *(byte *)(lVar22 + 0x130)) ||
        ...
        uVar11 = func_0x03280ca0();
        func_0x04b68fa4(uVar11,plVar15,lVar16,*(undefined8 *)(puVar18[7] + 0x58));
        return uVar11;
      }
      ...
      if ((*(byte *)(lVar22 + 0x130) <= *(byte *)(*plVar15 + 0x130)) &&
        ...
        func_0x04b713b0(uVar11,plVar15,lVar16,*(undefined8 *)(puVar18[7] + 0x48));
        return uVar11;
      }
      goto LAB_03d60c04;
    }
    ...
    lVar20 = func_0x03280b90(plVar15,lVar22);
    if (lVar20 != 0) {
      func_0x04b66610(uVar11,lVar20,lVar16,*(undefined8 *)(puVar18[7] + 0x30));
      return uVar11;
    }
  }
  auVar24 = func_0x03281048(plVar15,lVar22);
  lVar16 = auVar24._8_8_;
  plVar15 = auVar24._0_8_;
  ...
  *(undefined1 (*) [16])((long)puVar7 + -0xa0) = auVar25;
  ...
  if ((plVar15 == (long *)0x0) || (puVar14 = PTR_DAT_077799b8, lVar16 == 0)) {
    ...
    if ((bVar1 < *(byte *)(lVar20 + 0x130)) ||
      ...
      lVar20 = func_0x03280b90(plVar15,lVar20);
      if (lVar20 != 0) {
        ...
        lVar20 = func_0x03280b90(plVar15,lVar22);
        if (lVar20 != 0) {
          func_0x04b667e0(uVar11,lVar20,lVar16,*(undefined8 *)(puVar19[7] + 0x30));
          return uVar11;
        }
        goto LAB_03d60ee0;
      }
      ...
      if ((*(byte *)(*plVar15 + 0x130) < *(byte *)(lVar20 + 0x130)) ||
         (*(long *)(*(long *)(*plVar15 + 200) + (ulong)*(byte *)(lVar20 + 0x130) * 8 + -8) != lVar20
         )) {
        if ((*(byte *)(*(long *)(puVar19[7] + 0x50) + 0x135) & 1) == 0) {
          func_0x0325681c();
        }
        uVar11 = func_0x03280ca0();
        func_0x04b693d0(uVar11,plVar15,lVar16,*(undefined8 *)(puVar19[7] + 0x58));
        return uVar11;
      }
      ...
      if ((*(byte *)(lVar20 + 0x130) <= *(byte *)(*plVar15 + 0x130)) &&
         (*(long *)(*(long *)(*plVar15 + 200) + (ulong)*(byte *)(lVar20 + 0x130) * 8 + -8) == lVar20
         )) {
        func_0x04b715c8(uVar11,plVar15,lVar16,*(undefined8 *)(puVar19[7] + 0x48));
        return uVar11;
      }
    }
    else {
         ...
         (*(long *)(*(long *)(lVar17 + 200) + (ulong)*(byte *)(lVar20 + 0x130) * 8 + -8) == lVar20))
      {
        ...
        if ((*(byte *)(lVar20 + 0x130) <= bVar1) &&
           (*(long *)(*(long *)(lVar17 + 200) + (ulong)*(byte *)(lVar20 + 0x130) * 8 + -8) == lVar20
                    ...
                    /* WARNING: Treating indirect jump as call */
          uVar11 = (**(code **)(lVar17 + 0x228))(plVar15,lVar16,*(undefined8 *)(lVar17 + 0x230));
          return uVar11;
        }
      }
    }
  ...
  func_0x03281048(plVar15);
LAB_03d60ee0:
  lVar16 = func_0x03281048(plVar15,lVar22);
  ...
  *(undefined1 (*) [16])((long)puVar7 + -0xd0) = auVar24;
  ...
  if (uVar11 == 0) {
    ...
    **(ulong **)(lVar22 + 0xb8) = uVar11;
    ...
    func_0x032809c4(*(undefined8 *)(lVar16 + 0xb8),uVar11);
  }
  return uVar11;
}
