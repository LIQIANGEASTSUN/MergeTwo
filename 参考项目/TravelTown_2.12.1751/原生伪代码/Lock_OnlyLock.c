...
long * target_Lock_OnlyLock(long param_1,undefined8 param_2,undefined8 param_3,long param_4)

{
  ...
  uStack_28 = 0;
  if (lVar19 != 0) {
    uVar11 = func_0x03d1f470(lVar19,acStack_18,*(undefined8 *)PTR_DAT_0777a528);
    bVar10 = acStack_18[0] != '\0';
    uVar12 = func_0x03d1e508(lVar19,&uStack_38,*(undefined8 *)puVar6);
    return (long *)(ulong)(uVar11 & bVar10 & (uVar12 ^ 1 | (uint)((char)uStack_38 == '\0')));
  }
  lVar17 = func_0x03280cac();
  auStack_60[0] = 0x6b980b4;
  uStack_50 = 0x7e2a000;
  lStack_48 = lVar19;
  ...
  uVar11 = target_Lock_AnyMovement(lVar17);
  if (lVar17 != 0) {
  ...
  uVar18 = func_0x03d1be30(lVar19,*(undefined8 *)PTR_DAT_07831028);
  if (((uVar18 & 1) != 0) ||
     (uVar18 = func_0x03d1bec8(lVar19,*(undefined8 *)PTR_DAT_07831030), (uVar18 & 1) != 0)) {
    return (long *)0x1;
  }
  ...
  if (lVar19 == 0) {
    ...
    if (lVar19 == 0) {
      ...
      if (lVar19 == 0) {
        ...
        lVar19 = *(long *)(auVar36._0_8_ + 0x10);
        if (((lVar19 != 0) &&
            (func_0x04fe2f04(lVar19,*(undefined8 *)PTR_DAT_077c3a88), puVar8 = PTR_DAT_077c3a60,
            puVar7 = PTR_DAT_077c3a58, puVar6 = PTR_DAT_07779c58, auVar36._8_8_ != 0)) &&
           (lVar19 = *(long *)(auVar36._8_8_ + 0x10), lVar19 != 0)) {
          func_0x04fe31ac(&uStack_120,lVar19,*(undefined8 *)PTR_DAT_077c3a50);
          while( true ) {
            uVar18 = func_0x0515fbd0(&uStack_120,*(undefined8 *)puVar8);
            if ((uVar18 & 1) == 0) {
            ...
            lVar19 = *(long *)(auVar36._0_8_ + 0x10);
            if (lVar19 == 0) break;
            func_0x04fe2d68(lVar19,uStack_110,uStack_108,*(undefined8 *)puVar6);
          }
          func_0x03280cac();
        }
...
LAB_04fe3e2c:
        ...
        *(undefined8 *)((long)puVar22 + -0x1e8) = *(undefined8 *)((long)puVar22 + -0x1e8);
        ...
        unaff_x21 = func_0x03280afc(*(undefined8 *)puVar6,uVar18);
...
LAB_04fe4274:
  ...
  *(undefined8 *)((long)puVar9 + -0x10) = uVar29;
