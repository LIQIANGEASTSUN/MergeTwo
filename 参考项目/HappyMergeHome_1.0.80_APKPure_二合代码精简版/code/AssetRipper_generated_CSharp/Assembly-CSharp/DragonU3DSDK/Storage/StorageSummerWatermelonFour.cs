...
{
	[Serializable]
	public class StorageSummerWatermelonFour : StorageBase
	{
		[JsonProperty]
		[NonSerialized]
		public bool isStart;
		...
		[JsonProperty]
		[NonSerialized]
		public StorageDictionary<int, bool> claimedStageRewards;

		[JsonProperty]
		[NonSerialized]
		public int mergeBoardOffect;

		[JsonProperty]
		[NonSerialized]
		public StorageDictionary<int, bool> mergeLineRwards;

		[JsonProperty]
		[NonSerialized]
		public bool isClaimFinalReward;
		...
		[JsonIgnore]
		public StorageDictionary<int, bool> ClaimedStageRewards => null;
		...
		[JsonIgnore]
		public StorageDictionary<int, bool> MergeLineRwards => null;
