...
namespace Activity.SummerWatermelon_8
{
	public class SummerWatermelonModel : ActivityEntityBase
	{
		...
		public struct _003CUseMergeItem_003Ed__87 : IAsyncStateMachine
		{
			...
			[NonSerialized]
			public SummerWatermelonEightStageRewardConfig _003ClevelConfig_003E5__2;
		...
		public const int BOARD_HEIGHT_BIG = 44;

		public static SummerWatermelonModel _instance;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonEightFirstTimeRewardConfig> _summerWatermelonFirstTimeRewardConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonEightMergeRewardConfig> _summerWatermelonMergeRewardConfig;
		...
		public List<SummerWatermelonEightPackageConfig> PackageConfig => null;

		public static SummerWatermelonModel Instance => null;

		public override string Guid => null;

		public StorageSummerWatermelonSix StorageSummerWatermelon => null;

		public SummerWatermelonEightConfig SummerWatermelonConfig => null;

		public Dictionary<int, SummerWatermelonEightFirstTimeRewardConfig> SummerWatermelonFirstTimeRewardConfig => null;

		public Dictionary<int, SummerWatermelonEightMergeRewardConfig> SummerWatermelonMergeRewardConfig => null;
		...
		public static bool IsActivityStorageEnd(StorageSummerWatermelonSix storage)
		{
			return false;
		}

		public static void CompletedStorageActivity(StorageSummerWatermelonSix storage)
		{
		}
		...
		public void DebugMove(int moveStep)
		{
		}
		...
		public void ClaimIllustratedMergeLineReward(SummerWatermelonEightMergeLineRewardConifig config)
		{
		}
		...
		public SummerWatermelonEightPackageConfig GetCurrentPackage()
		{
			return null;
		}
		...
		public bool IsPackageOpened(SummerWatermelonEightPackageConfig config)
		{
			return false;
		}

		public ulong GetPackageLeftTime(SummerWatermelonEightPackageConfig curPackage)
		{
			return 0uL;
		}

		public string GetPackageLeftTimeText(SummerWatermelonEightPackageConfig curPackage)
		{
			return null;
		}
		...
		public void OpenGiftPopup(SummerWatermelonEightPackageConfig curPackage)
		{
		}
		...
		public SummerWatermelonEightStageRewardConfig GetCurrentLevelConfig()
		{
			return null;
		}

		public SummerWatermelonEightStageRewardConfig GetLevelConfig(int level)
		{
			return null;
		}

		public SummerWatermelonEightStageRewardConfig GetNextLevelConfig()
		{
			return null;
		}
