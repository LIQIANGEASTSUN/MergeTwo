...
namespace Activity.SummerWatermelon_27
{
	public class SummerWatermelonModel : ActivityEntityBase
	{
		...
		[NonSerialized]
		public Dictionary<int, SummerWatermelonTwentySevenProductConfig> _summerWatermelonProductConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonTwentySevenFirstTimeRewardConfig> _summerWatermelonFirstTimeRewardConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonTwentySevenMergeRewardConfig> _summerWatermelonMergeRewardConfig;
		...
		public List<SummerWatermelonTwentySevenPackageConfig> PackageConfig => null;

		public List<SummerWatermelonTwentySevenProductAttenuationConfig> ProductAttenuationConfig => null;
		...
		public SummerWatermelonTwentySevenConfig SummerWatermelonConfig => null;

		public Dictionary<int, SummerWatermelonTwentySevenProductConfig> SummerWatermelonProductConfig => null;

		public Dictionary<int, SummerWatermelonTwentySevenFirstTimeRewardConfig> SummerWatermelonFirstTimeRewardConfig => null;

		public Dictionary<int, SummerWatermelonTwentySevenMergeRewardConfig> SummerWatermelonMergeRewardConfig => null;
		...
		public BattlePassTwentySeven GetBattlePassConfig(int index)
		{
			return null;
		}
		...
		public BattlePassTwentySeven GetFrontRewardConfig(int score = -1)
		{
			return null;
		}
		...
		public BattlePassTwentySeven GetRewardConfig(int score, out bool isEnd)
		{
			isEnd = default(bool);
			return null;
		}

		public BattlePassTwentySeven GetNowRewardConfig()
		{
			return null;
		}
		...
		public SummerWatermelonTwentySevenPackageConfig GetCurrentPackage()
		{
			return null;
		}
		...
		public bool IsPackageOpened(SummerWatermelonTwentySevenPackageConfig config)
		{
			return false;
		}

		public ulong GetPackageLeftTime(SummerWatermelonTwentySevenPackageConfig curPackage)
		{
			return 0uL;
		}

		public string GetPackageLeftTimeText(SummerWatermelonTwentySevenPackageConfig curPackage)
		{
			return null;
		}
		...
		public void OpenGiftPopup(SummerWatermelonTwentySevenPackageConfig curPackage)
		{
		}
		...
		public List<SummerWatermelonTwentySevenPackageFourReward> GetCurrentNewPackageRewards()
		{
			return null;
		}
		...
		public void AddNewGiftsRewards(SummerWatermelonTwentySevenPackageFourReward _reward)
		{
		}
