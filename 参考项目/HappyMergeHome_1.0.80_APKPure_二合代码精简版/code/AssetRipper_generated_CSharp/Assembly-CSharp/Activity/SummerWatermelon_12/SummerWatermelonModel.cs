...
namespace Activity.SummerWatermelon_12
{
	public class SummerWatermelonModel : ActivityEntityBase
	{
		...
		[NonSerialized]
		public Dictionary<int, SummerWatermelonTwelveProductConfig> _summerWatermelonProductConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonTwelveFirstTimeRewardConfig> _summerWatermelonFirstTimeRewardConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonTwelveMergeRewardConfig> _summerWatermelonMergeRewardConfig;
		...
		public List<SummerWatermelonTwelvePackageConfig> PackageConfig => null;

		public List<SummerWatermelonTwelveProductAttenuationConfig> ProductAttenuationConfig => null;
		...
		public SummerWatermelonTwelveConfig SummerWatermelonConfig => null;

		public Dictionary<int, SummerWatermelonTwelveProductConfig> SummerWatermelonProductConfig => null;

		public Dictionary<int, SummerWatermelonTwelveFirstTimeRewardConfig> SummerWatermelonFirstTimeRewardConfig => null;

		public Dictionary<int, SummerWatermelonTwelveMergeRewardConfig> SummerWatermelonMergeRewardConfig => null;
		...
		public BattlePassTwelve GetBattlePassConfig(int index)
		{
			return null;
		}
		...
		public BattlePassTwelve GetFrontRewardConfig(int score = -1)
		{
			return null;
		}
		...
		public BattlePassTwelve GetRewardConfig(int score, out bool isEnd)
		{
			isEnd = default(bool);
			return null;
		}

		public BattlePassTwelve GetNowRewardConfig()
		{
			return null;
		}
		...
		public SummerWatermelonTwelvePackageConfig GetCurrentPackage()
		{
			return null;
		}
		...
		public bool IsPackageOpened(SummerWatermelonTwelvePackageConfig config)
		{
			return false;
		}

		public ulong GetPackageLeftTime(SummerWatermelonTwelvePackageConfig curPackage)
		{
			return 0uL;
		}

		public string GetPackageLeftTimeText(SummerWatermelonTwelvePackageConfig curPackage)
		{
			return null;
		}
		...
		public List<SummerWatermelonTwelvePackageFourReward> GetCurrentNewPackageRewards()
		{
			return null;
		}
		...
		public void AddNewGiftsRewards(SummerWatermelonTwelvePackageFourReward rewardConfig)
		{
		}
		...
		public void OpenGiftPopup(SummerWatermelonTwelvePackageConfig curPackage)
		{
		}
