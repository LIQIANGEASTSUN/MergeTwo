...
namespace Activity.SummerWatermelon_33
{
	public class SummerWatermelonModel : ActivityEntityBase
	{
		[CompilerGenerated]
		public sealed class _003C_003Ec__DisplayClass87_0
		{
		...
		[CompilerGenerated]
		public struct _003COnNewItem_003Ed__87 : IAsyncStateMachine
		{
			...
			[NonSerialized]
			public _003C_003Ec__DisplayClass87_0 _003C_003E8__1;
		...
		[NonSerialized]
		public Dictionary<int, SummerWatermelonThirtyThreeProductConfig> _summerWatermelonProductConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonThirtyThreeFirstTimeRewardConfig> _summerWatermelonFirstTimeRewardConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonThirtyThreeMergeRewardConfig> _summerWatermelonMergeRewardConfig;
		...
		public List<SummerWatermelonThirtyThreePackageConfig> PackageConfig => null;

		public List<SummerWatermelonThirtyThreeProductAttenuationConfig> ProductAttenuationConfig => null;

		public static SummerWatermelonModel Instance => null;

		public override string Guid => null;

		public StorageSummerWatermelonTen StorageSummerWatermelon => null;

		public SummerWatermelonThirtyThreeConfig SummerWatermelonConfig => null;

		public Dictionary<int, SummerWatermelonThirtyThreeProductConfig> SummerWatermelonProductConfig => null;

		public Dictionary<int, SummerWatermelonThirtyThreeFirstTimeRewardConfig> SummerWatermelonFirstTimeRewardConfig => null;

		public Dictionary<int, SummerWatermelonThirtyThreeMergeRewardConfig> SummerWatermelonMergeRewardConfig => null;
		...
		public static bool IsActivityStorageEnd(StorageSummerWatermelonTen storage)
		{
			return false;
		}

		public static void CompletedStorageActivity(StorageSummerWatermelonTen storage)
		{
		}
		...
		[AsyncStateMachine(typeof(_003COnNewItem_003Ed__87))]
		...
		public void TransferItemsToUnSet(int moveCount)
		{
		}
		...
		public BattlePassThirtyThree GetBattlePassConfig(int index)
		{
			return null;
		}
		...
		public BattlePassThirtyThree GetFrontRewardConfig(int score = -1)
		{
			return null;
		}
		...
		public BattlePassThirtyThree GetRewardConfig(int score, out bool isEnd)
		{
			isEnd = default(bool);
			return null;
		}

		public BattlePassThirtyThree GetNowRewardConfig()
		{
			return null;
		}
		...
		public SummerWatermelonThirtyThreePackageConfig GetCurrentPackage()
		{
			return null;
		}
		...
		public bool IsPackageOpened(SummerWatermelonThirtyThreePackageConfig config)
		{
			return false;
		}

		public ulong GetPackageLeftTime(SummerWatermelonThirtyThreePackageConfig curPackage)
		{
			return 0uL;
		}

		public string GetPackageLeftTimeText(SummerWatermelonThirtyThreePackageConfig curPackage)
		{
			return null;
		}
		...
		public void OpenGiftPopup(SummerWatermelonThirtyThreePackageConfig curPackage)
		{
		}
		...
		public List<SummerWatermelonThirtyThreePackageFourReward> GetCurrentNewPackageRewards()
		{
			return null;
		}
		...
		public void AddNewGiftsRewards(SummerWatermelonThirtyThreePackageFourReward _reward)
		{
		}
