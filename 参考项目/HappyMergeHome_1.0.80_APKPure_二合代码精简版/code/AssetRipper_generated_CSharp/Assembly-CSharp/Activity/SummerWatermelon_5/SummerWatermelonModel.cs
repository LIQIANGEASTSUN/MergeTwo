...
namespace Activity.SummerWatermelon_5
{
	public class SummerWatermelonModel : ActivityEntityBase
	{
		...
		[NonSerialized]
		public Dictionary<int, SummerWatermelonFiveProductConfig> _summerWatermelonProductConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonFiveFirstTimeRewardConfig> _summerWatermelonFirstTimeRewardConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonFiveMergeRewardConfig> _summerWatermelonMergeRewardConfig;
		...
		public List<SummerWatermelonFivePackageConfig> PackageConfig => null;

		public List<SummerWatermelonFiveProductAttenuationConfig> ProductAttenuationConfig => null;
		...
		public SummerWatermelonFiveConfig SummerWatermelonConfig => null;

		public Dictionary<int, SummerWatermelonFiveProductConfig> SummerWatermelonProductConfig => null;

		public Dictionary<int, SummerWatermelonFiveFirstTimeRewardConfig> SummerWatermelonFirstTimeRewardConfig => null;

		public Dictionary<int, SummerWatermelonFiveMergeRewardConfig> SummerWatermelonMergeRewardConfig => null;
		...
		public BattlePassFive GetBattlePassConfig(int index)
		{
			return null;
		}
		...
		public BattlePassFive GetFrontRewardConfig(int score = -1)
		{
			return null;
		}
		...
		public BattlePassFive GetRewardConfig(int score, out bool isEnd)
		{
			isEnd = default(bool);
			return null;
		}

		public BattlePassFive GetNowRewardConfig()
		{
			return null;
		}
		...
		public SummerWatermelonFivePackageConfig GetCurrentPackage()
		{
			return null;
		}
		...
		public bool IsPackageOpened(SummerWatermelonFivePackageConfig config)
		{
			return false;
		}

		public ulong GetPackageLeftTime(SummerWatermelonFivePackageConfig curPackage)
		{
			return 0uL;
		}

		public string GetPackageLeftTimeText(SummerWatermelonFivePackageConfig curPackage)
		{
			return null;
		}
		...
		public List<SummerWatermelonFivePackageFourReward> GetCurrentNewPackageRewards()
		{
			return null;
		}
		...
		public void AddNewGiftsRewards(SummerWatermelonFivePackageFourReward rewardConfig)
		{
		}
		...
		public void OpenGiftPopup(SummerWatermelonFivePackageConfig curPackage)
		{
		}
