...
namespace Activity.SummerWatermelon_23
{
	public class SummerWatermelonModel : ActivityEntityBase
	{
		...
		[NonSerialized]
		public Dictionary<int, SummerWatermelonTwentyThreeProductConfig> _summerWatermelonProductConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonTwentyThreeFirstTimeRewardConfig> _summerWatermelonFirstTimeRewardConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonTwentyThreeMergeRewardConfig> _summerWatermelonMergeRewardConfig;
		...
		public List<SummerWatermelonTwentyThreePackageConfig> PackageConfig => null;

		public List<SummerWatermelonTwentyThreeProductAttenuationConfig> ProductAttenuationConfig => null;
		...
		public SummerWatermelonTwentyThreeConfig SummerWatermelonConfig => null;

		public Dictionary<int, SummerWatermelonTwentyThreeProductConfig> SummerWatermelonProductConfig => null;

		public Dictionary<int, SummerWatermelonTwentyThreeFirstTimeRewardConfig> SummerWatermelonFirstTimeRewardConfig => null;

		public Dictionary<int, SummerWatermelonTwentyThreeMergeRewardConfig> SummerWatermelonMergeRewardConfig => null;
		...
		public BattlePassTwentyThree GetBattlePassConfig(int index)
		{
			return null;
		}
		...
		public BattlePassTwentyThree GetFrontRewardConfig(int score = -1)
		{
			return null;
		}
		...
		public BattlePassTwentyThree GetRewardConfig(int score, out bool isEnd)
		{
			isEnd = default(bool);
			return null;
		}

		public BattlePassTwentyThree GetNowRewardConfig()
		{
			return null;
		}
		...
		public SummerWatermelonTwentyThreePackageConfig GetCurrentPackage()
		{
			return null;
		}
		...
		public bool IsPackageOpened(SummerWatermelonTwentyThreePackageConfig config)
		{
			return false;
		}

		public ulong GetPackageLeftTime(SummerWatermelonTwentyThreePackageConfig curPackage)
		{
			return 0uL;
		}

		public string GetPackageLeftTimeText(SummerWatermelonTwentyThreePackageConfig curPackage)
		{
			return null;
		}
		...
		public void OpenGiftPopup(SummerWatermelonTwentyThreePackageConfig curPackage)
		{
		}
		...
		public List<SummerWatermelonTwentyThreePackageFourReward> GetCurrentNewPackageRewards()
		{
			return null;
		}
		...
		public void AddNewGiftsRewards(SummerWatermelonTwentyThreePackageFourReward _reward)
		{
		}
