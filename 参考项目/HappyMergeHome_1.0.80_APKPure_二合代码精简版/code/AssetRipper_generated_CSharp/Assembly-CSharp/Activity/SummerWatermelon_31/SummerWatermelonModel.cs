...
namespace Activity.SummerWatermelon_31
{
	public class SummerWatermelonModel : ActivityEntityBase
	{
		...
		[NonSerialized]
		public Dictionary<int, SummerWatermelonThirtyOneProductConfig> _summerWatermelonProductConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonThirtyOneFirstTimeRewardConfig> _summerWatermelonFirstTimeRewardConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonThirtyOneMergeRewardConfig> _summerWatermelonMergeRewardConfig;
		...
		public List<SummerWatermelonThirtyOnePackageConfig> PackageConfig => null;

		public List<SummerWatermelonThirtyOneProductAttenuationConfig> ProductAttenuationConfig => null;
		...
		public SummerWatermelonThirtyOneConfig SummerWatermelonConfig => null;

		public Dictionary<int, SummerWatermelonThirtyOneProductConfig> SummerWatermelonProductConfig => null;

		public Dictionary<int, SummerWatermelonThirtyOneFirstTimeRewardConfig> SummerWatermelonFirstTimeRewardConfig => null;

		public Dictionary<int, SummerWatermelonThirtyOneMergeRewardConfig> SummerWatermelonMergeRewardConfig => null;
		...
		public BattlePassThirtyOne GetBattlePassConfig(int index)
		{
			return null;
		}
		...
		public BattlePassThirtyOne GetFrontRewardConfig(int score = -1)
		{
			return null;
		}
		...
		public BattlePassThirtyOne GetRewardConfig(int score, out bool isEnd)
		{
			isEnd = default(bool);
			return null;
		}

		public BattlePassThirtyOne GetNowRewardConfig()
		{
			return null;
		}
		...
		public SummerWatermelonThirtyOnePackageConfig GetCurrentPackage()
		{
			return null;
		}
		...
		public bool IsPackageOpened(SummerWatermelonThirtyOnePackageConfig config)
		{
			return false;
		}

		public ulong GetPackageLeftTime(SummerWatermelonThirtyOnePackageConfig curPackage)
		{
			return 0uL;
		}

		public string GetPackageLeftTimeText(SummerWatermelonThirtyOnePackageConfig curPackage)
		{
			return null;
		}
		...
		public void OpenGiftPopup(SummerWatermelonThirtyOnePackageConfig curPackage)
		{
		}
		...
		public List<SummerWatermelonThirtyOnePackageFourReward> GetCurrentNewPackageRewards()
		{
			return null;
		}
		...
		public void AddNewGiftsRewards(SummerWatermelonThirtyOnePackageFourReward _reward)
		{
		}
