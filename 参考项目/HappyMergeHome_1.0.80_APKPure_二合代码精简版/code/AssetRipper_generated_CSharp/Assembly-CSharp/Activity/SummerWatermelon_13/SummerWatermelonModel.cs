...
namespace Activity.SummerWatermelon_13
{
	public class SummerWatermelonModel : ActivityEntityBase
	{
		...
		[NonSerialized]
		public Dictionary<int, SummerWatermelonThirteenProductConfig> _summerWatermelonProductConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonThirteenFirstTimeRewardConfig> _summerWatermelonFirstTimeRewardConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonThirteenMergeRewardConfig> _summerWatermelonMergeRewardConfig;
		...
		public List<SummerWatermelonThirteenPackageConfig> PackageConfig => null;

		public List<SummerWatermelonThirteenProductAttenuationConfig> ProductAttenuationConfig => null;

		public static SummerWatermelonModel Instance => null;

		public override string Guid => null;

		public StorageSummerWatermelonTwelve StorageSummerWatermelon => null;

		public SummerWatermelonThirteenConfig SummerWatermelonConfig => null;

		public Dictionary<int, SummerWatermelonThirteenProductConfig> SummerWatermelonProductConfig => null;

		public Dictionary<int, SummerWatermelonThirteenFirstTimeRewardConfig> SummerWatermelonFirstTimeRewardConfig => null;

		public Dictionary<int, SummerWatermelonThirteenMergeRewardConfig> SummerWatermelonMergeRewardConfig => null;
		...
		public static bool IsActivityStorageEnd(StorageSummerWatermelonTwelve storage)
		{
			return false;
		}

		public static void CompletedStorageActivity(StorageSummerWatermelonTwelve storage)
		{
		}
		...
		public BattlePassThirteen GetBattlePassConfig(int index)
		{
			return null;
		}
		...
		public BattlePassThirteen GetFrontRewardConfig(int score = -1)
		{
			return null;
		}
		...
		public BattlePassThirteen GetRewardConfig(int score, out bool isEnd)
		{
			isEnd = default(bool);
			return null;
		}

		public BattlePassThirteen GetNowRewardConfig()
		{
			return null;
		}
		...
		public SummerWatermelonThirteenPackageConfig GetCurrentPackage()
		{
			return null;
		}
		...
		public bool IsPackageOpened(SummerWatermelonThirteenPackageConfig config)
		{
			return false;
		}

		public ulong GetPackageLeftTime(SummerWatermelonThirteenPackageConfig curPackage)
		{
			return 0uL;
		}

		public string GetPackageLeftTimeText(SummerWatermelonThirteenPackageConfig curPackage)
		{
			return null;
		}
		...
		public List<SummerWatermelonThirteenPackageFourReward> GetCurrentNewPackageRewards()
		{
			return null;
		}
		...
		public void AddNewGiftsRewards(SummerWatermelonThirteenPackageFourReward rewardConfig)
		{
		}
		...
		public void OpenGiftPopup(SummerWatermelonThirteenPackageConfig curPackage)
		{
		}
