...
namespace Activity.SummerWatermelon_7
{
	public class SummerWatermelonModel : ActivityEntityBase
	{
		...
		[CompilerGenerated]
		public struct _003COnNewItem_003Ed__95 : IAsyncStateMachine
		{
			...
			[NonSerialized]
			public _003C_003Ec__DisplayClass95_0 _003C_003E8__1;
		...
		[NonSerialized]
		public Dictionary<int, SummerWatermelonSevenProductConfig> _summerWatermelonProductConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonSevenFirstTimeRewardConfig> _summerWatermelonFirstTimeRewardConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonSevenMergeRewardConfig> _summerWatermelonMergeRewardConfig;
		...
		public List<SummerWatermelonSevenPackageConfig> PackageConfig => null;

		public List<SummerWatermelonSevenProductAttenuationConfig> ProductAttenuationConfig => null;
		...
		public SummerWatermelonSevenConfig SummerWatermelonConfig => null;

		public Dictionary<int, SummerWatermelonSevenProductConfig> SummerWatermelonProductConfig => null;

		public Dictionary<int, SummerWatermelonSevenFirstTimeRewardConfig> SummerWatermelonFirstTimeRewardConfig => null;

		public Dictionary<int, SummerWatermelonSevenMergeRewardConfig> SummerWatermelonMergeRewardConfig => null;
		...
		[AsyncStateMachine(typeof(_003COnNewItem_003Ed__95))]
		...
		public SummerWatermelonSevenPackageConfig GetCurrentPackage()
		{
			return null;
		}
		...
		public bool IsPackageOpened(SummerWatermelonSevenPackageConfig config)
		{
			return false;
		}

		public ulong GetPackageLeftTime(SummerWatermelonSevenPackageConfig curPackage)
		{
			return 0uL;
		}

		public string GetPackageLeftTimeText(SummerWatermelonSevenPackageConfig curPackage)
		{
			return null;
		}
		...
		public void OpenGiftPopup(SummerWatermelonSevenPackageConfig curPackage)
		{
		}
