...
namespace Activity.SummerWatermelon_14
{
	public class SummerWatermelonModel : ActivityEntityBase
	{
		...
		[NonSerialized]
		public Dictionary<int, SummerWatermelonFourteenProductConfig> _summerWatermelonProductConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonFourteenFirstTimeRewardConfig> _summerWatermelonFirstTimeRewardConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonFourteenMergeRewardConfig> _summerWatermelonMergeRewardConfig;
		...
		public List<SummerWatermelonFourteenPackageConfig> PackageConfig => null;

		public List<SummerWatermelonFourteenProductAttenuationConfig> ProductAttenuationConfig => null;
		...
		public SummerWatermelonFourteenConfig SummerWatermelonConfig => null;

		public Dictionary<int, SummerWatermelonFourteenProductConfig> SummerWatermelonProductConfig => null;

		public Dictionary<int, SummerWatermelonFourteenFirstTimeRewardConfig> SummerWatermelonFirstTimeRewardConfig => null;

		public Dictionary<int, SummerWatermelonFourteenMergeRewardConfig> SummerWatermelonMergeRewardConfig => null;
		...
		public BattlePassFourteen GetBattlePassConfig(int index)
		{
			return null;
		}
		...
		public BattlePassFourteen GetFrontRewardConfig(int score = -1)
		{
			return null;
		}
		...
		public BattlePassFourteen GetRewardConfig(int score, out bool isEnd)
		{
			isEnd = default(bool);
			return null;
		}

		public BattlePassFourteen GetNowRewardConfig()
		{
			return null;
		}
		...
		public SummerWatermelonFourteenPackageConfig GetCurrentPackage()
		{
			return null;
		}
		...
		public bool IsPackageOpened(SummerWatermelonFourteenPackageConfig config)
		{
			return false;
		}

		public ulong GetPackageLeftTime(SummerWatermelonFourteenPackageConfig curPackage)
		{
			return 0uL;
		}

		public string GetPackageLeftTimeText(SummerWatermelonFourteenPackageConfig curPackage)
		{
			return null;
		}
		...
		public void OpenGiftPopup(SummerWatermelonFourteenPackageConfig curPackage)
		{
		}
