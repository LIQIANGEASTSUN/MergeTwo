...
namespace Activity.LuckyGoldenPearls
{
	public class LuckyGoldenPearlsModel : ActivityEntityBase, I_ActivityStatus
	{
		public static LuckyGoldenPearlsModel _instance;
		...
		public static LuckyGoldenPearlsModel Instance => null;

		public override string Guid => null;

		public StorageLuckyGoldenEgg LuckyGoldenPearls => null;
		...
		public void BreakItem(int index, LuckyGoldenPearlsLevelConfig levelConfig)
		{
		}
