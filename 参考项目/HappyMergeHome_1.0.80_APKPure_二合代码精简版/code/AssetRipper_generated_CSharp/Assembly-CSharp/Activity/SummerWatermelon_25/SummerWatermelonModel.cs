...
namespace Activity.SummerWatermelon_25
{
	public class SummerWatermelonModel : ActivityEntityBase
	{
		...
		[NonSerialized]
		public Dictionary<int, SummerWatermelonTwentyFiveProductConfig> _summerWatermelonProductConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonTwentyFiveFirstTimeRewardConfig> _summerWatermelonFirstTimeRewardConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonTwentyFiveMergeRewardConfig> _summerWatermelonMergeRewardConfig;
		...
		public List<SummerWatermelonTwentyFivePackageConfig> PackageConfig => null;

		public List<SummerWatermelonTwentyFiveProductAttenuationConfig> ProductAttenuationConfig => null;
		...
		public SummerWatermelonTwentyFiveConfig SummerWatermelonConfig => null;

		public Dictionary<int, SummerWatermelonTwentyFiveProductConfig> SummerWatermelonProductConfig => null;

		public Dictionary<int, SummerWatermelonTwentyFiveFirstTimeRewardConfig> SummerWatermelonFirstTimeRewardConfig => null;

		public Dictionary<int, SummerWatermelonTwentyFiveMergeRewardConfig> SummerWatermelonMergeRewardConfig => null;
		...
		public BattlePassTwentyFive GetBattlePassConfig(int index)
		{
			return null;
		}
		...
		public BattlePassTwentyFive GetFrontRewardConfig(int score = -1)
		{
			return null;
		}
		...
		public BattlePassTwentyFive GetRewardConfig(int score, out bool isEnd)
		{
			isEnd = default(bool);
			return null;
		}

		public BattlePassTwentyFive GetNowRewardConfig()
		{
			return null;
		}
		...
		public SummerWatermelonTwentyFivePackageConfig GetCurrentPackage()
		{
			return null;
		}
		...
		public bool IsPackageOpened(SummerWatermelonTwentyFivePackageConfig config)
		{
			return false;
		}

		public ulong GetPackageLeftTime(SummerWatermelonTwentyFivePackageConfig curPackage)
		{
			return 0uL;
		}

		public string GetPackageLeftTimeText(SummerWatermelonTwentyFivePackageConfig curPackage)
		{
			return null;
		}
		...
		public void OpenGiftPopup(SummerWatermelonTwentyFivePackageConfig curPackage)
		{
		}
		...
		public List<SummerWatermelonTwentyFivePackageFourReward> GetCurrentNewPackageRewards()
		{
			return null;
		}
		...
		public void AddNewGiftsRewards(SummerWatermelonTwentyFivePackageFourReward _reward)
		{
		}
