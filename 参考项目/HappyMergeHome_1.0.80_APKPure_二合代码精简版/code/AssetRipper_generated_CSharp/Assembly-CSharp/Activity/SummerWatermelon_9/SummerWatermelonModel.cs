...
namespace Activity.SummerWatermelon_9
{
	public class SummerWatermelonModel : ActivityEntityBase
	{
		...
		[NonSerialized]
		public Dictionary<int, SummerWatermelonNineProductConfig> _summerWatermelonProductConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonNineFirstTimeRewardConfig> _summerWatermelonFirstTimeRewardConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonNineMergeRewardConfig> _summerWatermelonMergeRewardConfig;
		...
		public List<SummerWatermelonNinePackageConfig> PackageConfig => null;

		public List<SummerWatermelonNineProductAttenuationConfig> ProductAttenuationConfig => null;
		...
		public SummerWatermelonNineConfig SummerWatermelonConfig => null;

		public Dictionary<int, SummerWatermelonNineProductConfig> SummerWatermelonProductConfig => null;

		public Dictionary<int, SummerWatermelonNineFirstTimeRewardConfig> SummerWatermelonFirstTimeRewardConfig => null;

		public Dictionary<int, SummerWatermelonNineMergeRewardConfig> SummerWatermelonMergeRewardConfig => null;
		...
		public SummerWatermelonNinePackageConfig GetCurrentPackage()
		{
			return null;
		}
		...
		public bool IsPackageOpened(SummerWatermelonNinePackageConfig config)
		{
			return false;
		}

		public ulong GetPackageLeftTime(SummerWatermelonNinePackageConfig curPackage)
		{
			return 0uL;
		}

		public string GetPackageLeftTimeText(SummerWatermelonNinePackageConfig curPackage)
		{
			return null;
		}
		...
		public void OpenGiftPopup(SummerWatermelonNinePackageConfig curPackage)
		{
		}
