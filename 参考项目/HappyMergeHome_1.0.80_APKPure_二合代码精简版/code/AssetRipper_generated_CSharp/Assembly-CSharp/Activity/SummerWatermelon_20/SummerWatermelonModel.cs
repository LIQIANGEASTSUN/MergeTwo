...
namespace Activity.SummerWatermelon_20
{
	public class SummerWatermelonModel : ActivityEntityBase
	{
		...
		[NonSerialized]
		public Dictionary<int, SummerWatermelonTwentyProductConfig> _summerWatermelonProductConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonTwentyFirstTimeRewardConfig> _summerWatermelonFirstTimeRewardConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonTwentyMergeRewardConfig> _summerWatermelonMergeRewardConfig;
		...
		public List<SummerWatermelonTwentyPackageConfig> PackageConfig => null;

		public List<SummerWatermelonTwentyProductAttenuationConfig> ProductAttenuationConfig => null;
		...
		public SummerWatermelonTwentyConfig SummerWatermelonConfig => null;

		public Dictionary<int, SummerWatermelonTwentyProductConfig> SummerWatermelonProductConfig => null;

		public Dictionary<int, SummerWatermelonTwentyFirstTimeRewardConfig> SummerWatermelonFirstTimeRewardConfig => null;

		public Dictionary<int, SummerWatermelonTwentyMergeRewardConfig> SummerWatermelonMergeRewardConfig => null;
		...
		public BattlePassTwenty GetBattlePassConfig(int index)
		{
			return null;
		}
		...
		public BattlePassTwenty GetFrontRewardConfig(int score = -1)
		{
			return null;
		}
		...
		public BattlePassTwenty GetRewardConfig(int score, out bool isEnd)
		{
			isEnd = default(bool);
			return null;
		}

		public BattlePassTwenty GetNowRewardConfig()
		{
			return null;
		}
		...
		public SummerWatermelonTwentyPackageConfig GetCurrentPackage()
		{
			return null;
		}
		...
		public bool IsPackageOpened(SummerWatermelonTwentyPackageConfig config)
		{
			return false;
		}

		public ulong GetPackageLeftTime(SummerWatermelonTwentyPackageConfig curPackage)
		{
			return 0uL;
		}

		public string GetPackageLeftTimeText(SummerWatermelonTwentyPackageConfig curPackage)
		{
			return null;
		}
		...
		public void OpenGiftPopup(SummerWatermelonTwentyPackageConfig curPackage)
		{
		}
		...
		public List<SummerWatermelonTwentyPackageFourReward> GetCurrentNewPackageRewards()
		{
			return null;
		}
		...
		public void AddNewGiftsRewards(SummerWatermelonTwentyPackageFourReward _reward)
		{
		}
