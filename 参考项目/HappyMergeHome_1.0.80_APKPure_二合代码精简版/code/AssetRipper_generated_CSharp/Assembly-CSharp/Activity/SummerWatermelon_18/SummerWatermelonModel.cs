...
namespace Activity.SummerWatermelon_18
{
	public class SummerWatermelonModel : ActivityEntityBase
	{
		...
		[NonSerialized]
		public Dictionary<int, SummerWatermelonEighTeenProductConfig> _summerWatermelonProductConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonEighTeenFirstTimeRewardConfig> _summerWatermelonFirstTimeRewardConfig;

		[NonSerialized]
		public Dictionary<int, SummerWatermelonEighTeenMergeRewardConfig> _summerWatermelonMergeRewardConfig;
		...
		public List<SummerWatermelonEighTeenPackageConfig> PackageConfig => null;

		public List<SummerWatermelonEighTeenProductAttenuationConfig> ProductAttenuationConfig => null;
		...
		public SummerWatermelonEighTeenConfig SummerWatermelonConfig => null;

		public Dictionary<int, SummerWatermelonEighTeenProductConfig> SummerWatermelonProductConfig => null;

		public Dictionary<int, SummerWatermelonEighTeenFirstTimeRewardConfig> SummerWatermelonFirstTimeRewardConfig => null;

		public Dictionary<int, SummerWatermelonEighTeenMergeRewardConfig> SummerWatermelonMergeRewardConfig => null;
		...
		public BattlePassEighTeen GetBattlePassConfig(int index)
		{
			return null;
		}
		...
		public BattlePassEighTeen GetFrontRewardConfig(int score = -1)
		{
			return null;
		}
		...
		public BattlePassEighTeen GetRewardConfig(int score, out bool isEnd)
		{
			isEnd = default(bool);
			return null;
		}

		public BattlePassEighTeen GetNowRewardConfig()
		{
			return null;
		}
		...
		public SummerWatermelonEighTeenPackageConfig GetCurrentPackage()
		{
			return null;
		}
		...
		public bool IsPackageOpened(SummerWatermelonEighTeenPackageConfig config)
		{
			return false;
		}

		public ulong GetPackageLeftTime(SummerWatermelonEighTeenPackageConfig curPackage)
		{
			return 0uL;
		}

		public string GetPackageLeftTimeText(SummerWatermelonEighTeenPackageConfig curPackage)
		{
			return null;
		}
		...
		public void OpenGiftPopup(SummerWatermelonEighTeenPackageConfig curPackage)
		{
		}
		...
		public List<SummerWatermelonEightTeenPackageFourReward> GetCurrentNewPackageRewards()
		{
			return null;
		}
		...
		public void AddNewGiftsRewards(SummerWatermelonEightTeenPackageFourReward _reward)
		{
		}
