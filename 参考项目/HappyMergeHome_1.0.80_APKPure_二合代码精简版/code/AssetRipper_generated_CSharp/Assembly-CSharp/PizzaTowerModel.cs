...
public class PizzaTowerModel : ActivityEntityBase
{
	[StructLayout((LayoutKind)3)]
	[CompilerGenerated]
	public struct _003CAddActivityScore_003Ed__51 : IAsyncStateMachine
	{
		...
		public PizzaTowerModel _003C_003E4__this;
	...
	[StructLayout((LayoutKind)3)]
	[CompilerGenerated]
	public struct _003CAddScore_003Ed__36 : IAsyncStateMachine
	{
		public int _003C_003E1__state;
	...
	public static PizzaTowerModel _instance;
	...
	[NonSerialized]
	public Dictionary<int, PizzaTowerProductConfig> _PizzaTowerProductConfig;
	...
	public Dictionary<int, PizzaTowerConfig> PizzaTowerDictionary;
	...
	public static PizzaTowerModel Instance => null;
	...
	public Dictionary<int, PizzaTowerProductConfig> PizzaTowerProductConfig => null;

	public List<PizzaTowerConfig> PizzaTowerList => null;

	public List<PizzaTowerProductConfig> PizzaTowerProductList => null;

	public PizzaTowerGlobalConfig GlobalConfig => null;

	public List<PizzaTowerLeaderBoardRewardConfig> LeaderBoardRewardConfig => null;

	public static StoragePizzaTower StoragePizzaTower => null;

	public StoragePizzaTower CurStoragePizzaTowerWeek => null;
	...
	public void RebuildScoreState(int totalScore, int curScore)
	{
	}
	...
	public static bool IsPizzaTowerStorageEnd(StoragePizzaTower storagePizzaTower)
	{
		return false;
	}
	...
	[AsyncStateMachine(typeof(_003CAddScore_003Ed__36))]
	...
	public void RemoveAllPizzaTowerBanana()
	{
	}
	...
	public void MergeToProductPizzaTower(TableMergeItem tableMergeItem, Vector3 srcPos)
	{
	}
	...
	[AsyncStateMachine(typeof(_003CAddActivityScore_003Ed__51))]
	[IDTag(1)]
	...
	public static StoragePizzaTower GetFirstWeekCanGetReward()
	{
		return null;
	}
