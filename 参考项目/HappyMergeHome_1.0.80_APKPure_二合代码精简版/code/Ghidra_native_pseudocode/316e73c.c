...

{
  ...
  pcVar4 = (char *)(_UNK_0317e7e8 + 0x317e74c);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0317e7ec + 0x317e760));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7b92,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7b92,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0317e7f0 + 0x317e7b4) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_031783f4();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
