...
/* WARNING: Possible PIC construction at 0x02fd3ab0: Changing call to branch */
/* WARNING: Possible PIC construction at 0x02fd3ad8: Changing call to branch */
/* WARNING: Possible PIC construction at 0x02fd3b00: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x02fd3adc) */
/* WARNING: Removing unreachable block (ram,0x02fd3af0) */
/* WARNING: Removing unreachable block (ram,0x02fd3af4) */
/* WARNING: Removing unreachable block (ram,0x02fd3ab4) */
/* WARNING: Removing unreachable block (ram,0x02fd3ac8) */
/* WARNING: Removing unreachable block (ram,0x02fd3acc) */
/* WARNING: Removing unreachable block (ram,0x02fd3b04) */
/* WARNING: Removing unreachable block (ram,0x02fd3b18) */
/* WARNING: Removing unreachable block (ram,0x02fd3b1c) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_02fd3930(int param_1)

{
  ...
  pcVar11 = (char *)(_UNK_02fd3b30 + 0x2fd3944);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fd3b34 + 0x2fd3958));
    func_0x01438628(*(undefined4 *)(_UNK_02fd3b38 + 0x2fd3964));
    func_0x01438628(*(undefined4 *)(_UNK_02fd3b3c + 0x2fd3970));
    func_0x01438628(*(undefined4 *)(_UNK_02fd3b40 + 0x2fd397c));
    func_0x01438628(*(undefined4 *)(_UNK_02fd3b44 + 0x2fd3988));
    func_0x01438628(*(undefined4 *)(_UNK_02fd3b48 + 0x2fd3994));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x710b,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x710b,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02fd3b4c + 0x2fd39f8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02fd3b50 + 0x2fd3a14));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = func_0x036c7bec(iVar3,**(undefined4 **)(_UNK_02fd3b54 + 0x2fd3a34));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar3 + 0x38c) != 0) {
    func_0x03b73ab8(*(int *)(iVar3 + 0x38c),**(undefined4 **)(_UNK_02fd3b58 + 0x2fd3a64));
  }
  if (*(int *)(**(int **)(_UNK_02fd3b5c + 0x2fd3a74) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar12 = *(undefined4 **)(_UNK_02fd3b60 + 0x2fd3a90);
  ...
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x46,0);
  ...
  if (iVar3 != 0) {
    ...
    puStack_30 = puVar4;
    puStack_2c = puVar12;
    func_0x024f56c0(&uStack_60,0,0x46,0);
    ...
    func_0x01523a2c(&puStack_48,0x46,0);
    iVar10 = *(int *)(iVar3 + 8);
    uVar13 = *(undefined4 *)(iVar3 + 0xc);
    iVar3 = *(int *)(iVar3 + 0x10);
    if (iVar10 == 0) {
  ...
  iVar10 = func_0x046ccb14(iVar3,0x46,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar10 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar1 = (*(code *)*puVar4)(piVar9,0x46,puVar4[1]);
      iVar3 = iStack_40;
    }
    iVar10 = *(int *)(iVar3 + 8);
    iVar3 = iVar10;
