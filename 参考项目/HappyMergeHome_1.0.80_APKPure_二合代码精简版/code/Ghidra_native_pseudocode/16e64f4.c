...
undefined4 FUN_016f64f4(undefined4 param_1,int param_2)
  ...
  if (iVar1 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      *piVar14 = iVar3;
      ...
      iVar3 = FUN_016f0010(param_1);
      uVar2 = *(undefined4 *)(param_2 + 8);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      func_0x024f064c(iVar3,uVar2,&iStack_28,**(undefined4 **)(_UNK_016f6d30 + 0x16f67e0));
      iVar3 = iStack_28;
      if (iStack_28 == 0) {
        func_0x014388e4();
      }
      ...
      iVar3 = func_0x014388d4(**(undefined4 **)(_UNK_016f6d40 + 0x16f6964));
      func_0x024f1124(iVar3,**(undefined4 **)(_UNK_016f6d44 + 0x16f6978));
      ...
      *piVar7 = iVar3;
      ...
      if (0 < *(int *)(iVar3 + 0xc)) {
        ...
        iVar3 = FUN_016edd54();
        if (iVar3 != 0) {
          func_0x01708f54(iVar3,0);
        }
        if (*(int *)(**(int **)(_UNK_016f6d4c + 0x16f69ec) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_016f6d50 + 0x16f6a0c));
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        ...
        iVar3 = func_0x014e96a8(**(undefined4 **)(_UNK_016f6d60 + 0x16f6bc4));
        iVar9 = *piVar14;
        if (*(int *)(**(int **)(_UNK_016f6d64 + 0x16f6bd8) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar10 = func_0x014e9518(**(undefined4 **)(_UNK_016f6d68 + 0x16f6bf8));
        if (iVar10 == 0) {
          func_0x014388e4();
        }
