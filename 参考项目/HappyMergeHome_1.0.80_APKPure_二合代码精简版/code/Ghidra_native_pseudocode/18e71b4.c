...
void FUN_018f71b4(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar8 = (char *)(_UNK_018f7278 + 0x18f71cc);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018f727c + 0x18f71e0));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x965e,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x965e,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x01904824(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_018f7280 + 0x18f7250) + 0x74) == 0) {
    func_0x014387a4();
  }
