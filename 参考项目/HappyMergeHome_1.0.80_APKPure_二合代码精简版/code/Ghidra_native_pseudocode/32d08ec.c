...
void FUN_032e08ec(int param_1,undefined4 param_2,int param_3)

{
  ...
  iVar3 = func_0x02953fd4(0x83d3,0);
  if (iVar3 == 0) {
    iVar3 = FUN_032d4694(param_1);
    if (((iVar3 != 0) && (iVar3 = FUN_032e04a8(param_1,param_2,param_3), iVar3 == 0)) &&
       (iVar3 = FUN_032e0578(param_1,param_2), iVar3 != 0)) {
      if (param_3 == 0) {
      ...
      iVar3 = func_0x02953fd4(0x1ee7,0);
      if (iVar3 != 0) {
        iVar3 = func_0x029540a4(0x1ee7,0);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
...
LAB_032e02f8:
            ...
            if (*(char *)(iVar2 + 0xd) == '\0') goto LAB_032e02f8;
            iVar2 = FUN_032d4694(param_1);
            if (iVar2 == 0) {
              func_0x014388e4();
            }
    ...
    iVar3 = func_0x029540a4(0x83d3,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
