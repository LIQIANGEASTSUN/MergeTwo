...
void FUN_01724ae0(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_01724c9c + 0x1724af8);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01724ca0 + 0x1724b0c));
    func_0x01438628(*(undefined4 *)(_UNK_01724ca4 + 0x1724b18));
    func_0x01438628(*(undefined4 *)(_UNK_01724ca8 + 0x1724b24));
    func_0x01438628(*(undefined4 *)(_UNK_01724cac + 0x1724b30));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x2c9a,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x2c9a,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar2 = func_0x024f0540(iVar2,param_2,**(undefined4 **)(_UNK_01724cb0 + 0x1724bc8));
  ...
  if (iVar5 == 0) {
    func_0x014388e4();
    if (iVar2 == 0) goto LAB_01724c7c;
    iVar2 = func_0x024f05d4(0,param_2,**(undefined4 **)(_UNK_01724cb4 + 0x1724c4c));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_01724c7c:
      iVar2 = **(int **)(_UNK_01724cc0 + 0x1724c90);
      iStack_18 = unaff_r4;
      if (iVar5 == 0) {
        func_0x024f83d4();
      }
    ...
    iVar2 = func_0x024f05d4(iVar5,param_2,**(undefined4 **)(_UNK_01724cb8 + 0x1724c20));
  }
  unaff_r7 = iVar2 + 1;
  unaff_r5 = **(int **)(_UNK_01724cbc + 0x1724c70);
  iStack_1c = unaff_r7;
  if (iVar5 == 0) {
    func_0x024f83d4();
  }
