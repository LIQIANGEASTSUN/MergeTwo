...
undefined4 FUN_01810780(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar5 = (char *)(_UNK_018108bc + 0x1810798);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018108c0 + 0x18107ac));
    func_0x01438628(*(undefined4 *)(_UNK_018108c4 + 0x18107b8));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x90f5,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x90f5,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_018108c8 + 0x1810850));
  if (iVar1 != 0) {
    iVar1 = FUN_018013d8(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_018108cc + 0x18108a8);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
