...
undefined4 FUN_0323dd74(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_0323de60 + 0x323dd88);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0323de64 + 0x323dd9c));
    func_0x01438628(*(undefined4 *)(_UNK_0323de68 + 0x323dda8));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7fda,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7fda,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0323de6c + 0x323de00) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_0323de70 + 0x323de1c));
  iVar5 = FUN_0323cde4(param_1);
  if (iVar5 == 0) {
    func_0x014388e4();
  }
