...
void FUN_016c2710(int param_1,undefined4 param_2,int param_3)

{
  ...
  iVar3 = func_0x02953fd4(0x893b,0);
  if (iVar3 == 0) {
    iVar3 = func_0x016b6be8(param_1);
    if (((iVar3 != 0) && (iVar3 = FUN_016c22cc(param_1,param_2,param_3), iVar3 == 0)) &&
       (iVar3 = FUN_016c239c(param_1,param_2), iVar3 != 0)) {
      if (param_3 == 0) {
...
LAB_016c211c:
    ...
    iVar3 = func_0x029540a4(0x893b,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
