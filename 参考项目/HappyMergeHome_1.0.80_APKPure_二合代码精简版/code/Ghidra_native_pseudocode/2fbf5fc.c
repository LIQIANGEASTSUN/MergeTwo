...
uint FUN_02fcf5fc(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_02fcf6e4 + 0x2fcf61c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fcf6e8 + 0x2fcf630));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x70f9,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x70f9,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_02fcf6ec + 0x2fcf6ac) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_02fc8d20();
  if (iVar2 == 0) {
