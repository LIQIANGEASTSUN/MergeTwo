...
undefined4 FUN_03316478(undefined4 param_1,int param_2)
  ...
  if (iVar1 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      *piVar14 = iVar3;
      ...
      iVar3 = FUN_0330fb18(param_1);
      uVar2 = *(undefined4 *)(param_2 + 8);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      func_0x046ce3e4(iVar3,uVar2,&iStack_28,**(undefined4 **)(_UNK_03316cac + 0x3316764));
      iVar3 = iStack_28;
      if (iStack_28 == 0) {
        func_0x014388e4();
      }
      ...
      iVar3 = func_0x014388d4(**(undefined4 **)(_UNK_03316cbc + 0x33168e8));
      func_0x03bbd054(iVar3,**(undefined4 **)(_UNK_03316cc0 + 0x33168fc));
      ...
      *piVar7 = iVar3;
      ...
      if (0 < *(int *)(iVar3 + 0xc)) {
        ...
        iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03316ccc + 0x3316988));
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        ...
        iVar3 = func_0x03b2c734(**(undefined4 **)(_UNK_03316cdc + 0x3316b40));
        iVar9 = *piVar14;
        if (*(int *)(**(int **)(_UNK_03316ce0 + 0x3316b54) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar10 = func_0x04e4a028(**(undefined4 **)(_UNK_03316ce4 + 0x3316b74));
        if (iVar10 == 0) {
          func_0x014388e4();
        }
