...
uint FUN_03274b3c(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_03274c24 + 0x3274b5c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03274c28 + 0x3274b70));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8143,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8143,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_03274c2c + 0x3274bec) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_03271308();
  if (iVar1 == 0) {
  ...
  pcVar11 = (char *)(_UNK_03274d50 + 0x3274c48);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03274d54 + 0x3274c5c));
    func_0x01438628(*(undefined4 *)(_UNK_03274d58 + 0x3274c68));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x8144,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_03274d5c + 0x3274cc4) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03274d60 + 0x3274ce0));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_0327db70 + 0x327d93c);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_0327db74 + 0x327d950));
      func_0x01438628(*(undefined4 *)(_UNK_0327db78 + 0x327d95c));
      func_0x01438628(*(undefined4 *)(_UNK_0327db7c + 0x327d968));
      func_0x01438628(*(undefined4 *)(_UNK_0327db80 + 0x327d974));
      func_0x01438628(*(undefined4 *)(_UNK_0327db84 + 0x327d980));
      func_0x01438628(*(undefined4 *)(_UNK_0327db88 + 0x327d98c));
      func_0x01438628(*(undefined4 *)(_UNK_0327db8c + 0x327d998));
      *pcVar11 = '\x01';
    }
    iVar3 = func_0x02953fd4(0x812c,0);
    if (iVar3 == 0) {
      iVar3 = func_0x032777e8(iVar1);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x046c26fc(iVar3,param_3,**(undefined4 **)(_UNK_0327db90 + 0x327da14));
      if (iVar3 == 0) {
        uVar10 = func_0x0515c4b0(&uStack_1c,0);
        uVar10 = func_0x04f6b198(**(undefined4 **)(_UNK_0327db94 + 0x327da78),uVar10,
                                 **(undefined4 **)(_UNK_0327db98 + 0x327da84),0);
        if (*(int *)(**(int **)(_UNK_0327db9c + 0x327da98) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar3 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_3,**(undefined4 **)(_UNK_0327dba4 + 0x327dacc));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar3,param_3,**(undefined4 **)(_UNK_0327dba0 + 0x327da48));
        }
        func_0x03b70fe4(iVar3,param_3,iVar9 + -1,**(undefined4 **)(_UNK_0327dba8 + 0x327daf0));
        iVar3 = func_0x032777e8(iVar1);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x03b70fac(iVar3,param_3,**(undefined4 **)(_UNK_0327dbac + 0x327db20));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x032777e8(iVar1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar3 = **(int **)(_UNK_0327dbb0 + 0x327db60);
...
LAB_046c3e4c:
    ...
    iVar3 = func_0x029540a4(0x812c,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar3 = func_0x029540a4(0x8144,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
