...
int FUN_016444cc(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_01644598 + 0x16444e0);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0164459c + 0x16444f4));
    func_0x01438628(*(undefined4 *)(_UNK_016445a0 + 0x1644500));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x861a,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x861a,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_016445a4 + 0x1644558) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_016445a8 + 0x1644574));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
