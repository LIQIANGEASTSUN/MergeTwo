...
uint FUN_02f44614(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_02f446fc + 0x2f44634);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f44700 + 0x2f44648));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x6df7,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x6df7,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_02f44704 + 0x2f446c4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_02f3dd38();
  if (iVar2 == 0) {
  ...
  pcVar11 = (char *)(_UNK_02f42edc + 0x2f42dd4);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f42ee0 + 0x2f42de8));
    func_0x01438628(*(undefined4 *)(_UNK_02f42ee4 + 0x2f42df4));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x6deb,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_02f42ee8 + 0x2f42e50) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_02f42eec + 0x2f42e6c));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_02f4c878 + 0x2f4c644);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_02f4c87c + 0x2f4c658));
      func_0x01438628(*(undefined4 *)(_UNK_02f4c880 + 0x2f4c664));
      func_0x01438628(*(undefined4 *)(_UNK_02f4c884 + 0x2f4c670));
      func_0x01438628(*(undefined4 *)(_UNK_02f4c888 + 0x2f4c67c));
      func_0x01438628(*(undefined4 *)(_UNK_02f4c88c + 0x2f4c688));
      func_0x01438628(*(undefined4 *)(_UNK_02f4c890 + 0x2f4c694));
      func_0x01438628(*(undefined4 *)(_UNK_02f4c894 + 0x2f4c6a0));
      *pcVar11 = '\x01';
    }
    iVar1 = func_0x02953fd4(0x6dcb,0);
    if (iVar1 == 0) {
      iVar1 = func_0x02f46870(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x046c26fc(iVar1,param_3,**(undefined4 **)(_UNK_02f4c898 + 0x2f4c71c));
      if (iVar1 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x024eee28(**(undefined4 **)(_UNK_02f4c89c + 0x2f4c780),uVar10,
                                 **(undefined4 **)(_UNK_02f4c8a0 + 0x2f4c78c),0);
        if (*(int *)(**(int **)(_UNK_02f4c8a4 + 0x2f4c7a0) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_3,**(undefined4 **)(_UNK_02f4c8ac + 0x2f4c7d4));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_02f4c8a8 + 0x2f4c750));
        }
        func_0x03b70fe4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_02f4c8b0 + 0x2f4c7f8));
        iVar1 = func_0x02f46870(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_02f4c8b4 + 0x2f4c828));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x02f46870(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_02f4c8b8 + 0x2f4c868);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x6dcb,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x6deb,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
