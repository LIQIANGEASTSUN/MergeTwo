...
uint FUN_0307dd10(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_0307ddf8 + 0x307dd30);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0307ddfc + 0x307dd44));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7589,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7589,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0307de00 + 0x307ddc0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_03078444();
  if (iVar2 == 0) {
