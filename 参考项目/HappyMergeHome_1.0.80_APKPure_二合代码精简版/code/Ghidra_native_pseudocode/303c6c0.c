...
int FUN_0304c6c0(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_0304c9b8 + 0x304c6d4);
  if (*pcVar6 == '\0') {
  ...
  if (0 < *(int *)(iVar1 + 0x74)) {
    ...
    if (iVar5 <= *(int *)(iVar1 + 0xc)) {
      ...
      uVar7 = func_0x04cd26d0(iVar5,iVar1 + -1,**(undefined4 **)(_UNK_0304c9e0 + 0x304c860));
    }
  }
  ...
  if (iVar1 == 0) {
    ...
    if (iVar5 != 0) {
      ...
      pcVar6 = (char *)(_UNK_0306fffc + 0x306fca0);
      if (*pcVar6 == '\0') {
        func_0x01438628(*(undefined4 *)(_UNK_03070000 + 0x306fcb4),uVar7,iVar1,0);
      ...
      if (iVar2 == 0) {
        ...
        *(undefined1 *)(iVar5 + 0xb0) = 1;
        ...
        iVar1 = func_0x046ccb14(iVar1,uVar7,**(undefined4 **)(_UNK_0307003c + 0x306fe1c));
        if (iVar1 == 0) {
          uStack_1c = uVar7;
          uVar7 = func_0x014387ac(**(undefined4 **)(_UNK_03070040 + 0x306fec4),&uStack_1c);
          ...
          uVar4 = func_0x046cc810(iVar1,uVar7,**(undefined4 **)(_UNK_0307004c + 0x306fe4c));
          ...
          if (iVar1 == 0) {
            ...
            uVar7 = func_0x014388d4(**(undefined4 **)(_UNK_03070060 + 0x306ff60));
            func_0x0152e3ec(uVar7,iVar2,**(undefined4 **)(_UNK_03070064 + 0x306ff84),0);
            ...
            iVar5 = func_0x02aee9b4(uVar4,**(undefined4 **)(_UNK_03070070 + 0x306ffc4),
                                    **(undefined4 **)(_UNK_0307006c + 0x306ffb8),uVar7);
            if (iVar1 == 0) {
              func_0x014388e4();
            }
          ...
          uStack_20 = uVar7;
          uVar7 = func_0x014387ac(**(undefined4 **)(_UNK_03070054 + 0x306fe9c),&uStack_20);
