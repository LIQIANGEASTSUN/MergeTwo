...
undefined4 FUN_0320b514(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_0320b600 + 0x320b528);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0320b604 + 0x320b53c));
    func_0x01438628(*(undefined4 *)(_UNK_0320b608 + 0x320b548));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7e83,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7e83,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0320b60c + 0x320b5a0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_0320b610 + 0x320b5bc));
  iVar5 = FUN_0320a60c(param_1);
  if (iVar5 == 0) {
    func_0x014388e4();
  }
