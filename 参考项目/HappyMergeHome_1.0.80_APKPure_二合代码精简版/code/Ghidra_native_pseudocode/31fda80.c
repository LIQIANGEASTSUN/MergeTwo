...

{
  ...
  pcVar11 = (char *)(_UNK_0320dc08 + 0x320da94);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0320dc0c + 0x320daa8));
    func_0x01438628(*(undefined4 *)(_UNK_0320dc10 + 0x320dab4));
    func_0x01438628(*(undefined4 *)(_UNK_0320dc14 + 0x320dac0));
    func_0x01438628(*(undefined4 *)(_UNK_0320dc18 + 0x320dacc));
    func_0x01438628(*(undefined4 *)(_UNK_0320dc1c + 0x320dad8));
    func_0x01438628(*(undefined4 *)(_UNK_0320dc20 + 0x320dae4));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7e8c,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x7e8c,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0320dc24 + 0x320db48) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_0320dc28 + 0x320db64));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = func_0x036c7bec(iVar3,**(undefined4 **)(_UNK_0320dc2c + 0x320db84));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar3 + 0x2b8) != 0) {
    func_0x03b73ab8(*(int *)(iVar3 + 0x2b8),**(undefined4 **)(_UNK_0320dc30 + 0x320dbb4));
  }
  if (*(int *)(**(int **)(_UNK_0320dc34 + 0x320dbc4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_0320dc38 + 0x320dbe0));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  pcVar11 = (char *)(_UNK_02be82b0 + 0x2be8170);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x1b,0);
  ...
  if (iVar9 != 0) {
    ...
    uStack_38 = 0;
    uStack_28 = 0;
    func_0x024f56c0(&uStack_50,0,0x1b,0);
    uStack_38 = uStack_50;
    iStack_34 = uStack_4c;
    uStack_30 = uStack_48;
    uStack_2c = iStack_44;
    ...
    func_0x01523a2c(&uStack_38,0x1b,0);
    iVar10 = *(int *)(iVar9 + 8);
  ...
  iVar3 = func_0x046ccb14(uVar2,0x1b,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar3 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar1 = (*(code *)*puVar4)(piVar8,0x1b,puVar4[1]);
      uVar2 = uStack_30;
    }
    iVar9 = *(int *)(uVar2 + 8);
    iVar3 = iVar9;
