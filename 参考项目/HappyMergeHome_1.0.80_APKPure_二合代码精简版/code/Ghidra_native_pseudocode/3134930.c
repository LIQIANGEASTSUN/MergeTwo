...
void FUN_03144930(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  pcVar4 = (char *)(_UNK_03144a1c + 0x3144950);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03144a20 + 0x3144970));
    *pcVar4 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7a09,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7a09,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iStack_34 = param_5;
  ...
  if (*(int *)(**(int **)(_UNK_03144a24 + 0x31449e0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_0313e53c();
  if (iVar2 == 0) {
  ...
  uStack_2c = uStack_3c;
  iStack_28 = iStack_44;
  iVar1 = func_0x02953fd4(0x79d4,0);
  if (iVar1 == 0) {
    ...
    *puVar3 = uStack_58;
    ...
    iVar1 = func_0x029540a4(0x79d4,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
