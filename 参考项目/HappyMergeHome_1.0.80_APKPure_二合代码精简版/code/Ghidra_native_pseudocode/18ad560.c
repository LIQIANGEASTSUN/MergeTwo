...

{
  ...
  pcVar7 = (char *)(_UNK_018bd6c0 + 0x18bd574);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018bd6c4 + 0x18bd588));
    func_0x01438628(*(undefined4 *)(_UNK_018bd6c8 + 0x18bd594));
    func_0x01438628(*(undefined4 *)(_UNK_018bd6cc + 0x18bd5a0));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x2ab6,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x2ab6,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_018bd6d0 + 0x18bd5f8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018bd6d4 + 0x18bd614));
  uVar10 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar9 = **(int **)(_UNK_018bd6d8 + 0x18bd640);
