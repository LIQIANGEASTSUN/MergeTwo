...
int FUN_01aec2e4(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_01aec438 + 0x1aec2f8);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01aec43c + 0x1aec30c));
    func_0x01438628(*(undefined4 *)(_UNK_01aec440 + 0x1aec318));
    func_0x01438628(*(undefined4 *)(_UNK_01aec444 + 0x1aec324));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xa4b5,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xa4b5,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01aec448 + 0x1aec37c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01aec44c + 0x1aec398));
  uVar10 = FUN_01aebbbc(param_1);
  iVar9 = **(int **)(_UNK_01aec450 + 0x1aec3b8);
