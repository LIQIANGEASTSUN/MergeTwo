...
int FUN_017ad654(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_017ad774 + 0x17ad668);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017ad778 + 0x17ad67c));
    func_0x01438628(*(undefined4 *)(_UNK_017ad77c + 0x17ad688));
    func_0x01438628(*(undefined4 *)(_UNK_017ad780 + 0x17ad694));
    func_0x01438628(*(undefined4 *)(_UNK_017ad784 + 0x17ad6a0));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x1e97,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x1e97,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_017ad788 + 0x17ad6f8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_017ad78c + 0x17ad714));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  ...
  iVar2 = func_0x0152983c(iVar2,*(int *)(iVar2 + 0xc) + -1,
                          **(undefined4 **)(_UNK_017ad790 + 0x17ad744));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  iVar2 = *(int *)(iVar2 + 0x1c);
  pcVar7 = (char *)(_UNK_017ac6e4 + 0x17ac2e8);
  iStack_24 = unaff_r4;
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017ac6e8 + 0x17ac2fc));
    func_0x01438628(*(undefined4 *)(_UNK_017ac6ec + 0x17ac308));
    func_0x01438628(*(undefined4 *)(_UNK_017ac6f0 + 0x17ac314));
    func_0x01438628(*(undefined4 *)(_UNK_017ac6f4 + 0x17ac320));
    func_0x01438628(*(undefined4 *)(_UNK_017ac6f8 + 0x17ac32c));
    func_0x01438628(*(undefined4 *)(_UNK_017ac6fc + 0x17ac338));
    func_0x01438628(*(undefined4 *)(_UNK_017ac700 + 0x17ac344));
    func_0x01438628(*(undefined4 *)(_UNK_017ac704 + 0x17ac350));
    func_0x01438628(*(undefined4 *)(_UNK_017ac708 + 0x17ac35c));
    func_0x01438628(*(undefined4 *)(_UNK_017ac70c + 0x17ac368));
    *pcVar7 = '\x01';
  }
  iVar8 = func_0x02953fd4(0x1e98,0);
  if (iVar8 == 0) {
    iVar8 = FUN_017a2fe8(param_1);
    if (iVar8 == 0) {
      func_0x014388e4();
    }
    ...
    puVar11 = *(undefined4 **)(_UNK_017ac710 + 0x17ac408);
    iVar8 = func_0x024f0f34(iVar8,iVar2,*puVar11);
    if (iVar8 == 0) {
      if (*(int *)(**(int **)(_UNK_017ac714 + 0x17ac428) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar8 = func_0x014e9518(**(undefined4 **)(_UNK_017ac718 + 0x17ac444));
      if (iVar8 == 0) {
        func_0x014388e4();
      }
      iVar8 = *(int *)(iVar8 + 0x30);
      iVar9 = 0;
      puVar12 = *(undefined4 **)(_UNK_017ac71c + 0x17ac46c);
      while( true ) {
        if (iVar8 == 0) {
          func_0x014388e4();
        }
          ...
          while( true ) {
            ...
            if (*(int *)(iVar1 + 0x1c) <= iVar2) {
              ...
              if (iVar1 == 0) {
                ...
                func_0x024f05ac(iVar1,uVar10,**(undefined4 **)(_UNK_017ac720 + 0x17ac5e4));
              }
            }
            iVar9 = iVar9 + 1;
          }
          func_0x017adebc(param_1);
          if (*(int *)(**(int **)(_UNK_017ac724 + 0x17ac608) + 0x74) == 0) {
            func_0x014387a4();
          }
          iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_017ac728 + 0x17ac624));
          piVar6 = *(int **)(_UNK_017ac72c + 0x17ac638);
          iVar8 = *piVar6;
          if (*(int *)(iVar8 + 0x74) == 0) {
            func_0x014387a4();
            iVar8 = *piVar6;
          }
          iVar1 = **(int **)(_UNK_017ac730 + 0x17ac658);
  ...
  iVar8 = func_0x029540a4(0x1e98,0);
  if (iVar8 == 0) {
    func_0x014388e4();
  }
  puStack_20 = (undefined4 *)iStack_24;
