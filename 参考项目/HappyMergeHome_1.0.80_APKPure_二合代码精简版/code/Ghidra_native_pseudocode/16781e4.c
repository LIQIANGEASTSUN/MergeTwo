...
undefined4 FUN_016881e4(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_016882c0 + 0x16881f8);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016882c4 + 0x168820c));
    func_0x01438628(*(undefined4 *)(_UNK_016882c8 + 0x1688218));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x87b1,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_016882cc + 0x1688270) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_016882d0 + 0x168828c));
    uVar7 = func_0x016882d4(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x029540a4(0x87b1,0);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
