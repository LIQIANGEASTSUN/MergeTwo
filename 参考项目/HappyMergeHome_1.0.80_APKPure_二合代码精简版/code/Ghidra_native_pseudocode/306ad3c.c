...
int FUN_0307ad3c(undefined4 param_1)

{
  ...
  iVar3 = func_0x02953fd4(0x754f,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x754f,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = FUN_03078794(param_1);
  if (iVar3 == 0) {
    return 0;
  }
  pcVar6 = (char *)(_UNK_030c64d8 + 0x30c6374);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030c64dc + 0x30c6388));
    func_0x01438628(*(undefined4 *)(_UNK_030c64e0 + 0x30c6394));
    func_0x01438628(*(undefined4 *)(_UNK_030c64e4 + 0x30c63a0));
    func_0x01438628(*(undefined4 *)(_UNK_030c64e8 + 0x30c63ac));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x153b,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x153b,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_030c64ec + 0x30c6400) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_030c64f0 + 0x30c641c));
  piVar8 = *(int **)(_UNK_030c64f4 + 0x30c6430);
  iVar7 = *piVar8;
  if (*(int *)(iVar7 + 0x74) == 0) {
    func_0x014387a4();
    iVar7 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_030c64f8 + 0x30c6450);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar7 + 0x5c) + 0x970);
  if (iVar4 == 0) {
