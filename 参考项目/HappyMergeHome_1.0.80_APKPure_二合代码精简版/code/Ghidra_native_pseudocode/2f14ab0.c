...
/* WARNING: Possible PIC construction at 0x02f24c30: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x02f24c34) */
/* WARNING: Removing unreachable block (ram,0x02f24c48) */
/* WARNING: Removing unreachable block (ram,0x02f24c4c) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_02f24ab0(int param_1)

{
  ...
  pcVar11 = (char *)(_UNK_02f24c60 + 0x2f24ac4);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f24c64 + 0x2f24ad8));
    func_0x01438628(*(undefined4 *)(_UNK_02f24c68 + 0x2f24ae4));
    func_0x01438628(*(undefined4 *)(_UNK_02f24c6c + 0x2f24af0));
    func_0x01438628(*(undefined4 *)(_UNK_02f24c70 + 0x2f24afc));
    func_0x01438628(*(undefined4 *)(_UNK_02f24c74 + 0x2f24b08));
    func_0x01438628(*(undefined4 *)(_UNK_02f24c78 + 0x2f24b14));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x6d34,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x6d34,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f24c7c + 0x2f24b78) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02f24c80 + 0x2f24b94));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = func_0x036c7bec(iVar3,**(undefined4 **)(_UNK_02f24c84 + 0x2f24bb4));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar3 + 0x1cc) != 0) {
    func_0x03b73ab8(*(int *)(iVar3 + 0x1cc),**(undefined4 **)(_UNK_02f24c88 + 0x2f24be4));
  }
  if (*(int *)(**(int **)(_UNK_02f24c8c + 0x2f24bf4) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar12 = *(undefined4 **)(_UNK_02f24c90 + 0x2f24c10);
  ...
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0xe,0);
  ...
  if (iVar3 != 0) {
    ...
    puStack_30 = puVar4;
    puStack_2c = puVar12;
    func_0x024f56c0(&uStack_60,0,0xe,0);
    ...
    func_0x01523a2c(&puStack_48,0xe,0);
    iVar10 = *(int *)(iVar3 + 8);
    uVar13 = *(undefined4 *)(iVar3 + 0xc);
    iVar3 = *(int *)(iVar3 + 0x10);
    if (iVar10 == 0) {
  ...
  iVar10 = func_0x046ccb14(iVar3,0xe,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar10 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar1 = (*(code *)*puVar4)(piVar9,0xe,puVar4[1]);
      iVar3 = iStack_40;
    }
    iVar10 = *(int *)(iVar3 + 8);
    iVar3 = iVar10;
