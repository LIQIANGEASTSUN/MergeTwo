...

{
  ...
  pcVar7 = (char *)(_UNK_03149914 + 0x3149740);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03149918 + 0x3149754));
    func_0x01438628(*(undefined4 *)(_UNK_0314991c + 0x3149760));
    func_0x01438628(*(undefined4 *)(_UNK_03149920 + 0x314976c));
    func_0x01438628(*(undefined4 *)(_UNK_03149924 + 0x3149778));
    *pcVar7 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x7a21,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x7a21,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03149928 + 0x3149850) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x04e4a028(**(undefined4 **)(_UNK_0314992c + 0x314986c));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  ...
  if ((iVar4 != 0) && (0 < *(int *)(iVar4 + 0xc))) {
    ...
    iVar4 = func_0x04cfd760(iVar4,0,**(undefined4 **)(_UNK_03149930 + 0x31498c0));
    if (iVar4 == 0) {
      func_0x014388e4();
    }
