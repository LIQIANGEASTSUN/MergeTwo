...
undefined4 FUN_019376a4(int param_1)

{
  ...
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0192e57c + 0x192ddec),iVar10,0);
  ...
  if (iVar1 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      *piVar14 = iVar3;
      ...
      iVar9 = FUN_019273e8(iVar9);
      uVar2 = *(undefined4 *)(iVar10 + 8);
      if (iVar9 == 0) {
        func_0x014388e4();
      }
      func_0x024f064c(iVar9,uVar2,aiStack_28,**(undefined4 **)(_UNK_0192e5f8 + 0x192e0a8));
      iVar9 = aiStack_28[0];
      if (aiStack_28[0] == 0) {
        func_0x014388e4();
      }
      ...
      iVar9 = func_0x014388d4(**(undefined4 **)(_UNK_0192e608 + 0x192e22c));
      func_0x024f1124(iVar9,**(undefined4 **)(_UNK_0192e60c + 0x192e240));
      ...
      *piVar7 = iVar9;
      ...
      if (0 < *(int *)(iVar9 + 0xc)) {
        ...
        iVar9 = FUN_01924e6c();
        if (iVar9 != 0) {
          func_0x01938a38(iVar9,0);
        }
        if (*(int *)(**(int **)(_UNK_0192e614 + 0x192e2b4) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar9 = func_0x014e9518(**(undefined4 **)(_UNK_0192e618 + 0x192e2d4));
        if (iVar9 == 0) {
          func_0x014388e4();
        }
        ...
        while( true ) {
          ...
          func_0x020257a4(iVar3,0x351,uVar2,uVar4,0,0,0);
          iVar9 = iVar9 + 1;
        }
        if (*(int *)(**(int **)(_UNK_0192e624 + 0x192e470) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar9 = func_0x014e96a8(**(undefined4 **)(_UNK_0192e628 + 0x192e48c));
        iVar10 = *piVar14;
        if (*(int *)(**(int **)(_UNK_0192e62c + 0x192e4a0) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_0192e630 + 0x192e4c0));
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        ...
        func_0x02b75870(iVar9,iVar10,uVar4,1,0x129,0,0,0,0,0,0,0,uVar2,0,0);
        iVar9 = *piVar7;
        if (iVar9 == 0) {
          func_0x014388e4();
        }
