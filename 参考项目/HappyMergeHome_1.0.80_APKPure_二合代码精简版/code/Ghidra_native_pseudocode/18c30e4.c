...
void FUN_018d30e4(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar2 = func_0x024f0540(iVar2,param_2,**(undefined4 **)(_UNK_018d32b4 + 0x18d31cc));
  ...
  if (iVar5 == 0) {
    ...
    iVar2 = func_0x024f05d4(0,param_2,**(undefined4 **)(_UNK_018d32b8 + 0x18d3250));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_018d3280:
    ...
    iVar2 = func_0x024f05d4(iVar5,param_2,**(undefined4 **)(_UNK_018d32bc + 0x18d3224));
  }
  unaff_r7 = iVar2 + 1;
