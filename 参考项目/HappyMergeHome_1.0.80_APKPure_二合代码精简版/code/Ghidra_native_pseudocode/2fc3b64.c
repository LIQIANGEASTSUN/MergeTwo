...

{
  ...
  pcVar7 = (char *)(_UNK_02fd3d50 + 0x2fd3b7c);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fd3d54 + 0x2fd3b90));
    func_0x01438628(*(undefined4 *)(_UNK_02fd3d58 + 0x2fd3b9c));
    func_0x01438628(*(undefined4 *)(_UNK_02fd3d5c + 0x2fd3ba8));
    func_0x01438628(*(undefined4 *)(_UNK_02fd3d60 + 0x2fd3bb4));
    *pcVar7 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x710c,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x710c,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02fd3d64 + 0x2fd3c8c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x04e4a028(**(undefined4 **)(_UNK_02fd3d68 + 0x2fd3ca8));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  ...
  if ((iVar4 != 0) && (0 < *(int *)(iVar4 + 0xc))) {
    ...
    iVar4 = func_0x04cfd760(iVar4,0,**(undefined4 **)(_UNK_02fd3d6c + 0x2fd3cfc));
    if (iVar4 == 0) {
      func_0x014388e4();
    }
