...
void FUN_02fa3104(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar7 = (char *)(_UNK_02fa3504 + 0x2fa312c);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fa3508 + 0x2fa3140));
    func_0x01438628(*(undefined4 *)(_UNK_02fa350c + 0x2fa314c));
    func_0x01438628(*(undefined4 *)(_UNK_02fa3510 + 0x2fa3158));
    func_0x01438628(*(undefined4 *)(_UNK_02fa3514 + 0x2fa3164));
    func_0x01438628(*(undefined4 *)(_UNK_02fa3518 + 0x2fa3170));
    func_0x01438628(*(undefined4 *)(_UNK_02fa351c + 0x2fa317c));
    func_0x01438628(*(undefined4 *)(_UNK_02fa3520 + 0x2fa3188));
    func_0x01438628(*(undefined4 *)(_UNK_02fa3524 + 0x2fa3194));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x1503,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_02fa3528 + 0x2fa31f8) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_02fa352c + 0x2fa3214));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    if ((int)(iVar6 - (iVar2 + (uint)bVar12)) < 0 !=
      ...
      func_0x03b70d24(iVar5,**(undefined4 **)(_UNK_02fa3530 + 0x2fa33a0));
      uVar15 = FUN_02f95f8c(param_1);
      ...
      if (*(int *)(**(int **)(_UNK_02fa3534 + 0x2fa33f4) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_02fa3538 + 0x2fa3410));
      piVar10 = *(int **)(_UNK_02fa353c + 0x2fa3424);
      iVar5 = *piVar10;
      if (*(int *)(iVar5 + 0x74) == 0) {
        func_0x014387a4();
        iVar5 = *piVar10;
      ...
      piVar10 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_02fa3540 + 0x2fa3448),1);
      uStack_54 = 0;
      iVar5 = func_0x014387ac(**(undefined4 **)(_UNK_02fa3544 + 0x2fa3468),&uStack_54);
      if (piVar10 == (int *)0x0) {
        func_0x014388e4();
      }
      if ((iVar5 != 0) &&
    ...
    iVar2 = func_0x029540a4(0x1503,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
