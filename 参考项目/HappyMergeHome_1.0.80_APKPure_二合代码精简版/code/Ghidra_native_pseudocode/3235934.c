...
uint FUN_03245934(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_032459d4 + 0x3245948);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032459d8 + 0x324595c));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7fe9,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7fe9,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_032459dc + 0x32459b4) + 0x74) == 0) {
    func_0x014387a4();
  }
