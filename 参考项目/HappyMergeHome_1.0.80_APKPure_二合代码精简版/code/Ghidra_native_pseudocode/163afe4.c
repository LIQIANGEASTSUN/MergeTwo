...
int FUN_0164afe4(undefined4 param_1,int param_2)

{
  ...
  pcVar6 = (char *)(_UNK_0164b12c + 0x164affc);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0164b130 + 0x164b010));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x85f3,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x85f3,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(iVar1 + 0xc) == 8) {
    if (*(int *)(**(int **)(_UNK_0164b134 + 0x164b09c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = FUN_01640370();
    if (iVar1 != 0) {
      func_0x0166a598(iVar1,0);
    }
  }
  iVar1 = FUN_01642704(param_1);
  if (iVar1 == 0) {
  ...
  iVar1 = FUN_0164a450(param_1);
  if (iVar5 < iVar1) {
    iVar1 = FUN_01642704(param_1);
    uVar7 = FUN_0164a450(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    func_0x026cf66c(iVar1,uVar7,0);
    pcVar6 = (char *)(_UNK_0164af9c + 0x164acb8);
    uStack_18 = unaff_r4;
    if (*pcVar6 == '\0') {
    ...
    if (0 < *(int *)(iVar1 + 0x74)) {
      ...
      if (iVar5 <= *(int *)(iVar1 + 0xc)) {
        ...
        uVar7 = func_0x024f0530(iVar5,iVar1 + -1,**(undefined4 **)(_UNK_0164afc4 + 0x164ae44));
      }
    }
    ...
    uVar4 = *(undefined4 *)(*(int *)(iVar5 + 0x5c) + 0xa8c);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    if (iVar1 == 0) {
      ...
      if (iVar5 != 0) {
        ...
        pcVar6 = (char *)(_UNK_0166e54c + 0x166e1f0);
        if (*pcVar6 == '\0') {
          ...
          *(undefined1 *)(iVar5 + 0xb0) = 1;
          ...
          if (iVar1 == 0) {
            ...
            if (iVar1 == 0) {
              ...
              uStack_28 = 1;
              uStack_24 = 0;
              iVar5 = func_0x02aee9b4(uVar4,**(undefined4 **)(_UNK_0166e5c0 + 0x166e514),
