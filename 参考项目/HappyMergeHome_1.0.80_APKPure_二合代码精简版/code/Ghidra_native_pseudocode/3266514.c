...
undefined4 FUN_03276514(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_032765c4 + 0x327652c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032765c8 + 0x3276540));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xeeb,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xeeb,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x0327746c(param_1);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar4 = **(int **)(_UNK_032765cc + 0x32765b8);
