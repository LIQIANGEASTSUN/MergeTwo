...
uint FUN_03208d6c(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_03208e54 + 0x3208d8c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03208e58 + 0x3208da0));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7e74,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7e74,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_03208e5c + 0x3208e1c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_03204330();
  if (iVar1 == 0) {
  ...
  pcVar11 = (char *)(_UNK_03208f80 + 0x3208e78);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03208f84 + 0x3208e8c));
    func_0x01438628(*(undefined4 *)(_UNK_03208f88 + 0x3208e98));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7e75,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_03208f8c + 0x3208ef4) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03208f90 + 0x3208f10));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_03211650 + 0x321141c);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_03211654 + 0x3211430));
      func_0x01438628(*(undefined4 *)(_UNK_03211658 + 0x321143c));
      func_0x01438628(*(undefined4 *)(_UNK_0321165c + 0x3211448));
      func_0x01438628(*(undefined4 *)(_UNK_03211660 + 0x3211454));
      func_0x01438628(*(undefined4 *)(_UNK_03211664 + 0x3211460));
      func_0x01438628(*(undefined4 *)(_UNK_03211668 + 0x321146c));
      func_0x01438628(*(undefined4 *)(_UNK_0321166c + 0x3211478));
      *pcVar11 = '\x01';
    }
    iVar3 = func_0x02953fd4(0x7e5d,0);
    if (iVar3 == 0) {
      iVar3 = func_0x0320b990(iVar1);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x046c26fc(iVar3,param_3,**(undefined4 **)(_UNK_03211670 + 0x32114f4));
      if (iVar3 == 0) {
        uVar10 = func_0x0515c4b0(&uStack_1c,0);
        uVar10 = func_0x04f6b198(**(undefined4 **)(_UNK_03211674 + 0x3211558),uVar10,
                                 **(undefined4 **)(_UNK_03211678 + 0x3211564),0);
        if (*(int *)(**(int **)(_UNK_0321167c + 0x3211578) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar3 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_3,**(undefined4 **)(_UNK_03211684 + 0x32115ac));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar3,param_3,**(undefined4 **)(_UNK_03211680 + 0x3211528));
        }
        func_0x03b70fe4(iVar3,param_3,iVar9 + -1,**(undefined4 **)(_UNK_03211688 + 0x32115d0));
        iVar3 = func_0x0320b990(iVar1);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x03b70fac(iVar3,param_3,**(undefined4 **)(_UNK_0321168c + 0x3211600));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x0320b990(iVar1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar3 = **(int **)(_UNK_03211690 + 0x3211640);
...
LAB_046c3e4c:
    ...
    iVar3 = func_0x029540a4(0x7e5d,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar3 = func_0x029540a4(0x7e75,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
