...
uint FUN_032a8ec4(int param_1,int param_2)

{
  ...
  pcVar12 = (char *)(_UNK_032a8f8c + 0x32a8edc);
  if (*pcVar12 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032a8f90 + 0x32a8ef0));
    *pcVar12 = '\x01';
  }
  iVar6 = func_0x02953fd4(0x465,0);
  if (iVar6 == 0) {
    if (*(int *)(**(int **)(_UNK_032a8f94 + 0x32a8f4c) + 0x74) == 0) {
      func_0x014387a4();
    }
