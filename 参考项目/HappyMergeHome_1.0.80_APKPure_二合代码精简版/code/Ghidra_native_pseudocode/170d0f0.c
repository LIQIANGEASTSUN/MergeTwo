...
int FUN_0171d0f0(undefined4 param_1,int param_2)

{
  ...
  pcVar5 = (char *)(_UNK_0171d508 + 0x171d10c);
  if (*pcVar5 == '\0') {
  ...
  iVar1 = func_0x02953fd4(0x1fe0,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x1fe0,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  puVar10 = *(undefined4 **)(_UNK_0171d534 + 0x171d22c);
  iVar1 = func_0x024f0f34(iVar1,param_2,*puVar10);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_0171d538 + 0x171d24c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0171d53c + 0x171d268));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    iVar1 = *(int *)(iVar1 + 0x2c);
    iVar8 = 0;
    puVar11 = *(undefined4 **)(_UNK_0171d540 + 0x171d290);
    do {
      if (iVar1 == 0) {
        func_0x014388e4();
      }
    ...
    while( true ) {
      ...
      if (*(int *)(iVar2 + 0x24) <= param_2) {
        ...
        if (iVar2 == 0) {
          ...
          func_0x024f05ac(iVar2,uVar9,**(undefined4 **)(_UNK_0171d544 + 0x171d408));
        }
      }
      iVar8 = iVar8 + 1;
    }
    ...
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0171d54c + 0x171d448));
    piVar7 = *(int **)(_UNK_0171d550 + 0x171d45c);
    iVar8 = *piVar7;
    if (*(int *)(iVar8 + 0x74) == 0) {
      func_0x014387a4();
      iVar8 = *piVar7;
    }
    iVar6 = **(int **)(_UNK_0171d554 + 0x171d47c);
