...

{
  ...
  pcVar7 = (char *)(_UNK_03183cd8 + 0x3183c44);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03183cdc + 0x3183c58));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7ba1,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7ba1,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar6 = **(int **)(_UNK_03183ce0 + 0x3183ccc);
