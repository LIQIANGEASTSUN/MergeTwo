...
void FUN_0308c9dc(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar7 = (char *)(_UNK_0308cddc + 0x308ca04);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0308cde0 + 0x308ca18));
    func_0x01438628(*(undefined4 *)(_UNK_0308cde4 + 0x308ca24));
    func_0x01438628(*(undefined4 *)(_UNK_0308cde8 + 0x308ca30));
    func_0x01438628(*(undefined4 *)(_UNK_0308cdec + 0x308ca3c));
    func_0x01438628(*(undefined4 *)(_UNK_0308cdf0 + 0x308ca48));
    func_0x01438628(*(undefined4 *)(_UNK_0308cdf4 + 0x308ca54));
    func_0x01438628(*(undefined4 *)(_UNK_0308cdf8 + 0x308ca60));
    func_0x01438628(*(undefined4 *)(_UNK_0308cdfc + 0x308ca6c));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x153a,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_0308ce00 + 0x308cad0) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0308ce04 + 0x308caec));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    if ((int)(iVar6 - (iVar2 + (uint)bVar12)) < 0 !=
      ...
      func_0x03b70d24(iVar5,**(undefined4 **)(_UNK_0308ce08 + 0x308cc78));
      uVar15 = FUN_0307f35c(param_1);
      ...
      if (*(int *)(**(int **)(_UNK_0308ce0c + 0x308cccc) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0308ce10 + 0x308cce8));
      piVar10 = *(int **)(_UNK_0308ce14 + 0x308ccfc);
      iVar5 = *piVar10;
      if (*(int *)(iVar5 + 0x74) == 0) {
        func_0x014387a4();
        iVar5 = *piVar10;
      ...
      piVar10 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_0308ce18 + 0x308cd20),1);
      uStack_54 = 0;
      iVar5 = func_0x014387ac(**(undefined4 **)(_UNK_0308ce1c + 0x308cd40),&uStack_54);
      if (piVar10 == (int *)0x0) {
        func_0x014388e4();
      }
      if ((iVar5 != 0) &&
    ...
    iVar2 = func_0x029540a4(0x153a,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
