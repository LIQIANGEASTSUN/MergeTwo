...

{
  ...
  pcVar3 = (char *)(_UNK_02c6e96c + 0x2c6e644);
  if (*pcVar3 == '\0') {
...
SUB_02868e1c:
  ...
  *piVar8 = iVar1;
  ...
  puVar4 = *(undefined4 **)(_UNK_02c6e99c + 0x2c6e784);
  ...
  *piVar7 = iVar1;
  ...
  iVar1 = FUN_02bdd468(iVar1,uVar2,uVar6,0);
  if ((*piVar8 == 0 || iVar1 == 0) || ((*piVar7 != 0 && (*(int *)(*piVar7 + 0xc) == -1)))) {
    pcVar3 = (char *)(_UNK_02c6eb50 + 0x2c6e9c4);
    if (*pcVar3 == '\0') {
