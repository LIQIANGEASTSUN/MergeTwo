...
void FUN_030ddbc4(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_030ddd24 + 0x30ddbd8);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030ddd28 + 0x30ddbec));
    func_0x01438628(*(undefined4 *)(_UNK_030ddd2c + 0x30ddbf8));
    func_0x01438628(*(undefined4 *)(_UNK_030ddd30 + 0x30ddc04));
    func_0x01438628(*(undefined4 *)(_UNK_030ddd34 + 0x30ddc10));
    *pcVar7 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x2095,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x2095,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_030ddd38 + 0x30ddc68) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x04e4a028(**(undefined4 **)(_UNK_030ddd3c + 0x30ddc84));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  ...
  if ((iVar4 != 0) && (0 < *(int *)(iVar4 + 0xc))) {
    ...
    iVar4 = func_0x04cfd760(iVar4,0,**(undefined4 **)(_UNK_030ddd40 + 0x30ddcd8));
    if (iVar4 == 0) {
      func_0x014388e4();
    }
