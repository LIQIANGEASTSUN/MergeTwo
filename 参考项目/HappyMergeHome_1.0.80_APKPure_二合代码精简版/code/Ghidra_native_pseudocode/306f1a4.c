...
void FUN_0307f1a4(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  pcVar3 = (char *)(_UNK_0307f208 + 0x307f1b8);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0307f20c + 0x307f1cc));
    *pcVar3 = '\x01';
    param_4 = extraout_r3;
  }
  piVar1 = *(int **)(_UNK_0307f210 + 0x307f1e4);
