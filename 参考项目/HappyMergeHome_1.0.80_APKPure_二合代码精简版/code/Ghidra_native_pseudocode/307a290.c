...
int FUN_0308a290(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_0308a3b0 + 0x308a2a4);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0308a3b4 + 0x308a2b8));
    func_0x01438628(*(undefined4 *)(_UNK_0308a3b8 + 0x308a2c4));
    func_0x01438628(*(undefined4 *)(_UNK_0308a3bc + 0x308a2d0));
    func_0x01438628(*(undefined4 *)(_UNK_0308a3c0 + 0x308a2dc));
    *pcVar9 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x20c0,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x20c0,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0308a3c4 + 0x308a334) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_0308a3c8 + 0x308a350));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  ...
  iVar3 = func_0x04cfd760(iVar3,*(int *)(iVar3 + 0xc) + -1,
                          **(undefined4 **)(_UNK_0308a3cc + 0x308a380));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = *(int *)(iVar3 + 0x24);
  pcVar9 = (char *)(_UNK_03089078 + 0x3088c7c);
  iStack_24 = unaff_r4;
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0308907c + 0x3088c90));
    func_0x01438628(*(undefined4 *)(_UNK_03089080 + 0x3088c9c));
    func_0x01438628(*(undefined4 *)(_UNK_03089084 + 0x3088ca8));
    func_0x01438628(*(undefined4 *)(_UNK_03089088 + 0x3088cb4));
    func_0x01438628(*(undefined4 *)(_UNK_0308908c + 0x3088cc0));
    func_0x01438628(*(undefined4 *)(_UNK_03089090 + 0x3088ccc));
    func_0x01438628(*(undefined4 *)(_UNK_03089094 + 0x3088cd8));
    func_0x01438628(*(undefined4 *)(_UNK_03089098 + 0x3088ce4));
    func_0x01438628(*(undefined4 *)(_UNK_0308909c + 0x3088cf0));
    func_0x01438628(*(undefined4 *)(_UNK_030890a0 + 0x3088cfc));
    *pcVar9 = '\x01';
  }
  iVar6 = func_0x02953fd4(0x20c1,0);
  if (iVar6 == 0) {
    ...
    puVar11 = *(undefined4 **)(_UNK_030890a4 + 0x3088d9c);
    iVar6 = func_0x04cd2d7c(iVar6,iVar3,*puVar11);
    if (iVar6 == 0) {
      if (*(int *)(**(int **)(_UNK_030890a8 + 0x3088dbc) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar6 = func_0x04e4a028(**(undefined4 **)(_UNK_030890ac + 0x3088dd8));
      if (iVar6 == 0) {
        func_0x014388e4();
      }
      iVar6 = *(int *)(iVar6 + 0x38);
      iVar7 = 0;
      puVar12 = *(undefined4 **)(_UNK_030890b0 + 0x3088e00);
      while( true ) {
        if (iVar6 == 0) {
          func_0x014388e4();
        }
          ...
          while( true ) {
            ...
            if (*(int *)(iVar2 + 0x24) <= iVar3) {
              ...
              if (iVar2 == 0) {
                ...
                func_0x03b75ba0(iVar2,uVar10,**(undefined4 **)(_UNK_030890b4 + 0x3088f78));
              }
            }
            iVar7 = iVar7 + 1;
          }
          func_0x0308a554(param_1);
          if (*(int *)(**(int **)(_UNK_030890b8 + 0x3088f9c) + 0x74) == 0) {
            func_0x014387a4();
          }
          iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_030890bc + 0x3088fb8));
          piVar8 = *(int **)(_UNK_030890c0 + 0x3088fcc);
          iVar6 = *piVar8;
          if (*(int *)(iVar6 + 0x74) == 0) {
            func_0x014387a4();
            iVar6 = *piVar8;
          }
          iVar2 = **(int **)(_UNK_030890c4 + 0x3088fec);
  ...
  iVar6 = func_0x029540a4(0x20c1,0);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
  puStack_20 = (undefined4 *)iStack_24;
