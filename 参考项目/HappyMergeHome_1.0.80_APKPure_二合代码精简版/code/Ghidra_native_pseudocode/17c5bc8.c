...
uint FUN_017d5bc8(int param_1,int param_2)

{
  ...
  pcVar10 = (char *)(_UNK_017d5c90 + 0x17d5be0);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017d5c94 + 0x17d5bf4));
    *pcVar10 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x45b,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_017d5c98 + 0x17d5c50) + 0x74) == 0) {
      func_0x014387a4();
    }
