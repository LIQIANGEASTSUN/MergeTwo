...
int FUN_03014a60(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_03014b80 + 0x3014a74);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03014b84 + 0x3014a88));
    func_0x01438628(*(undefined4 *)(_UNK_03014b88 + 0x3014a94));
    func_0x01438628(*(undefined4 *)(_UNK_03014b8c + 0x3014aa0));
    func_0x01438628(*(undefined4 *)(_UNK_03014b90 + 0x3014aac));
    *pcVar9 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x2115,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x2115,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03014b94 + 0x3014b04) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03014b98 + 0x3014b20));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  ...
  iVar3 = func_0x04cfd760(iVar3,*(int *)(iVar3 + 0xc) + -1,
                          **(undefined4 **)(_UNK_03014b9c + 0x3014b50));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = *(int *)(iVar3 + 0x24);
  pcVar9 = (char *)(_UNK_03012a38 + 0x301263c);
  iStack_24 = unaff_r4;
  if (*pcVar9 == '\0') {
  ...
  iVar6 = func_0x02953fd4(0x2116,0);
  if (iVar6 == 0) {
    ...
    puVar11 = *(undefined4 **)(_UNK_03012a64 + 0x301275c);
    iVar6 = func_0x04cd2d7c(iVar6,iVar3,*puVar11);
    if (iVar6 == 0) {
      if (*(int *)(**(int **)(_UNK_03012a68 + 0x301277c) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar6 = func_0x04e4a028(**(undefined4 **)(_UNK_03012a6c + 0x3012798));
      if (iVar6 == 0) {
        func_0x014388e4();
      }
      iVar6 = *(int *)(iVar6 + 0x2c);
      iVar7 = 0;
      puVar12 = *(undefined4 **)(_UNK_03012a70 + 0x30127c0);
      while( true ) {
        if (iVar6 == 0) {
          func_0x014388e4();
        }
        ...
        if (*(int *)(iVar2 + 0x24) == iVar3) {
          ...
          while( true ) {
            ...
            if (*(int *)(iVar2 + 0x24) <= iVar3) {
              ...
              if (iVar2 == 0) {
                ...
                func_0x03b75ba0(iVar2,uVar10,**(undefined4 **)(_UNK_03012a74 + 0x3012938));
              }
            }
            iVar7 = iVar7 + 1;
          }
          ...
          iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03012a7c + 0x3012978));
          ...
          iVar2 = **(int **)(_UNK_03012a84 + 0x30129ac);
  ...
  iVar6 = func_0x029540a4(0x2116,0);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
  puStack_20 = (undefined4 *)iStack_24;
