...

{
  ...
  pcVar4 = (char *)(_UNK_030d2c98 + 0x30d2bfc);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030d2c9c + 0x30d2c10));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7714,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7714,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_030d2ca0 + 0x30d2c64) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_030ccbc4();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
