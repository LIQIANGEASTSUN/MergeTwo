...

{
  ...
  pcVar4 = (char *)(_UNK_02f23d0c + 0x2f23c70);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f23d10 + 0x2f23c84));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x6d31,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x6d31,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f23d14 + 0x2f23cd8) + 0x74) == 0) {
    func_0x014387a4();
  }
