...
uint FUN_02b4c698(int param_1,int param_2)

{
  ...
  pcVar12 = (char *)(_UNK_02b4c760 + 0x2b4c6b0);
  if (*pcVar12 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02b4c764 + 0x2b4c6c4));
    *pcVar12 = '\x01';
  }
  iVar6 = func_0x02953fd4(0x62f,0);
  if (iVar6 == 0) {
    if (*(int *)(**(int **)(_UNK_02b4c768 + 0x2b4c720) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar6 = func_0x02c35d10(0x17,0);
    if (iVar6 == 0) {
      return 0;
    }
