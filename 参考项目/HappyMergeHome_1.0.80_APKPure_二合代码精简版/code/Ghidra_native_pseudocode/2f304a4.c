...
void FUN_02f404a4(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_02f4055c + 0x2f404b8);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f40560 + 0x2f404cc));
    *pcVar8 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x6db3,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x6db3,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x02f52028(param_1);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_02f40564 + 0x2f40534) + 0x74) == 0) {
    func_0x014387a4();
  }
