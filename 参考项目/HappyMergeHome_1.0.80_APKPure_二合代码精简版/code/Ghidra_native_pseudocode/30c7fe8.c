...

{
  ...
  pcVar7 = (char *)(_UNK_030d8090 + 0x30d7ffc);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030d8094 + 0x30d8010));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7722,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7722,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar6 = **(int **)(_UNK_030d8098 + 0x30d8084);
