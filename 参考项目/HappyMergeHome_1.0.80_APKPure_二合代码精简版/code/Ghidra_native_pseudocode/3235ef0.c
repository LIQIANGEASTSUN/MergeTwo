...
int FUN_03245ef0(undefined4 param_1,int param_2)

{
  ...
  pcVar5 = (char *)(_UNK_03246308 + 0x3245f0c);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0324630c + 0x3245f20));
    func_0x01438628(*(undefined4 *)(_UNK_03246310 + 0x3245f2c));
    func_0x01438628(*(undefined4 *)(_UNK_03246314 + 0x3245f38));
    func_0x01438628(*(undefined4 *)(_UNK_03246318 + 0x3245f44));
    func_0x01438628(*(undefined4 *)(_UNK_0324631c + 0x3245f50));
    func_0x01438628(*(undefined4 *)(_UNK_03246320 + 0x3245f5c));
    func_0x01438628(*(undefined4 *)(_UNK_03246324 + 0x3245f68));
    func_0x01438628(*(undefined4 *)(_UNK_03246328 + 0x3245f74));
    func_0x01438628(*(undefined4 *)(_UNK_0324632c + 0x3245f80));
    func_0x01438628(*(undefined4 *)(_UNK_03246330 + 0x3245f8c));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x1fc3,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x1fc3,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  puVar10 = *(undefined4 **)(_UNK_03246334 + 0x324602c);
  iVar2 = func_0x04cd2d7c(iVar2,param_2,*puVar10);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_03246338 + 0x324604c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0324633c + 0x3246068));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iVar2 = *(int *)(iVar2 + 0x38);
    iVar7 = 0;
    puVar11 = *(undefined4 **)(_UNK_03246340 + 0x3246090);
    do {
      if (iVar2 == 0) {
        func_0x014388e4();
      }
    ...
    while( true ) {
      ...
      if (*(int *)(iVar3 + 0x24) <= param_2) {
        ...
        if (iVar3 == 0) {
          ...
          func_0x03b75ba0(iVar3,uVar9,**(undefined4 **)(_UNK_03246344 + 0x3246208));
        }
      }
      iVar7 = iVar7 + 1;
    }
    func_0x032477e4(param_1);
    if (*(int *)(**(int **)(_UNK_03246348 + 0x324622c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0324634c + 0x3246248));
    piVar8 = *(int **)(_UNK_03246350 + 0x324625c);
    iVar7 = *piVar8;
    if (*(int *)(iVar7 + 0x74) == 0) {
      func_0x014387a4();
      iVar7 = *piVar8;
    }
    iVar6 = **(int **)(_UNK_03246354 + 0x324627c);
