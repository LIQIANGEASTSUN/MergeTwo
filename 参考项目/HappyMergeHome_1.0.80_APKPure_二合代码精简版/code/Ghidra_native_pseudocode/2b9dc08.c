...
void FUN_02badc08(undefined4 param_1,int param_2)

{
  ...
  iVar2 = func_0x02baddd0(param_1);
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  uVar12 = func_0x014e6a14((int)uVar12,(int)((ulonglong)uVar12 >> 0x20),1000,0);
  uStack_28 = 0;
  iVar2 = func_0x02680d50((int)uVar12,(int)((ulonglong)uVar12 >> 0x20),*(undefined4 *)(iVar2 + 0x40)
