...
int * FUN_030d28b4(undefined4 param_1)

{
  ...
  pcVar17 = (char *)(_UNK_030d2994 + 0x30d28c8);
  if (*pcVar17 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030d2998 + 0x30d28dc));
    func_0x01438628(*(undefined4 *)(_UNK_030d299c + 0x30d28e8));
    func_0x01438628(*(undefined4 *)(_UNK_030d29a0 + 0x30d28f4));
    *pcVar17 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x770f,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x770f,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
    pcVar17 = (char *)(_UNK_02919a68 + 0x2919988);
    if (*pcVar17 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_02919a6c + 0x291999c),param_1,0);
      *pcVar17 = '\x01';
    }
    ...
    piVar3 = (int *)func_0x035daef8(&uStack_30,0,**(undefined4 **)(_UNK_02919a70 + 0x2919a58));
    return piVar3;
  }
  if (*(int *)(**(int **)(_UNK_030d29a4 + 0x30d294c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x04e4a028(**(undefined4 **)(_UNK_030d29a8 + 0x30d2968));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  iVar16 = **(int **)(_UNK_030d29ac + 0x30d2988);
  puVar21 = auStack_20;
