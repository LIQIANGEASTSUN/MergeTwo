...

{
  ...
  pcVar3 = (char *)(_UNK_017e41e4 + 0x17e40f4);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017e41e8 + 0x17e4108));
    func_0x01438628(*(undefined4 *)(_UNK_017e41ec + 0x17e4114));
    func_0x01438628(*(undefined4 *)(_UNK_017e41f0 + 0x17e4120));
    func_0x01438628(*(undefined4 *)(_UNK_017e41f4 + 0x17e412c));
    *pcVar3 = '\x01';
  }
  iVar4 = *(int *)(param_1 + 8);
  ...
  iVar2 = *(int *)(iVar2 + 0xc);
  if (*(int *)(**(int **)(_UNK_017e41f8 + 0x17e4164) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x0152ae0c(0,iVar2 + -6,0);
  if (iVar4 == iVar2) {
    if (*(int *)(**(int **)(_UNK_017e41fc + 0x17e419c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_017e4200 + 0x17e41b8));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
