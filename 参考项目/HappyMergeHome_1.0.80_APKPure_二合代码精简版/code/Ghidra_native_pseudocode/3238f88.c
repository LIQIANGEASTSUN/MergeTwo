...
void FUN_03248f88(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar6 = (char *)(_UNK_03249204 + 0x3248fb0);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03249208 + 0x3248fc4));
    func_0x01438628(*(undefined4 *)(_UNK_0324920c + 0x3248fd0));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x16eb,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_03249210 + 0x3249034) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_03249214 + 0x3249054));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    uVar9 = (uint)lVar15;
    iVar3 = FUN_0323c5d0(param_1,param_4 - (uVar8 + !bVar10));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x029540a4(0x16eb,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
