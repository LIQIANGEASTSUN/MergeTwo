...
int FUN_02f92908(undefined4 param_1)

{
  ...
  iVar3 = func_0x02953fd4(0x6f41,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x6f41,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = FUN_02f901fc(param_1);
  if (iVar3 == 0) {
    return 0;
  }
  pcVar6 = (char *)(_UNK_02fc26e8 + 0x2fc2584);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fc26ec + 0x2fc2598));
    func_0x01438628(*(undefined4 *)(_UNK_02fc26f0 + 0x2fc25a4));
    func_0x01438628(*(undefined4 *)(_UNK_02fc26f4 + 0x2fc25b0));
    func_0x01438628(*(undefined4 *)(_UNK_02fc26f8 + 0x2fc25bc));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x1504,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x1504,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_02fc26fc + 0x2fc2610) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02fc2700 + 0x2fc262c));
  piVar8 = *(int **)(_UNK_02fc2704 + 0x2fc2640);
  iVar7 = *piVar8;
  if (*(int *)(iVar7 + 0x74) == 0) {
    func_0x014387a4();
    iVar7 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_02fc2708 + 0x2fc2660);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar7 + 0x5c) + 0x948);
  if (iVar4 == 0) {
