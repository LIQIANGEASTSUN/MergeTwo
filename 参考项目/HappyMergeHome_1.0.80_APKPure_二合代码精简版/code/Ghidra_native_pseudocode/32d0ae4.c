...
undefined4 FUN_032e0ae4(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_032e0bc0 + 0x32e0af8);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032e0bc4 + 0x32e0b0c));
    func_0x01438628(*(undefined4 *)(_UNK_032e0bc8 + 0x32e0b18));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x83d6,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_032e0bcc + 0x32e0b70) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_032e0bd0 + 0x32e0b8c));
    uVar7 = func_0x032e0bd4(param_1);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = func_0x029540a4(0x83d6,0);
  if (iVar3 == 0) {
    func_0x014388e4();
  }
