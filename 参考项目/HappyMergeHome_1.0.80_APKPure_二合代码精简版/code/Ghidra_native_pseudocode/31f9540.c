...
void FUN_03209540(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  pcVar4 = (char *)(_UNK_03209648 + 0x3209560);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0320964c + 0x3209580));
    *pcVar4 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7e78,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7e78,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iStack_34 = param_5;
  ...
  if (*(int *)(**(int **)(_UNK_03209650 + 0x320960c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_03204330();
  if (iVar2 == 0) {
