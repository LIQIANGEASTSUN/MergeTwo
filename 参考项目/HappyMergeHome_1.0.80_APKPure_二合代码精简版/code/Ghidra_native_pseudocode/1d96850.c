...
uint FUN_01da6850(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_01da6938 + 0x1da6870);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01da693c + 0x1da6884));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x3eec,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x3eec,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_01da6940 + 0x1da6900) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_01da3ca8();
  if (iVar1 == 0) {
  ...
  pcVar11 = (char *)(_UNK_01da6a64 + 0x1da695c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01da6a68 + 0x1da6970));
    func_0x01438628(*(undefined4 *)(_UNK_01da6a6c + 0x1da697c));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x3eed,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_01da6a70 + 0x1da69d8) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_01da6a74 + 0x1da69f4));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_01daca48 + 0x1dac814);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_01daca4c + 0x1dac828));
      func_0x01438628(*(undefined4 *)(_UNK_01daca50 + 0x1dac834));
      func_0x01438628(*(undefined4 *)(_UNK_01daca54 + 0x1dac840));
      func_0x01438628(*(undefined4 *)(_UNK_01daca58 + 0x1dac84c));
      func_0x01438628(*(undefined4 *)(_UNK_01daca5c + 0x1dac858));
      func_0x01438628(*(undefined4 *)(_UNK_01daca60 + 0x1dac864));
      func_0x01438628(*(undefined4 *)(_UNK_01daca64 + 0x1dac870));
      *pcVar11 = '\x01';
    }
    iVar3 = func_0x02953fd4(0x3ed4,0);
    if (iVar3 == 0) {
      iVar3 = func_0x01da8520(iVar1);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x024f0540(iVar3,param_3,**(undefined4 **)(_UNK_01daca68 + 0x1dac8ec));
      if (iVar3 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x024eee28(**(undefined4 **)(_UNK_01daca6c + 0x1dac950),uVar10,
                                 **(undefined4 **)(_UNK_01daca70 + 0x1dac95c),0);
        if (*(int *)(**(int **)(_UNK_01daca74 + 0x1dac970) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar3 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_3,**(undefined4 **)(_UNK_01daca7c + 0x1dac9a4));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar3,param_3,**(undefined4 **)(_UNK_01daca78 + 0x1dac920));
        }
        func_0x03b70fe4(iVar3,param_3,iVar9 + -1,**(undefined4 **)(_UNK_01daca80 + 0x1dac9c8));
        iVar3 = func_0x01da8520(iVar1);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x03b70fac(iVar3,param_3,**(undefined4 **)(_UNK_01daca84 + 0x1dac9f8));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x01da8520(iVar1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar3 = **(int **)(_UNK_01daca88 + 0x1daca38);
...
LAB_046c3e4c:
    ...
    iVar3 = func_0x029540a4(0x3ed4,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar3 = func_0x029540a4(0x3eed,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
