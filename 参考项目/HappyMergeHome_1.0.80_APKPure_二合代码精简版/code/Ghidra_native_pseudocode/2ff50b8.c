...
int FUN_030050b8(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_03005234 + 0x30050cc);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03005238 + 0x30050e0));
    func_0x01438628(*(undefined4 *)(_UNK_0300523c + 0x30050ec));
    func_0x01438628(*(undefined4 *)(_UNK_03005240 + 0x30050f8));
    func_0x01438628(*(undefined4 *)(_UNK_03005244 + 0x3005104));
    *pcVar7 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7238,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x7238,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03005248 + 0x300515c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_0300524c + 0x3005178));
  piVar8 = *(int **)(_UNK_03005250 + 0x300518c);
  iVar6 = *piVar8;
  if (*(int *)(iVar6 + 0x74) == 0) {
    func_0x014387a4();
    iVar6 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_03005254 + 0x30051ac);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar6 + 0x5c) + 0x9e4);
  if (iVar4 == 0) {
