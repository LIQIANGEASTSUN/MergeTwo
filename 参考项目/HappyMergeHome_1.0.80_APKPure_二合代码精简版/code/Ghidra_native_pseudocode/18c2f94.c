...
undefined4 FUN_018d2f94(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar5 = (char *)(_UNK_018d30d0 + 0x18d2fac);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018d30d4 + 0x18d2fc0));
    func_0x01438628(*(undefined4 *)(_UNK_018d30d8 + 0x18d2fcc));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x955e,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x955e,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_018d30dc + 0x18d3064));
  if (iVar1 != 0) {
    iVar1 = FUN_018c3704(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_018d30e0 + 0x18d30bc);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
