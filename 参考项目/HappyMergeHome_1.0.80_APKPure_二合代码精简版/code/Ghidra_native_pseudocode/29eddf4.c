...
int FUN_029fddf4(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_029fdec0 + 0x29fde08);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_029fdec4 + 0x29fde1c));
    func_0x01438628(*(undefined4 *)(_UNK_029fdec8 + 0x29fde28));
    *pcVar9 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x2637,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x2637,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_029fdecc + 0x29fde80) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_029fded0 + 0x29fde9c));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
