...
int FUN_018ce3b0(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_018ce4d0 + 0x18ce3c4);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018ce4d4 + 0x18ce3d8));
    func_0x01438628(*(undefined4 *)(_UNK_018ce4d8 + 0x18ce3e4));
    func_0x01438628(*(undefined4 *)(_UNK_018ce4dc + 0x18ce3f0));
    func_0x01438628(*(undefined4 *)(_UNK_018ce4e0 + 0x18ce3fc));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x1df7,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x1df7,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_018ce4e4 + 0x18ce454) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_018ce4e8 + 0x18ce470));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  ...
  iVar2 = func_0x0152983c(iVar2,*(int *)(iVar2 + 0xc) + -1,
                          **(undefined4 **)(_UNK_018ce4ec + 0x18ce4a0));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  iVar2 = *(int *)(iVar2 + 0x24);
  pcVar7 = (char *)(_UNK_018cc4bc + 0x18cc0c0);
  iStack_24 = unaff_r4;
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018cc4c0 + 0x18cc0d4));
    func_0x01438628(*(undefined4 *)(_UNK_018cc4c4 + 0x18cc0e0));
    func_0x01438628(*(undefined4 *)(_UNK_018cc4c8 + 0x18cc0ec));
    func_0x01438628(*(undefined4 *)(_UNK_018cc4cc + 0x18cc0f8));
    func_0x01438628(*(undefined4 *)(_UNK_018cc4d0 + 0x18cc104));
    func_0x01438628(*(undefined4 *)(_UNK_018cc4d4 + 0x18cc110));
    func_0x01438628(*(undefined4 *)(_UNK_018cc4d8 + 0x18cc11c));
    func_0x01438628(*(undefined4 *)(_UNK_018cc4dc + 0x18cc128));
    func_0x01438628(*(undefined4 *)(_UNK_018cc4e0 + 0x18cc134));
    func_0x01438628(*(undefined4 *)(_UNK_018cc4e4 + 0x18cc140));
    *pcVar7 = '\x01';
  }
  iVar8 = func_0x02953fd4(0x1df8,0);
  if (iVar8 == 0) {
    ...
    puVar11 = *(undefined4 **)(_UNK_018cc4e8 + 0x18cc1e0);
    iVar8 = func_0x024f0f34(iVar8,iVar2,*puVar11);
    if (iVar8 == 0) {
      if (*(int *)(**(int **)(_UNK_018cc4ec + 0x18cc200) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar8 = func_0x014e9518(**(undefined4 **)(_UNK_018cc4f0 + 0x18cc21c));
      if (iVar8 == 0) {
        func_0x014388e4();
      }
      iVar8 = *(int *)(iVar8 + 0x2c);
      iVar9 = 0;
      puVar12 = *(undefined4 **)(_UNK_018cc4f4 + 0x18cc244);
      while( true ) {
        if (iVar8 == 0) {
          func_0x014388e4();
        }
          ...
          while( true ) {
            ...
            if (*(int *)(iVar1 + 0x24) <= iVar2) {
              ...
              if (iVar1 == 0) {
                ...
                func_0x024f05ac(iVar1,uVar10,**(undefined4 **)(_UNK_018cc4f8 + 0x18cc3bc));
              }
            }
            iVar9 = iVar9 + 1;
          }
          func_0x018ceabc(param_1);
          if (*(int *)(**(int **)(_UNK_018cc4fc + 0x18cc3e0) + 0x74) == 0) {
            func_0x014387a4();
          }
          iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_018cc500 + 0x18cc3fc));
          piVar6 = *(int **)(_UNK_018cc504 + 0x18cc410);
          iVar8 = *piVar6;
          if (*(int *)(iVar8 + 0x74) == 0) {
            func_0x014387a4();
            iVar8 = *piVar6;
          }
          iVar1 = **(int **)(_UNK_018cc508 + 0x18cc430);
  ...
  iVar8 = func_0x029540a4(0x1df8,0);
  if (iVar8 == 0) {
    func_0x014388e4();
  }
  puStack_20 = (undefined4 *)iStack_24;
