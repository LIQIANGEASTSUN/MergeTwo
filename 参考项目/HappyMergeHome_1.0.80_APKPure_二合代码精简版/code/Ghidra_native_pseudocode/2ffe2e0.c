...
int FUN_0300e2e0(int *param_1,int param_2,int param_3)

{
  ...
  pcVar10 = (char *)(_UNK_0300e4b4 + 0x300e300);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0300e4b8 + 0x300e314));
    func_0x01438628(*(undefined4 *)(_UNK_0300e4bc + 0x300e320));
    func_0x01438628(*(undefined4 *)(_UNK_0300e4c0 + 0x300e32c));
    *pcVar10 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x726c,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x726c,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0300e4c4 + 0x300e394) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_0300e4c8 + 0x300e3b0));
  uVar6 = (**(code **)(*param_1 + 0x1a0))(param_1,*(undefined4 *)(*param_1 + 0x1a4));
  piVar7 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_0300e4cc + 0x300e3e0),2);
  if (piVar7 == (int *)0x0) {
    func_0x014388e4();
  }
  if ((param_2 != 0) &&
