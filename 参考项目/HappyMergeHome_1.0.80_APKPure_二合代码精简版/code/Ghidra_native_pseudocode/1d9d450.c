...
void FUN_01dad450(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar8 = (char *)(_UNK_01dad514 + 0x1dad468);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01dad518 + 0x1dad47c));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x3f11,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x3f11,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = FUN_01dad2c4(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_01dad51c + 0x1dad4ec) + 0x74) == 0) {
    func_0x014387a4();
  }
