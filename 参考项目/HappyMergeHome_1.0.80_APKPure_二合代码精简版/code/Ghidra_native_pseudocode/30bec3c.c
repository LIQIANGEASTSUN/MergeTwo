...
void FUN_030cec3c(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_030ced00 + 0x30cec54);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030ced04 + 0x30cec68));
    *pcVar10 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x76d4,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x76d4,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x030dfcdc(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_030ced08 + 0x30cecd8) + 0x74) == 0) {
    func_0x014387a4();
  }
