...
/* WARNING: Possible PIC construction at 0x017a6e78: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x017a6e7c) */
/* WARNING: Removing unreachable block (ram,0x017a6e90) */
/* WARNING: Removing unreachable block (ram,0x017a6e94) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_017a6cf8(int param_1)

{
  ...
  pcVar10 = (char *)(_UNK_017a6ea8 + 0x17a6d0c);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017a6eac + 0x17a6d20));
    func_0x01438628(*(undefined4 *)(_UNK_017a6eb0 + 0x17a6d2c));
    func_0x01438628(*(undefined4 *)(_UNK_017a6eb4 + 0x17a6d38));
    func_0x01438628(*(undefined4 *)(_UNK_017a6eb8 + 0x17a6d44));
    func_0x01438628(*(undefined4 *)(_UNK_017a6ebc + 0x17a6d50));
    func_0x01438628(*(undefined4 *)(_UNK_017a6ec0 + 0x17a6d5c));
    *pcVar10 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8e84,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8e84,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_017a6ec4 + 0x17a6dc0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_017a6ec8 + 0x17a6ddc));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar1 = func_0x036c7bec(iVar1,**(undefined4 **)(_UNK_017a6ecc + 0x17a6dfc));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar1 + 0x30c) != 0) {
    func_0x024f04d0(*(int *)(iVar1 + 0x30c),**(undefined4 **)(_UNK_017a6ed0 + 0x17a6e2c));
  }
  if (*(int *)(**(int **)(_UNK_017a6ed4 + 0x17a6e3c) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar11 = *(undefined4 **)(_UNK_017a6ed8 + 0x17a6e58);
  ...
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x26,0);
  ...
  if (iVar1 != 0) {
    ...
    puStack_30 = puVar2;
    puStack_2c = puVar11;
    func_0x024f56c0(&uStack_60,0,0x26,0);
    ...
    func_0x01523a2c(&puStack_48,0x26,0);
    iVar12 = *(int *)(iVar1 + 8);
    uVar13 = *(undefined4 *)(iVar1 + 0xc);
    iVar1 = *(int *)(iVar1 + 0x10);
    if (iVar12 == 0) {
  ...
  iVar12 = func_0x046ccb14(iVar1,0x26,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar12 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar3 = (*(code *)*puVar2)(piVar9,0x26,puVar2[1]);
      iVar1 = iStack_40;
    }
    iVar12 = *(int *)(iVar1 + 8);
    iVar1 = iVar12;
