...
undefined4 FUN_031b84d4(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_031b8584 + 0x31b84ec);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031b8588 + 0x31b8500));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x17a3,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x17a3,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x031b942c(param_1);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar4 = **(int **)(_UNK_031b858c + 0x31b8578);
