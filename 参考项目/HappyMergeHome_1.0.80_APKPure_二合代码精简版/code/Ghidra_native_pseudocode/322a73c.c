...
uint FUN_0323a73c(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar2 = func_0x02953fd4(0x7fc5,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_0323a868 + 0x323a7d0) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0323a86c + 0x323a7ec));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
...
LAB_046c3e4c:
    ...
    iVar2 = func_0x029540a4(0x7fc5,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
