...

{
  ...
  pcVar7 = (char *)(_UNK_0300f070 + 0x300efdc);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0300f074 + 0x300eff0));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7289,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7289,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar6 = **(int **)(_UNK_0300f078 + 0x300f064);
