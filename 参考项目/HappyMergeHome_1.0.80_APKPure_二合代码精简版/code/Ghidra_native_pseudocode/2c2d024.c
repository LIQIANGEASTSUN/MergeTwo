...
undefined4 FUN_02c3d024(undefined4 param_1,undefined4 param_2,int param_3)

{
  ...
  pcVar3 = (char *)(_UNK_02c3d504 + 0x2c3d044);
  if (*pcVar3 == '\0') {
...
LAB_02c3d1a4:
      ...
      if (iVar1 != 0) {
        iVar1 = iStack_4c;
        if (iStack_2c != 0) {
          uVar4 = *(undefined4 *)(iStack_2c + 0xc);
          ...
          if (iVar2 == 0) {
            if (param_3 != 0) {
              ...
              iVar2 = FUN_02c251d8(iVar2,0);
              if (iVar2 != 0) goto LAB_02c3d1a4;
            }
            iVar1 = iVar5;
            if (iStack_4c != 0) {
      ...
      if (iStack_4c == 0) {
        ...
        uVar4 = FUN_02bec634(iVar2,iStack_4c,0);
        if (iVar5 == 0) {
          func_0x014388e4();
        }
        FUN_02bed744(&uStack_48,iVar5,uVar4,0);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
    ...
    uVar4 = func_0x0286e8b4(iVar1,param_1,param_2,param_3,0);
  }
  return uVar4;
}
