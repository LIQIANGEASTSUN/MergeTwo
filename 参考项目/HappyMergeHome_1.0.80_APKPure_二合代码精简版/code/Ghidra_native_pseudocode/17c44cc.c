...
uint FUN_017d44cc(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_017d45b4 + 0x17d44ec);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017d45b8 + 0x17d4500));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8f98,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8f98,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_017d45bc + 0x17d457c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_017d0b50();
  if (iVar1 == 0) {
  ...
  iVar3 = func_0x02953fd4(0x8f99,0);
  if (iVar3 == 0) {
    pcVar11 = (char *)(_UNK_017daf60 + 0x17dac40);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_017daf64 + 0x17dac54));
      func_0x01438628(*(undefined4 *)(_UNK_017daf68 + 0x17dac60));
      func_0x01438628(*(undefined4 *)(_UNK_017daf6c + 0x17dac6c));
      func_0x01438628(*(undefined4 *)(_UNK_017daf70 + 0x17dac78));
      func_0x01438628(*(undefined4 *)(_UNK_017daf74 + 0x17dac84));
      func_0x01438628(*(undefined4 *)(_UNK_017daf78 + 0x17dac90));
      func_0x01438628(*(undefined4 *)(_UNK_017daf7c + 0x17dac9c));
      func_0x01438628(*(undefined4 *)(_UNK_017daf80 + 0x17daca8));
      func_0x01438628(*(undefined4 *)(_UNK_017daf84 + 0x17dacb4));
      func_0x01438628(*(undefined4 *)(_UNK_017daf88 + 0x17dacc0));
      *pcVar11 = '\x01';
    }
    iVar3 = func_0x02953fd4(0x8f93,0);
    if (iVar3 == 0) {
      if (*(int *)(**(int **)(_UNK_017daf8c + 0x17dad20) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_017daf90 + 0x17dad3c));
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x029a6fa8(iVar3,param_3,0);
      if (iVar3 != 0) {
        iVar9 = func_0x017d5398(iVar1);
        if (iVar9 == 0) {
          func_0x014388e4();
        }
        if (*(int *)(iVar9 + 0x10) != 0) {
          ...
          iVar3 = func_0x024f0f34(iVar9,uVar10,**(undefined4 **)(_UNK_017daf94 + 0x17dadcc));
          if (iVar3 == 0) {
            return 0;
          }
        }
      }
      iVar3 = func_0x017d5b5c(iVar1);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x024f0540(iVar3,param_3,**(undefined4 **)(_UNK_017daf98 + 0x17dae04));
      if (iVar3 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x024eee28(**(undefined4 **)(_UNK_017daf9c + 0x17dae68),uVar10,
                                 **(undefined4 **)(_UNK_017dafa0 + 0x17dae74),0);
        if (*(int *)(**(int **)(_UNK_017dafa4 + 0x17dae88) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar3 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_3,**(undefined4 **)(_UNK_017dafac + 0x17daebc));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar3,param_3,**(undefined4 **)(_UNK_017dafa8 + 0x17dae38));
        }
        func_0x024f10d4(iVar3,param_3,iVar9 + -1,**(undefined4 **)(_UNK_017dafb0 + 0x17daee0));
        iVar3 = func_0x017d5b5c(iVar1);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x024f05d4(iVar3,param_3,**(undefined4 **)(_UNK_017dafb4 + 0x17daf10));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x017d5b5c(iVar1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar3 = **(int **)(_UNK_017dafb8 + 0x17daf50);
...
LAB_046c3e4c:
    ...
    iVar3 = func_0x029540a4(0x8f93,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar3 = func_0x029540a4(0x8f99,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
