...
uint FUN_029fdcbc(int param_1,int param_2)

{
  ...
  pcVar12 = (char *)(_UNK_029fdd80 + 0x29fdcd4);
  if (*pcVar12 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_029fdd84 + 0x29fdce8));
    *pcVar12 = '\x01';
  }
  iVar6 = func_0x02953fd4(0x1a1a,0);
  if (iVar6 == 0) {
    if (*(int *)(**(int **)(_UNK_029fdd88 + 0x29fdd44) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar6 = func_0x02c35d10(0x20,0);
    if (iVar6 == 0) {
      return 0;
    }
    pcVar12 = (char *)(_UNK_029f0e48 + 0x29f09dc);
    if (*pcVar12 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_029f0e4c + 0x29f09f0));
    ...
    iVar6 = func_0x029540a4(0x1a1a,0);
    if (iVar6 == 0) {
      func_0x014388e4();
    }
  }
