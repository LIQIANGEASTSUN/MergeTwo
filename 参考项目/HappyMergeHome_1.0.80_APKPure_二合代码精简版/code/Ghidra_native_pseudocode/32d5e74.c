...
int FUN_032e5e74(undefined4 param_1)

{
  ...
  iVar3 = func_0x02953fd4(0x835d,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x835d,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = FUN_032d6320(param_1);
  if (iVar3 == 0) {
    return 0;
  }
  pcVar6 = (char *)(_UNK_0330389c + 0x3303738);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_033038a0 + 0x330374c));
    func_0x01438628(*(undefined4 *)(_UNK_033038a4 + 0x3303758));
    func_0x01438628(*(undefined4 *)(_UNK_033038a8 + 0x3303764));
    func_0x01438628(*(undefined4 *)(_UNK_033038ac + 0x3303770));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x182b,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x182b,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_033038b0 + 0x33037c4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_033038b4 + 0x33037e0));
  piVar8 = *(int **)(_UNK_033038b8 + 0x33037f4);
  iVar7 = *piVar8;
  if (*(int *)(iVar7 + 0x74) == 0) {
    func_0x014387a4();
    iVar7 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_033038bc + 0x3303814);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar7 + 0x5c) + 0x858);
  if (iVar4 == 0) {
