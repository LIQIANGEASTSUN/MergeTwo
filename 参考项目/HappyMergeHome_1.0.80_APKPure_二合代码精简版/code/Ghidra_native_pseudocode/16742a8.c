...
undefined4 FUN_016842a8(undefined4 param_1,int param_2)

{
  ...
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01684a68 + 0x16842d8));
  ...
  if (iVar1 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      *piVar14 = iVar3;
      ...
      iVar3 = FUN_0167d8d4(param_1);
      uVar2 = *(undefined4 *)(param_2 + 8);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      func_0x024f064c(iVar3,uVar2,&iStack_28,**(undefined4 **)(_UNK_01684ae4 + 0x1684594));
      iVar3 = iStack_28;
      if (iStack_28 == 0) {
        func_0x014388e4();
      }
      ...
      iVar3 = func_0x014388d4(**(undefined4 **)(_UNK_01684af4 + 0x1684718));
      func_0x024f1124(iVar3,**(undefined4 **)(_UNK_01684af8 + 0x168472c));
      ...
      *piVar7 = iVar3;
      ...
      if (0 < *(int *)(iVar3 + 0xc)) {
        ...
        iVar3 = FUN_0167b358();
        if (iVar3 != 0) {
          func_0x0168ef24(iVar3,0);
        }
        if (*(int *)(**(int **)(_UNK_01684b00 + 0x16847a0) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_01684b04 + 0x16847c0));
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        ...
        while( true ) {
          ...
          func_0x020257a4(iVar10,0x329,uVar2,uVar4,0,0,0);
          iVar3 = iVar3 + 1;
        }
        if (*(int *)(**(int **)(_UNK_01684b10 + 0x168495c) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar3 = func_0x014e96a8(**(undefined4 **)(_UNK_01684b14 + 0x1684978));
        iVar9 = *piVar14;
        if (*(int *)(**(int **)(_UNK_01684b18 + 0x168498c) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar10 = func_0x014e9518(**(undefined4 **)(_UNK_01684b1c + 0x16849ac));
        if (iVar10 == 0) {
          func_0x014388e4();
        }
        ...
        func_0x02b75870(iVar3,iVar9,uVar4,1,0x112,0,0,0,0,0,0,0,uVar2,0,0);
        iVar1 = *piVar7;
        if (iVar1 == 0) {
          func_0x014388e4();
        }
