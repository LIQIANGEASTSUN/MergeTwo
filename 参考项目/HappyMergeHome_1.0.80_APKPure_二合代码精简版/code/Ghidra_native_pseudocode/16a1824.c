...
void FUN_016b1824(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar8 = (char *)(_UNK_016b18e8 + 0x16b183c);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016b18ec + 0x16b1850));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x88c9,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x88c9,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x016c393c(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_016b18f0 + 0x16b18c0) + 0x74) == 0) {
    func_0x014387a4();
  }
