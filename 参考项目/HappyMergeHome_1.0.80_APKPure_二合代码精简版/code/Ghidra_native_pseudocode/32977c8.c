...
uint FUN_032a77c8(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_032a78b0 + 0x32a77e8);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032a78b4 + 0x32a77fc));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8276,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8276,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_032a78b8 + 0x32a7878) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_032a3fc4();
  if (iVar1 == 0) {
  ...
  iVar3 = func_0x02953fd4(0x8277,0);
  if (iVar3 == 0) {
    ...
    iVar3 = func_0x02953fd4(0x8271,0);
    if (iVar3 == 0) {
      if (*(int *)(**(int **)(_UNK_032ae280 + 0x32ae014) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_032ae284 + 0x32ae030));
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x029a6fa8(iVar3,param_3,0);
      if (iVar3 != 0) {
        iVar9 = func_0x032a8694(iVar1);
        if (iVar9 == 0) {
          func_0x014388e4();
        }
        if (*(int *)(iVar9 + 0x10) != 0) {
          ...
          iVar3 = func_0x04cd2d7c(iVar9,uVar10,**(undefined4 **)(_UNK_032ae288 + 0x32ae0c0));
          if (iVar3 == 0) {
            return 0;
          }
        }
      }
      iVar3 = func_0x032a8e58(iVar1);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x046c26fc(iVar3,param_3,**(undefined4 **)(_UNK_032ae28c + 0x32ae0f8));
      if (iVar3 == 0) {
        ...
        if (iVar3 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_3,**(undefined4 **)(_UNK_032ae2a0 + 0x32ae1b0));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar3,param_3,**(undefined4 **)(_UNK_032ae29c + 0x32ae12c));
        }
        func_0x03b70fe4(iVar3,param_3,iVar9 + -1,**(undefined4 **)(_UNK_032ae2a4 + 0x32ae1d4));
        iVar3 = func_0x032a8e58(iVar1);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x03b70fac(iVar3,param_3,**(undefined4 **)(_UNK_032ae2a8 + 0x32ae204));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x032a8e58(iVar1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar3 = **(int **)(_UNK_032ae2ac + 0x32ae244);
...
LAB_046c3e4c:
    ...
    iVar3 = func_0x029540a4(0x8271,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar3 = func_0x029540a4(0x8277,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
