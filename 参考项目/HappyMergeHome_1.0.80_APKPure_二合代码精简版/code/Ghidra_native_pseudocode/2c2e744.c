...
uint FUN_02c3e744(undefined4 param_1,undefined4 param_2,int param_3)

{
  ...
  pcVar3 = (char *)(_UNK_02c3e9dc + 0x2c3e764);
  if (*pcVar3 == '\0') {
  ...
  if (iVar1 == 0) {
    iVar1 = FUN_02c3d564(param_1,param_2);
    if ((iVar1 != 0) &&
       (bVar9 = *(int *)(iVar1 + 0xc) != 0, uVar4 = (uint)bVar9, bVar9 && param_3 != 0)) {
      ...
      do {
        ...
        iVar1 = FUN_02bd149c(iVar2,uVar5,0);
      } while (iVar1 == 0);
      iVar1 = 8;
LAB_02c3e918:
