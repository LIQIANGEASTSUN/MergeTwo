...
int FUN_02fd8518(undefined4 param_1,int param_2)

{
  ...
  pcVar7 = (char *)(_UNK_02fd8660 + 0x2fd8530);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fd8664 + 0x2fd8544));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x70dd,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x70dd,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(iVar1 + 0xc) == 8) {
    if (*(int *)(**(int **)(_UNK_02fd8668 + 0x2fd85d0) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = FUN_02fcd8a4();
    if (iVar1 != 0) {
      func_0x02ff7acc(iVar1,0);
    }
  }
  iVar1 = FUN_02fcfc38(param_1);
  if (iVar1 == 0) {
  ...
  iVar1 = FUN_02fd7984(param_1);
  if (iVar5 < iVar1) {
    iVar1 = FUN_02fcfc38(param_1);
    uVar6 = FUN_02fd7984(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    FUN_026cf66c(iVar1,uVar6,0);
    pcVar7 = (char *)(_UNK_02fd84d0 + 0x2fd81ec);
    uStack_18 = unaff_r4;
    if (*pcVar7 == '\0') {
    ...
    if (0 < *(int *)(iVar1 + 0x74)) {
      ...
      if (iVar5 <= *(int *)(iVar1 + 0xc)) {
        ...
        uVar6 = func_0x04cd26d0(iVar5,iVar1 + -1,**(undefined4 **)(_UNK_02fd84f8 + 0x2fd8378));
      }
    }
    ...
    if (iVar1 == 0) {
      ...
      if (iVar5 != 0) {
        ...
        pcVar7 = (char *)(_UNK_02ffba80 + 0x2ffb724);
        if (*pcVar7 == '\0') {
          func_0x01438628(*(undefined4 *)(_UNK_02ffba84 + 0x2ffb738),uVar6,iVar1,0);
        ...
        if (iVar2 == 0) {
          ...
          *(undefined1 *)(iVar5 + 0xb0) = 1;
          ...
          iVar1 = func_0x046ccb14(iVar1,uVar6,**(undefined4 **)(_UNK_02ffbac0 + 0x2ffb8a0));
          if (iVar1 == 0) {
            uStack_1c = uVar6;
            uVar6 = func_0x014387ac(**(undefined4 **)(_UNK_02ffbac4 + 0x2ffb948),&uStack_1c);
            ...
            uVar4 = func_0x046cc810(iVar1,uVar6,**(undefined4 **)(_UNK_02ffbad0 + 0x2ffb8d0));
            ...
            if (iVar1 == 0) {
              ...
              uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02ffbae4 + 0x2ffb9e4));
              func_0x0152e3ec(uVar6,iVar2,**(undefined4 **)(_UNK_02ffbae8 + 0x2ffba08),0);
              ...
              iVar5 = func_0x02aee9b4(uVar4,**(undefined4 **)(_UNK_02ffbaf4 + 0x2ffba48),
                                      **(undefined4 **)(_UNK_02ffbaf0 + 0x2ffba3c),uVar6);
              if (iVar1 == 0) {
                func_0x014388e4();
              }
            ...
            uStack_20 = uVar6;
            uVar6 = func_0x014387ac(**(undefined4 **)(_UNK_02ffbad8 + 0x2ffb920),&uStack_20);
