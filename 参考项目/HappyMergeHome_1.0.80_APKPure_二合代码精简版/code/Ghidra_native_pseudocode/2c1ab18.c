...
undefined4 FUN_02c2ab18(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2acd8 + 0x2c2ab2c);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2acdc + 0x2c2ab40));
    func_0x01438628(*(undefined4 *)(_UNK_02c2ace0 + 0x2c2ab4c));
    func_0x01438628(*(undefined4 *)(_UNK_02c2ace4 + 0x2c2ab58));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d87,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d87,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2ace8 + 0x2c2ac80));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2acec + 0x2c2ac9c),0);
  if (*(int *)(**(int **)(_UNK_02c2acf0 + 0x2c2acb0) + 0x74) == 0) {
    func_0x014387a4();
  }
