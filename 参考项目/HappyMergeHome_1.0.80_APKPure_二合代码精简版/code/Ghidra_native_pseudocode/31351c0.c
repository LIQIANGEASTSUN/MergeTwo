...
uint FUN_031451c0(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_031452a8 + 0x31451e0);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031452ac + 0x31451f4));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7a0e,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7a0e,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_031452b0 + 0x3145270) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_0313e53c();
  if (iVar2 == 0) {
