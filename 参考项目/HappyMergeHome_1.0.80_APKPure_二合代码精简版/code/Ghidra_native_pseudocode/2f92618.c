...
void FUN_02fa2618(int param_1,undefined4 param_2)

{
  ...
  iVar2 = func_0x02953fd4(0x6fa6,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x6fa6,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (iVar2 != 0) {
    iVar2 = FUN_02fa2564(param_1,param_2);
    if (iVar2 != 0) {
      return;
    }
    iVar2 = FUN_02fa11b8(param_1,param_2);
    if (iVar2 != 0) {
