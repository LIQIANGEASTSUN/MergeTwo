...

{
  ...
  pcVar6 = (char *)(_UNK_017187f4 + 0x1718620);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017187f8 + 0x1718634));
    func_0x01438628(*(undefined4 *)(_UNK_017187fc + 0x1718640));
    func_0x01438628(*(undefined4 *)(_UNK_01718800 + 0x171864c));
    func_0x01438628(*(undefined4 *)(_UNK_01718804 + 0x1718658));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8b83,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8b83,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01718808 + 0x1718730) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0171880c + 0x171874c));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  ...
  if ((iVar2 != 0) && (0 < *(int *)(iVar2 + 0xc))) {
    ...
    iVar2 = func_0x0152983c(iVar2,0,**(undefined4 **)(_UNK_01718810 + 0x17187a0));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
