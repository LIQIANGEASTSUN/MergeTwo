...
uint FUN_02f4df98(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02f4e038 + 0x2f4dfac);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f4e03c + 0x2f4dfc0));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x6e0f,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x6e0f,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f4e040 + 0x2f4e018) + 0x74) == 0) {
    func_0x014387a4();
  }
