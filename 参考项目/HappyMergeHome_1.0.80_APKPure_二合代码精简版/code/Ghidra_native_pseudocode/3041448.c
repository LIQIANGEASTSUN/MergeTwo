...
undefined4 FUN_03051448(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_03051584 + 0x3051460);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03051588 + 0x3051474));
    func_0x01438628(*(undefined4 *)(_UNK_0305158c + 0x3051480));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7440,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7440,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x046c26fc(iVar1,param_2,**(undefined4 **)(_UNK_03051590 + 0x3051518));
  if (iVar1 != 0) {
    iVar1 = FUN_0304411c(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_03051594 + 0x3051570);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
