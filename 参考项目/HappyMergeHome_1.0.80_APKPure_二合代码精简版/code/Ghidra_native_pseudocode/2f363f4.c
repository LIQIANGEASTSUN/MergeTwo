...
undefined4 FUN_02f463f4(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_02f464e0 + 0x2f46408);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f464e4 + 0x2f4641c));
    func_0x01438628(*(undefined4 *)(_UNK_02f464e8 + 0x2f46428));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x6e00,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x6e00,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f464ec + 0x2f46480) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_02f464f0 + 0x2f4649c));
  iVar5 = FUN_02f45464(param_1);
  if (iVar5 == 0) {
    func_0x014388e4();
  }
