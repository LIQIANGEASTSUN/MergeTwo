...
void FUN_03016df8(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar7 = (char *)(_UNK_030171f8 + 0x3016e20);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030171fc + 0x3016e34));
    func_0x01438628(*(undefined4 *)(_UNK_03017200 + 0x3016e40));
    func_0x01438628(*(undefined4 *)(_UNK_03017204 + 0x3016e4c));
    func_0x01438628(*(undefined4 *)(_UNK_03017208 + 0x3016e58));
    func_0x01438628(*(undefined4 *)(_UNK_0301720c + 0x3016e64));
    func_0x01438628(*(undefined4 *)(_UNK_03017210 + 0x3016e70));
    func_0x01438628(*(undefined4 *)(_UNK_03017214 + 0x3016e7c));
    func_0x01438628(*(undefined4 *)(_UNK_03017218 + 0x3016e88));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x15b7,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_0301721c + 0x3016eec) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_03017220 + 0x3016f08));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    if ((int)(iVar6 - (iVar2 + (uint)bVar12)) < 0 !=
      ...
      func_0x03b70d24(iVar5,**(undefined4 **)(_UNK_03017224 + 0x3017094));
      uVar15 = FUN_03009c84(param_1);
      ...
      FUN_026ee084(iVar5,uVar11,uVar9,iVar2,0);
      if (*(int *)(**(int **)(_UNK_03017228 + 0x30170e8) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0301722c + 0x3017104));
      piVar10 = *(int **)(_UNK_03017230 + 0x3017118);
      iVar5 = *piVar10;
      if (*(int *)(iVar5 + 0x74) == 0) {
        func_0x014387a4();
        iVar5 = *piVar10;
      ...
      piVar10 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_03017234 + 0x301713c),1);
      uStack_54 = 0;
      iVar5 = func_0x014387ac(**(undefined4 **)(_UNK_03017238 + 0x301715c),&uStack_54);
      if (piVar10 == (int *)0x0) {
        func_0x014388e4();
      }
      if ((iVar5 != 0) &&
    ...
    iVar2 = func_0x029540a4(0x15b7,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
