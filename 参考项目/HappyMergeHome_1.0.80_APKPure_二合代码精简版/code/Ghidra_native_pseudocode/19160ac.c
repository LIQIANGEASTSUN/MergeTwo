...
void FUN_019260ac(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  pcVar3 = (char *)(_UNK_01926110 + 0x19260c0);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01926114 + 0x19260d4));
    *pcVar3 = '\x01';
    param_4 = extraout_r3;
  }
  piVar1 = *(int **)(_UNK_01926118 + 0x19260ec);
