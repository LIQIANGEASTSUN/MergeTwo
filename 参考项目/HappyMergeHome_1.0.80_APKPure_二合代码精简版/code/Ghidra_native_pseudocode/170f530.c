...
int FUN_0171f530(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_0171f650 + 0x171f544);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0171f654 + 0x171f558));
    func_0x01438628(*(undefined4 *)(_UNK_0171f658 + 0x171f564));
    func_0x01438628(*(undefined4 *)(_UNK_0171f65c + 0x171f570));
    func_0x01438628(*(undefined4 *)(_UNK_0171f660 + 0x171f57c));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x1fdf,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x1fdf,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0171f664 + 0x171f5d4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0171f668 + 0x171f5f0));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  ...
  iVar2 = func_0x0152983c(iVar2,*(int *)(iVar2 + 0xc) + -1,
                          **(undefined4 **)(_UNK_0171f66c + 0x171f620));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  iVar2 = *(int *)(iVar2 + 0x24);
  pcVar7 = (char *)(_UNK_0171d508 + 0x171d10c);
  iStack_24 = unaff_r4;
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0171d50c + 0x171d120));
    func_0x01438628(*(undefined4 *)(_UNK_0171d510 + 0x171d12c));
    func_0x01438628(*(undefined4 *)(_UNK_0171d514 + 0x171d138));
    func_0x01438628(*(undefined4 *)(_UNK_0171d518 + 0x171d144));
    func_0x01438628(*(undefined4 *)(_UNK_0171d51c + 0x171d150));
    func_0x01438628(*(undefined4 *)(_UNK_0171d520 + 0x171d15c));
    func_0x01438628(*(undefined4 *)(_UNK_0171d524 + 0x171d168));
    func_0x01438628(*(undefined4 *)(_UNK_0171d528 + 0x171d174));
    func_0x01438628(*(undefined4 *)(_UNK_0171d52c + 0x171d180));
    func_0x01438628(*(undefined4 *)(_UNK_0171d530 + 0x171d18c));
    *pcVar7 = '\x01';
  }
  iVar8 = func_0x02953fd4(0x1fe0,0);
  if (iVar8 == 0) {
    ...
    puVar11 = *(undefined4 **)(_UNK_0171d534 + 0x171d22c);
    iVar8 = func_0x024f0f34(iVar8,iVar2,*puVar11);
    if (iVar8 == 0) {
      if (*(int *)(**(int **)(_UNK_0171d538 + 0x171d24c) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar8 = func_0x014e9518(**(undefined4 **)(_UNK_0171d53c + 0x171d268));
      if (iVar8 == 0) {
        func_0x014388e4();
      }
      iVar8 = *(int *)(iVar8 + 0x2c);
      iVar9 = 0;
      puVar12 = *(undefined4 **)(_UNK_0171d540 + 0x171d290);
      while( true ) {
        if (iVar8 == 0) {
          func_0x014388e4();
        }
          ...
          while( true ) {
            ...
            if (*(int *)(iVar1 + 0x24) <= iVar2) {
              ...
              if (iVar1 == 0) {
                ...
                func_0x024f05ac(iVar1,uVar10,**(undefined4 **)(_UNK_0171d544 + 0x171d408));
              }
            }
            iVar9 = iVar9 + 1;
          }
          func_0x0171fc3c(param_1);
          if (*(int *)(**(int **)(_UNK_0171d548 + 0x171d42c) + 0x74) == 0) {
            func_0x014387a4();
          }
          iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0171d54c + 0x171d448));
          piVar6 = *(int **)(_UNK_0171d550 + 0x171d45c);
          iVar8 = *piVar6;
          if (*(int *)(iVar8 + 0x74) == 0) {
            func_0x014387a4();
            iVar8 = *piVar6;
          }
          iVar1 = **(int **)(_UNK_0171d554 + 0x171d47c);
  ...
  iVar8 = func_0x029540a4(0x1fe0,0);
  if (iVar8 == 0) {
    func_0x014388e4();
  }
  puStack_20 = (undefined4 *)iStack_24;
