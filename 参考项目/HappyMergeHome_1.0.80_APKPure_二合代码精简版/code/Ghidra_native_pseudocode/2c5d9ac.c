...
void FUN_02c6d9ac(int param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar8 = (char *)(_UNK_02c6da80 + 0x2c6d9cc);
  if (*pcVar8 == '\0') {
  ...
  if (iVar1 != 0) {
    ...
    uStack_20 = 0;
    func_0x028fd010(iVar1,param_1,param_2,param_3);
    return;
  }
  piVar2 = *(int **)(_UNK_02c6da88 + 0x2c6da48);
  ...
  *(undefined4 *)(iVar1 + 0x9c) = param_3;
  pcVar8 = (char *)(_UNK_02c6e96c + 0x2c6e644);
  if (*pcVar8 == '\0') {
...
SUB_02868e1c:
    ...
    func_0x024f56d0(iVar6,uVar3,&uStack_30,uVar4,0,0);
    return;
  }
  ...
  iVar1 = func_0x029a6fa8(iVar1,uVar3,0);
  ...
  *piVar2 = iVar1;
  ...
  puVar5 = *(undefined4 **)(_UNK_02c6e99c + 0x2c6e784);
  ...
  iVar1 = FUN_02bad204(iVar1,uVar4,uVar3,0);
  ...
  *piVar7 = iVar1;
  ...
  iVar1 = FUN_02bdd468(iVar1,uVar4,uVar3,0);
  if ((*piVar2 == 0 || iVar1 == 0) || ((*piVar7 != 0 && (*(int *)(*piVar7 + 0xc) == -1)))) {
    pcVar8 = (char *)(_UNK_02c6eb50 + 0x2c6e9c4);
    if (*pcVar8 == '\0') {
    ...
    *(undefined4 *)(param_1 + 0x90) = 0;
    ...
    if (iVar1 != 0) {
      ...
      uVar3 = FUN_02c4a818(iVar1,iVar6,0);
    }
  ...
  (*(code *)&UNK_05d3ec04)(iVar1,uVar3,0);
  return;
}
