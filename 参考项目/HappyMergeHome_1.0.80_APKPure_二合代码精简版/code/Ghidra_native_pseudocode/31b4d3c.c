...
void FUN_031c4d3c(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar7 = (char *)(_UNK_031c4ef8 + 0x31c4d54);
  if (*pcVar7 == '\0') {
  ...
  iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_031c4f0c + 0x31c4e24));
  iVar5 = FUN_031b7b88(param_1);
  if (iVar5 == 0) {
    func_0x014388e4();
  }
  ...
  if (iVar5 == 0) {
    ...
    iVar2 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_031c4f10 + 0x31c4ea8));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_031c4ed8:
    ...
    iVar2 = func_0x03b70fac(iVar5,param_2,**(undefined4 **)(_UNK_031c4f14 + 0x31c4e7c));
  }
  unaff_r7 = iVar2 + 1;
