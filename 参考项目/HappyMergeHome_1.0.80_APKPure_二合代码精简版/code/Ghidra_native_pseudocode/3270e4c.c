...
void FUN_03280e4c(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_03280fac + 0x3280e60);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03280fb0 + 0x3280e74));
    func_0x01438628(*(undefined4 *)(_UNK_03280fb4 + 0x3280e80));
    func_0x01438628(*(undefined4 *)(_UNK_03280fb8 + 0x3280e8c));
    func_0x01438628(*(undefined4 *)(_UNK_03280fbc + 0x3280e98));
    *pcVar7 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x1f45,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x1f45,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03280fc0 + 0x3280ef0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x04e4a028(**(undefined4 **)(_UNK_03280fc4 + 0x3280f0c));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  ...
  if ((iVar4 != 0) && (0 < *(int *)(iVar4 + 0xc))) {
    ...
    iVar4 = func_0x04cfd760(iVar4,0,**(undefined4 **)(_UNK_03280fc8 + 0x3280f60));
    if (iVar4 == 0) {
      func_0x014388e4();
    }
