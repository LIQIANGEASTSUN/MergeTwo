...

{
  ...
  pcVar7 = (char *)(_UNK_0308484c + 0x30847b8);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03084850 + 0x30847cc));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x75a5,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x75a5,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar6 = **(int **)(_UNK_03084854 + 0x3084840);
