...
undefined4 FUN_02c2c910(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2cad0 + 0x2c2c924);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2cad4 + 0x2c2c938));
    func_0x01438628(*(undefined4 *)(_UNK_02c2cad8 + 0x2c2c944));
    func_0x01438628(*(undefined4 *)(_UNK_02c2cadc + 0x2c2c950));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5da7,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5da7,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2cae0 + 0x2c2ca78));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2cae4 + 0x2c2ca94),0);
  if (*(int *)(**(int **)(_UNK_02c2cae8 + 0x2c2caa8) + 0x74) == 0) {
    func_0x014387a4();
  }
