...
int FUN_016c19e8(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_016c1b08 + 0x16c19fc);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016c1b0c + 0x16c1a10));
    func_0x01438628(*(undefined4 *)(_UNK_016c1b10 + 0x16c1a1c));
    func_0x01438628(*(undefined4 *)(_UNK_016c1b14 + 0x16c1a28));
    func_0x01438628(*(undefined4 *)(_UNK_016c1b18 + 0x16c1a34));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x1ec5,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x1ec5,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_016c1b1c + 0x16c1a8c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_016c1b20 + 0x16c1aa8));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  ...
  iVar2 = func_0x0152983c(iVar2,*(int *)(iVar2 + 0xc) + -1,
                          **(undefined4 **)(_UNK_016c1b24 + 0x16c1ad8));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  iVar2 = *(int *)(iVar2 + 0x24);
  pcVar7 = (char *)(_UNK_016c0904 + 0x16c0508);
  iStack_24 = unaff_r4;
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016c0908 + 0x16c051c));
    func_0x01438628(*(undefined4 *)(_UNK_016c090c + 0x16c0528));
    func_0x01438628(*(undefined4 *)(_UNK_016c0910 + 0x16c0534));
    func_0x01438628(*(undefined4 *)(_UNK_016c0914 + 0x16c0540));
    func_0x01438628(*(undefined4 *)(_UNK_016c0918 + 0x16c054c));
    func_0x01438628(*(undefined4 *)(_UNK_016c091c + 0x16c0558));
    func_0x01438628(*(undefined4 *)(_UNK_016c0920 + 0x16c0564));
    func_0x01438628(*(undefined4 *)(_UNK_016c0924 + 0x16c0570));
    func_0x01438628(*(undefined4 *)(_UNK_016c0928 + 0x16c057c));
    func_0x01438628(*(undefined4 *)(_UNK_016c092c + 0x16c0588));
    *pcVar7 = '\x01';
  }
  iVar8 = func_0x02953fd4(0x1ec6,0);
  if (iVar8 == 0) {
    iVar8 = func_0x016b6be8(param_1);
    if (iVar8 == 0) {
      func_0x014388e4();
    }
    ...
    puVar11 = *(undefined4 **)(_UNK_016c0930 + 0x16c0628);
    iVar8 = func_0x024f0f34(iVar8,iVar2,*puVar11);
    if (iVar8 == 0) {
      if (*(int *)(**(int **)(_UNK_016c0934 + 0x16c0648) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar8 = func_0x014e9518(**(undefined4 **)(_UNK_016c0938 + 0x16c0664));
      if (iVar8 == 0) {
        func_0x014388e4();
      }
      iVar8 = *(int *)(iVar8 + 0x38);
      iVar9 = 0;
      puVar12 = *(undefined4 **)(_UNK_016c093c + 0x16c068c);
      while( true ) {
        if (iVar8 == 0) {
          func_0x014388e4();
        }
          ...
          while( true ) {
            ...
            if (*(int *)(iVar1 + 0x24) <= iVar2) {
              ...
              if (iVar1 == 0) {
                ...
                func_0x024f05ac(iVar1,uVar10,**(undefined4 **)(_UNK_016c0940 + 0x16c0804));
              }
            }
            iVar9 = iVar9 + 1;
          }
          func_0x016c1cac(param_1);
          if (*(int *)(**(int **)(_UNK_016c0944 + 0x16c0828) + 0x74) == 0) {
            func_0x014387a4();
          }
          iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_016c0948 + 0x16c0844));
          piVar6 = *(int **)(_UNK_016c094c + 0x16c0858);
          iVar8 = *piVar6;
          if (*(int *)(iVar8 + 0x74) == 0) {
            func_0x014387a4();
            iVar8 = *piVar6;
          }
          iVar1 = **(int **)(_UNK_016c0950 + 0x16c0878);
  ...
  iVar8 = func_0x029540a4(0x1ec6,0);
  if (iVar8 == 0) {
    func_0x014388e4();
  }
  puStack_20 = (undefined4 *)iStack_24;
