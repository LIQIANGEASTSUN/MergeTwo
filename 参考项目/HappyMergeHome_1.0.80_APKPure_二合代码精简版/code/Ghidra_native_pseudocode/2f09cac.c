...

{
  ...
  pcVar4 = (char *)(_UNK_02f19d58 + 0x2f19cbc);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f19d5c + 0x2f19cd0));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x6cca,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x6cca,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f19d60 + 0x2f19d24) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_02f190cc();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
