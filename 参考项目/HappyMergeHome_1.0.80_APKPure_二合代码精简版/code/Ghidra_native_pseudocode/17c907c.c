...

{
  ...
  pcVar6 = (char *)(_UNK_017d9124 + 0x17d9090);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017d9128 + 0x17d90a4));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8fa9,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8fa9,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar7 = **(int **)(_UNK_017d912c + 0x17d9118);
