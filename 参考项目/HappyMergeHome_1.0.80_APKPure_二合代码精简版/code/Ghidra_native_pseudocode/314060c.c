...

{
  ...
  pcVar6 = (char *)(_UNK_03150770 + 0x3150620);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03150774 + 0x3150634));
    func_0x01438628(*(undefined4 *)(_UNK_03150778 + 0x3150640));
    func_0x01438628(*(undefined4 *)(_UNK_0315077c + 0x315064c));
    func_0x01438628(*(undefined4 *)(_UNK_03150780 + 0x3150658));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x2041,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_03150784 + 0x31506b0) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_03150788 + 0x31506cc));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    if ((iVar2 != 0) && (0 < *(int *)(iVar2 + 0xc))) {
      ...
      iVar2 = func_0x04cfd760(iVar2,0,**(undefined4 **)(_UNK_0315078c + 0x3150720));
      if (iVar2 == 0) {
        func_0x014388e4();
      }
    ...
    iVar2 = func_0x029540a4(0x2041,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
