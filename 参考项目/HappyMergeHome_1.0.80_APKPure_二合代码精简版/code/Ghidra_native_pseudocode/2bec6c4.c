...
void FUN_02bfc6c4(int param_1,int param_2)

{
  ...
  iVar3 = func_0x02953fd4(0x5ee7,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x5ee7,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = func_0x02953fd4(0x2186,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x2186,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (iVar3 != 0) {
    ...
    func_0x02bfc7e8(param_1);
    func_0x02bfcc54(param_1,*(undefined4 *)(param_1 + 0xb8));
