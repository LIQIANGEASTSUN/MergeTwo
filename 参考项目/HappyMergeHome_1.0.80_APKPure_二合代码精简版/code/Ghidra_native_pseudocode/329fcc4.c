...
void FUN_032afcc4(undefined4 param_1,int param_2)

{
  ...
  iVar3 = func_0x02953fd4(0x46a,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x46a,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(iVar3 + 0x78) == param_2) {
    return;
  }
  piVar1 = *(int **)(_UNK_026eee34 + 0x26eede0);
  *(int *)(iVar3 + 0x78) = param_2;
  if (*(int *)(*piVar1 + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_026eee38 + 0x26eee00));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
