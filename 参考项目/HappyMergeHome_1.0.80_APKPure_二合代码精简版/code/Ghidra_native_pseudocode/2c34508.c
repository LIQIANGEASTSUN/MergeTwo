...

{
  ...
  pcVar3 = (char *)(_UNK_02c445bc + 0x2c4451c);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c445c0 + 0x2c44530));
    func_0x01438628(*(undefined4 *)(_UNK_02c445c4 + 0x2c4453c));
    *pcVar3 = '\x01';
  }
  iVar4 = *(int *)(param_1 + 8);
  ...
  iVar2 = *(int *)(iVar2 + 8) + -1;
  if (iVar4 == iVar2) {
    if (*(int *)(**(int **)(_UNK_02c445c8 + 0x2c44574) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_02c445cc + 0x2c44590));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
