...
int FUN_0164c004(undefined4 param_1,int param_2)

{
  ...
  pcVar5 = (char *)(_UNK_0164c41c + 0x164c020);
  if (*pcVar5 == '\0') {
  ...
  iVar1 = func_0x02953fd4(0x2019,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x2019,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  puVar10 = *(undefined4 **)(_UNK_0164c448 + 0x164c140);
  iVar1 = func_0x024f0f34(iVar1,param_2,*puVar10);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_0164c44c + 0x164c160) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0164c450 + 0x164c17c));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    iVar1 = *(int *)(iVar1 + 0x38);
    iVar8 = 0;
    puVar11 = *(undefined4 **)(_UNK_0164c454 + 0x164c1a4);
    do {
      if (iVar1 == 0) {
        func_0x014388e4();
      }
    ...
    while( true ) {
      ...
      if (*(int *)(iVar2 + 0x24) <= param_2) {
        ...
        if (iVar2 == 0) {
          ...
          func_0x024f05ac(iVar2,uVar9,**(undefined4 **)(_UNK_0164c458 + 0x164c31c));
        }
      }
      iVar8 = iVar8 + 1;
    }
    ...
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0164c460 + 0x164c35c));
    piVar7 = *(int **)(_UNK_0164c464 + 0x164c370);
    iVar8 = *piVar7;
    if (*(int *)(iVar8 + 0x74) == 0) {
      func_0x014387a4();
      iVar8 = *piVar7;
    }
    iVar6 = **(int **)(_UNK_0164c468 + 0x164c390);
