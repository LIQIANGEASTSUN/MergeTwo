...
undefined4 FUN_02c2b288(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2b448 + 0x2c2b29c);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2b44c + 0x2c2b2b0));
    func_0x01438628(*(undefined4 *)(_UNK_02c2b450 + 0x2c2b2bc));
    func_0x01438628(*(undefined4 *)(_UNK_02c2b454 + 0x2c2b2c8));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d8f,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d8f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2b458 + 0x2c2b3f0));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2b45c + 0x2c2b40c),0);
  if (*(int *)(**(int **)(_UNK_02c2b460 + 0x2c2b420) + 0x74) == 0) {
    func_0x014387a4();
  }
