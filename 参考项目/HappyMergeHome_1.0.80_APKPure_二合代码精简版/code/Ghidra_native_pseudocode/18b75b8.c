...

{
  ...
  pcVar6 = (char *)(_UNK_018c77a4 + 0x18c75d0);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018c77a8 + 0x18c75e4));
    func_0x01438628(*(undefined4 *)(_UNK_018c77ac + 0x18c75f0));
    func_0x01438628(*(undefined4 *)(_UNK_018c77b0 + 0x18c75fc));
    func_0x01438628(*(undefined4 *)(_UNK_018c77b4 + 0x18c7608));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x9538,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x9538,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_018c77b8 + 0x18c76e0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_018c77bc + 0x18c76fc));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  ...
  if ((iVar2 != 0) && (0 < *(int *)(iVar2 + 0xc))) {
    ...
    iVar2 = func_0x0152983c(iVar2,0,**(undefined4 **)(_UNK_018c77c0 + 0x18c7750));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
