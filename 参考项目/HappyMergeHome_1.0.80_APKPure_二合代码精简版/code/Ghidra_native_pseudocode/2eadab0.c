...
void FUN_02ebdab0(undefined4 param_1,int param_2)

{
  ...
  iVar3 = func_0x02953fd4(0x4af,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x4af,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  param_2 = *(int *)(iVar3 + 0x24) + param_2;
  pcVar6 = (char *)(_UNK_026c2a20 + 0x26c2998);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_026c2a24 + 0x26c29ac),param_2,0);
  ...
  *(int *)(iVar3 + 0x24) = param_2;
  ...
  iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_026c2a30 + 0x26c29f8));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
