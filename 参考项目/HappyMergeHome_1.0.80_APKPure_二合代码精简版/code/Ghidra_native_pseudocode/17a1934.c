...

{
  ...
  pcVar4 = (char *)(_UNK_017b19f0 + 0x17b1948);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017b19f4 + 0x17b195c));
    func_0x01438628(*(undefined4 *)(_UNK_017b19f8 + 0x17b1968));
    *pcVar4 = '\x01';
  }
  if (*(int *)(**(int **)(_UNK_017b19fc + 0x17b197c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_017b1a00 + 0x17b1998));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  func_0x02bb3638(iVar1,0x27,0);
