...
uint FUN_0317d8d0(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_0317d9b8 + 0x317d8f0);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0317d9bc + 0x317d904));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7b87,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7b87,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0317d9c0 + 0x317d980) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_031783f4();
  if (iVar1 == 0) {
  ...
  pcVar11 = (char *)(_UNK_0317dae4 + 0x317d9dc);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0317dae8 + 0x317d9f0));
    func_0x01438628(*(undefined4 *)(_UNK_0317daec + 0x317d9fc));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7b88,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_0317daf0 + 0x317da58) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_0317daf4 + 0x317da74));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_03186410 + 0x31861dc);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_03186414 + 0x31861f0));
      func_0x01438628(*(undefined4 *)(_UNK_03186418 + 0x31861fc));
      func_0x01438628(*(undefined4 *)(_UNK_0318641c + 0x3186208));
      func_0x01438628(*(undefined4 *)(_UNK_03186420 + 0x3186214));
      func_0x01438628(*(undefined4 *)(_UNK_03186424 + 0x3186220));
      func_0x01438628(*(undefined4 *)(_UNK_03186428 + 0x318622c));
      func_0x01438628(*(undefined4 *)(_UNK_0318642c + 0x3186238));
      *pcVar11 = '\x01';
    }
    iVar3 = func_0x02953fd4(0x7b67,0);
    if (iVar3 == 0) {
      iVar3 = func_0x031804a0(iVar1);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x046c26fc(iVar3,param_3,**(undefined4 **)(_UNK_03186430 + 0x31862b4));
      if (iVar3 == 0) {
        uVar10 = func_0x0515c4b0(&uStack_1c,0);
        uVar10 = func_0x04f6b198(**(undefined4 **)(_UNK_03186434 + 0x3186318),uVar10,
                                 **(undefined4 **)(_UNK_03186438 + 0x3186324),0);
        if (*(int *)(**(int **)(_UNK_0318643c + 0x3186338) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar3 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_3,**(undefined4 **)(_UNK_03186444 + 0x318636c));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar3,param_3,**(undefined4 **)(_UNK_03186440 + 0x31862e8));
        }
        func_0x03b70fe4(iVar3,param_3,iVar9 + -1,**(undefined4 **)(_UNK_03186448 + 0x3186390));
        iVar3 = func_0x031804a0(iVar1);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x03b70fac(iVar3,param_3,**(undefined4 **)(_UNK_0318644c + 0x31863c0));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x031804a0(iVar1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar3 = **(int **)(_UNK_03186450 + 0x3186400);
...
LAB_046c3e4c:
    ...
    iVar3 = func_0x029540a4(0x7b67,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar3 = func_0x029540a4(0x7b88,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
