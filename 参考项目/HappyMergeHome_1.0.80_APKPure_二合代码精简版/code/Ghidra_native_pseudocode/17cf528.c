...
void FUN_017df528(undefined4 param_1,int param_2)

{
  ...
  iVar1 = func_0x02953fd4(0x2928,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x2928,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  pcVar6 = (char *)(_UNK_026ed6d8 + 0x26ed650);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_026ed6dc + 0x26ed664),param_2,0);
