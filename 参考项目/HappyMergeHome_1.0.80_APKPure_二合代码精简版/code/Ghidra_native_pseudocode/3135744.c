...

{
  ...
  pcVar4 = (char *)(_UNK_031457f0 + 0x3145754);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031457f4 + 0x3145768));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7a14,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7a14,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_031457f8 + 0x31457bc) + 0x74) == 0) {
    func_0x014387a4();
  }
