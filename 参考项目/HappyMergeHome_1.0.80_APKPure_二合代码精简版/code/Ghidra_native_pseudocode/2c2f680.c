...

{
  ...
  pcVar5 = (char *)(_UNK_02c3f70c + 0x2c3f690);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c3f710 + 0x2c3f6a4));
    func_0x01438628(*(undefined4 *)(_UNK_02c3f714 + 0x2c3f6b0));
    *pcVar5 = '\x01';
  }
  if (*(int *)(**(int **)(_UNK_02c3f718 + 0x2c3f6c4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x014e9518(**(undefined4 **)(_UNK_02c3f71c + 0x2c3f6e0));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
