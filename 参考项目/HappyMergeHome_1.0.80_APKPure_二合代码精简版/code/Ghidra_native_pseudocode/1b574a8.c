...
uint FUN_01b674a8(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  iVar2 = func_0x02953fd4(0xa6d4,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0xa6d4,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  pcVar10 = (char *)(_UNK_01b5effc + 0x1b5eeec);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01b5f000 + 0x1b5ef00));
    func_0x01438628(*(undefined4 *)(_UNK_01b5f004 + 0x1b5ef0c));
    *pcVar10 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xa6a1,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xa6a1,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
SUB_0286c2b8:
  ...
  iVar1 = FUN_01b5b268(iVar2);
  uVar3 = 0;
  if (iVar1 != 0) {
    if (*(int *)(**(int **)(_UNK_01b5f008 + 0x1b5ef78) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01b5f00c + 0x1b5ef94));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    if (iVar1 != 0) {
      ...
      if (uVar12 != uVar3) {
        pcVar10 = (char *)(_UNK_01b5eea8 + 0x1b5ecf4);
        if (*pcVar10 == '\0') {
          func_0x01438628(*(undefined4 *)(_UNK_01b5eeac + 0x1b5ed08));
          func_0x01438628(*(undefined4 *)(_UNK_01b5eeb0 + 0x1b5ed14));
          func_0x01438628(*(undefined4 *)(_UNK_01b5eeb4 + 0x1b5ed20));
          func_0x01438628(*(undefined4 *)(_UNK_01b5eeb8 + 0x1b5ed2c));
          *pcVar10 = '\x01';
        }
        iVar1 = func_0x02953fd4(0xa6a0,0);
        if (iVar1 == 0) {
          iVar1 = FUN_01b5bb4c(iVar2);
          if (iVar1 != 0) {
            iVar1 = FUN_01b5bb4c(iVar2);
            if (iVar1 == 0) {
              func_0x014388e4();
            }
            iVar1 = func_0x024f0540(iVar1,param_3,**(undefined4 **)(_UNK_01b5eebc + 0x1b5edb4));
            if (iVar1 != 0) {
              iVar1 = FUN_01b5bb4c(iVar2);
              if (iVar1 == 0) {
                func_0x014388e4();
                iVar9 = func_0x024f05d4(0,param_3,**(undefined4 **)(_UNK_01b5eec4 + 0x1b5ee10));
                func_0x014388e4();
              }
              else {
                iVar9 = func_0x024f05d4(iVar1,param_3,**(undefined4 **)(_UNK_01b5eec0 + 0x1b5ede8));
              }
              func_0x024f10d4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_01b5eec8 + 0x1b5ee34))
              ;
              iVar1 = FUN_01b5bb4c(iVar2);
              if (iVar1 == 0) {
                func_0x014388e4();
              }
              uVar3 = func_0x024f05d4(iVar1,param_3,**(undefined4 **)(_UNK_01b5eecc + 0x1b5ee64));
              if (0 < (int)uVar3) {
                return uVar3;
              }
              iVar2 = FUN_01b5bb4c(iVar2);
              if (iVar2 == 0) {
                func_0x014388e4();
              }
              iVar1 = **(int **)(_UNK_01b5eed0 + 0x1b5ee9c);
...
LAB_046c3e4c:
        ...
        iVar1 = func_0x029540a4(0xa6a0,0);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        goto SUB_0286c2b8;
