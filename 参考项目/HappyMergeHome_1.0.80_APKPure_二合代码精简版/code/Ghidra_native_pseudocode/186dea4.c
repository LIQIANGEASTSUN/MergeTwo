...
int FUN_0187dea4(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_0187dfc4 + 0x187deb8);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0187dfc8 + 0x187decc));
    func_0x01438628(*(undefined4 *)(_UNK_0187dfcc + 0x187ded8));
    func_0x01438628(*(undefined4 *)(_UNK_0187dfd0 + 0x187dee4));
    func_0x01438628(*(undefined4 *)(_UNK_0187dfd4 + 0x187def0));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x1e11,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x1e11,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0187dfd8 + 0x187df48) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0187dfdc + 0x187df64));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  ...
  iVar2 = func_0x0152983c(iVar2,*(int *)(iVar2 + 0xc) + -1,
                          **(undefined4 **)(_UNK_0187dfe0 + 0x187df94));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  iVar2 = *(int *)(iVar2 + 0x1c);
  pcVar7 = (char *)(_UNK_0187cf34 + 0x187cb38);
  iStack_24 = unaff_r4;
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0187cf38 + 0x187cb4c));
    func_0x01438628(*(undefined4 *)(_UNK_0187cf3c + 0x187cb58));
    func_0x01438628(*(undefined4 *)(_UNK_0187cf40 + 0x187cb64));
    func_0x01438628(*(undefined4 *)(_UNK_0187cf44 + 0x187cb70));
    func_0x01438628(*(undefined4 *)(_UNK_0187cf48 + 0x187cb7c));
    func_0x01438628(*(undefined4 *)(_UNK_0187cf4c + 0x187cb88));
    func_0x01438628(*(undefined4 *)(_UNK_0187cf50 + 0x187cb94));
    func_0x01438628(*(undefined4 *)(_UNK_0187cf54 + 0x187cba0));
    func_0x01438628(*(undefined4 *)(_UNK_0187cf58 + 0x187cbac));
    func_0x01438628(*(undefined4 *)(_UNK_0187cf5c + 0x187cbb8));
    *pcVar7 = '\x01';
  }
  iVar8 = func_0x02953fd4(0x1e12,0);
  if (iVar8 == 0) {
    iVar8 = FUN_01873864(param_1);
    if (iVar8 == 0) {
      func_0x014388e4();
    }
    ...
    puVar11 = *(undefined4 **)(_UNK_0187cf60 + 0x187cc58);
    iVar8 = func_0x024f0f34(iVar8,iVar2,*puVar11);
    if (iVar8 == 0) {
      if (*(int *)(**(int **)(_UNK_0187cf64 + 0x187cc78) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar8 = func_0x014e9518(**(undefined4 **)(_UNK_0187cf68 + 0x187cc94));
      if (iVar8 == 0) {
        func_0x014388e4();
      }
      iVar8 = *(int *)(iVar8 + 0x30);
      iVar9 = 0;
      puVar12 = *(undefined4 **)(_UNK_0187cf6c + 0x187ccbc);
      while( true ) {
        if (iVar8 == 0) {
          func_0x014388e4();
        }
          ...
          while( true ) {
            ...
            if (*(int *)(iVar1 + 0x1c) <= iVar2) {
              ...
              if (iVar1 == 0) {
                ...
                func_0x024f05ac(iVar1,uVar10,**(undefined4 **)(_UNK_0187cf70 + 0x187ce34));
              }
            }
            iVar9 = iVar9 + 1;
          }
          func_0x0187e5b0(param_1);
          if (*(int *)(**(int **)(_UNK_0187cf74 + 0x187ce58) + 0x74) == 0) {
            func_0x014387a4();
          }
          iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0187cf78 + 0x187ce74));
          piVar6 = *(int **)(_UNK_0187cf7c + 0x187ce88);
          iVar8 = *piVar6;
          if (*(int *)(iVar8 + 0x74) == 0) {
            func_0x014387a4();
            iVar8 = *piVar6;
          }
          iVar1 = **(int **)(_UNK_0187cf80 + 0x187cea8);
  ...
  iVar8 = func_0x029540a4(0x1e12,0);
  if (iVar8 == 0) {
    func_0x014388e4();
  }
  puStack_20 = (undefined4 *)iStack_24;
