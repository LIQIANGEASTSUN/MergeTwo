...
void FUN_031b29b4(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_031b2a78 + 0x31b29cc);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031b2a7c + 0x31b29e0));
    *pcVar10 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x7cc0,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x7cc0,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x031c4754(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_031b2a80 + 0x31b2a50) + 0x74) == 0) {
    func_0x014387a4();
  }
