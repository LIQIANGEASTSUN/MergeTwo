...
void FUN_03249c74(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar7 = (char *)(_UNK_0324a074 + 0x3249c9c);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0324a078 + 0x3249cb0));
    func_0x01438628(*(undefined4 *)(_UNK_0324a07c + 0x3249cbc));
    func_0x01438628(*(undefined4 *)(_UNK_0324a080 + 0x3249cc8));
    func_0x01438628(*(undefined4 *)(_UNK_0324a084 + 0x3249cd4));
    func_0x01438628(*(undefined4 *)(_UNK_0324a088 + 0x3249ce0));
    func_0x01438628(*(undefined4 *)(_UNK_0324a08c + 0x3249cec));
    func_0x01438628(*(undefined4 *)(_UNK_0324a090 + 0x3249cf8));
    func_0x01438628(*(undefined4 *)(_UNK_0324a094 + 0x3249d04));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x16fc,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_0324a098 + 0x3249d68) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0324a09c + 0x3249d84));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    if ((int)(iVar6 - (iVar2 + (uint)bVar12)) < 0 !=
      ...
      func_0x03b70d24(iVar5,**(undefined4 **)(_UNK_0324a0a0 + 0x3249f10));
      uVar15 = FUN_0323c5d0(param_1);
      ...
      if (*(int *)(**(int **)(_UNK_0324a0a4 + 0x3249f64) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0324a0a8 + 0x3249f80));
      piVar10 = *(int **)(_UNK_0324a0ac + 0x3249f94);
      iVar5 = *piVar10;
      if (*(int *)(iVar5 + 0x74) == 0) {
        func_0x014387a4();
        iVar5 = *piVar10;
      ...
      piVar10 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_0324a0b0 + 0x3249fb8),1);
      uStack_54 = 0;
      iVar5 = func_0x014387ac(**(undefined4 **)(_UNK_0324a0b4 + 0x3249fd8),&uStack_54);
      if (piVar10 == (int *)0x0) {
        func_0x014388e4();
      }
      if ((iVar5 != 0) &&
    ...
    iVar2 = func_0x029540a4(0x16fc,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
