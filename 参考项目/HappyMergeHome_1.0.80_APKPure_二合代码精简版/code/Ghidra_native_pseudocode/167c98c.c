...
undefined4 FUN_0168c98c(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar5 = (char *)(_UNK_0168cac8 + 0x168c9a4);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0168cacc + 0x168c9b8));
    func_0x01438628(*(undefined4 *)(_UNK_0168cad0 + 0x168c9c4));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x87c3,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x87c3,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_0168cad4 + 0x168ca5c));
  if (iVar1 != 0) {
    iVar1 = FUN_0167c750(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_0168cad8 + 0x168cab4);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
