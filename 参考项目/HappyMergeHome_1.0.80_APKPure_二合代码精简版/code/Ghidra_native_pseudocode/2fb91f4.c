...

{
  ...
  pcVar7 = (char *)(_UNK_02fc9354 + 0x2fc9208);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fc9358 + 0x2fc921c));
    func_0x01438628(*(undefined4 *)(_UNK_02fc935c + 0x2fc9228));
    func_0x01438628(*(undefined4 *)(_UNK_02fc9360 + 0x2fc9234));
    *pcVar7 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x2bd4,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x2bd4,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02fc9364 + 0x2fc928c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_02fc9368 + 0x2fc92a8));
  uVar9 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar10 = **(int **)(_UNK_02fc936c + 0x2fc92d4);
