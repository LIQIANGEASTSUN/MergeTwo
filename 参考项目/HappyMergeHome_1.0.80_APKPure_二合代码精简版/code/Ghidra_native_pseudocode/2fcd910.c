...
undefined4 FUN_02fdd910(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_02fdda4c + 0x2fdd928);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fdda50 + 0x2fdd93c));
    func_0x01438628(*(undefined4 *)(_UNK_02fdda54 + 0x2fdd948));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7130,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7130,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x046c26fc(iVar1,param_2,**(undefined4 **)(_UNK_02fdda58 + 0x2fdd9e0));
  if (iVar1 != 0) {
    iVar1 = FUN_02fcfc38(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_02fdda5c + 0x2fdda38);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
