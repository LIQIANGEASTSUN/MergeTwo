...
int FUN_01843134(undefined4 param_1,int param_2)

{
  ...
  pcVar6 = (char *)(_UNK_0184327c + 0x184314c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01843280 + 0x1843160));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x921d,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x921d,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(iVar1 + 0xc) == 8) {
    if (*(int *)(**(int **)(_UNK_01843284 + 0x18431ec) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = FUN_018386ac();
    if (iVar1 != 0) {
      func_0x01861298(iVar1,0);
    }
  }
  iVar1 = FUN_0183a850(param_1);
  if (iVar1 == 0) {
  ...
  iVar1 = FUN_018425a0(param_1);
  if (iVar5 < iVar1) {
    iVar1 = FUN_0183a850(param_1);
    uVar7 = FUN_018425a0(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    func_0x026cf66c(iVar1,uVar7,0);
    pcVar6 = (char *)(_UNK_018430ec + 0x1842e08);
    uStack_18 = unaff_r4;
    if (*pcVar6 == '\0') {
    ...
    if (0 < *(int *)(iVar1 + 0x74)) {
      ...
      if (iVar5 <= *(int *)(iVar1 + 0xc)) {
        ...
        uVar7 = func_0x024f0530(iVar5,iVar1 + -1,**(undefined4 **)(_UNK_01843114 + 0x1842f94));
      }
    }
    ...
    uVar4 = *(undefined4 *)(*(int *)(iVar5 + 0x5c) + 0x7e8);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    if (iVar1 == 0) {
      ...
      if (iVar5 != 0) {
        ...
        pcVar6 = (char *)(_UNK_018652a0 + 0x1864f44);
        if (*pcVar6 == '\0') {
          ...
          *(undefined1 *)(iVar5 + 0xb0) = 1;
          ...
          if (iVar1 == 0) {
            ...
            if (iVar1 == 0) {
              ...
              uStack_28 = 1;
              uStack_24 = 0;
              iVar5 = func_0x02aee9b4(uVar4,**(undefined4 **)(_UNK_01865314 + 0x1865268),
