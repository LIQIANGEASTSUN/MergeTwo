...
void FUN_019365f0(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar2 = func_0x024f0540(iVar2,param_2,**(undefined4 **)(_UNK_019367c0 + 0x19366d8));
  ...
  if (iVar5 == 0) {
    ...
    iVar2 = func_0x024f05d4(0,param_2,**(undefined4 **)(_UNK_019367c4 + 0x193675c));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_0193678c:
    ...
    iVar2 = func_0x024f05d4(iVar5,param_2,**(undefined4 **)(_UNK_019367c8 + 0x1936730));
  }
  unaff_r7 = iVar2 + 1;
