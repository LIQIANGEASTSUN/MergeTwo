...
void FUN_0196ca40(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar6 = (char *)(_UNK_0196ccbc + 0x196ca68);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0196ccc0 + 0x196ca7c));
    func_0x01438628(*(undefined4 *)(_UNK_0196ccc4 + 0x196ca88));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x1637,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_0196ccc8 + 0x196caec) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0196cccc + 0x196cb0c));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    uVar9 = (uint)lVar15;
    iVar3 = FUN_019600b0(param_1,param_4 - (uVar8 + !bVar10));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x029540a4(0x1637,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
