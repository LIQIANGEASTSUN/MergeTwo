...

{
  ...
  pcVar3 = (char *)(_UNK_01873858 + 0x18737bc);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0187385c + 0x18737d0));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x93b9,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x93b9,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01873860 + 0x1873824) + 0x74) == 0) {
    func_0x014387a4();
  }
