...
void FUN_0308c35c(undefined4 param_1)

{
  ...
  iVar3 = func_0x02953fd4(0x2ba9,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x2ba9,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = FUN_0308c2f0(param_1);
  iVar3 = iVar3 + 1;
  iVar5 = func_0x02953fd4(0x2bab,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x2bab,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
