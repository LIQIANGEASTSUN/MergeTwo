...
void FUN_016b2078(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_016b2130 + 0x16b208c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016b2134 + 0x16b20a0));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x88ce,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x88ce,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x016c3ac8(param_1);
  iVar7 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_016b2138 + 0x16b2108) + 0x74) == 0) {
    func_0x014387a4();
  }
