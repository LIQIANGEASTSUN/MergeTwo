...

{
  ...
  pcVar4 = (char *)(_UNK_02fcfc2c + 0x2fcfb90);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fcfc30 + 0x2fcfba4));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x70ff,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x70ff,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02fcfc34 + 0x2fcfbf8) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_02fc8d20();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
