...
void FUN_02fdda60(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar7 = (char *)(_UNK_02fddc1c + 0x2fdda78);
  if (*pcVar7 == '\0') {
  ...
  iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_02fddc30 + 0x2fddb48));
  ...
  if (iVar5 == 0) {
    ...
    iVar2 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_02fddc34 + 0x2fddbcc));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_02fddbfc:
    ...
    iVar2 = func_0x03b70fac(iVar5,param_2,**(undefined4 **)(_UNK_02fddc38 + 0x2fddba0));
  }
  unaff_r7 = iVar2 + 1;
