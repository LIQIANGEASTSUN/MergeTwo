...
void FUN_0304fc44(int param_1,undefined4 param_2,int param_3)

{
  ...
  iVar3 = func_0x02953fd4(0x7431,0);
  if (iVar3 == 0) {
    iVar3 = FUN_0304411c(param_1);
    if (((iVar3 != 0) && (iVar3 = FUN_0304f800(param_1,param_2,param_3), iVar3 == 0)) &&
       (iVar3 = FUN_0304f8d0(param_1,param_2), iVar3 != 0)) {
      if (param_3 == 0) {
...
LAB_0304f650:
    ...
    iVar3 = func_0x029540a4(0x7431,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
