...
void FUN_01af7998(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0xd39,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xd39,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iStack_34 = FUN_01af3828(param_1);
  if (iStack_34 == 0) {
    return;
  }
  ...
  piVar2 = (int *)func_0x024ef924(iStack_34,0);
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
