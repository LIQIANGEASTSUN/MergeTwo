...
uint FUN_032dde74(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_032ddf14 + 0x32dde88);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032ddf18 + 0x32dde9c));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x83c3,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x83c3,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_032ddf1c + 0x32ddef4) + 0x74) == 0) {
    func_0x014387a4();
  }
