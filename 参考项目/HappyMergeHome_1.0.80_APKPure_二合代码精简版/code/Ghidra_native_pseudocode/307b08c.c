...
void FUN_0308b08c(int param_1,undefined4 param_2)

{
  ...
  iVar3 = func_0x02953fd4(0x75ba,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x75ba,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (iVar3 != 0) {
    iVar3 = FUN_0308adec(param_1,param_2);
    if (iVar3 != 0) {
      return;
    }
    iVar3 = FUN_0308ac44(param_1,param_2);
    if (iVar3 != 0) {
