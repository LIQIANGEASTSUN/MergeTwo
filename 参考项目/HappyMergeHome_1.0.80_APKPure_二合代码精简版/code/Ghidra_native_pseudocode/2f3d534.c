...
int FUN_02f4d534(undefined4 param_1,int param_2)

{
  ...
  pcVar7 = (char *)(_UNK_02f4d67c + 0x2f4d54c);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f4d680 + 0x2f4d560));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x6ddb,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x6ddb,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(iVar1 + 0xc) == 8) {
    if (*(int *)(**(int **)(_UNK_02f4d684 + 0x2f4d5ec) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = FUN_02f428bc();
    if (iVar1 != 0) {
      func_0x02f6c9e0(iVar1,0);
    }
  }
  iVar1 = FUN_02f44c50(param_1);
  if (iVar1 == 0) {
  ...
  iVar1 = FUN_02f4c9a0(param_1);
  if (iVar5 < iVar1) {
    iVar1 = FUN_02f44c50(param_1);
    uVar6 = FUN_02f4c9a0(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    FUN_026cf66c(iVar1,uVar6,0);
    pcVar7 = (char *)(_UNK_02f4d4ec + 0x2f4d208);
    uStack_18 = unaff_r4;
    if (*pcVar7 == '\0') {
    ...
    if (0 < *(int *)(iVar1 + 0x74)) {
      ...
      if (iVar5 <= *(int *)(iVar1 + 0xc)) {
        ...
        uVar6 = func_0x04cd26d0(iVar5,iVar1 + -1,**(undefined4 **)(_UNK_02f4d514 + 0x2f4d394));
      }
    }
    ...
    if (iVar1 == 0) {
      ...
      if (iVar5 != 0) {
        ...
        pcVar7 = (char *)(_UNK_02f70994 + 0x2f70638);
        if (*pcVar7 == '\0') {
          func_0x01438628(*(undefined4 *)(_UNK_02f70998 + 0x2f7064c),uVar6,iVar1,0);
        ...
        if (iVar2 == 0) {
          ...
          *(undefined1 *)(iVar5 + 0xb0) = 1;
          ...
          iVar1 = func_0x046ccb14(iVar1,uVar6,**(undefined4 **)(_UNK_02f709d4 + 0x2f707b4));
          if (iVar1 == 0) {
            uStack_1c = uVar6;
            uVar6 = func_0x014387ac(**(undefined4 **)(_UNK_02f709d8 + 0x2f7085c),&uStack_1c);
            ...
            uVar4 = func_0x046cc810(iVar1,uVar6,**(undefined4 **)(_UNK_02f709e4 + 0x2f707e4));
            ...
            if (iVar1 == 0) {
              ...
              uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02f709f8 + 0x2f708f8));
              func_0x0152e3ec(uVar6,iVar2,**(undefined4 **)(_UNK_02f709fc + 0x2f7091c),0);
              ...
              iVar5 = func_0x02aee9b4(uVar4,**(undefined4 **)(_UNK_02f70a08 + 0x2f7095c),
                                      **(undefined4 **)(_UNK_02f70a04 + 0x2f70950),uVar6);
              if (iVar1 == 0) {
                func_0x014388e4();
              }
            ...
            uStack_20 = uVar6;
            uVar6 = func_0x014387ac(**(undefined4 **)(_UNK_02f709ec + 0x2f70834),&uStack_20);
