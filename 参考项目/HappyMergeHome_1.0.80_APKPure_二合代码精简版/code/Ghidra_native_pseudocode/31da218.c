...
uint FUN_031ea218(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_031ea2b8 + 0x31ea22c);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031ea2bc + 0x31ea240));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x331d,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x331d,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_031ea2c0 + 0x31ea298) + 0x74) == 0) {
    func_0x014387a4();
  }
