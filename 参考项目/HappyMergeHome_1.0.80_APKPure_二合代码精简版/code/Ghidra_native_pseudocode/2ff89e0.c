...
void FUN_030089e0(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  pcVar4 = (char *)(_UNK_03008acc + 0x3008a00);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03008ad0 + 0x3008a20));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7249,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7249,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    iStack_34 = param_5;
  ...
  if (*(int *)(**(int **)(_UNK_03008ad4 + 0x3008a90) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_03003ba4();
  if (iVar1 == 0) {
  ...
  uStack_2c = uStack_3c;
  iStack_28 = iStack_44;
  iVar2 = func_0x02953fd4(0x724a,0);
  if (iVar2 == 0) {
    ...
    *puVar3 = uStack_58;
    ...
    iVar2 = func_0x029540a4(0x724a,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
