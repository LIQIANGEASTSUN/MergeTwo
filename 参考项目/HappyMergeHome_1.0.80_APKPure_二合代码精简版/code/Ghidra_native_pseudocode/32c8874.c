...

{
  ...
  pcVar7 = (char *)(_UNK_032d89d4 + 0x32d8888);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032d89d8 + 0x32d889c));
    func_0x01438628(*(undefined4 *)(_UNK_032d89dc + 0x32d88a8));
    func_0x01438628(*(undefined4 *)(_UNK_032d89e0 + 0x32d88b4));
    *pcVar7 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x2a92,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x2a92,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_032d89e4 + 0x32d890c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_032d89e8 + 0x32d8928));
  uVar9 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar10 = **(int **)(_UNK_032d89ec + 0x32d8954);
