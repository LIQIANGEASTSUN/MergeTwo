...
undefined4 FUN_01900c54(undefined4 param_1,int param_2)

{
  ...
  pcVar7 = (char *)(_UNK_01900e04 + 0x1900c6c);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01900e08 + 0x1900c80));
    func_0x01438628(*(undefined4 *)(_UNK_01900e0c + 0x1900c8c));
    func_0x01438628(*(undefined4 *)(_UNK_01900e10 + 0x1900c98));
    func_0x01438628(*(undefined4 *)(_UNK_01900e14 + 0x1900ca4));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x458,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x458,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  func_0x026eebfc(iVar1,*(int *)(iVar1 + 0x68) + param_2,0);
  if (*(int *)(**(int **)(_UNK_01900e18 + 0x1900d2c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01900e1c + 0x1900d48));
  piVar5 = *(int **)(_UNK_01900e20 + 0x1900d5c);
  iVar6 = *piVar5;
  if (*(int *)(iVar6 + 0x74) == 0) {
    func_0x014387a4();
    iVar6 = *piVar5;
  }
  iVar8 = **(int **)(_UNK_01900e24 + 0x1900d7c);
