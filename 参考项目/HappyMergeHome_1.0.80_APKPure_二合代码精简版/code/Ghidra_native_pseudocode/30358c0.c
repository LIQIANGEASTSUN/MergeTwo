...
undefined4 FUN_030458c0(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_030459ac + 0x30458d4);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030459b0 + 0x30458e8));
    func_0x01438628(*(undefined4 *)(_UNK_030459b4 + 0x30458f4));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7412,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7412,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_030459b8 + 0x304594c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_030459bc + 0x3045968));
  iVar5 = FUN_03044930(param_1);
  if (iVar5 == 0) {
    func_0x014388e4();
  }
