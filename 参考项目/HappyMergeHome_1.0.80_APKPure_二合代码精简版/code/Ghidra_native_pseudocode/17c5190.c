...
void FUN_017d5190(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  pcVar1 = (char *)(_UNK_017d51ec + 0x17d51a4);
  if (*pcVar1 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017d51f0 + 0x17d51b8));
    *pcVar1 = '\x01';
    param_3 = extraout_r2;
    param_4 = extraout_r3;
  }
  if (*(int *)(**(int **)(_UNK_017d51f4 + 0x17d51cc) + 0x74) == 0) {
    func_0x014387a4();
