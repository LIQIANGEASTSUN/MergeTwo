...

{
  ...
  pcVar6 = (char *)(_UNK_017a70c8 + 0x17a6ef4);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017a70cc + 0x17a6f08));
    func_0x01438628(*(undefined4 *)(_UNK_017a70d0 + 0x17a6f14));
    func_0x01438628(*(undefined4 *)(_UNK_017a70d4 + 0x17a6f20));
    func_0x01438628(*(undefined4 *)(_UNK_017a70d8 + 0x17a6f2c));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8e85,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8e85,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_017a70dc + 0x17a7004) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_017a70e0 + 0x17a7020));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  ...
  if ((iVar2 != 0) && (0 < *(int *)(iVar2 + 0xc))) {
    ...
    iVar2 = func_0x0152983c(iVar2,0,**(undefined4 **)(_UNK_017a70e4 + 0x17a7074));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
