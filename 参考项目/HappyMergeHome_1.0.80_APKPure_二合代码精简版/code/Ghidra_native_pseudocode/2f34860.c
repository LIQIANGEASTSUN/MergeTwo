...
int * FUN_02f44860(undefined4 param_1)

{
  ...
  pcVar11 = (char *)(_UNK_02f44940 + 0x2f44874);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f44944 + 0x2f44888));
    func_0x01438628(*(undefined4 *)(_UNK_02f44948 + 0x2f44894));
    func_0x01438628(*(undefined4 *)(_UNK_02f4494c + 0x2f448a0));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x6df8,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x6df8,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    pcVar11 = (char *)(_UNK_029145c8 + 0x29144e8);
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_029145cc + 0x29144fc),param_1,0);
      *pcVar11 = '\x01';
    }
    ...
    piVar1 = (int *)func_0x035daef8(&uStack_30,0,**(undefined4 **)(_UNK_029145d0 + 0x29145b8));
    return piVar1;
  }
  if (*(int *)(**(int **)(_UNK_02f44950 + 0x2f448f8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_02f44954 + 0x2f44914));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  pcVar11 = (char *)**(undefined4 **)(_UNK_02f44958 + 0x2f44934);
