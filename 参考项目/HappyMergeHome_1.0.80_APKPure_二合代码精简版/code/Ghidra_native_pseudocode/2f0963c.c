...
uint FUN_02f1963c(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02f196dc + 0x2f19650);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f196e0 + 0x2f19664));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x1a4f,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x1a4f,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f196e4 + 0x2f196bc) + 0x74) == 0) {
    func_0x014387a4();
  }
