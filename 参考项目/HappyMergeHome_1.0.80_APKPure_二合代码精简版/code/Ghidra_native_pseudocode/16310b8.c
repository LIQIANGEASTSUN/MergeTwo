...
uint FUN_016410b8(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_016411a0 + 0x16410d8);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016411a4 + 0x16410ec));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8607,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8607,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_016411a8 + 0x1641168) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_0163b7ec();
  if (iVar2 == 0) {
