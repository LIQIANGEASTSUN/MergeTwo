...
undefined4 FUN_031c4bec(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_031c4d28 + 0x31c4c04);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031c4d2c + 0x31c4c18));
    func_0x01438628(*(undefined4 *)(_UNK_031c4d30 + 0x31c4c24));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7d3f,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7d3f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x046c26fc(iVar1,param_2,**(undefined4 **)(_UNK_031c4d34 + 0x31c4cbc));
  if (iVar1 != 0) {
    iVar1 = FUN_031b7b88(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_031c4d38 + 0x31c4d14);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
