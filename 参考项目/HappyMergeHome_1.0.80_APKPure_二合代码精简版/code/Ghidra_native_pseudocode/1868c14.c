...

{
  ...
  pcVar6 = (char *)(_UNK_01878cbc + 0x1878c28);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01878cc0 + 0x1878c3c));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x93c7,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x93c7,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar7 = **(int **)(_UNK_01878cc4 + 0x1878cb0);
  pcVar6 = (char *)(_UNK_03b70e48 + 0x3b70d3c);
  if (*pcVar6 == '\0') {
  ...
  func_0x046c268c(iVar2,*(undefined4 *)(*(int *)(*(int *)(iVar7 + 0x10) + 0x60) + 0x2c));
