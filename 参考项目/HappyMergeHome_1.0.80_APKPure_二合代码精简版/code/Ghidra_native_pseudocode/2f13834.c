...
int * FUN_02f23834(undefined4 param_1)

{
  ...
  pcVar10 = (char *)(_UNK_02f23914 + 0x2f23848);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f23918 + 0x2f2385c));
    func_0x01438628(*(undefined4 *)(_UNK_02f2391c + 0x2f23868));
    func_0x01438628(*(undefined4 *)(_UNK_02f23920 + 0x2f23874));
    *pcVar10 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x1336,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x1336,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    pcVar10 = (char *)(_UNK_028a0e78 + 0x28a0d98);
    if (*pcVar10 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_028a0e7c + 0x28a0dac),param_1,0);
      *pcVar10 = '\x01';
    }
    ...
    piVar1 = (int *)func_0x035daef8(&uStack_30,0,**(undefined4 **)(_UNK_028a0e80 + 0x28a0e68));
    return piVar1;
  }
  if (*(int *)(**(int **)(_UNK_02f23924 + 0x2f238cc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_02f23928 + 0x2f238e8));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  iVar9 = **(int **)(_UNK_02f2392c + 0x2f23908);
