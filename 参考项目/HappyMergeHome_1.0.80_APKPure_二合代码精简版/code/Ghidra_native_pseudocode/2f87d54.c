...
int FUN_02f97d54(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_02f97e20 + 0x2f97d68);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f97e24 + 0x2f97d7c));
    func_0x01438628(*(undefined4 *)(_UNK_02f97e28 + 0x2f97d88));
    *pcVar9 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x6f7f,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x6f7f,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f97e2c + 0x2f97de0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_02f97e30 + 0x2f97dfc));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
