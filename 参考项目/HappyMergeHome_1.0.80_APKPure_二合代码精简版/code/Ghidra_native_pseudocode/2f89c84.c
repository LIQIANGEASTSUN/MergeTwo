...

{
  ...
  pcVar11 = (char *)(_UNK_02f99e0c + 0x2f99c98);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f99e10 + 0x2f99cac));
    func_0x01438628(*(undefined4 *)(_UNK_02f99e14 + 0x2f99cb8));
    func_0x01438628(*(undefined4 *)(_UNK_02f99e18 + 0x2f99cc4));
    func_0x01438628(*(undefined4 *)(_UNK_02f99e1c + 0x2f99cd0));
    func_0x01438628(*(undefined4 *)(_UNK_02f99e20 + 0x2f99cdc));
    func_0x01438628(*(undefined4 *)(_UNK_02f99e24 + 0x2f99ce8));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x6f86,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x6f86,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f99e28 + 0x2f99d4c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02f99e2c + 0x2f99d68));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = func_0x036c7bec(iVar3,**(undefined4 **)(_UNK_02f99e30 + 0x2f99d88));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar3 + 0x380) != 0) {
    func_0x03b73ab8(*(int *)(iVar3 + 0x380),**(undefined4 **)(_UNK_02f99e34 + 0x2f99db8));
  }
  if (*(int *)(**(int **)(_UNK_02f99e38 + 0x2f99dc8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02f99e3c + 0x2f99de4));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  pcVar11 = (char *)(_UNK_02be82b0 + 0x2be8170);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x40,0);
  ...
  if (iVar9 != 0) {
    ...
    uStack_38 = 0;
    uStack_28 = 0;
    func_0x024f56c0(&uStack_50,0,0x40,0);
    uStack_38 = uStack_50;
    iStack_34 = uStack_4c;
    uStack_30 = uStack_48;
    uStack_2c = iStack_44;
    ...
    func_0x01523a2c(&uStack_38,0x40,0);
    iVar10 = *(int *)(iVar9 + 8);
  ...
  iVar3 = func_0x046ccb14(uVar2,0x40,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar3 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar1 = (*(code *)*puVar4)(piVar8,0x40,puVar4[1]);
      uVar2 = uStack_30;
    }
    iVar9 = *(int *)(uVar2 + 8);
    iVar3 = iVar9;
