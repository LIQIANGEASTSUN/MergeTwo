...
int FUN_01968650(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_01968948 + 0x1968664);
  if (*pcVar5 == '\0') {
  ...
  if (0 < *(int *)(iVar1 + 0x74)) {
    ...
    if (iVar6 <= *(int *)(iVar1 + 0xc)) {
      ...
      uVar7 = func_0x024f0530(iVar6,iVar1 + -1,**(undefined4 **)(_UNK_01968970 + 0x19687f0));
    }
  }
  ...
  uVar4 = *(undefined4 *)(*(int *)(iVar6 + 0x5c) + 0xa3c);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  ...
  if (iVar1 == 0) {
    ...
    if (iVar6 != 0) {
      ...
      pcVar5 = (char *)(_UNK_0198bef8 + 0x198bb9c);
      if (*pcVar5 == '\0') {
        ...
        *(undefined1 *)(iVar6 + 0xb0) = 1;
        ...
        if (iVar1 == 0) {
          ...
          if (iVar1 == 0) {
            ...
            uStack_28 = 1;
            uStack_24 = 0;
            iVar6 = func_0x02aee9b4(uVar4,**(undefined4 **)(_UNK_0198bf6c + 0x198bec0),
