...
int FUN_017fdebc(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0x907f,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x907f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  pcVar6 = (char *)(_UNK_0182ce08 + 0x182cca4);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0182ce0c + 0x182ccb8));
    func_0x01438628(*(undefined4 *)(_UNK_0182ce10 + 0x182ccc4));
    func_0x01438628(*(undefined4 *)(_UNK_0182ce14 + 0x182ccd0));
    func_0x01438628(*(undefined4 *)(_UNK_0182ce18 + 0x182ccdc));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x13d0,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x13d0,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_0182ce1c + 0x182cd30) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0182ce20 + 0x182cd4c));
  piVar7 = *(int **)(_UNK_0182ce24 + 0x182cd60);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_0182ce28 + 0x182cd80);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0x69c);
  if (iVar2 == 0) {
