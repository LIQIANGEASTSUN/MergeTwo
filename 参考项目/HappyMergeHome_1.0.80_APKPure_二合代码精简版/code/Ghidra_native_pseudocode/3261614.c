...
int FUN_03271614(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_03271790 + 0x3271628);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03271794 + 0x327163c));
    func_0x01438628(*(undefined4 *)(_UNK_03271798 + 0x3271648));
    func_0x01438628(*(undefined4 *)(_UNK_0327179c + 0x3271654));
    func_0x01438628(*(undefined4 *)(_UNK_032717a0 + 0x3271660));
    *pcVar7 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x8111,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x8111,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_032717a4 + 0x32716b8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_032717a8 + 0x32716d4));
  piVar8 = *(int **)(_UNK_032717ac + 0x32716e8);
  iVar6 = *piVar8;
  if (*(int *)(iVar6 + 0x74) == 0) {
    func_0x014387a4();
    iVar6 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_032717b0 + 0x3271708);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar6 + 0x5c) + 0x830);
  if (iVar4 == 0) {
