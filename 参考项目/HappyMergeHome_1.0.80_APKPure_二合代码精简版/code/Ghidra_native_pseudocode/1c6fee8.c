...

{
  ...
  pcVar3 = (char *)(_UNK_01c8000c + 0x1c7fef8);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01c80010 + 0x1c7ff0c));
    func_0x01438628(*(undefined4 *)(_UNK_01c80014 + 0x1c7ff18));
    func_0x01438628(*(undefined4 *)(_UNK_01c80018 + 0x1c7ff24));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xadce,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xadce,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    uStack_50 = 0;
    uStack_4c = 0;
    func_0x024f56d0(iVar9,uVar7,&uStack_30,uVar4);
    return;
  }
  puVar5 = *(undefined4 **)(_UNK_01c8001c + 0x1c7ff78);
  uVar4 = func_0x014388d4(*puVar5);
  puVar8 = *(undefined4 **)(_UNK_01c80020 + 0x1c7ff94);
  func_0x0152e3ec(uVar4,0,*puVar8,0);
  if (*(int *)(**(int **)(_UNK_01c80024 + 0x1c7ffa4) + 0x74) == 0) {
    func_0x014387a4();
  }
  func_0x024f1ae0(uVar4,0);
  uVar4 = func_0x014388d4(*puVar5);
  func_0x0152e3ec(uVar4,0,*puVar8,0);
  func_0x024f1af0(uVar4,0);
  piVar2 = (int *)FUN_01c681c4();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
  ...
  if (iVar1 == 0) {
    piVar10 = *(int **)(_UNK_029f2634 + 0x29f25bc);
    ...
    if (iVar1 == 0) {
      ...
      iVar9 = func_0x02953fd4(0x237e,0);
      if (iVar9 == 0) {
        ...
        iVar9 = func_0x04753c80(iVar9,uVar4,**(undefined4 **)(_UNK_029f2a34 + 0x29f281c));
        if (iVar9 == 0) {
          ...
          iVar6 = **(int **)(_UNK_029f2a50 + 0x29f2984);
          ...
          iVar9 = *(int *)(*(int *)(iVar6 + 0x1c) + 8);
          if ((*(ushort *)(iVar9 + 0xbd) & 1) == 0) {
            iVar9 = func_0x0149097c();
          }
          piVar2 = (int *)**(int **)(iVar9 + 0x5c);
          if (*(int *)(**(int **)(_UNK_029f2a54 + 0x29f29e4) + 0x74) == 0) {
            func_0x014387a4(**(int **)(_UNK_029f2a54 + 0x29f29e4));
          }
          iVar9 = func_0x02953fd4(0x42,0,0);
          if (iVar9 == 0) {
            return;
          }
          iVar9 = func_0x029540a4(0x42,0);
          if (iVar9 == 0) {
            func_0x014388e4();
          }
        }
          ...
          iVar6 = **(int **)(_UNK_029f2a40 + 0x29f2874);
          iVar9 = *(int *)(iVar6 + 0x1c);
          if (iVar9 == 0) {
            func_0x014909d8(iVar6);
            iVar9 = *(int *)(iVar6 + 0x1c);
          ...
          iVar9 = func_0x02953fd4(0x53,0,0);
          if (iVar9 == 0) {
            return;
          }
          iVar9 = func_0x029540a4(0x53,0);
          if (iVar9 == 0) {
            func_0x014388e4();
          }
        }
        ...
        iVar9 = func_0x029540a4(0x237e,0);
        if (iVar9 == 0) {
          func_0x014388e4();
        }
      }
      ...
      func_0x024f56d0(iVar6,uVar4,&uStack_38,uVar7,0,0);
      return;
    }
    return;
  }
  ...
  uStack_50 = 0;
  uStack_4c = 0;
  func_0x024f56d0(iVar9,uVar4,&uStack_30,uVar7);
  return;
}
