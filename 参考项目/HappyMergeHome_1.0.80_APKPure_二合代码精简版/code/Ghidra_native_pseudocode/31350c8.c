...
void FUN_031450c8(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  pcVar4 = (char *)(_UNK_031451b4 + 0x31450e8);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031451b8 + 0x3145108));
    *pcVar4 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7a0d,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7a0d,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iStack_34 = param_5;
  ...
  if (*(int *)(**(int **)(_UNK_031451bc + 0x3145178) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_0313e53c();
  if (iVar2 == 0) {
