...
int FUN_0310df2c(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_0310dff8 + 0x310df40);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0310dffc + 0x310df54));
    func_0x01438628(*(undefined4 *)(_UNK_0310e000 + 0x310df60));
    *pcVar9 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7891,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7891,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0310e004 + 0x310dfb8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0310e008 + 0x310dfd4));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
