...
undefined4 FUN_02c2bde8(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2bfa8 + 0x2c2bdfc);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2bfac + 0x2c2be10));
    func_0x01438628(*(undefined4 *)(_UNK_02c2bfb0 + 0x2c2be1c));
    func_0x01438628(*(undefined4 *)(_UNK_02c2bfb4 + 0x2c2be28));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d9b,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d9b,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2bfb8 + 0x2c2bf50));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2bfbc + 0x2c2bf6c),0);
  if (*(int *)(**(int **)(_UNK_02c2bfc0 + 0x2c2bf80) + 0x74) == 0) {
    func_0x014387a4();
  }
