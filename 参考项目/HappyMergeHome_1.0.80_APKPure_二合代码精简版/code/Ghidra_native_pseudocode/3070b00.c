...
undefined4 FUN_03080b00(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_03080bec + 0x3080b14);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03080bf0 + 0x3080b28));
    func_0x01438628(*(undefined4 *)(_UNK_03080bf4 + 0x3080b34));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x759a,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x759a,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03080bf8 + 0x3080b8c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_03080bfc + 0x3080ba8));
  iVar5 = FUN_0307fb70(param_1);
  if (iVar5 == 0) {
    func_0x014388e4();
  }
