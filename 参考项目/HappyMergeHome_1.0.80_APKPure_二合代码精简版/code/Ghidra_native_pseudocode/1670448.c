...

{
  ...
  pcVar9 = (char *)(_UNK_016805d0 + 0x168045c);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016805d4 + 0x1680470));
    func_0x01438628(*(undefined4 *)(_UNK_016805d8 + 0x168047c));
    func_0x01438628(*(undefined4 *)(_UNK_016805dc + 0x1680488));
    func_0x01438628(*(undefined4 *)(_UNK_016805e0 + 0x1680494));
    func_0x01438628(*(undefined4 *)(_UNK_016805e4 + 0x16804a0));
    func_0x01438628(*(undefined4 *)(_UNK_016805e8 + 0x16804ac));
    *pcVar9 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x879d,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x879d,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_016805ec + 0x1680510) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_016805f0 + 0x168052c));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar1 = func_0x024f04cc(iVar1,**(undefined4 **)(_UNK_016805f4 + 0x168054c));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar1 + 0x398) != 0) {
    func_0x024f04d0(*(int *)(iVar1 + 0x398),**(undefined4 **)(_UNK_016805f8 + 0x168057c));
  }
  if (*(int *)(**(int **)(_UNK_016805fc + 0x168058c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01680600 + 0x16805a8));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  pcVar9 = (char *)(_UNK_02be82b0 + 0x2be8170);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x4f,0);
  ...
  if (iVar10 != 0) {
    ...
    uStack_38 = 0;
    uStack_28 = 0;
    func_0x024f56c0(&uStack_50,0,0x4f,0);
    uStack_38 = uStack_50;
    iStack_34 = uStack_4c;
    uStack_30 = uStack_48;
    uStack_2c = iStack_44;
    ...
    func_0x01523a2c(&uStack_38,0x4f,0);
    iVar11 = *(int *)(iVar10 + 8);
  ...
  iVar1 = func_0x046ccb14(uVar3,0x4f,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar1 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar2 = (*(code *)*puVar4)(piVar8,0x4f,puVar4[1]);
      uVar3 = uStack_30;
    }
    iVar10 = *(int *)(uVar3 + 8);
    iVar1 = iVar10;
