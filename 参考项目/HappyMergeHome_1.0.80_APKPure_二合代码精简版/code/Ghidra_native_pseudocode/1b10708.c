...
uint FUN_01b20708(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_01b207a8 + 0x1b2071c);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01b207ac + 0x1b20730));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x384b,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x384b,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01b207b0 + 0x1b20788) + 0x74) == 0) {
    func_0x014387a4();
  }
  ...
  if (iVar1 != 0) {
    ...
    func_0x01523a2c(&uStack_30,0x18,0);
    iVar5 = *(int *)(iVar1 + 8);
    uVar6 = *(undefined4 *)(iVar1 + 0xc);
    iVar1 = *(int *)(iVar1 + 0x10);
    if (iVar5 == 0) {
