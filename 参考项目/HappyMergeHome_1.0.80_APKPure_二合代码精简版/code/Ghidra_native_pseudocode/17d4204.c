...

{
  ...
  pcVar4 = (char *)(_UNK_017e42a0 + 0x17e4218);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017e42a4 + 0x17e422c));
    func_0x01438628(*(undefined4 *)(_UNK_017e42a8 + 0x17e4238));
    *pcVar4 = '\x01';
  }
  if (*(int *)(param_1 + 8) != 0) {
    return *(int *)(param_1 + 8);
  }
  if (*(int *)(**(int **)(_UNK_017e42ac + 0x17e4258) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_017e42b0 + 0x17e4274));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
