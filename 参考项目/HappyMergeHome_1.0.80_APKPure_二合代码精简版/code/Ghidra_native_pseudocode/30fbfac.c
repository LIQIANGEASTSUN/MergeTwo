...
void FUN_0310bfac(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  pcVar3 = (char *)(_UNK_0310c010 + 0x310bfc0);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0310c014 + 0x310bfd4));
    *pcVar3 = '\x01';
    param_4 = extraout_r3;
  }
  piVar1 = *(int **)(_UNK_0310c018 + 0x310bfec);
