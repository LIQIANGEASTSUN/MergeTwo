...
void FUN_0317a514(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_0317a5d8 + 0x317a52c);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0317a5dc + 0x317a540));
    *pcVar10 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x7b49,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x7b49,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x0318adec(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_0317a5e0 + 0x317a5b0) + 0x74) == 0) {
    func_0x014387a4();
  }
