...
int FUN_03107000(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_0310717c + 0x3107014);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03107180 + 0x3107028));
    func_0x01438628(*(undefined4 *)(_UNK_03107184 + 0x3107034));
    func_0x01438628(*(undefined4 *)(_UNK_03107188 + 0x3107040));
    func_0x01438628(*(undefined4 *)(_UNK_0310718c + 0x310704c));
    *pcVar7 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7848,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x7848,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03107190 + 0x31070a4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03107194 + 0x31070c0));
  piVar8 = *(int **)(_UNK_03107198 + 0x31070d4);
  iVar6 = *piVar8;
  if (*(int *)(iVar6 + 0x74) == 0) {
    func_0x014387a4();
    iVar6 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_0310719c + 0x31070f4);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar6 + 0x5c) + 0x8cc);
  if (iVar4 == 0) {
