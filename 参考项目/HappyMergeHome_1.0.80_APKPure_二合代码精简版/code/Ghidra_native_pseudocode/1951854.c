...
undefined4 FUN_01961854(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_01961940 + 0x1961868);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01961944 + 0x196187c));
    func_0x01438628(*(undefined4 *)(_UNK_01961948 + 0x1961888));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x991d,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x991d,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0196194c + 0x19618e0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01961950 + 0x19618fc));
  iVar6 = FUN_019608c4(param_1);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
