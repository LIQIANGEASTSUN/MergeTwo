...
void FUN_0308bcf0(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar6 = (char *)(_UNK_0308bf6c + 0x308bd18);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0308bf70 + 0x308bd2c));
    func_0x01438628(*(undefined4 *)(_UNK_0308bf74 + 0x308bd38));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x1529,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_0308bf78 + 0x308bd9c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0308bf7c + 0x308bdbc));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    uVar9 = (uint)lVar15;
    iVar3 = FUN_0307f35c(param_1,param_4 - (uVar8 + !bVar10));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x029540a4(0x1529,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
