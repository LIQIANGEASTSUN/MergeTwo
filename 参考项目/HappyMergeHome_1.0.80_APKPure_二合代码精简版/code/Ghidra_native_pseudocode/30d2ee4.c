...
undefined4 FUN_030e2ee4(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_030e3020 + 0x30e2efc);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030e3024 + 0x30e2f10));
    func_0x01438628(*(undefined4 *)(_UNK_030e3028 + 0x30e2f1c));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7746,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7746,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x046c26fc(iVar1,param_2,**(undefined4 **)(_UNK_030e302c + 0x30e2fb4));
  if (iVar1 != 0) {
    iVar1 = FUN_030d2ca4(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_030e3030 + 0x30e300c);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
