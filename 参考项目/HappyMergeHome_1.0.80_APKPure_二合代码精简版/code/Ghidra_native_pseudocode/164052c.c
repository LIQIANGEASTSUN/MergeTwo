...
void FUN_0165052c(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_016506e8 + 0x1650544);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016506ec + 0x1650558));
    func_0x01438628(*(undefined4 *)(_UNK_016506f0 + 0x1650564));
    func_0x01438628(*(undefined4 *)(_UNK_016506f4 + 0x1650570));
    func_0x01438628(*(undefined4 *)(_UNK_016506f8 + 0x165057c));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x2d05,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x2d05,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar2 = func_0x024f0540(iVar2,param_2,**(undefined4 **)(_UNK_016506fc + 0x1650614));
  ...
  if (iVar5 == 0) {
    func_0x014388e4();
    if (iVar2 == 0) goto LAB_016506c8;
    iVar2 = func_0x024f05d4(0,param_2,**(undefined4 **)(_UNK_01650700 + 0x1650698));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_016506c8:
      iVar2 = **(int **)(_UNK_0165070c + 0x16506dc);
      iStack_18 = unaff_r4;
      if (iVar5 == 0) {
        func_0x024f83d4();
      }
    ...
    iVar2 = func_0x024f05d4(iVar5,param_2,**(undefined4 **)(_UNK_01650704 + 0x165066c));
  }
  unaff_r7 = iVar2 + 1;
  unaff_r5 = **(int **)(_UNK_01650708 + 0x16506bc);
  iStack_1c = unaff_r7;
  if (iVar5 == 0) {
    func_0x024f83d4();
  }
