...

{
  ...
  pcVar5 = (char *)(_UNK_02a025b0 + 0x2a02534);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02a025b4 + 0x2a02548));
    func_0x01438628(*(undefined4 *)(_UNK_02a025b8 + 0x2a02554));
    *pcVar5 = '\x01';
  }
  if (*(int *)(**(int **)(_UNK_02a025bc + 0x2a02568) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x014e9518(**(undefined4 **)(_UNK_02a025c0 + 0x2a02584));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  pcVar5 = (char *)(_UNK_02029ad0 + 0x20299ac);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02029ad4 + 0x20299c0),0x25,0,0);
  ...
  if (iVar1 == 0) {
    ...
    iVar1 = func_0x029b4dd0(iVar1,0x25,0);
    if ((iVar1 != 0) &&
    ...
    uVar2 = func_0x02871198(iVar1,iVar4,0x25,0,0);
  }
  return uVar2;
}
