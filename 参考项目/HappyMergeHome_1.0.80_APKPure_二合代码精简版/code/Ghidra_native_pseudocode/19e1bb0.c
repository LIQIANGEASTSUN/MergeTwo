...

{
  ...
  pcVar5 = (char *)(_UNK_019f1cc4 + 0x19f1bc0);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_019f1cc8 + 0x19f1bd4));
    func_0x01438628(*(undefined4 *)(_UNK_019f1ccc + 0x19f1be0));
    func_0x01438628(*(undefined4 *)(_UNK_019f1cd0 + 0x19f1bec));
    func_0x01438628(*(undefined4 *)(_UNK_019f1cd4 + 0x19f1bf8));
    *pcVar5 = '\x01';
  }
  if (*(int *)(**(int **)(_UNK_019f1cd8 + 0x19f1c0c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_019f1cdc + 0x19f1c28));
  iVar6 = **(int **)(_UNK_019f1ce0 + 0x19f1c3c);
  ...
  uVar4 = **(undefined4 **)(_UNK_019f1ce4 + 0x19f1cb8);
