...

{
  ...
  pcVar7 = (char *)(_UNK_0313eb70 + 0x313ea24);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0313eb74 + 0x313ea38));
    func_0x01438628(*(undefined4 *)(_UNK_0313eb78 + 0x313ea44));
    func_0x01438628(*(undefined4 *)(_UNK_0313eb7c + 0x313ea50));
    *pcVar7 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x29f2,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x29f2,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0313eb80 + 0x313eaa8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_0313eb84 + 0x313eac4));
  uVar9 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar10 = **(int **)(_UNK_0313eb88 + 0x313eaf0);
