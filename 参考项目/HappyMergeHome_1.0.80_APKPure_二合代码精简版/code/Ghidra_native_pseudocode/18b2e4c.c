...
void FUN_018c2e4c(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  pcVar4 = (char *)(_UNK_018c2f54 + 0x18c2e6c);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018c2f58 + 0x18c2e8c));
    *pcVar4 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x9523,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x9523,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iStack_34 = param_5;
  ...
  if (*(int *)(**(int **)(_UNK_018c2f5c + 0x18c2f18) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_018bd08c();
  if (iVar2 == 0) {
  ...
  iStack_2c = uStack_3c;
  iStack_28 = iStack_44;
  iVar1 = func_0x02953fd4(0x94fa,0);
  if (iVar1 == 0) {
    ...
    *puVar3 = uStack_58;
    ...
    iVar1 = func_0x029540a4(0x94fa,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
