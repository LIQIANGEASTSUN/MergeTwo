...

{
  ...
  pcVar6 = (char *)(_UNK_01dab638 + 0x1dab5a4);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01dab63c + 0x1dab5b8));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x3f0c,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x3f0c,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar7 = **(int **)(_UNK_01dab640 + 0x1dab62c);
