...
void FUN_0330ec04(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  pcVar1 = (char *)(_UNK_0330ec60 + 0x330ec18);
  if (*pcVar1 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0330ec64 + 0x330ec2c));
    *pcVar1 = '\x01';
    param_3 = extraout_r2;
    param_4 = extraout_r3;
  }
  if (*(int *)(**(int **)(_UNK_0330ec68 + 0x330ec40) + 0x74) == 0) {
    func_0x014387a4();
