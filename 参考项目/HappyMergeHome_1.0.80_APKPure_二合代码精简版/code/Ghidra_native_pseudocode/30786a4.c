...
uint FUN_030886a4(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_03088744 + 0x30886b8);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03088748 + 0x30886cc));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x75a9,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x75a9,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0308874c + 0x3088724) + 0x74) == 0) {
    func_0x014387a4();
  }
