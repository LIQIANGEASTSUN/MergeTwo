...

{
  ...
  pcVar4 = (char *)(_UNK_0307f350 + 0x307f2b4);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0307f354 + 0x307f2c8));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7597,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7597,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0307f358 + 0x307f31c) + 0x74) == 0) {
    func_0x014387a4();
  }
