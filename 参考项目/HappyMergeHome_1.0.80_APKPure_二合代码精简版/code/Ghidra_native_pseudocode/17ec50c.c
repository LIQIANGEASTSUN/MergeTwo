...
int FUN_017fc50c(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_017fc688 + 0x17fc520);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017fc68c + 0x17fc534));
    func_0x01438628(*(undefined4 *)(_UNK_017fc690 + 0x17fc540));
    func_0x01438628(*(undefined4 *)(_UNK_017fc694 + 0x17fc54c));
    func_0x01438628(*(undefined4 *)(_UNK_017fc698 + 0x17fc558));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9074,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9074,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_017fc69c + 0x17fc5b0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_017fc6a0 + 0x17fc5cc));
  piVar7 = *(int **)(_UNK_017fc6a4 + 0x17fc5e0);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_017fc6a8 + 0x17fc600);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0x698);
  if (iVar2 == 0) {
