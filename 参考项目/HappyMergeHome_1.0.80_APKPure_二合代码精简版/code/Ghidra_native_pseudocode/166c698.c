...

{
  ...
  pcVar3 = (char *)(_UNK_0167c744 + 0x167c6a8);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0167c748 + 0x167c6bc));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8791,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8791,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0167c74c + 0x167c710) + 0x74) == 0) {
    func_0x014387a4();
  }
