...
undefined4 FUN_02f50aa4(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_02f50b80 + 0x2f50ab8);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f50b84 + 0x2f50acc));
    func_0x01438628(*(undefined4 *)(_UNK_02f50b88 + 0x2f50ad8));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x6e22,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_02f50b8c + 0x2f50b30) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02f50b90 + 0x2f50b4c));
    uVar7 = func_0x02f50b94(param_1);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = func_0x029540a4(0x6e22,0);
  if (iVar3 == 0) {
    func_0x014388e4();
  }
