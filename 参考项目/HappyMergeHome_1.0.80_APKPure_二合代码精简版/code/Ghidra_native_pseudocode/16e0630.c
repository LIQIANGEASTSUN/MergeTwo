...
undefined4 FUN_016f0630(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_016f071c + 0x16f0644);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016f0720 + 0x16f0658));
    func_0x01438628(*(undefined4 *)(_UNK_016f0724 + 0x16f0664));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8a9c,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8a9c,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_016f0728 + 0x16f06bc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_016f072c + 0x16f06d8));
  iVar6 = FUN_016efab8(param_1);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
