...
void FUN_032a5674(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_032a5738 + 0x32a568c);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032a573c + 0x32a56a0));
    *pcVar10 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x825f,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x825f,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x032b2ca4(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_032a5740 + 0x32a5710) + 0x74) == 0) {
    func_0x014387a4();
  }
