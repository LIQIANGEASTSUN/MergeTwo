...
void FUN_01922a54(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_01922b0c + 0x1922a68);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01922b10 + 0x1922a7c));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9759,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9759,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x01936120(param_1);
  iVar7 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_01922b14 + 0x1922ae4) + 0x74) == 0) {
    func_0x014387a4();
  }
