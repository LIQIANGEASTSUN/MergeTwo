...

{
  ...
  pcVar3 = (char *)(_UNK_016ef2a0 + 0x16ef204);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016ef2a4 + 0x16ef218));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8a99,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8a99,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_016ef2a8 + 0x16ef26c) + 0x74) == 0) {
    func_0x014387a4();
  }
