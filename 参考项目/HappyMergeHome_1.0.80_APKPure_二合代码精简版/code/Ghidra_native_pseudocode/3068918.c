...

{
  ...
  pcVar7 = (char *)(_UNK_03078a78 + 0x307892c);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03078a7c + 0x3078940));
    func_0x01438628(*(undefined4 *)(_UNK_03078a80 + 0x307894c));
    func_0x01438628(*(undefined4 *)(_UNK_03078a84 + 0x3078958));
    *pcVar7 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x2b8d,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x2b8d,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03078a88 + 0x30789b0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_03078a8c + 0x30789cc));
  uVar9 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar10 = **(int **)(_UNK_03078a90 + 0x30789f8);
