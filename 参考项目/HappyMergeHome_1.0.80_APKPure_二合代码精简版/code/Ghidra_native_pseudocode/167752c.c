...
int FUN_0168752c(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_0168764c + 0x1687540);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01687650 + 0x1687554));
    func_0x01438628(*(undefined4 *)(_UNK_01687654 + 0x1687560));
    func_0x01438628(*(undefined4 *)(_UNK_01687658 + 0x168756c));
    func_0x01438628(*(undefined4 *)(_UNK_0168765c + 0x1687578));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x20dd,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x20dd,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01687660 + 0x16875d0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_01687664 + 0x16875ec));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  ...
  iVar2 = func_0x0152983c(iVar2,*(int *)(iVar2 + 0xc) + -1,
                          **(undefined4 **)(_UNK_01687668 + 0x168761c));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  iVar2 = *(int *)(iVar2 + 0x24);
  pcVar7 = (char *)(_UNK_01685504 + 0x1685108);
  iStack_24 = unaff_r4;
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01685508 + 0x168511c));
    func_0x01438628(*(undefined4 *)(_UNK_0168550c + 0x1685128));
    func_0x01438628(*(undefined4 *)(_UNK_01685510 + 0x1685134));
    func_0x01438628(*(undefined4 *)(_UNK_01685514 + 0x1685140));
    func_0x01438628(*(undefined4 *)(_UNK_01685518 + 0x168514c));
    func_0x01438628(*(undefined4 *)(_UNK_0168551c + 0x1685158));
    func_0x01438628(*(undefined4 *)(_UNK_01685520 + 0x1685164));
    func_0x01438628(*(undefined4 *)(_UNK_01685524 + 0x1685170));
    func_0x01438628(*(undefined4 *)(_UNK_01685528 + 0x168517c));
    func_0x01438628(*(undefined4 *)(_UNK_0168552c + 0x1685188));
    *pcVar7 = '\x01';
  }
  iVar8 = func_0x02953fd4(0x20de,0);
  if (iVar8 == 0) {
    ...
    puVar11 = *(undefined4 **)(_UNK_01685530 + 0x1685228);
    iVar8 = func_0x024f0f34(iVar8,iVar2,*puVar11);
    if (iVar8 == 0) {
      if (*(int *)(**(int **)(_UNK_01685534 + 0x1685248) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar8 = func_0x014e9518(**(undefined4 **)(_UNK_01685538 + 0x1685264));
      if (iVar8 == 0) {
        func_0x014388e4();
      }
      iVar8 = *(int *)(iVar8 + 0x2c);
      iVar9 = 0;
      puVar12 = *(undefined4 **)(_UNK_0168553c + 0x168528c);
      while( true ) {
        if (iVar8 == 0) {
          func_0x014388e4();
        }
          ...
          while( true ) {
            ...
            if (*(int *)(iVar1 + 0x24) <= iVar2) {
              ...
              if (iVar1 == 0) {
                ...
                func_0x024f05ac(iVar1,uVar10,**(undefined4 **)(_UNK_01685540 + 0x1685404));
              }
            }
            iVar9 = iVar9 + 1;
          }
          func_0x01687c38(param_1);
          if (*(int *)(**(int **)(_UNK_01685544 + 0x1685428) + 0x74) == 0) {
            func_0x014387a4();
          }
          iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_01685548 + 0x1685444));
          piVar6 = *(int **)(_UNK_0168554c + 0x1685458);
          iVar8 = *piVar6;
          if (*(int *)(iVar8 + 0x74) == 0) {
            func_0x014387a4();
            iVar8 = *piVar6;
          }
          iVar1 = **(int **)(_UNK_01685550 + 0x1685478);
  ...
  iVar8 = func_0x029540a4(0x20de,0);
  if (iVar8 == 0) {
    func_0x014388e4();
  }
  puStack_20 = (undefined4 *)iStack_24;
