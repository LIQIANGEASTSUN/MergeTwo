...
void FUN_018bfb30(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_018bfbe8 + 0x18bfb44);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018bfbec + 0x18bfb58));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x94ef,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x94ef,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x018d2c88(param_1);
  iVar7 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_018bfbf0 + 0x18bfbc0) + 0x74) == 0) {
    func_0x014387a4();
  }
