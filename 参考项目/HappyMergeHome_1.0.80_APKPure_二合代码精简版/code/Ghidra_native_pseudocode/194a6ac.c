...
int FUN_0195a6ac(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_0195a828 + 0x195a6c0);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0195a82c + 0x195a6d4));
    func_0x01438628(*(undefined4 *)(_UNK_0195a830 + 0x195a6e0));
    func_0x01438628(*(undefined4 *)(_UNK_0195a834 + 0x195a6ec));
    func_0x01438628(*(undefined4 *)(_UNK_0195a838 + 0x195a6f8));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x98c8,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x98c8,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0195a83c + 0x195a750) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0195a840 + 0x195a76c));
  piVar7 = *(int **)(_UNK_0195a844 + 0x195a780);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_0195a848 + 0x195a7a0);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0xa5c);
  if (iVar2 == 0) {
