...

{
  ...
  pcVar7 = (char *)(_UNK_017d11f0 + 0x17d10a4);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017d11f4 + 0x17d10b8));
    func_0x01438628(*(undefined4 *)(_UNK_017d11f8 + 0x17d10c4));
    func_0x01438628(*(undefined4 *)(_UNK_017d11fc + 0x17d10d0));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x2915,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x2915,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_017d1200 + 0x17d1128) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_017d1204 + 0x17d1144));
  uVar10 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar9 = **(int **)(_UNK_017d1208 + 0x17d1170);
