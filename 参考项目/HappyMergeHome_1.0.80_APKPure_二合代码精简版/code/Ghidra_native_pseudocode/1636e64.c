...
int FUN_01646e64(int *param_1,int param_2,int param_3)

{
  ...
  pcVar10 = (char *)(_UNK_01647038 + 0x1646e84);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0164703c + 0x1646e98));
    func_0x01438628(*(undefined4 *)(_UNK_01647040 + 0x1646ea4));
    func_0x01438628(*(undefined4 *)(_UNK_01647044 + 0x1646eb0));
    *pcVar10 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x85eb,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x85eb,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_01647048 + 0x1646f18) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0164704c + 0x1646f34));
  uVar2 = (**(code **)(*param_1 + 0x1a0))(param_1,*(undefined4 *)(*param_1 + 0x1a4));
  piVar3 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_01647050 + 0x1646f64),2);
  if (piVar3 == (int *)0x0) {
    func_0x014388e4();
  }
  if ((param_2 != 0) &&
