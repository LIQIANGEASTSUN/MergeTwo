...
void FUN_03014ba0(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_03014d00 + 0x3014bb4);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03014d04 + 0x3014bc8));
    func_0x01438628(*(undefined4 *)(_UNK_03014d08 + 0x3014bd4));
    func_0x01438628(*(undefined4 *)(_UNK_03014d0c + 0x3014be0));
    func_0x01438628(*(undefined4 *)(_UNK_03014d10 + 0x3014bec));
    *pcVar7 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x2107,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x2107,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03014d14 + 0x3014c44) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x04e4a028(**(undefined4 **)(_UNK_03014d18 + 0x3014c60));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  ...
  if ((iVar4 != 0) && (0 < *(int *)(iVar4 + 0xc))) {
    ...
    iVar4 = func_0x04cfd760(iVar4,0,**(undefined4 **)(_UNK_03014d1c + 0x3014cb4));
    if (iVar4 == 0) {
      func_0x014388e4();
    }
