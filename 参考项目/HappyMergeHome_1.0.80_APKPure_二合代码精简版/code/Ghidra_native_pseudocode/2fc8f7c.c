...
uint FUN_02fd8f7c(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02fd901c + 0x2fd8f90);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fd9020 + 0x2fd8fa4));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7111,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7111,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02fd9024 + 0x2fd8ffc) + 0x74) == 0) {
    func_0x014387a4();
  }
