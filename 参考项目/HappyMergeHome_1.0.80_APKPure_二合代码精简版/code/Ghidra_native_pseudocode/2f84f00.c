...
uint FUN_02f94f00(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_02f94fe8 + 0x2f94f20);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f94fec + 0x2f94f34));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x6f6e,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x6f6e,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_02f94ff0 + 0x2f94fb0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_02f8feac();
  if (iVar1 == 0) {
  ...
  iVar3 = func_0x02953fd4(0x6f6f,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_02f95120 + 0x2f95088) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02f95124 + 0x2f950a4));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    iVar3 = func_0x02953fd4(0x6f57,0);
    if (iVar3 == 0) {
      iVar3 = func_0x02f97bac(iVar1);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x046c26fc(iVar3,param_3,**(undefined4 **)(_UNK_02f9dac4 + 0x2f9d948));
      if (iVar3 == 0) {
        ...
        if (iVar3 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_3,**(undefined4 **)(_UNK_02f9dad8 + 0x2f9da00));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar3,param_3,**(undefined4 **)(_UNK_02f9dad4 + 0x2f9d97c));
        }
        func_0x03b70fe4(iVar3,param_3,iVar9 + -1,**(undefined4 **)(_UNK_02f9dadc + 0x2f9da24));
        iVar3 = func_0x02f97bac(iVar1);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x03b70fac(iVar3,param_3,**(undefined4 **)(_UNK_02f9dae0 + 0x2f9da54));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x02f97bac(iVar1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar3 = **(int **)(_UNK_02f9dae4 + 0x2f9da94);
...
LAB_046c3e4c:
    ...
    iVar3 = func_0x029540a4(0x6f57,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar3 = func_0x029540a4(0x6f6f,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
