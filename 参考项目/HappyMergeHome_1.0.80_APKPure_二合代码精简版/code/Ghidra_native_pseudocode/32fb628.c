...
void FUN_0330b628(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_0330b6ec + 0x330b640);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0330b6f0 + 0x330b654));
    *pcVar10 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x84e5,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x84e5,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x033183b0(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_0330b6f4 + 0x330b6c4) + 0x74) == 0) {
    func_0x014387a4();
  }
