...
undefined4 FUN_03019ec0(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_03019ffc + 0x3019ed8);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0301a000 + 0x3019eec));
    func_0x01438628(*(undefined4 *)(_UNK_0301a004 + 0x3019ef8));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x72ad,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x72ad,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x046c26fc(iVar1,param_2,**(undefined4 **)(_UNK_0301a008 + 0x3019f90));
  if (iVar1 != 0) {
    iVar1 = FUN_03009c84(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_0301a00c + 0x3019fe8);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
