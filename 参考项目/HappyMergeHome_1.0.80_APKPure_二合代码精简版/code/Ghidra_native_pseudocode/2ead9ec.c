...
void FUN_02ebd9ec(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_02ebdaa4 + 0x2ebda00);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02ebdaa8 + 0x2ebda14));
    *pcVar8 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x47ed,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x47ed,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = FUN_02ebd554(param_1);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_02ebdaac + 0x2ebda7c) + 0x74) == 0) {
    func_0x014387a4();
  }
