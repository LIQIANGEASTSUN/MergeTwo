...
int FUN_018fd1d0(int *param_1,int param_2,int param_3)

{
  ...
  pcVar10 = (char *)(_UNK_018fd3a4 + 0x18fd1f0);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018fd3a8 + 0x18fd204));
    func_0x01438628(*(undefined4 *)(_UNK_018fd3ac + 0x18fd210));
    func_0x01438628(*(undefined4 *)(_UNK_018fd3b0 + 0x18fd21c));
    *pcVar10 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9685,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9685,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_018fd3b4 + 0x18fd284) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018fd3b8 + 0x18fd2a0));
  uVar2 = (**(code **)(*param_1 + 0x1a0))(param_1,*(undefined4 *)(*param_1 + 0x1a4));
  piVar3 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_018fd3bc + 0x18fd2d0),2);
  if (piVar3 == (int *)0x0) {
    func_0x014388e4();
  }
  if ((param_2 != 0) &&
