...
void FUN_01bc3de0(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_01bc3e98 + 0x1bc3df4);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01bc3e9c + 0x1bc3e08));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x3649,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x3649,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x01bc3ea4(param_1);
  iVar7 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_01bc3ea0 + 0x1bc3e70) + 0x74) == 0) {
    func_0x014387a4();
  }
