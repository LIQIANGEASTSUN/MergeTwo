...
void FUN_01d3f7e8(undefined4 param_1,int param_2)

{
  ...
  iVar1 = func_0x02953fd4(0xb3b2,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xb3b2,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  FUN_01d3f6c4(param_1);
  iVar1 = FUN_01d3a9c0(param_1);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  pcVar6 = (char *)(_UNK_0269f764 + 0x269f6dc);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0269f768 + 0x269f6f0),param_2,0);
    func_0x01438628(*(undefined4 *)(_UNK_0269f76c + 0x269f6fc));
    *pcVar6 = '\x01';
  }
  if (*(int *)(iVar1 + 0x34) == param_2) {
    return;
  }
  piVar2 = *(int **)(_UNK_0269f770 + 0x269f71c);
