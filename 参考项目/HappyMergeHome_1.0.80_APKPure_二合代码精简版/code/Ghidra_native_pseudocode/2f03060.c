...
undefined4 FUN_02f13060(int *param_1)

{
  ...
  pcVar8 = (char *)(_UNK_02f131e8 + 0x2f13074);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f131ec + 0x2f13088));
    func_0x01438628(*(undefined4 *)(_UNK_02f131f0 + 0x2f13094));
    func_0x01438628(*(undefined4 *)(_UNK_02f131f4 + 0x2f130a0));
    func_0x01438628(*(undefined4 *)(_UNK_02f131f8 + 0x2f130ac));
    *pcVar8 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x6bdd,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x6bdd,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
    ...
    uVar9 = func_0x035daef8(&uStack_30,0,**(undefined4 **)(_UNK_02869560 + 0x2869548));
    return uVar9;
  }
  iVar4 = (**(code **)(*param_1 + 0x110))(param_1,0,*(undefined4 *)(*param_1 + 0x114));
  if (iVar4 == 0) {
    return **(undefined4 **)(_UNK_02f13208 + 0x2f131e4);
  }
  iVar4 = FUN_02f0ab60(param_1);
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  uVar11 = *(uint *)(iVar4 + 0x18);
  iVar4 = *(int *)(iVar4 + 0x1c);
  if (*(int *)(**(int **)(_UNK_02f131fc + 0x2f1313c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar6 = func_0x04e4a028(**(undefined4 **)(_UNK_02f13200 + 0x2f1315c));
  if (iVar6 == 0) {
    func_0x014388e4();
  }
  uVar14 = func_0x026ffbe0(iVar6,0);
  iVar6 = uVar11 - (uint)uVar14;
  iVar4 = iVar4 - ((int)((ulonglong)uVar14 >> 0x20) + (uint)(uVar11 < (uint)uVar14));
  if ((int)-(iVar4 + (uint)(iVar6 != 0)) < 0 ==
      (SBORROW4(0,iVar4) != SBORROW4(-iVar4,(uint)(iVar6 != 0)))) {
    iVar6 = 0;
    iVar4 = 0;
  }
  if (*(int *)(**(int **)(_UNK_02f13204 + 0x2f1319c) + 0x74) == 0) {
    func_0x014387a4();
  }
  pcVar8 = (char *)(_UNK_02af28fc + 0x2af25f4);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02af2900 + 0x2af2608),iVar4,0,0);
  ...
  if (iVar1 != 0) {
    ...
    uStack_38 = 0;
    uStack_34 = 0;
    uVar9 = func_0x0288f430((int)uVar14,uVar9,iVar6,iVar4);
    return uVar9;
  }
  if ((int)-(iVar4 + (uint)(iVar6 != 0)) < 0 ==
      (SBORROW4(0,iVar4) != SBORROW4(-iVar4,(uint)(iVar6 != 0)))) {
  ...
  uVar2 = func_0x014e6e04(iVar6,iVar4,1000,0);
  if ((int)uVar2 < 0x3c) {
    uVar10 = 0;
    uVar13 = uVar2;
  }
...
LAB_02af2708:
  if (uVar11 == 0) {
    ...
    uStack_38 = 0;
    uVar9 = func_0x0152927c(**(undefined4 **)(_UNK_02af2938 + 0x2af282c),uVar9,uVar5,uVar3);
  }
  else {
    uStack_24 = uVar11;
    if (uVar7 == 0) {
      ...
      uVar9 = func_0x01529a5c(*puVar12,uVar9,0);
    }
    else {
      ...
      uStack_28 = uVar7;
      uVar5 = func_0x014387ac(*puVar12,&uStack_28);
      uVar9 = func_0x014e95b8(**(undefined4 **)(_UNK_02af2924 + 0x2af27cc),uVar9,uVar5,0);
    }
  }
  return uVar9;
}
