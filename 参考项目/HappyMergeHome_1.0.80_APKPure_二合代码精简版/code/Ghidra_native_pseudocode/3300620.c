...
uint FUN_03310620(int param_1,int param_2)

{
  ...
  pcVar12 = (char *)(_UNK_033106e8 + 0x3310638);
  if (*pcVar12 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_033106ec + 0x331064c));
    *pcVar12 = '\x01';
  }
  iVar6 = func_0x02953fd4(0x13d5,0);
  if (iVar6 == 0) {
    if (*(int *)(**(int **)(_UNK_033106f0 + 0x33106a8) + 0x74) == 0) {
      func_0x014387a4();
    }
    ...
    iVar6 = func_0x029540a4(0x13d5,0);
    if (iVar6 == 0) {
      func_0x014388e4();
    }
  }
