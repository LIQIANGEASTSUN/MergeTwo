...
void FUN_01749df4(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_01749eac + 0x1749e08);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01749eb0 + 0x1749e1c));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8cb2,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8cb2,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x0175b974(param_1);
  iVar7 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_01749eb4 + 0x1749e84) + 0x74) == 0) {
    func_0x014387a4();
  }
