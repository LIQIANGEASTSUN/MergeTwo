...
/* WARNING: Possible PIC construction at 0x02f48ac8: Changing call to branch */
/* WARNING: Possible PIC construction at 0x02f48af0: Changing call to branch */
/* WARNING: Possible PIC construction at 0x02f48b18: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x02f48af4) */
/* WARNING: Removing unreachable block (ram,0x02f48b08) */
/* WARNING: Removing unreachable block (ram,0x02f48b0c) */
/* WARNING: Removing unreachable block (ram,0x02f48acc) */
/* WARNING: Removing unreachable block (ram,0x02f48ae0) */
/* WARNING: Removing unreachable block (ram,0x02f48ae4) */
/* WARNING: Removing unreachable block (ram,0x02f48b1c) */
/* WARNING: Removing unreachable block (ram,0x02f48b30) */
/* WARNING: Removing unreachable block (ram,0x02f48b34) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_02f48948(int param_1)

{
  ...
  pcVar11 = (char *)(_UNK_02f48b48 + 0x2f4895c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f48b4c + 0x2f48970));
    func_0x01438628(*(undefined4 *)(_UNK_02f48b50 + 0x2f4897c));
    func_0x01438628(*(undefined4 *)(_UNK_02f48b54 + 0x2f48988));
    func_0x01438628(*(undefined4 *)(_UNK_02f48b58 + 0x2f48994));
    func_0x01438628(*(undefined4 *)(_UNK_02f48b5c + 0x2f489a0));
    func_0x01438628(*(undefined4 *)(_UNK_02f48b60 + 0x2f489ac));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x6e09,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x6e09,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f48b64 + 0x2f48a10) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02f48b68 + 0x2f48a2c));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = func_0x036c7bec(iVar3,**(undefined4 **)(_UNK_02f48b6c + 0x2f48a4c));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar3 + 0x37c) != 0) {
    func_0x03b73ab8(*(int *)(iVar3 + 0x37c),**(undefined4 **)(_UNK_02f48b70 + 0x2f48a7c));
  }
  if (*(int *)(**(int **)(_UNK_02f48b74 + 0x2f48a8c) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar12 = *(undefined4 **)(_UNK_02f48b78 + 0x2f48aa8);
  ...
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x3c,0);
  ...
  if (iVar3 != 0) {
    ...
    puStack_30 = puVar4;
    puStack_2c = puVar12;
    func_0x024f56c0(&uStack_60,0,0x3c,0);
    ...
    func_0x01523a2c(&puStack_48,0x3c,0);
    iVar10 = *(int *)(iVar3 + 8);
    uVar13 = *(undefined4 *)(iVar3 + 0xc);
    iVar3 = *(int *)(iVar3 + 0x10);
    if (iVar10 == 0) {
  ...
  iVar10 = func_0x046ccb14(iVar3,0x3c,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar10 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar1 = (*(code *)*puVar4)(piVar9,0x3c,puVar4[1]);
      iVar3 = iStack_40;
    }
    iVar10 = *(int *)(iVar3 + 8);
    iVar3 = iVar10;
