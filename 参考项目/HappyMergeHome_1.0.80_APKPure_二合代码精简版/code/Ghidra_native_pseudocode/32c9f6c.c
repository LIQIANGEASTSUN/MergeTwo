...

{
  ...
  pcVar7 = (char *)(_UNK_032da014 + 0x32d9f80);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032da018 + 0x32d9f94));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x83bf,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x83bf,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar6 = **(int **)(_UNK_032da01c + 0x32da008);
