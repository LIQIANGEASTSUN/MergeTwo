...
void FUN_02f522d0(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar7 = (char *)(_UNK_02f526d0 + 0x2f522f8);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f526d4 + 0x2f5230c));
    func_0x01438628(*(undefined4 *)(_UNK_02f526d8 + 0x2f52318));
    func_0x01438628(*(undefined4 *)(_UNK_02f526dc + 0x2f52324));
    func_0x01438628(*(undefined4 *)(_UNK_02f526e0 + 0x2f52330));
    func_0x01438628(*(undefined4 *)(_UNK_02f526e4 + 0x2f5233c));
    func_0x01438628(*(undefined4 *)(_UNK_02f526e8 + 0x2f52348));
    func_0x01438628(*(undefined4 *)(_UNK_02f526ec + 0x2f52354));
    func_0x01438628(*(undefined4 *)(_UNK_02f526f0 + 0x2f52360));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x14e0,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_02f526f4 + 0x2f523c4) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_02f526f8 + 0x2f523e0));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    if ((int)(iVar6 - (iVar2 + (uint)bVar12)) < 0 !=
      ...
      func_0x03b70d24(iVar5,**(undefined4 **)(_UNK_02f526fc + 0x2f5256c));
      uVar15 = FUN_02f44c50(param_1);
      ...
      if (*(int *)(**(int **)(_UNK_02f52700 + 0x2f525c0) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_02f52704 + 0x2f525dc));
      piVar10 = *(int **)(_UNK_02f52708 + 0x2f525f0);
      iVar5 = *piVar10;
      if (*(int *)(iVar5 + 0x74) == 0) {
        func_0x014387a4();
        iVar5 = *piVar10;
      ...
      piVar10 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_02f5270c + 0x2f52614),1);
      uStack_54 = 0;
      iVar5 = func_0x014387ac(**(undefined4 **)(_UNK_02f52710 + 0x2f52634),&uStack_54);
      if (piVar10 == (int *)0x0) {
        func_0x014388e4();
      }
      if ((iVar5 != 0) &&
    ...
    iVar2 = func_0x029540a4(0x14e0,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
