...
undefined4 FUN_01927a08(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_01927af4 + 0x1927a1c);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01927af8 + 0x1927a30));
    func_0x01438628(*(undefined4 *)(_UNK_01927afc + 0x1927a3c));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9797,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9797,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01927b00 + 0x1927a94) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01927b04 + 0x1927ab0));
  iVar6 = FUN_01926a78(param_1);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
