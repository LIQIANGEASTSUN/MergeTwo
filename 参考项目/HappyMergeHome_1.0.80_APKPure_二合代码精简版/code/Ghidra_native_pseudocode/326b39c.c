...

{
  ...
  pcVar7 = (char *)(_UNK_0327b444 + 0x327b3b0);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0327b448 + 0x327b3c4));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x815d,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x815d,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar6 = **(int **)(_UNK_0327b44c + 0x327b438);
