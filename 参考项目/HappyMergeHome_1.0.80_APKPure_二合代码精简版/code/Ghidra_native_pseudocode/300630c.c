...
void FUN_0301630c(int param_1,undefined4 param_2)

{
  ...
  iVar2 = func_0x02953fd4(0x72a7,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x72a7,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (iVar2 != 0) {
    iVar2 = FUN_03016258(param_1,param_2);
    if (iVar2 != 0) {
      return;
    }
    iVar2 = FUN_03014eac(param_1,param_2);
    if (iVar2 != 0) {
