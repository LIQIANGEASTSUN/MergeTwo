...

{
  ...
  pcVar9 = (char *)(_UNK_018c7584 + 0x18c7410);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018c7588 + 0x18c7424));
    func_0x01438628(*(undefined4 *)(_UNK_018c758c + 0x18c7430));
    func_0x01438628(*(undefined4 *)(_UNK_018c7590 + 0x18c743c));
    func_0x01438628(*(undefined4 *)(_UNK_018c7594 + 0x18c7448));
    func_0x01438628(*(undefined4 *)(_UNK_018c7598 + 0x18c7454));
    func_0x01438628(*(undefined4 *)(_UNK_018c759c + 0x18c7460));
    *pcVar9 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9537,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9537,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_018c75a0 + 0x18c74c4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018c75a4 + 0x18c74e0));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar1 = func_0x036c7bec(iVar1,**(undefined4 **)(_UNK_018c75a8 + 0x18c7500));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar1 + 0x348) != 0) {
    func_0x024f04d0(*(int *)(iVar1 + 0x348),**(undefined4 **)(_UNK_018c75ac + 0x18c7530));
  }
  if (*(int *)(**(int **)(_UNK_018c75b0 + 0x18c7540) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018c75b4 + 0x18c755c));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  pcVar9 = (char *)(_UNK_02be82b0 + 0x2be8170);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x31,0);
  ...
  if (iVar10 != 0) {
    ...
    uStack_38 = 0;
    uStack_28 = 0;
    func_0x024f56c0(&uStack_50,0,0x31,0);
    uStack_38 = uStack_50;
    iStack_34 = uStack_4c;
    uStack_30 = uStack_48;
    uStack_2c = iStack_44;
    ...
    func_0x01523a2c(&uStack_38,0x31,0);
    iVar11 = *(int *)(iVar10 + 8);
  ...
  iVar1 = func_0x046ccb14(uVar3,0x31,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar1 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar2 = (*(code *)*puVar4)(piVar8,0x31,puVar4[1]);
      uVar3 = uStack_30;
    }
    iVar10 = *(int *)(uVar3 + 8);
    iVar1 = iVar10;
