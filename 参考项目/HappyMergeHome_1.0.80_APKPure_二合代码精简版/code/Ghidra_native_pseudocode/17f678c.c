...

{
  ...
  pcVar6 = (char *)(_UNK_01806834 + 0x18067a0);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01806838 + 0x18067b4));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x90cf,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x90cf,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar7 = **(int **)(_UNK_0180683c + 0x1806828);
