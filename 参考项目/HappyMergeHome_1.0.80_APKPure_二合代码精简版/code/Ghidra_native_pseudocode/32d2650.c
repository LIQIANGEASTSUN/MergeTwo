...
void FUN_032e2650(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_032e2708 + 0x32e2664);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032e270c + 0x32e2678));
    *pcVar8 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x835a,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x835a,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = FUN_032e241c(param_1);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_032e2710 + 0x32e26e0) + 0x74) == 0) {
    func_0x014387a4();
  }
