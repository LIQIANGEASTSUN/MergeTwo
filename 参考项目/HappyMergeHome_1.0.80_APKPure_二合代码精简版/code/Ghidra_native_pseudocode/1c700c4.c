...
void FUN_01c800c4(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_01c801ec + 0x1c800d8);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01c801f0 + 0x1c800ec));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xadd0,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xadd0,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    uStack_50 = 0;
    uStack_4c = 0;
    func_0x024f56d0(iVar8,uVar10,&iStack_30,uVar5);
    return;
  }
  ...
  iVar8 = func_0x02b637f8(iVar1,0x1d58,0);
  if (iVar8 != 0) {
    return;
  }
  ...
  if (*(char *)(iVar8 + 0x58) == '\0') {
    return;
  }
  iVar8 = **(int **)(*piVar9 + 0x5c);
  if (iVar8 == 0) {
    func_0x014388e4();
  }
  pcVar7 = (char *)(_UNK_02b67a88 + 0x2b6790c);
  piStack_28 = (int *)iVar8;
  iStack_24 = iVar1;
  if (*pcVar7 == '\0') {
  ...
  iVar1 = func_0x02953fd4(0x67f,0);
  if (iVar1 == 0) {
    iVar1 = func_0x014388d4(**(undefined4 **)(_UNK_02b67aa4 + 0x2b679b8));
    func_0x02b68b1c(iVar1,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    piVar3 = *(int **)(_UNK_02b67aa8 + 0x2b679e0);
    *(undefined4 *)(iVar1 + 8) = 0x1d57;
    if (*(int *)(*piVar3 + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar4 = func_0x03b2c734(**(undefined4 **)(_UNK_02b67aac + 0x2b67a00));
    if (iVar4 == 0) {
      func_0x014388e4();
    }
    iVar4 = func_0x029b55e8(iVar4,0);
    uVar10 = func_0x014388d4(**(undefined4 **)(_UNK_02b67ab0 + 0x2b67a30));
    func_0x03a062d0(uVar10,iVar1,**(undefined4 **)(_UNK_02b67ab4 + 0x2b67a4c),0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
    iVar1 = func_0x024f0618(iVar4,uVar10,**(undefined4 **)(_UNK_02b67ab8 + 0x2b67a70));
    iStack_2c = iStack_24;
    iStack_30 = (int)piStack_28;
    pcVar7 = (char *)(_UNK_02b66efc + 0x2b66828);
    piStack_28 = piVar9;
    if (*pcVar7 == '\0') {
    ...
    iVar4 = func_0x02953fd4(0x682,0);
    if (iVar4 == 0) {
      iVar4 = func_0x014388d4(**(undefined4 **)(_UNK_02b66f60 + 0x2b669ac));
      func_0x02b68a30(iVar4,0);
      if (iVar4 == 0) {
        func_0x014388e4();
      }
      piVar9 = (int *)(iVar4 + 8);
      *piVar9 = iVar1;
      ...
      if (*piVar9 != 0) {
        uVar5 = *(undefined4 *)(*piVar9 + 8);
        uStack_34 = uVar5;
        uVar10 = func_0x024ef924(iVar8,0);
        uStack_38 = uVar5;
        uVar5 = func_0x014387ac(**(undefined4 **)(_UNK_02b66f64 + 0x2b66a10),&uStack_38);
        uVar10 = func_0x014e95b8(**(undefined4 **)(_UNK_02b66f68 + 0x2b66a30),uVar10,uVar5,0);
        ...
        func_0x026794a8(uVar10,uVar5,0);
        uVar10 = uStack_34;
        iVar1 = *(int *)(iVar8 + 0xc);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        iVar1 = func_0x046c26fc(iVar1,uVar10,**(undefined4 **)(_UNK_02b66f74 + 0x2b66af4));
        uVar10 = uStack_34;
        if (iVar1 == 0) {
          iVar1 = *(int *)(iVar8 + 0xc);
          if (iVar1 == 0) {
          ...
          func_0x046c24b0(iVar1,uVar10,uVar10,**(undefined4 **)(_UNK_02b66f78 + 0x2b66b2c));
        }
        iVar1 = *piVar9;
        if (iVar1 == 0) {
          func_0x014388e4();
        ...
        if (*(char *)(iVar1 + 0x11) != '\0') {
          ...
          iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_02b66f80 + 0x2b66b78));
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar1 = func_0x036c7bec(iVar1,**(undefined4 **)(_UNK_02b66f84 + 0x2b66b98));
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          ...
          iVar1 = *(int *)(iVar1 + 8);
          if (iVar1 != 0) {
            uVar10 = func_0x01524ffc(&uStack_34,0);
            iVar6 = func_0x04753c80(iVar1,uVar10,**(undefined4 **)(_UNK_02b66f88 + 0x2b66be8));
            if (iVar6 == 0) {
              uVar10 = func_0x01524ffc(&uStack_34,0);
              uVar5 = func_0x01524ffc(&uStack_34,0);
              func_0x03b73a64(iVar1,uVar10,uVar5,**(undefined4 **)(_UNK_02b66f8c + 0x2b66c2c));
            }
          }
          func_0x02b66fc0(iVar8,*piVar9);
        }
        if (*(int *)(**(int **)(_UNK_02b66f90 + 0x2b66c4c) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_02b66f94 + 0x2b66c68));
        ...
        uVar10 = *(undefined4 *)(*(int *)(iVar6 + 0x5c) + 0x180);
        ...
        func_0x02990414(iVar1,uVar10,piVar3,0);
        iVar1 = *piVar9;
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar10 = func_0x01524ffc(iVar1 + 8,0);
        func_0x02b6127c(iVar8,1,uVar10,0);
        iVar1 = *piVar9;
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        if (0 < *(int *)(iVar1 + 0x38)) {
          ...
          iVar1 = func_0x03b2c734(**(undefined4 **)(_UNK_02b66fa4 + 0x2b66da0));
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar1 = func_0x029b55e8(iVar1,0);
          uVar10 = func_0x014388d4(**(undefined4 **)(_UNK_02b66fa8 + 0x2b66dd0));
          func_0x03a062d0(uVar10,iVar4,**(undefined4 **)(_UNK_02b66fac + 0x2b66dec),0);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar1 = func_0x024f0618(iVar1,uVar10,**(undefined4 **)(_UNK_02b66fb0 + 0x2b66e10));
          if (iVar1 != 0) {
            if (*(char *)(iVar1 + 0x28) != '\0') {
              ...
              uVar10 = func_0x014e9518(*puVar11);
              if (*(int *)(**(int **)(_UNK_02b66fbc + 0x2b66e6c) + 0x74) == 0) {
                func_0x014387a4();
              }
              iVar4 = func_0x024ef144(uVar10,0,0);
              if (iVar4 != 0) {
                if (*(int *)(*piVar9 + 0x74) == 0) {
                  func_0x014387a4();
                }
                ...
                uStack_40 = 0;
                iVar4 = func_0x02bdd790(iVar4,1,0,0);
                if (iVar4 < 0) {
                  return;
                }
              }
            }
            func_0x02b61988(iVar8,iVar1,0);
          }
        }
      }
    }
    else {
      iVar4 = func_0x029540a4(0x682,0);
      if (iVar4 == 0) {
        func_0x014388e4();
      }
      func_0x02869298(iVar4,iVar8,iVar1,0);
    }
    return;
  }
  iVar1 = func_0x029540a4(0x67f,0);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iStack_2c = iStack_24;
  ...
  uStack_38 = uStack_50;
  if (*(int *)(iVar1 + 0x10) != 0) {
    func_0x01523a6c(&iStack_48,*(int *)(iVar1 + 0x10),0);
  }
  func_0x01523a6c(&iStack_48,iVar8,0);
  ...
  func_0x024f56d0(iVar8,uVar10,&iStack_48,uVar5,0,0);
  return;
}
