...
uint FUN_017d45c0(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar1 = func_0x02953fd4(0x8f99,0);
  if (iVar1 == 0) {
    pcVar10 = (char *)(_UNK_017daf60 + 0x17dac40);
    uStack_1c = param_2;
    uStack_18 = unaff_r4;
    if (*pcVar10 == '\0') {
    ...
    iVar1 = func_0x02953fd4(0x8f93,0);
    if (iVar1 == 0) {
      if (*(int *)(**(int **)(_UNK_017daf8c + 0x17dad20) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_017daf90 + 0x17dad3c));
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x029a6fa8(iVar1,param_2,0);
      if (iVar1 != 0) {
        iVar9 = func_0x017d5398(param_1);
        if (iVar9 == 0) {
          func_0x014388e4();
        }
        if (*(int *)(iVar9 + 0x10) != 0) {
          ...
          iVar1 = func_0x024f0f34(iVar9,uVar11,**(undefined4 **)(_UNK_017daf94 + 0x17dadcc));
          if (iVar1 == 0) {
            return 0;
          }
        }
      }
      iVar1 = func_0x017d5b5c(param_1);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_017daf98 + 0x17dae04));
      if (iVar1 == 0) {
        uVar11 = func_0x01524ffc(&uStack_1c,0);
        uVar11 = func_0x024eee28(**(undefined4 **)(_UNK_017daf9c + 0x17dae68),uVar11,
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_2,**(undefined4 **)(_UNK_017dafac + 0x17daebc));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar1,param_2,**(undefined4 **)(_UNK_017dafa8 + 0x17dae38));
        }
        func_0x024f10d4(iVar1,param_2,iVar9 + -1,**(undefined4 **)(_UNK_017dafb0 + 0x17daee0));
        iVar1 = func_0x017d5b5c(param_1);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x024f05d4(iVar1,param_2,**(undefined4 **)(_UNK_017dafb4 + 0x17daf10));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x017d5b5c(param_1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar9 = **(int **)(_UNK_017dafb8 + 0x17daf50);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x8f93,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x8f99,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
