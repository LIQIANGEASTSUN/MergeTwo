...

{
  ...
  pcVar7 = (char *)(_UNK_02f904e0 + 0x2f90394);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f904e4 + 0x2f903a8));
    func_0x01438628(*(undefined4 *)(_UNK_02f904e8 + 0x2f903b4));
    func_0x01438628(*(undefined4 *)(_UNK_02f904ec + 0x2f903c0));
    *pcVar7 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x2b6a,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x2b6a,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f904f0 + 0x2f90418) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_02f904f4 + 0x2f90434));
  uVar9 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar10 = **(int **)(_UNK_02f904f8 + 0x2f90460);
