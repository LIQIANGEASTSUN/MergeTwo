...

{
  ...
  pcVar5 = (char *)(_UNK_01759774 + 0x1759624);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01759778 + 0x1759638));
    func_0x01438628(*(undefined4 *)(_UNK_0175977c + 0x1759644));
    func_0x01438628(*(undefined4 *)(_UNK_01759780 + 0x1759650));
    func_0x01438628(*(undefined4 *)(_UNK_01759784 + 0x175965c));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x2077,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_01759788 + 0x17596b4) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0175978c + 0x17596d0));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iVar2 = *(int *)(iVar2 + 0x14);
    if ((iVar2 != 0) && (0 < *(int *)(iVar2 + 0xc))) {
      iVar6 = FUN_0174e5a0(param_1);
      if (iVar6 == 0) {
        func_0x014388e4();
      }
      iVar6 = *(int *)(iVar6 + 0x6c);
      iVar2 = func_0x0152983c(iVar2,0,**(undefined4 **)(_UNK_01759790 + 0x1759724));
      if (iVar2 == 0) {
        func_0x014388e4();
      }
    ...
    iVar2 = func_0x02953fd4(0x2079,0);
    if (iVar2 == 0) {
...
LAB_01759c04:
            ...
            if (*(char *)(iVar3 + 0xd) == '\0') goto LAB_01759c04;
            iVar3 = FUN_0174e5a0(param_1);
            if (iVar3 == 0) {
              func_0x014388e4();
            }
    ...
    iVar2 = func_0x029540a4(0x2079,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar2 = func_0x029540a4(0x2077,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
