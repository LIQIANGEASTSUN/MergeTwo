...
uint FUN_02f25aac(int param_1,int param_2)

{
  ...
  pcVar12 = (char *)(_UNK_02f25b74 + 0x2f25ac4);
  if (*pcVar12 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f25b78 + 0x2f25ad8));
    *pcVar12 = '\x01';
  }
  iVar6 = func_0x02953fd4(0x1325,0);
  if (iVar6 == 0) {
    if (*(int *)(**(int **)(_UNK_02f25b7c + 0x2f25b34) + 0x74) == 0) {
      func_0x014387a4();
    }
    ...
    iVar6 = func_0x029540a4(0x1325,0);
    if (iVar6 == 0) {
      func_0x014388e4();
    }
  }
