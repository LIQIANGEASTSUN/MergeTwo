...

{
  ...
  iVar1 = func_0x02953fd4(0x2ed8,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x2ed8,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    uStack_50 = 0;
    uStack_4c = 0;
    func_0x024f56d0(iVar7,uVar5,&uStack_30,uVar3);
    return;
  }
  piVar2 = (int *)FUN_02b3dda0();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
  pcVar6 = (char *)(_UNK_029f262c + 0x29f2550);
  if (*pcVar6 == '\0') {
  ...
  if (iVar1 == 0) {
    ...
    pcVar6 = (char *)(_UNK_029f2a14 + 0x29f272c);
    if (*pcVar6 == '\0') {
    ...
    if (iVar7 == 0) {
      ...
      if (iVar7 == 0) {
        ...
        iVar4 = **(int **)(_UNK_029f2a50 + 0x29f2984);
        ...
        iVar4 = **(int **)(_UNK_029f2a40 + 0x29f2874);
        iVar7 = *(int *)(iVar4 + 0x1c);
        if (iVar7 == 0) {
          func_0x014909d8(iVar4);
          iVar7 = *(int *)(iVar4 + 0x1c);
    ...
    func_0x024f56d0(iVar4,uVar3,&uStack_38,uVar5,0,0);
    return;
  }
  ...
  uStack_50 = 0;
  uStack_4c = 0;
  func_0x024f56d0(iVar7,uVar3,&uStack_30,uVar5);
  return;
}
