...
int FUN_02fa0d6c(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_02fa0e8c + 0x2fa0d80);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fa0e90 + 0x2fa0d94));
    func_0x01438628(*(undefined4 *)(_UNK_02fa0e94 + 0x2fa0da0));
    func_0x01438628(*(undefined4 *)(_UNK_02fa0e98 + 0x2fa0dac));
    func_0x01438628(*(undefined4 *)(_UNK_02fa0e9c + 0x2fa0db8));
    *pcVar9 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x214f,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x214f,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02fa0ea0 + 0x2fa0e10) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02fa0ea4 + 0x2fa0e2c));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  ...
  iVar3 = func_0x04cfd760(iVar3,*(int *)(iVar3 + 0xc) + -1,
                          **(undefined4 **)(_UNK_02fa0ea8 + 0x2fa0e5c));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = *(int *)(iVar3 + 0x24);
  pcVar9 = (char *)(_UNK_02f9ed44 + 0x2f9e948);
  iStack_24 = unaff_r4;
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f9ed48 + 0x2f9e95c));
    func_0x01438628(*(undefined4 *)(_UNK_02f9ed4c + 0x2f9e968));
    func_0x01438628(*(undefined4 *)(_UNK_02f9ed50 + 0x2f9e974));
    func_0x01438628(*(undefined4 *)(_UNK_02f9ed54 + 0x2f9e980));
    func_0x01438628(*(undefined4 *)(_UNK_02f9ed58 + 0x2f9e98c));
    func_0x01438628(*(undefined4 *)(_UNK_02f9ed5c + 0x2f9e998));
    func_0x01438628(*(undefined4 *)(_UNK_02f9ed60 + 0x2f9e9a4));
    func_0x01438628(*(undefined4 *)(_UNK_02f9ed64 + 0x2f9e9b0));
    func_0x01438628(*(undefined4 *)(_UNK_02f9ed68 + 0x2f9e9bc));
    func_0x01438628(*(undefined4 *)(_UNK_02f9ed6c + 0x2f9e9c8));
    *pcVar9 = '\x01';
  }
  iVar6 = func_0x02953fd4(0x2150,0);
  if (iVar6 == 0) {
    ...
    puVar11 = *(undefined4 **)(_UNK_02f9ed70 + 0x2f9ea68);
    iVar6 = func_0x04cd2d7c(iVar6,iVar3,*puVar11);
    if (iVar6 == 0) {
      if (*(int *)(**(int **)(_UNK_02f9ed74 + 0x2f9ea88) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar6 = func_0x04e4a028(**(undefined4 **)(_UNK_02f9ed78 + 0x2f9eaa4));
      if (iVar6 == 0) {
        func_0x014388e4();
      }
      iVar6 = *(int *)(iVar6 + 0x2c);
      iVar7 = 0;
      puVar12 = *(undefined4 **)(_UNK_02f9ed7c + 0x2f9eacc);
      while( true ) {
        if (iVar6 == 0) {
          func_0x014388e4();
        }
          ...
          while( true ) {
            ...
            if (*(int *)(iVar2 + 0x24) <= iVar3) {
              ...
              if (iVar2 == 0) {
                ...
                func_0x03b75ba0(iVar2,uVar10,**(undefined4 **)(_UNK_02f9ed80 + 0x2f9ec44));
              }
            }
            iVar7 = iVar7 + 1;
          }
          func_0x02fa1478(param_1);
          if (*(int *)(**(int **)(_UNK_02f9ed84 + 0x2f9ec68) + 0x74) == 0) {
            func_0x014387a4();
          }
          iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02f9ed88 + 0x2f9ec84));
          piVar8 = *(int **)(_UNK_02f9ed8c + 0x2f9ec98);
          iVar6 = *piVar8;
          if (*(int *)(iVar6 + 0x74) == 0) {
            func_0x014387a4();
            iVar6 = *piVar8;
          }
          iVar2 = **(int **)(_UNK_02f9ed90 + 0x2f9ecb8);
  ...
  iVar6 = func_0x029540a4(0x2150,0);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
  puStack_20 = (undefined4 *)iStack_24;
