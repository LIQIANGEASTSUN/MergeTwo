...

{
  ...
  pcVar4 = (char *)(_UNK_0330eda8 + 0x330ed0c);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0330edac + 0x330ed20));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8529,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8529,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0330edb0 + 0x330ed74) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_0330a560();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
