...
/* WARNING: Possible PIC construction at 0x01963f28: Changing call to branch */
/* WARNING: Possible PIC construction at 0x01963f50: Changing call to branch */
/* WARNING: Possible PIC construction at 0x01963f78: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x01963f54) */
/* WARNING: Removing unreachable block (ram,0x01963f68) */
/* WARNING: Removing unreachable block (ram,0x01963f6c) */
/* WARNING: Removing unreachable block (ram,0x01963f2c) */
/* WARNING: Removing unreachable block (ram,0x01963f40) */
/* WARNING: Removing unreachable block (ram,0x01963f44) */
/* WARNING: Removing unreachable block (ram,0x01963f7c) */
/* WARNING: Removing unreachable block (ram,0x01963f90) */
/* WARNING: Removing unreachable block (ram,0x01963f94) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_01963da8(int param_1)

{
  ...
  pcVar10 = (char *)(_UNK_01963fa8 + 0x1963dbc);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01963fac + 0x1963dd0));
    func_0x01438628(*(undefined4 *)(_UNK_01963fb0 + 0x1963ddc));
    func_0x01438628(*(undefined4 *)(_UNK_01963fb4 + 0x1963de8));
    func_0x01438628(*(undefined4 *)(_UNK_01963fb8 + 0x1963df4));
    func_0x01438628(*(undefined4 *)(_UNK_01963fbc + 0x1963e00));
    func_0x01438628(*(undefined4 *)(_UNK_01963fc0 + 0x1963e0c));
    *pcVar10 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9926,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9926,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01963fc4 + 0x1963e70) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01963fc8 + 0x1963e8c));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar1 = func_0x036c7bec(iVar1,**(undefined4 **)(_UNK_01963fcc + 0x1963eac));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar1 + 0x39c) != 0) {
    func_0x024f04d0(*(int *)(iVar1 + 0x39c),**(undefined4 **)(_UNK_01963fd0 + 0x1963edc));
  }
  if (*(int *)(**(int **)(_UNK_01963fd4 + 0x1963eec) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar11 = *(undefined4 **)(_UNK_01963fd8 + 0x1963f08);
  ...
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x50,0);
  ...
  if (iVar1 != 0) {
    ...
    puStack_30 = puVar2;
    puStack_2c = puVar11;
    func_0x024f56c0(&uStack_60,0,0x50,0);
    ...
    func_0x01523a2c(&puStack_48,0x50,0);
    iVar12 = *(int *)(iVar1 + 8);
    uVar13 = *(undefined4 *)(iVar1 + 0xc);
    iVar1 = *(int *)(iVar1 + 0x10);
    if (iVar12 == 0) {
  ...
  iVar12 = func_0x046ccb14(iVar1,0x50,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar12 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar3 = (*(code *)*puVar2)(piVar9,0x50,puVar2[1]);
      iVar1 = iStack_40;
    }
    iVar12 = *(int *)(iVar1 + 8);
    iVar1 = iVar12;
