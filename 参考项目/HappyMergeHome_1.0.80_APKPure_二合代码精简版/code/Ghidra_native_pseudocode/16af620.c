...
/* WARNING: Possible PIC construction at 0x016beeac: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x016beeb0) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_016bf620(int param_1)

{
  ...
  iVar2 = func_0x02953fd4(0x88f1,0);
  if (iVar2 == 0) {
    ...
    iVar2 = FUN_016be938(param_1);
    if (iVar2 <= iVar3) {
      return;
    }
    pcVar5 = (char *)(_UNK_016bf12c + 0x16bedd0);
    if (*pcVar5 == '\0') {
    ...
    uStack_30 = 0;
    iVar2 = func_0x02953fd4(0x88f4,0);
    if (iVar2 == 0) {
      if (*(int *)(**(int **)(_UNK_016bf15c + 0x16beec0) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_016bf160 + 0x16beedc));
      if (iVar2 == 0) {
        func_0x014388e4();
      }
      iVar2 = func_0x024f04cc(iVar2,**(undefined4 **)(_UNK_016bf164 + 0x16beefc));
      if (iVar2 == 0) {
        func_0x014388e4();
      }
      iVar3 = *(int *)(iVar2 + 8);
      ...
      uVar7 = FUN_016be8d0(param_1,*(undefined4 *)(iVar2 + 0x74));
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar2 = func_0x024f110c(iVar3,uVar7,**(undefined4 **)(_UNK_016bf168 + 0x16bef5c));
      if (iVar2 != 0) {
        iVar3 = *(int *)(iVar2 + 0x10);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        func_0x0152da0c(&uStack_40,iVar3,**(undefined4 **)(_UNK_016bf16c + 0x16bef94));
        uStack_30 = uStack_40;
        uStack_2c = uStack_3c;
        uStack_28 = uStack_38;
        iStack_24 = iStack_34;
        puVar6 = *(undefined4 **)(_UNK_016bf170 + 0x16befb0);
        puVar8 = *(undefined4 **)(_UNK_016bf174 + 0x16befb8);
        ...
        func_0x024f0708(iVar2,**(undefined4 **)(_UNK_016bf180 + 0x16bf060));
        if (*(int *)(**(int **)(_UNK_016bf184 + 0x16bf074) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar2 = FUN_016b4854();
        if (iVar2 != 0) {
          func_0x016de5f4(iVar2,0);
        }
      }
      return;
    }
    iVar2 = func_0x029540a4(0x88f4,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    unaff_lr = 0x16beeb0;
    ...
    iVar2 = func_0x029540a4(0x88f1,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
