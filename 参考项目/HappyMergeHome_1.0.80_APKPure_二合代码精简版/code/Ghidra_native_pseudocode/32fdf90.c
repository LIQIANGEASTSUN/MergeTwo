...
uint FUN_0330df90(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar2 = func_0x02953fd4(0x851f,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_0330e0bc + 0x330e024) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0330e0c0 + 0x330e040));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x02953fd4(0x84fd,0);
    if (iVar2 == 0) {
      iVar2 = func_0x033105b4(param_1);
      if (iVar2 == 0) {
        func_0x014388e4();
      }
      iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_033156f0 + 0x3315574));
      if (iVar2 == 0) {
        ...
        if (iVar2 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_03315704 + 0x331562c));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar2,param_2,**(undefined4 **)(_UNK_03315700 + 0x33155a8));
        }
        func_0x03b70fe4(iVar2,param_2,iVar9 + -1,**(undefined4 **)(_UNK_03315708 + 0x3315650));
        iVar2 = func_0x033105b4(param_1);
        if (iVar2 == 0) {
          func_0x014388e4();
        }
        uVar1 = func_0x03b70fac(iVar2,param_2,**(undefined4 **)(_UNK_0331570c + 0x3315680));
        if ((int)uVar1 < 1) {
          iVar2 = func_0x033105b4(param_1);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar9 = **(int **)(_UNK_03315710 + 0x33156c0);
...
LAB_046c3e4c:
    ...
    iVar2 = func_0x029540a4(0x84fd,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar2 = func_0x029540a4(0x851f,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
