...
/* WARNING: Possible PIC construction at 0x030831d4: Changing call to branch */
/* WARNING: Possible PIC construction at 0x030831fc: Changing call to branch */
/* WARNING: Possible PIC construction at 0x03083224: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x03083200) */
/* WARNING: Removing unreachable block (ram,0x03083214) */
/* WARNING: Removing unreachable block (ram,0x03083218) */
/* WARNING: Removing unreachable block (ram,0x030831d8) */
/* WARNING: Removing unreachable block (ram,0x030831ec) */
/* WARNING: Removing unreachable block (ram,0x030831f0) */
/* WARNING: Removing unreachable block (ram,0x03083228) */
/* WARNING: Removing unreachable block (ram,0x0308323c) */
/* WARNING: Removing unreachable block (ram,0x03083240) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_03083054(int param_1)

{
  ...
  pcVar11 = (char *)(_UNK_03083254 + 0x3083068);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03083258 + 0x308307c));
    func_0x01438628(*(undefined4 *)(_UNK_0308325c + 0x3083088));
    func_0x01438628(*(undefined4 *)(_UNK_03083260 + 0x3083094));
    func_0x01438628(*(undefined4 *)(_UNK_03083264 + 0x30830a0));
    func_0x01438628(*(undefined4 *)(_UNK_03083268 + 0x30830ac));
    func_0x01438628(*(undefined4 *)(_UNK_0308326c + 0x30830b8));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x75a3,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x75a3,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03083270 + 0x308311c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03083274 + 0x3083138));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = func_0x036c7bec(iVar3,**(undefined4 **)(_UNK_03083278 + 0x3083158));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar3 + 900) != 0) {
    func_0x03b73ab8(*(int *)(iVar3 + 900),**(undefined4 **)(_UNK_0308327c + 0x3083188));
  }
  if (*(int *)(**(int **)(_UNK_03083280 + 0x3083198) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar12 = *(undefined4 **)(_UNK_03083284 + 0x30831b4);
  ...
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x41,0);
  ...
  if (iVar3 != 0) {
    ...
    puStack_30 = puVar4;
    puStack_2c = puVar12;
    func_0x024f56c0(&uStack_60,0,0x41,0);
    ...
    func_0x01523a2c(&puStack_48,0x41,0);
    iVar10 = *(int *)(iVar3 + 8);
    uVar13 = *(undefined4 *)(iVar3 + 0xc);
    iVar3 = *(int *)(iVar3 + 0x10);
    if (iVar10 == 0) {
  ...
  iVar10 = func_0x046ccb14(iVar3,0x41,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar10 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar1 = (*(code *)*puVar4)(piVar9,0x41,puVar4[1]);
      iVar3 = iStack_40;
    }
    iVar10 = *(int *)(iVar3 + 8);
    iVar3 = iVar10;
