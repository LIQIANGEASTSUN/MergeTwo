...
int FUN_0300ba4c(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_0300bb18 + 0x300ba60);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0300bb1c + 0x300ba74));
    func_0x01438628(*(undefined4 *)(_UNK_0300bb20 + 0x300ba80));
    *pcVar9 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7280,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7280,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0300bb24 + 0x300bad8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0300bb28 + 0x300baf4));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
