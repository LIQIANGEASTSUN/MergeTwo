...
uint FUN_0183a214(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_0183a2fc + 0x183a234);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0183a300 + 0x183a248));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x9239,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x9239,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0183a304 + 0x183a2c4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_01833590();
  if (iVar2 == 0) {
