...
void FUN_02bacecc(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_02bacf20 + 0x2bacee0);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02bacf24 + 0x2bacef4));
    *pcVar7 = '\x01';
  }
  **(undefined1 **)(**(int **)(_UNK_02bacf28 + 0x2bacf0c) + 0x5c) = 0;
  pcVar7 = (char *)(_UNK_02ba9d0c + 0x2ba96d8);
  if (*pcVar7 == '\0') {
  ...
  if (*(char *)(iVar1 + 0x2d) != '\0') {
    piVar6 = *(int **)(_UNK_02ba9d3c + 0x2ba97e0);
    iVar1 = *piVar6;
    if (*(int *)(iVar1 + 0x74) == 0) {
      func_0x014387a4();
      iVar1 = *piVar6;
  ...
  if (iVar1 != 0) {
    ...
    if (*(char *)(iVar1 + 0xc) != '\0') {
      piVar6 = *(int **)(_UNK_02ba9d40 + 0x2ba98bc);
      pcVar7 = *(char **)(*piVar6 + 0x5c);
      if (pcVar7[1] == '\0') {
        iVar1 = **(int **)(*piVar10 + 0x5c);
        if (iVar1 == 0) {
          func_0x014388e4();
        ...
        if (iVar1 == 0) {
          piVar6 = *(int **)(_UNK_02ba9d58 + 0x2ba9ab4);
