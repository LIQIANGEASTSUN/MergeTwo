...
void FUN_03140628(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_031406ec + 0x3140640);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031406f0 + 0x3140654));
    *pcVar10 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x79c4,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x79c4,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x031523bc(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_031406f4 + 0x31406c4) + 0x74) == 0) {
    func_0x014387a4();
  }
