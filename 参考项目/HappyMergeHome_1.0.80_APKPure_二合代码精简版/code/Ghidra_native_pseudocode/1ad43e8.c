...
uint FUN_01ae43e8(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_01ae4488 + 0x1ae43fc);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01ae448c + 0x1ae4410));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xa487,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xa487,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01ae4490 + 0x1ae4468) + 0x74) == 0) {
    func_0x014387a4();
  }
  ...
  if (iVar1 != 0) {
    ...
    func_0x01523a2c(&uStack_30,0x54,0);
    iVar5 = *(int *)(iVar1 + 8);
    uVar6 = *(undefined4 *)(iVar1 + 0xc);
    iVar1 = *(int *)(iVar1 + 0x10);
    if (iVar5 == 0) {
