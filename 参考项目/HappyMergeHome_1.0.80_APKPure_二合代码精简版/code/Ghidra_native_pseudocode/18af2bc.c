...
void FUN_018bf2bc(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar8 = (char *)(_UNK_018bf380 + 0x18bf2d4);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018bf384 + 0x18bf2e8));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x94ea,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x94ea,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x018d01f8(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_018bf388 + 0x18bf358) + 0x74) == 0) {
    func_0x014387a4();
  }
