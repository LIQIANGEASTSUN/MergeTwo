...
void FUN_01af6e4c(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_01af6f04 + 0x1af6e60);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01af6f08 + 0x1af6e74));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xa4fd,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xa4fd,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = FUN_01af6824(param_1);
  iVar7 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_01af6f0c + 0x1af6edc) + 0x74) == 0) {
    func_0x014387a4();
  }
