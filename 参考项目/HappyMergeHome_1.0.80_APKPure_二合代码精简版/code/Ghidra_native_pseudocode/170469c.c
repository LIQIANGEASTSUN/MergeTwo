...

{
  ...
  pcVar3 = (char *)(_UNK_01714748 + 0x17146ac);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0171474c + 0x17146c0));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8b76,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8b76,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01714750 + 0x1714714) + 0x74) == 0) {
    func_0x014387a4();
  }
