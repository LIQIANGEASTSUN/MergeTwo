...
uint FUN_0320b9fc(int param_1,int param_2)

{
  ...
  pcVar12 = (char *)(_UNK_0320bac4 + 0x320ba14);
  if (*pcVar12 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0320bac8 + 0x320ba28));
    *pcVar12 = '\x01';
  }
  iVar6 = func_0x02953fd4(0x140c,0);
  if (iVar6 == 0) {
    if (*(int *)(**(int **)(_UNK_0320bacc + 0x320ba84) + 0x74) == 0) {
      func_0x014387a4();
    }
    ...
    iVar6 = func_0x029540a4(0x140c,0);
    if (iVar6 == 0) {
      func_0x014388e4();
    }
  }
