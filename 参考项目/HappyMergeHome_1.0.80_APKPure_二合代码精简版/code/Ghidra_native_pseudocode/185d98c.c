...

{
  ...
  pcVar7 = (char *)(_UNK_0186daec + 0x186d9a0);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0186daf0 + 0x186d9b4));
    func_0x01438628(*(undefined4 *)(_UNK_0186daf4 + 0x186d9c0));
    func_0x01438628(*(undefined4 *)(_UNK_0186daf8 + 0x186d9cc));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x29ce,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x29ce,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0186dafc + 0x186da24) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0186db00 + 0x186da40));
  uVar10 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar9 = **(int **)(_UNK_0186db04 + 0x186da6c);
