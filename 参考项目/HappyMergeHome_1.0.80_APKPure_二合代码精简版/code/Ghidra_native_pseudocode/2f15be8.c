...
int FUN_02f25be8(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_02f25cb4 + 0x2f25bfc);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f25cb8 + 0x2f25c10));
    func_0x01438628(*(undefined4 *)(_UNK_02f25cbc + 0x2f25c1c));
    *pcVar9 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x6d39,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x6d39,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f25cc0 + 0x2f25c74) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_02f25cc4 + 0x2f25c90));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
