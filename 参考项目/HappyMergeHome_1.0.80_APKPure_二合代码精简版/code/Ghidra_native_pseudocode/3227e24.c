...
void FUN_03237e24(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_03237edc + 0x3237e38);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03237ee0 + 0x3237e4c));
    *pcVar8 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x7f8d,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x7f8d,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x032499cc(param_1);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_03237ee4 + 0x3237eb4) + 0x74) == 0) {
    func_0x014387a4();
  }
