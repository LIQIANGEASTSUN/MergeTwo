...
uint FUN_03211f28(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_03211fc8 + 0x3211f3c);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03211fcc + 0x3211f50));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7e91,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7e91,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03211fd0 + 0x3211fa8) + 0x74) == 0) {
    func_0x014387a4();
  }
