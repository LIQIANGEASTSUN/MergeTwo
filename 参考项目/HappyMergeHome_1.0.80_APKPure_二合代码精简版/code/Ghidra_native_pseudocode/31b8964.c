...
undefined4 FUN_031c8964(int param_1)

{
  ...
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031c0e04 + 0x31c0674),iVar10,0);
  ...
  if (iVar1 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      *piVar14 = iVar3;
      ...
      iVar9 = FUN_031b8d0c(iVar9);
      uVar2 = *(undefined4 *)(iVar10 + 8);
      if (iVar9 == 0) {
        func_0x014388e4();
      }
      func_0x046ce3e4(iVar9,uVar2,aiStack_28,**(undefined4 **)(_UNK_031c0e80 + 0x31c0930));
      iVar9 = aiStack_28[0];
      if (aiStack_28[0] == 0) {
        func_0x014388e4();
      }
      ...
      iVar9 = func_0x014388d4(**(undefined4 **)(_UNK_031c0e90 + 0x31c0ab4));
      func_0x03bbd054(iVar9,**(undefined4 **)(_UNK_031c0e94 + 0x31c0ac8));
      ...
      *piVar7 = iVar9;
      ...
      if (0 < *(int *)(iVar9 + 0xc)) {
        ...
        iVar9 = FUN_031b59e4();
        if (iVar9 != 0) {
          func_0x031c9c9c(iVar9,0);
        }
        if (*(int *)(**(int **)(_UNK_031c0e9c + 0x31c0b3c) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar9 = func_0x04e4a028(**(undefined4 **)(_UNK_031c0ea0 + 0x31c0b5c));
        if (iVar9 == 0) {
          func_0x014388e4();
        }
        ...
        while( true ) {
          ...
          func_0x020257a4(iVar3,0x29a,uVar2,uVar4,0,0,0);
          iVar9 = iVar9 + 1;
        }
        if (*(int *)(**(int **)(_UNK_031c0eac + 0x31c0cf8) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar9 = func_0x03b2c734(**(undefined4 **)(_UNK_031c0eb0 + 0x31c0d14));
        iVar10 = *piVar14;
        if (*(int *)(**(int **)(_UNK_031c0eb4 + 0x31c0d28) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_031c0eb8 + 0x31c0d48));
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        ...
        func_0x02b75870(iVar9,iVar10,uVar4,1,0xb6,0,0,0,0,0,0,0,uVar2,0,0);
        iVar9 = *piVar7;
        if (iVar9 == 0) {
          func_0x014388e4();
        }
