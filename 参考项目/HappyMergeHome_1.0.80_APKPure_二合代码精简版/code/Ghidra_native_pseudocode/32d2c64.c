...
void FUN_032e2c64(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar7 = (char *)(_UNK_032e2e20 + 0x32e2c7c);
  if (*pcVar7 == '\0') {
  ...
  iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_032e2e34 + 0x32e2d4c));
  ...
  if (iVar5 == 0) {
    ...
    iVar2 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_032e2e38 + 0x32e2dd0));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_032e2e00:
    ...
    iVar2 = func_0x03b70fac(iVar5,param_2,**(undefined4 **)(_UNK_032e2e3c + 0x32e2da4));
  }
  unaff_r7 = iVar2 + 1;
