...
void FUN_02be7534(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_02be75f8 + 0x2be754c);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be75fc + 0x2be7560));
    *pcVar10 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x5d2a,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x5d2a,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
    pcVar10 = (char *)(_UNK_028faff0 + 0x28faefc);
    if (*pcVar10 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_028faff4 + 0x28faf10),param_1,param_2,0);
      *pcVar10 = '\x01';
    }
    ...
    func_0x035daef8(&uStack_38,0,**(undefined4 **)(_UNK_028faff8 + 0x28fafe0));
    return;
  }
  uVar14 = FUN_02be73f4(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_02be7600 + 0x2be75d0) + 0x74) == 0) {
    func_0x014387a4();
  }
