...
uint FUN_017163e0(int param_1,int param_2)

{
  ...
  pcVar10 = (char *)(_UNK_017164a8 + 0x17163f8);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017164ac + 0x171640c));
    *pcVar10 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x164e,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_017164b0 + 0x1716468) + 0x74) == 0) {
      func_0x014387a4();
    }
    ...
    iVar3 = func_0x029540a4(0x164e,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
