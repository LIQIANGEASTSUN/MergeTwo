...
void FUN_01873114(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  pcVar4 = (char *)(_UNK_0187321c + 0x1873134);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01873220 + 0x1873154));
    *pcVar4 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x93b2,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x93b2,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iStack_34 = param_5;
  ...
  if (*(int *)(**(int **)(_UNK_01873224 + 0x18731e0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_0186d4b8();
  if (iVar2 == 0) {
  ...
  iStack_2c = uStack_3c;
  iStack_28 = iStack_44;
  iVar1 = func_0x02953fd4(0x9384,0);
  if (iVar1 == 0) {
    ...
    *puVar3 = uStack_58;
    ...
    iVar1 = func_0x029540a4(0x9384,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
