...
uint FUN_01b5eed4(undefined4 param_1,undefined4 param_2)
      ...
      if (uVar12 != uVar2) {
        ...
        if (iVar1 == 0) {
          ...
          if (iVar1 != 0) {
            ...
            iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_01b5eebc + 0x1b5edb4));
            if (iVar1 != 0) {
              iVar1 = FUN_01b5bb4c(param_1);
              if (iVar1 == 0) {
                func_0x014388e4();
                iVar9 = func_0x024f05d4(0,param_2,**(undefined4 **)(_UNK_01b5eec4 + 0x1b5ee10));
                func_0x014388e4();
              }
              else {
                iVar9 = func_0x024f05d4(iVar1,param_2,**(undefined4 **)(_UNK_01b5eec0 + 0x1b5ede8));
              }
              func_0x024f10d4(iVar1,param_2,iVar9 + -1,**(undefined4 **)(_UNK_01b5eec8 + 0x1b5ee34))
              ;
              iVar1 = FUN_01b5bb4c(param_1);
              if (iVar1 == 0) {
                func_0x014388e4();
              }
              uVar2 = func_0x024f05d4(iVar1,param_2,**(undefined4 **)(_UNK_01b5eecc + 0x1b5ee64));
              if (0 < (int)uVar2) {
                return uVar2;
              }
              iVar1 = FUN_01b5bb4c(param_1);
              ...
              iVar9 = **(int **)(_UNK_01b5eed0 + 0x1b5ee9c);
...
LAB_046c3e4c:
                      ...
                      if (iVar3 != 0) {
                        if ((int)uVar12 < 0) {
                          ...
                          *(undefined4 *)(iVar1 + uVar12 * 0x10 + 0x14) = uVar11;
                        }
