...
undefined4 FUN_02c29cac(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c29e6c + 0x2c29cc0);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c29e70 + 0x2c29cd4));
    func_0x01438628(*(undefined4 *)(_UNK_02c29e74 + 0x2c29ce0));
    func_0x01438628(*(undefined4 *)(_UNK_02c29e78 + 0x2c29cec));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d79,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d79,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c29e7c + 0x2c29e14));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c29e80 + 0x2c29e30),0);
  if (*(int *)(**(int **)(_UNK_02c29e84 + 0x2c29e44) + 0x74) == 0) {
    func_0x014387a4();
  }
