...
undefined4 FUN_030e40e8(int param_1)

{
  ...
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030dafc0 + 0x30da830),iVar10,0);
  ...
  if (iVar1 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      *piVar14 = iVar3;
      ...
      iVar9 = FUN_030d3e28(iVar9);
      uVar2 = *(undefined4 *)(iVar10 + 8);
      if (iVar9 == 0) {
        func_0x014388e4();
      }
      func_0x046ce3e4(iVar9,uVar2,aiStack_28,**(undefined4 **)(_UNK_030db03c + 0x30daaec));
      iVar9 = aiStack_28[0];
      if (aiStack_28[0] == 0) {
        func_0x014388e4();
      }
      ...
      iVar9 = func_0x014388d4(**(undefined4 **)(_UNK_030db04c + 0x30dac70));
      func_0x03bbd054(iVar9,**(undefined4 **)(_UNK_030db050 + 0x30dac84));
      ...
      *piVar7 = iVar9;
      ...
      if (0 < *(int *)(iVar9 + 0xc)) {
        ...
        iVar9 = FUN_030d18ac();
        if (iVar9 != 0) {
          func_0x030e547c(iVar9,0);
        }
        if (*(int *)(**(int **)(_UNK_030db058 + 0x30dacf8) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar9 = func_0x04e4a028(**(undefined4 **)(_UNK_030db05c + 0x30dad18));
        if (iVar9 == 0) {
          func_0x014388e4();
        }
        ...
        iVar9 = func_0x03b2c734(**(undefined4 **)(_UNK_030db06c + 0x30daed0));
        iVar10 = *piVar14;
        if (*(int *)(**(int **)(_UNK_030db070 + 0x30daee4) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_030db074 + 0x30daf04));
        if (iVar3 == 0) {
          func_0x014388e4();
        }
