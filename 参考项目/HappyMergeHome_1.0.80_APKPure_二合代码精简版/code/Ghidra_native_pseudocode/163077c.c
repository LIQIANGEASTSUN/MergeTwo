...
uint FUN_0164077c(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_01640864 + 0x164079c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01640868 + 0x16407b0));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8602,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8602,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0164086c + 0x164082c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_0163b7ec();
  if (iVar1 == 0) {
  ...
  pcVar11 = (char *)(_UNK_01640990 + 0x1640888);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01640994 + 0x164089c));
    func_0x01438628(*(undefined4 *)(_UNK_01640998 + 0x16408a8));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x8603,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_0164099c + 0x1640904) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_016409a0 + 0x1640920));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_0164a328 + 0x164a0f4);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_0164a32c + 0x164a108));
      func_0x01438628(*(undefined4 *)(_UNK_0164a330 + 0x164a114));
      func_0x01438628(*(undefined4 *)(_UNK_0164a334 + 0x164a120));
      func_0x01438628(*(undefined4 *)(_UNK_0164a338 + 0x164a12c));
      func_0x01438628(*(undefined4 *)(_UNK_0164a33c + 0x164a138));
      func_0x01438628(*(undefined4 *)(_UNK_0164a340 + 0x164a144));
      func_0x01438628(*(undefined4 *)(_UNK_0164a344 + 0x164a150));
      *pcVar11 = '\x01';
    }
    iVar3 = func_0x02953fd4(0x85e3,0);
    if (iVar3 == 0) {
      iVar3 = func_0x01644324(iVar1);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x024f0540(iVar3,param_3,**(undefined4 **)(_UNK_0164a348 + 0x164a1cc));
      if (iVar3 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x024eee28(**(undefined4 **)(_UNK_0164a34c + 0x164a230),uVar10,
                                 **(undefined4 **)(_UNK_0164a350 + 0x164a23c),0);
        if (*(int *)(**(int **)(_UNK_0164a354 + 0x164a250) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar3 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_3,**(undefined4 **)(_UNK_0164a35c + 0x164a284));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar3,param_3,**(undefined4 **)(_UNK_0164a358 + 0x164a200));
        }
        func_0x024f10d4(iVar3,param_3,iVar9 + -1,**(undefined4 **)(_UNK_0164a360 + 0x164a2a8));
        iVar3 = func_0x01644324(iVar1);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x024f05d4(iVar3,param_3,**(undefined4 **)(_UNK_0164a364 + 0x164a2d8));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x01644324(iVar1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar3 = **(int **)(_UNK_0164a368 + 0x164a318);
...
LAB_046c3e4c:
    ...
    iVar3 = func_0x029540a4(0x85e3,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar3 = func_0x029540a4(0x8603,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
