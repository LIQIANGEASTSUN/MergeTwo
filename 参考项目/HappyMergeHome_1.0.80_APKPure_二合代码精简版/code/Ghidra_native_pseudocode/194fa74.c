...
uint FUN_0195fa74(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_0195fb5c + 0x195fa94);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0195fb60 + 0x195faa8));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x9914,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x9914,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0195fb64 + 0x195fb24) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_01959198();
  if (iVar2 == 0) {
  ...
  pcVar11 = (char *)(_UNK_0195e33c + 0x195e234);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0195e340 + 0x195e248));
    func_0x01438628(*(undefined4 *)(_UNK_0195e344 + 0x195e254));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9908,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_0195e348 + 0x195e2b0) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0195e34c + 0x195e2cc));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_01967cd4 + 0x1967aa0);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_01967cd8 + 0x1967ab4));
      func_0x01438628(*(undefined4 *)(_UNK_01967cdc + 0x1967ac0));
      func_0x01438628(*(undefined4 *)(_UNK_01967ce0 + 0x1967acc));
      func_0x01438628(*(undefined4 *)(_UNK_01967ce4 + 0x1967ad8));
      func_0x01438628(*(undefined4 *)(_UNK_01967ce8 + 0x1967ae4));
      func_0x01438628(*(undefined4 *)(_UNK_01967cec + 0x1967af0));
      func_0x01438628(*(undefined4 *)(_UNK_01967cf0 + 0x1967afc));
      *pcVar11 = '\x01';
    }
    iVar1 = func_0x02953fd4(0x98e8,0);
    if (iVar1 == 0) {
      iVar1 = func_0x01961cd0(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x024f0540(iVar1,param_3,**(undefined4 **)(_UNK_01967cf4 + 0x1967b78));
      if (iVar1 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x024eee28(**(undefined4 **)(_UNK_01967cf8 + 0x1967bdc),uVar10,
                                 **(undefined4 **)(_UNK_01967cfc + 0x1967be8),0);
        if (*(int *)(**(int **)(_UNK_01967d00 + 0x1967bfc) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_3,**(undefined4 **)(_UNK_01967d08 + 0x1967c30));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar1,param_3,**(undefined4 **)(_UNK_01967d04 + 0x1967bac));
        }
        func_0x024f10d4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_01967d0c + 0x1967c54));
        iVar1 = func_0x01961cd0(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x024f05d4(iVar1,param_3,**(undefined4 **)(_UNK_01967d10 + 0x1967c84));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x01961cd0(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_01967d14 + 0x1967cc4);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x98e8,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x9908,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
