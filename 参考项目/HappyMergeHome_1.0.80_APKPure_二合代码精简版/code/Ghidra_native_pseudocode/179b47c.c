...
undefined4 FUN_017ab47c(undefined4 param_1,int param_2)
  ...
  if (iVar1 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      *piVar14 = iVar3;
      ...
      iVar3 = FUN_017a416c(param_1);
      uVar2 = *(undefined4 *)(param_2 + 8);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      func_0x024f064c(iVar3,uVar2,&iStack_28,**(undefined4 **)(_UNK_017abcb8 + 0x17ab768));
      iVar3 = iStack_28;
      if (iStack_28 == 0) {
        func_0x014388e4();
      }
      ...
      iVar3 = func_0x014388d4(**(undefined4 **)(_UNK_017abcc8 + 0x17ab8ec));
      func_0x024f1124(iVar3,**(undefined4 **)(_UNK_017abccc + 0x17ab900));
      ...
      *piVar7 = iVar3;
      ...
      if (0 < *(int *)(iVar3 + 0xc)) {
        ...
        iVar3 = FUN_017a1d58();
        if (iVar3 != 0) {
          func_0x017b3604(iVar3,0);
        }
        if (*(int *)(**(int **)(_UNK_017abcd4 + 0x17ab974) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_017abcd8 + 0x17ab994));
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        ...
        while( true ) {
          ...
          func_0x020257a4(iVar10,0x2a1,uVar2,uVar4,0,0,0);
          iVar3 = iVar3 + 1;
        }
        if (*(int *)(**(int **)(_UNK_017abce4 + 0x17abb30) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar3 = func_0x014e96a8(**(undefined4 **)(_UNK_017abce8 + 0x17abb4c));
        iVar9 = *piVar14;
        if (*(int *)(**(int **)(_UNK_017abcec + 0x17abb60) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar10 = func_0x014e9518(**(undefined4 **)(_UNK_017abcf0 + 0x17abb80));
        if (iVar10 == 0) {
          func_0x014388e4();
        }
        ...
        func_0x02b75870(iVar3,iVar9,uVar4,1,0xbb,0,0,0,0,0,0,0,uVar2,0,0);
        iVar1 = *piVar7;
        if (iVar1 == 0) {
          func_0x014388e4();
        }
