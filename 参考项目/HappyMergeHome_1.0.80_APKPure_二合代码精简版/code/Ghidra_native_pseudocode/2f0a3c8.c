...
void FUN_02f1a3c8(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_02f1a480 + 0x2f1a3dc);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f1a484 + 0x2f1a3f0));
    *pcVar8 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x42d2,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x42d2,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x02f1a48c(param_1);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_02f1a488 + 0x2f1a458) + 0x74) == 0) {
    func_0x014387a4();
  }
