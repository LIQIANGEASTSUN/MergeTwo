...
void FUN_01901894(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
                 undefined4 param_5)

{
  ...
  pcVar2 = (char *)(_UNK_019019d0 + 0x19018b4);
  if (*pcVar2 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_019019d4 + 0x19018cc));
    *pcVar2 = '\x01';
  }
  ...
  uStack_30 = uStack_50;
  uStack_2c = uStack_4c;
  iVar1 = func_0x02953fd4(0x1d55,0);
  if (iVar1 == 0) {
    func_0x024f1060(&uStack_68,0);
    ...
    *puVar3 = uStack_68;
    ...
    uStack_3c = param_3;
    uStack_38 = param_4;
    func_0x035cc5d0(puVar3,&uStack_58,**(undefined4 **)(_UNK_019019d8 + 0x19019b8));
  }
  else {
    iVar1 = func_0x029540a4(0x1d55,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
