...
void FUN_0317e63c(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  pcVar3 = (char *)(_UNK_0317e6a0 + 0x317e650);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0317e6a4 + 0x317e664));
    *pcVar3 = '\x01';
    param_4 = extraout_r3;
  }
  piVar1 = *(int **)(_UNK_0317e6a8 + 0x317e67c);
