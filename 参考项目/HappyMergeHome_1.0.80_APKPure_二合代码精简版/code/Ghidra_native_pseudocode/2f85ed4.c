...

{
  ...
  pcVar4 = (char *)(_UNK_02f95f80 + 0x2f95ee4);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f95f84 + 0x2f95ef8));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x6f7a,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x6f7a,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f95f88 + 0x2f95f4c) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_02f8feac();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
