...
uint FUN_0195f26c(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_0195f354 + 0x195f28c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0195f358 + 0x195f2a0));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x9910,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x9910,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0195f35c + 0x195f31c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_01959198();
  if (iVar2 == 0) {
