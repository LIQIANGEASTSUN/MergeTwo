...
undefined4 FUN_02c35028(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_02c35280 + 0x2c35040);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c35284 + 0x2c35054));
    func_0x01438628(*(undefined4 *)(_UNK_02c35288 + 0x2c35060));
    func_0x01438628(*(undefined4 *)(_UNK_02c3528c + 0x2c3506c));
    func_0x01438628(*(undefined4 *)(_UNK_02c35290 + 0x2c35078));
    func_0x01438628(*(undefined4 *)(_UNK_02c35294 + 0x2c35084));
    func_0x01438628(*(undefined4 *)(_UNK_02c35298 + 0x2c35090));
    func_0x01438628(*(undefined4 *)(_UNK_02c3529c + 0x2c3509c));
    func_0x01438628(*(undefined4 *)(_UNK_02c352a0 + 0x2c350a8));
    *pcVar4 = '\x01';
  }
  iVar2 = func_0x024eecb8(param_1,0);
  pcVar4 = (char *)(_UNK_02c352a4 + 0x2c350cc);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c352a8 + 0x2c350e0));
    *pcVar4 = '\x01';
  }
  iVar3 = *(int *)(**(int **)(_UNK_02c352ac + 0x2c350f8) + 0x5c);
  ...
  if (*(int *)(**(int **)(_UNK_02c352b0 + 0x2c35134) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x03b2c734(**(undefined4 **)(_UNK_02c352b4 + 0x2c35150));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  iVar2 = func_0x029b3f20(iVar2,**(undefined4 **)(_UNK_02c352b8 + 0x2c35174),0);
  if (iVar2 < 1) {
    iVar2 = 0x27db;
  }
  if (*(int *)(**(int **)(_UNK_02c352bc + 0x2c35194) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_02c352c0 + 0x2c351b0));
  ...
  FUN_02c230dc(param_1,**(undefined4 **)(_UNK_02c352c4 + 0x2c35210),0);
  FUN_02c30f54(param_1);
  FUN_02c2d7ec(param_1);
  if (*(int *)(**(int **)(_UNK_02c352c8 + 0x2c35234) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_02c352cc + 0x2c35250));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
