...
uint FUN_03043ae0(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_03043bc8 + 0x3043b00);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03043bcc + 0x3043b14));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7409,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7409,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_03043bd0 + 0x3043b90) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_0303cc6c();
  if (iVar2 == 0) {
