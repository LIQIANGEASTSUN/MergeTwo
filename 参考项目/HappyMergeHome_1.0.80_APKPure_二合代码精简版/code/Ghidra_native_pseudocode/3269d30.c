...

{
  ...
  pcVar7 = (char *)(_UNK_03279e90 + 0x3279d44);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03279e94 + 0x3279d58));
    func_0x01438628(*(undefined4 *)(_UNK_03279e98 + 0x3279d64));
    func_0x01438628(*(undefined4 *)(_UNK_03279e9c + 0x3279d70));
    *pcVar7 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x2a78,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x2a78,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03279ea0 + 0x3279dc8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_03279ea4 + 0x3279de4));
  uVar9 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar10 = **(int **)(_UNK_03279ea8 + 0x3279e10);
