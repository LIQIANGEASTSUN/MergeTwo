...

{
  ...
  pcVar3 = (char *)(_UNK_016426f8 + 0x164265c);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016426fc + 0x1642670));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8615,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8615,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01642700 + 0x16426c4) + 0x74) == 0) {
    func_0x014387a4();
  }
