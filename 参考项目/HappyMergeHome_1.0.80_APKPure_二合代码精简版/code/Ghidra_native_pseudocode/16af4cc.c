...
int FUN_016bf4cc(undefined4 param_1,int param_2)

{
  ...
  pcVar6 = (char *)(_UNK_016bf614 + 0x16bf4e4);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016bf618 + 0x16bf4f8));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x88f7,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x88f7,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(iVar1 + 0xc) == 8) {
    if (*(int *)(**(int **)(_UNK_016bf61c + 0x16bf584) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = FUN_016b4854();
    if (iVar1 != 0) {
      func_0x016ddf74(iVar1,0);
    }
  }
  iVar1 = FUN_016b6be8(param_1);
  if (iVar1 == 0) {
  ...
  iVar1 = FUN_016be938(param_1);
  if (iVar5 < iVar1) {
    iVar1 = FUN_016b6be8(param_1);
    uVar7 = FUN_016be938(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    func_0x026cf66c(iVar1,uVar7,0);
    pcVar6 = (char *)(_UNK_016bf484 + 0x16bf1a0);
    uStack_18 = unaff_r4;
    if (*pcVar6 == '\0') {
    ...
    if (0 < *(int *)(iVar1 + 0x74)) {
      ...
      if (iVar5 <= *(int *)(iVar1 + 0xc)) {
        ...
        uVar7 = func_0x024f0530(iVar5,iVar1 + -1,**(undefined4 **)(_UNK_016bf4ac + 0x16bf32c));
      }
    }
    ...
    uVar4 = *(undefined4 *)(*(int *)(iVar5 + 0x5c) + 0x884);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    if (iVar1 == 0) {
      ...
      if (iVar5 != 0) {
        ...
        pcVar6 = (char *)(_UNK_016e1f7c + 0x16e1c20);
        if (*pcVar6 == '\0') {
          ...
          *(undefined1 *)(iVar5 + 0xb0) = 1;
          ...
          if (iVar1 == 0) {
            ...
            if (iVar1 == 0) {
              ...
              uStack_28 = 1;
              uStack_24 = 0;
              iVar5 = func_0x02aee9b4(uVar4,**(undefined4 **)(_UNK_016e1ff0 + 0x16e1f44),
