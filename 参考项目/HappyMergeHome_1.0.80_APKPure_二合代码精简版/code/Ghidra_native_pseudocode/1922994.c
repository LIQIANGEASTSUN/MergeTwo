...
void FUN_01932994(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar6 = (char *)(_UNK_01932c10 + 0x19329bc);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01932c14 + 0x19329d0));
    func_0x01438628(*(undefined4 *)(_UNK_01932c18 + 0x19329dc));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x16b3,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_01932c1c + 0x1932a40) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_01932c20 + 0x1932a60));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    uVar9 = (uint)lVar15;
    iVar3 = FUN_01926264(param_1,param_4 - (uVar8 + !bVar10));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x029540a4(0x16b3,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
