...
void FUN_03043f64(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  pcVar3 = (char *)(_UNK_03043fc8 + 0x3043f78);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03043fcc + 0x3043f8c));
    *pcVar3 = '\x01';
    param_4 = extraout_r3;
  }
  piVar1 = *(int **)(_UNK_03043fd0 + 0x3043fa4);
