...
int FUN_032dd0c8(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_032dd3c0 + 0x32dd0dc);
  if (*pcVar6 == '\0') {
  ...
  if (0 < *(int *)(iVar1 + 0x74)) {
    ...
    if (iVar5 <= *(int *)(iVar1 + 0xc)) {
      ...
      uVar7 = func_0x04cd26d0(iVar5,iVar1 + -1,**(undefined4 **)(_UNK_032dd3e8 + 0x32dd268));
    }
  }
  ...
  if (iVar1 == 0) {
    ...
    if (iVar5 != 0) {
      ...
      pcVar6 = (char *)(_UNK_03301bbc + 0x3301860);
      if (*pcVar6 == '\0') {
        func_0x01438628(*(undefined4 *)(_UNK_03301bc0 + 0x3301874),uVar7,iVar1,0);
      ...
      if (iVar2 == 0) {
        ...
        *(undefined1 *)(iVar5 + 0xb0) = 1;
        ...
        iVar1 = func_0x046ccb14(iVar1,uVar7,**(undefined4 **)(_UNK_03301bfc + 0x33019dc));
        if (iVar1 == 0) {
          uStack_1c = uVar7;
          uVar7 = func_0x014387ac(**(undefined4 **)(_UNK_03301c00 + 0x3301a84),&uStack_1c);
          ...
          uVar4 = func_0x046cc810(iVar1,uVar7,**(undefined4 **)(_UNK_03301c0c + 0x3301a0c));
          ...
          if (iVar1 == 0) {
            ...
            uVar7 = func_0x014388d4(**(undefined4 **)(_UNK_03301c20 + 0x3301b20));
            func_0x05096384(uVar7,iVar2,**(undefined4 **)(_UNK_03301c24 + 0x3301b44),0);
            ...
            iVar5 = func_0x02aee9b4(uVar4,**(undefined4 **)(_UNK_03301c30 + 0x3301b84),
                                    **(undefined4 **)(_UNK_03301c2c + 0x3301b78),uVar7);
            if (iVar1 == 0) {
              func_0x014388e4();
            }
          ...
          uStack_20 = uVar7;
          uVar7 = func_0x014387ac(**(undefined4 **)(_UNK_03301c14 + 0x3301a5c),&uStack_20);
