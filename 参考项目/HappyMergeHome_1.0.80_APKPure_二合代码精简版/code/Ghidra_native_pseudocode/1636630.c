...

{
  ...
  pcVar6 = (char *)(_UNK_0164681c + 0x1646648);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01646820 + 0x164665c));
    func_0x01438628(*(undefined4 *)(_UNK_01646824 + 0x1646668));
    func_0x01438628(*(undefined4 *)(_UNK_01646828 + 0x1646674));
    func_0x01438628(*(undefined4 *)(_UNK_0164682c + 0x1646680));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8622,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8622,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01646830 + 0x1646758) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_01646834 + 0x1646774));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  iVar2 = *(int *)(iVar2 + 0x14);
  if ((iVar2 != 0) && (0 < *(int *)(iVar2 + 0xc))) {
    iVar7 = FUN_01642704(param_1);
    if (iVar7 == 0) {
      func_0x014388e4();
    }
    iVar7 = *(int *)(iVar7 + 0x6c);
    iVar2 = func_0x0152983c(iVar2,0,**(undefined4 **)(_UNK_01646838 + 0x16467c8));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
