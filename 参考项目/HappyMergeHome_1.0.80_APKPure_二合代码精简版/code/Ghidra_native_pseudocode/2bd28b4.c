...
void FUN_02be28b4(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar3 = func_0x02953fd4(0x5d13,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x5d13,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar5 = *(int *)(iVar3 + 0x28) + 1;
  pcVar6 = (char *)(_UNK_026f623c + 0x26f61b4);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_026f6240 + 0x26f61c8),iVar5,0);
  ...
  *(int *)(iVar3 + 0x28) = iVar5;
  ...
  iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_026f624c + 0x26f6214));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
