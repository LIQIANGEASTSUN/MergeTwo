...

{
  ...
  pcVar6 = (char *)(_UNK_018c8af0 + 0x18c8a5c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018c8af4 + 0x18c8a70));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x9539,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x9539,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar7 = **(int **)(_UNK_018c8af8 + 0x18c8ae4);
