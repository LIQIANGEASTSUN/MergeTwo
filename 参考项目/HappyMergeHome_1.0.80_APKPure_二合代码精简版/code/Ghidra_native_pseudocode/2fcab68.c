...
int FUN_02fdab68(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_02fdac88 + 0x2fdab7c);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fdac8c + 0x2fdab90));
    func_0x01438628(*(undefined4 *)(_UNK_02fdac90 + 0x2fdab9c));
    func_0x01438628(*(undefined4 *)(_UNK_02fdac94 + 0x2fdaba8));
    func_0x01438628(*(undefined4 *)(_UNK_02fdac98 + 0x2fdabb4));
    *pcVar9 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x2132,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x2132,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02fdac9c + 0x2fdac0c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02fdaca0 + 0x2fdac28));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  ...
  iVar3 = func_0x04cfd760(iVar3,*(int *)(iVar3 + 0xc) + -1,
                          **(undefined4 **)(_UNK_02fdaca4 + 0x2fdac58));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = *(int *)(iVar3 + 0x24);
  pcVar9 = (char *)(_UNK_02fd9950 + 0x2fd9554);
  iStack_24 = unaff_r4;
  if (*pcVar9 == '\0') {
  ...
  iVar6 = func_0x02953fd4(0x2133,0);
  if (iVar6 == 0) {
    iVar6 = FUN_02fcfc38(param_1);
    if (iVar6 == 0) {
      func_0x014388e4();
    }
    ...
    puVar11 = *(undefined4 **)(_UNK_02fd997c + 0x2fd9674);
    iVar6 = func_0x04cd2d7c(iVar6,iVar3,*puVar11);
    if (iVar6 == 0) {
      if (*(int *)(**(int **)(_UNK_02fd9980 + 0x2fd9694) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar6 = func_0x04e4a028(**(undefined4 **)(_UNK_02fd9984 + 0x2fd96b0));
      if (iVar6 == 0) {
        func_0x014388e4();
      }
      iVar6 = *(int *)(iVar6 + 0x38);
      iVar7 = 0;
      puVar12 = *(undefined4 **)(_UNK_02fd9988 + 0x2fd96d8);
      while( true ) {
        if (iVar6 == 0) {
          func_0x014388e4();
        }
        ...
        if (*(int *)(iVar2 + 0x24) == iVar3) {
          ...
          while( true ) {
            ...
            if (*(int *)(iVar2 + 0x24) <= iVar3) {
              ...
              if (iVar2 == 0) {
                ...
                func_0x03b75ba0(iVar2,uVar10,**(undefined4 **)(_UNK_02fd998c + 0x2fd9850));
              }
            }
            iVar7 = iVar7 + 1;
          }
          ...
          iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02fd9994 + 0x2fd9890));
          ...
          iVar2 = **(int **)(_UNK_02fd999c + 0x2fd98c4);
  ...
  iVar6 = func_0x029540a4(0x2133,0);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
  puStack_20 = (undefined4 *)iStack_24;
