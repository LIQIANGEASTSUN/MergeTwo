...

{
  ...
  pcVar3 = (char *)(_UNK_018013cc + 0x1801330);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018013d0 + 0x1801344));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x90c0,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x90c0,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_018013d4 + 0x1801398) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_017faff8();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
