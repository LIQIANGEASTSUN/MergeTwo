...
void FUN_0301a010(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar7 = (char *)(_UNK_0301a1cc + 0x301a028);
  if (*pcVar7 == '\0') {
  ...
  iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_0301a1e0 + 0x301a0f8));
  ...
  if (iVar5 == 0) {
    ...
    iVar2 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_0301a1e4 + 0x301a17c));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_0301a1ac:
    ...
    iVar2 = func_0x03b70fac(iVar5,param_2,**(undefined4 **)(_UNK_0301a1e8 + 0x301a150));
  }
  unaff_r7 = iVar2 + 1;
