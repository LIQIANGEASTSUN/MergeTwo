...
undefined4 FUN_0196dd88(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar5 = (char *)(_UNK_0196dec4 + 0x196dda0);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0196dec8 + 0x196ddb4));
    func_0x01438628(*(undefined4 *)(_UNK_0196decc + 0x196ddc0));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x994b,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x994b,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_0196ded0 + 0x196de58));
  if (iVar1 != 0) {
    iVar1 = FUN_019600b0(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_0196ded4 + 0x196deb0);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
