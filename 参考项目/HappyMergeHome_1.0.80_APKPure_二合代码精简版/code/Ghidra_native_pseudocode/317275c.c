...

{
  ...
  pcVar7 = (char *)(_UNK_03182948 + 0x3182774);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0318294c + 0x3182788));
    func_0x01438628(*(undefined4 *)(_UNK_03182950 + 0x3182794));
    func_0x01438628(*(undefined4 *)(_UNK_03182954 + 0x31827a0));
    func_0x01438628(*(undefined4 *)(_UNK_03182958 + 0x31827ac));
    *pcVar7 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x7b9f,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x7b9f,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uStack_28 = 0;
  func_0x026f1a28((int)uVar10,uVar8,uVar5,uVar9);
  uVar10 = FUN_0317e7f4(param_1);
  uVar8 = (undefined4)((ulonglong)uVar10 >> 0x20);
  ...
  uStack_28 = 0;
  func_0x026f1af8((int)uVar10,uVar8,uVar5,uVar9);
  if (*(int *)(**(int **)(_UNK_0318295c + 0x3182884) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x04e4a028(**(undefined4 **)(_UNK_03182960 + 0x31828a0));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  ...
  if ((iVar4 != 0) && (0 < *(int *)(iVar4 + 0xc))) {
    ...
    iVar4 = func_0x04cfd760(iVar4,0,**(undefined4 **)(_UNK_03182964 + 0x31828f4));
    if (iVar4 == 0) {
      func_0x014388e4();
    }
