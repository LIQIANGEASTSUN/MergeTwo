...
int FUN_0164a450(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_0164a584 + 0x164a464);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0164a588 + 0x164a478));
    func_0x01438628(*(undefined4 *)(_UNK_0164a58c + 0x164a484));
    *pcVar4 = '\x01';
  }
  iVar7 = 0;
  iVar1 = func_0x02953fd4(0x85ee,0);
  if (iVar1 != 0) {
    iVar7 = func_0x029540a4(0x85ee,0);
    if (iVar7 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = 1;
  puVar8 = *(undefined4 **)(_UNK_0164a590 + 0x164a4e4);
  while( true ) {
