...

{
  ...
  pcVar7 = (char *)(_UNK_032d8854 + 0x32d8680);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032d8858 + 0x32d8694));
    func_0x01438628(*(undefined4 *)(_UNK_032d885c + 0x32d86a0));
    func_0x01438628(*(undefined4 *)(_UNK_032d8860 + 0x32d86ac));
    func_0x01438628(*(undefined4 *)(_UNK_032d8864 + 0x32d86b8));
    *pcVar7 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x83be,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x83be,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_032d8868 + 0x32d8790) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x04e4a028(**(undefined4 **)(_UNK_032d886c + 0x32d87ac));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  ...
  if ((iVar4 != 0) && (0 < *(int *)(iVar4 + 0xc))) {
    ...
    iVar4 = func_0x04cfd760(iVar4,0,**(undefined4 **)(_UNK_032d8870 + 0x32d8800));
    if (iVar4 == 0) {
      func_0x014388e4();
    }
