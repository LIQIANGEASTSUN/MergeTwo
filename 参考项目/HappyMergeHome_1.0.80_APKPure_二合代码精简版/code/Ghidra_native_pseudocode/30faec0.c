...
void FUN_0310aec0(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  pcVar4 = (char *)(_UNK_0310afac + 0x310aee0);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0310afb0 + 0x310af00));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x785a,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x785a,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    iStack_34 = param_5;
  ...
  if (*(int *)(**(int **)(_UNK_0310afb4 + 0x310af70) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_03105aec();
  if (iVar1 == 0) {
  ...
  uStack_2c = uStack_3c;
  iStack_28 = iStack_44;
  iVar2 = func_0x02953fd4(0x785b,0);
  if (iVar2 == 0) {
    ...
    *puVar3 = uStack_58;
    ...
    iVar2 = func_0x029540a4(0x785b,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
