...
void FUN_031b6524(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  pcVar4 = (char *)(_UNK_031b6610 + 0x31b6544);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031b6614 + 0x31b6564));
    *pcVar4 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7d01,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7d01,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iStack_34 = param_5;
  ...
  if (*(int *)(**(int **)(_UNK_031b6618 + 0x31b65d4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_031b08c8();
  if (iVar2 == 0) {
