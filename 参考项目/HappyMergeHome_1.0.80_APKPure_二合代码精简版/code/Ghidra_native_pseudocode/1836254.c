...
void FUN_01846254(int param_1,undefined4 param_2,int param_3)

{
  ...
  iVar3 = func_0x02953fd4(0x925f,0);
  if (iVar3 == 0) {
    iVar3 = FUN_0183a850(param_1);
    if (((iVar3 != 0) && (iVar3 = FUN_01845e10(param_1,param_2,param_3), iVar3 == 0)) &&
       (iVar3 = FUN_01845ee0(param_1,param_2), iVar3 != 0)) {
      if (param_3 == 0) {
      ...
      iVar3 = func_0x02953fd4(0x1e21,0);
      if (iVar3 != 0) {
        iVar3 = func_0x029540a4(0x1e21,0);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
...
LAB_01845c60:
            ...
            if (*(char *)(iVar2 + 0xd) == '\0') goto LAB_01845c60;
            iVar2 = FUN_0183a850(param_1);
            if (iVar2 == 0) {
              func_0x014388e4();
            }
    ...
    iVar3 = func_0x029540a4(0x925f,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
