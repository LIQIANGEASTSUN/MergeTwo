...

{
  ...
  pcVar5 = (char *)(_UNK_02c5930c + 0x2c59294);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c59310 + 0x2c592a8));
    func_0x01438628(*(undefined4 *)(_UNK_02c59314 + 0x2c592b4));
    *pcVar5 = '\x01';
  }
  if (*(int *)(**(int **)(_UNK_02c59318 + 0x2c592c8) + 0x74) == 0) {
    func_0x014387a4();
  }
  ...
  iVar3 = **(int **)(_UNK_02c5931c + 0x2c59300);
