...
uint FUN_018f93fc(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar1 = func_0x02953fd4(0x9676,0);
  if (iVar1 == 0) {
    pcVar10 = (char *)(_UNK_018ffd9c + 0x18ffa7c);
    uStack_1c = param_2;
    uStack_18 = unaff_r4;
    if (*pcVar10 == '\0') {
    ...
    iVar1 = func_0x02953fd4(0x9670,0);
    if (iVar1 == 0) {
      if (*(int *)(**(int **)(_UNK_018ffdc8 + 0x18ffb5c) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018ffdcc + 0x18ffb78));
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x029a6fa8(iVar1,param_2,0);
      if (iVar1 != 0) {
        iVar9 = func_0x018fa1d4(param_1);
        if (iVar9 == 0) {
          func_0x014388e4();
        }
        if (*(int *)(iVar9 + 0x10) != 0) {
          ...
          iVar1 = func_0x024f0f34(iVar9,uVar11,**(undefined4 **)(_UNK_018ffdd0 + 0x18ffc08));
          if (iVar1 == 0) {
            return 0;
          }
        }
      }
      iVar1 = func_0x018fa998(param_1);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_018ffdd4 + 0x18ffc40));
      if (iVar1 == 0) {
        uVar11 = func_0x01524ffc(&uStack_1c,0);
        uVar11 = func_0x024eee28(**(undefined4 **)(_UNK_018ffdd8 + 0x18ffca4),uVar11,
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_2,**(undefined4 **)(_UNK_018ffde8 + 0x18ffcf8));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar1,param_2,**(undefined4 **)(_UNK_018ffde4 + 0x18ffc74));
        }
        func_0x024f10d4(iVar1,param_2,iVar9 + -1,**(undefined4 **)(_UNK_018ffdec + 0x18ffd1c));
        iVar1 = func_0x018fa998(param_1);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x024f05d4(iVar1,param_2,**(undefined4 **)(_UNK_018ffdf0 + 0x18ffd4c));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x018fa998(param_1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar9 = **(int **)(_UNK_018ffdf4 + 0x18ffd8c);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x9670,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x9676,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
