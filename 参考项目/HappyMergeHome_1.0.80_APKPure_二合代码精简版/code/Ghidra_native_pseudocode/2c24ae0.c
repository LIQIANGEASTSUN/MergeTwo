...
undefined4 FUN_02c34ae0(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_02c34d38 + 0x2c34af8);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c34d3c + 0x2c34b0c));
    func_0x01438628(*(undefined4 *)(_UNK_02c34d40 + 0x2c34b18));
    func_0x01438628(*(undefined4 *)(_UNK_02c34d44 + 0x2c34b24));
    func_0x01438628(*(undefined4 *)(_UNK_02c34d48 + 0x2c34b30));
    func_0x01438628(*(undefined4 *)(_UNK_02c34d4c + 0x2c34b3c));
    func_0x01438628(*(undefined4 *)(_UNK_02c34d50 + 0x2c34b48));
    func_0x01438628(*(undefined4 *)(_UNK_02c34d54 + 0x2c34b54));
    func_0x01438628(*(undefined4 *)(_UNK_02c34d58 + 0x2c34b60));
    *pcVar4 = '\x01';
  }
  iVar2 = func_0x024eecb8(param_1,0);
  pcVar4 = (char *)(_UNK_02c34d5c + 0x2c34b84);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c34d60 + 0x2c34b98));
    *pcVar4 = '\x01';
  }
  iVar3 = *(int *)(**(int **)(_UNK_02c34d64 + 0x2c34bb0) + 0x5c);
  ...
  if (*(int *)(**(int **)(_UNK_02c34d68 + 0x2c34bec) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x03b2c734(**(undefined4 **)(_UNK_02c34d6c + 0x2c34c08));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  iVar2 = func_0x029b3f20(iVar2,**(undefined4 **)(_UNK_02c34d70 + 0x2c34c2c),0);
  if (iVar2 < 1) {
    iVar2 = 0x27db;
  }
  if (*(int *)(**(int **)(_UNK_02c34d74 + 0x2c34c4c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_02c34d78 + 0x2c34c68));
  ...
  FUN_02c230dc(param_1,**(undefined4 **)(_UNK_02c34d7c + 0x2c34cc8),0);
  FUN_02c31108(param_1);
  FUN_02c2d7ec(param_1);
  if (*(int *)(**(int **)(_UNK_02c34d80 + 0x2c34cec) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_02c34d84 + 0x2c34d08));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
