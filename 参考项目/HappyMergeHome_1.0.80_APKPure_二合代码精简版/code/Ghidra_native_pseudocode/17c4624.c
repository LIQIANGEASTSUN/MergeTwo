...
int FUN_017d4624(int param_1,int param_2)

{
  ...
  pcVar6 = (char *)(_UNK_017d48c8 + 0x17d4640);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017d48cc + 0x17d4654));
    func_0x01438628(*(undefined4 *)(_UNK_017d48d0 + 0x17d4660));
    func_0x01438628(*(undefined4 *)(_UNK_017d48d4 + 0x17d466c));
    func_0x01438628(*(undefined4 *)(_UNK_017d48d8 + 0x17d4678));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5db9,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5db9,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x014388d4(**(undefined4 **)(_UNK_017d48dc + 0x17d46d8));
  func_0x024eed9c(iVar1,**(undefined4 **)(_UNK_017d48e0 + 0x17d46ec));
  if (((*(int *)(param_1 + 0x44) != 0) && (0 < param_2)) &&
     (iVar9 = *(int *)(*(int *)(param_1 + 0x44) + 0xc), iVar9 != 0)) {
    if (param_2 < iVar9) {
      iVar9 = param_2;
    }
    if (*(int *)(**(int **)(_UNK_017d48e4 + 0x17d4728) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = FUN_017d0b50();
    if (iVar2 == 0) {
    ...
    while( true ) {
      ...
      if (*(int *)(iVar9 + uVar11 * 4 + 0x10) != 0) {
        ...
        *(uint *)(iVar9 + 0x24) = uVar11;
        ...
        piVar4 = *(int **)(_UNK_017d48e8 + 0x17d4868);
