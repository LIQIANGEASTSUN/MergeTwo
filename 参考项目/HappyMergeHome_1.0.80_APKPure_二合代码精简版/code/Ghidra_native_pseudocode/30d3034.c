...
void FUN_030e3034(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar7 = (char *)(_UNK_030e31f0 + 0x30e304c);
  if (*pcVar7 == '\0') {
  ...
  iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_030e3204 + 0x30e311c));
  ...
  if (iVar5 == 0) {
    ...
    iVar2 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_030e3208 + 0x30e31a0));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_030e31d0:
    ...
    iVar2 = func_0x03b70fac(iVar5,param_2,**(undefined4 **)(_UNK_030e320c + 0x30e3174));
  }
  unaff_r7 = iVar2 + 1;
