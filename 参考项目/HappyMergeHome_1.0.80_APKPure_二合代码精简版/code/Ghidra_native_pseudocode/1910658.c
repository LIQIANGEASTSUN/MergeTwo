...

{
  ...
  pcVar7 = (char *)(_UNK_019207b8 + 0x192066c);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_019207bc + 0x1920680));
    func_0x01438628(*(undefined4 *)(_UNK_019207c0 + 0x192068c));
    func_0x01438628(*(undefined4 *)(_UNK_019207c4 + 0x1920698));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x2ca9,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x2ca9,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_019207c8 + 0x19206f0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_019207cc + 0x192070c));
  uVar10 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar9 = **(int **)(_UNK_019207d0 + 0x1920738);
