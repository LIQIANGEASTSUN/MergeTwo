...
int FUN_032de430(undefined4 param_1,int param_2)

{
  ...
  pcVar5 = (char *)(_UNK_032de848 + 0x32de44c);
  if (*pcVar5 == '\0') {
  ...
  iVar2 = func_0x02953fd4(0x1ef5,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x1ef5,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  puVar10 = *(undefined4 **)(_UNK_032de874 + 0x32de56c);
  iVar2 = func_0x04cd2d7c(iVar2,param_2,*puVar10);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_032de878 + 0x32de58c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_032de87c + 0x32de5a8));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iVar2 = *(int *)(iVar2 + 0x38);
    iVar7 = 0;
    puVar11 = *(undefined4 **)(_UNK_032de880 + 0x32de5d0);
    do {
      if (iVar2 == 0) {
        func_0x014388e4();
      }
    ...
    while( true ) {
      ...
      if (*(int *)(iVar3 + 0x24) <= param_2) {
        ...
        if (iVar3 == 0) {
          ...
          func_0x03b75ba0(iVar3,uVar9,**(undefined4 **)(_UNK_032de884 + 0x32de748));
        }
      }
      iVar7 = iVar7 + 1;
    }
    ...
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_032de88c + 0x32de788));
    ...
    iVar6 = **(int **)(_UNK_032de894 + 0x32de7bc);
