...
uint FUN_02f957e8(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_02f958d0 + 0x2f95808);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f958d4 + 0x2f9581c));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x6f73,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x6f73,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_02f958d8 + 0x2f95898) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_02f8feac();
  if (iVar2 == 0) {
  ...
  iVar1 = func_0x02953fd4(0x6f6f,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_02f95120 + 0x2f95088) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_02f95124 + 0x2f950a4));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    iVar1 = func_0x02953fd4(0x6f57,0);
    if (iVar1 == 0) {
      iVar1 = func_0x02f97bac(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x046c26fc(iVar1,param_3,**(undefined4 **)(_UNK_02f9dac4 + 0x2f9d948));
      if (iVar1 == 0) {
        ...
        if (iVar1 == 0) {
          ...
          iVar9 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_02f9dad4 + 0x2f9d97c));
        }
        func_0x03b70fe4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_02f9dadc + 0x2f9da24));
        iVar1 = func_0x02f97bac(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_02f9dae0 + 0x2f9da54));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x02f97bac(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_02f9dae4 + 0x2f9da94);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x6f57,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x6f6f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
