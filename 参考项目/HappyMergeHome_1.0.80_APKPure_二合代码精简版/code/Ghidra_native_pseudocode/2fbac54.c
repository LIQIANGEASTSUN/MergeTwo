...
void FUN_02fcac54(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_02fcad18 + 0x2fcac6c);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fcad1c + 0x2fcac80));
    *pcVar10 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x70b0,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x70b0,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x02fdcecc(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_02fcad20 + 0x2fcacf0) + 0x74) == 0) {
    func_0x014387a4();
  }
