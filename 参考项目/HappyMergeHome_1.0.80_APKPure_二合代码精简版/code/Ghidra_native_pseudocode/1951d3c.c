...
uint FUN_01961d3c(int param_1,int param_2)

{
  ...
  pcVar10 = (char *)(_UNK_01961e04 + 0x1961d54);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01961e08 + 0x1961d68));
    *pcVar10 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x1618,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_01961e0c + 0x1961dc4) + 0x74) == 0) {
      func_0x014387a4();
    }
    ...
    iVar3 = func_0x029540a4(0x1618,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
