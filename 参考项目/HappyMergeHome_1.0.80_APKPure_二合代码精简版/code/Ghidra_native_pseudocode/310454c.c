...
uint FUN_0311454c(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_031145ec + 0x3114560);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031145f0 + 0x3114574));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x789d,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x789d,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_031145f4 + 0x31145cc) + 0x74) == 0) {
    func_0x014387a4();
  }
