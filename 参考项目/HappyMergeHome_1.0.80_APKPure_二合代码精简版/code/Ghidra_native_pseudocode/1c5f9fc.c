...
undefined4 FUN_01c6f9fc(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0xad49,0);
  if (iVar1 == 0) {
    pcVar5 = (char *)(_UNK_01c73578 + 0x1c733b4);
    if (*pcVar5 == '\0') {
    ...
    if (iVar1 == 0) {
      ...
      iVar4 = **(int **)(_UNK_01c735a8 + 0x1c7356c);
      if (iVar1 == 0) {
        func_0x024f83d4();
      }
    ...
    iVar1 = func_0x029540a4(0xad49,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  pcVar5 = (char *)(_UNK_0287e3b8 + 0x287e2d8);
  if (*pcVar5 == '\0') {
