...
undefined4 FUN_0180c9dc(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_0180cab8 + 0x180c9f0);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0180cabc + 0x180ca04));
    func_0x01438628(*(undefined4 *)(_UNK_0180cac0 + 0x180ca10));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x90e4,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_0180cac4 + 0x180ca68) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0180cac8 + 0x180ca84));
    uVar7 = func_0x0180cacc(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x029540a4(0x90e4,0);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
