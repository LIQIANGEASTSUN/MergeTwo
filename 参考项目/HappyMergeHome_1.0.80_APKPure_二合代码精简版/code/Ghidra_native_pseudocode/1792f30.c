...

{
  ...
  pcVar3 = (char *)(_UNK_017a2fdc + 0x17a2f40);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017a2fe0 + 0x17a2f54));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8e78,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8e78,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_017a2fe4 + 0x17a2fa8) + 0x74) == 0) {
    func_0x014387a4();
  }
