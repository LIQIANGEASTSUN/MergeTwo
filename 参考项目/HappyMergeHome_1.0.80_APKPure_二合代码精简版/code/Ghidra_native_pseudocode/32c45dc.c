...

{
  ...
  pcVar4 = (char *)(_UNK_032d4688 + 0x32d45ec);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032d468c + 0x32d4600));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x83b1,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x83b1,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_032d4690 + 0x32d4654) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_032d2dac();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
