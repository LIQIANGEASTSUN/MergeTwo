...
uint FUN_02f236e4(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_02f237cc + 0x2f23704);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f237d0 + 0x2f23718));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x6d2b,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x6d2b,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_02f237d4 + 0x2f23794) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_02f1f154();
  if (iVar2 == 0) {
  ...
  pcVar11 = (char *)(_UNK_02f23010 + 0x2f22f08);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f23014 + 0x2f22f1c));
    func_0x01438628(*(undefined4 *)(_UNK_02f23018 + 0x2f22f28));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x6d27,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_02f2301c + 0x2f22f84) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_02f23020 + 0x2f22fa0));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_02f2a1f0 + 0x2f29fbc);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_02f2a1f4 + 0x2f29fd0));
      func_0x01438628(*(undefined4 *)(_UNK_02f2a1f8 + 0x2f29fdc));
      func_0x01438628(*(undefined4 *)(_UNK_02f2a1fc + 0x2f29fe8));
      func_0x01438628(*(undefined4 *)(_UNK_02f2a200 + 0x2f29ff4));
      func_0x01438628(*(undefined4 *)(_UNK_02f2a204 + 0x2f2a000));
      func_0x01438628(*(undefined4 *)(_UNK_02f2a208 + 0x2f2a00c));
      func_0x01438628(*(undefined4 *)(_UNK_02f2a20c + 0x2f2a018));
      *pcVar11 = '\x01';
    }
    iVar1 = func_0x02953fd4(0x6d06,0);
    if (iVar1 == 0) {
      iVar1 = func_0x02f25a40(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x046c26fc(iVar1,param_3,**(undefined4 **)(_UNK_02f2a210 + 0x2f2a094));
      if (iVar1 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x024eee28(**(undefined4 **)(_UNK_02f2a214 + 0x2f2a0f8),uVar10,
                                 **(undefined4 **)(_UNK_02f2a218 + 0x2f2a104),0);
        if (*(int *)(**(int **)(_UNK_02f2a21c + 0x2f2a118) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_3,**(undefined4 **)(_UNK_02f2a224 + 0x2f2a14c));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_02f2a220 + 0x2f2a0c8));
        }
        func_0x03b70fe4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_02f2a228 + 0x2f2a170));
        iVar1 = func_0x02f25a40(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_02f2a22c + 0x2f2a1a0));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x02f25a40(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_02f2a230 + 0x2f2a1e0);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x6d06,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x6d27,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
