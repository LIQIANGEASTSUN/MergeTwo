...

{
  ...
  if (iVar3 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      if (*(int *)(param_1 + 0xc) == 0) goto LAB_032e6a50;
    }
  }
  else {
    iVar8 = *(int *)(iVar3 + 8);
...
LAB_032e6a50:
        ...
        uVar11 = 0x32e6a54;
        pcVar1 = (char *)(_UNK_032e6b98 + 0x32e6a6c);
        if (*pcVar1 == '\0') {
        ...
        iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_032e6bb0 + 0x32e6ad4));
        ...
        iVar10 = func_0x04e4a028(**(undefined4 **)(_UNK_032e6bb8 + 0x32e6b4c));
        if (iVar10 == 0) {
          func_0x014388e4();
        }
