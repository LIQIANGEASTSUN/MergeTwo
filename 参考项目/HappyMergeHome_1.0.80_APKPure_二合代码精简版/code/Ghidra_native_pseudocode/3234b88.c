...
int FUN_03244b88(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_03244e80 + 0x3244b9c);
  if (*pcVar6 == '\0') {
  ...
  if (0 < *(int *)(iVar1 + 0x74)) {
    ...
    if (iVar5 <= *(int *)(iVar1 + 0xc)) {
      ...
      uVar7 = func_0x04cd26d0(iVar5,iVar1 + -1,**(undefined4 **)(_UNK_03244ea8 + 0x3244d28));
    }
  }
  ...
  if (iVar1 == 0) {
    ...
    if (iVar5 != 0) {
      ...
      pcVar6 = (char *)(_UNK_03268480 + 0x3268124);
      if (*pcVar6 == '\0') {
        func_0x01438628(*(undefined4 *)(_UNK_03268484 + 0x3268138),uVar7,iVar1,0);
      ...
      if (iVar2 == 0) {
        ...
        *(undefined1 *)(iVar5 + 0xb0) = 1;
        ...
        iVar1 = func_0x046ccb14(iVar1,uVar7,**(undefined4 **)(_UNK_032684c0 + 0x32682a0));
        if (iVar1 == 0) {
          uStack_1c = uVar7;
          uVar7 = func_0x014387ac(**(undefined4 **)(_UNK_032684c4 + 0x3268348),&uStack_1c);
          ...
          uVar4 = func_0x046cc810(iVar1,uVar7,**(undefined4 **)(_UNK_032684d0 + 0x32682d0));
          ...
          if (iVar1 == 0) {
            ...
            uVar7 = func_0x014388d4(**(undefined4 **)(_UNK_032684e4 + 0x32683e4));
            func_0x05096384(uVar7,iVar2,**(undefined4 **)(_UNK_032684e8 + 0x3268408),0);
            ...
            iVar5 = func_0x02aee9b4(uVar4,**(undefined4 **)(_UNK_032684f4 + 0x3268448),
                                    **(undefined4 **)(_UNK_032684f0 + 0x326843c),uVar7);
            if (iVar1 == 0) {
              func_0x014388e4();
            }
          ...
          uStack_20 = uVar7;
          uVar7 = func_0x014387ac(**(undefined4 **)(_UNK_032684d8 + 0x3268320),&uStack_20);
