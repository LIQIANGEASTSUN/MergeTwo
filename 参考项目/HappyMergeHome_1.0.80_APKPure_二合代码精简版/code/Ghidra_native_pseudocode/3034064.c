...

{
  ...
  pcVar4 = (char *)(_UNK_03044110 + 0x3044074);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03044114 + 0x3044088));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x740f,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x740f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03044118 + 0x30440dc) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_0303cc6c();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
