...
int FUN_01daaacc(int *param_1,int param_2,int param_3)

{
  ...
  pcVar10 = (char *)(_UNK_01daaca0 + 0x1daaaec);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01daaca4 + 0x1daab00));
    func_0x01438628(*(undefined4 *)(_UNK_01daaca8 + 0x1daab0c));
    func_0x01438628(*(undefined4 *)(_UNK_01daacac + 0x1daab18));
    *pcVar10 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x3ee6,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x3ee6,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_01daacb0 + 0x1daab80) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01daacb4 + 0x1daab9c));
  uVar2 = (**(code **)(*param_1 + 0x1a0))(param_1,*(undefined4 *)(*param_1 + 0x1a4));
  piVar3 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_01daacb8 + 0x1daabcc),2);
  if (piVar3 == (int *)0x0) {
    func_0x014388e4();
  }
  if ((param_2 != 0) &&
