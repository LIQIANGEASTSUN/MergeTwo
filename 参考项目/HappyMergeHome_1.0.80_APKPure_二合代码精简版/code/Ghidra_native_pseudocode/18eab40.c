...
int FUN_018fab40(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_018fac0c + 0x18fab54);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018fac10 + 0x18fab68));
    func_0x01438628(*(undefined4 *)(_UNK_018fac14 + 0x18fab74));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x967b,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x967b,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_018fac18 + 0x18fabcc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018fac1c + 0x18fabe8));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
