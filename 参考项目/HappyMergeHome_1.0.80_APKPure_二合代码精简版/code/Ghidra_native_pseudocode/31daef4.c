...
uint FUN_031eaef4(undefined4 param_1)

{
  ...
  iVar2 = func_0x02953fd4(0x3326,0);
  if (iVar2 == 0) {
    ...
    iVar2 = func_0x02953fd4(0x3327,0);
    if (iVar2 == 0) {
      ...
      if (iVar2 != 0) {
        ...
        FUN_031e6094(iVar2);
        uVar8 = func_0x031e96b8();
        iVar2 = (int)((ulonglong)uVar8 >> 0x20);
        bVar7 = (int)uVar8 != 0;
        if (((int)-(iVar2 + (uint)bVar7) < 0 == (SBORROW4(0,iVar2) != SBORROW4(-iVar2,(uint)bVar7)))
           && (iVar2 = func_0x031e7ce8(param_1), iVar2 == 0)) {
    ...
    iVar2 = func_0x029540a4(0x3327,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar2 = func_0x029540a4(0x3326,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
