...
void FUN_02eb85f4(undefined4 param_1,int param_2)

{
  ...
  iVar3 = func_0x02953fd4(0x69f2,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x69f2,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = func_0x02ebc9c0(param_1);
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  pcVar6 = (char *)(_UNK_026c2ae4 + 0x26c2a5c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_026c2ae8 + 0x26c2a70),param_2,0);
  ...
  *(int *)(iVar3 + 0x2c) = param_2;
  ...
  iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_026c2af4 + 0x26c2abc));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
