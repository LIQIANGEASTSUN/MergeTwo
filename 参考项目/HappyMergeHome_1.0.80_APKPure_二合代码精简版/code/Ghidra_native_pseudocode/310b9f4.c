...
undefined4 FUN_0311b9f4(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_0311bb30 + 0x311ba0c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0311bb34 + 0x311ba20));
    func_0x01438628(*(undefined4 *)(_UNK_0311bb38 + 0x311ba2c));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x78bf,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x78bf,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x046c26fc(iVar1,param_2,**(undefined4 **)(_UNK_0311bb3c + 0x311bac4));
  if (iVar1 != 0) {
    iVar1 = FUN_0310c164(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_0311bb40 + 0x311bb1c);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
