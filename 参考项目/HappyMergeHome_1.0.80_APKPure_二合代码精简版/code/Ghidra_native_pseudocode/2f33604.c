...
uint FUN_02f43604(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_02f436ec + 0x2f43624);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f436f0 + 0x2f43638));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x6def,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x6def,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_02f436f4 + 0x2f436b4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_02f3dd38();
  if (iVar2 == 0) {
