...
uint FUN_019252cc(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_019253ec + 0x19252e4);
  if (*pcVar10 == '\0') {
  ...
  if (iVar1 == 0) {
    ...
    pcVar10 = (char *)(_UNK_0192dd78 + 0x192db44);
    uStack_1c = param_2;
    if (*pcVar10 == '\0') {
    ...
    if (iVar1 == 0) {
      iVar1 = func_0x01927e84(param_1);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_0192dd98 + 0x192dc1c));
      if (iVar1 == 0) {
        uVar11 = func_0x01524ffc(&uStack_1c,0);
        uVar11 = func_0x024eee28(**(undefined4 **)(_UNK_0192dd9c + 0x192dc80),uVar11,
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_2,**(undefined4 **)(_UNK_0192ddac + 0x192dcd4));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar1,param_2,**(undefined4 **)(_UNK_0192dda8 + 0x192dc50));
        }
        func_0x024f10d4(iVar1,param_2,iVar9 + -1,**(undefined4 **)(_UNK_0192ddb0 + 0x192dcf8));
        iVar1 = func_0x01927e84(param_1);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x024f05d4(iVar1,param_2,**(undefined4 **)(_UNK_0192ddb4 + 0x192dd28));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x01927e84(param_1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar9 = **(int **)(_UNK_0192ddb8 + 0x192dd68);
