...
undefined4 FUN_02fd13dc(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_02fd14c8 + 0x2fd13f0);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fd14cc + 0x2fd1404));
    func_0x01438628(*(undefined4 *)(_UNK_02fd14d0 + 0x2fd1410));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7102,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7102,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02fd14d4 + 0x2fd1468) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_02fd14d8 + 0x2fd1484));
  iVar5 = FUN_02fd044c(param_1);
  if (iVar5 == 0) {
    func_0x014388e4();
  }
