...

{
  ...
  pcVar7 = (char *)(_UNK_01833bc4 + 0x1833a78);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01833bc8 + 0x1833a8c));
    func_0x01438628(*(undefined4 *)(_UNK_01833bcc + 0x1833a98));
    func_0x01438628(*(undefined4 *)(_UNK_01833bd0 + 0x1833aa4));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x2a54,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x2a54,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01833bd4 + 0x1833afc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01833bd8 + 0x1833b18));
  uVar10 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar9 = **(int **)(_UNK_01833bdc + 0x1833b44);
