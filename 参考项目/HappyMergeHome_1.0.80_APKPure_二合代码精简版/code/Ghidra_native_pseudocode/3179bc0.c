...
void FUN_03189bc0(int param_1,undefined4 param_2,int param_3)

{
  ...
  iVar3 = func_0x02953fd4(0x7bb3,0);
  if (iVar3 == 0) {
    iVar3 = FUN_0317e7f4(param_1);
    if (((iVar3 != 0) && (iVar3 = FUN_0318977c(param_1,param_2,param_3), iVar3 == 0)) &&
       (iVar3 = FUN_0318984c(param_1,param_2), iVar3 != 0)) {
      if (param_3 == 0) {
      ...
      iVar3 = func_0x02953fd4(0x2035,0);
      if (iVar3 != 0) {
        iVar3 = func_0x029540a4(0x2035,0);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
...
LAB_03189650:
            ...
            if (*(char *)(iVar2 + 0xd) == '\0') goto LAB_03189650;
            iVar2 = FUN_0317e7f4(param_1);
            if (iVar2 == 0) {
              func_0x014388e4();
            }
    ...
    iVar3 = func_0x029540a4(0x7bb3,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
