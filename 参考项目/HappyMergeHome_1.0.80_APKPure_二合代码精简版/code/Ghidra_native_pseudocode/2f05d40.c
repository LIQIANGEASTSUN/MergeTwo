...
undefined4 FUN_02f15d40(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_02f15e5c + 0x2f15d58);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f15e60 + 0x2f15d6c));
    func_0x01438628(*(undefined4 *)(_UNK_02f15e64 + 0x2f15d78));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x6c49,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x6c49,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x046c26fc(iVar1,param_2,**(undefined4 **)(_UNK_02f15e68 + 0x2f15e00));
  if (iVar1 != 0) {
    iVar1 = FUN_02f0ab60(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_02f15e6c + 0x2f15e48);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
