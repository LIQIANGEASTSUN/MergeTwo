...
uint FUN_0330e780(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_0330e868 + 0x330e7a0);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0330e86c + 0x330e7b4));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8523,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8523,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0330e870 + 0x330e830) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_0330a560();
  if (iVar2 == 0) {
  ...
  iVar1 = func_0x02953fd4(0x851f,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_0330e0bc + 0x330e024) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_0330e0c0 + 0x330e040));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    iVar1 = func_0x02953fd4(0x84fd,0);
    if (iVar1 == 0) {
      iVar1 = func_0x033105b4(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x046c26fc(iVar1,param_3,**(undefined4 **)(_UNK_033156f0 + 0x3315574));
      if (iVar1 == 0) {
        ...
        if (iVar1 == 0) {
          ...
          iVar9 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_03315700 + 0x33155a8));
        }
        func_0x03b70fe4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_03315708 + 0x3315650));
        iVar1 = func_0x033105b4(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_0331570c + 0x3315680));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x033105b4(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_03315710 + 0x33156c0);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x84fd,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x851f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
