...

{
  ...
  pcVar6 = (char *)(_UNK_019655a0 + 0x196550c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_019655a4 + 0x1965520));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x9928,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x9928,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar7 = **(int **)(_UNK_019655a8 + 0x1965594);
