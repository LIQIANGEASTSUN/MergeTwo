...
/* WARNING: Removing unreachable block (ram,0x02c1b0a8) */
/* WARNING: Removing unreachable block (ram,0x02c1b0ac) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_02c35314(int param_1)

{
  ...
  FUN_02c1b844(param_1);
  FUN_02c1c0e4(param_1);
  FUN_02c1c20c(param_1);
