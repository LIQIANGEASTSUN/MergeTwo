...
int FUN_032a9000(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_032a90cc + 0x32a9014);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032a90d0 + 0x32a9028));
    func_0x01438628(*(undefined4 *)(_UNK_032a90d4 + 0x32a9034));
    *pcVar9 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x827c,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x827c,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_032a90d8 + 0x32a908c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_032a90dc + 0x32a90a8));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
