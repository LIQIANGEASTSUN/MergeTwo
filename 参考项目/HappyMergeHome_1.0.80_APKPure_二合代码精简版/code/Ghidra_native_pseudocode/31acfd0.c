...

{
  ...
  pcVar7 = (char *)(_UNK_031bd078 + 0x31bcfe4);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031bd07c + 0x31bcff8));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7d1e,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7d1e,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar6 = **(int **)(_UNK_031bd080 + 0x31bd06c);
