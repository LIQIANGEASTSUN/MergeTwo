...
void FUN_0196bddc(int param_1,undefined4 param_2)

{
  ...
  iVar3 = func_0x02953fd4(0x993d,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x993d,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (iVar3 != 0) {
    iVar3 = FUN_0196bb3c(param_1,param_2);
    if (iVar3 != 0) {
      return;
    }
    iVar3 = FUN_0196b994(param_1,param_2);
    if (iVar3 != 0) {
