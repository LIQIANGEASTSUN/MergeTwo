...
undefined4 FUN_017a478c(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_017a4878 + 0x17a47a0);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017a487c + 0x17a47b4));
    func_0x01438628(*(undefined4 *)(_UNK_017a4880 + 0x17a47c0));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8e7b,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8e7b,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_017a4884 + 0x17a4818) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_017a4888 + 0x17a4834));
  iVar6 = FUN_017a37fc(param_1);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
