...
int FUN_0327a448(int *param_1,int param_2,int param_3)

{
  ...
  pcVar10 = (char *)(_UNK_0327a61c + 0x327a468);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0327a620 + 0x327a47c));
    func_0x01438628(*(undefined4 *)(_UNK_0327a624 + 0x327a488));
    func_0x01438628(*(undefined4 *)(_UNK_0327a628 + 0x327a494));
    *pcVar10 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x8140,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x8140,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0327a62c + 0x327a4fc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_0327a630 + 0x327a518));
  uVar6 = (**(code **)(*param_1 + 0x1a0))(param_1,*(undefined4 *)(*param_1 + 0x1a4));
  piVar7 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_0327a634 + 0x327a548),2);
  if (piVar7 == (int *)0x0) {
    func_0x014388e4();
  }
  if ((param_2 != 0) &&
