...
void FUN_0167c598(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  pcVar3 = (char *)(_UNK_0167c5fc + 0x167c5ac);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0167c600 + 0x167c5c0));
    *pcVar3 = '\x01';
    param_4 = extraout_r3;
  }
  piVar1 = *(int **)(_UNK_0167c604 + 0x167c5d8);
