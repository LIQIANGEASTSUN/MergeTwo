...
void FUN_02f16258(undefined4 param_1,int param_2)

{
  ...
  iVar3 = func_0x02953fd4(0x6c4e,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x6c4e,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(iVar3 + 0x58) == param_2) {
    return;
  }
  piVar1 = *(int **)(_UNK_026b37a0 + 0x26b374c);
  *(int *)(iVar3 + 0x58) = param_2;
  if (*(int *)(*piVar1 + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_026b37a4 + 0x26b376c));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
