...

{
  ...
  pcVar5 = (char *)(_UNK_0331a810 + 0x331a768);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0331a814 + 0x331a77c));
    func_0x01438628(*(undefined4 *)(_UNK_0331a818 + 0x331a788));
    *pcVar5 = '\x01';
  }
  if (*(int *)(**(int **)(_UNK_0331a81c + 0x331a79c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0331a820 + 0x331a7b8));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  func_0x02bb3638(iVar2,0x17,0);
