...
undefined4 FUN_02f5292c(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_02f52a68 + 0x2f52944);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f52a6c + 0x2f52958));
    func_0x01438628(*(undefined4 *)(_UNK_02f52a70 + 0x2f52964));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x6e2e,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x6e2e,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x046c26fc(iVar1,param_2,**(undefined4 **)(_UNK_02f52a74 + 0x2f529fc));
  if (iVar1 != 0) {
    iVar1 = FUN_02f44c50(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_02f52a78 + 0x2f52a54);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
