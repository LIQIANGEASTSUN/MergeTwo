...
uint FUN_02be8474(undefined4 param_1,int param_2,undefined4 param_3)

{
  ...
  iVar1 = func_0x02953fd4(0x5d30,0);
  if (iVar1 == 0) {
    if (-1 < param_2) {
      iVar3 = FUN_02bad204(param_1,param_2,param_3);
      iVar1 = func_0x02953fd4(0x2198,0);
      if (iVar1 != 0) {
        iVar1 = func_0x029540a4(0x2198,0);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
      ...
      return (uint)(*(int *)(iVar3 + 0xc) == 6);
    }
    uVar2 = 0;
  }
  else {
    iVar1 = func_0x029540a4(0x5d30,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
