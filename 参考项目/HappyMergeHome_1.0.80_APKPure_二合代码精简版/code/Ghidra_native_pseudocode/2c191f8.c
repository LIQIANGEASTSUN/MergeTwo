...
undefined4 FUN_02c291f8(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c293b8 + 0x2c2920c);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c293bc + 0x2c29220));
    func_0x01438628(*(undefined4 *)(_UNK_02c293c0 + 0x2c2922c));
    func_0x01438628(*(undefined4 *)(_UNK_02c293c4 + 0x2c29238));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d6f,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d6f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c293c8 + 0x2c29360));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c293cc + 0x2c2937c),0);
  if (*(int *)(**(int **)(_UNK_02c293d0 + 0x2c29390) + 0x74) == 0) {
    func_0x014387a4();
  }
