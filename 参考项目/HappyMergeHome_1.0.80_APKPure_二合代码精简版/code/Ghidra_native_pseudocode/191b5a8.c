...

{
  ...
  pcVar6 = (char *)(_UNK_0192b650 + 0x192b5bc);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0192b654 + 0x192b5d0));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x97a2,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x97a2,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar7 = **(int **)(_UNK_0192b658 + 0x192b644);
