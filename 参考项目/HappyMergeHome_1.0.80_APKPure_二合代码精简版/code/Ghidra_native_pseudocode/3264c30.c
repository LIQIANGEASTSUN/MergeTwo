...
uint FUN_03274c30(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar2 = func_0x02953fd4(0x8144,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_03274d5c + 0x3274cc4) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_03274d60 + 0x3274ce0));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x02953fd4(0x812c,0);
    if (iVar2 == 0) {
      iVar2 = func_0x032777e8(param_1);
      if (iVar2 == 0) {
        func_0x014388e4();
      }
      iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_0327db90 + 0x327da14));
      if (iVar2 == 0) {
        ...
        if (iVar2 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_0327dba4 + 0x327dacc));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar2,param_2,**(undefined4 **)(_UNK_0327dba0 + 0x327da48));
        }
        func_0x03b70fe4(iVar2,param_2,iVar9 + -1,**(undefined4 **)(_UNK_0327dba8 + 0x327daf0));
        iVar2 = func_0x032777e8(param_1);
        if (iVar2 == 0) {
          func_0x014388e4();
        }
        uVar1 = func_0x03b70fac(iVar2,param_2,**(undefined4 **)(_UNK_0327dbac + 0x327db20));
        if ((int)uVar1 < 1) {
          iVar2 = func_0x032777e8(param_1);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar9 = **(int **)(_UNK_0327dbb0 + 0x327db60);
...
LAB_046c3e4c:
    ...
    iVar2 = func_0x029540a4(0x812c,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar2 = func_0x029540a4(0x8144,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
