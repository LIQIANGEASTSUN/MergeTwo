...
void FUN_02be3be4(int param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_02be3c90 + 0x2be3bfc);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be3c94 + 0x2be3c10));
    *pcVar10 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x5d20,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x5d20,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  iStack_34 = func_0x03600048(*(undefined4 *)(param_1 + 0x14),param_2,
                              **(undefined4 **)(_UNK_02be3c98 + 0x2be3c70));
  if (iStack_34 == 0) {
    return;
  }
  pcVar10 = (char *)(_UNK_0268c5d8 + 0x268be84);
  if (*pcVar10 == '\0') {
  ...
  piVar1 = (int *)func_0x024ef924(iStack_34,0);
  if (piVar1 == (int *)0x0) {
    func_0x014388e4();
  }
  iVar5 = (**(code **)(*piVar1 + 0x440))(piVar1,0x34,*(undefined4 *)(*piVar1 + 0x444));
  uVar12 = 0;
  ...
  do {
    ...
    if ((int)*(uint *)(iVar5 + 0xc) <= (int)uVar12) {
      return;
    }
    if (*(uint *)(iVar5 + 0xc) <= uVar12) {
      func_0x014388e8();
    }
    piVar11 = *(int **)(iVar5 + 0x10 + uVar12 * 4);
    if (piVar11 == (int *)0x0) {
      func_0x014388e4();
    }
    piVar2 = (int *)(**(code **)(*piVar11 + 0x140))(piVar11,*(undefined4 *)(*piVar11 + 0x144));
    uVar9 = (**(code **)(*piVar11 + 0x140))(piVar11,*(undefined4 *)(*piVar11 + 0x144));
    uVar6 = **(undefined4 **)(_UNK_0268c638 + 0x268c05c);
    if (*(int *)(*piVar1 + 0x74) == 0) {
      func_0x014387a4();
    }
    uVar6 = func_0x024ef3e8(uVar6,0);
    iVar7 = func_0x024f22c0(uVar9,uVar6,0);
    if (iVar7 == 0) {
      uVar9 = (**(code **)(*piVar11 + 0x140))(piVar11,*(undefined4 *)(*piVar11 + 0x144));
      ...
      iVar7 = func_0x024f22c0(uVar9,uVar6,0);
      if (iVar7 != 0) {
        puVar3 = *(undefined4 **)(_UNK_0268c644 + 0x268c120);
LAB_0268c11c:
        uVar9 = *puVar3;
LAB_0268c198:
        uStack_30 = 0;
LAB_0268c19c:
        uVar9 = func_0x014387ac(uVar9,&uStack_30);
        pcVar8 = *(code **)(*piVar11 + 0x198);
      ...
      iVar7 = func_0x024f22c0(uVar9,uVar6,0);
      if (iVar7 != 0) {
        puVar3 = *(undefined4 **)(_UNK_0268c64c + 0x268c190);
LAB_0268c18c:
        uVar9 = *puVar3;
        uStack_2c = 0;
        goto LAB_0268c198;
      ...
      iVar7 = func_0x024f22c0(uVar9,uVar6,0);
      if (iVar7 != 0) {
        puVar3 = *(undefined4 **)(_UNK_0268c654 + 0x268c238);
        goto LAB_0268c11c;
      }
      uVar9 = (**(code **)(*piVar11 + 0x140))(piVar11,*(undefined4 *)(*piVar11 + 0x144));
      ...
      iVar7 = func_0x024f22c0(uVar9,uVar6,0);
      if (iVar7 != 0) {
        puVar3 = *(undefined4 **)(_UNK_0268c65c + 0x268c2a0);
        goto LAB_0268c18c;
      }
      uVar9 = (**(code **)(*piVar11 + 0x140))(piVar11,*(undefined4 *)(*piVar11 + 0x144));
      ...
      iVar7 = func_0x024f22c0(uVar9,uVar6,0);
      if (iVar7 != 0) {
        puVar3 = *(undefined4 **)(_UNK_0268c664 + 0x268c308);
        goto LAB_0268c11c;
      }
      uVar9 = (**(code **)(*piVar11 + 0x140))(piVar11,*(undefined4 *)(*piVar11 + 0x144));
      ...
      iVar7 = func_0x024f22c0(uVar9,uVar6,0);
      if (iVar7 != 0) {
        puVar3 = *(undefined4 **)(_UNK_0268c66c + 0x268c370);
        goto LAB_0268c18c;
      }
      uVar9 = (**(code **)(*piVar11 + 0x140))(piVar11,*(undefined4 *)(*piVar11 + 0x144));
      ...
      if (iVar7 != 0) {
        ...
        uVar9 = **(undefined4 **)(_UNK_0268c674 + 0x268c3dc);
        goto LAB_0268c19c;
      }
      uVar9 = **(undefined4 **)(_UNK_0268c678 + 0x268c3f4);
      if (*(int *)(*piVar1 + 0x74) == 0) {
        func_0x014387a4();
      }
      ...
      iVar7 = (**(code **)(*piVar2 + 0x168))(piVar2,uVar9,*(undefined4 *)(*piVar2 + 0x16c));
      if (iVar7 == 0) {
        iVar7 = (**(code **)(*piVar2 + 0x200))(piVar2,*(undefined4 *)(*piVar2 + 0x204));
        if (iVar7 != 0) {
          uVar9 = (**(code **)(*piVar2 + 0x240))(piVar2,*(undefined4 *)(*piVar2 + 0x244));
...
LAB_0268c530:
        iVar7 = (**(code **)(*piVar11 + 0x188))
                          (piVar11,iStack_34,0,*(undefined4 *)(*piVar11 + 0x18c));
        if (iVar7 == 0) {
          func_0x014388e4();
        }
        iVar4 = func_0x024ef924(iVar7,0);
        if (iVar4 == 0) {
          func_0x014388e4();
        }
        iVar4 = func_0x024f03e4(iVar4,**(undefined4 **)(_UNK_0268c684 + 0x268c588),0);
        uVar9 = func_0x014386f0(**(undefined4 **)(_UNK_0268c688 + 0x268c5a4),0);
        if (iVar4 == 0) {
          func_0x014388e4();
        }
        func_0x024f1c98(iVar4,iVar7,uVar9,0);
      }
    }
    else {
      pcVar8 = *(code **)(*piVar11 + 0x198);
      uStack_38 = *(undefined4 *)(*piVar11 + 0x19c);
      uVar9 = **(undefined4 **)(**(int **)(_UNK_0268c63c + 0x268c09c) + 0x5c);
LAB_0268c1b8:
      (*pcVar8)(piVar11,iStack_34,uVar9,0);
    }
    uVar12 = uVar12 + 1;
  } while( true );
}
