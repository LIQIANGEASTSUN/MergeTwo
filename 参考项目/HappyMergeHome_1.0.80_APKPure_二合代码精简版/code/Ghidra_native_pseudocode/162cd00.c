...
int FUN_0163cd00(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_0163ce7c + 0x163cd14);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0163ce80 + 0x163cd28));
    func_0x01438628(*(undefined4 *)(_UNK_0163ce84 + 0x163cd34));
    func_0x01438628(*(undefined4 *)(_UNK_0163ce88 + 0x163cd40));
    func_0x01438628(*(undefined4 *)(_UNK_0163ce8c + 0x163cd4c));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x85c3,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x85c3,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0163ce90 + 0x163cda4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0163ce94 + 0x163cdc0));
  piVar7 = *(int **)(_UNK_0163ce98 + 0x163cdd4);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_0163ce9c + 0x163cdf4);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0xaac);
  if (iVar2 == 0) {
