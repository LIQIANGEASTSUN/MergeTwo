...

{
  ...
  pcVar11 = (char *)(_UNK_030d6b24 + 0x30d69b0);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030d6b28 + 0x30d69c4));
    func_0x01438628(*(undefined4 *)(_UNK_030d6b2c + 0x30d69d0));
    func_0x01438628(*(undefined4 *)(_UNK_030d6b30 + 0x30d69dc));
    func_0x01438628(*(undefined4 *)(_UNK_030d6b34 + 0x30d69e8));
    func_0x01438628(*(undefined4 *)(_UNK_030d6b38 + 0x30d69f4));
    func_0x01438628(*(undefined4 *)(_UNK_030d6b3c + 0x30d6a00));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7720,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x7720,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_030d6b40 + 0x30d6a64) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_030d6b44 + 0x30d6a80));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = func_0x036c7bec(iVar3,**(undefined4 **)(_UNK_030d6b48 + 0x30d6aa0));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar3 + 0x388) != 0) {
    func_0x03b73ab8(*(int *)(iVar3 + 0x388),**(undefined4 **)(_UNK_030d6b4c + 0x30d6ad0));
  }
  if (*(int *)(**(int **)(_UNK_030d6b50 + 0x30d6ae0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_030d6b54 + 0x30d6afc));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  pcVar11 = (char *)(_UNK_02be82b0 + 0x2be8170);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x45,0);
  ...
  if (iVar9 != 0) {
    ...
    uStack_38 = 0;
    uStack_28 = 0;
    func_0x024f56c0(&uStack_50,0,0x45,0);
    uStack_38 = uStack_50;
    iStack_34 = uStack_4c;
    uStack_30 = uStack_48;
    uStack_2c = iStack_44;
    ...
    func_0x01523a2c(&uStack_38,0x45,0);
    iVar10 = *(int *)(iVar9 + 8);
  ...
  iVar3 = func_0x046ccb14(uVar2,0x45,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar3 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar1 = (*(code *)*puVar4)(piVar8,0x45,puVar4[1]);
      uVar2 = uStack_30;
    }
    iVar9 = *(int *)(uVar2 + 8);
    iVar3 = iVar9;
