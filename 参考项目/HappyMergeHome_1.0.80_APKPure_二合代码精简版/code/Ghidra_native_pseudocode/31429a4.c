...
void FUN_031529a4(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar7 = (char *)(_UNK_03152b60 + 0x31529bc);
  if (*pcVar7 == '\0') {
  ...
  iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_03152b74 + 0x3152a8c));
  ...
  if (iVar5 == 0) {
    ...
    iVar2 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_03152b78 + 0x3152b10));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_03152b40:
    ...
    iVar2 = func_0x03b70fac(iVar5,param_2,**(undefined4 **)(_UNK_03152b7c + 0x3152ae4));
  }
  unaff_r7 = iVar2 + 1;
