...
void FUN_017218c8(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar7 = (char *)(_UNK_01721cc8 + 0x17218f0);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01721ccc + 0x1721904));
    func_0x01438628(*(undefined4 *)(_UNK_01721cd0 + 0x1721910));
    func_0x01438628(*(undefined4 *)(_UNK_01721cd4 + 0x172191c));
    func_0x01438628(*(undefined4 *)(_UNK_01721cd8 + 0x1721928));
    func_0x01438628(*(undefined4 *)(_UNK_01721cdc + 0x1721934));
    func_0x01438628(*(undefined4 *)(_UNK_01721ce0 + 0x1721940));
    func_0x01438628(*(undefined4 *)(_UNK_01721ce4 + 0x172194c));
    func_0x01438628(*(undefined4 *)(_UNK_01721ce8 + 0x1721958));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x166b,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_01721cec + 0x17219bc) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_01721cf0 + 0x17219d8));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    if ((int)(iVar6 - (iVar2 + (uint)bVar12)) < 0 !=
      ...
      func_0x024f0570(iVar5,**(undefined4 **)(_UNK_01721cf4 + 0x1721b64));
      uVar15 = FUN_01714754(param_1);
      ...
      if (*(int *)(**(int **)(_UNK_01721cf8 + 0x1721bb8) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_01721cfc + 0x1721bd4));
      piVar10 = *(int **)(_UNK_01721d00 + 0x1721be8);
      iVar5 = *piVar10;
      if (*(int *)(iVar5 + 0x74) == 0) {
        func_0x014387a4();
        iVar5 = *piVar10;
      ...
      piVar10 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_01721d04 + 0x1721c0c),1);
      uStack_54 = 0;
      iVar5 = func_0x014387ac(**(undefined4 **)(_UNK_01721d08 + 0x1721c2c),&uStack_54);
      if (piVar10 == (int *)0x0) {
        func_0x014388e4();
      }
      if ((iVar5 != 0) &&
    ...
    iVar2 = func_0x029540a4(0x166b,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
