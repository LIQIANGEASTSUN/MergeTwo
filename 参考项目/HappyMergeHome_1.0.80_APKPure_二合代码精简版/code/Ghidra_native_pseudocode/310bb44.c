...
void FUN_0311bb44(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar7 = (char *)(_UNK_0311bd00 + 0x311bb5c);
  if (*pcVar7 == '\0') {
  ...
  iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_0311bd14 + 0x311bc2c));
  ...
  if (iVar5 == 0) {
    ...
    iVar2 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_0311bd18 + 0x311bcb0));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_0311bce0:
    ...
    iVar2 = func_0x03b70fac(iVar5,param_2,**(undefined4 **)(_UNK_0311bd1c + 0x311bc84));
  }
  unaff_r7 = iVar2 + 1;
