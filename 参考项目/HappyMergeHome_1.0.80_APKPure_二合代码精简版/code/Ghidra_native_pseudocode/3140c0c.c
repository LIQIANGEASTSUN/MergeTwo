...
void FUN_03150c0c(undefined4 param_1)

{
  ...
  iVar5 = func_0x02953fd4(0x205b,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x205b,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  iStack_34 = iVar5;
  piVar1 = (int *)func_0x024ef924(iVar5,0);
  if (piVar1 == (int *)0x0) {
    func_0x014388e4();
  }
...
LAB_0268c18c:
      ...
      iVar8 = (**(code **)(*piVar2 + 0x168))(piVar2,uVar10,*(undefined4 *)(*piVar2 + 0x16c));
      if (iVar8 == 0) {
        iVar8 = (**(code **)(*piVar2 + 0x200))(piVar2,*(undefined4 *)(*piVar2 + 0x204));
        if (iVar8 != 0) {
          uVar10 = (**(code **)(*piVar2 + 0x240))(piVar2,*(undefined4 *)(*piVar2 + 0x244));
...
LAB_0268c530:
        ...
        func_0x024f1c98(iVar4,iVar8,uVar10,0);
      }
    }
    else {
      pcVar9 = *(code **)(*piVar11 + 0x198);
