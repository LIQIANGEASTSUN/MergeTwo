...
uint FUN_02c780a4(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_02c781f4 + 0x2c780b8);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c781f8 + 0x2c780cc));
    func_0x01438628(*(undefined4 *)(_UNK_02c781fc + 0x2c780d8));
    func_0x01438628(*(undefined4 *)(_UNK_02c78200 + 0x2c780e4));
    func_0x01438628(*(undefined4 *)(_UNK_02c78204 + 0x2c780f0));
    func_0x01438628(*(undefined4 *)(_UNK_02c78208 + 0x2c780fc));
    *pcVar9 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x6042,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x6042,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02c7820c + 0x2c78154) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_02c78210 + 0x2c78170));
  piVar12 = *(int **)(_UNK_02c78214 + 0x2c78184);
  iVar7 = *piVar12;
  if (*(int *)(iVar7 + 0x74) == 0) {
    func_0x014387a4();
    iVar7 = *piVar12;
  }
  piVar12 = *(int **)(*(int *)(iVar7 + 0x5c) + 0x14);
  uVar11 = func_0x014388d4(**(undefined4 **)(_UNK_02c78218 + 0x2c781a8));
  func_0x038ec9e8(uVar11,param_1,**(undefined4 **)(_UNK_02c7821c + 0x2c781c8),0);
  if (iVar3 == 0) {
    func_0x014388e4();
  }
