...

{
  ...
  pcVar3 = (char *)(_UNK_01bc3824 + 0x1bc3788);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01bc3828 + 0x1bc379c));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xa8d2,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xa8d2,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01bc382c + 0x1bc37f0) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_01bc01cc();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
