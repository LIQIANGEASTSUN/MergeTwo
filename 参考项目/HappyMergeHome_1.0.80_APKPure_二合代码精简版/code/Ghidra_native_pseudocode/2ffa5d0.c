...
undefined4 FUN_0300a5d0(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_0300a680 + 0x300a5e8);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0300a684 + 0x300a5fc));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xf5e,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xf5e,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x0300b528(param_1);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar4 = **(int **)(_UNK_0300a688 + 0x300a674);
