...

{
  ...
  pcVar3 = (char *)(_UNK_02c44344 + 0x2c44284);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c44348 + 0x2c44298));
    func_0x01438628(*(undefined4 *)(_UNK_02c4434c + 0x2c442a4));
    *pcVar3 = '\x01';
  }
  iVar4 = *(int *)(param_1 + 8);
  ...
  if (iVar4 == iVar2) {
    if (*(int *)(**(int **)(_UNK_02c44350 + 0x2c442fc) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_02c44354 + 0x2c44318));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
