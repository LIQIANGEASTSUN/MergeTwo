...

{
  ...
  pcVar7 = (char *)(_UNK_0170eca8 + 0x170eb5c);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0170ecac + 0x170eb70));
    func_0x01438628(*(undefined4 *)(_UNK_0170ecb0 + 0x170eb7c));
    func_0x01438628(*(undefined4 *)(_UNK_0170ecb4 + 0x170eb88));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x2c86,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x2c86,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0170ecb8 + 0x170ebe0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0170ecbc + 0x170ebfc));
  uVar10 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar9 = **(int **)(_UNK_0170ecc0 + 0x170ec28);
