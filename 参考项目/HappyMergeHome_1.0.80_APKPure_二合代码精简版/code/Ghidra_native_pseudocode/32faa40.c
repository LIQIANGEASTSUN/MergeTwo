...

{
  ...
  pcVar7 = (char *)(_UNK_0330aba0 + 0x330aa54);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0330aba4 + 0x330aa68));
    func_0x01438628(*(undefined4 *)(_UNK_0330aba8 + 0x330aa74));
    func_0x01438628(*(undefined4 *)(_UNK_0330abac + 0x330aa80));
    *pcVar7 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x296a,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x296a,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0330abb0 + 0x330aad8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_0330abb4 + 0x330aaf4));
  uVar9 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar10 = **(int **)(_UNK_0330abb8 + 0x330ab20);
