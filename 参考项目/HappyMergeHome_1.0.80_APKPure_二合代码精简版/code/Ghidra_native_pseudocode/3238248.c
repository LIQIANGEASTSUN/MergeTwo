...
void FUN_03248248(int param_1,undefined4 param_2,int param_3)

{
  ...
  iVar3 = func_0x02953fd4(0x7ff9,0);
  if (iVar3 == 0) {
    iVar3 = FUN_0323c5d0(param_1);
    if (((iVar3 != 0) && (iVar3 = FUN_03247e04(param_1,param_2,param_3), iVar3 == 0)) &&
       (iVar3 = FUN_03247ed4(param_1,param_2), iVar3 != 0)) {
      if (param_3 == 0) {
      ...
      iVar3 = func_0x02953fd4(0x1fb5,0);
      if (iVar3 != 0) {
        iVar3 = func_0x029540a4(0x1fb5,0);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
...
LAB_03247c54:
            ...
            if (*(char *)(iVar2 + 0xd) == '\0') goto LAB_03247c54;
            iVar2 = FUN_0323c5d0(param_1);
            if (iVar2 == 0) {
              func_0x014388e4();
            }
    ...
    iVar3 = func_0x029540a4(0x7ff9,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
