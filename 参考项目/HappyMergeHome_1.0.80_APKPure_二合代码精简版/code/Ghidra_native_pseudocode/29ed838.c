...
undefined4 FUN_029fd838(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_029fd924 + 0x29fd84c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_029fd928 + 0x29fd860));
    func_0x01438628(*(undefined4 *)(_UNK_029fd92c + 0x29fd86c));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x24fd,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x24fd,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_029fd930 + 0x29fd8c4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_029fd934 + 0x29fd8e0));
  iVar5 = FUN_029fd48c(param_1);
  if (iVar5 == 0) {
    func_0x014388e4();
  }
