...
int FUN_03244334(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_03244468 + 0x3244348);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0324446c + 0x324435c));
    func_0x01438628(*(undefined4 *)(_UNK_03244470 + 0x3244368));
    *pcVar4 = '\x01';
  }
  iVar7 = 0;
  iVar1 = func_0x02953fd4(0x7fb0,0);
  if (iVar1 != 0) {
    iVar7 = func_0x029540a4(0x7fb0,0);
    if (iVar7 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = 1;
  puVar8 = *(undefined4 **)(_UNK_03244474 + 0x32443c8);
  while( true ) {
