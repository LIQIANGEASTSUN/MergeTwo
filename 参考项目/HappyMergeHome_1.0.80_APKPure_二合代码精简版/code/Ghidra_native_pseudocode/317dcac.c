...
void FUN_0318dcac(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar7 = (char *)(_UNK_0318de68 + 0x318dcc4);
  if (*pcVar7 == '\0') {
  ...
  iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_0318de7c + 0x318dd94));
  ...
  if (iVar5 == 0) {
    ...
    iVar2 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_0318de80 + 0x318de18));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_0318de48:
    ...
    iVar2 = func_0x03b70fac(iVar5,param_2,**(undefined4 **)(_UNK_0318de84 + 0x318ddec));
  }
  unaff_r7 = iVar2 + 1;
