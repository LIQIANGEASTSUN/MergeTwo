...
uint FUN_02fcedf4(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_02fceedc + 0x2fcee14);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fceee0 + 0x2fcee28));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x70f5,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x70f5,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_02fceee4 + 0x2fceea4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_02fc8d20();
  if (iVar2 == 0) {
