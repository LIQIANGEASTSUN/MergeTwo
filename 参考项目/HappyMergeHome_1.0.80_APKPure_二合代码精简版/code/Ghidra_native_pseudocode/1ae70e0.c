...
undefined4 FUN_01af70e0(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar5 = (char *)(_UNK_01af720c + 0x1af70f8);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01af7210 + 0x1af710c));
    func_0x01438628(*(undefined4 *)(_UNK_01af7214 + 0x1af7118));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xa4fe,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xa4fe,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (iVar1 != 0) {
    ...
    iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_01af7218 + 0x1af71b0));
    if (iVar1 != 0) {
      iVar1 = FUN_01af3828(param_1);
      if (iVar1 == 0) {
        func_0x014388e4();
      ...
      iVar4 = **(int **)(_UNK_01af721c + 0x1af71f8);
      if (iVar1 == 0) {
        func_0x024f83d4();
      }
