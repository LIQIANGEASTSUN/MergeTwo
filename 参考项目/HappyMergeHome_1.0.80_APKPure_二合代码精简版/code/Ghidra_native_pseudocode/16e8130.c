...
void FUN_016f8130(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0x29ac,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x29ac,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = FUN_016f80c4(param_1);
  iVar1 = iVar1 + 1;
  iVar5 = func_0x02953fd4(0x29ae,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x29ae,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
