...
int FUN_0195ba90(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0x98d2,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x98d2,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  pcVar6 = (char *)(_UNK_0198d9e4 + 0x198d880);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0198d9e8 + 0x198d894));
    func_0x01438628(*(undefined4 *)(_UNK_0198d9ec + 0x198d8a0));
    func_0x01438628(*(undefined4 *)(_UNK_0198d9f0 + 0x198d8ac));
    func_0x01438628(*(undefined4 *)(_UNK_0198d9f4 + 0x198d8b8));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x1649,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x1649,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_0198d9f8 + 0x198d90c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0198d9fc + 0x198d928));
  piVar7 = *(int **)(_UNK_0198da00 + 0x198d93c);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_0198da04 + 0x198d95c);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0xa60);
  if (iVar2 == 0) {
