...

{
  ...
  pcVar4 = (char *)(_UNK_0323c5c4 + 0x323c528);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0323c5c8 + 0x323c53c));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7fd7,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7fd7,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0323c5cc + 0x323c590) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_032356b8();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
