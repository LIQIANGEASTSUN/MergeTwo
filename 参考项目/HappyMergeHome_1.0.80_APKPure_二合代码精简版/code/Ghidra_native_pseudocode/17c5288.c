...

{
  ...
  pcVar3 = (char *)(_UNK_017d5334 + 0x17d5298);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017d5338 + 0x17d52ac));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8f9b,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8f9b,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_017d533c + 0x17d5300) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_017d0b50();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
