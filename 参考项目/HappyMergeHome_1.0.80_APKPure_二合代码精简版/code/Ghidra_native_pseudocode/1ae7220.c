...
void FUN_01af7220(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_01af73d0 + 0x1af7238);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01af73d4 + 0x1af724c));
    func_0x01438628(*(undefined4 *)(_UNK_01af73d8 + 0x1af7258));
    func_0x01438628(*(undefined4 *)(_UNK_01af73dc + 0x1af7264));
    func_0x01438628(*(undefined4 *)(_UNK_01af73e0 + 0x1af7270));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x2d26,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x2d26,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar2 = func_0x024f0540(iVar2,param_2,**(undefined4 **)(_UNK_01af73e4 + 0x1af7308));
  iVar5 = FUN_01af3828(param_1);
  if (iVar5 == 0) {
    func_0x014388e4();
  }
  ...
  if (iVar5 == 0) {
    func_0x014388e4();
    if (iVar2 == 0) goto LAB_01af73b0;
    iVar2 = func_0x024f05d4(0,param_2,**(undefined4 **)(_UNK_01af73e8 + 0x1af7380));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_01af73b0:
      iVar2 = **(int **)(_UNK_01af73f4 + 0x1af73c4);
      iStack_18 = unaff_r4;
      if (iVar5 == 0) {
        func_0x024f83d4();
      }
    ...
    iVar2 = func_0x024f05d4(iVar5,param_2,**(undefined4 **)(_UNK_01af73ec + 0x1af7350));
  }
  unaff_r7 = iVar2 + 1;
  unaff_r5 = **(int **)(_UNK_01af73f0 + 0x1af73a4);
  iStack_1c = unaff_r7;
  if (iVar5 == 0) {
    func_0x024f83d4();
  }
