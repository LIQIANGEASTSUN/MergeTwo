...

{
  ...
  pcVar5 = (char *)(_UNK_01bc3ce0 + 0x1bc3b30);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01bc3ce4 + 0x1bc3b44));
    func_0x01438628(*(undefined4 *)(_UNK_01bc3ce8 + 0x1bc3b50));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xa8da,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xa8da,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (iVar1 == 0) {
    ...
    if (*(int *)(**(int **)(_UNK_01bc3cec + 0x1bc3c64) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x03b2c734(**(undefined4 **)(_UNK_01bc3cf0 + 0x1bc3c80));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
