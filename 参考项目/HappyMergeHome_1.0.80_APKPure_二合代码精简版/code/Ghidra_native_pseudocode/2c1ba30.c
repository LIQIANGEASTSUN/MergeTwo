...
undefined4 FUN_02c2ba30(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2bbf0 + 0x2c2ba44);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2bbf4 + 0x2c2ba58));
    func_0x01438628(*(undefined4 *)(_UNK_02c2bbf8 + 0x2c2ba64));
    func_0x01438628(*(undefined4 *)(_UNK_02c2bbfc + 0x2c2ba70));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d97,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d97,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2bc00 + 0x2c2bb98));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2bc04 + 0x2c2bbb4),0);
  if (*(int *)(**(int **)(_UNK_02c2bc08 + 0x2c2bbc8) + 0x74) == 0) {
    func_0x014387a4();
  }
