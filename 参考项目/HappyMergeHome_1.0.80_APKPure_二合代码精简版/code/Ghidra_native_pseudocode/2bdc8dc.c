...
undefined4 FUN_02bec8dc(int param_1,uint *param_2)

{
  ...
  pcVar4 = (char *)(_UNK_02becab8 + 0x2bec8f8);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02becabc + 0x2bec90c));
    func_0x01438628(*(undefined4 *)(_UNK_02becac0 + 0x2bec918));
    *pcVar4 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x5ee1,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x5ee1,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar2 = 4;
  piVar8 = *(int **)(_UNK_02becac4 + 0x2bec97c);
  puVar9 = *(undefined4 **)(_UNK_02becac8 + 0x2bec984);
  do {
