...
void FUN_031b7454(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  pcVar4 = (char *)(_UNK_031b7540 + 0x31b7474);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031b7544 + 0x31b7494));
    *pcVar4 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7d09,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7d09,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iStack_34 = param_5;
  ...
  if (*(int *)(**(int **)(_UNK_031b7548 + 0x31b7504) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_031b08c8();
  if (iVar2 == 0) {
