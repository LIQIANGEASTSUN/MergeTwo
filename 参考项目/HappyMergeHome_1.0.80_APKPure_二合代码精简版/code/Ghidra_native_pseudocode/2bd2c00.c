...
void FUN_02be2c00(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_02be2d04 + 0x2be2c18);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be2d08 + 0x2be2c2c));
    *pcVar6 = '\x01';
  }
  iVar7 = 0;
  ...
  while( true ) {
    ...
    iVar3 = func_0x02be2d0c(param_1,iVar7,param_2);
    iVar1 = iVar2;
    if (iVar2 < 1) {
      iVar1 = iVar3 + -1;
    }
    if (iVar1 < 0 == (iVar2 < 1 && SBORROW4(iVar3,1))) {
      func_0x02be2ef0(param_1,iVar7,param_2);
    }
    iVar7 = iVar7 + 1;
  }
  return;
