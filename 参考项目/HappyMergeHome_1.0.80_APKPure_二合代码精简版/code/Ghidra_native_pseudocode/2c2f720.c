...

{
  ...
  pcVar5 = (char *)(_UNK_02c3f7ac + 0x2c3f730);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c3f7b0 + 0x2c3f744));
    func_0x01438628(*(undefined4 *)(_UNK_02c3f7b4 + 0x2c3f750));
    *pcVar5 = '\x01';
  }
  if (*(int *)(**(int **)(_UNK_02c3f7b8 + 0x2c3f764) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x014e9518(**(undefined4 **)(_UNK_02c3f7bc + 0x2c3f780));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
