...
int FUN_017110d0(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0x8b3d,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8b3d,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  pcVar6 = (char *)(_UNK_01741050 + 0x1740eec);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01741054 + 0x1740f00));
    func_0x01438628(*(undefined4 *)(_UNK_01741058 + 0x1740f0c));
    func_0x01438628(*(undefined4 *)(_UNK_0174105c + 0x1740f18));
    func_0x01438628(*(undefined4 *)(_UNK_01741060 + 0x1740f24));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x166c,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x166c,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_01741064 + 0x1740f78) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01741068 + 0x1740f94));
  piVar7 = *(int **)(_UNK_0174106c + 0x1740fa8);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_01741070 + 0x1740fc8);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0xa88);
  if (iVar2 == 0) {
