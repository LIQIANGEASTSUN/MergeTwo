...
void FUN_0324a420(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar7 = (char *)(_UNK_0324a5dc + 0x324a438);
  if (*pcVar7 == '\0') {
  ...
  iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_0324a5f0 + 0x324a508));
  ...
  if (iVar5 == 0) {
    ...
    iVar2 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_0324a5f4 + 0x324a58c));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_0324a5bc:
    ...
    iVar2 = func_0x03b70fac(iVar5,param_2,**(undefined4 **)(_UNK_0324a5f8 + 0x324a560));
  }
  unaff_r7 = iVar2 + 1;
