...
undefined4 FUN_02f255c4(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_02f256b0 + 0x2f255d8);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f256b4 + 0x2f255ec));
    func_0x01438628(*(undefined4 *)(_UNK_02f256b8 + 0x2f255f8));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x6d37,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x6d37,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f256bc + 0x2f25650) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_02f256c0 + 0x2f2566c));
  iVar5 = FUN_02f243cc(param_1);
  if (iVar5 == 0) {
    func_0x014388e4();
  }
