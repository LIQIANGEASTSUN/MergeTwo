...
int FUN_03240d48(int *param_1,int param_2,int param_3)

{
  ...
  pcVar10 = (char *)(_UNK_03240f1c + 0x3240d68);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03240f20 + 0x3240d7c));
    func_0x01438628(*(undefined4 *)(_UNK_03240f24 + 0x3240d88));
    func_0x01438628(*(undefined4 *)(_UNK_03240f28 + 0x3240d94));
    *pcVar10 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x7fad,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x7fad,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_03240f2c + 0x3240dfc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_03240f30 + 0x3240e18));
  uVar6 = (**(code **)(*param_1 + 0x1a0))(param_1,*(undefined4 *)(*param_1 + 0x1a4));
  piVar7 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_03240f34 + 0x3240e48),2);
  if (piVar7 == (int *)0x0) {
    func_0x014388e4();
  }
  if ((param_2 != 0) &&
