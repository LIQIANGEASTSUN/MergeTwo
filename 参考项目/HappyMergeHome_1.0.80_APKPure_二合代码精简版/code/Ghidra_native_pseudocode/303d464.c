...
uint FUN_0304d464(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_0304d504 + 0x304d478);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0304d508 + 0x304d48c));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7421,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7421,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0304d50c + 0x304d4e4) + 0x74) == 0) {
    func_0x014387a4();
  }
