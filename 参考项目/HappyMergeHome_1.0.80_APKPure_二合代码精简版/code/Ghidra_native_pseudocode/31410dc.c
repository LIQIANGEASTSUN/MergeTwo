...
void FUN_031510dc(int param_1,undefined4 param_2,int param_3)

{
  ...
  iVar3 = func_0x02953fd4(0x7a33,0);
  if (iVar3 == 0) {
    iVar3 = FUN_031457fc(param_1);
    if (((iVar3 != 0) && (iVar3 = FUN_03150d4c(param_1,param_2,param_3), iVar3 == 0)) &&
       (iVar3 = FUN_03150e1c(param_1,param_2), iVar3 != 0)) {
      if (param_3 == 0) {
    ...
    iVar3 = func_0x029540a4(0x7a33,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
