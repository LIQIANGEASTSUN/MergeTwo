...

{
  ...
  pcVar3 = (char *)(_UNK_01926258 + 0x19261bc);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0192625c + 0x19261d0));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9794,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9794,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01926260 + 0x1926224) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_01920184();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
