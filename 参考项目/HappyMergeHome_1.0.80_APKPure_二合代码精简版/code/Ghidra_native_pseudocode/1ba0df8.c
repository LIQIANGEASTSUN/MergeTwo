...

{
  ...
  pcVar3 = (char *)(_UNK_01bb0ea4 + 0x1bb0e08);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01bb0ea8 + 0x1bb0e1c));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xa854,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xa854,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01bb0eac + 0x1bb0e70) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_01ba1db8();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
