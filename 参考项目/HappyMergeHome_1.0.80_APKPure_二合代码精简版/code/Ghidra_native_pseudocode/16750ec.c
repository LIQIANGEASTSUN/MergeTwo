...
int FUN_016850ec(undefined4 param_1,int param_2)

{
  ...
  pcVar5 = (char *)(_UNK_01685504 + 0x1685108);
  if (*pcVar5 == '\0') {
  ...
  iVar1 = func_0x02953fd4(0x20de,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x20de,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  puVar10 = *(undefined4 **)(_UNK_01685530 + 0x1685228);
  iVar1 = func_0x024f0f34(iVar1,param_2,*puVar10);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_01685534 + 0x1685248) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01685538 + 0x1685264));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    iVar1 = *(int *)(iVar1 + 0x2c);
    iVar8 = 0;
    puVar11 = *(undefined4 **)(_UNK_0168553c + 0x168528c);
    do {
      if (iVar1 == 0) {
        func_0x014388e4();
      }
    ...
    while( true ) {
      ...
      if (*(int *)(iVar2 + 0x24) <= param_2) {
        ...
        if (iVar2 == 0) {
          ...
          func_0x024f05ac(iVar2,uVar9,**(undefined4 **)(_UNK_01685540 + 0x1685404));
        }
      }
      iVar8 = iVar8 + 1;
    }
    ...
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01685548 + 0x1685444));
    piVar7 = *(int **)(_UNK_0168554c + 0x1685458);
    iVar8 = *piVar7;
    if (*(int *)(iVar8 + 0x74) == 0) {
      func_0x014387a4();
      iVar8 = *piVar7;
    }
    iVar6 = **(int **)(_UNK_01685550 + 0x1685478);
