...

{
  ...
  pcVar7 = (char *)(_UNK_03106120 + 0x3105fd4);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03106124 + 0x3105fe8));
    func_0x01438628(*(undefined4 *)(_UNK_03106128 + 0x3105ff4));
    func_0x01438628(*(undefined4 *)(_UNK_0310612c + 0x3106000));
    *pcVar7 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x2afe,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x2afe,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03106130 + 0x3106058) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_03106134 + 0x3106074));
  uVar9 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar10 = **(int **)(_UNK_03106138 + 0x31060a0);
