...
/* WARNING: Possible PIC construction at 0x0183e6c8: Changing call to branch */
/* WARNING: Possible PIC construction at 0x0183e6f0: Changing call to branch */
/* WARNING: Possible PIC construction at 0x0183e718: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x0183e6f4) */
/* WARNING: Removing unreachable block (ram,0x0183e708) */
/* WARNING: Removing unreachable block (ram,0x0183e70c) */
/* WARNING: Removing unreachable block (ram,0x0183e6cc) */
/* WARNING: Removing unreachable block (ram,0x0183e6e0) */
/* WARNING: Removing unreachable block (ram,0x0183e6e4) */
/* WARNING: Removing unreachable block (ram,0x0183e71c) */
/* WARNING: Removing unreachable block (ram,0x0183e730) */
/* WARNING: Removing unreachable block (ram,0x0183e734) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_0183e548(int param_1)

{
  ...
  pcVar10 = (char *)(_UNK_0183e748 + 0x183e55c);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0183e74c + 0x183e570));
    func_0x01438628(*(undefined4 *)(_UNK_0183e750 + 0x183e57c));
    func_0x01438628(*(undefined4 *)(_UNK_0183e754 + 0x183e588));
    func_0x01438628(*(undefined4 *)(_UNK_0183e758 + 0x183e594));
    func_0x01438628(*(undefined4 *)(_UNK_0183e75c + 0x183e5a0));
    func_0x01438628(*(undefined4 *)(_UNK_0183e760 + 0x183e5ac));
    *pcVar10 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x924b,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x924b,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0183e764 + 0x183e610) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0183e768 + 0x183e62c));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar1 = func_0x036c7bec(iVar1,**(undefined4 **)(_UNK_0183e76c + 0x183e64c));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar1 + 0x310) != 0) {
    func_0x024f04d0(*(int *)(iVar1 + 0x310),**(undefined4 **)(_UNK_0183e770 + 0x183e67c));
  }
  if (*(int *)(**(int **)(_UNK_0183e774 + 0x183e68c) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar11 = *(undefined4 **)(_UNK_0183e778 + 0x183e6a8);
  ...
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x28,0);
  ...
  if (iVar1 != 0) {
    ...
    puStack_30 = puVar2;
    puStack_2c = puVar11;
    func_0x024f56c0(&uStack_60,0,0x28,0);
    ...
    func_0x01523a2c(&puStack_48,0x28,0);
    iVar12 = *(int *)(iVar1 + 8);
    uVar13 = *(undefined4 *)(iVar1 + 0xc);
    iVar1 = *(int *)(iVar1 + 0x10);
    if (iVar12 == 0) {
  ...
  iVar12 = func_0x046ccb14(iVar1,0x28,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar12 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar3 = (*(code *)*puVar2)(piVar9,0x28,puVar2[1]);
      iVar1 = iStack_40;
    }
    iVar12 = *(int *)(iVar1 + 8);
    iVar1 = iVar12;
