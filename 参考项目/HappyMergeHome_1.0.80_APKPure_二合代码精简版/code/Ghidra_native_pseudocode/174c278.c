...
undefined4 FUN_0175c278(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar5 = (char *)(_UNK_0175c3b4 + 0x175c290);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0175c3b8 + 0x175c2a4));
    func_0x01438628(*(undefined4 *)(_UNK_0175c3bc + 0x175c2b0));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8d2d,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8d2d,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_0175c3c0 + 0x175c348));
  if (iVar1 != 0) {
    iVar1 = FUN_0174e5a0(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_0175c3c4 + 0x175c3a0);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
