...
void FUN_03140e7c(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_03140f34 + 0x3140e90);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03140f38 + 0x3140ea4));
    *pcVar8 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x79c9,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x79c9,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x03152548(param_1);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_03140f3c + 0x3140f0c) + 0x74) == 0) {
    func_0x014387a4();
  }
