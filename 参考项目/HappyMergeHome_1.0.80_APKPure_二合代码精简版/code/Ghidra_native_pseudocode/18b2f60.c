...
uint FUN_018c2f60(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_018c3048 + 0x18c2f80);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018c304c + 0x18c2f94));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x9524,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x9524,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_018c3050 + 0x18c3010) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_018bd08c();
  if (iVar2 == 0) {
  ...
  pcVar11 = (char *)(_UNK_018c288c + 0x18c2784);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018c2890 + 0x18c2798));
    func_0x01438628(*(undefined4 *)(_UNK_018c2894 + 0x18c27a4));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9520,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_018c2898 + 0x18c2800) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018c289c + 0x18c281c));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_018cb21c + 0x18cafe8);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_018cb220 + 0x18caffc));
      func_0x01438628(*(undefined4 *)(_UNK_018cb224 + 0x18cb008));
      func_0x01438628(*(undefined4 *)(_UNK_018cb228 + 0x18cb014));
      func_0x01438628(*(undefined4 *)(_UNK_018cb22c + 0x18cb020));
      func_0x01438628(*(undefined4 *)(_UNK_018cb230 + 0x18cb02c));
      func_0x01438628(*(undefined4 *)(_UNK_018cb234 + 0x18cb038));
      func_0x01438628(*(undefined4 *)(_UNK_018cb238 + 0x18cb044));
      *pcVar11 = '\x01';
    }
    iVar1 = func_0x02953fd4(0x9508,0);
    if (iVar1 == 0) {
      iVar1 = func_0x018c5324(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x024f0540(iVar1,param_3,**(undefined4 **)(_UNK_018cb23c + 0x18cb0c0));
      if (iVar1 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x024eee28(**(undefined4 **)(_UNK_018cb240 + 0x18cb124),uVar10,
                                 **(undefined4 **)(_UNK_018cb244 + 0x18cb130),0);
        if (*(int *)(**(int **)(_UNK_018cb248 + 0x18cb144) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_3,**(undefined4 **)(_UNK_018cb250 + 0x18cb178));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar1,param_3,**(undefined4 **)(_UNK_018cb24c + 0x18cb0f4));
        }
        func_0x024f10d4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_018cb254 + 0x18cb19c));
        iVar1 = func_0x018c5324(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x024f05d4(iVar1,param_3,**(undefined4 **)(_UNK_018cb258 + 0x18cb1cc));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x018c5324(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_018cb25c + 0x18cb20c);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x9508,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x9520,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
