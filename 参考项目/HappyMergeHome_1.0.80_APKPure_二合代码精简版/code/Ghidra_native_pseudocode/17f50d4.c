...
/* WARNING: Possible PIC construction at 0x01805254: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x01805258) */
/* WARNING: Removing unreachable block (ram,0x0180526c) */
/* WARNING: Removing unreachable block (ram,0x01805270) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_018050d4(int param_1)

{
  ...
  pcVar10 = (char *)(_UNK_01805284 + 0x18050e8);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01805288 + 0x18050fc));
    func_0x01438628(*(undefined4 *)(_UNK_0180528c + 0x1805108));
    func_0x01438628(*(undefined4 *)(_UNK_01805290 + 0x1805114));
    func_0x01438628(*(undefined4 *)(_UNK_01805294 + 0x1805120));
    func_0x01438628(*(undefined4 *)(_UNK_01805298 + 0x180512c));
    func_0x01438628(*(undefined4 *)(_UNK_0180529c + 0x1805138));
    *pcVar10 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x90cc,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x90cc,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_018052a0 + 0x180519c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018052a4 + 0x18051b8));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar1 = func_0x036c7bec(iVar1,**(undefined4 **)(_UNK_018052a8 + 0x18051d8));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar1 + 0x238) != 0) {
    func_0x024f04d0(*(int *)(iVar1 + 0x238),**(undefined4 **)(_UNK_018052ac + 0x1805208));
  }
  if (*(int *)(**(int **)(_UNK_018052b0 + 0x1805218) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar11 = *(undefined4 **)(_UNK_018052b4 + 0x1805234);
  ...
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x13,0);
  ...
  if (iVar1 != 0) {
    ...
    puStack_30 = puVar2;
    puStack_2c = puVar11;
    func_0x024f56c0(&uStack_60,0,0x13,0);
    ...
    func_0x01523a2c(&puStack_48,0x13,0);
    iVar12 = *(int *)(iVar1 + 8);
    uVar13 = *(undefined4 *)(iVar1 + 0xc);
    iVar1 = *(int *)(iVar1 + 0x10);
    if (iVar12 == 0) {
  ...
  iVar12 = func_0x046ccb14(iVar1,0x13,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar12 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar3 = (*(code *)*puVar2)(piVar9,0x13,puVar2[1]);
      iVar1 = iStack_40;
    }
    iVar12 = *(int *)(iVar1 + 8);
    iVar1 = iVar12;
