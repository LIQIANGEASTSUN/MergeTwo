...
uint FUN_017136c8(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_017137b0 + 0x17136e8);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017137b4 + 0x17136fc));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8b6a,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8b6a,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_017137b8 + 0x1713778) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_0170e674();
  if (iVar1 == 0) {
  ...
  pcVar11 = (char *)(_UNK_017138dc + 0x17137d4);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017138e0 + 0x17137e8));
    func_0x01438628(*(undefined4 *)(_UNK_017138e4 + 0x17137f4));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x8b6b,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_017138e8 + 0x1713850) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_017138ec + 0x171386c));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_0171c268 + 0x171c034);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_0171c26c + 0x171c048));
      func_0x01438628(*(undefined4 *)(_UNK_0171c270 + 0x171c054));
      func_0x01438628(*(undefined4 *)(_UNK_0171c274 + 0x171c060));
      func_0x01438628(*(undefined4 *)(_UNK_0171c278 + 0x171c06c));
      func_0x01438628(*(undefined4 *)(_UNK_0171c27c + 0x171c078));
      func_0x01438628(*(undefined4 *)(_UNK_0171c280 + 0x171c084));
      func_0x01438628(*(undefined4 *)(_UNK_0171c284 + 0x171c090));
      *pcVar11 = '\x01';
    }
    iVar3 = func_0x02953fd4(0x8b53,0);
    if (iVar3 == 0) {
      iVar3 = func_0x01716374(iVar1);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x024f0540(iVar3,param_3,**(undefined4 **)(_UNK_0171c288 + 0x171c10c));
      if (iVar3 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x024eee28(**(undefined4 **)(_UNK_0171c28c + 0x171c170),uVar10,
                                 **(undefined4 **)(_UNK_0171c290 + 0x171c17c),0);
        if (*(int *)(**(int **)(_UNK_0171c294 + 0x171c190) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar3 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_3,**(undefined4 **)(_UNK_0171c29c + 0x171c1c4));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar3,param_3,**(undefined4 **)(_UNK_0171c298 + 0x171c140));
        }
        func_0x024f10d4(iVar3,param_3,iVar9 + -1,**(undefined4 **)(_UNK_0171c2a0 + 0x171c1e8));
        iVar3 = func_0x01716374(iVar1);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x024f05d4(iVar3,param_3,**(undefined4 **)(_UNK_0171c2a4 + 0x171c218));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x01716374(iVar1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar3 = **(int **)(_UNK_0171c2a8 + 0x171c258);
...
LAB_046c3e4c:
    ...
    iVar3 = func_0x029540a4(0x8b53,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar3 = func_0x029540a4(0x8b6b,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
