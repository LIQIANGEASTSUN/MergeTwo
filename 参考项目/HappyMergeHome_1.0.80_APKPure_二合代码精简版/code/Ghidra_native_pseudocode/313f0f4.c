...
int FUN_0314f0f4(undefined4 param_1,int param_2)

{
  ...
  pcVar5 = (char *)(_UNK_0314f50c + 0x314f110);
  if (*pcVar5 == '\0') {
  ...
  iVar2 = func_0x02953fd4(0x2051,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x2051,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  puVar10 = *(undefined4 **)(_UNK_0314f538 + 0x314f230);
  iVar2 = func_0x04cd2d7c(iVar2,param_2,*puVar10);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_0314f53c + 0x314f250) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0314f540 + 0x314f26c));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iVar2 = *(int *)(iVar2 + 0x38);
    iVar7 = 0;
    puVar11 = *(undefined4 **)(_UNK_0314f544 + 0x314f294);
    do {
      if (iVar2 == 0) {
        func_0x014388e4();
      }
    ...
    while( true ) {
      ...
      if (*(int *)(iVar3 + 0x1c) <= param_2) {
        ...
        if (iVar3 == 0) {
          ...
          func_0x03b75ba0(iVar3,uVar9,**(undefined4 **)(_UNK_0314f548 + 0x314f40c));
        }
      }
      iVar7 = iVar7 + 1;
    }
    ...
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0314f550 + 0x314f44c));
    ...
    iVar6 = **(int **)(_UNK_0314f558 + 0x314f480);
