...
void FUN_02fdb964(int param_1,undefined4 param_2)

{
  ...
  iVar3 = func_0x02953fd4(0x7122,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x7122,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (iVar3 != 0) {
    iVar3 = FUN_02fdb6c4(param_1,param_2);
    if (iVar3 != 0) {
      return;
    }
    iVar3 = FUN_02fdb51c(param_1,param_2);
    if (iVar3 != 0) {
