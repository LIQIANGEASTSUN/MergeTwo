...
uint FUN_03187588(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_03187628 + 0x318759c);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0318762c + 0x31875b0));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7ba4,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7ba4,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03187630 + 0x3187608) + 0x74) == 0) {
    func_0x014387a4();
  }
