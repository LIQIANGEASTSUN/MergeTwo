...

{
  ...
  iVar1 = func_0x02953fd4(0x939f,0);
  if (iVar1 == 0) {
    ...
    iVar1 = FUN_0187b42c(param_1);
    if (iVar1 == 0) {
      pcVar4 = (char *)(_UNK_0187bb90 + 0x187b9f8);
      if (*pcVar4 == '\0') {
        func_0x01438628(*(undefined4 *)(_UNK_0187bb94 + 0x187ba0c));
        func_0x01438628(*(undefined4 *)(_UNK_0187bb98 + 0x187ba18));
        func_0x01438628(*(undefined4 *)(_UNK_0187bb9c + 0x187ba24));
        *pcVar4 = '\x01';
      }
      iVar1 = func_0x02953fd4(0x93ac,0);
      if (iVar1 == 0) {
        uVar2 = 0;
        if (*(char *)(param_1 + 0x52) != '\0') {
          if (*(int *)(**(int **)(_UNK_0187bba0 + 0x187ba88) + 0x74) == 0) {
            func_0x014387a4();
          }
          iVar1 = FUN_018725d4();
          if (iVar1 == 0) {
          ...
          if (*(int *)(**(int **)(_UNK_0187bba4 + 0x187bb44) + 0x74) == 0) {
            func_0x014387a4();
          }
          iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0187bba8 + 0x187bb60));
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          uVar2 = func_0x02bb3638(iVar1,0x1c,0);
          *(undefined1 *)(param_1 + 0x52) = 0;
        }
        return uVar2;
      }
      iVar1 = func_0x029540a4(0x93ac,0);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
    }
    ...
    iVar1 = func_0x029540a4(0x939f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
