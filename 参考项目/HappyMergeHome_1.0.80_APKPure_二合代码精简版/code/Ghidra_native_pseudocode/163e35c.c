...
void FUN_0164e35c(int param_1,undefined4 param_2,int param_3)

{
  ...
  iVar3 = func_0x02953fd4(0x8637,0);
  if (iVar3 == 0) {
    iVar3 = FUN_01642704(param_1);
    if (((iVar3 != 0) && (iVar3 = FUN_0164df18(param_1,param_2,param_3), iVar3 == 0)) &&
       (iVar3 = FUN_0164dfe8(param_1,param_2), iVar3 != 0)) {
      if (param_3 == 0) {
      ...
      iVar3 = func_0x02953fd4(0x200b,0);
      if (iVar3 != 0) {
        iVar3 = func_0x029540a4(0x200b,0);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
...
LAB_0164dd68:
            ...
            if (*(char *)(iVar2 + 0xd) == '\0') goto LAB_0164dd68;
            iVar2 = FUN_01642704(param_1);
            if (iVar2 == 0) {
              func_0x014388e4();
            }
    ...
    iVar3 = func_0x029540a4(0x8637,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
