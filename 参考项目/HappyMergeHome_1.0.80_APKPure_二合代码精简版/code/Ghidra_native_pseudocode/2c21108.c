...
void FUN_02c31108(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_02c31294 + 0x2c3111c);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c31298 + 0x2c31130));
    func_0x01438628(*(undefined4 *)(_UNK_02c3129c + 0x2c3113c));
    func_0x01438628(*(undefined4 *)(_UNK_02c312a0 + 0x2c31148));
    func_0x01438628(*(undefined4 *)(_UNK_02c312a4 + 0x2c31154));
    *pcVar9 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x5ef2,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x5ef2,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02c312a8 + 0x2c311ac) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x014e9518(**(undefined4 **)(_UNK_02c312ac + 0x2c311c8));
  ...
  if (iVar4 != 0) {
    if (*(int *)(**(int **)(_UNK_02c312b0 + 0x2c31210) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar8 = func_0x0202346c(0);
    iVar5 = func_0x014388d4(**(undefined4 **)(_UNK_02c312b4 + 0x2c31238));
