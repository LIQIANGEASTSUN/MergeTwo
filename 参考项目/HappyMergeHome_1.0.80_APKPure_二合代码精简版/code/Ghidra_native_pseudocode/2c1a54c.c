...
undefined4 FUN_02c2a54c(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2a70c + 0x2c2a560);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2a710 + 0x2c2a574));
    func_0x01438628(*(undefined4 *)(_UNK_02c2a714 + 0x2c2a580));
    func_0x01438628(*(undefined4 *)(_UNK_02c2a718 + 0x2c2a58c));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d81,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d81,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2a71c + 0x2c2a6b4));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2a720 + 0x2c2a6d0),0);
  if (*(int *)(**(int **)(_UNK_02c2a724 + 0x2c2a6e4) + 0x74) == 0) {
    func_0x014387a4();
  }
