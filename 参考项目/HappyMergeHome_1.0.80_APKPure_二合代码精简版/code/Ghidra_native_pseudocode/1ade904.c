...
void FUN_01aee904(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_01aee9bc + 0x1aee918);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01aee9c0 + 0x1aee92c));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xa4c4,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xa4c4,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = FUN_01aee770(param_1);
  iVar7 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_01aee9c4 + 0x1aee994) + 0x74) == 0) {
    func_0x014387a4();
  }
