...

{
  ...
  pcVar7 = (char *)(_UNK_03240700 + 0x324052c);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03240704 + 0x3240540));
    func_0x01438628(*(undefined4 *)(_UNK_03240708 + 0x324054c));
    func_0x01438628(*(undefined4 *)(_UNK_0324070c + 0x3240558));
    func_0x01438628(*(undefined4 *)(_UNK_03240710 + 0x3240564));
    *pcVar7 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x7fe4,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x7fe4,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03240714 + 0x324063c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x04e4a028(**(undefined4 **)(_UNK_03240718 + 0x3240658));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  iVar4 = *(int *)(iVar4 + 0x14);
  if ((iVar4 != 0) && (0 < *(int *)(iVar4 + 0xc))) {
    iVar6 = FUN_0323c5d0(param_1);
    if (iVar6 == 0) {
      func_0x014388e4();
    }
    iVar6 = *(int *)(iVar6 + 0x6c);
    iVar4 = func_0x04cfd760(iVar4,0,**(undefined4 **)(_UNK_0324071c + 0x32406ac));
    if (iVar4 == 0) {
      func_0x014388e4();
    }
