...
void FUN_0186f5a4(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar8 = (char *)(_UNK_0186f668 + 0x186f5bc);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0186f66c + 0x186f5d0));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9374,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9374,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x0187fd50(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_0186f670 + 0x186f640) + 0x74) == 0) {
    func_0x014387a4();
  }
