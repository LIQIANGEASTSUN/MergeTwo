...
int FUN_017d5d04(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_017d5dd0 + 0x17d5d18);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017d5dd4 + 0x17d5d2c));
    func_0x01438628(*(undefined4 *)(_UNK_017d5dd8 + 0x17d5d38));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8f9e,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8f9e,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_017d5ddc + 0x17d5d90) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_017d5de0 + 0x17d5dac));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
