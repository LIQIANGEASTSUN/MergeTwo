...
undefined4 FUN_03248440(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_0324851c + 0x3248454);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03248520 + 0x3248468));
    func_0x01438628(*(undefined4 *)(_UNK_03248524 + 0x3248474));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7ffc,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_03248528 + 0x32484cc) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_0324852c + 0x32484e8));
    uVar7 = func_0x03248530(param_1);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = func_0x029540a4(0x7ffc,0);
  if (iVar3 == 0) {
    func_0x014388e4();
  }
