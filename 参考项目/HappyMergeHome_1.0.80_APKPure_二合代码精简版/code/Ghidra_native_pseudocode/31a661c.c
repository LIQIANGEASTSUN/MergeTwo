...
uint FUN_031b661c(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_031b6704 + 0x31b663c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031b6708 + 0x31b6650));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7d02,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7d02,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_031b670c + 0x31b66cc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_031b08c8();
  if (iVar2 == 0) {
