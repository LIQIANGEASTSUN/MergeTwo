...
/* WARNING: Possible PIC construction at 0x03149674: Changing call to branch */
/* WARNING: Possible PIC construction at 0x0314969c: Changing call to branch */
/* WARNING: Possible PIC construction at 0x031496c4: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x031496a0) */
/* WARNING: Removing unreachable block (ram,0x031496b4) */
/* WARNING: Removing unreachable block (ram,0x031496b8) */
/* WARNING: Removing unreachable block (ram,0x03149678) */
/* WARNING: Removing unreachable block (ram,0x0314968c) */
/* WARNING: Removing unreachable block (ram,0x03149690) */
/* WARNING: Removing unreachable block (ram,0x031496c8) */
/* WARNING: Removing unreachable block (ram,0x031496dc) */
/* WARNING: Removing unreachable block (ram,0x031496e0) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_031494f4(int param_1)

{
  ...
  pcVar11 = (char *)(_UNK_031496f4 + 0x3149508);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031496f8 + 0x314951c));
    func_0x01438628(*(undefined4 *)(_UNK_031496fc + 0x3149528));
    func_0x01438628(*(undefined4 *)(_UNK_03149700 + 0x3149534));
    func_0x01438628(*(undefined4 *)(_UNK_03149704 + 0x3149540));
    func_0x01438628(*(undefined4 *)(_UNK_03149708 + 0x314954c));
    func_0x01438628(*(undefined4 *)(_UNK_0314970c + 0x3149558));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7a20,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x7a20,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03149710 + 0x31495bc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03149714 + 0x31495d8));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = func_0x036c7bec(iVar3,**(undefined4 **)(_UNK_03149718 + 0x31495f8));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar3 + 0x2fc) != 0) {
    func_0x03b73ab8(*(int *)(iVar3 + 0x2fc),**(undefined4 **)(_UNK_0314971c + 0x3149628));
  }
  if (*(int *)(**(int **)(_UNK_03149720 + 0x3149638) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar12 = *(undefined4 **)(_UNK_03149724 + 0x3149654);
  ...
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x1e,0);
  ...
  if (iVar3 != 0) {
    ...
    puStack_30 = puVar4;
    puStack_2c = puVar12;
    func_0x024f56c0(&uStack_60,0,0x1e,0);
    ...
    func_0x01523a2c(&puStack_48,0x1e,0);
    iVar10 = *(int *)(iVar3 + 8);
    uVar13 = *(undefined4 *)(iVar3 + 0xc);
    iVar3 = *(int *)(iVar3 + 0x10);
    if (iVar10 == 0) {
  ...
  iVar10 = func_0x046ccb14(iVar3,0x1e,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar10 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar1 = (*(code *)*puVar4)(piVar9,0x1e,puVar4[1]);
      iVar3 = iStack_40;
    }
    iVar10 = *(int *)(iVar3 + 8);
    iVar3 = iVar10;
