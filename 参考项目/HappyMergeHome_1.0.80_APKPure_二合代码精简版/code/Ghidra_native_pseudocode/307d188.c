...
void FUN_0308d188(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar7 = (char *)(_UNK_0308d344 + 0x308d1a0);
  if (*pcVar7 == '\0') {
  ...
  iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_0308d358 + 0x308d270));
  ...
  if (iVar5 == 0) {
    ...
    iVar2 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_0308d35c + 0x308d2f4));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_0308d324:
    ...
    iVar2 = func_0x03b70fac(iVar5,param_2,**(undefined4 **)(_UNK_0308d360 + 0x308d2c8));
  }
  unaff_r7 = iVar2 + 1;
