...

{
  ...
  pcVar4 = (char *)(_UNK_03009c78 + 0x3009bdc);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03009c7c + 0x3009bf0));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x727b,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x727b,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03009c80 + 0x3009c44) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_03003ba4();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
