...
void FUN_02f52a7c(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar7 = (char *)(_UNK_02f52c38 + 0x2f52a94);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f52c3c + 0x2f52aa8));
    func_0x01438628(*(undefined4 *)(_UNK_02f52c40 + 0x2f52ab4));
    func_0x01438628(*(undefined4 *)(_UNK_02f52c44 + 0x2f52ac0));
    func_0x01438628(*(undefined4 *)(_UNK_02f52c48 + 0x2f52acc));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x2b5b,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x2b5b,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_02f52c4c + 0x2f52b64));
  ...
  if (iVar5 == 0) {
    func_0x014388e4();
    if (iVar2 == 0) goto LAB_02f52c18;
    iVar2 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_02f52c50 + 0x2f52be8));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_02f52c18:
      iVar2 = **(int **)(_UNK_02f52c5c + 0x2f52c2c);
      iStack_18 = unaff_r4;
      if (iVar5 == 0) {
        func_0x024f83d4();
      }
    ...
    iVar2 = func_0x03b70fac(iVar5,param_2,**(undefined4 **)(_UNK_02f52c54 + 0x2f52bbc));
  }
  unaff_r7 = iVar2 + 1;
  unaff_r5 = **(int **)(_UNK_02f52c58 + 0x2f52c0c);
  iStack_1c = unaff_r7;
  if (iVar5 == 0) {
    func_0x024f83d4();
  }
