...
uint FUN_0323a648(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_0323a730 + 0x323a668);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0323a734 + 0x323a67c));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7fc4,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7fc4,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0323a738 + 0x323a6f8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_032356b8();
  if (iVar1 == 0) {
  ...
  pcVar11 = (char *)(_UNK_0323a85c + 0x323a754);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0323a860 + 0x323a768));
    func_0x01438628(*(undefined4 *)(_UNK_0323a864 + 0x323a774));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7fc5,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_0323a868 + 0x323a7d0) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_0323a86c + 0x323a7ec));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    iVar3 = func_0x02953fd4(0x7fa5,0);
    if (iVar3 == 0) {
      iVar3 = func_0x0323e1f0(iVar1);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x046c26fc(iVar3,param_3,**(undefined4 **)(_UNK_0324422c + 0x32440b0));
      if (iVar3 == 0) {
        ...
        if (iVar3 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_3,**(undefined4 **)(_UNK_03244240 + 0x3244168));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar3,param_3,**(undefined4 **)(_UNK_0324423c + 0x32440e4));
        }
        func_0x03b70fe4(iVar3,param_3,iVar9 + -1,**(undefined4 **)(_UNK_03244244 + 0x324418c));
        iVar3 = func_0x0323e1f0(iVar1);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x03b70fac(iVar3,param_3,**(undefined4 **)(_UNK_03244248 + 0x32441bc));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x0323e1f0(iVar1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar3 = **(int **)(_UNK_0324424c + 0x32441fc);
...
LAB_046c3e4c:
    ...
    iVar3 = func_0x029540a4(0x7fa5,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar3 = func_0x029540a4(0x7fc5,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
