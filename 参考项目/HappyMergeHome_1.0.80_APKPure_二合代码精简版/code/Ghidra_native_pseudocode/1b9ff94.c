...
int FUN_01baff94(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_01bb0170 + 0x1baffa8);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01bb0174 + 0x1baffbc));
    func_0x01438628(*(undefined4 *)(_UNK_01bb0178 + 0x1baffc8));
    func_0x01438628(*(undefined4 *)(_UNK_01bb017c + 0x1baffd4));
    func_0x01438628(*(undefined4 *)(_UNK_01bb0180 + 0x1baffe0));
    func_0x01438628(*(undefined4 *)(_UNK_01bb0184 + 0x1baffec));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0xa84c,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0xa84c,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01bb0188 + 0x1bb0044) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_01ba1db8();
  if (iVar2 == 0) {
  ...
  if (*(int *)(**(int **)(_UNK_01bb018c + 0x1bb008c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_01bb0190 + 0x1bb00ac));
  piVar9 = *(int **)(_UNK_01bb0194 + 0x1bb00c0);
  iVar8 = *piVar9;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar9;
  ...
  if (cVar1 == '\0') {
    uVar11 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0xd1c);
  }
  else {
    uVar11 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0xd10);
  }
  iVar10 = **(int **)(_UNK_01bb0198 + 0x1bb00e8);
