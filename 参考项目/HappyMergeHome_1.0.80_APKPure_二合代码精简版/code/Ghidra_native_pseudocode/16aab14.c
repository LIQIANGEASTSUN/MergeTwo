...

{
  ...
  pcVar6 = (char *)(_UNK_016bad00 + 0x16bab2c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016bad04 + 0x16bab40));
    func_0x01438628(*(undefined4 *)(_UNK_016bad08 + 0x16bab4c));
    func_0x01438628(*(undefined4 *)(_UNK_016bad0c + 0x16bab58));
    func_0x01438628(*(undefined4 *)(_UNK_016bad10 + 0x16bab64));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8926,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8926,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_016bad14 + 0x16bac3c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_016bad18 + 0x16bac58));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  iVar2 = *(int *)(iVar2 + 0x14);
  if ((iVar2 != 0) && (0 < *(int *)(iVar2 + 0xc))) {
    iVar7 = FUN_016b6be8(param_1);
    if (iVar7 == 0) {
      func_0x014388e4();
    }
    iVar7 = *(int *)(iVar7 + 0x6c);
    iVar2 = func_0x0152983c(iVar2,0,**(undefined4 **)(_UNK_016bad1c + 0x16bacac));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
