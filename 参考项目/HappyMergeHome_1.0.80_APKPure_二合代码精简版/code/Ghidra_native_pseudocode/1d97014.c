...

{
  ...
  pcVar3 = (char *)(_UNK_01da70c0 + 0x1da7024);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01da70c4 + 0x1da7038));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x3ef3,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x3ef3,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01da70c8 + 0x1da708c) + 0x74) == 0) {
    func_0x014387a4();
  }
