...
void FUN_02c31e3c(int param_1,undefined4 param_2)

{
  ...
  iVar1 = func_0x02953fd4(0x4fff,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x4fff,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  pcVar5 = (char *)(_UNK_02c23448 + 0x2c23378);
  if (*pcVar5 == '\0') {
  ...
  if (iVar3 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      uStack_20 = 0;
      func_0x024f1368(iVar1,param_2,0,0);
    }
  }
  else {
    ...
    uStack_20 = 0;
    func_0x028691b4(iVar3,param_1,iVar1,param_2);
  }
  return;
}
