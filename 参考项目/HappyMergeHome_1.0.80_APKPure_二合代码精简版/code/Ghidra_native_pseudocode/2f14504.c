...
undefined4 FUN_02f24504(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_02f245b4 + 0x2f2451c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f245b8 + 0x2f24530));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x1330,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x1330,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x02f256c4(param_1);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar4 = **(int **)(_UNK_02f245bc + 0x2f245a8);
