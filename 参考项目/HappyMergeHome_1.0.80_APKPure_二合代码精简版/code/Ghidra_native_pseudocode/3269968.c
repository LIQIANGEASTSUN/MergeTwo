...

{
  ...
  pcVar11 = (char *)(_UNK_03279af0 + 0x327997c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03279af4 + 0x3279990));
    func_0x01438628(*(undefined4 *)(_UNK_03279af8 + 0x327999c));
    func_0x01438628(*(undefined4 *)(_UNK_03279afc + 0x32799a8));
    func_0x01438628(*(undefined4 *)(_UNK_03279b00 + 0x32799b4));
    func_0x01438628(*(undefined4 *)(_UNK_03279b04 + 0x32799c0));
    func_0x01438628(*(undefined4 *)(_UNK_03279b08 + 0x32799cc));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x815b,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x815b,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03279b0c + 0x3279a30) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03279b10 + 0x3279a4c));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = func_0x036c7bec(iVar3,**(undefined4 **)(_UNK_03279b14 + 0x3279a6c));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar3 + 0x328) != 0) {
    func_0x03b73ab8(*(int *)(iVar3 + 0x328),**(undefined4 **)(_UNK_03279b18 + 0x3279a9c));
  }
  if (*(int *)(**(int **)(_UNK_03279b1c + 0x3279aac) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03279b20 + 0x3279ac8));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  pcVar11 = (char *)(_UNK_02be82b0 + 0x2be8170);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x2c,0);
  ...
  if (iVar9 != 0) {
    ...
    uStack_38 = 0;
    uStack_28 = 0;
    func_0x024f56c0(&uStack_50,0,0x2c,0);
    uStack_38 = uStack_50;
    iStack_34 = uStack_4c;
    uStack_30 = uStack_48;
    uStack_2c = iStack_44;
    ...
    func_0x01523a2c(&uStack_38,0x2c,0);
    iVar10 = *(int *)(iVar9 + 8);
  ...
  iVar3 = func_0x046ccb14(uVar2,0x2c,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar3 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar1 = (*(code *)*puVar4)(piVar8,0x2c,puVar4[1]);
      uVar2 = uStack_30;
    }
    iVar9 = *(int *)(uVar2 + 8);
    iVar3 = iVar9;
