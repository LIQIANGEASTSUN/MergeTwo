...
int FUN_018c0080(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0x94f2,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x94f2,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  pcVar6 = (char *)(_UNK_018ef3ac + 0x18ef248);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018ef3b0 + 0x18ef25c));
    func_0x01438628(*(undefined4 *)(_UNK_018ef3b4 + 0x18ef268));
    func_0x01438628(*(undefined4 *)(_UNK_018ef3b8 + 0x18ef274));
    func_0x01438628(*(undefined4 *)(_UNK_018ef3bc + 0x18ef280));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x1459,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x1459,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_018ef3c0 + 0x18ef2d4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018ef3c4 + 0x18ef2f0));
  piVar7 = *(int **)(_UNK_018ef3c8 + 0x18ef304);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_018ef3cc + 0x18ef324);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0x880);
  if (iVar2 == 0) {
