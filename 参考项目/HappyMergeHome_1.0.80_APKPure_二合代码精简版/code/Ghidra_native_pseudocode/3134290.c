...
uint FUN_03144290(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_03144378 + 0x31442b0);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0314437c + 0x31442c4));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7a06,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7a06,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_03144380 + 0x3144340) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_0313e53c();
  if (iVar2 == 0) {
