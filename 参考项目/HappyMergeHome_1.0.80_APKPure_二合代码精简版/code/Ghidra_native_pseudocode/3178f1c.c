...
int FUN_03188f1c(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_0318903c + 0x3188f30);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03189040 + 0x3188f44));
    func_0x01438628(*(undefined4 *)(_UNK_03189044 + 0x3188f50));
    func_0x01438628(*(undefined4 *)(_UNK_03189048 + 0x3188f5c));
    func_0x01438628(*(undefined4 *)(_UNK_0318904c + 0x3188f68));
    *pcVar9 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x2033,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x2033,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03189050 + 0x3188fc0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03189054 + 0x3188fdc));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  ...
  iVar3 = func_0x04cfd760(iVar3,*(int *)(iVar3 + 0xc) + -1,
                          **(undefined4 **)(_UNK_03189058 + 0x318900c));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = *(int *)(iVar3 + 0x24);
  pcVar9 = (char *)(_UNK_03187f5c + 0x3187b60);
  iStack_24 = unaff_r4;
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03187f60 + 0x3187b74));
    func_0x01438628(*(undefined4 *)(_UNK_03187f64 + 0x3187b80));
    func_0x01438628(*(undefined4 *)(_UNK_03187f68 + 0x3187b8c));
    func_0x01438628(*(undefined4 *)(_UNK_03187f6c + 0x3187b98));
    func_0x01438628(*(undefined4 *)(_UNK_03187f70 + 0x3187ba4));
    func_0x01438628(*(undefined4 *)(_UNK_03187f74 + 0x3187bb0));
    func_0x01438628(*(undefined4 *)(_UNK_03187f78 + 0x3187bbc));
    func_0x01438628(*(undefined4 *)(_UNK_03187f7c + 0x3187bc8));
    func_0x01438628(*(undefined4 *)(_UNK_03187f80 + 0x3187bd4));
    func_0x01438628(*(undefined4 *)(_UNK_03187f84 + 0x3187be0));
    *pcVar9 = '\x01';
  }
  iVar6 = func_0x02953fd4(0x2034,0);
  if (iVar6 == 0) {
    iVar6 = FUN_0317e7f4(param_1);
    if (iVar6 == 0) {
      func_0x014388e4();
    }
    ...
    puVar11 = *(undefined4 **)(_UNK_03187f88 + 0x3187c80);
    iVar6 = func_0x04cd2d7c(iVar6,iVar3,*puVar11);
    if (iVar6 == 0) {
      if (*(int *)(**(int **)(_UNK_03187f8c + 0x3187ca0) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar6 = func_0x04e4a028(**(undefined4 **)(_UNK_03187f90 + 0x3187cbc));
      if (iVar6 == 0) {
        func_0x014388e4();
      }
      iVar6 = *(int *)(iVar6 + 0x30);
      iVar7 = 0;
      puVar12 = *(undefined4 **)(_UNK_03187f94 + 0x3187ce4);
      while( true ) {
        if (iVar6 == 0) {
          func_0x014388e4();
        }
          ...
          while( true ) {
            ...
            if (*(int *)(iVar2 + 0x24) <= iVar3) {
              ...
              if (iVar2 == 0) {
                ...
                func_0x03b75ba0(iVar2,uVar10,**(undefined4 **)(_UNK_03187f98 + 0x3187e5c));
              }
            }
            iVar7 = iVar7 + 1;
          }
          func_0x031891e0(param_1);
          if (*(int *)(**(int **)(_UNK_03187f9c + 0x3187e80) + 0x74) == 0) {
            func_0x014387a4();
          }
          iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03187fa0 + 0x3187e9c));
          piVar8 = *(int **)(_UNK_03187fa4 + 0x3187eb0);
          iVar6 = *piVar8;
          if (*(int *)(iVar6 + 0x74) == 0) {
            func_0x014387a4();
            iVar6 = *piVar8;
          }
          iVar2 = **(int **)(_UNK_03187fa8 + 0x3187ed0);
  ...
  iVar6 = func_0x029540a4(0x2034,0);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
  puStack_20 = (undefined4 *)iStack_24;
