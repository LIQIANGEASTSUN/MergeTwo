...
void FUN_017dca48(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
                 undefined4 param_5)

{
  ...
  pcVar2 = (char *)(_UNK_017dcb84 + 0x17dca68);
  if (*pcVar2 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017dcb88 + 0x17dca80));
    *pcVar2 = '\x01';
  }
  ...
  uStack_30 = uStack_50;
  uStack_2c = uStack_4c;
  iVar1 = func_0x02953fd4(0x1e6c,0);
  if (iVar1 == 0) {
    ...
    *puVar3 = uStack_68;
    ...
    uStack_3c = param_3;
    uStack_38 = param_4;
    func_0x035cbf40(puVar3,&uStack_58,**(undefined4 **)(_UNK_017dcb8c + 0x17dcb6c));
  }
  else {
    iVar1 = func_0x029540a4(0x1e6c,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
