...
void FUN_019333d8(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar7 = (char *)(_UNK_019337d8 + 0x1933400);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_019337dc + 0x1933414));
    func_0x01438628(*(undefined4 *)(_UNK_019337e0 + 0x1933420));
    func_0x01438628(*(undefined4 *)(_UNK_019337e4 + 0x193342c));
    func_0x01438628(*(undefined4 *)(_UNK_019337e8 + 0x1933438));
    func_0x01438628(*(undefined4 *)(_UNK_019337ec + 0x1933444));
    func_0x01438628(*(undefined4 *)(_UNK_019337f0 + 0x1933450));
    func_0x01438628(*(undefined4 *)(_UNK_019337f4 + 0x193345c));
    func_0x01438628(*(undefined4 *)(_UNK_019337f8 + 0x1933468));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x16c5,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_019337fc + 0x19334cc) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_01933800 + 0x19334e8));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    if ((int)(iVar6 - (iVar2 + (uint)bVar12)) < 0 !=
      ...
      func_0x024f0570(iVar5,**(undefined4 **)(_UNK_01933804 + 0x1933674));
      uVar15 = FUN_01926264(param_1);
      ...
      if (*(int *)(**(int **)(_UNK_01933808 + 0x19336c8) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0193380c + 0x19336e4));
      piVar10 = *(int **)(_UNK_01933810 + 0x19336f8);
      iVar5 = *piVar10;
      if (*(int *)(iVar5 + 0x74) == 0) {
        func_0x014387a4();
        iVar5 = *piVar10;
      ...
      piVar10 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_01933814 + 0x193371c),1);
      uStack_54 = 0;
      iVar5 = func_0x014387ac(**(undefined4 **)(_UNK_01933818 + 0x193373c),&uStack_54);
      if (piVar10 == (int *)0x0) {
        func_0x014388e4();
      }
      if ((iVar5 != 0) &&
    ...
    iVar2 = func_0x029540a4(0x16c5,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
