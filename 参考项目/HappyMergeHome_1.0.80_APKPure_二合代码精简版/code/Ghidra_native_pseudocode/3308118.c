...
void FUN_03318118(undefined4 param_1)

{
  ...
  iVar3 = func_0x02953fd4(0x297b,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x297b,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = FUN_033180ac(param_1);
  iVar3 = iVar3 + 1;
  iVar5 = func_0x02953fd4(0x297d,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x297d,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  iVar5 = FUN_0330edb4(param_1);
  if (iVar5 == 0) {
    func_0x014388e4();
  }
  pcVar7 = (char *)(_UNK_026f2104 + 0x26f207c);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_026f2108 + 0x26f2090),iVar3,0);
  ...
  piVar1 = *(int **)(_UNK_026f2110 + 0x26f20bc);
  *(int *)(iVar5 + 0x5c) = iVar3;
  if (*(int *)(*piVar1 + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_026f2114 + 0x26f20dc));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
