...
undefined4 FUN_03180024(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_03180110 + 0x3180038);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03180114 + 0x318004c));
    func_0x01438628(*(undefined4 *)(_UNK_03180118 + 0x3180058));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7b95,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7b95,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0318011c + 0x31800b0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_03180120 + 0x31800cc));
  iVar5 = FUN_0317f008(param_1);
  if (iVar5 == 0) {
    func_0x014388e4();
  }
