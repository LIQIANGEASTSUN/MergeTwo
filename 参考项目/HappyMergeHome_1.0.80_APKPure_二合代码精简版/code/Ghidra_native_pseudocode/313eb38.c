...
uint FUN_0314eb38(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_0314ebd8 + 0x314eb4c);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0314ebdc + 0x314eb60));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7a26,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7a26,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0314ebe0 + 0x314ebb8) + 0x74) == 0) {
    func_0x014387a4();
  }
