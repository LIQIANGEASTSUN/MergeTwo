...
void FUN_0186fdf8(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_0186feb0 + 0x186fe0c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0186feb4 + 0x186fe20));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9379,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9379,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x0187fedc(param_1);
  iVar7 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_0186feb8 + 0x186fe88) + 0x74) == 0) {
    func_0x014387a4();
  }
