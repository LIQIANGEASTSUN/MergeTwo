...
void FUN_03050bd8(undefined4 param_1)

{
  ...
  iVar3 = func_0x02953fd4(0x2b3e,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x2b3e,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = FUN_03050b6c(param_1);
  iVar3 = iVar3 + 1;
  iVar5 = func_0x02953fd4(0x2b40,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x2b40,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
