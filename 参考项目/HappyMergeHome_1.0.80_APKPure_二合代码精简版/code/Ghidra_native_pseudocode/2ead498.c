...
undefined4 FUN_02ebd498(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_02ebd548 + 0x2ebd4b0);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02ebd54c + 0x2ebd4c4));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xd8f,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xd8f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = FUN_02ebd1a0(param_1);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar4 = **(int **)(_UNK_02ebd550 + 0x2ebd53c);
