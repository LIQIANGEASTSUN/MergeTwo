...
int * FUN_0310bc78(undefined4 param_1)

{
  ...
  pcVar16 = (char *)(_UNK_0310bd58 + 0x310bc8c);
  if (*pcVar16 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0310bd5c + 0x310bca0));
    func_0x01438628(*(undefined4 *)(_UNK_0310bd60 + 0x310bcac));
    func_0x01438628(*(undefined4 *)(_UNK_0310bd64 + 0x310bcb8));
    *pcVar16 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x1465,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x1465,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
    pcVar16 = (char *)(_UNK_028a39a4 + 0x28a38c4);
    if (*pcVar16 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_028a39a8 + 0x28a38d8),param_1,0);
      *pcVar16 = '\x01';
    }
    ...
    piVar3 = (int *)func_0x035daef8(&uStack_30,0,**(undefined4 **)(_UNK_028a39ac + 0x28a3994));
    return piVar3;
  }
  if (*(int *)(**(int **)(_UNK_0310bd68 + 0x310bd10) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x04e4a028(**(undefined4 **)(_UNK_0310bd6c + 0x310bd2c));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  iVar15 = **(int **)(_UNK_0310bd70 + 0x310bd4c);
  puVar20 = auStack_20;
