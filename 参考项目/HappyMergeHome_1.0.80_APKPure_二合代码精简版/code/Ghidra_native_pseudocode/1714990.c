...
undefined4 FUN_01724990(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar5 = (char *)(_UNK_01724acc + 0x17249a8);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01724ad0 + 0x17249bc));
    func_0x01438628(*(undefined4 *)(_UNK_01724ad4 + 0x17249c8));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8ba8,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8ba8,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_01724ad8 + 0x1724a60));
  if (iVar1 != 0) {
    iVar1 = FUN_01714754(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_01724adc + 0x1724ab8);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
