...
int FUN_02f40630(undefined4 param_1)

{
  ...
  iVar3 = func_0x02953fd4(0x6db5,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x6db5,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = FUN_02f3e088(param_1);
  if (iVar3 == 0) {
    return 0;
  }
  pcVar6 = (char *)(_UNK_02f897c0 + 0x2f8965c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f897c4 + 0x2f89670));
    func_0x01438628(*(undefined4 *)(_UNK_02f897c8 + 0x2f8967c));
    func_0x01438628(*(undefined4 *)(_UNK_02f897cc + 0x2f89688));
    func_0x01438628(*(undefined4 *)(_UNK_02f897d0 + 0x2f89694));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x14e1,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x14e1,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_02f897d4 + 0x2f896e8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02f897d8 + 0x2f89704));
  piVar8 = *(int **)(_UNK_02f897dc + 0x2f89718);
  iVar7 = *piVar8;
  if (*(int *)(iVar7 + 0x74) == 0) {
    func_0x014387a4();
    iVar7 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_02f897e0 + 0x2f89738);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar7 + 0x5c) + 0x920);
  if (iVar4 == 0) {
