...
void FUN_0183567c(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar8 = (char *)(_UNK_01835740 + 0x1835694);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01835744 + 0x18356a8));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x91ef,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x91ef,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x01847480(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_01835748 + 0x1835718) + 0x74) == 0) {
    func_0x014387a4();
  }
