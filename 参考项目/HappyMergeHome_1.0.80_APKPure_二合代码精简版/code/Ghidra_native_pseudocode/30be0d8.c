...
int FUN_030ce0d8(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_030ce254 + 0x30ce0ec);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030ce258 + 0x30ce100));
    func_0x01438628(*(undefined4 *)(_UNK_030ce25c + 0x30ce10c));
    func_0x01438628(*(undefined4 *)(_UNK_030ce260 + 0x30ce118));
    func_0x01438628(*(undefined4 *)(_UNK_030ce264 + 0x30ce124));
    *pcVar7 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x76d1,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x76d1,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_030ce268 + 0x30ce17c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_030ce26c + 0x30ce198));
  piVar8 = *(int **)(_UNK_030ce270 + 0x30ce1ac);
  iVar6 = *piVar8;
  if (*(int *)(iVar6 + 0x74) == 0) {
    func_0x014387a4();
    iVar6 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_030ce274 + 0x30ce1cc);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar6 + 0x5c) + 0x994);
  if (iVar4 == 0) {
