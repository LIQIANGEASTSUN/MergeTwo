...
void FUN_0168b05c(int param_1,int param_2)

{
  ...
  pcVar6 = (char *)(_UNK_0168b6a8 + 0x168b078);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0168b6ac + 0x168b08c));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6b0 + 0x168b098));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6b4 + 0x168b0a4));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6b8 + 0x168b0b0));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6bc + 0x168b0bc));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6c0 + 0x168b0c8));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6c4 + 0x168b0d4));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6c8 + 0x168b0e0));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6cc + 0x168b0ec));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6d0 + 0x168b0f8));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6d4 + 0x168b104));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6d8 + 0x168b110));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6dc + 0x168b11c));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6e0 + 0x168b128));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6e4 + 0x168b134));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6e8 + 0x168b140));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6ec + 0x168b14c));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6f0 + 0x168b158));
    func_0x01438628(*(undefined4 *)(_UNK_0168b6f4 + 0x168b164));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x2c42,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x2c42,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iStack_2c = param_2;
  if (*(int *)(**(int **)(_UNK_0168b6f8 + 0x168b1cc) + 0x74) == 0) {
    func_0x014387a4();
  }
  ...
  while( true ) {
    ...
    iVar9 = func_0x0152983c(iVar9,iVar2,**(undefined4 **)(_UNK_0168b6fc + 0x168b234));
    iVar7 = **(int **)(**(int **)(_UNK_0168b700 + 0x168b250) + 0x5c);
    if (iVar9 == 0) {
      func_0x014388e4();
    }
    ...
    if (iVar7 == 0) {
      if (*(int *)(**(int **)(_UNK_0168b704 + 0x168b294) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar7 = func_0x0202346c(0);
      iVar3 = func_0x014388d4(**(undefined4 **)(_UNK_0168b708 + 0x168b2bc));
      func_0x02025440(iVar3,0);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      *(undefined4 *)(iVar3 + 8) = 0x80;
      uVar10 = *(undefined4 *)(iVar9 + 8);
      ...
      *(undefined4 *)(iVar3 + 0xc) = uVar10;
      ...
      iVar7 = FUN_01689d08(param_1,*(undefined4 *)(iVar9 + 8));
      if (iVar7 == 0) goto LAB_0168b3dc;
      if (0 < *(int *)(iVar9 + 0xc)) {
        iVar7 = 0;
        do {
          iVar3 = FUN_0167c750(param_1);
          if (iVar3 == 0) {
            func_0x014388e4();
          }
          ...
          func_0x024f05ac(iVar3,uVar10,**(undefined4 **)(_UNK_0168b70c + 0x168b370));
          iVar3 = **(int **)(_UNK_0168b710 + 0x168b384);
...
LAB_0168b3dc:
      ...
      iVar9 = **(int **)(**(int **)(_UNK_0168b714 + 0x168b3e8) + 0x5c);
      if (iVar9 == 0) {
        func_0x014388e4();
      }
      iStack_40 = 1;
  ...
  if (*(int *)(**(int **)(_UNK_0168b718 + 0x168b460) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0168b71c + 0x168b47c));
  piVar8 = *(int **)(_UNK_0168b720 + 0x168b490);
  iVar7 = *piVar8;
  if (*(int *)(iVar7 + 0x74) == 0) {
    func_0x014387a4();
    iVar7 = *piVar8;
  ...
  piVar8 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_0168b724 + 0x168b4b4),1);
  if (piVar8 == (int *)0x0) {
    func_0x014388e4();
  }
  ...
  if (*(int *)(**(int **)(_UNK_0168b728 + 0x168b540) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e96a8(**(undefined4 **)(_UNK_0168b72c + 0x168b55c));
  if (*(int *)(**(int **)(_UNK_0168b730 + 0x168b570) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar7 = func_0x014e9518(**(undefined4 **)(_UNK_0168b734 + 0x168b58c));
  if (iVar7 == 0) {
    func_0x014388e4();
  }
  piVar8 = *(int **)(_UNK_0168b738 + 0x168b5ac);
  ...
  if (iVar3 == 0) {
    ...
    iVar3 = func_0x014388d4(**(undefined4 **)(_UNK_0168b73c + 0x168b5f8));
    func_0x0152e3ec(iVar3,uVar5,**(undefined4 **)(_UNK_0168b740 + 0x168b618),0);
  ...
  uStack_44 = 0;
  iStack_40 = iVar3;
  func_0x02b75870(iVar2,iVar9,uVar10,0,0x112,0,0,0);
  ...
  iVar2 = func_0x024f0540(iVar2,uVar10,**(undefined4 **)(_UNK_0168ccac + 0x168cbc4));
  iVar9 = FUN_0167c750(param_1);
  if (iVar9 == 0) {
    func_0x014388e4();
  }
  ...
  if (iVar9 == 0) {
    ...
    iVar2 = func_0x024f05d4(0,uVar10,**(undefined4 **)(_UNK_0168ccb0 + 0x168cc48));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_0168cc78:
    ...
    iVar2 = func_0x024f05d4(iVar9,uVar10,**(undefined4 **)(_UNK_0168ccb4 + 0x168cc1c));
  }
  unaff_r7 = iVar2 + 1;
