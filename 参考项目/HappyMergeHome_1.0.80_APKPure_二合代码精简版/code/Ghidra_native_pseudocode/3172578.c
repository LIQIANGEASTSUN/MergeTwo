...
/* WARNING: Possible PIC construction at 0x031826f8: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x031826fc) */
/* WARNING: Removing unreachable block (ram,0x03182710) */
/* WARNING: Removing unreachable block (ram,0x03182714) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_03182578(int param_1)

{
  ...
  pcVar11 = (char *)(_UNK_03182728 + 0x318258c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0318272c + 0x31825a0));
    func_0x01438628(*(undefined4 *)(_UNK_03182730 + 0x31825ac));
    func_0x01438628(*(undefined4 *)(_UNK_03182734 + 0x31825b8));
    func_0x01438628(*(undefined4 *)(_UNK_03182738 + 0x31825c4));
    func_0x01438628(*(undefined4 *)(_UNK_0318273c + 0x31825d0));
    func_0x01438628(*(undefined4 *)(_UNK_03182740 + 0x31825dc));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7b9e,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x7b9e,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03182744 + 0x3182640) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03182748 + 0x318265c));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = func_0x036c7bec(iVar3,**(undefined4 **)(_UNK_0318274c + 0x318267c));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar3 + 0x208) != 0) {
    func_0x03b73ab8(*(int *)(iVar3 + 0x208),**(undefined4 **)(_UNK_03182750 + 0x31826ac));
  }
  if (*(int *)(**(int **)(_UNK_03182754 + 0x31826bc) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar12 = *(undefined4 **)(_UNK_03182758 + 0x31826d8);
  ...
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x10,0);
  ...
  if (iVar3 != 0) {
    ...
    puStack_30 = puVar4;
    puStack_2c = puVar12;
    func_0x024f56c0(&uStack_60,0,0x10,0);
    ...
    func_0x01523a2c(&puStack_48,0x10,0);
    iVar10 = *(int *)(iVar3 + 8);
    uVar13 = *(undefined4 *)(iVar3 + 0xc);
    iVar3 = *(int *)(iVar3 + 0x10);
    if (iVar10 == 0) {
  ...
  iVar10 = func_0x046ccb14(iVar3,0x10,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar10 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar1 = (*(code *)*puVar4)(piVar9,0x10,puVar4[1]);
      iVar3 = iStack_40;
    }
    iVar10 = *(int *)(iVar3 + 8);
    iVar3 = iVar10;
