...

{
  ...
  pcVar6 = (char *)(_UNK_017a8458 + 0x17a83c4);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017a845c + 0x17a83d8));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8e86,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8e86,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar7 = **(int **)(_UNK_017a8460 + 0x17a844c);
