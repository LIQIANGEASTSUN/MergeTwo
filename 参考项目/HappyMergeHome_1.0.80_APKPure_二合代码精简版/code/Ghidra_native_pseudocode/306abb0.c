...
void FUN_0307abb0(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_0307ac68 + 0x307abc4);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0307ac6c + 0x307abd8));
    *pcVar8 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x754d,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x754d,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x0308c734(param_1);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_0307ac70 + 0x307ac40) + 0x74) == 0) {
    func_0x014387a4();
  }
