...

{
  ...
  pcVar9 = (char *)(_UNK_017d7ce8 + 0x17d7b74);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017d7cec + 0x17d7b88));
    func_0x01438628(*(undefined4 *)(_UNK_017d7cf0 + 0x17d7b94));
    func_0x01438628(*(undefined4 *)(_UNK_017d7cf4 + 0x17d7ba0));
    func_0x01438628(*(undefined4 *)(_UNK_017d7cf8 + 0x17d7bac));
    func_0x01438628(*(undefined4 *)(_UNK_017d7cfc + 0x17d7bb8));
    func_0x01438628(*(undefined4 *)(_UNK_017d7d00 + 0x17d7bc4));
    *pcVar9 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8fa5,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8fa5,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_017d7d04 + 0x17d7c28) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_017d7d08 + 0x17d7c44));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar1 = func_0x036c7bec(iVar1,**(undefined4 **)(_UNK_017d7d0c + 0x17d7c64));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar1 + 0x20c) != 0) {
    func_0x024f04d0(*(int *)(iVar1 + 0x20c),**(undefined4 **)(_UNK_017d7d10 + 0x17d7c94));
  }
  if (*(int *)(**(int **)(_UNK_017d7d14 + 0x17d7ca4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_017d7d18 + 0x17d7cc0));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  pcVar9 = (char *)(_UNK_02be82b0 + 0x2be8170);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x12,0);
  ...
  if (iVar10 != 0) {
    ...
    uStack_38 = 0;
    uStack_28 = 0;
    func_0x024f56c0(&uStack_50,0,0x12,0);
    uStack_38 = uStack_50;
    iStack_34 = uStack_4c;
    uStack_30 = uStack_48;
    uStack_2c = iStack_44;
    ...
    func_0x01523a2c(&uStack_38,0x12,0);
    iVar11 = *(int *)(iVar10 + 8);
  ...
  iVar1 = func_0x046ccb14(uVar3,0x12,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar1 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar2 = (*(code *)*puVar4)(piVar8,0x12,puVar4[1]);
      uVar3 = uStack_30;
    }
    iVar10 = *(int *)(uVar3 + 8);
    iVar1 = iVar10;
