...
int FUN_03237fb0(undefined4 param_1)

{
  ...
  iVar3 = func_0x02953fd4(0x7f8f,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x7f8f,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = FUN_03235a08(param_1);
  if (iVar3 == 0) {
    return 0;
  }
  pcVar6 = (char *)(_UNK_03269f3c + 0x3269dd8);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03269f40 + 0x3269dec));
    func_0x01438628(*(undefined4 *)(_UNK_03269f44 + 0x3269df8));
    func_0x01438628(*(undefined4 *)(_UNK_03269f48 + 0x3269e04));
    func_0x01438628(*(undefined4 *)(_UNK_03269f4c + 0x3269e10));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x16fd,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x16fd,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_03269f50 + 0x3269e64) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03269f54 + 0x3269e80));
  piVar8 = *(int **)(_UNK_03269f58 + 0x3269e94);
  iVar7 = *piVar8;
  if (*(int *)(iVar7 + 0x74) == 0) {
    func_0x014387a4();
    iVar7 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_03269f5c + 0x3269eb4);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar7 + 0x5c) + 0xb00);
  if (iVar4 == 0) {
