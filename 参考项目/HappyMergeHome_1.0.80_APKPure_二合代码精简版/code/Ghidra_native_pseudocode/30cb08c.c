...
uint FUN_030db08c(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_030db12c + 0x30db0a0);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030db130 + 0x30db0b4));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7725,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7725,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_030db134 + 0x30db10c) + 0x74) == 0) {
    func_0x014387a4();
  }
