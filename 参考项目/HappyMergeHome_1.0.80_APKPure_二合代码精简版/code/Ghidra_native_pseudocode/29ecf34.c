...

{
  ...
  pcVar4 = (char *)(_UNK_029fcfdc + 0x29fcf44);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_029fcfe0 + 0x29fcf58));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x2632,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x2632,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    uStack_50 = 0;
    uStack_4c = 0;
    func_0x024f56d0(iVar7,uVar6,&uStack_30,uVar3);
    return;
  }
  if (*(int *)(**(int **)(_UNK_029fcfe4 + 0x29fcfac) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_029fc490();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
  pcVar4 = (char *)(_UNK_029f262c + 0x29f2550);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_029f2630 + 0x29f2564));
    *pcVar4 = '\x01';
  }
  ...
  if (iVar1 == 0) {
    ...
    if (iVar1 == 0) {
      ...
      pcVar4 = (char *)(_UNK_029f2a14 + 0x29f272c);
      if (*pcVar4 == '\0') {
      ...
      if (iVar7 == 0) {
        ...
        uVar3 = (**(code **)(*piVar2 + 0xe0))(piVar2,*(undefined4 *)(*piVar2 + 0xe4));
        if (iVar7 == 0) {
          func_0x014388e4();
        }
        iVar7 = func_0x04753c80(iVar7,uVar3,**(undefined4 **)(_UNK_029f2a34 + 0x29f281c));
        if (iVar7 == 0) {
          ...
          func_0x04753a0c(iVar1,uVar3,piVar2,**(undefined4 **)(_UNK_029f2a48 + 0x29f2940));
          uVar3 = (**(code **)(*piVar2 + 0xe0))(piVar2,*(undefined4 *)(*piVar2 + 0xe4));
          iVar1 = func_0x014e9568(**(undefined4 **)(_UNK_029f2a4c + 0x29f2970),uVar3,0);
          ...
          piVar2 = (int *)**(undefined4 **)(iVar7 + 0x5c);
          ...
          uVar3 = (**(code **)(*piVar2 + 0xe0))(piVar2,*(undefined4 *)(*piVar2 + 0xe4));
          iVar1 = func_0x024eee28(**(undefined4 **)(_UNK_029f2a38 + 0x29f2854),uVar3,
      ...
      func_0x024f56d0(iVar5,uVar3,&uStack_38,uVar6,0,0);
      return;
    }
    return;
  }
  ...
  uStack_50 = 0;
  uStack_4c = 0;
  func_0x024f56d0(iVar7,uVar3,&uStack_30,uVar6);
  return;
}
