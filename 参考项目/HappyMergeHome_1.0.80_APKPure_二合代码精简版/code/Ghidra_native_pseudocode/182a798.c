...

{
  ...
  pcVar3 = (char *)(_UNK_0183a844 + 0x183a7a8);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0183a848 + 0x183a7bc));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x923f,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x923f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0183a84c + 0x183a810) + 0x74) == 0) {
    func_0x014387a4();
  }
