...
undefined4 FUN_01715ef8(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_01715fe4 + 0x1715f0c);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01715fe8 + 0x1715f20));
    func_0x01438628(*(undefined4 *)(_UNK_01715fec + 0x1715f2c));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8b79,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8b79,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01715ff0 + 0x1715f84) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01715ff4 + 0x1715fa0));
  iVar6 = FUN_01714f68(param_1);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
