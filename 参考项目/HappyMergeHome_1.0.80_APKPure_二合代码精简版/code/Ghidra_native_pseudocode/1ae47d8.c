...
void FUN_01af47d8(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar8 = (char *)(_UNK_01af489c + 0x1af47f0);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01af48a0 + 0x1af4804));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xa4f8,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xa4f8,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = FUN_01af45f4(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_01af48a4 + 0x1af4874) + 0x74) == 0) {
    func_0x014387a4();
  }
