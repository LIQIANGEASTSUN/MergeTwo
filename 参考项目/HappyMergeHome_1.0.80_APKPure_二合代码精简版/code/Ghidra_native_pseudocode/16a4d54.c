...
uint FUN_016b4d54(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_016b4e74 + 0x16b4d6c);
  if (*pcVar10 == '\0') {
  ...
  if (iVar1 == 0) {
    ...
    pcVar10 = (char *)(_UNK_016be810 + 0x16be5dc);
    uStack_1c = param_2;
    if (*pcVar10 == '\0') {
    ...
    if (iVar1 == 0) {
      iVar1 = func_0x016b8808(param_1);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_016be830 + 0x16be6b4));
      if (iVar1 == 0) {
        uVar11 = func_0x01524ffc(&uStack_1c,0);
        uVar11 = func_0x024eee28(**(undefined4 **)(_UNK_016be834 + 0x16be718),uVar11,
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_2,**(undefined4 **)(_UNK_016be844 + 0x16be76c));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar1,param_2,**(undefined4 **)(_UNK_016be840 + 0x16be6e8));
        }
        func_0x024f10d4(iVar1,param_2,iVar9 + -1,**(undefined4 **)(_UNK_016be848 + 0x16be790));
        iVar1 = func_0x016b8808(param_1);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x024f05d4(iVar1,param_2,**(undefined4 **)(_UNK_016be84c + 0x16be7c0));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x016b8808(param_1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar9 = **(int **)(_UNK_016be850 + 0x16be800);
