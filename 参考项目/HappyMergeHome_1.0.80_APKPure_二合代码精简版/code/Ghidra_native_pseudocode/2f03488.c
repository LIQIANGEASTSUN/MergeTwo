...
uint FUN_02f13488(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02f13528 + 0x2f1349c);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f1352c + 0x2f134b0));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x6cab,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x6cab,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f13530 + 0x2f13508) + 0x74) == 0) {
    func_0x014387a4();
  }
