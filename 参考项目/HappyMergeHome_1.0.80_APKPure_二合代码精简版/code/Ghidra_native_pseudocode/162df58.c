...
void FUN_0163df58(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_0163e010 + 0x163df6c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0163e014 + 0x163df80));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x85cb,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x85cb,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x0164fad8(param_1);
  iVar7 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_0163e018 + 0x163dfe8) + 0x74) == 0) {
    func_0x014387a4();
  }
