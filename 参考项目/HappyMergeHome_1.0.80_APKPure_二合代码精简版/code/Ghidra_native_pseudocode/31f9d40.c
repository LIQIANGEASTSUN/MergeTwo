...

{
  ...
  pcVar4 = (char *)(_UNK_03209dec + 0x3209d50);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03209df0 + 0x3209d64));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7e80,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7e80,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03209df4 + 0x3209db8) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_03204330();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
