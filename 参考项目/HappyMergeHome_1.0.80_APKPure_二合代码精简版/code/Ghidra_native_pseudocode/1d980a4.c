...
undefined4 FUN_01da80a4(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_01da8190 + 0x1da80b8);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01da8194 + 0x1da80cc));
    func_0x01438628(*(undefined4 *)(_UNK_01da8198 + 0x1da80d8));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x3ef6,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x3ef6,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01da819c + 0x1da8130) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01da81a0 + 0x1da814c));
  iVar6 = FUN_01da7580(param_1);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
