...
undefined4 FUN_02c2bc0c(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2bdcc + 0x2c2bc20);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2bdd0 + 0x2c2bc34));
    func_0x01438628(*(undefined4 *)(_UNK_02c2bdd4 + 0x2c2bc40));
    func_0x01438628(*(undefined4 *)(_UNK_02c2bdd8 + 0x2c2bc4c));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d99,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d99,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2bddc + 0x2c2bd74));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2bde0 + 0x2c2bd90),0);
  if (*(int *)(**(int **)(_UNK_02c2bde4 + 0x2c2bda4) + 0x74) == 0) {
    func_0x014387a4();
  }
