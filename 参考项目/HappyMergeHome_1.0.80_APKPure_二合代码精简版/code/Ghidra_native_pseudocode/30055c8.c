...
void FUN_030155c8(int param_1,undefined4 param_2,int param_3)

{
  ...
  iVar2 = func_0x02953fd4(0x7299,0);
  if (iVar2 == 0) {
    iVar2 = FUN_03009c84(param_1);
    if (((iVar2 != 0) && (iVar2 = FUN_03014ddc(param_1,param_2,param_3), iVar2 == 0)) &&
       (iVar2 = FUN_03014eac(param_1,param_2), iVar2 != 0)) {
      if (param_3 == 0) {
      ...
      iVar2 = func_0x02953fd4(0x2117,0);
      if (iVar2 == 0) {
        iVar2 = FUN_03009c84(param_1);
        if (iVar2 == 0) {
          func_0x014388e4();
      ...
      iVar2 = func_0x029540a4(0x2117,0);
      if (iVar2 == 0) {
        func_0x014388e4();
      }
    ...
    iVar2 = func_0x029540a4(0x7299,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
