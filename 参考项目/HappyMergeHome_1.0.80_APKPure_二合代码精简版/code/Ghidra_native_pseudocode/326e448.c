...
uint FUN_0327e448(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_0327e4e8 + 0x327e45c);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0327e4ec + 0x327e470));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8160,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8160,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0327e4f0 + 0x327e4c8) + 0x74) == 0) {
    func_0x014387a4();
  }
