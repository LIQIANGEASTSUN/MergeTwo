...

{
  ...
  pcVar3 = (char *)(_UNK_01909810 + 0x1909720);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01909814 + 0x1909734));
    func_0x01438628(*(undefined4 *)(_UNK_01909818 + 0x1909740));
    func_0x01438628(*(undefined4 *)(_UNK_0190981c + 0x190974c));
    func_0x01438628(*(undefined4 *)(_UNK_01909820 + 0x1909758));
    *pcVar3 = '\x01';
  }
  iVar4 = *(int *)(param_1 + 8);
  ...
  iVar2 = *(int *)(iVar2 + 0xc);
  if (*(int *)(**(int **)(_UNK_01909824 + 0x1909790) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x0152ae0c(0,iVar2 + -6,0);
  if (iVar4 == iVar2) {
    if (*(int *)(**(int **)(_UNK_01909828 + 0x19097c8) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0190982c + 0x19097e4));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
