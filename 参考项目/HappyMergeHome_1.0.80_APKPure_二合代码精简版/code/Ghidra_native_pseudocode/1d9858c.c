...
uint FUN_01da858c(int param_1,int param_2)

{
  ...
  pcVar10 = (char *)(_UNK_01da8654 + 0x1da85a4);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01da8658 + 0x1da85b8));
    *pcVar10 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x1002,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_01da865c + 0x1da8614) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x02c35d10(0x2e,0);
    if (iVar3 == 0) {
      return 0;
    }
    ...
    iVar3 = func_0x029540a4(0x1002,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
