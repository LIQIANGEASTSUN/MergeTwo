...
undefined4 FUN_029a6fa8(int param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_029a7094 + 0x29a6fc0);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_029a7098 + 0x29a6fd4));
    func_0x01438628(*(undefined4 *)(_UNK_029a709c + 0x29a6fe0));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x489,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x489,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x046ccb14(iVar1,param_2,**(undefined4 **)(_UNK_029a70a0 + 0x29a7050));
  if (iVar1 != 0) {
    iVar1 = *(int *)(param_1 + 0x38);
    if (iVar1 == 0) {
      func_0x014388e4();
