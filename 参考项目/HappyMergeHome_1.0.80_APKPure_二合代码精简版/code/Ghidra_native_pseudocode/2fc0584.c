...
undefined4 FUN_02fd0584(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_02fd0634 + 0x2fd059c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fd0638 + 0x2fd05b0));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x156f,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x156f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x02fd14dc(param_1);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar4 = **(int **)(_UNK_02fd063c + 0x2fd0628);
