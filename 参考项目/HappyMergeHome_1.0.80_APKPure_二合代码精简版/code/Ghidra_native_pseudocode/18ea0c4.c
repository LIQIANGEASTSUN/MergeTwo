...

{
  ...
  pcVar3 = (char *)(_UNK_018fa170 + 0x18fa0d4);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018fa174 + 0x18fa0e8));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9678,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9678,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_018fa178 + 0x18fa13c) + 0x74) == 0) {
    func_0x014387a4();
  }
