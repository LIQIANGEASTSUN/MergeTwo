...
int FUN_03087900(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_03087bf8 + 0x3087914);
  if (*pcVar6 == '\0') {
  ...
  if (0 < *(int *)(iVar1 + 0x74)) {
    ...
    if (iVar5 <= *(int *)(iVar1 + 0xc)) {
      ...
      uVar7 = func_0x04cd26d0(iVar5,iVar1 + -1,**(undefined4 **)(_UNK_03087c20 + 0x3087aa0));
    }
  }
  ...
  if (iVar1 == 0) {
    ...
    if (iVar5 != 0) {
      ...
      pcVar6 = (char *)(_UNK_030ab0a0 + 0x30aad44);
      if (*pcVar6 == '\0') {
        func_0x01438628(*(undefined4 *)(_UNK_030ab0a4 + 0x30aad58),uVar7,iVar1,0);
      ...
      if (iVar2 == 0) {
        ...
        *(undefined1 *)(iVar5 + 0xb0) = 1;
        ...
        iVar1 = func_0x046ccb14(iVar1,uVar7,**(undefined4 **)(_UNK_030ab0e0 + 0x30aaec0));
        if (iVar1 == 0) {
          uStack_1c = uVar7;
          uVar7 = func_0x014387ac(**(undefined4 **)(_UNK_030ab0e4 + 0x30aaf68),&uStack_1c);
          ...
          uVar4 = func_0x046cc810(iVar1,uVar7,**(undefined4 **)(_UNK_030ab0f0 + 0x30aaef0));
          ...
          if (iVar1 == 0) {
            ...
            uVar7 = func_0x014388d4(**(undefined4 **)(_UNK_030ab104 + 0x30ab004));
            func_0x05096384(uVar7,iVar2,**(undefined4 **)(_UNK_030ab108 + 0x30ab028),0);
            ...
            iVar5 = func_0x02aee9b4(uVar4,**(undefined4 **)(_UNK_030ab114 + 0x30ab068),
                                    **(undefined4 **)(_UNK_030ab110 + 0x30ab05c),uVar7);
            if (iVar1 == 0) {
              func_0x014388e4();
            }
          ...
          uStack_20 = uVar7;
          uVar7 = func_0x014387ac(**(undefined4 **)(_UNK_030ab0f8 + 0x30aaf40),&uStack_20);
