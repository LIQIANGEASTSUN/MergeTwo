...
void FUN_01710f44(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_01710ffc + 0x1710f58);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01711000 + 0x1710f6c));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8b3b,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8b3b,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x01724610(param_1);
  iVar7 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_01711004 + 0x1710fd4) + 0x74) == 0) {
    func_0x014387a4();
  }
