...
undefined4 FUN_02c293d4(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c295c4 + 0x2c293e8);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c295c8 + 0x2c293fc));
    func_0x01438628(*(undefined4 *)(_UNK_02c295cc + 0x2c29408));
    func_0x01438628(*(undefined4 *)(_UNK_02c295d0 + 0x2c29414));
    func_0x01438628(*(undefined4 *)(_UNK_02c295d4 + 0x2c29420));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d71,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d71,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02c295d8 + 0x2c29478) + 0x74) == 0) {
    func_0x014387a4();
  }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c295dc + 0x2c29570));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c295e0 + 0x2c2958c),0);
  if (*(int *)(**(int **)(_UNK_02c295e4 + 0x2c295a0) + 0x74) == 0) {
    func_0x014387a4();
  }
