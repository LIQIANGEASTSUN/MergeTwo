...

{
  ...
  pcVar7 = (char *)(_UNK_03048234 + 0x3048060);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03048238 + 0x3048074));
    func_0x01438628(*(undefined4 *)(_UNK_0304823c + 0x3048080));
    func_0x01438628(*(undefined4 *)(_UNK_03048240 + 0x304808c));
    func_0x01438628(*(undefined4 *)(_UNK_03048244 + 0x3048098));
    *pcVar7 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x741c,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x741c,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03048248 + 0x3048170) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x04e4a028(**(undefined4 **)(_UNK_0304824c + 0x304818c));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  ...
  if ((iVar4 != 0) && (0 < *(int *)(iVar4 + 0xc))) {
    ...
    iVar4 = func_0x04cfd760(iVar4,0,**(undefined4 **)(_UNK_03048250 + 0x30481e0));
    if (iVar4 == 0) {
      func_0x014388e4();
    }
