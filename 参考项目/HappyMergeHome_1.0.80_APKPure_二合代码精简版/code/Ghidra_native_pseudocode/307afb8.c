...
void FUN_0308afb8(int param_1,undefined4 param_2,int param_3)

{
  ...
  iVar3 = func_0x02953fd4(0x75b9,0);
  if (iVar3 == 0) {
    iVar3 = FUN_0307f35c(param_1);
    if (((iVar3 != 0) && (iVar3 = FUN_0308ab74(param_1,param_2,param_3), iVar3 == 0)) &&
       (iVar3 = FUN_0308ac44(param_1,param_2), iVar3 != 0)) {
      if (param_3 == 0) {
      ...
      iVar3 = func_0x02953fd4(0x20b3,0);
      if (iVar3 != 0) {
        iVar3 = func_0x029540a4(0x20b3,0);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
...
LAB_0308a9c4:
            ...
            if (*(char *)(iVar2 + 0xd) == '\0') goto LAB_0308a9c4;
            iVar2 = FUN_0307f35c(param_1);
            if (iVar2 == 0) {
              func_0x014388e4();
            }
    ...
    iVar3 = func_0x029540a4(0x75b9,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
