...

{
  ...
  pcVar7 = (char *)(_UNK_0303d2a0 + 0x303d154);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0303d2a4 + 0x303d168));
    func_0x01438628(*(undefined4 *)(_UNK_0303d2a8 + 0x303d174));
    func_0x01438628(*(undefined4 *)(_UNK_0303d2ac + 0x303d180));
    *pcVar7 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x2b22,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x2b22,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0303d2b0 + 0x303d1d8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_0303d2b4 + 0x303d1f4));
  uVar9 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar10 = **(int **)(_UNK_0303d2b8 + 0x303d220);
