...
uint FUN_032d4058(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_032d4140 + 0x32d4078);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032d4144 + 0x32d408c));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x83ab,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x83ab,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_032d4148 + 0x32d4108) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_032d2dac();
  if (iVar2 == 0) {
  ...
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032d3934 + 0x32d383c));
    func_0x01438628(*(undefined4 *)(_UNK_032d3938 + 0x32d3848));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x839f,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_032d393c + 0x32d38a4) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_032d3940 + 0x32d38c0));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    iVar1 = func_0x02953fd4(0x8373,0);
    if (iVar1 == 0) {
      iVar1 = func_0x032d62b4(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x046c26fc(iVar1,param_3,**(undefined4 **)(_UNK_032dc76c + 0x32dc5f0));
      if (iVar1 == 0) {
        ...
        if (iVar1 == 0) {
          ...
          iVar9 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_032dc77c + 0x32dc624));
        }
        func_0x03b70fe4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_032dc784 + 0x32dc6cc));
        iVar1 = func_0x032d62b4(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_032dc788 + 0x32dc6fc));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x032d62b4(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_032dc78c + 0x32dc73c);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x8373,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x839f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
