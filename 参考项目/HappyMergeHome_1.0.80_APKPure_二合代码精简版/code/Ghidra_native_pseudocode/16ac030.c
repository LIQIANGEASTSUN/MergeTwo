...

{
  ...
  pcVar6 = (char *)(_UNK_016bc0d8 + 0x16bc044);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016bc0dc + 0x16bc058));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8927,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8927,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar7 = **(int **)(_UNK_016bc0e0 + 0x16bc0cc);
