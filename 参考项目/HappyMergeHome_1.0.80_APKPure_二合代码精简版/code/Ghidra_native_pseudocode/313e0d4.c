...
int FUN_0314e0d4(undefined4 param_1,int param_2)

{
  ...
  pcVar7 = (char *)(_UNK_0314e21c + 0x314e0ec);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0314e220 + 0x314e100));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x79f2,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x79f2,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(iVar1 + 0xc) == 8) {
    if (*(int *)(**(int **)(_UNK_0314e224 + 0x314e18c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = FUN_03143658();
    if (iVar1 != 0) {
      func_0x0316c1d4(iVar1,0);
    }
  }
  iVar1 = FUN_031457fc(param_1);
  if (iVar1 == 0) {
  ...
  iVar1 = FUN_0314d540(param_1);
  if (iVar5 < iVar1) {
    iVar1 = FUN_031457fc(param_1);
    uVar6 = FUN_0314d540(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    func_0x026f151c(iVar1,uVar6,0);
    pcVar7 = (char *)(_UNK_0314e08c + 0x314dda8);
    uStack_18 = unaff_r4;
    if (*pcVar7 == '\0') {
    ...
    if (0 < *(int *)(iVar1 + 0x74)) {
      ...
      if (iVar5 <= *(int *)(iVar1 + 0xc)) {
        ...
        uVar6 = func_0x04cd26d0(iVar5,iVar1 + -1,**(undefined4 **)(_UNK_0314e0b4 + 0x314df34));
      }
    }
    ...
    if (iVar1 == 0) {
      ...
      if (iVar5 != 0) {
        ...
        pcVar7 = (char *)(_UNK_031701dc + 0x316fe80);
        if (*pcVar7 == '\0') {
          func_0x01438628(*(undefined4 *)(_UNK_031701e0 + 0x316fe94),uVar6,iVar1,0);
        ...
        if (iVar2 == 0) {
          ...
          *(undefined1 *)(iVar5 + 0xb0) = 1;
          ...
          iVar1 = func_0x046ccb14(iVar1,uVar6,**(undefined4 **)(_UNK_0317021c + 0x316fffc));
          if (iVar1 == 0) {
            uStack_1c = uVar6;
            uVar6 = func_0x014387ac(**(undefined4 **)(_UNK_03170220 + 0x31700a4),&uStack_1c);
            ...
            uVar4 = func_0x046cc810(iVar1,uVar6,**(undefined4 **)(_UNK_0317022c + 0x317002c));
            ...
            if (iVar1 == 0) {
              ...
              uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_03170240 + 0x3170140));
              func_0x05096384(uVar6,iVar2,**(undefined4 **)(_UNK_03170244 + 0x3170164),0);
              ...
              iVar5 = func_0x02aee9b4(uVar4,**(undefined4 **)(_UNK_03170250 + 0x31701a4),
                                      **(undefined4 **)(_UNK_0317024c + 0x3170198),uVar6);
              if (iVar1 == 0) {
                func_0x014388e4();
              }
            ...
            uStack_20 = uVar6;
            uVar6 = func_0x014387ac(**(undefined4 **)(_UNK_03170234 + 0x317007c),&uStack_20);
