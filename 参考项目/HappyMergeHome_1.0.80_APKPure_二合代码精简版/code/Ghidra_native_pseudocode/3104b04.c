...
int FUN_03114b04(undefined4 param_1,int param_2)

{
  ...
  pcVar5 = (char *)(_UNK_03114f1c + 0x3114b20);
  if (*pcVar5 == '\0') {
  ...
  iVar2 = func_0x02953fd4(0x206c,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x206c,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  puVar10 = *(undefined4 **)(_UNK_03114f48 + 0x3114c40);
  iVar2 = func_0x04cd2d7c(iVar2,param_2,*puVar10);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_03114f4c + 0x3114c60) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_03114f50 + 0x3114c7c));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iVar2 = *(int *)(iVar2 + 0x2c);
    iVar7 = 0;
    puVar11 = *(undefined4 **)(_UNK_03114f54 + 0x3114ca4);
    do {
      if (iVar2 == 0) {
        func_0x014388e4();
      }
    ...
    while( true ) {
      ...
      if (*(int *)(iVar3 + 0x24) <= param_2) {
        ...
        if (iVar3 == 0) {
          ...
          func_0x03b75ba0(iVar3,uVar9,**(undefined4 **)(_UNK_03114f58 + 0x3114e1c));
        }
      }
      iVar7 = iVar7 + 1;
    }
    ...
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_03114f60 + 0x3114e5c));
    ...
    iVar6 = **(int **)(_UNK_03114f68 + 0x3114e90);
