...
int FUN_02fd4398(int *param_1,int param_2,int param_3)

{
  ...
  pcVar10 = (char *)(_UNK_02fd456c + 0x2fd43b8);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fd4570 + 0x2fd43cc));
    func_0x01438628(*(undefined4 *)(_UNK_02fd4574 + 0x2fd43d8));
    func_0x01438628(*(undefined4 *)(_UNK_02fd4578 + 0x2fd43e4));
    *pcVar10 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x70d5,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x70d5,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_02fd457c + 0x2fd444c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_02fd4580 + 0x2fd4468));
  uVar6 = (**(code **)(*param_1 + 0x1a0))(param_1,*(undefined4 *)(*param_1 + 0x1a4));
  piVar7 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_02fd4584 + 0x2fd4498),2);
  if (piVar7 == (int *)0x0) {
    func_0x014388e4();
  }
  if ((param_2 != 0) &&
