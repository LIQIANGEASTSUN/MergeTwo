...
undefined4 FUN_0318db5c(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_0318dc98 + 0x318db74);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0318dc9c + 0x318db88));
    func_0x01438628(*(undefined4 *)(_UNK_0318dca0 + 0x318db94));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7bc7,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7bc7,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x046c26fc(iVar1,param_2,**(undefined4 **)(_UNK_0318dca4 + 0x318dc2c));
  if (iVar1 != 0) {
    iVar1 = FUN_0317e7f4(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_0318dca8 + 0x318dc84);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
