...
void FUN_02bae118(undefined4 param_1)

{
  ...
  iVar3 = func_0x02953fd4(0x5cc7,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x5cc7,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar5 = *(int *)(iVar3 + 0x38) + 1;
  pcVar6 = (char *)(_UNK_026f63c4 + 0x26f633c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_026f63c8 + 0x26f6350),iVar5,0);
    func_0x01438628(*(undefined4 *)(_UNK_026f63cc + 0x26f635c));
    *pcVar6 = '\x01';
  }
  if (*(int *)(iVar3 + 0x38) == iVar5) {
    return;
  }
  ...
  *(int *)(iVar3 + 0x38) = iVar5;
  ...
  iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_026f63d4 + 0x26f639c));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
