...

{
  ...
  pcVar3 = (char *)(_UNK_018c36f8 + 0x18c365c);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018c36fc + 0x18c3670));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x952b,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x952b,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_018c3700 + 0x18c36c4) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_018bd08c();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
