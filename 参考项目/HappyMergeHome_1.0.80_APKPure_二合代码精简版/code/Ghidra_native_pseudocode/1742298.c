...
/* WARNING: Possible PIC construction at 0x01752418: Changing call to branch */
/* WARNING: Possible PIC construction at 0x01752440: Changing call to branch */
/* WARNING: Possible PIC construction at 0x01752468: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x01752444) */
/* WARNING: Removing unreachable block (ram,0x01752458) */
/* WARNING: Removing unreachable block (ram,0x0175245c) */
/* WARNING: Removing unreachable block (ram,0x0175241c) */
/* WARNING: Removing unreachable block (ram,0x01752430) */
/* WARNING: Removing unreachable block (ram,0x01752434) */
/* WARNING: Removing unreachable block (ram,0x0175246c) */
/* WARNING: Removing unreachable block (ram,0x01752480) */
/* WARNING: Removing unreachable block (ram,0x01752484) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_01752298(int param_1)

{
  ...
  pcVar10 = (char *)(_UNK_01752498 + 0x17522ac);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0175249c + 0x17522c0));
    func_0x01438628(*(undefined4 *)(_UNK_017524a0 + 0x17522cc));
    func_0x01438628(*(undefined4 *)(_UNK_017524a4 + 0x17522d8));
    func_0x01438628(*(undefined4 *)(_UNK_017524a8 + 0x17522e4));
    func_0x01438628(*(undefined4 *)(_UNK_017524ac + 0x17522f0));
    func_0x01438628(*(undefined4 *)(_UNK_017524b0 + 0x17522fc));
    *pcVar10 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8d08,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8d08,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_017524b4 + 0x1752360) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_017524b8 + 0x175237c));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar1 = func_0x036c7bec(iVar1,**(undefined4 **)(_UNK_017524bc + 0x175239c));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar1 + 0x394) != 0) {
    func_0x024f04d0(*(int *)(iVar1 + 0x394),**(undefined4 **)(_UNK_017524c0 + 0x17523cc));
  }
  if (*(int *)(**(int **)(_UNK_017524c4 + 0x17523dc) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar11 = *(undefined4 **)(_UNK_017524c8 + 0x17523f8);
  ...
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x4b,0);
  ...
  if (iVar1 != 0) {
    ...
    puStack_30 = puVar2;
    puStack_2c = puVar11;
    func_0x024f56c0(&uStack_60,0,0x4b,0);
    ...
    func_0x01523a2c(&puStack_48,0x4b,0);
    iVar12 = *(int *)(iVar1 + 8);
    uVar13 = *(undefined4 *)(iVar1 + 0xc);
    iVar1 = *(int *)(iVar1 + 0x10);
    if (iVar12 == 0) {
  ...
  iVar12 = func_0x046ccb14(iVar1,0x4b,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar12 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar3 = (*(code *)*puVar2)(piVar9,0x4b,puVar2[1]);
      iVar1 = iStack_40;
    }
    iVar12 = *(int *)(iVar1 + 8);
    iVar1 = iVar12;
