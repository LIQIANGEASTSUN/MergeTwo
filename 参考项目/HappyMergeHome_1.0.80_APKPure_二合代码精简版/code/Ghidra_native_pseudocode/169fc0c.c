...

{
  ...
  pcVar7 = (char *)(_UNK_016afd6c + 0x16afc20);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016afd70 + 0x16afc34));
    func_0x01438628(*(undefined4 *)(_UNK_016afd74 + 0x16afc40));
    func_0x01438628(*(undefined4 *)(_UNK_016afd78 + 0x16afc4c));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x2ada,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x2ada,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_016afd7c + 0x16afca4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_016afd80 + 0x16afcc0));
  uVar10 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar9 = **(int **)(_UNK_016afd84 + 0x16afcec);
