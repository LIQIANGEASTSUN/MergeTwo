...
undefined4 FUN_0315122c(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_03151308 + 0x3151240);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0315130c + 0x3151254));
    func_0x01438628(*(undefined4 *)(_UNK_03151310 + 0x3151260));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7a35,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_03151314 + 0x31512b8) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03151318 + 0x31512d4));
    uVar7 = func_0x0315131c(param_1);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = func_0x029540a4(0x7a35,0);
  if (iVar3 == 0) {
    func_0x014388e4();
  }
