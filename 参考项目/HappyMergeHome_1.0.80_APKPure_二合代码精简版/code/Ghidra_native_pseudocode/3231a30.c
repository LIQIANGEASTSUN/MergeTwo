...

{
  ...
  pcVar7 = (char *)(_UNK_03241ad8 + 0x3241a44);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03241adc + 0x3241a58));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7fe5,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7fe5,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar6 = **(int **)(_UNK_03241ae0 + 0x3241acc);
