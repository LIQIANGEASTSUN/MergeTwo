...
uint FUN_016ee1b4(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_016ee2d4 + 0x16ee1cc);
  if (*pcVar10 == '\0') {
  ...
  if (iVar1 == 0) {
    ...
    pcVar10 = (char *)(_UNK_016f5bc4 + 0x16f5990);
    uStack_1c = param_2;
    if (*pcVar10 == '\0') {
    ...
    if (iVar1 == 0) {
      iVar1 = func_0x016f0aac(param_1);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_016f5be4 + 0x16f5a68));
      if (iVar1 == 0) {
        uVar11 = func_0x01524ffc(&uStack_1c,0);
        uVar11 = func_0x024eee28(**(undefined4 **)(_UNK_016f5be8 + 0x16f5acc),uVar11,
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_2,**(undefined4 **)(_UNK_016f5bf8 + 0x16f5b20));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar1,param_2,**(undefined4 **)(_UNK_016f5bf4 + 0x16f5a9c));
        }
        func_0x024f10d4(iVar1,param_2,iVar9 + -1,**(undefined4 **)(_UNK_016f5bfc + 0x16f5b44));
        iVar1 = func_0x016f0aac(param_1);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x024f05d4(iVar1,param_2,**(undefined4 **)(_UNK_016f5c00 + 0x16f5b74));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x016f0aac(param_1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar9 = **(int **)(_UNK_016f5c04 + 0x16f5bb4);
