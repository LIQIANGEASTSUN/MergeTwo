...

{
  ...
  pcVar6 = (char *)(_UNK_016f41cc + 0x16f4138);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016f41d0 + 0x16f414c));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8aa7,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8aa7,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar7 = **(int **)(_UNK_016f41d4 + 0x16f41c0);
