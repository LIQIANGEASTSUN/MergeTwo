...
uint FUN_0167bfac(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_0167c094 + 0x167bfcc);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0167c098 + 0x167bfe0));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x878a,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x878a,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0167c09c + 0x167c05c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_01676670();
  if (iVar2 == 0) {
  ...
  if (iVar1 == 0) {
    ...
    if (iVar1 == 0) {
      iVar1 = func_0x0167e370(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x024f0540(iVar1,param_3,**(undefined4 **)(_UNK_01684284 + 0x1684108));
      if (iVar1 == 0) {
        ...
        if (iVar1 == 0) {
          ...
          iVar9 = func_0x024f05d4(iVar1,param_3,**(undefined4 **)(_UNK_01684294 + 0x168413c));
        }
        func_0x024f10d4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_0168429c + 0x16841e4));
        iVar1 = func_0x0167e370(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x024f05d4(iVar1,param_3,**(undefined4 **)(_UNK_016842a0 + 0x1684214));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x0167e370(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_016842a4 + 0x1684254);
