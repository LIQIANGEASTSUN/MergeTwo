...
uint FUN_01927ef0(int param_1,int param_2)

{
  ...
  pcVar10 = (char *)(_UNK_01927fb8 + 0x1927f08);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01927fbc + 0x1927f1c));
    *pcVar10 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x16a8,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_01927fc0 + 0x1927f78) + 0x74) == 0) {
      func_0x014387a4();
    }
    ...
    iVar3 = func_0x029540a4(0x16a8,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
