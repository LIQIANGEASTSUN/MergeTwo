...
undefined4 FUN_0310cab0(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_0310cb60 + 0x310cac8);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0310cb64 + 0x310cadc));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xf19,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xf19,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x0310da08(param_1);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar4 = **(int **)(_UNK_0310cb68 + 0x310cb54);
