...
undefined4 FUN_02f968d8(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_02f96988 + 0x2f968f0);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f9698c + 0x2f96904));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xf30,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xf30,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x02f97830(param_1);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar4 = **(int **)(_UNK_02f96990 + 0x2f9697c);
