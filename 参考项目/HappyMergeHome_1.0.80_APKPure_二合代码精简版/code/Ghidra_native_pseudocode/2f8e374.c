...
uint FUN_02f9e374(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02f9e414 + 0x2f9e388);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f9e418 + 0x2f9e39c));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x6f8b,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x6f8b,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f9e41c + 0x2f9e3f4) + 0x74) == 0) {
    func_0x014387a4();
  }
