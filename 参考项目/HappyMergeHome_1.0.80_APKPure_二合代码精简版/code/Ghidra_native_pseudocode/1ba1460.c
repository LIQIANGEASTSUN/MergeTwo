...
void FUN_01bb1460(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_01bb1518 + 0x1bb1474);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01bb151c + 0x1bb1488));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x3657,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x3657,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x01bb1524(param_1);
  iVar7 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_01bb1520 + 0x1bb14f0) + 0x74) == 0) {
    func_0x014387a4();
  }
