...
uint FUN_03012068(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_03012108 + 0x301207c);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0301210c + 0x3012090));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x728c,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x728c,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03012110 + 0x30120e8) + 0x74) == 0) {
    func_0x014387a4();
  }
