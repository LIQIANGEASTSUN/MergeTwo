...
void FUN_032375ec(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_032376b0 + 0x3237604);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032376b4 + 0x3237618));
    *pcVar10 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x7f88,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x7f88,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x0324988c(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_032376b8 + 0x3237688) + 0x74) == 0) {
    func_0x014387a4();
  }
