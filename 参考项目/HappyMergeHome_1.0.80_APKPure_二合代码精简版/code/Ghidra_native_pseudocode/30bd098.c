...

{
  ...
  pcVar7 = (char *)(_UNK_030cd1f8 + 0x30cd0ac);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030cd1fc + 0x30cd0c0));
    func_0x01438628(*(undefined4 *)(_UNK_030cd200 + 0x30cd0cc));
    func_0x01438628(*(undefined4 *)(_UNK_030cd204 + 0x30cd0d8));
    *pcVar7 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x2bb1,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x2bb1,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_030cd208 + 0x30cd130) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_030cd20c + 0x30cd14c));
  uVar9 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar10 = **(int **)(_UNK_030cd210 + 0x30cd178);
