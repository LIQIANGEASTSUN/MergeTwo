...
int FUN_01749f80(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0x8cb4,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8cb4,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  pcVar6 = (char *)(_UNK_01797100 + 0x1796f9c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01797104 + 0x1796fb0));
    func_0x01438628(*(undefined4 *)(_UNK_01797108 + 0x1796fbc));
    func_0x01438628(*(undefined4 *)(_UNK_0179710c + 0x1796fc8));
    func_0x01438628(*(undefined4 *)(_UNK_01797110 + 0x1796fd4));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x15ef,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x15ef,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_01797114 + 0x1797028) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01797118 + 0x1797044));
  piVar7 = *(int **)(_UNK_0179711c + 0x1797058);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_01797120 + 0x1797078);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0xa10);
  if (iVar2 == 0) {
