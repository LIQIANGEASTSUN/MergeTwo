...
undefined4 FUN_01757058(undefined4 param_1,int param_2)

{
  ...
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01757818 + 0x1757088));
  ...
  if (iVar1 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      *piVar14 = iVar3;
      ...
      iVar3 = FUN_0174f724(param_1);
      uVar2 = *(undefined4 *)(param_2 + 8);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      func_0x024f064c(iVar3,uVar2,&iStack_28,**(undefined4 **)(_UNK_01757894 + 0x1757344));
      iVar3 = iStack_28;
      if (iStack_28 == 0) {
        func_0x014388e4();
      }
      ...
      iVar3 = func_0x014388d4(**(undefined4 **)(_UNK_017578a4 + 0x17574c8));
      func_0x024f1124(iVar3,**(undefined4 **)(_UNK_017578a8 + 0x17574dc));
      ...
      *piVar7 = iVar3;
      ...
      if (0 < *(int *)(iVar3 + 0xc)) {
        ...
        iVar3 = FUN_0174c20c();
        if (iVar3 != 0) {
          func_0x0177c424(iVar3,0);
        }
        if (*(int *)(**(int **)(_UNK_017578b0 + 0x1757550) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_017578b4 + 0x1757570));
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        ...
        while( true ) {
          ...
          func_0x020257a4(iVar10,0x322,uVar2,uVar4,0,0,0);
          iVar3 = iVar3 + 1;
        }
        if (*(int *)(**(int **)(_UNK_017578c0 + 0x175770c) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar3 = func_0x014e96a8(**(undefined4 **)(_UNK_017578c4 + 0x1757728));
        iVar9 = *piVar14;
        if (*(int *)(**(int **)(_UNK_017578c8 + 0x175773c) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar10 = func_0x014e9518(**(undefined4 **)(_UNK_017578cc + 0x175775c));
        if (iVar10 == 0) {
          func_0x014388e4();
        }
        ...
        func_0x02b75870(iVar3,iVar9,uVar4,1,0x10d,0,0,0,0,0,0,0,uVar2,0,0);
        iVar1 = *piVar7;
        if (iVar1 == 0) {
          func_0x014388e4();
        }
