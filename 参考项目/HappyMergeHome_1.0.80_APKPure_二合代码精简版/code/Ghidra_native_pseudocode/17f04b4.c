...
uint FUN_018004b4(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_0180059c + 0x18004d4);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018005a0 + 0x18004e8));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x90b5,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x90b5,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_018005a4 + 0x1800564) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_017faff8();
  if (iVar1 == 0) {
  ...
  pcVar11 = (char *)(_UNK_018006c8 + 0x18005c0);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018006cc + 0x18005d4));
    func_0x01438628(*(undefined4 *)(_UNK_018006d0 + 0x18005e0));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x90b6,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_018006d4 + 0x180063c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_018006d8 + 0x1800658));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_01808f6c + 0x1808d38);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_01808f70 + 0x1808d4c));
      func_0x01438628(*(undefined4 *)(_UNK_01808f74 + 0x1808d58));
      func_0x01438628(*(undefined4 *)(_UNK_01808f78 + 0x1808d64));
      func_0x01438628(*(undefined4 *)(_UNK_01808f7c + 0x1808d70));
      func_0x01438628(*(undefined4 *)(_UNK_01808f80 + 0x1808d7c));
      func_0x01438628(*(undefined4 *)(_UNK_01808f84 + 0x1808d88));
      func_0x01438628(*(undefined4 *)(_UNK_01808f88 + 0x1808d94));
      *pcVar11 = '\x01';
    }
    iVar3 = func_0x02953fd4(0x9095,0);
    if (iVar3 == 0) {
      iVar3 = func_0x01802ff8(iVar1);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x024f0540(iVar3,param_3,**(undefined4 **)(_UNK_01808f8c + 0x1808e10));
      if (iVar3 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x024eee28(**(undefined4 **)(_UNK_01808f90 + 0x1808e74),uVar10,
                                 **(undefined4 **)(_UNK_01808f94 + 0x1808e80),0);
        if (*(int *)(**(int **)(_UNK_01808f98 + 0x1808e94) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar3 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_3,**(undefined4 **)(_UNK_01808fa0 + 0x1808ec8));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar3,param_3,**(undefined4 **)(_UNK_01808f9c + 0x1808e44));
        }
        func_0x024f10d4(iVar3,param_3,iVar9 + -1,**(undefined4 **)(_UNK_01808fa4 + 0x1808eec));
        iVar3 = func_0x01802ff8(iVar1);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x024f05d4(iVar3,param_3,**(undefined4 **)(_UNK_01808fa8 + 0x1808f1c));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x01802ff8(iVar1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar3 = **(int **)(_UNK_01808fac + 0x1808f5c);
...
LAB_046c3e4c:
    ...
    iVar3 = func_0x029540a4(0x9095,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar3 = func_0x029540a4(0x90b6,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
