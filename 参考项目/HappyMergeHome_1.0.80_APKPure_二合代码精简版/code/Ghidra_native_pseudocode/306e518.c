...
uint FUN_0307e518(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_0307e600 + 0x307e538);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0307e604 + 0x307e54c));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x758d,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x758d,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0307e608 + 0x307e5c8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_03078444();
  if (iVar2 == 0) {
