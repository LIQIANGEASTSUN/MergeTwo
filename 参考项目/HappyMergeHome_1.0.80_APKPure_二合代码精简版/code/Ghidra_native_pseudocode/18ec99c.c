...

{
  ...
  pcVar9 = (char *)(_UNK_018fcb24 + 0x18fc9b0);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018fcb28 + 0x18fc9c4));
    func_0x01438628(*(undefined4 *)(_UNK_018fcb2c + 0x18fc9d0));
    func_0x01438628(*(undefined4 *)(_UNK_018fcb30 + 0x18fc9dc));
    func_0x01438628(*(undefined4 *)(_UNK_018fcb34 + 0x18fc9e8));
    func_0x01438628(*(undefined4 *)(_UNK_018fcb38 + 0x18fc9f4));
    func_0x01438628(*(undefined4 *)(_UNK_018fcb3c + 0x18fca00));
    *pcVar9 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9682,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9682,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_018fcb40 + 0x18fca64) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018fcb44 + 0x18fca80));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar1 = func_0x036c7bec(iVar1,**(undefined4 **)(_UNK_018fcb48 + 0x18fcaa0));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar1 + 0x2b4) != 0) {
    func_0x024f04d0(*(int *)(iVar1 + 0x2b4),**(undefined4 **)(_UNK_018fcb4c + 0x18fcad0));
  }
  if (*(int *)(**(int **)(_UNK_018fcb50 + 0x18fcae0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018fcb54 + 0x18fcafc));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  pcVar9 = (char *)(_UNK_02be82b0 + 0x2be8170);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x18,0);
  ...
  if (iVar10 != 0) {
    ...
    uStack_38 = 0;
    uStack_28 = 0;
    func_0x024f56c0(&uStack_50,0,0x18,0);
    uStack_38 = uStack_50;
    iStack_34 = uStack_4c;
    uStack_30 = uStack_48;
    uStack_2c = iStack_44;
    ...
    func_0x01523a2c(&uStack_38,0x18,0);
    iVar11 = *(int *)(iVar10 + 8);
  ...
  iVar1 = func_0x046ccb14(uVar3,0x18,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar1 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar2 = (*(code *)*puVar4)(piVar8,0x18,puVar4[1]);
      uVar3 = uStack_30;
    }
    iVar10 = *(int *)(uVar3 + 8);
    iVar1 = iVar10;
