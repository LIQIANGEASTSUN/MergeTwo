...
undefined4 FUN_02c2c1a0(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2c360 + 0x2c2c1b4);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2c364 + 0x2c2c1c8));
    func_0x01438628(*(undefined4 *)(_UNK_02c2c368 + 0x2c2c1d4));
    func_0x01438628(*(undefined4 *)(_UNK_02c2c36c + 0x2c2c1e0));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d9f,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d9f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2c370 + 0x2c2c308));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2c374 + 0x2c2c324),0);
  if (*(int *)(**(int **)(_UNK_02c2c378 + 0x2c2c338) + 0x74) == 0) {
    func_0x014387a4();
  }
