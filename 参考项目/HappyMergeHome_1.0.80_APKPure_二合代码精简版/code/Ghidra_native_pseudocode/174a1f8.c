...
void FUN_0175a1f8(int param_1,undefined4 param_2,int param_3)

{
  ...
  iVar3 = func_0x02953fd4(0x8d1e,0);
  if (iVar3 == 0) {
    iVar3 = FUN_0174e5a0(param_1);
    if (((iVar3 != 0) && (iVar3 = FUN_01759db4(param_1,param_2,param_3), iVar3 == 0)) &&
       (iVar3 = FUN_01759e84(param_1,param_2), iVar3 != 0)) {
      if (param_3 == 0) {
...
LAB_01759c04:
    ...
    iVar3 = func_0x029540a4(0x8d1e,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
