...
void FUN_01aea658(int param_1,undefined4 param_2)

{
  ...
  iVar5 = func_0x02953fd4(0xa4a6,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0xa4a6,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  iVar5 = FUN_01ae9dd4(param_1,param_2);
  if (iVar5 != 0) {
    return;
  }
  ...
  uStack_50 = 0;
  uStack_4c = 0;
  func_0x024f56d0(iVar8,uVar9,&uStack_30,uVar6);
  return;
}
