...

{
  ...
  pcVar3 = (char *)(_UNK_0174e594 + 0x174e4f8);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0174e598 + 0x174e50c));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8cfc,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8cfc,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0174e59c + 0x174e560) + 0x74) == 0) {
    func_0x014387a4();
  }
