...
void FUN_0164f094(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar6 = (char *)(_UNK_0164f310 + 0x164f0bc);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0164f314 + 0x164f0d0));
    func_0x01438628(*(undefined4 *)(_UNK_0164f318 + 0x164f0dc));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x1691,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_0164f31c + 0x164f140) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0164f320 + 0x164f160));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    uVar9 = (uint)lVar15;
    iVar3 = FUN_01642704(param_1,param_4 - (uVar8 + !bVar10));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x029540a4(0x1691,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
