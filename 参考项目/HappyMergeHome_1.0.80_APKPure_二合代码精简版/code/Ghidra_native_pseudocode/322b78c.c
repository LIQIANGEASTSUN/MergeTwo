...
uint FUN_0323b78c(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_0323b874 + 0x323b7ac);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0323b878 + 0x323b7c0));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7fcd,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7fcd,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0323b87c + 0x323b83c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_032356b8();
  if (iVar2 == 0) {
