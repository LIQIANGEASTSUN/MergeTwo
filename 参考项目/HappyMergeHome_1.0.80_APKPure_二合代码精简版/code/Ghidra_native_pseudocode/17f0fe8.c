...
int * FUN_01800fe8(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_018010c8 + 0x1800ffc);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018010cc + 0x1801010));
    func_0x01438628(*(undefined4 *)(_UNK_018010d0 + 0x180101c));
    func_0x01438628(*(undefined4 *)(_UNK_018010d4 + 0x1801028));
    *pcVar9 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x90bb,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x90bb,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    pcVar9 = (char *)(_UNK_0292712c + 0x292704c);
    if (*pcVar9 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_02927130 + 0x2927060),param_1,0);
      *pcVar9 = '\x01';
    }
    ...
    piVar2 = (int *)func_0x035daef8(&puStack_30,0,**(undefined4 **)(_UNK_02927134 + 0x292711c));
    return piVar2;
  }
  if (*(int *)(**(int **)(_UNK_018010d8 + 0x1801080) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018010dc + 0x180109c));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar10 = **(int **)(_UNK_018010e0 + 0x18010bc);
