...
int FUN_0303fafc(undefined4 param_1)

{
  ...
  iVar3 = func_0x02953fd4(0x73bb,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x73bb,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  pcVar6 = (char *)(_UNK_03071d14 + 0x3071bb0);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03071d18 + 0x3071bc4));
    func_0x01438628(*(undefined4 *)(_UNK_03071d1c + 0x3071bd0));
    func_0x01438628(*(undefined4 *)(_UNK_03071d20 + 0x3071bdc));
    func_0x01438628(*(undefined4 *)(_UNK_03071d24 + 0x3071be8));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x14aa,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x14aa,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_03071d28 + 0x3071c3c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03071d2c + 0x3071c58));
  piVar8 = *(int **)(_UNK_03071d30 + 0x3071c6c);
  iVar7 = *piVar8;
  if (*(int *)(iVar7 + 0x74) == 0) {
    func_0x014387a4();
    iVar7 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_03071d34 + 0x3071c8c);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar7 + 0x5c) + 0x8f8);
  if (iVar4 == 0) {
