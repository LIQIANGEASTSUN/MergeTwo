...
uint FUN_0167b6c4(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_0167b7ac + 0x167b6e4);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0167b7b0 + 0x167b6f8));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8785,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8785,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0167b7b4 + 0x167b774) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_01676670();
  if (iVar1 == 0) {
  ...
  if (iVar3 == 0) {
    ...
    pcVar11 = (char *)(_UNK_01684264 + 0x1684030);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
    ...
    iVar3 = func_0x02953fd4(0x876e,0);
    if (iVar3 == 0) {
      iVar3 = func_0x0167e370(iVar1);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x024f0540(iVar3,param_3,**(undefined4 **)(_UNK_01684284 + 0x1684108));
      if (iVar3 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x024eee28(**(undefined4 **)(_UNK_01684288 + 0x168416c),uVar10,
        ...
        if (iVar3 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_3,**(undefined4 **)(_UNK_01684298 + 0x16841c0));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar3,param_3,**(undefined4 **)(_UNK_01684294 + 0x168413c));
        }
        func_0x024f10d4(iVar3,param_3,iVar9 + -1,**(undefined4 **)(_UNK_0168429c + 0x16841e4));
        iVar3 = func_0x0167e370(iVar1);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x024f05d4(iVar3,param_3,**(undefined4 **)(_UNK_016842a0 + 0x1684214));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x0167e370(iVar1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar3 = **(int **)(_UNK_016842a4 + 0x1684254);
...
LAB_046c3e4c:
    ...
    iVar3 = func_0x029540a4(0x876e,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar3 = func_0x029540a4(0x8786,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
