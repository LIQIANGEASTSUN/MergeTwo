...
int FUN_03088c60(undefined4 param_1,int param_2)

{
  ...
  pcVar5 = (char *)(_UNK_03089078 + 0x3088c7c);
  if (*pcVar5 == '\0') {
  ...
  iVar2 = func_0x02953fd4(0x20c1,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x20c1,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  puVar10 = *(undefined4 **)(_UNK_030890a4 + 0x3088d9c);
  iVar2 = func_0x04cd2d7c(iVar2,param_2,*puVar10);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_030890a8 + 0x3088dbc) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_030890ac + 0x3088dd8));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iVar2 = *(int *)(iVar2 + 0x38);
    iVar7 = 0;
    puVar11 = *(undefined4 **)(_UNK_030890b0 + 0x3088e00);
    do {
      if (iVar2 == 0) {
        func_0x014388e4();
      }
    ...
    while( true ) {
      ...
      if (*(int *)(iVar3 + 0x24) <= param_2) {
        ...
        if (iVar3 == 0) {
          ...
          func_0x03b75ba0(iVar3,uVar9,**(undefined4 **)(_UNK_030890b4 + 0x3088f78));
        }
      }
      iVar7 = iVar7 + 1;
    }
    ...
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_030890bc + 0x3088fb8));
    ...
    iVar6 = **(int **)(_UNK_030890c4 + 0x3088fec);
