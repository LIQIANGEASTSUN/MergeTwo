...
int FUN_030cf620(undefined4 param_1)

{
  ...
  iVar3 = func_0x02953fd4(0x76db,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x76db,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = FUN_030ccf14(param_1);
  if (iVar3 == 0) {
    return 0;
  }
  pcVar6 = (char *)(_UNK_030ff400 + 0x30ff29c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030ff404 + 0x30ff2b0));
    func_0x01438628(*(undefined4 *)(_UNK_030ff408 + 0x30ff2bc));
    func_0x01438628(*(undefined4 *)(_UNK_030ff40c + 0x30ff2c8));
    func_0x01438628(*(undefined4 *)(_UNK_030ff410 + 0x30ff2d4));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x155e,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x155e,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_030ff414 + 0x30ff328) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_030ff418 + 0x30ff344));
  piVar8 = *(int **)(_UNK_030ff41c + 0x30ff358);
  iVar7 = *piVar8;
  if (*(int *)(iVar7 + 0x74) == 0) {
    func_0x014387a4();
    iVar7 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_030ff420 + 0x30ff378);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar7 + 0x5c) + 0x998);
  if (iVar4 == 0) {
