...

{
  ...
  pcVar11 = (char *)(_UNK_032aafdc + 0x32aae68);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032aafe0 + 0x32aae7c));
    func_0x01438628(*(undefined4 *)(_UNK_032aafe4 + 0x32aae88));
    func_0x01438628(*(undefined4 *)(_UNK_032aafe8 + 0x32aae94));
    func_0x01438628(*(undefined4 *)(_UNK_032aafec + 0x32aaea0));
    func_0x01438628(*(undefined4 *)(_UNK_032aaff0 + 0x32aaeac));
    func_0x01438628(*(undefined4 *)(_UNK_032aaff4 + 0x32aaeb8));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x8283,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x8283,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_032aaff8 + 0x32aaf1c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_032aaffc + 0x32aaf38));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = func_0x036c7bec(iVar3,**(undefined4 **)(_UNK_032ab000 + 0x32aaf58));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar3 + 600) != 0) {
    func_0x03b73ab8(*(int *)(iVar3 + 600),**(undefined4 **)(_UNK_032ab004 + 0x32aaf88));
  }
  if (*(int *)(**(int **)(_UNK_032ab008 + 0x32aaf98) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_032ab00c + 0x32aafb4));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  pcVar11 = (char *)(_UNK_02be82b0 + 0x2be8170);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x15,0);
  ...
  if (iVar9 != 0) {
    ...
    uStack_38 = 0;
    uStack_28 = 0;
    func_0x024f56c0(&uStack_50,0,0x15,0);
    uStack_38 = uStack_50;
    iStack_34 = uStack_4c;
    uStack_30 = uStack_48;
    uStack_2c = iStack_44;
    ...
    func_0x01523a2c(&uStack_38,0x15,0);
    iVar10 = *(int *)(iVar9 + 8);
  ...
  iVar3 = func_0x046ccb14(uVar2,0x15,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar3 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar1 = (*(code *)*puVar4)(piVar8,0x15,puVar4[1]);
      uVar2 = uStack_30;
    }
    iVar9 = *(int *)(uVar2 + 8);
    iVar3 = iVar9;
