...
int FUN_0304887c(int *param_1,int param_2,int param_3)

{
  ...
  pcVar10 = (char *)(_UNK_03048a50 + 0x304889c);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03048a54 + 0x30488b0));
    func_0x01438628(*(undefined4 *)(_UNK_03048a58 + 0x30488bc));
    func_0x01438628(*(undefined4 *)(_UNK_03048a5c + 0x30488c8));
    *pcVar10 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x73d9,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x73d9,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_03048a60 + 0x3048930) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_03048a64 + 0x304894c));
  uVar6 = (**(code **)(*param_1 + 0x1a0))(param_1,*(undefined4 *)(*param_1 + 0x1a4));
  piVar7 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_03048a68 + 0x304897c),2);
  if (piVar7 == (int *)0x0) {
    func_0x014388e4();
  }
  if ((param_2 != 0) &&
