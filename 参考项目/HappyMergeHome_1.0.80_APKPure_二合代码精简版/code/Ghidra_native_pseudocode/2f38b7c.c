...

{
  ...
  pcVar7 = (char *)(_UNK_02f48d68 + 0x2f48b94);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f48d6c + 0x2f48ba8));
    func_0x01438628(*(undefined4 *)(_UNK_02f48d70 + 0x2f48bb4));
    func_0x01438628(*(undefined4 *)(_UNK_02f48d74 + 0x2f48bc0));
    func_0x01438628(*(undefined4 *)(_UNK_02f48d78 + 0x2f48bcc));
    *pcVar7 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x6e0a,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x6e0a,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f48d7c + 0x2f48ca4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x04e4a028(**(undefined4 **)(_UNK_02f48d80 + 0x2f48cc0));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  ...
  if ((iVar4 != 0) && (0 < *(int *)(iVar4 + 0xc))) {
    ...
    iVar4 = func_0x04cfd760(iVar4,0,**(undefined4 **)(_UNK_02f48d84 + 0x2f48d14));
    if (iVar4 == 0) {
      func_0x014388e4();
    }
