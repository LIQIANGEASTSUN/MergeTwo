...

{
  ...
  iVar1 = func_0x02953fd4(0x90a6,0);
  if (iVar1 == 0) {
    ...
    iVar1 = FUN_01808fb0(param_1);
    if (iVar1 == 0) {
      pcVar4 = (char *)(_UNK_01809758 + 0x18095c0);
      if (*pcVar4 == '\0') {
        func_0x01438628(*(undefined4 *)(_UNK_0180975c + 0x18095d4));
        func_0x01438628(*(undefined4 *)(_UNK_01809760 + 0x18095e0));
        func_0x01438628(*(undefined4 *)(_UNK_01809764 + 0x18095ec));
        *pcVar4 = '\x01';
      }
      iVar1 = func_0x02953fd4(0x90b3,0);
      if (iVar1 == 0) {
        uVar2 = 0;
        if (*(char *)(param_1 + 0x52) != '\0') {
          if (*(int *)(**(int **)(_UNK_01809768 + 0x1809650) + 0x74) == 0) {
            func_0x014387a4();
          }
          iVar1 = FUN_01800148();
          if (iVar1 == 0) {
          ...
          if (*(int *)(**(int **)(_UNK_0180976c + 0x180970c) + 0x74) == 0) {
            func_0x014387a4();
          }
          iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01809770 + 0x1809728));
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          uVar2 = func_0x02bb3638(iVar1,0x13,0);
          *(undefined1 *)(param_1 + 0x52) = 0;
        }
        return uVar2;
      }
      iVar1 = func_0x029540a4(0x90b3,0);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
    }
    ...
    iVar1 = func_0x029540a4(0x90a6,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
