...
int FUN_0187562c(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_018756f8 + 0x1875640);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018756fc + 0x1875654));
    func_0x01438628(*(undefined4 *)(_UNK_01875700 + 0x1875660));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x93be,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x93be,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01875704 + 0x18756b8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01875708 + 0x18756d4));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
