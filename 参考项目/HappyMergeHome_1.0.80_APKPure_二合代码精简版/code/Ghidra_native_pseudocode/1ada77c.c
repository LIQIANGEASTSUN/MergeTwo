...
undefined4 FUN_01aea77c(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_01aea858 + 0x1aea790);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01aea85c + 0x1aea7a4));
    func_0x01438628(*(undefined4 *)(_UNK_01aea860 + 0x1aea7b0));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xa4a8,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_01aea864 + 0x1aea808) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01aea868 + 0x1aea824));
    uVar7 = func_0x01aea86c(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x029540a4(0xa4a8,0);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
