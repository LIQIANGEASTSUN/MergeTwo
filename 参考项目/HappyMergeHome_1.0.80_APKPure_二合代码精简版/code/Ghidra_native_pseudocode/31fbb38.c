...
int FUN_0320bb38(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_0320bc04 + 0x320bb4c);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0320bc08 + 0x320bb60));
    func_0x01438628(*(undefined4 *)(_UNK_0320bc0c + 0x320bb6c));
    *pcVar9 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7e85,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7e85,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0320bc10 + 0x320bbc4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0320bc14 + 0x320bbe0));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
