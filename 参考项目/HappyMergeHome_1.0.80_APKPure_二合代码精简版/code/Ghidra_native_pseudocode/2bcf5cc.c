...
void FUN_02bdf5cc(int param_1,int param_2,undefined4 param_3)

{
  ...
  pcVar8 = (char *)(_UNK_02bdf7d8 + 0x2bdf5ec);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02bdf7dc + 0x2bdf600));
    func_0x01438628(*(undefined4 *)(_UNK_02bdf7e0 + 0x2bdf60c));
    func_0x01438628(*(undefined4 *)(_UNK_02bdf7e4 + 0x2bdf618));
    func_0x01438628(*(undefined4 *)(_UNK_02bdf7e8 + 0x2bdf624));
    func_0x01438628(*(undefined4 *)(_UNK_02bdf7ec + 0x2bdf630));
    *pcVar8 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x5d03,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x5d03,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_28 = 0;
  ...
  func_0x03b77610(iVar3,param_2,**(undefined4 **)(_UNK_02bdf7f0 + 0x2bdf6c8));
  piVar4 = *(int **)(_UNK_02bdf7f4 + 0x2bdf6e0);
  *(undefined1 *)(param_1 + 0x20) = 1;
  if (*(int *)(*piVar4 + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_02bdf7f8 + 0x2bdf700));
  piVar4 = *(int **)(_UNK_02bdf7fc + 0x2bdf714);
  iVar5 = *piVar4;
  if (*(int *)(iVar5 + 0x74) == 0) {
    func_0x014387a4();
    iVar5 = *piVar4;
  }
  iVar9 = **(int **)(_UNK_02bdf800 + 0x2bdf734);
