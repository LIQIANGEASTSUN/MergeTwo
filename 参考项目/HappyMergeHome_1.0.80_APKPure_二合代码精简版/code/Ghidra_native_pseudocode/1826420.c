...
int FUN_01836420(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0x91f7,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x91f7,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  pcVar6 = (char *)(_UNK_01866d88 + 0x1866c24);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01866d8c + 0x1866c38));
    func_0x01438628(*(undefined4 *)(_UNK_01866d90 + 0x1866c44));
    func_0x01438628(*(undefined4 *)(_UNK_01866d94 + 0x1866c50));
    func_0x01438628(*(undefined4 *)(_UNK_01866d98 + 0x1866c5c));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x17f8,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x17f8,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_01866d9c + 0x1866cb0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01866da0 + 0x1866ccc));
  piVar7 = *(int **)(_UNK_01866da4 + 0x1866ce0);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_01866da8 + 0x1866d00);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0x80c);
  if (iVar2 == 0) {
