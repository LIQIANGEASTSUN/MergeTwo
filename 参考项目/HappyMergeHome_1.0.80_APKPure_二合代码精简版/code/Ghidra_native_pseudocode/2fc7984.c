...
int FUN_02fd7984(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_02fd7ab8 + 0x2fd7998);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fd7abc + 0x2fd79ac));
    func_0x01438628(*(undefined4 *)(_UNK_02fd7ac0 + 0x2fd79b8));
    *pcVar4 = '\x01';
  }
  iVar7 = 0;
  iVar1 = func_0x02953fd4(0x70d8,0);
  if (iVar1 != 0) {
    iVar7 = func_0x029540a4(0x70d8,0);
    if (iVar7 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = 1;
  puVar8 = *(undefined4 **)(_UNK_02fd7ac4 + 0x2fd7a18);
  while( true ) {
