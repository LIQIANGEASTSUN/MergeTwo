...
void FUN_01b5e5c0(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_01b5e678 + 0x1b5e5d4);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01b5e67c + 0x1b5e5e8));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xa699,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xa699,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = FUN_01b5e42c(param_1);
  iVar7 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_01b5e680 + 0x1b5e650) + 0x74) == 0) {
    func_0x014387a4();
  }
