...
void FUN_019259ac(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  pcVar4 = (char *)(_UNK_01925ab4 + 0x19259cc);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01925ab8 + 0x19259ec));
    *pcVar4 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x978c,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x978c,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iStack_34 = param_5;
  ...
  if (*(int *)(**(int **)(_UNK_01925abc + 0x1925a78) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_01920184();
  if (iVar2 == 0) {
