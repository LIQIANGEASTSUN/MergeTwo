...

{
  ...
  pcVar7 = (char *)(_UNK_029fc6d4 + 0x29fc588);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_029fc6d8 + 0x29fc59c));
    func_0x01438628(*(undefined4 *)(_UNK_029fc6dc + 0x29fc5a8));
    func_0x01438628(*(undefined4 *)(_UNK_029fc6e0 + 0x29fc5b4));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x24f1,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x24f1,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    iVar1 = func_0x024f56d0(iVar8,uVar9,&uStack_30,uVar6,0,0);
    return iVar1;
  }
  if (*(int *)(**(int **)(_UNK_029fc6e4 + 0x29fc60c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_029fc6e8 + 0x29fc628));
  uVar9 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar10 = **(int **)(_UNK_029fc6ec + 0x29fc654);
  ...
  if (iVar10 != 0) {
    ...
    iStack_20 = 0;
    iVar1 = func_0x0286ef30(iVar10,iVar1,uVar9,iVar8);
    return iVar1;
  }
  iStack_20 = uStack_14;
  uStack_24 = uStack_18;
  ...
  if (iVar10 != 0) {
    ...
    iVar1 = func_0x0286ef30(iVar10,iVar1,uVar9,iVar8,0);
    return iVar1;
  }
  iVar10 = *(int *)(iVar1 + 0x2c);
  if (iVar10 == 0) {
    func_0x014388e4();
  }
  ...
  uVar2 = func_0x0478480c(&iStack_38,iVar10,uVar9,**(undefined4 **)(_UNK_02b0d208 + 0x2b0cb08));
...
LAB_02b0d1b0:
        ...
        if (iVar10 == 0) {
          ...
          iVar1 = _UNK_02b0d248;
          *puVar5 = *puVar11;
          uVar9 = func_0x014e9588(puVar5,iVar1 + 0x2b0d1a4,0);
          func_0x014e9558();
          goto LAB_02b0d1b0;
        }
        piVar4 = (int *)*puVar11;
  ...
  if (iStack_38 != 2) {
    ...
    iVar3 = func_0x0475561c(iVar10,uVar9,&iStack_28,**(undefined4 **)(_UNK_02b0d218 + 0x2b0ce2c));
    iVar10 = iStack_28;
    if (iVar3 == 0) {
      ...
      iVar10 = func_0x03b67d0c(iVar3,iVar10,**(undefined4 **)(_UNK_02b0d21c + 0x2b0ce60));
      if (iVar10 == 0) {
        if (iStack_38 == 0) {
          ...
          if (0 < *(int *)(iVar10 + 0xc)) {
            ...
            iVar3 = func_0x024ef144(iVar10,0,0);
            if (iVar3 != 0) {
              if (iVar10 == 0) {
                func_0x014388e4();
              }
        ...
        func_0x03b681a8(iVar3,iVar10,**(undefined4 **)(_UNK_02b0d228 + 0x2b0cf54));
      }
      else {
        iVar10 = *(int *)(iVar1 + 0x14);
        if (iVar10 == 0) {
        ...
        if (0 < *(int *)(iVar10 + 0xc)) {
          ...
          while( true ) {
            ...
            piVar4 = (int *)func_0x03b680f4(iVar10,*puVar11);
            iVar10 = iStack_28;
            if (piVar4 == (int *)0x0) {
              func_0x014388e4();
            }
            iVar10 = (**(code **)(*piVar4 + 0xc0))(piVar4,iVar10,*(undefined4 *)(*piVar4 + 0xc4));
            if (iVar10 != 0) break;
            iVar10 = *(int *)(iVar1 + 0x14);
            if (iVar10 == 0) {
              func_0x014388e4();
