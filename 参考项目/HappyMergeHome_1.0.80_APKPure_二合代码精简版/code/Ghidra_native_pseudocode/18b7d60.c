...
int FUN_018c7d60(int *param_1,int param_2,int param_3)

{
  ...
  pcVar10 = (char *)(_UNK_018c7f34 + 0x18c7d80);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018c7f38 + 0x18c7d94));
    func_0x01438628(*(undefined4 *)(_UNK_018c7f3c + 0x18c7da0));
    func_0x01438628(*(undefined4 *)(_UNK_018c7f40 + 0x18c7dac));
    *pcVar10 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x951c,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x951c,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_018c7f44 + 0x18c7e14) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018c7f48 + 0x18c7e30));
  uVar2 = (**(code **)(*param_1 + 0x1a0))(param_1,*(undefined4 *)(*param_1 + 0x1a4));
  piVar3 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_018c7f4c + 0x18c7e60),2);
  if (piVar3 == (int *)0x0) {
    func_0x014388e4();
  }
  if ((param_2 != 0) &&
