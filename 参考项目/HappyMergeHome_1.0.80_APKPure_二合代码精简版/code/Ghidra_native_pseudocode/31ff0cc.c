...

{
  ...
  pcVar7 = (char *)(_UNK_0320f174 + 0x320f0e0);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0320f178 + 0x320f0f4));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7e8e,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7e8e,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar6 = **(int **)(_UNK_0320f17c + 0x320f168);
