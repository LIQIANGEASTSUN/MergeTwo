...
void FUN_02f9277c(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_02f92834 + 0x2f92790);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f92838 + 0x2f927a4));
    *pcVar8 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x6f3f,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x6f3f,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x02fa5e4c(param_1);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_02f9283c + 0x2f9280c) + 0x74) == 0) {
    func_0x014387a4();
  }
