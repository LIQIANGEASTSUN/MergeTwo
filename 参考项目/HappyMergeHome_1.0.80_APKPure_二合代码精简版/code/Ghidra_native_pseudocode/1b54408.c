...
void FUN_01b64408(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar8 = (char *)(_UNK_01b644cc + 0x1b64420);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01b644d0 + 0x1b64434));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xa6cd,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xa6cd,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = FUN_01b64224(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_01b644d4 + 0x1b644a4) + 0x74) == 0) {
    func_0x014387a4();
  }
