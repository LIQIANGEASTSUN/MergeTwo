...

{
  ...
  pcVar6 = (char *)(_UNK_01ae6bcc + 0x1ae6b30);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01ae6bd0 + 0x1ae6b44));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0xa49b,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0xa49b,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (param_1 != 0 && iVar2 != 0) {
    ...
    iVar7 = **(int **)(_UNK_01ae6bd4 + 0x1ae6bc0);
