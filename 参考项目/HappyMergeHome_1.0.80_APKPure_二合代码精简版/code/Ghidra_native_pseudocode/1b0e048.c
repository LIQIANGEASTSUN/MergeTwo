...
uint FUN_01b1e048(int param_1,int param_2)

{
  ...
  pcVar10 = (char *)(_UNK_01b1e110 + 0x1b1e060);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01b1e114 + 0x1b1e074));
    *pcVar10 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x6f4,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_01b1e118 + 0x1b1e0d0) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x02c35d10(0x18,0);
    if (iVar3 == 0) {
      return 0;
    }
