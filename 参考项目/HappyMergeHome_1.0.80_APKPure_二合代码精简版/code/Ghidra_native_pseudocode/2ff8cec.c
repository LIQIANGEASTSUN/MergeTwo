...
uint FUN_03008cec(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar2 = func_0x02953fd4(0x7270,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_03008e18 + 0x3008d80) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_03008e1c + 0x3008d9c));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x02953fd4(0x7258,0);
    if (iVar2 == 0) {
      iVar2 = func_0x0300b8a4(param_1);
      if (iVar2 == 0) {
        func_0x014388e4();
      }
      iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_030117b8 + 0x301163c));
      if (iVar2 == 0) {
        ...
        if (iVar2 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_030117cc + 0x30116f4));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar2,param_2,**(undefined4 **)(_UNK_030117c8 + 0x3011670));
        }
        func_0x03b70fe4(iVar2,param_2,iVar9 + -1,**(undefined4 **)(_UNK_030117d0 + 0x3011718));
        iVar2 = func_0x0300b8a4(param_1);
        if (iVar2 == 0) {
          func_0x014388e4();
        }
        uVar1 = func_0x03b70fac(iVar2,param_2,**(undefined4 **)(_UNK_030117d4 + 0x3011748));
        if ((int)uVar1 < 1) {
          iVar2 = func_0x0300b8a4(param_1);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar9 = **(int **)(_UNK_030117d8 + 0x3011788);
...
LAB_046c3e4c:
    ...
    iVar2 = func_0x029540a4(0x7258,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar2 = func_0x029540a4(0x7270,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
