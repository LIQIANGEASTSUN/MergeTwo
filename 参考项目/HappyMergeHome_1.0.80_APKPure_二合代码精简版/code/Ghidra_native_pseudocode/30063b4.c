...
void FUN_030163b4(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar6 = (char *)(_UNK_03016630 + 0x30163dc);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03016634 + 0x30163f0));
    func_0x01438628(*(undefined4 *)(_UNK_03016638 + 0x30163fc));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x15a5,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_0301663c + 0x3016460) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_03016640 + 0x3016480));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    uVar9 = (uint)lVar15;
    iVar3 = FUN_03009c84(param_1,param_4 - (uVar8 + !bVar10));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x029540a4(0x15a5,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
