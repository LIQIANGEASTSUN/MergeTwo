...
void FUN_01847a68(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar2 = func_0x024f0540(iVar2,param_2,**(undefined4 **)(_UNK_01847c38 + 0x1847b50));
  ...
  if (iVar5 == 0) {
    ...
    iVar2 = func_0x024f05d4(0,param_2,**(undefined4 **)(_UNK_01847c3c + 0x1847bd4));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_01847c04:
    ...
    iVar2 = func_0x024f05d4(iVar5,param_2,**(undefined4 **)(_UNK_01847c40 + 0x1847ba8));
  }
  unaff_r7 = iVar2 + 1;
