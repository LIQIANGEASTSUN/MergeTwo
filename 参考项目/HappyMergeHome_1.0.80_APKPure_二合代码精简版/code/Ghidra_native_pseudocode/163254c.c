...
void FUN_0164254c(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  pcVar3 = (char *)(_UNK_016425b0 + 0x1642560);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016425b4 + 0x1642574));
    *pcVar3 = '\x01';
    param_4 = extraout_r3;
  }
  piVar1 = *(int **)(_UNK_016425b8 + 0x164258c);
