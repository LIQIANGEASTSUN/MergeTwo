...
int FUN_0170fb88(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_0170fd04 + 0x170fb9c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0170fd08 + 0x170fbb0));
    func_0x01438628(*(undefined4 *)(_UNK_0170fd0c + 0x170fbbc));
    func_0x01438628(*(undefined4 *)(_UNK_0170fd10 + 0x170fbc8));
    func_0x01438628(*(undefined4 *)(_UNK_0170fd14 + 0x170fbd4));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8b33,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8b33,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0170fd18 + 0x170fc2c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0170fd1c + 0x170fc48));
  piVar7 = *(int **)(_UNK_0170fd20 + 0x170fc5c);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_0170fd24 + 0x170fc7c);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0xa84);
  if (iVar2 == 0) {
