...

{
  ...
  pcVar7 = (char *)(_UNK_018f61a4 + 0x18f6058);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018f61a8 + 0x18f606c));
    func_0x01438628(*(undefined4 *)(_UNK_018f61ac + 0x18f6078));
    func_0x01438628(*(undefined4 *)(_UNK_018f61b0 + 0x18f6084));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x2981,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x2981,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_018f61b4 + 0x18f60dc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018f61b8 + 0x18f60f8));
  uVar10 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar9 = **(int **)(_UNK_018f61bc + 0x18f6124);
