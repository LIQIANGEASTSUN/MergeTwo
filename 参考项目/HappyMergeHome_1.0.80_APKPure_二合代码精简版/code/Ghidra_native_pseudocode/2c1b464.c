...
undefined4 FUN_02c2b464(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2b624 + 0x2c2b478);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2b628 + 0x2c2b48c));
    func_0x01438628(*(undefined4 *)(_UNK_02c2b62c + 0x2c2b498));
    func_0x01438628(*(undefined4 *)(_UNK_02c2b630 + 0x2c2b4a4));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d91,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d91,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2b634 + 0x2c2b5cc));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2b638 + 0x2c2b5e8),0);
  if (*(int *)(**(int **)(_UNK_02c2b63c + 0x2c2b5fc) + 0x74) == 0) {
    func_0x014387a4();
  }
