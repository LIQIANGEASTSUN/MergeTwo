...
int * FUN_02fcf74c(undefined4 param_1)

{
  ...
  pcVar13 = (char *)(_UNK_02fcf82c + 0x2fcf760);
  if (*pcVar13 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fcf830 + 0x2fcf774));
    func_0x01438628(*(undefined4 *)(_UNK_02fcf834 + 0x2fcf780));
    func_0x01438628(*(undefined4 *)(_UNK_02fcf838 + 0x2fcf78c));
    *pcVar13 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x157f,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x157f,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    pcVar13 = (char *)(_UNK_028a5844 + 0x28a5764);
    if (*pcVar13 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_028a5848 + 0x28a5778),param_1,0);
      *pcVar13 = '\x01';
    }
    ...
    piVar1 = (int *)func_0x035daef8(&pcStack_30,0,**(undefined4 **)(_UNK_028a584c + 0x28a5834));
    return piVar1;
  }
  if (*(int *)(**(int **)(_UNK_02fcf83c + 0x2fcf7e4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_02fcf840 + 0x2fcf800));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  pcVar13 = (char *)**(undefined4 **)(_UNK_02fcf844 + 0x2fcf820);
