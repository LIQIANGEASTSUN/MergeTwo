...
uint FUN_018392e4(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_018393cc + 0x1839304);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018393d0 + 0x1839318));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x9231,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x9231,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_018393d4 + 0x1839394) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_01833590();
  if (iVar2 == 0) {
