...
int FUN_031b3758(undefined4 param_1)

{
  ...
  iVar3 = func_0x02953fd4(0x7cc8,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x7cc8,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = FUN_031b0c18(param_1);
  if (iVar3 == 0) {
    return 0;
  }
  pcVar6 = (char *)(_UNK_031fdc00 + 0x31fda9c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031fdc04 + 0x31fdab0));
    func_0x01438628(*(undefined4 *)(_UNK_031fdc08 + 0x31fdabc));
    func_0x01438628(*(undefined4 *)(_UNK_031fdc0c + 0x31fdac8));
    func_0x01438628(*(undefined4 *)(_UNK_031fdc10 + 0x31fdad4));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x17c5,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x17c5,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_031fdc14 + 0x31fdb28) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_031fdc18 + 0x31fdb44));
  piVar8 = *(int **)(_UNK_031fdc1c + 0x31fdb58);
  iVar7 = *piVar8;
  if (*(int *)(iVar7 + 0x74) == 0) {
    func_0x014387a4();
    iVar7 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_031fdc20 + 0x31fdb78);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar7 + 0x5c) + 0x7c0);
  if (iVar4 == 0) {
