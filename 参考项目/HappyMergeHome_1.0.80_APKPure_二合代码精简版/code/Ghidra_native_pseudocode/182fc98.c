...

{
  ...
  pcVar6 = (char *)(_UNK_0183fd40 + 0x183fcac);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0183fd44 + 0x183fcc0));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x924d,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x924d,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar7 = **(int **)(_UNK_0183fd48 + 0x183fd34);
