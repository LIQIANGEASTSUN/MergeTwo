...
void FUN_0307a378(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_0307a43c + 0x307a390);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0307a440 + 0x307a3a4));
    *pcVar10 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x7548,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x7548,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x0308c5f4(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_0307a444 + 0x307a414) + 0x74) == 0) {
    func_0x014387a4();
  }
