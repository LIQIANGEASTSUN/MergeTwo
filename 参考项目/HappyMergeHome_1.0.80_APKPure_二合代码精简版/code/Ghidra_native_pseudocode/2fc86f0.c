...
undefined4 FUN_02fd86f0(undefined4 param_1,int param_2)

{
  ...
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fd8eb0 + 0x2fd8720));
  ...
  if (iVar1 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      *piVar14 = iVar3;
      ...
      iVar3 = FUN_02fd0dbc(param_1);
      uVar2 = *(undefined4 *)(param_2 + 8);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      func_0x046ce3e4(iVar3,uVar2,&iStack_28,**(undefined4 **)(_UNK_02fd8f2c + 0x2fd89dc));
      iVar3 = iStack_28;
      if (iStack_28 == 0) {
        func_0x014388e4();
      }
      ...
      iVar3 = func_0x014388d4(**(undefined4 **)(_UNK_02fd8f3c + 0x2fd8b60));
      func_0x03bbd054(iVar3,**(undefined4 **)(_UNK_02fd8f40 + 0x2fd8b74));
      ...
      *piVar7 = iVar3;
      ...
      if (0 < *(int *)(iVar3 + 0xc)) {
        ...
        iVar3 = FUN_02fcd8a4();
        if (iVar3 != 0) {
          func_0x02fe2890(iVar3,0);
        }
        if (*(int *)(**(int **)(_UNK_02fd8f48 + 0x2fd8be8) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02fd8f4c + 0x2fd8c08));
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        ...
        while( true ) {
          ...
          func_0x020257a4(iVar10,0x313,uVar2,uVar4,0,0,0);
          iVar3 = iVar3 + 1;
        }
        if (*(int *)(**(int **)(_UNK_02fd8f58 + 0x2fd8da4) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar3 = func_0x03b2c734(**(undefined4 **)(_UNK_02fd8f5c + 0x2fd8dc0));
        iVar9 = *piVar14;
        if (*(int *)(**(int **)(_UNK_02fd8f60 + 0x2fd8dd4) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar10 = func_0x04e4a028(**(undefined4 **)(_UNK_02fd8f64 + 0x2fd8df4));
        if (iVar10 == 0) {
          func_0x014388e4();
        }
        ...
        func_0x02b75870(iVar3,iVar9,uVar4,1,0x103,0,0,0,0,0,0,0,uVar2,0,0);
        iVar1 = *piVar7;
        if (iVar1 == 0) {
          func_0x014388e4();
        }
