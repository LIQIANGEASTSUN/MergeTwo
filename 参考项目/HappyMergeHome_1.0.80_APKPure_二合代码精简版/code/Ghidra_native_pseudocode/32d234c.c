...
void FUN_032e234c(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_032e2410 + 0x32e2364);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032e2414 + 0x32e2378));
    *pcVar10 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x8355,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x8355,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = FUN_032e21c0(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_032e2418 + 0x32e23e8) + 0x74) == 0) {
    func_0x014387a4();
  }
