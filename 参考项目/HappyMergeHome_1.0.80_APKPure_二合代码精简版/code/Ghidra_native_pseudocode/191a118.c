...

{
  ...
  pcVar6 = (char *)(_UNK_0192a304 + 0x192a130);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0192a308 + 0x192a144));
    func_0x01438628(*(undefined4 *)(_UNK_0192a30c + 0x192a150));
    func_0x01438628(*(undefined4 *)(_UNK_0192a310 + 0x192a15c));
    func_0x01438628(*(undefined4 *)(_UNK_0192a314 + 0x192a168));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x97a1,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x97a1,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0192a318 + 0x192a240) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0192a31c + 0x192a25c));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  ...
  if ((iVar2 != 0) && (0 < *(int *)(iVar2 + 0xc))) {
    ...
    iVar2 = func_0x0152983c(iVar2,0,**(undefined4 **)(_UNK_0192a320 + 0x192a2b0));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
