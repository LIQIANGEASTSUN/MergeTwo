...
undefined4 FUN_03015718(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_030157f4 + 0x301572c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030157f8 + 0x3015740));
    func_0x01438628(*(undefined4 *)(_UNK_030157fc + 0x301574c));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x729b,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_03015800 + 0x30157a4) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03015804 + 0x30157c0));
    uVar7 = func_0x03015808(param_1);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = func_0x029540a4(0x729b,0);
  if (iVar3 == 0) {
    func_0x014388e4();
  }
