...

{
  ...
  pcVar7 = (char *)(_UNK_02f1f788 + 0x2f1f63c);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f1f78c + 0x2f1f650));
    func_0x01438628(*(undefined4 *)(_UNK_02f1f790 + 0x2f1f65c));
    func_0x01438628(*(undefined4 *)(_UNK_02f1f794 + 0x2f1f668));
    *pcVar7 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x28e2,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x28e2,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_02f1f79c + 0x2f1f6dc));
