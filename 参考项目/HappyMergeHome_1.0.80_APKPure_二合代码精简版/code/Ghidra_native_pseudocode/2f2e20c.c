...

{
  ...
  pcVar7 = (char *)(_UNK_02f3e36c + 0x2f3e220);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f3e370 + 0x2f3e234));
    func_0x01438628(*(undefined4 *)(_UNK_02f3e374 + 0x2f3e240));
    func_0x01438628(*(undefined4 *)(_UNK_02f3e378 + 0x2f3e24c));
    *pcVar7 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x2b46,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x2b46,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f3e37c + 0x2f3e2a4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_02f3e380 + 0x2f3e2c0));
  uVar9 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar10 = **(int **)(_UNK_02f3e384 + 0x2f3e2ec);
