...
void FUN_02fdd2b4(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar7 = (char *)(_UNK_02fdd6b4 + 0x2fdd2dc);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fdd6b8 + 0x2fdd2f0));
    func_0x01438628(*(undefined4 *)(_UNK_02fdd6bc + 0x2fdd2fc));
    func_0x01438628(*(undefined4 *)(_UNK_02fdd6c0 + 0x2fdd308));
    func_0x01438628(*(undefined4 *)(_UNK_02fdd6c4 + 0x2fdd314));
    func_0x01438628(*(undefined4 *)(_UNK_02fdd6c8 + 0x2fdd320));
    func_0x01438628(*(undefined4 *)(_UNK_02fdd6cc + 0x2fdd32c));
    func_0x01438628(*(undefined4 *)(_UNK_02fdd6d0 + 0x2fdd338));
    func_0x01438628(*(undefined4 *)(_UNK_02fdd6d4 + 0x2fdd344));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x1594,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_02fdd6d8 + 0x2fdd3a8) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_02fdd6dc + 0x2fdd3c4));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    if ((int)(iVar6 - (iVar2 + (uint)bVar12)) < 0 !=
      ...
      func_0x03b70d24(iVar5,**(undefined4 **)(_UNK_02fdd6e0 + 0x2fdd550));
      uVar15 = FUN_02fcfc38(param_1);
      ...
      if (*(int *)(**(int **)(_UNK_02fdd6e4 + 0x2fdd5a4) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_02fdd6e8 + 0x2fdd5c0));
      piVar10 = *(int **)(_UNK_02fdd6ec + 0x2fdd5d4);
      iVar5 = *piVar10;
      if (*(int *)(iVar5 + 0x74) == 0) {
        func_0x014387a4();
        iVar5 = *piVar10;
      ...
      piVar10 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_02fdd6f0 + 0x2fdd5f8),1);
      uStack_54 = 0;
      iVar5 = func_0x014387ac(**(undefined4 **)(_UNK_02fdd6f4 + 0x2fdd618),&uStack_54);
      if (piVar10 == (int *)0x0) {
        func_0x014388e4();
      }
      if ((iVar5 != 0) &&
    ...
    iVar2 = func_0x029540a4(0x1594,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
