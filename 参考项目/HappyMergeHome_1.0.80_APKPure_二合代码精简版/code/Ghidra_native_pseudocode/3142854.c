...
undefined4 FUN_03152854(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_03152990 + 0x315286c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03152994 + 0x3152880));
    func_0x01438628(*(undefined4 *)(_UNK_03152998 + 0x315288c));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7a43,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7a43,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x046c26fc(iVar1,param_2,**(undefined4 **)(_UNK_0315299c + 0x3152924));
  if (iVar1 != 0) {
    iVar1 = FUN_031457fc(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_031529a0 + 0x315297c);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
