...

{
  ...
  pcVar6 = (char *)(_UNK_019641c8 + 0x1963ff4);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_019641cc + 0x1964008));
    func_0x01438628(*(undefined4 *)(_UNK_019641d0 + 0x1964014));
    func_0x01438628(*(undefined4 *)(_UNK_019641d4 + 0x1964020));
    func_0x01438628(*(undefined4 *)(_UNK_019641d8 + 0x196402c));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x9927,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x9927,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_019641dc + 0x1964104) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_019641e0 + 0x1964120));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  iVar2 = *(int *)(iVar2 + 0x14);
  if ((iVar2 != 0) && (0 < *(int *)(iVar2 + 0xc))) {
    iVar7 = FUN_019600b0(param_1);
    if (iVar7 == 0) {
      func_0x014388e4();
    }
    iVar7 = *(int *)(iVar7 + 0x6c);
    iVar2 = func_0x0152983c(iVar2,0,**(undefined4 **)(_UNK_019641e4 + 0x1964174));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
