...
int FUN_032df24c(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_032df3c8 + 0x32df260);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032df3cc + 0x32df274));
    func_0x01438628(*(undefined4 *)(_UNK_032df3d0 + 0x32df280));
    func_0x01438628(*(undefined4 *)(_UNK_032df3d4 + 0x32df28c));
    func_0x01438628(*(undefined4 *)(_UNK_032df3d8 + 0x32df298));
    *pcVar7 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x8352,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x8352,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_032df3dc + 0x32df2f0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_032df3e0 + 0x32df30c));
  piVar8 = *(int **)(_UNK_032df3e4 + 0x32df320);
  iVar6 = *piVar8;
  if (*(int *)(iVar6 + 0x74) == 0) {
    func_0x014387a4();
    iVar6 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_032df3e8 + 0x32df340);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar6 + 0x5c) + 0x854);
  if (iVar4 == 0) {
