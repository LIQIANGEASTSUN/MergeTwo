...
int FUN_0304da20(undefined4 param_1,int param_2)

{
  ...
  pcVar5 = (char *)(_UNK_0304de38 + 0x304da3c);
  if (*pcVar5 == '\0') {
  ...
  iVar2 = func_0x02953fd4(0x20fb,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x20fb,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  puVar10 = *(undefined4 **)(_UNK_0304de64 + 0x304db5c);
  iVar2 = func_0x04cd2d7c(iVar2,param_2,*puVar10);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_0304de68 + 0x304db7c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0304de6c + 0x304db98));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iVar2 = *(int *)(iVar2 + 0x38);
    iVar7 = 0;
    puVar11 = *(undefined4 **)(_UNK_0304de70 + 0x304dbc0);
    do {
      if (iVar2 == 0) {
        func_0x014388e4();
      }
    ...
    while( true ) {
      ...
      if (*(int *)(iVar3 + 0x24) <= param_2) {
        ...
        if (iVar3 == 0) {
          ...
          func_0x03b75ba0(iVar3,uVar9,**(undefined4 **)(_UNK_0304de74 + 0x304dd38));
        }
      }
      iVar7 = iVar7 + 1;
    }
    ...
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0304de7c + 0x304dd78));
    ...
    iVar6 = **(int **)(_UNK_0304de84 + 0x304ddac);
