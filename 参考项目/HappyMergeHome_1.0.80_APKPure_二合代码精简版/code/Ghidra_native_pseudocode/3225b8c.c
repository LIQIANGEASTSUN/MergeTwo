...

{
  ...
  pcVar7 = (char *)(_UNK_03235cec + 0x3235ba0);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03235cf0 + 0x3235bb4));
    func_0x01438628(*(undefined4 *)(_UNK_03235cf4 + 0x3235bc0));
    func_0x01438628(*(undefined4 *)(_UNK_03235cf8 + 0x3235bcc));
    *pcVar7 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x2ccc,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x2ccc,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03235cfc + 0x3235c24) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_03235d00 + 0x3235c40));
  uVar9 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar10 = **(int **)(_UNK_03235d04 + 0x3235c6c);
