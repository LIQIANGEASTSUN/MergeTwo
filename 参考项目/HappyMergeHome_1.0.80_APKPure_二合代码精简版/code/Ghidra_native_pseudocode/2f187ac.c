...

{
  ...
  pcVar7 = (char *)(_UNK_02f28854 + 0x2f287c0);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f28858 + 0x2f287d4));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x6d3f,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x6d3f,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar6 = **(int **)(_UNK_02f2885c + 0x2f28848);
