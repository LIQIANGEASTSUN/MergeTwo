...
int * FUN_01873474(undefined4 param_1)

{
  ...
  pcVar11 = (char *)(_UNK_01873554 + 0x1873488);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01873558 + 0x187349c));
    func_0x01438628(*(undefined4 *)(_UNK_0187355c + 0x18734a8));
    func_0x01438628(*(undefined4 *)(_UNK_01873560 + 0x18734b4));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x93b4,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x93b4,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    pcVar11 = (char *)(_UNK_02928c8c + 0x2928bac);
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_02928c90 + 0x2928bc0),param_1,0);
      *pcVar11 = '\x01';
    }
    ...
    piVar2 = (int *)func_0x035daef8(&uStack_30,0,**(undefined4 **)(_UNK_02928c94 + 0x2928c7c));
    return piVar2;
  }
  if (*(int *)(**(int **)(_UNK_01873564 + 0x187350c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01873568 + 0x1873528));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar12 = **(int **)(_UNK_0187356c + 0x1873548);
