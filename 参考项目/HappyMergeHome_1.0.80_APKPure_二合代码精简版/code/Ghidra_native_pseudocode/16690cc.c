...
int FUN_016790cc(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0x8758,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8758,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  pcVar6 = (char *)(_UNK_016a904c + 0x16a8ee8);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016a9050 + 0x16a8efc));
    func_0x01438628(*(undefined4 *)(_UNK_016a9054 + 0x16a8f08));
    func_0x01438628(*(undefined4 *)(_UNK_016a9058 + 0x16a8f14));
    func_0x01438628(*(undefined4 *)(_UNK_016a905c + 0x16a8f20));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x1612,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x1612,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_016a9060 + 0x16a8f74) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_016a9064 + 0x16a8f90));
  piVar7 = *(int **)(_UNK_016a9068 + 0x16a8fa4);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_016a906c + 0x16a8fc4);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0xa38);
  if (iVar2 == 0) {
