...
int FUN_03179908(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_03179a84 + 0x317991c);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03179a88 + 0x3179930));
    func_0x01438628(*(undefined4 *)(_UNK_03179a8c + 0x317993c));
    func_0x01438628(*(undefined4 *)(_UNK_03179a90 + 0x3179948));
    func_0x01438628(*(undefined4 *)(_UNK_03179a94 + 0x3179954));
    *pcVar7 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7b46,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x7b46,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03179a98 + 0x31799ac) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03179a9c + 0x31799c8));
  piVar8 = *(int **)(_UNK_03179aa0 + 0x31799dc);
  iVar6 = *piVar8;
  if (*(int *)(iVar6 + 0x74) == 0) {
    func_0x014387a4();
    iVar6 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_03179aa4 + 0x31799fc);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar6 + 0x5c) + 0x64c);
  if (iVar4 == 0) {
