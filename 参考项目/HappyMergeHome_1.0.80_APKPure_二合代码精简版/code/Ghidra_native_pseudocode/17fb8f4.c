...

{
  ...
  pcVar5 = (char *)(_UNK_0180ba58 + 0x180b908);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0180ba5c + 0x180b91c));
    func_0x01438628(*(undefined4 *)(_UNK_0180ba60 + 0x180b928));
    func_0x01438628(*(undefined4 *)(_UNK_0180ba64 + 0x180b934));
    func_0x01438628(*(undefined4 *)(_UNK_0180ba68 + 0x180b940));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x90db,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_0180ba6c + 0x180b998) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0180ba70 + 0x180b9b4));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iVar2 = *(int *)(iVar2 + 0x14);
    if ((iVar2 != 0) && (0 < *(int *)(iVar2 + 0xc))) {
      iVar6 = FUN_018013d8(param_1);
      if (iVar6 == 0) {
        func_0x014388e4();
      }
      iVar6 = *(int *)(iVar6 + 0x6c);
      iVar2 = func_0x0152983c(iVar2,0,**(undefined4 **)(_UNK_0180ba74 + 0x180ba08));
      if (iVar2 == 0) {
        func_0x014388e4();
      }
...
LAB_0180bee8:
    ...
    iVar2 = func_0x029540a4(0x90db,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
