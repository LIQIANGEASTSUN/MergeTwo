...
void FUN_0164e430(int param_1,undefined4 param_2)

{
  ...
  iVar3 = func_0x02953fd4(0x8638,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x8638,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (iVar3 != 0) {
    iVar3 = FUN_0164e190(param_1,param_2);
    if (iVar3 != 0) {
      return;
    }
    iVar3 = FUN_0164dfe8(param_1,param_2);
    if (iVar3 != 0) {
