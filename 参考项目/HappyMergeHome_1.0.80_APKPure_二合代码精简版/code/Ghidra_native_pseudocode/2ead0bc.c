...
undefined4 FUN_02ebd0bc(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_02ebd18c + 0x2ebd0d0);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02ebd190 + 0x2ebd0e4));
    func_0x01438628(*(undefined4 *)(_UNK_02ebd194 + 0x2ebd0f0));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x6a14,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x6a14,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02ebd198 + 0x2ebd148) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_02ebd19c + 0x2ebd164));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  pcVar6 = (char *)(_UNK_029b1044 + 0x29b0f70);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_029b1048 + 0x29b0f84),0x56be,0);
  ...
  if (iVar5 != 0) {
    ...
    if (*pcVar6 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_0289b0e8 + 0x289b004),iVar1,0x56be,0);
      *pcVar6 = '\x01';
    }
    ...
    func_0x01523a2c(&uStack_38,0x56be,0);
    iVar4 = *(int *)(iVar5 + 8);
  ...
  iVar5 = func_0x046ccb14(iVar5,0x56be,**(undefined4 **)(_UNK_029b1050 + 0x29b1000));
  if (iVar5 != 0) {
    ...
    uVar2 = func_0x046cd0dc(iVar1,0x56be,
