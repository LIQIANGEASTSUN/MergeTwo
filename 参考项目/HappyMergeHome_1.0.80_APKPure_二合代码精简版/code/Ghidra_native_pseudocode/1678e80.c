...
void FUN_01688e80(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar6 = (char *)(_UNK_016890fc + 0x1688ea8);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01689100 + 0x1688ebc));
    func_0x01438628(*(undefined4 *)(_UNK_01689104 + 0x1688ec8));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x15ff,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_01689108 + 0x1688f2c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0168910c + 0x1688f4c));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    uVar9 = (uint)lVar15;
    iVar3 = FUN_0167c750(param_1,param_4 - (uVar8 + !bVar10));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x029540a4(0x15ff,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
