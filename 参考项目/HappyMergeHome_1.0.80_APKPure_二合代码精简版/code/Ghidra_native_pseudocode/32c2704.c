...
uint FUN_032d2704(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_032d27f4 + 0x32d2724);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032d27f8 + 0x32d2738));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x83a3,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x83a3,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_032d27fc + 0x32d27b4) + 0x74) == 0) {
    func_0x014387a4();
  }
