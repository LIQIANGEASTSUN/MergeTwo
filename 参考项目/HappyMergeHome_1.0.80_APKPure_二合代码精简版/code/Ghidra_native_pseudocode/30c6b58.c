...

{
  ...
  pcVar7 = (char *)(_UNK_030d6d44 + 0x30d6b70);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030d6d48 + 0x30d6b84));
    func_0x01438628(*(undefined4 *)(_UNK_030d6d4c + 0x30d6b90));
    func_0x01438628(*(undefined4 *)(_UNK_030d6d50 + 0x30d6b9c));
    func_0x01438628(*(undefined4 *)(_UNK_030d6d54 + 0x30d6ba8));
    *pcVar7 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x7721,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x7721,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_030d6d58 + 0x30d6c80) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x04e4a028(**(undefined4 **)(_UNK_030d6d5c + 0x30d6c9c));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  ...
  if ((iVar4 != 0) && (0 < *(int *)(iVar4 + 0xc))) {
    ...
    iVar4 = func_0x04cfd760(iVar4,0,**(undefined4 **)(_UNK_030d6d60 + 0x30d6cf0));
    if (iVar4 == 0) {
      func_0x014388e4();
    }
