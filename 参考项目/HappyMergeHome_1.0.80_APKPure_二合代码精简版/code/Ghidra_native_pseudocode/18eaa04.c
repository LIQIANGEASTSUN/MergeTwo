...
uint FUN_018faa04(int param_1,int param_2)

{
  ...
  pcVar10 = (char *)(_UNK_018faacc + 0x18faa1c);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018faad0 + 0x18faa30));
    *pcVar10 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x46f,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_018faad4 + 0x18faa8c) + 0x74) == 0) {
      func_0x014387a4();
    }
