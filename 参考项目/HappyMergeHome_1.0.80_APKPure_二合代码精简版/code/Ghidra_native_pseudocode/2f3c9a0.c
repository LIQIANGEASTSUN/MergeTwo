...
int FUN_02f4c9a0(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_02f4cad4 + 0x2f4c9b4);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f4cad8 + 0x2f4c9c8));
    func_0x01438628(*(undefined4 *)(_UNK_02f4cadc + 0x2f4c9d4));
    *pcVar4 = '\x01';
  }
  iVar7 = 0;
  iVar1 = func_0x02953fd4(0x6dd6,0);
  if (iVar1 != 0) {
    iVar7 = func_0x029540a4(0x6dd6,0);
    if (iVar7 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = 1;
  puVar8 = *(undefined4 **)(_UNK_02f4cae0 + 0x2f4ca34);
  while( true ) {
