...
void FUN_031c4520(undefined4 param_1,int param_2)

{
  ...
  iVar3 = func_0x02953fd4(0x2a34,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x2a34,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  pcVar6 = (char *)(_UNK_026f12bc + 0x26f1234);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_026f12c0 + 0x26f1248),param_2,0);
