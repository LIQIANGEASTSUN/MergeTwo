...

{
  ...
  pcVar6 = (char *)(_UNK_01681b3c + 0x1681aa8);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01681b40 + 0x1681abc));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x879f,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x879f,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar7 = **(int **)(_UNK_01681b44 + 0x1681b30);
