...
void FUN_02f515e4(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar6 = (char *)(_UNK_02f51860 + 0x2f5160c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f51864 + 0x2f51620));
    func_0x01438628(*(undefined4 *)(_UNK_02f51868 + 0x2f5162c));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x14cf,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_02f5186c + 0x2f51690) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_02f51870 + 0x2f516b0));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    uVar9 = (uint)lVar15;
    iVar3 = FUN_02f44c50(param_1,param_4 - (uVar8 + !bVar10));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x029540a4(0x14cf,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
