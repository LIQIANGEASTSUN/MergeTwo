...
void FUN_02f120fc(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  pcVar1 = (char *)(_UNK_02f12158 + 0x2f12110);
  if (*pcVar1 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f1215c + 0x2f12124));
    *pcVar1 = '\x01';
    param_3 = extraout_r2;
    param_4 = extraout_r3;
  }
  if (*(int *)(**(int **)(_UNK_02f12160 + 0x2f12138) + 0x74) == 0) {
    func_0x014387a4();
