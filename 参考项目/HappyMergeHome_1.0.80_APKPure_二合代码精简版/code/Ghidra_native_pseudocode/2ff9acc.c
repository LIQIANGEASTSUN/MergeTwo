...
void FUN_03009acc(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  pcVar3 = (char *)(_UNK_03009b30 + 0x3009ae0);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03009b34 + 0x3009af4));
    *pcVar3 = '\x01';
    param_4 = extraout_r3;
  }
  piVar1 = *(int **)(_UNK_03009b38 + 0x3009b0c);
