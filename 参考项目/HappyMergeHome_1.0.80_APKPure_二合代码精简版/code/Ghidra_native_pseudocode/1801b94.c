...
undefined4 FUN_01811b94(int param_1)

{
  ...
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0180a05c + 0x18098cc),iVar10,0);
  ...
  if (iVar1 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      *piVar14 = iVar3;
      ...
      iVar9 = FUN_0180255c(iVar9);
      uVar2 = *(undefined4 *)(iVar10 + 8);
      if (iVar9 == 0) {
        func_0x014388e4();
      }
      func_0x024f064c(iVar9,uVar2,aiStack_28,**(undefined4 **)(_UNK_0180a0d8 + 0x1809b88));
      iVar9 = aiStack_28[0];
      if (aiStack_28[0] == 0) {
        func_0x014388e4();
      }
      ...
      iVar9 = func_0x014388d4(**(undefined4 **)(_UNK_0180a0e8 + 0x1809d0c));
      func_0x024f1124(iVar9,**(undefined4 **)(_UNK_0180a0ec + 0x1809d20));
      ...
      *piVar7 = iVar9;
      ...
      if (0 < *(int *)(iVar9 + 0xc)) {
        ...
        iVar9 = FUN_01800148();
        if (iVar9 != 0) {
          func_0x01812f44(iVar9,0);
        }
        if (*(int *)(**(int **)(_UNK_0180a0f4 + 0x1809d94) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar9 = func_0x014e9518(**(undefined4 **)(_UNK_0180a0f8 + 0x1809db4));
        if (iVar9 == 0) {
          func_0x014388e4();
        }
        ...
        iVar9 = func_0x014e96a8(**(undefined4 **)(_UNK_0180a108 + 0x1809f6c));
        iVar10 = *piVar14;
        if (*(int *)(**(int **)(_UNK_0180a10c + 0x1809f80) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_0180a110 + 0x1809fa0));
        if (iVar3 == 0) {
          func_0x014388e4();
        }
