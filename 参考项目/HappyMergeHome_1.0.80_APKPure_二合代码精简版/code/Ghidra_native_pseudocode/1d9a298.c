...

{
  ...
  pcVar9 = (char *)(_UNK_01daa420 + 0x1daa2ac);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01daa424 + 0x1daa2c0));
    func_0x01438628(*(undefined4 *)(_UNK_01daa428 + 0x1daa2cc));
    func_0x01438628(*(undefined4 *)(_UNK_01daa42c + 0x1daa2d8));
    func_0x01438628(*(undefined4 *)(_UNK_01daa430 + 0x1daa2e4));
    func_0x01438628(*(undefined4 *)(_UNK_01daa434 + 0x1daa2f0));
    func_0x01438628(*(undefined4 *)(_UNK_01daa438 + 0x1daa2fc));
    *pcVar9 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x3f09,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x3f09,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01daa43c + 0x1daa360) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01daa440 + 0x1daa37c));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar1 = func_0x036c7bec(iVar1,**(undefined4 **)(_UNK_01daa444 + 0x1daa39c));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar1 + 0x1ac) != 0) {
    func_0x03b73ab8(*(int *)(iVar1 + 0x1ac),**(undefined4 **)(_UNK_01daa448 + 0x1daa3cc));
  }
  if (*(int *)(**(int **)(_UNK_01daa44c + 0x1daa3dc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01daa450 + 0x1daa3f8));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  pcVar9 = (char *)(_UNK_02be82b0 + 0x2be8170);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0xd,0);
  ...
  if (iVar10 != 0) {
    ...
    uStack_38 = 0;
    uStack_28 = 0;
    func_0x024f56c0(&uStack_50,0,0xd,0);
    uStack_38 = uStack_50;
    iStack_34 = uStack_4c;
    uStack_30 = uStack_48;
    uStack_2c = iStack_44;
    ...
    func_0x01523a2c(&uStack_38,0xd,0);
    iVar11 = *(int *)(iVar10 + 8);
  ...
  iVar1 = func_0x046ccb14(uVar3,0xd,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar1 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar2 = (*(code *)*puVar4)(piVar8,0xd,puVar4[1]);
      uVar3 = uStack_30;
    }
    iVar10 = *(int *)(uVar3 + 8);
    iVar1 = iVar10;
