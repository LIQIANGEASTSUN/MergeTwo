...
void FUN_019328ec(int param_1,undefined4 param_2)

{
  ...
  iVar2 = func_0x02953fd4(0x97c0,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x97c0,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (iVar2 != 0) {
    iVar2 = FUN_01932838(param_1,param_2);
    if (iVar2 != 0) {
      return;
    }
    iVar2 = FUN_0193148c(param_1,param_2);
    if (iVar2 != 0) {
