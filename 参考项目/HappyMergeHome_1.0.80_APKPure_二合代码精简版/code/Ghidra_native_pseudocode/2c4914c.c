...

{
  ...
  pcVar5 = (char *)(_UNK_02c591d4 + 0x2c5915c);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c591d8 + 0x2c59170));
    func_0x01438628(*(undefined4 *)(_UNK_02c591dc + 0x2c5917c));
    *pcVar5 = '\x01';
  }
  if (*(int *)(**(int **)(_UNK_02c591e0 + 0x2c59190) + 0x74) == 0) {
    func_0x014387a4();
  }
  ...
  iVar3 = **(int **)(_UNK_02c591e4 + 0x2c591c8);
