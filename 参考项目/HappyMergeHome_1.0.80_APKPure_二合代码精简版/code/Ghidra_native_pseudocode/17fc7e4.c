...
void FUN_0180c7e4(int param_1,undefined4 param_2,int param_3)

{
  ...
  iVar3 = func_0x02953fd4(0x90e1,0);
  if (iVar3 == 0) {
    iVar3 = FUN_018013d8(param_1);
    if (((iVar3 != 0) && (iVar3 = FUN_0180c3a0(param_1,param_2,param_3), iVar3 == 0)) &&
       (iVar3 = FUN_0180c470(param_1,param_2), iVar3 != 0)) {
      if (param_3 == 0) {
      ...
      iVar3 = func_0x02953fd4(0x1e49,0);
      if (iVar3 != 0) {
        iVar3 = func_0x029540a4(0x1e49,0);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
...
LAB_0180bee8:
            ...
            if (*(char *)(iVar2 + 0xd) == '\0') goto LAB_0180bee8;
            iVar2 = FUN_018013d8(param_1);
            if (iVar2 == 0) {
              func_0x014388e4();
            }
    ...
    iVar3 = func_0x029540a4(0x90e1,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
