...
void FUN_03006474(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_0300652c + 0x3006488);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03006530 + 0x300649c));
    *pcVar8 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x7240,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x7240,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x03019b40(param_1);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_03006534 + 0x3006504) + 0x74) == 0) {
    func_0x014387a4();
  }
