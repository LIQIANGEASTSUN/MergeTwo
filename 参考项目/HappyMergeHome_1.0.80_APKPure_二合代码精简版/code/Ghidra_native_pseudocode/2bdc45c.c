...
undefined4 FUN_02bec45c(int param_1,uint *param_2)

{
  ...
  pcVar4 = (char *)(_UNK_02bec620 + 0x2bec478);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02bec624 + 0x2bec48c));
    func_0x01438628(*(undefined4 *)(_UNK_02bec628 + 0x2bec498));
    *pcVar4 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x5edf,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x5edf,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar2 = 4;
  piVar8 = *(int **)(_UNK_02bec62c + 0x2bec4fc);
  puVar9 = *(undefined4 **)(_UNK_02bec630 + 0x2bec504);
  do {
    ...
    if (*(int *)(iVar5 + 0x14) == 1) {
      ...
      iVar5 = func_0x02c4a88c(iVar5,uVar6,0);
      if (iVar5 != 0) {
        iVar5 = *(int *)(param_1 + 0x44);
        *param_2 = uVar1;
        if (iVar5 == 0) {
