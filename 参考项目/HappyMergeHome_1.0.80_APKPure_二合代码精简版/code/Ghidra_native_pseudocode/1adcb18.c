...
undefined4 FUN_01aecb18(int param_1)

{
  ...
  pcVar3 = (char *)(_UNK_01aeccb8 + 0x1aecb30);
  if (*pcVar3 == '\0') {
  ...
  if (iVar1 == 0) {
    piVar5 = *(int **)(_UNK_01aeccc0 + 0x1aecba0);
    ...
    if (iVar1 == 0) {
      ...
      iVar1 = func_0x02b63a9c(iVar4,0x206e,0,0);
      if (iVar1 == 0) {
        param_1 = func_0x01b36e78(0);
        if (param_1 == 0) {
          func_0x014388e4();
        }
        pcVar3 = (char *)(_UNK_01b4bdc8 + 0x1b4bd20);
        if (*pcVar3 == '\0') {
        ...
        if (iVar1 == 0) {
          ...
          pcVar3 = (char *)(_UNK_01b4babc + 0x1b4b9ac);
          if (*pcVar3 == '\0') {
          ...
          if (iVar1 == 0) {
            piVar5 = *(int **)(_UNK_01b4bac4 + 0x1b4ba1c);
            iVar1 = **(int **)(*piVar5 + 0x5c);
            if (iVar1 == 0) {
              func_0x014388e4();
            }
            ...
            if (iVar1 == 0) {
              ...
              if (iVar1 == 0) {
                ...
                uStack_18 = 0;
                uVar6 = func_0x02b6127c(iVar1,0x206e,0,0);
                return uVar6;
              }
            }
            return 0;
