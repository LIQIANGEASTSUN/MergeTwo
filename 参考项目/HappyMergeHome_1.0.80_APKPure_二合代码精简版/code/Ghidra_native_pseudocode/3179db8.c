...
undefined4 FUN_03189db8(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_03189e94 + 0x3189dcc);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03189e98 + 0x3189de0));
    func_0x01438628(*(undefined4 *)(_UNK_03189e9c + 0x3189dec));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7bb6,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_03189ea0 + 0x3189e44) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03189ea4 + 0x3189e60));
    uVar7 = func_0x03189ea8(param_1);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = func_0x029540a4(0x7bb6,0);
  if (iVar3 == 0) {
    func_0x014388e4();
  }
