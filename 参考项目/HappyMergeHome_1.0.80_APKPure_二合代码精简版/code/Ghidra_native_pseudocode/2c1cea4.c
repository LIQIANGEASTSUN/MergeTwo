...
undefined4 FUN_02c2cea4(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2d064 + 0x2c2ceb8);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2d068 + 0x2c2cecc));
    func_0x01438628(*(undefined4 *)(_UNK_02c2d06c + 0x2c2ced8));
    func_0x01438628(*(undefined4 *)(_UNK_02c2d070 + 0x2c2cee4));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5dad,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5dad,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2d074 + 0x2c2d00c));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2d078 + 0x2c2d028),0);
  if (*(int *)(**(int **)(_UNK_02c2d07c + 0x2c2d03c) + 0x74) == 0) {
    func_0x014387a4();
  }
