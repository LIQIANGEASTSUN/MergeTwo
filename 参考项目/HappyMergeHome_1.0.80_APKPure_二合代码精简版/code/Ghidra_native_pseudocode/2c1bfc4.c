...
undefined4 FUN_02c2bfc4(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2c184 + 0x2c2bfd8);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2c188 + 0x2c2bfec));
    func_0x01438628(*(undefined4 *)(_UNK_02c2c18c + 0x2c2bff8));
    func_0x01438628(*(undefined4 *)(_UNK_02c2c190 + 0x2c2c004));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d9d,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d9d,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2c194 + 0x2c2c12c));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2c198 + 0x2c2c148),0);
  if (*(int *)(**(int **)(_UNK_02c2c19c + 0x2c2c15c) + 0x74) == 0) {
    func_0x014387a4();
  }
