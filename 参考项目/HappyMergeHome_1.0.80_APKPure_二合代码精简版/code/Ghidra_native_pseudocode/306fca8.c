...
undefined4 FUN_0307fca8(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_0307fd58 + 0x307fcc0);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0307fd5c + 0x307fcd4));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x1515,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x1515,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x03080c00(param_1);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar4 = **(int **)(_UNK_0307fd60 + 0x307fd4c);
