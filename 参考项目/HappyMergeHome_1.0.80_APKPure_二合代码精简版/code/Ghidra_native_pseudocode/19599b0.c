...
int FUN_019699b0(undefined4 param_1,int param_2)

{
  ...
  pcVar5 = (char *)(_UNK_01969dc8 + 0x19699cc);
  if (*pcVar5 == '\0') {
  ...
  iVar1 = func_0x02953fd4(0x1fa5,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x1fa5,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  puVar10 = *(undefined4 **)(_UNK_01969df4 + 0x1969aec);
  iVar1 = func_0x024f0f34(iVar1,param_2,*puVar10);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_01969df8 + 0x1969b0c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01969dfc + 0x1969b28));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    iVar1 = *(int *)(iVar1 + 0x38);
    iVar8 = 0;
    puVar11 = *(undefined4 **)(_UNK_01969e00 + 0x1969b50);
    do {
      if (iVar1 == 0) {
        func_0x014388e4();
      }
    ...
    while( true ) {
      ...
      if (*(int *)(iVar2 + 0x24) <= param_2) {
        ...
        if (iVar2 == 0) {
          ...
          func_0x024f05ac(iVar2,uVar9,**(undefined4 **)(_UNK_01969e04 + 0x1969cc8));
        }
      }
      iVar8 = iVar8 + 1;
    }
    ...
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01969e0c + 0x1969d08));
    piVar7 = *(int **)(_UNK_01969e10 + 0x1969d1c);
    iVar8 = *piVar7;
    if (*(int *)(iVar8 + 0x74) == 0) {
      func_0x014387a4();
      iVar8 = *piVar7;
    }
    iVar6 = **(int **)(_UNK_01969e14 + 0x1969d3c);
