...

{
  ...
  pcVar3 = (char *)(_UNK_01c0ed24 + 0x1c0ec88);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01c0ed28 + 0x1c0ec9c));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xaae9,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xaae9,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01c0ed2c + 0x1c0ecf0) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_01c0ddc4();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
