...
uint FUN_02a02314(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02a023b4 + 0x2a02328);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02a023b8 + 0x2a0233c));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x2655,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x2655,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02a023bc + 0x2a02394) + 0x74) == 0) {
    func_0x014387a4();
  }
  ...
  if (iVar2 != 0) {
    ...
    func_0x01523a2c(&uStack_30,0x20,0);
    iVar4 = *(int *)(iVar2 + 8);
    uVar6 = *(undefined4 *)(iVar2 + 0xc);
    iVar2 = *(int *)(iVar2 + 0x10);
    if (iVar4 == 0) {
