...
void FUN_0317ad88(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_0317ae40 + 0x317ad9c);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0317ae44 + 0x317adb0));
    *pcVar8 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x7b4e,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x7b4e,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x0318d850(param_1);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_0317ae48 + 0x317ae18) + 0x74) == 0) {
    func_0x014387a4();
  }
