...
int FUN_03236bcc(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_03236d48 + 0x3236be0);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03236d4c + 0x3236bf4));
    func_0x01438628(*(undefined4 *)(_UNK_03236d50 + 0x3236c00));
    func_0x01438628(*(undefined4 *)(_UNK_03236d54 + 0x3236c0c));
    func_0x01438628(*(undefined4 *)(_UNK_03236d58 + 0x3236c18));
    *pcVar7 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7f85,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x7f85,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03236d5c + 0x3236c70) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03236d60 + 0x3236c8c));
  piVar8 = *(int **)(_UNK_03236d64 + 0x3236ca0);
  iVar6 = *piVar8;
  if (*(int *)(iVar6 + 0x74) == 0) {
    func_0x014387a4();
    iVar6 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_03236d68 + 0x3236cc0);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar6 + 0x5c) + 0xafc);
  if (iVar4 == 0) {
