...
undefined4 FUN_02c2c558(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2c718 + 0x2c2c56c);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2c71c + 0x2c2c580));
    func_0x01438628(*(undefined4 *)(_UNK_02c2c720 + 0x2c2c58c));
    func_0x01438628(*(undefined4 *)(_UNK_02c2c724 + 0x2c2c598));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5da3,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5da3,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2c728 + 0x2c2c6c0));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2c72c + 0x2c2c6dc),0);
  if (*(int *)(**(int **)(_UNK_02c2c730 + 0x2c2c6f0) + 0x74) == 0) {
    func_0x014387a4();
  }
