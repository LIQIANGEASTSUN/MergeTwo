...
uint FUN_017a29ac(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_017a2a94 + 0x17a29cc);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017a2a98 + 0x17a29e0));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8e72,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8e72,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_017a2a9c + 0x17a2a5c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_0179d7ec();
  if (iVar2 == 0) {
  ...
  pcVar11 = (char *)(_UNK_017a22d8 + 0x17a21d0);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017a22dc + 0x17a21e4));
    func_0x01438628(*(undefined4 *)(_UNK_017a22e0 + 0x17a21f0));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8e6e,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_017a22e4 + 0x17a224c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_017a22e8 + 0x17a2268));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_017aab90 + 0x17aa95c);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_017aab94 + 0x17aa970));
      func_0x01438628(*(undefined4 *)(_UNK_017aab98 + 0x17aa97c));
      func_0x01438628(*(undefined4 *)(_UNK_017aab9c + 0x17aa988));
      func_0x01438628(*(undefined4 *)(_UNK_017aaba0 + 0x17aa994));
      func_0x01438628(*(undefined4 *)(_UNK_017aaba4 + 0x17aa9a0));
      func_0x01438628(*(undefined4 *)(_UNK_017aaba8 + 0x17aa9ac));
      func_0x01438628(*(undefined4 *)(_UNK_017aabac + 0x17aa9b8));
      *pcVar11 = '\x01';
    }
    iVar1 = func_0x02953fd4(0x8e51,0);
    if (iVar1 == 0) {
      iVar1 = func_0x017a4c08(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x024f0540(iVar1,param_3,**(undefined4 **)(_UNK_017aabb0 + 0x17aaa34));
      if (iVar1 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x024eee28(**(undefined4 **)(_UNK_017aabb4 + 0x17aaa98),uVar10,
                                 **(undefined4 **)(_UNK_017aabb8 + 0x17aaaa4),0);
        if (*(int *)(**(int **)(_UNK_017aabbc + 0x17aaab8) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_3,**(undefined4 **)(_UNK_017aabc4 + 0x17aaaec));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar1,param_3,**(undefined4 **)(_UNK_017aabc0 + 0x17aaa68));
        }
        func_0x024f10d4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_017aabc8 + 0x17aab10));
        iVar1 = func_0x017a4c08(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x024f05d4(iVar1,param_3,**(undefined4 **)(_UNK_017aabcc + 0x17aab40));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x017a4c08(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_017aabd0 + 0x17aab80);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x8e51,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x8e6e,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
