...

{
  ...
  pcVar7 = (char *)(_UNK_0179de20 + 0x179dcd4);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0179de24 + 0x179dce8));
    func_0x01438628(*(undefined4 *)(_UNK_0179de28 + 0x179dcf4));
    func_0x01438628(*(undefined4 *)(_UNK_0179de2c + 0x179dd00));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x2a3a,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x2a3a,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0179de30 + 0x179dd58) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0179de34 + 0x179dd74));
  uVar10 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar9 = **(int **)(_UNK_0179de38 + 0x179dda0);
