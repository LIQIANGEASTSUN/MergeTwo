...

{
  ...
  pcVar7 = (char *)(_UNK_0304960c + 0x3049578);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03049610 + 0x304958c));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x741d,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x741d,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar6 = **(int **)(_UNK_03049614 + 0x3049600);
