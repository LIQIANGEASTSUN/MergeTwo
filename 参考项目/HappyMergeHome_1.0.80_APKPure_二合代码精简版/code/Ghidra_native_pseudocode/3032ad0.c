...
uint FUN_03042ad0(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_03042bb8 + 0x3042af0);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03042bbc + 0x3042b04));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7401,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7401,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_03042bc0 + 0x3042b80) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_0303cc6c();
  if (iVar2 == 0) {
  ...
  pcVar11 = (char *)(_UNK_030423a8 + 0x30422a0);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030423ac + 0x30422b4));
    func_0x01438628(*(undefined4 *)(_UNK_030423b0 + 0x30422c0));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x73fd,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_030423b4 + 0x304231c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_030423b8 + 0x3042338));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    iVar1 = FUN_029a6fa8(iVar1,param_3,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uVar3 = *(uint *)(iVar1 + 0x30);
    iVar1 = func_0x03044930(iVar2);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_0304bd44 + 0x304bb10);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_0304bd48 + 0x304bb24));
      func_0x01438628(*(undefined4 *)(_UNK_0304bd4c + 0x304bb30));
      func_0x01438628(*(undefined4 *)(_UNK_0304bd50 + 0x304bb3c));
      func_0x01438628(*(undefined4 *)(_UNK_0304bd54 + 0x304bb48));
      func_0x01438628(*(undefined4 *)(_UNK_0304bd58 + 0x304bb54));
      func_0x01438628(*(undefined4 *)(_UNK_0304bd5c + 0x304bb60));
      func_0x01438628(*(undefined4 *)(_UNK_0304bd60 + 0x304bb6c));
      *pcVar11 = '\x01';
    }
    iVar1 = func_0x02953fd4(0x73d1,0);
    if (iVar1 == 0) {
      iVar1 = func_0x03045d3c(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x046c26fc(iVar1,param_3,**(undefined4 **)(_UNK_0304bd64 + 0x304bbe8));
      if (iVar1 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x04f6b198(**(undefined4 **)(_UNK_0304bd68 + 0x304bc4c),uVar10,
                                 **(undefined4 **)(_UNK_0304bd6c + 0x304bc58),0);
        if (*(int *)(**(int **)(_UNK_0304bd70 + 0x304bc6c) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_3,**(undefined4 **)(_UNK_0304bd78 + 0x304bca0));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_0304bd74 + 0x304bc1c));
        }
        func_0x03b70fe4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_0304bd7c + 0x304bcc4));
        iVar1 = func_0x03045d3c(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_0304bd80 + 0x304bcf4));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x03045d3c(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_0304bd84 + 0x304bd34);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x73d1,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x73fd,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
