...
void FUN_032b2a0c(undefined4 param_1)

{
  ...
  iVar3 = func_0x02953fd4(0x293e,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x293e,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = FUN_032b29a0(param_1);
  iVar3 = iVar3 + 1;
  iVar5 = func_0x02953fd4(0x2940,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x2940,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_026eeb20 + 0x26eeaa8),iVar3,0);
