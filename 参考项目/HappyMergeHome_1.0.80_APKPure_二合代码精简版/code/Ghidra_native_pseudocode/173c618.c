...
uint FUN_0174c618(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_0174c700 + 0x174c638);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0174c704 + 0x174c64c));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8ce9,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8ce9,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0174c708 + 0x174c6c8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_01747688();
  if (iVar1 == 0) {
  ...
  iVar3 = func_0x02953fd4(0x8cea,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_0174c838 + 0x174c7a0) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_0174c83c + 0x174c7bc));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    iVar3 = func_0x02953fd4(0x8cca,0);
    if (iVar3 == 0) {
      iVar3 = func_0x017501c0(iVar1);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x024f0540(iVar3,param_3,**(undefined4 **)(_UNK_017561e4 + 0x1756068));
      if (iVar3 == 0) {
        ...
        if (iVar3 == 0) {
          ...
          iVar9 = func_0x024f05d4(iVar3,param_3,**(undefined4 **)(_UNK_017561f4 + 0x175609c));
        }
        func_0x024f10d4(iVar3,param_3,iVar9 + -1,**(undefined4 **)(_UNK_017561fc + 0x1756144));
        iVar3 = func_0x017501c0(iVar1);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x024f05d4(iVar3,param_3,**(undefined4 **)(_UNK_01756200 + 0x1756174));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x017501c0(iVar1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar3 = **(int **)(_UNK_01756204 + 0x17561b4);
...
LAB_046c3e4c:
    ...
    iVar3 = func_0x029540a4(0x8cca,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar3 = func_0x029540a4(0x8cea,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
