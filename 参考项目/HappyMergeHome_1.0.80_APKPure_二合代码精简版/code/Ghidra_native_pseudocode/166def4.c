...
undefined4 FUN_0167def4(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_0167dfe0 + 0x167df08);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0167dfe4 + 0x167df1c));
    func_0x01438628(*(undefined4 *)(_UNK_0167dfe8 + 0x167df28));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8794,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8794,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0167dfec + 0x167df80) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0167dff0 + 0x167df9c));
  iVar6 = FUN_0167cf64(param_1);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
