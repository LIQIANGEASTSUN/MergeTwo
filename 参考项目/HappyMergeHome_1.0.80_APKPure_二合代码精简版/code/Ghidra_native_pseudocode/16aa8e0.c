...
/* WARNING: Possible PIC construction at 0x016baa60: Changing call to branch */
/* WARNING: Possible PIC construction at 0x016baa88: Changing call to branch */
/* WARNING: Possible PIC construction at 0x016baab0: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x016baa8c) */
/* WARNING: Removing unreachable block (ram,0x016baaa0) */
/* WARNING: Removing unreachable block (ram,0x016baaa4) */
/* WARNING: Removing unreachable block (ram,0x016baa64) */
/* WARNING: Removing unreachable block (ram,0x016baa78) */
/* WARNING: Removing unreachable block (ram,0x016baa7c) */
/* WARNING: Removing unreachable block (ram,0x016baab4) */
/* WARNING: Removing unreachable block (ram,0x016baac8) */
/* WARNING: Removing unreachable block (ram,0x016baacc) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_016ba8e0(int param_1)

{
  ...
  pcVar10 = (char *)(_UNK_016baae0 + 0x16ba8f4);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016baae4 + 0x16ba908));
    func_0x01438628(*(undefined4 *)(_UNK_016baae8 + 0x16ba914));
    func_0x01438628(*(undefined4 *)(_UNK_016baaec + 0x16ba920));
    func_0x01438628(*(undefined4 *)(_UNK_016baaf0 + 0x16ba92c));
    func_0x01438628(*(undefined4 *)(_UNK_016baaf4 + 0x16ba938));
    func_0x01438628(*(undefined4 *)(_UNK_016baaf8 + 0x16ba944));
    *pcVar10 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8925,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8925,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_016baafc + 0x16ba9a8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_016bab00 + 0x16ba9c4));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar1 = func_0x024f04cc(iVar1,**(undefined4 **)(_UNK_016bab04 + 0x16ba9e4));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar1 + 0x35c) != 0) {
    func_0x024f04d0(*(int *)(iVar1 + 0x35c),**(undefined4 **)(_UNK_016bab08 + 0x16baa14));
  }
  if (*(int *)(**(int **)(_UNK_016bab0c + 0x16baa24) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar11 = *(undefined4 **)(_UNK_016bab10 + 0x16baa40);
  ...
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x32,0);
  ...
  if (iVar1 != 0) {
    ...
    puStack_30 = puVar2;
    puStack_2c = puVar11;
    func_0x024f56c0(&uStack_60,0,0x32,0);
    ...
    func_0x01523a2c(&puStack_48,0x32,0);
    iVar12 = *(int *)(iVar1 + 8);
    uVar13 = *(undefined4 *)(iVar1 + 0xc);
    iVar1 = *(int *)(iVar1 + 0x10);
    if (iVar12 == 0) {
  ...
  iVar12 = func_0x046ccb14(iVar1,0x32,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar12 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar3 = (*(code *)*puVar2)(piVar9,0x32,puVar2[1]);
      iVar1 = iStack_40;
    }
    iVar12 = *(int *)(iVar1 + 8);
    iVar1 = iVar12;
