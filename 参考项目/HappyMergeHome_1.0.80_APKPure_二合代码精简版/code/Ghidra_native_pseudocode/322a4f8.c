...
void FUN_0323a4f8(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  pcVar2 = (char *)(_UNK_0323a63c + 0x323a518);
  if (*pcVar2 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0323a640 + 0x323a530));
    *pcVar2 = '\x01';
  }
  ...
  uStack_38 = uStack_58;
  uStack_34 = uStack_54;
  iVar1 = func_0x02953fd4(0x7f97,0);
  if (iVar1 == 0) {
    ...
    *puVar3 = uStack_70;
    ...
    uStack_44 = param_3;
    uStack_40 = param_4;
    func_0x035cbd10(puVar3,&uStack_60,**(undefined4 **)(_UNK_0323a644 + 0x323a624));
  }
  else {
    iVar1 = func_0x029540a4(0x7f97,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
