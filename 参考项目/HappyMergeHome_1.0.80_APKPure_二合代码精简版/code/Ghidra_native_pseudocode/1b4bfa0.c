...
int FUN_01b5bfa0(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_01b5c0f4 + 0x1b5bfb4);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01b5c0f8 + 0x1b5bfc8));
    func_0x01438628(*(undefined4 *)(_UNK_01b5c0fc + 0x1b5bfd4));
    func_0x01438628(*(undefined4 *)(_UNK_01b5c100 + 0x1b5bfe0));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xa68a,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xa68a,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01b5c104 + 0x1b5c038) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01b5c108 + 0x1b5c054));
  uVar10 = FUN_01b5b810(param_1);
  iVar9 = **(int **)(_UNK_01b5c10c + 0x1b5c074);
