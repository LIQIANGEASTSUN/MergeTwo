...
void FUN_02c748ac(int param_1,uint param_2)

{
  ...
  pcVar4 = (char *)(_UNK_02c74b6c + 0x2c748c8);
  if (*pcVar4 == '\0') {
  ...
  iVar5 = func_0x014e9518(**(undefined4 **)(_UNK_02c74b94 + 0x2c749f8));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  ...
  iVar5 = FUN_02c4b828(iVar5,uVar6,0);
  if (iVar5 == 4) {
    if (*(int *)(*piVar8 + 0x74) == 0) {
      func_0x014387a4();
    }
    ...
    iVar5 = FUN_02baeb18(iVar5,uVar6,0);
    if (iVar5 != 0) {
      return;
    }
  }
  ...
  iVar5 = func_0x014e9518(**(undefined4 **)(_UNK_02c74b9c + 0x2c74ab4));
  if (iVar5 == 0) {
    func_0x014388e4();
  }
  uVar10 = func_0x026ffbe0(iVar5,0);
  uVar10 = func_0x014e6e04((int)uVar10,(int)((ulonglong)uVar10 >> 0x20),1000,0);
  iVar5 = (int)((ulonglong)uVar10 >> 0x20);
  uStack_30 = 0;
  FUN_026f7520(iVar1,iVar5,(uint)uVar10 - param_2,
               iVar5 - (((int)param_2 >> 0x1f) + (uint)((uint)uVar10 < param_2)));
  if (*(int *)(*piVar8 + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x014e9518(*puVar9);
  ...
  if (iVar1 == 0) {
    ...
    *(undefined4 *)(iVar1 + 0x9c) = uVar3;
    pcVar4 = (char *)(_UNK_02c6e96c + 0x2c6e644);
    if (*pcVar4 == '\0') {
...
SUB_02868e1c:
  ...
  uStack_50 = 0;
  uStack_4c = 0;
  func_0x024f56d0(iVar5,uVar6,&uStack_30,uVar3);
  return;
}
