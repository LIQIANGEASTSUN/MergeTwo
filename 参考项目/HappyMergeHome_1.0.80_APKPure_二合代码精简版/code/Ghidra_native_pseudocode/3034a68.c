...
undefined4 FUN_03044a68(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_03044b18 + 0x3044a80);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03044b1c + 0x3044a94));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x1488,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x1488,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x030459c0(param_1);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar4 = **(int **)(_UNK_03044b20 + 0x3044b0c);
