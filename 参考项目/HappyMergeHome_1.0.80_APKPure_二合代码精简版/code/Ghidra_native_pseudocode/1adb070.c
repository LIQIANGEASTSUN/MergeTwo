...
int FUN_01aeb070(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_01aeb1fc + 0x1aeb084);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01aeb200 + 0x1aeb098));
    func_0x01438628(*(undefined4 *)(_UNK_01aeb204 + 0x1aeb0a4));
    func_0x01438628(*(undefined4 *)(_UNK_01aeb208 + 0x1aeb0b0));
    func_0x01438628(*(undefined4 *)(_UNK_01aeb20c + 0x1aeb0bc));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xd27,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xd27,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = FUN_01aeafb0(param_1);
  if (iVar1 == 0) {
    return 0;
  }
  if (*(int *)(**(int **)(_UNK_01aeb210 + 0x1aeb124) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01aeb214 + 0x1aeb140));
  piVar7 = *(int **)(_UNK_01aeb218 + 0x1aeb154);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_01aeb21c + 0x1aeb174);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0x154);
  if (iVar2 == 0) {
