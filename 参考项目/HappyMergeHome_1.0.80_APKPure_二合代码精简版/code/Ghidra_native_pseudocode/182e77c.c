...

{
  ...
  pcVar6 = (char *)(_UNK_0183e968 + 0x183e794);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0183e96c + 0x183e7a8));
    func_0x01438628(*(undefined4 *)(_UNK_0183e970 + 0x183e7b4));
    func_0x01438628(*(undefined4 *)(_UNK_0183e974 + 0x183e7c0));
    func_0x01438628(*(undefined4 *)(_UNK_0183e978 + 0x183e7cc));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x924c,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x924c,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0183e97c + 0x183e8a4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0183e980 + 0x183e8c0));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  iVar2 = *(int *)(iVar2 + 0x14);
  if ((iVar2 != 0) && (0 < *(int *)(iVar2 + 0xc))) {
    iVar7 = FUN_0183a850(param_1);
    if (iVar7 == 0) {
      func_0x014388e4();
    }
    iVar7 = *(int *)(iVar7 + 0x6c);
    iVar2 = func_0x0152983c(iVar2,0,**(undefined4 **)(_UNK_0183e984 + 0x183e914));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
