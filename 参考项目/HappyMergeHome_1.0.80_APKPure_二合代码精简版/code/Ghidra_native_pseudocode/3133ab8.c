...
uint FUN_03143ab8(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar2 = func_0x02953fd4(0x7a02,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_03143be4 + 0x3143b4c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_03143be8 + 0x3143b68));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x02953fd4(0x79e2,0);
    if (iVar2 == 0) {
      iVar2 = func_0x0314741c(param_1);
      if (iVar2 == 0) {
        func_0x014388e4();
      }
      iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_0314d438 + 0x314d2bc));
      if (iVar2 == 0) {
        ...
        if (iVar2 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_0314d44c + 0x314d374));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar2,param_2,**(undefined4 **)(_UNK_0314d448 + 0x314d2f0));
        }
        func_0x03b70fe4(iVar2,param_2,iVar9 + -1,**(undefined4 **)(_UNK_0314d450 + 0x314d398));
        iVar2 = func_0x0314741c(param_1);
        if (iVar2 == 0) {
          func_0x014388e4();
        }
        uVar1 = func_0x03b70fac(iVar2,param_2,**(undefined4 **)(_UNK_0314d454 + 0x314d3c8));
        if ((int)uVar1 < 1) {
          iVar2 = func_0x0314741c(param_1);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar9 = **(int **)(_UNK_0314d458 + 0x314d408);
...
LAB_046c3e4c:
    ...
    iVar2 = func_0x029540a4(0x79e2,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar2 = func_0x029540a4(0x7a02,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
