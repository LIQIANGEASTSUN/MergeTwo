...
undefined4 FUN_02c2985c(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c29a1c + 0x2c29870);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c29a20 + 0x2c29884));
    func_0x01438628(*(undefined4 *)(_UNK_02c29a24 + 0x2c29890));
    func_0x01438628(*(undefined4 *)(_UNK_02c29a28 + 0x2c2989c));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d75,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d75,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c29a2c + 0x2c299c4));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c29a30 + 0x2c299e0),0);
  if (*(int *)(**(int **)(_UNK_02c29a34 + 0x2c299f4) + 0x74) == 0) {
    func_0x014387a4();
  }
