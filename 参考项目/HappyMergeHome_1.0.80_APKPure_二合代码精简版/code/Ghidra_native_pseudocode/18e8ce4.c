...
undefined4
FUN_018f8ce4(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  pcVar7 = (char *)(_UNK_018f8edc + 0x18f8d04);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018f8ee0 + 0x18f8d24));
    func_0x01438628(*(undefined4 *)(_UNK_018f8ee4 + 0x18f8d30));
    func_0x01438628(*(undefined4 *)(_UNK_018f8ee8 + 0x18f8d3c));
    func_0x01438628(*(undefined4 *)(_UNK_018f8eec + 0x18f8d48));
    func_0x01438628(*(undefined4 *)(_UNK_018f8ef0 + 0x18f8d54));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x966a,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x966a,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_34 = param_5;
  ...
  if (*(int *)(**(int **)(_UNK_018f8ef4 + 0x18f8dc4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_018f5b04();
  if (iVar1 == 0) {
  ...
  func_0x018f8f08(iVar1,param_4,param_6);
  iVar1 = FUN_018f5b04();
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  func_0x018f901c(iVar1);
  piVar6 = *(int **)(_UNK_018f8ef8 + 0x18f8e20);
  iVar1 = *piVar6;
  if (*(int *)(iVar1 + 0x74) == 0) {
    func_0x014387a4();
    iVar1 = *piVar6;
  ...
  if (iVar5 == 0) {
    ...
    iVar5 = func_0x014388d4(**(undefined4 **)(_UNK_018f8efc + 0x18f8e68));
    func_0x0152e3ec(iVar5,uVar2,**(undefined4 **)(_UNK_018f8f00 + 0x18f8e88),0);
    piVar6 = (int *)(*(int *)(*piVar6 + 0x5c) + 4);
    *piVar6 = iVar5;
    func_0x014385cc(piVar6,iVar5);
  }
  if (*(int *)(**(int **)(_UNK_018f8f04 + 0x18f8eb0) + 0x74) == 0) {
    func_0x014387a4();
  }
