...
undefined4 FUN_0318ef70(int param_1)

{
  ...
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031874bc + 0x3186d2c),iVar10,0);
  ...
  if (iVar1 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      *piVar14 = iVar3;
      ...
      iVar9 = FUN_0317fa04(iVar9);
      uVar2 = *(undefined4 *)(iVar10 + 8);
      if (iVar9 == 0) {
        func_0x014388e4();
      }
      func_0x046ce3e4(iVar9,uVar2,aiStack_28,**(undefined4 **)(_UNK_03187538 + 0x3186fe8));
      iVar9 = aiStack_28[0];
      if (aiStack_28[0] == 0) {
        func_0x014388e4();
      }
      ...
      iVar9 = func_0x014388d4(**(undefined4 **)(_UNK_03187548 + 0x318716c));
      func_0x03bbd054(iVar9,**(undefined4 **)(_UNK_0318754c + 0x3187180));
      ...
      *piVar7 = iVar9;
      ...
      if (0 < *(int *)(iVar9 + 0xc)) {
        ...
        iVar9 = FUN_0317d564();
        if (iVar9 != 0) {
          func_0x03190320(iVar9,0);
        }
        if (*(int *)(**(int **)(_UNK_03187554 + 0x31871f4) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar9 = func_0x04e4a028(**(undefined4 **)(_UNK_03187558 + 0x3187214));
        if (iVar9 == 0) {
          func_0x014388e4();
        }
        ...
        iVar9 = func_0x03b2c734(**(undefined4 **)(_UNK_03187568 + 0x31873cc));
        iVar10 = *piVar14;
        if (*(int *)(**(int **)(_UNK_0318756c + 0x31873e0) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03187570 + 0x3187400));
        if (iVar3 == 0) {
          func_0x014388e4();
        }
