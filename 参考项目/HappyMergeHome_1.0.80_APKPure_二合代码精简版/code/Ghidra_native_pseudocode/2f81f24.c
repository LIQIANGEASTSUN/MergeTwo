...
void FUN_02f91f24(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_02f91fe8 + 0x2f91f3c);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f91fec + 0x2f91f50));
    *pcVar10 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x6f3a,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x6f3a,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x02fa2fc4(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_02f91ff0 + 0x2f91fc0) + 0x74) == 0) {
    func_0x014387a4();
  }
