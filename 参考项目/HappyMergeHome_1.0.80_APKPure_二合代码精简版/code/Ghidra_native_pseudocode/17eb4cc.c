...

{
  ...
  pcVar7 = (char *)(_UNK_017fb62c + 0x17fb4e0);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017fb630 + 0x17fb4f4));
    func_0x01438628(*(undefined4 *)(_UNK_017fb634 + 0x17fb500));
    func_0x01438628(*(undefined4 *)(_UNK_017fb638 + 0x17fb50c));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x2946,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x2946,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_017fb63c + 0x17fb564) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_017fb640 + 0x17fb580));
  uVar10 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar9 = **(int **)(_UNK_017fb644 + 0x17fb5ac);
