...
undefined4 FUN_02c295e8(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c29830 + 0x2c295fc);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c29834 + 0x2c29610));
    func_0x01438628(*(undefined4 *)(_UNK_02c29838 + 0x2c2961c));
    func_0x01438628(*(undefined4 *)(_UNK_02c2983c + 0x2c29628));
    func_0x01438628(*(undefined4 *)(_UNK_02c29840 + 0x2c29634));
    func_0x01438628(*(undefined4 *)(_UNK_02c29844 + 0x2c29640));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d73,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d73,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02c29848 + 0x2c2974c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_02c2984c + 0x2c29768));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c29850 + 0x2c297d8));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c29854 + 0x2c297f4),0);
  if (*(int *)(**(int **)(_UNK_02c29858 + 0x2c29808) + 0x74) == 0) {
    func_0x014387a4();
  }
