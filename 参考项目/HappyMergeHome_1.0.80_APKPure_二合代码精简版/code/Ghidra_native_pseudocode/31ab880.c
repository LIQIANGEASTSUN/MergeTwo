...
/* WARNING: Possible PIC construction at 0x031bba00: Changing call to branch */
/* WARNING: Possible PIC construction at 0x031bba28: Changing call to branch */
/* WARNING: Possible PIC construction at 0x031bba50: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x031bba2c) */
/* WARNING: Removing unreachable block (ram,0x031bba40) */
/* WARNING: Removing unreachable block (ram,0x031bba44) */
/* WARNING: Removing unreachable block (ram,0x031bba04) */
/* WARNING: Removing unreachable block (ram,0x031bba18) */
/* WARNING: Removing unreachable block (ram,0x031bba1c) */
/* WARNING: Removing unreachable block (ram,0x031bba54) */
/* WARNING: Removing unreachable block (ram,0x031bba68) */
/* WARNING: Removing unreachable block (ram,0x031bba6c) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_031bb880(int param_1)

{
  ...
  pcVar11 = (char *)(_UNK_031bba80 + 0x31bb894);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031bba84 + 0x31bb8a8));
    func_0x01438628(*(undefined4 *)(_UNK_031bba88 + 0x31bb8b4));
    func_0x01438628(*(undefined4 *)(_UNK_031bba8c + 0x31bb8c0));
    func_0x01438628(*(undefined4 *)(_UNK_031bba90 + 0x31bb8cc));
    func_0x01438628(*(undefined4 *)(_UNK_031bba94 + 0x31bb8d8));
    func_0x01438628(*(undefined4 *)(_UNK_031bba98 + 0x31bb8e4));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7d1c,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x7d1c,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_031bba9c + 0x31bb948) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_031bbaa0 + 0x31bb964));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = func_0x036c7bec(iVar3,**(undefined4 **)(_UNK_031bbaa4 + 0x31bb984));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar3 + 0x308) != 0) {
    func_0x03b73ab8(*(int *)(iVar3 + 0x308),**(undefined4 **)(_UNK_031bbaa8 + 0x31bb9b4));
  }
  if (*(int *)(**(int **)(_UNK_031bbaac + 0x31bb9c4) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar12 = *(undefined4 **)(_UNK_031bbab0 + 0x31bb9e0);
  ...
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x22,0);
  ...
  if (iVar3 != 0) {
    ...
    puStack_30 = puVar4;
    puStack_2c = puVar12;
    func_0x024f56c0(&uStack_60,0,0x22,0);
    ...
    func_0x01523a2c(&puStack_48,0x22,0);
    iVar10 = *(int *)(iVar3 + 8);
    uVar13 = *(undefined4 *)(iVar3 + 0xc);
    iVar3 = *(int *)(iVar3 + 0x10);
    if (iVar10 == 0) {
  ...
  iVar10 = func_0x046ccb14(iVar3,0x22,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar10 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar1 = (*(code *)*puVar4)(piVar9,0x22,puVar4[1]);
      iVar3 = iStack_40;
    }
    iVar10 = *(int *)(iVar3 + 8);
    iVar3 = iVar10;
