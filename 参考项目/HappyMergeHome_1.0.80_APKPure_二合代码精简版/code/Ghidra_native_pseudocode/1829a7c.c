...
uint FUN_01839a7c(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_01839b64 + 0x1839a9c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01839b68 + 0x1839ab0));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x9235,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x9235,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_01839b6c + 0x1839b2c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_01833590();
  if (iVar2 == 0) {
  ...
  pcVar11 = (char *)(_UNK_01838c2c + 0x1838b24);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01838c30 + 0x1838b38));
    func_0x01438628(*(undefined4 *)(_UNK_01838c34 + 0x1838b44));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x922d,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_01838c38 + 0x1838ba0) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01838c3c + 0x1838bbc));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_01842478 + 0x1842244);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_0184247c + 0x1842258));
      func_0x01438628(*(undefined4 *)(_UNK_01842480 + 0x1842264));
      func_0x01438628(*(undefined4 *)(_UNK_01842484 + 0x1842270));
      func_0x01438628(*(undefined4 *)(_UNK_01842488 + 0x184227c));
      func_0x01438628(*(undefined4 *)(_UNK_0184248c + 0x1842288));
      func_0x01438628(*(undefined4 *)(_UNK_01842490 + 0x1842294));
      func_0x01438628(*(undefined4 *)(_UNK_01842494 + 0x18422a0));
      *pcVar11 = '\x01';
    }
    iVar1 = func_0x02953fd4(0x920d,0);
    if (iVar1 == 0) {
      iVar1 = func_0x0183c470(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x024f0540(iVar1,param_3,**(undefined4 **)(_UNK_01842498 + 0x184231c));
      if (iVar1 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x024eee28(**(undefined4 **)(_UNK_0184249c + 0x1842380),uVar10,
                                 **(undefined4 **)(_UNK_018424a0 + 0x184238c),0);
        if (*(int *)(**(int **)(_UNK_018424a4 + 0x18423a0) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_3,**(undefined4 **)(_UNK_018424ac + 0x18423d4));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar1,param_3,**(undefined4 **)(_UNK_018424a8 + 0x1842350));
        }
        func_0x024f10d4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_018424b0 + 0x18423f8));
        iVar1 = func_0x0183c470(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x024f05d4(iVar1,param_3,**(undefined4 **)(_UNK_018424b4 + 0x1842428));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x0183c470(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_018424b8 + 0x1842468);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x920d,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x922d,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
