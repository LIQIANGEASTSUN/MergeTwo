...

{
  ...
  pcVar7 = (char *)(_UNK_0300dd24 + 0x300db50);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0300dd28 + 0x300db64));
    func_0x01438628(*(undefined4 *)(_UNK_0300dd2c + 0x300db70));
    func_0x01438628(*(undefined4 *)(_UNK_0300dd30 + 0x300db7c));
    func_0x01438628(*(undefined4 *)(_UNK_0300dd34 + 0x300db88));
    *pcVar7 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x7288,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x7288,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0300dd38 + 0x300dc60) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x04e4a028(**(undefined4 **)(_UNK_0300dd3c + 0x300dc7c));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  ...
  if ((iVar4 != 0) && (0 < *(int *)(iVar4 + 0xc))) {
    ...
    iVar4 = func_0x04cfd760(iVar4,0,**(undefined4 **)(_UNK_0300dd40 + 0x300dcd0));
    if (iVar4 == 0) {
      func_0x014388e4();
    }
