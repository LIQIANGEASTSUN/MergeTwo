...
undefined4 FUN_02fa61cc(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_02fa6308 + 0x2fa61e4);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fa630c + 0x2fa61f8));
    func_0x01438628(*(undefined4 *)(_UNK_02fa6310 + 0x2fa6204));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x6fac,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x6fac,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x046c26fc(iVar1,param_2,**(undefined4 **)(_UNK_02fa6314 + 0x2fa629c));
  if (iVar1 != 0) {
    iVar1 = FUN_02f95f8c(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_02fa6318 + 0x2fa62f4);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
