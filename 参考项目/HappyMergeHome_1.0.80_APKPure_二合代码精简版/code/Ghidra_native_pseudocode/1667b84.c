...
int FUN_01677b84(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_01677d00 + 0x1677b98);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01677d04 + 0x1677bac));
    func_0x01438628(*(undefined4 *)(_UNK_01677d08 + 0x1677bb8));
    func_0x01438628(*(undefined4 *)(_UNK_01677d0c + 0x1677bc4));
    func_0x01438628(*(undefined4 *)(_UNK_01677d10 + 0x1677bd0));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x874e,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x874e,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01677d14 + 0x1677c28) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01677d18 + 0x1677c44));
  piVar7 = *(int **)(_UNK_01677d1c + 0x1677c58);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_01677d20 + 0x1677c78);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0xa34);
  if (iVar2 == 0) {
