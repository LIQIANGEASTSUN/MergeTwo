...
int FUN_01931040(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_01931160 + 0x1931054);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01931164 + 0x1931068));
    func_0x01438628(*(undefined4 *)(_UNK_01931168 + 0x1931074));
    func_0x01438628(*(undefined4 *)(_UNK_0193116c + 0x1931080));
    func_0x01438628(*(undefined4 *)(_UNK_01931170 + 0x193108c));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x1ffb,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x1ffb,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01931174 + 0x19310e4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_01931178 + 0x1931100));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  ...
  iVar2 = func_0x0152983c(iVar2,*(int *)(iVar2 + 0xc) + -1,
                          **(undefined4 **)(_UNK_0193117c + 0x1931130));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
  iVar2 = *(int *)(iVar2 + 0x24);
  pcVar7 = (char *)(_UNK_0192f018 + 0x192ec1c);
  iStack_24 = unaff_r4;
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0192f01c + 0x192ec30));
    func_0x01438628(*(undefined4 *)(_UNK_0192f020 + 0x192ec3c));
    func_0x01438628(*(undefined4 *)(_UNK_0192f024 + 0x192ec48));
    func_0x01438628(*(undefined4 *)(_UNK_0192f028 + 0x192ec54));
    func_0x01438628(*(undefined4 *)(_UNK_0192f02c + 0x192ec60));
    func_0x01438628(*(undefined4 *)(_UNK_0192f030 + 0x192ec6c));
    func_0x01438628(*(undefined4 *)(_UNK_0192f034 + 0x192ec78));
    func_0x01438628(*(undefined4 *)(_UNK_0192f038 + 0x192ec84));
    func_0x01438628(*(undefined4 *)(_UNK_0192f03c + 0x192ec90));
    func_0x01438628(*(undefined4 *)(_UNK_0192f040 + 0x192ec9c));
    *pcVar7 = '\x01';
  }
  iVar8 = func_0x02953fd4(0x1ffc,0);
  if (iVar8 == 0) {
    ...
    puVar11 = *(undefined4 **)(_UNK_0192f044 + 0x192ed3c);
    iVar8 = func_0x024f0f34(iVar8,iVar2,*puVar11);
    if (iVar8 == 0) {
      if (*(int *)(**(int **)(_UNK_0192f048 + 0x192ed5c) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar8 = func_0x014e9518(**(undefined4 **)(_UNK_0192f04c + 0x192ed78));
      if (iVar8 == 0) {
        func_0x014388e4();
      }
      iVar8 = *(int *)(iVar8 + 0x2c);
      iVar9 = 0;
      puVar12 = *(undefined4 **)(_UNK_0192f050 + 0x192eda0);
      while( true ) {
        if (iVar8 == 0) {
          func_0x014388e4();
        }
          ...
          while( true ) {
            ...
            if (*(int *)(iVar1 + 0x24) <= iVar2) {
              ...
              if (iVar1 == 0) {
                ...
                func_0x024f05ac(iVar1,uVar10,**(undefined4 **)(_UNK_0192f054 + 0x192ef18));
              }
            }
            iVar9 = iVar9 + 1;
          }
          func_0x0193174c(param_1);
          if (*(int *)(**(int **)(_UNK_0192f058 + 0x192ef3c) + 0x74) == 0) {
            func_0x014387a4();
          }
          iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0192f05c + 0x192ef58));
          piVar6 = *(int **)(_UNK_0192f060 + 0x192ef6c);
          iVar8 = *piVar6;
          if (*(int *)(iVar8 + 0x74) == 0) {
            func_0x014387a4();
            iVar8 = *piVar6;
          }
          iVar1 = **(int **)(_UNK_0192f064 + 0x192ef8c);
  ...
  iVar8 = func_0x029540a4(0x1ffc,0);
  if (iVar8 == 0) {
    func_0x014388e4();
  }
  puStack_20 = (undefined4 *)iStack_24;
