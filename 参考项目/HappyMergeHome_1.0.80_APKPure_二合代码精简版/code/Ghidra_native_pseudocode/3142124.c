...
void FUN_03152124(undefined4 param_1)

{
  ...
  iVar3 = func_0x02953fd4(0x2a0e,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x2a0e,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = FUN_031520b8(param_1);
  iVar3 = iVar3 + 1;
  iVar5 = func_0x02953fd4(0x2a10,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x2a10,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  pcVar7 = (char *)(_UNK_026f12bc + 0x26f1234);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_026f12c0 + 0x26f1248),iVar3,0);
  ...
  *(int *)(iVar5 + 0x5c) = iVar3;
  ...
  iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_026f12cc + 0x26f1294));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
