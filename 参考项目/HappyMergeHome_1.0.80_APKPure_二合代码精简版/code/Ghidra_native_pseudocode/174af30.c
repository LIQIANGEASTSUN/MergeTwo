...
void FUN_0175af30(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar6 = (char *)(_UNK_0175b1ac + 0x175af58);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0175b1b0 + 0x175af6c));
    func_0x01438628(*(undefined4 *)(_UNK_0175b1b4 + 0x175af78));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x15dd,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_0175b1b8 + 0x175afdc) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_0175b1bc + 0x175affc));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    uVar9 = (uint)lVar15;
    iVar3 = FUN_0174e5a0(param_1,param_4 - (uVar8 + !bVar10));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    if ((int)(iVar4 - (iVar2 + (uint)bVar10)) < 0 !=
      ...
      func_0x026cf36c(iVar3,0,0);
      iVar3 = FUN_0174e5a0(param_1);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      func_0x026cf2b0(iVar3,0,0);
      uVar13 = FUN_0174e5a0(param_1);
      uVar5 = (undefined4)((ulonglong)uVar13 >> 0x20);
      if ((int)uVar13 == 0) {
        func_0x014388e4();
        uVar5 = extraout_r1;
      }
      func_0x026cf730((int)uVar13,uVar5,uVar9,iVar2,0);
    }
  }
  else {
    iVar2 = func_0x029540a4(0x15dd,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
