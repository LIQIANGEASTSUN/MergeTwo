...
uint FUN_031c0ed0(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_031c0f70 + 0x31c0ee4);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031c0f74 + 0x31c0ef8));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7d22,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7d22,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_031c0f78 + 0x31c0f50) + 0x74) == 0) {
    func_0x014387a4();
  }
