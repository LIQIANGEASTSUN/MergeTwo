...
uint FUN_0318050c(int param_1,int param_2)

{
  ...
  pcVar12 = (char *)(_UNK_031805d4 + 0x3180524);
  if (*pcVar12 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031805d8 + 0x3180538));
    *pcVar12 = '\x01';
  }
  iVar6 = func_0x02953fd4(0x1346,0);
  if (iVar6 == 0) {
    if (*(int *)(**(int **)(_UNK_031805dc + 0x3180594) + 0x74) == 0) {
      func_0x014387a4();
    }
    ...
    iVar6 = func_0x029540a4(0x1346,0);
    if (iVar6 == 0) {
      func_0x014388e4();
    }
  }
