...
uint FUN_016b65ac(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_016b6694 + 0x16b65cc);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016b6698 + 0x16b65e0));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8913,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8913,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_016b669c + 0x16b665c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_016af738();
  if (iVar2 == 0) {
  ...
  pcVar11 = (char *)(_UNK_016b4e74 + 0x16b4d6c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016b4e78 + 0x16b4d80));
    func_0x01438628(*(undefined4 *)(_UNK_016b4e7c + 0x16b4d8c));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8907,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_016b4e80 + 0x16b4de8) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_016b4e84 + 0x16b4e04));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_016be810 + 0x16be5dc);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_016be814 + 0x16be5f0));
      func_0x01438628(*(undefined4 *)(_UNK_016be818 + 0x16be5fc));
      func_0x01438628(*(undefined4 *)(_UNK_016be81c + 0x16be608));
      func_0x01438628(*(undefined4 *)(_UNK_016be820 + 0x16be614));
      func_0x01438628(*(undefined4 *)(_UNK_016be824 + 0x16be620));
      func_0x01438628(*(undefined4 *)(_UNK_016be828 + 0x16be62c));
      func_0x01438628(*(undefined4 *)(_UNK_016be82c + 0x16be638));
      *pcVar11 = '\x01';
    }
    iVar1 = func_0x02953fd4(0x88e7,0);
    if (iVar1 == 0) {
      iVar1 = func_0x016b8808(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x024f0540(iVar1,param_3,**(undefined4 **)(_UNK_016be830 + 0x16be6b4));
      if (iVar1 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x024eee28(**(undefined4 **)(_UNK_016be834 + 0x16be718),uVar10,
                                 **(undefined4 **)(_UNK_016be838 + 0x16be724),0);
        if (*(int *)(**(int **)(_UNK_016be83c + 0x16be738) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_3,**(undefined4 **)(_UNK_016be844 + 0x16be76c));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar1,param_3,**(undefined4 **)(_UNK_016be840 + 0x16be6e8));
        }
        func_0x024f10d4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_016be848 + 0x16be790));
        iVar1 = func_0x016b8808(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x024f05d4(iVar1,param_3,**(undefined4 **)(_UNK_016be84c + 0x16be7c0));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x016b8808(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_016be850 + 0x16be800);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x88e7,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x8907,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
