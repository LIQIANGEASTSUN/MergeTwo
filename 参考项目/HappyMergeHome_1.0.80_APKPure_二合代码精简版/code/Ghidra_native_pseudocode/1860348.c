...
int FUN_01870348(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0x937c,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x937c,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  pcVar6 = (char *)(_UNK_018b695c + 0x18b67f8);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018b6960 + 0x18b680c));
    func_0x01438628(*(undefined4 *)(_UNK_018b6964 + 0x18b6818));
    func_0x01438628(*(undefined4 *)(_UNK_018b6968 + 0x18b6824));
    func_0x01438628(*(undefined4 *)(_UNK_018b696c + 0x18b6830));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x1730,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x1730,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
    ...
    iVar1 = func_0x024f56d0(iVar8,uVar5,&uStack_30,uVar10,0,0);
    return iVar1;
  }
  if (*(int *)(**(int **)(_UNK_018b6970 + 0x18b6884) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018b6974 + 0x18b68a0));
  piVar7 = *(int **)(_UNK_018b6978 + 0x18b68b4);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_018b697c + 0x18b68d4);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0x770);
  if (iVar2 == 0) {
