...

{
  ...
  pcVar4 = (char *)(_UNK_016fa604 + 0x16fa55c);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016fa608 + 0x16fa570));
    func_0x01438628(*(undefined4 *)(_UNK_016fa60c + 0x16fa57c));
    *pcVar4 = '\x01';
  }
  if (*(int *)(**(int **)(_UNK_016fa610 + 0x16fa590) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_016fa614 + 0x16fa5ac));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  func_0x02bb3638(iVar1,0x1a,0);
