...
undefined4 FUN_02fdba88(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_02fdbb64 + 0x2fdba9c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fdbb68 + 0x2fdbab0));
    func_0x01438628(*(undefined4 *)(_UNK_02fdbb6c + 0x2fdbabc));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7124,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_02fdbb70 + 0x2fdbb14) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02fdbb74 + 0x2fdbb30));
    uVar7 = func_0x02fdbb78(param_1);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = func_0x029540a4(0x7124,0);
  if (iVar3 == 0) {
    func_0x014388e4();
  }
