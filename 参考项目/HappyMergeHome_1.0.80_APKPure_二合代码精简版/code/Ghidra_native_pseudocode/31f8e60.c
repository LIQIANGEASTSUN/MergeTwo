...
uint FUN_03208e60(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar2 = func_0x02953fd4(0x7e75,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_03208f8c + 0x3208ef4) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_03208f90 + 0x3208f10));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x02953fd4(0x7e5d,0);
    if (iVar2 == 0) {
      iVar2 = func_0x0320b990(param_1);
      if (iVar2 == 0) {
        func_0x014388e4();
      }
      iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_03211670 + 0x32114f4));
      if (iVar2 == 0) {
        ...
        if (iVar2 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_03211684 + 0x32115ac));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar2,param_2,**(undefined4 **)(_UNK_03211680 + 0x3211528));
        }
        func_0x03b70fe4(iVar2,param_2,iVar9 + -1,**(undefined4 **)(_UNK_03211688 + 0x32115d0));
        iVar2 = func_0x0320b990(param_1);
        if (iVar2 == 0) {
          func_0x014388e4();
        }
        uVar1 = func_0x03b70fac(iVar2,param_2,**(undefined4 **)(_UNK_0321168c + 0x3211600));
        if ((int)uVar1 < 1) {
          iVar2 = func_0x0320b990(param_1);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar9 = **(int **)(_UNK_03211690 + 0x3211640);
...
LAB_046c3e4c:
    ...
    iVar2 = func_0x029540a4(0x7e5d,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar2 = func_0x029540a4(0x7e75,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
