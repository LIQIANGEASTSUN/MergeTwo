...

{
  ...
  pcVar6 = (char *)(_UNK_01647bf4 + 0x1647b60);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01647bf8 + 0x1647b74));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8623,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8623,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar7 = **(int **)(_UNK_01647bfc + 0x1647be8);
