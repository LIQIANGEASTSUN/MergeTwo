...

{
  ...
  pcVar7 = (char *)(_UNK_01676ca4 + 0x1676b58);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01676ca8 + 0x1676b6c));
    func_0x01438628(*(undefined4 *)(_UNK_01676cac + 0x1676b78));
    func_0x01438628(*(undefined4 *)(_UNK_01676cb0 + 0x1676b84));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x2c3f,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x2c3f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01676cb4 + 0x1676bdc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01676cb8 + 0x1676bf8));
  uVar10 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar9 = **(int **)(_UNK_01676cbc + 0x1676c24);
