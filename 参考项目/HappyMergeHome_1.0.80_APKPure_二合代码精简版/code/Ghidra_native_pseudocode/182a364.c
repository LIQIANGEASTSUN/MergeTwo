...
int * FUN_0183a364(undefined4 param_1)

{
  ...
  pcVar10 = (char *)(_UNK_0183a444 + 0x183a378);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0183a448 + 0x183a38c));
    func_0x01438628(*(undefined4 *)(_UNK_0183a44c + 0x183a398));
    func_0x01438628(*(undefined4 *)(_UNK_0183a450 + 0x183a3a4));
    *pcVar10 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x17e6,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x17e6,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    pcVar10 = (char *)(_UNK_028a9888 + 0x28a97a8);
    if (*pcVar10 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_028a988c + 0x28a97bc),param_1,0);
      *pcVar10 = '\x01';
    }
    ...
    piVar2 = (int *)func_0x035daef8(&uStack_30,0,**(undefined4 **)(_UNK_028a9890 + 0x28a9878));
    return piVar2;
  }
  if (*(int *)(**(int **)(_UNK_0183a454 + 0x183a3fc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0183a458 + 0x183a418));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar11 = **(int **)(_UNK_0183a45c + 0x183a438);
  puVar15 = auStack_20;
