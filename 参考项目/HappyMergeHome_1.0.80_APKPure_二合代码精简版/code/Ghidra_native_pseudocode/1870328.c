...
undefined4 FUN_01880328(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar5 = (char *)(_UNK_01880464 + 0x1880340);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01880468 + 0x1880354));
    func_0x01438628(*(undefined4 *)(_UNK_0188046c + 0x1880360));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x93e7,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x93e7,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_01880470 + 0x18803f8));
  if (iVar1 != 0) {
    iVar1 = FUN_01873864(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_01880474 + 0x1880450);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
