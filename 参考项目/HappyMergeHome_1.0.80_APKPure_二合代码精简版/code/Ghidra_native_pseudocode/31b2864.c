...
int FUN_031c2864(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_031c2984 + 0x31c2878);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031c2988 + 0x31c288c));
    func_0x01438628(*(undefined4 *)(_UNK_031c298c + 0x31c2898));
    func_0x01438628(*(undefined4 *)(_UNK_031c2990 + 0x31c28a4));
    func_0x01438628(*(undefined4 *)(_UNK_031c2994 + 0x31c28b0));
    *pcVar9 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x1f88,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x1f88,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_031c2998 + 0x31c2908) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_031c299c + 0x31c2924));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  ...
  iVar3 = func_0x04cfd760(iVar3,*(int *)(iVar3 + 0xc) + -1,
                          **(undefined4 **)(_UNK_031c29a0 + 0x31c2954));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = *(int *)(iVar3 + 0x1c);
  pcVar9 = (char *)(_UNK_031c18a4 + 0x31c14a8);
  iStack_24 = unaff_r4;
  if (*pcVar9 == '\0') {
  ...
  iVar6 = func_0x02953fd4(0x1f89,0);
  if (iVar6 == 0) {
    iVar6 = FUN_031b7b88(param_1);
    if (iVar6 == 0) {
      func_0x014388e4();
    }
    ...
    puVar11 = *(undefined4 **)(_UNK_031c18d0 + 0x31c15c8);
    iVar6 = func_0x04cd2d7c(iVar6,iVar3,*puVar11);
    if (iVar6 == 0) {
      if (*(int *)(**(int **)(_UNK_031c18d4 + 0x31c15e8) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar6 = func_0x04e4a028(**(undefined4 **)(_UNK_031c18d8 + 0x31c1604));
      if (iVar6 == 0) {
        func_0x014388e4();
      }
      iVar6 = *(int *)(iVar6 + 0x38);
      iVar7 = 0;
      puVar12 = *(undefined4 **)(_UNK_031c18dc + 0x31c162c);
      while( true ) {
        if (iVar6 == 0) {
          func_0x014388e4();
        }
        ...
        if (*(int *)(iVar2 + 0x1c) == iVar3) {
          ...
          while( true ) {
            ...
            if (*(int *)(iVar2 + 0x1c) <= iVar3) {
              ...
              if (iVar2 == 0) {
                ...
                func_0x03b75ba0(iVar2,uVar10,**(undefined4 **)(_UNK_031c18e0 + 0x31c17a4));
              }
            }
            iVar7 = iVar7 + 1;
          }
          ...
          iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_031c18e8 + 0x31c17e4));
          ...
          iVar2 = **(int **)(_UNK_031c18f0 + 0x31c1818);
  ...
  iVar6 = func_0x029540a4(0x1f89,0);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
  puStack_20 = (undefined4 *)iStack_24;
