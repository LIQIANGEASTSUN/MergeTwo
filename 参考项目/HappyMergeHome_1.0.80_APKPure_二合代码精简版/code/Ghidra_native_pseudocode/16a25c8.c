...
int FUN_016b25c8(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0x88d1,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x88d1,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  pcVar6 = (char *)(_UNK_016e3a68 + 0x16e3904);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016e3a6c + 0x16e3918));
    func_0x01438628(*(undefined4 *)(_UNK_016e3a70 + 0x16e3924));
    func_0x01438628(*(undefined4 *)(_UNK_016e3a74 + 0x16e3930));
    func_0x01438628(*(undefined4 *)(_UNK_016e3a78 + 0x16e393c));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x185e,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x185e,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_016e3a7c + 0x16e3990) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_016e3a80 + 0x16e39ac));
  piVar7 = *(int **)(_UNK_016e3a84 + 0x16e39c0);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_016e3a88 + 0x16e39e0);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0x8a8);
  if (iVar2 == 0) {
