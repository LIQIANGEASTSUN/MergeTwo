...
void FUN_030df3d8(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar6 = (char *)(_UNK_030df654 + 0x30df400);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030df658 + 0x30df414));
    func_0x01438628(*(undefined4 *)(_UNK_030df65c + 0x30df420));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x154b,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_030df660 + 0x30df484) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_030df664 + 0x30df4a4));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    uVar9 = (uint)lVar15;
    iVar3 = FUN_030d2ca4(param_1,param_4 - (uVar8 + !bVar10));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x029540a4(0x154b,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
