...
uint FUN_016b559c(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_016b5684 + 0x16b55bc);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016b5688 + 0x16b55d0));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x890b,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x890b,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_016b568c + 0x16b564c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_016af738();
  if (iVar2 == 0) {
