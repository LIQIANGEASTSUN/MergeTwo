...
uint FUN_032d3810(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar2 = func_0x02953fd4(0x839f,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_032d393c + 0x32d38a4) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_032d3940 + 0x32d38c0));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x02953fd4(0x8373,0);
    if (iVar2 == 0) {
      iVar2 = func_0x032d62b4(param_1);
      if (iVar2 == 0) {
        func_0x014388e4();
      }
      iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_032dc76c + 0x32dc5f0));
      if (iVar2 == 0) {
        ...
        if (iVar2 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_032dc780 + 0x32dc6a8));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar2,param_2,**(undefined4 **)(_UNK_032dc77c + 0x32dc624));
        }
        func_0x03b70fe4(iVar2,param_2,iVar9 + -1,**(undefined4 **)(_UNK_032dc784 + 0x32dc6cc));
        iVar2 = func_0x032d62b4(param_1);
        if (iVar2 == 0) {
          func_0x014388e4();
        }
        uVar1 = func_0x03b70fac(iVar2,param_2,**(undefined4 **)(_UNK_032dc788 + 0x32dc6fc));
        if ((int)uVar1 < 1) {
          iVar2 = func_0x032d62b4(param_1);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar9 = **(int **)(_UNK_032dc78c + 0x32dc73c);
...
LAB_046c3e4c:
    ...
    iVar2 = func_0x029540a4(0x8373,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar2 = func_0x029540a4(0x839f,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
