...
int FUN_016bb348(int *param_1,int param_2,int param_3)

{
  ...
  pcVar10 = (char *)(_UNK_016bb51c + 0x16bb368);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016bb520 + 0x16bb37c));
    func_0x01438628(*(undefined4 *)(_UNK_016bb524 + 0x16bb388));
    func_0x01438628(*(undefined4 *)(_UNK_016bb528 + 0x16bb394));
    *pcVar10 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x88ef,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x88ef,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_016bb52c + 0x16bb3fc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_016bb530 + 0x16bb418));
  uVar2 = (**(code **)(*param_1 + 0x1a0))(param_1,*(undefined4 *)(*param_1 + 0x1a4));
  piVar3 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_016bb534 + 0x16bb448),2);
  if (piVar3 == (int *)0x0) {
    func_0x014388e4();
  }
  if ((param_2 != 0) &&
