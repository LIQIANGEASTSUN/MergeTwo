...
undefined4 FUN_01cc354c(int *param_1)

{
  ...
  pcVar5 = (char *)(_UNK_01cc36ec + 0x1cc3560);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01cc36f0 + 0x1cc3574));
    func_0x01438628(*(undefined4 *)(_UNK_01cc36f4 + 0x1cc3580));
    func_0x01438628(*(undefined4 *)(_UNK_01cc36f8 + 0x1cc358c));
    func_0x01438628(*(undefined4 *)(_UNK_01cc36fc + 0x1cc3598));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x94a,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x94a,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  func_0x01cc3710(param_1);
  if (*(int *)(**(int **)(_UNK_01cc3700 + 0x1cc3614) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01cc3704 + 0x1cc3630));
  piVar6 = *(int **)(_UNK_01cc3708 + 0x1cc3644);
  iVar7 = *piVar6;
  if (*(int *)(iVar7 + 0x74) == 0) {
    func_0x014387a4();
    iVar7 = *piVar6;
  }
  iVar8 = **(int **)(_UNK_01cc370c + 0x1cc3664);
  iVar2 = *(int *)(iVar8 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar7 + 0x5c) + 0x230);
  if (iVar2 == 0) {
