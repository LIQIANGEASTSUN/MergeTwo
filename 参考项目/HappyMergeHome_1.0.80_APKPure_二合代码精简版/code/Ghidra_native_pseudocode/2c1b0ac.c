...
undefined4 FUN_02c2b0ac(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2b26c + 0x2c2b0c0);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2b270 + 0x2c2b0d4));
    func_0x01438628(*(undefined4 *)(_UNK_02c2b274 + 0x2c2b0e0));
    func_0x01438628(*(undefined4 *)(_UNK_02c2b278 + 0x2c2b0ec));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d8d,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d8d,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2b27c + 0x2c2b214));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2b280 + 0x2c2b230),0);
  if (*(int *)(**(int **)(_UNK_02c2b284 + 0x2c2b244) + 0x74) == 0) {
    func_0x014387a4();
  }
