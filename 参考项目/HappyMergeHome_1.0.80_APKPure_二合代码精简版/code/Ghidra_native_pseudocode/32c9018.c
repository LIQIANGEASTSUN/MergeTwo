...
int FUN_032d9018(int *param_1,int param_2,int param_3)

{
  ...
  pcVar10 = (char *)(_UNK_032d91ec + 0x32d9038);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032d91f0 + 0x32d904c));
    func_0x01438628(*(undefined4 *)(_UNK_032d91f4 + 0x32d9058));
    func_0x01438628(*(undefined4 *)(_UNK_032d91f8 + 0x32d9064));
    *pcVar10 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x837b,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x837b,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_032d91fc + 0x32d90cc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_032d9200 + 0x32d90e8));
  uVar6 = (**(code **)(*param_1 + 0x1a0))(param_1,*(undefined4 *)(*param_1 + 0x1a4));
  piVar7 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_032d9204 + 0x32d9118),2);
  if (piVar7 == (int *)0x0) {
    func_0x014388e4();
  }
  if ((param_2 != 0) &&
...
LAB_02b0cf5c:
  ...
  func_0x02b20ab0(iVar5,piVar7,0);
  return aiStack_28[0];
}
