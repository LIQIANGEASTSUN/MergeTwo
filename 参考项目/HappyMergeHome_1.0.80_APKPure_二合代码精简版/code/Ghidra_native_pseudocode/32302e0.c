...
/* WARNING: Possible PIC construction at 0x03240460: Changing call to branch */
/* WARNING: Possible PIC construction at 0x03240488: Changing call to branch */
/* WARNING: Possible PIC construction at 0x032404b0: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x0324048c) */
/* WARNING: Removing unreachable block (ram,0x032404a0) */
/* WARNING: Removing unreachable block (ram,0x032404a4) */
/* WARNING: Removing unreachable block (ram,0x03240464) */
/* WARNING: Removing unreachable block (ram,0x03240478) */
/* WARNING: Removing unreachable block (ram,0x0324047c) */
/* WARNING: Removing unreachable block (ram,0x032404b4) */
/* WARNING: Removing unreachable block (ram,0x032404c8) */
/* WARNING: Removing unreachable block (ram,0x032404cc) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_032402e0(int param_1)

{
  ...
  pcVar11 = (char *)(_UNK_032404e0 + 0x32402f4);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032404e4 + 0x3240308));
    func_0x01438628(*(undefined4 *)(_UNK_032404e8 + 0x3240314));
    func_0x01438628(*(undefined4 *)(_UNK_032404ec + 0x3240320));
    func_0x01438628(*(undefined4 *)(_UNK_032404f0 + 0x324032c));
    func_0x01438628(*(undefined4 *)(_UNK_032404f4 + 0x3240338));
    func_0x01438628(*(undefined4 *)(_UNK_032404f8 + 0x3240344));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7fe3,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x7fe3,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_032404fc + 0x32403a8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03240500 + 0x32403c4));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = func_0x036c7bec(iVar3,**(undefined4 **)(_UNK_03240504 + 0x32403e4));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar3 + 0x3a8) != 0) {
    func_0x03b73ab8(*(int *)(iVar3 + 0x3a8),**(undefined4 **)(_UNK_03240508 + 0x3240414));
  }
  if (*(int *)(**(int **)(_UNK_0324050c + 0x3240424) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar12 = *(undefined4 **)(_UNK_03240510 + 0x3240440);
  ...
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x5a,0);
  ...
  if (iVar3 != 0) {
    ...
    puStack_30 = puVar4;
    puStack_2c = puVar12;
    func_0x024f56c0(&uStack_60,0,0x5a,0);
    ...
    func_0x01523a2c(&puStack_48,0x5a,0);
    iVar10 = *(int *)(iVar3 + 8);
    uVar13 = *(undefined4 *)(iVar3 + 0xc);
    iVar3 = *(int *)(iVar3 + 0x10);
    if (iVar10 == 0) {
  ...
  iVar10 = func_0x046ccb14(iVar3,0x5a,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar10 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar1 = (*(code *)*puVar4)(piVar9,0x5a,puVar4[1]);
      iVar3 = iStack_40;
    }
    iVar10 = *(int *)(iVar3 + 8);
    iVar3 = iVar10;
