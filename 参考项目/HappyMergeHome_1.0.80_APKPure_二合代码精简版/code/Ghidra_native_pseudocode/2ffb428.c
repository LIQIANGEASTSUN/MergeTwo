...
undefined4 FUN_0300b428(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_0300b514 + 0x300b43c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0300b518 + 0x300b450));
    func_0x01438628(*(undefined4 *)(_UNK_0300b51c + 0x300b45c));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x727e,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x727e,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0300b520 + 0x300b4b4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_0300b524 + 0x300b4d0));
  iVar5 = FUN_0300a498(param_1);
  if (iVar5 == 0) {
    func_0x014388e4();
  }
