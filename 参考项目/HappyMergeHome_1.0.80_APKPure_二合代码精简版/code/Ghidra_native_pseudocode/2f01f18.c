...
undefined4 FUN_02f11f18(int *param_1)

{
  ...
  pcVar8 = (char *)(_UNK_02f120a0 + 0x2f11f2c);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f120a4 + 0x2f11f40));
    func_0x01438628(*(undefined4 *)(_UNK_02f120a8 + 0x2f11f4c));
    func_0x01438628(*(undefined4 *)(_UNK_02f120ac + 0x2f11f58));
    func_0x01438628(*(undefined4 *)(_UNK_02f120b0 + 0x2f11f64));
    *pcVar8 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x6bdc,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x6bdc,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  if (iVar4 == 0) {
    return **(undefined4 **)(_UNK_02f120c0 + 0x2f1209c);
  }
  ...
  if (*(int *)(**(int **)(_UNK_02f120b4 + 0x2f11ff4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar6 = func_0x04e4a028(**(undefined4 **)(_UNK_02f120b8 + 0x2f12014));
  if (iVar6 == 0) {
    func_0x014388e4();
  }
  ...
  if (*(int *)(**(int **)(_UNK_02f120bc + 0x2f12054) + 0x74) == 0) {
    func_0x014387a4();
  }
