...
uint FUN_030d2500(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_030d25e8 + 0x30d2520);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030d25ec + 0x30d2534));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x770d,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x770d,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_030d25f0 + 0x30d25b0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_030ccbc4();
  if (iVar2 == 0) {
  ...
  pcVar11 = (char *)(_UNK_030d1e2c + 0x30d1d24);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030d1e30 + 0x30d1d38));
    func_0x01438628(*(undefined4 *)(_UNK_030d1e34 + 0x30d1d44));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7709,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_030d1e38 + 0x30d1da0) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_030d1e3c + 0x30d1dbc));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_030da7bc + 0x30da588);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_030da7c0 + 0x30da59c));
      func_0x01438628(*(undefined4 *)(_UNK_030da7c4 + 0x30da5a8));
      func_0x01438628(*(undefined4 *)(_UNK_030da7c8 + 0x30da5b4));
      func_0x01438628(*(undefined4 *)(_UNK_030da7cc + 0x30da5c0));
      func_0x01438628(*(undefined4 *)(_UNK_030da7d0 + 0x30da5cc));
      func_0x01438628(*(undefined4 *)(_UNK_030da7d4 + 0x30da5d8));
      func_0x01438628(*(undefined4 *)(_UNK_030da7d8 + 0x30da5e4));
      *pcVar11 = '\x01';
    }
    iVar1 = func_0x02953fd4(0x76f1,0);
    if (iVar1 == 0) {
      iVar1 = func_0x030d48c4(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x046c26fc(iVar1,param_3,**(undefined4 **)(_UNK_030da7dc + 0x30da660));
      if (iVar1 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x04f6b198(**(undefined4 **)(_UNK_030da7e0 + 0x30da6c4),uVar10,
                                 **(undefined4 **)(_UNK_030da7e4 + 0x30da6d0),0);
        if (*(int *)(**(int **)(_UNK_030da7e8 + 0x30da6e4) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_3,**(undefined4 **)(_UNK_030da7f0 + 0x30da718));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_030da7ec + 0x30da694));
        }
        func_0x03b70fe4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_030da7f4 + 0x30da73c));
        iVar1 = func_0x030d48c4(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_030da7f8 + 0x30da76c));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x030d48c4(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_030da7fc + 0x30da7ac);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x76f1,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x7709,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
