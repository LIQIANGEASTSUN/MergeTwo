...
/* WARNING: Possible PIC construction at 0x03047f94: Changing call to branch */
/* WARNING: Possible PIC construction at 0x03047fbc: Changing call to branch */
/* WARNING: Possible PIC construction at 0x03047fe4: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x03047fc0) */
/* WARNING: Removing unreachable block (ram,0x03047fd4) */
/* WARNING: Removing unreachable block (ram,0x03047fd8) */
/* WARNING: Removing unreachable block (ram,0x03047f98) */
/* WARNING: Removing unreachable block (ram,0x03047fac) */
/* WARNING: Removing unreachable block (ram,0x03047fb0) */
/* WARNING: Removing unreachable block (ram,0x03047fe8) */
/* WARNING: Removing unreachable block (ram,0x03047ffc) */
/* WARNING: Removing unreachable block (ram,0x03048000) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_03047e14(int param_1)

{
  ...
  pcVar11 = (char *)(_UNK_03048014 + 0x3047e28);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03048018 + 0x3047e3c));
    func_0x01438628(*(undefined4 *)(_UNK_0304801c + 0x3047e48));
    func_0x01438628(*(undefined4 *)(_UNK_03048020 + 0x3047e54));
    func_0x01438628(*(undefined4 *)(_UNK_03048024 + 0x3047e60));
    func_0x01438628(*(undefined4 *)(_UNK_03048028 + 0x3047e6c));
    func_0x01438628(*(undefined4 *)(_UNK_0304802c + 0x3047e78));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x741b,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x741b,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03048030 + 0x3047edc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03048034 + 0x3047ef8));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = func_0x036c7bec(iVar3,**(undefined4 **)(_UNK_03048038 + 0x3047f18));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar3 + 0x368) != 0) {
    func_0x03b73ab8(*(int *)(iVar3 + 0x368),**(undefined4 **)(_UNK_0304803c + 0x3047f48));
  }
  if (*(int *)(**(int **)(_UNK_03048040 + 0x3047f58) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar12 = *(undefined4 **)(_UNK_03048044 + 0x3047f74);
  ...
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x37,0);
  ...
  if (iVar3 != 0) {
    ...
    puStack_30 = puVar4;
    puStack_2c = puVar12;
    func_0x024f56c0(&uStack_60,0,0x37,0);
    ...
    func_0x01523a2c(&puStack_48,0x37,0);
    iVar10 = *(int *)(iVar3 + 8);
    uVar13 = *(undefined4 *)(iVar3 + 0xc);
    iVar3 = *(int *)(iVar3 + 0x10);
    if (iVar10 == 0) {
  ...
  iVar10 = func_0x046ccb14(iVar3,0x37,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar10 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar1 = (*(code *)*puVar4)(piVar9,0x37,puVar4[1]);
      iVar3 = iStack_40;
    }
    iVar10 = *(int *)(iVar3 + 8);
    iVar3 = iVar10;
