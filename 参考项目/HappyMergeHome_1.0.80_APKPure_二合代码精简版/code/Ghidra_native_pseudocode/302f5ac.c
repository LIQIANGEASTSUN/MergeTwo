...
void FUN_0303f5ac(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_0303f664 + 0x303f5c0);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0303f668 + 0x303f5d4));
    *pcVar8 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x73b8,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x73b8,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x03050ffc(param_1);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_0303f66c + 0x303f63c) + 0x74) == 0) {
    func_0x014387a4();
  }
