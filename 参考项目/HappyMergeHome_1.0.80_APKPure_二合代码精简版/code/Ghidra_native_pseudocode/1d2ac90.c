...

{
  ...
  pcVar7 = (char *)(_UNK_01d3ae08 + 0x1d3aca4);
  if (*pcVar7 == '\0') {
  ...
  iVar1 = func_0x02953fd4(0xb388,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_01d3ae20 + 0x1d3ad40) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01d3ae24 + 0x1d3ad5c));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    uVar10 = func_0x024f0f0c(iVar1,uVar10,**(undefined4 **)(_UNK_01d3ae30 + 0x1d3adc0));
    *(undefined4 *)(param_1 + 0x44) = uVar10;
    ...
    iVar1 = func_0x029540a4(0xb388,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
