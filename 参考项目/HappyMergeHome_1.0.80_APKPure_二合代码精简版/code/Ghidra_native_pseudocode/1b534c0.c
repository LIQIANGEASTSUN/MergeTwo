...
void FUN_01b634c0(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar7 = (char *)(_UNK_01b63774 + 0x1b634e8);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01b63778 + 0x1b634fc));
    func_0x01438628(*(undefined4 *)(_UNK_01b6377c + 0x1b63508));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0xcbc,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_01b63780 + 0x1b6356c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_01b63784 + 0x1b63588));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
