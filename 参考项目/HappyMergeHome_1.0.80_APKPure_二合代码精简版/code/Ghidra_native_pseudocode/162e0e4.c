...
int FUN_0163e0e4(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0x85cd,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x85cd,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  pcVar6 = (char *)(_UNK_01670038 + 0x166fed4);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0167003c + 0x166fee8));
    func_0x01438628(*(undefined4 *)(_UNK_01670040 + 0x166fef4));
    func_0x01438628(*(undefined4 *)(_UNK_01670044 + 0x166ff00));
    func_0x01438628(*(undefined4 *)(_UNK_01670048 + 0x166ff0c));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x16a3,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x16a3,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_0167004c + 0x166ff60) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01670050 + 0x166ff7c));
  piVar7 = *(int **)(_UNK_01670054 + 0x166ff90);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_01670058 + 0x166ffb0);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0xab0);
  if (iVar2 == 0) {
