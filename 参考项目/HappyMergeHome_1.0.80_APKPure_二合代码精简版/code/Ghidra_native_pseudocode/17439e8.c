...

{
  ...
  pcVar6 = (char *)(_UNK_01753a90 + 0x17539fc);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01753a94 + 0x1753a10));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8d0a,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8d0a,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar7 = **(int **)(_UNK_01753a98 + 0x1753a84);
