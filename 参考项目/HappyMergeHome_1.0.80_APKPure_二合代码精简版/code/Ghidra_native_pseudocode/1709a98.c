...

{
  ...
  pcVar6 = (char *)(_UNK_01719b40 + 0x1719aac);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01719b44 + 0x1719ac0));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8b84,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8b84,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar7 = **(int **)(_UNK_01719b48 + 0x1719b34);
