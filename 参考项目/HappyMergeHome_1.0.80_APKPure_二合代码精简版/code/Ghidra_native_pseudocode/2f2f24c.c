...
int FUN_02f3f24c(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_02f3f3c8 + 0x2f3f260);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f3f3cc + 0x2f3f274));
    func_0x01438628(*(undefined4 *)(_UNK_02f3f3d0 + 0x2f3f280));
    func_0x01438628(*(undefined4 *)(_UNK_02f3f3d4 + 0x2f3f28c));
    func_0x01438628(*(undefined4 *)(_UNK_02f3f3d8 + 0x2f3f298));
    *pcVar7 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x6dab,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x6dab,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f3f3dc + 0x2f3f2f0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02f3f3e0 + 0x2f3f30c));
  piVar8 = *(int **)(_UNK_02f3f3e4 + 0x2f3f320);
  iVar6 = *piVar8;
  if (*(int *)(iVar6 + 0x74) == 0) {
    func_0x014387a4();
    iVar6 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_02f3f3e8 + 0x2f3f340);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar6 + 0x5c) + 0x91c);
  if (iVar4 == 0) {
