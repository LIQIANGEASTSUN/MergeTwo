...

{
  ...
  pcVar6 = (char *)(_UNK_02c50a18 + 0x2c5096c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c50a1c + 0x2c50980));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x499,0);
  if (iVar2 == 0) {
    ...
    piVar1 = (int *)0x0;
    if ((piVar3 != (int *)0x0) &&
       (piVar1 = piVar3, *piVar3 != **(int **)(_UNK_02c50a20 + 0x2c50a00))) {
      piVar1 = (int *)0x0;
    }
    return piVar1;
  }
  iVar2 = func_0x029540a4(0x499,0);
  if (iVar2 == 0) {
    func_0x014388e4();
  }
