...
/* WARNING: Possible PIC construction at 0x02f9f018: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x02f9f01c) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_02f9efc4(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0x214c,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x214c,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_30 = 0;
