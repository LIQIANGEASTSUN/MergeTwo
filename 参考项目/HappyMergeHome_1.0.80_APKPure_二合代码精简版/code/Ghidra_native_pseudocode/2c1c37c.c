...
undefined4 FUN_02c2c37c(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2c53c + 0x2c2c390);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2c540 + 0x2c2c3a4));
    func_0x01438628(*(undefined4 *)(_UNK_02c2c544 + 0x2c2c3b0));
    func_0x01438628(*(undefined4 *)(_UNK_02c2c548 + 0x2c2c3bc));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5da1,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5da1,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2c54c + 0x2c2c4e4));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2c550 + 0x2c2c500),0);
  if (*(int *)(**(int **)(_UNK_02c2c554 + 0x2c2c514) + 0x74) == 0) {
    func_0x014387a4();
  }
