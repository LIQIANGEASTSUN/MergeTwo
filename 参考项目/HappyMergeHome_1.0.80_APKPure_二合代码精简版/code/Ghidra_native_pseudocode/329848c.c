...
void FUN_032a848c(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  pcVar1 = (char *)(_UNK_032a84e8 + 0x32a84a0);
  if (*pcVar1 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032a84ec + 0x32a84b4));
    *pcVar1 = '\x01';
    param_3 = extraout_r2;
    param_4 = extraout_r3;
  }
  if (*(int *)(**(int **)(_UNK_032a84f0 + 0x32a84c8) + 0x74) == 0) {
    func_0x014387a4();
