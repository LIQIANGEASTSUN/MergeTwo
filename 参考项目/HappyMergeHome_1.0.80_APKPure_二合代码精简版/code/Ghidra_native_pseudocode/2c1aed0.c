...
undefined4 FUN_02c2aed0(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2b090 + 0x2c2aee4);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2b094 + 0x2c2aef8));
    func_0x01438628(*(undefined4 *)(_UNK_02c2b098 + 0x2c2af04));
    func_0x01438628(*(undefined4 *)(_UNK_02c2b09c + 0x2c2af10));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d8b,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d8b,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2b0a0 + 0x2c2b038));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2b0a4 + 0x2c2b054),0);
  if (*(int *)(**(int **)(_UNK_02c2b0a8 + 0x2c2b068) + 0x74) == 0) {
    func_0x014387a4();
  }
