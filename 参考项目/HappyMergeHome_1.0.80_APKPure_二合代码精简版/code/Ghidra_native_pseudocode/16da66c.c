...

{
  ...
  pcVar7 = (char *)(_UNK_016ea7cc + 0x16ea680);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016ea7d0 + 0x16ea694));
    func_0x01438628(*(undefined4 *)(_UNK_016ea7d4 + 0x16ea6a0));
    func_0x01438628(*(undefined4 *)(_UNK_016ea7d8 + 0x16ea6ac));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x299b,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x299b,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_016ea7dc + 0x16ea704) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_016ea7e0 + 0x16ea720));
  uVar10 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar9 = **(int **)(_UNK_016ea7e4 + 0x16ea74c);
