...
uint FUN_031b754c(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_031b7634 + 0x31b756c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031b7638 + 0x31b7580));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7d0a,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7d0a,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_031b763c + 0x31b75fc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_031b08c8();
  if (iVar2 == 0) {
  ...
  pcVar11 = (char *)(_UNK_031b5f64 + 0x31b5e5c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031b5f68 + 0x31b5e70));
    func_0x01438628(*(undefined4 *)(_UNK_031b5f6c + 0x31b5e7c));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7cfe,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_031b5f70 + 0x31b5ed8) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_031b5f74 + 0x31b5ef4));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_031bf7b0 + 0x31bf57c);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_031bf7b4 + 0x31bf590));
      func_0x01438628(*(undefined4 *)(_UNK_031bf7b8 + 0x31bf59c));
      func_0x01438628(*(undefined4 *)(_UNK_031bf7bc + 0x31bf5a8));
      func_0x01438628(*(undefined4 *)(_UNK_031bf7c0 + 0x31bf5b4));
      func_0x01438628(*(undefined4 *)(_UNK_031bf7c4 + 0x31bf5c0));
      func_0x01438628(*(undefined4 *)(_UNK_031bf7c8 + 0x31bf5cc));
      func_0x01438628(*(undefined4 *)(_UNK_031bf7cc + 0x31bf5d8));
      *pcVar11 = '\x01';
    }
    iVar1 = func_0x02953fd4(0x7cde,0);
    if (iVar1 == 0) {
      iVar1 = func_0x031b97a8(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x046c26fc(iVar1,param_3,**(undefined4 **)(_UNK_031bf7d0 + 0x31bf654));
      if (iVar1 == 0) {
        uVar10 = func_0x0515c4b0(&uStack_1c,0);
        uVar10 = func_0x04f6b198(**(undefined4 **)(_UNK_031bf7d4 + 0x31bf6b8),uVar10,
                                 **(undefined4 **)(_UNK_031bf7d8 + 0x31bf6c4),0);
        if (*(int *)(**(int **)(_UNK_031bf7dc + 0x31bf6d8) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_3,**(undefined4 **)(_UNK_031bf7e4 + 0x31bf70c));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_031bf7e0 + 0x31bf688));
        }
        func_0x03b70fe4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_031bf7e8 + 0x31bf730));
        iVar1 = func_0x031b97a8(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_031bf7ec + 0x31bf760));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x031b97a8(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_031bf7f0 + 0x31bf7a0);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x7cde,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x7cfe,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
