...
int FUN_018cc0a4(undefined4 param_1,int param_2)

{
  ...
  pcVar5 = (char *)(_UNK_018cc4bc + 0x18cc0c0);
  if (*pcVar5 == '\0') {
  ...
  iVar1 = func_0x02953fd4(0x1df8,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x1df8,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  puVar10 = *(undefined4 **)(_UNK_018cc4e8 + 0x18cc1e0);
  iVar1 = func_0x024f0f34(iVar1,param_2,*puVar10);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_018cc4ec + 0x18cc200) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018cc4f0 + 0x18cc21c));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    iVar1 = *(int *)(iVar1 + 0x2c);
    iVar8 = 0;
    puVar11 = *(undefined4 **)(_UNK_018cc4f4 + 0x18cc244);
    do {
      if (iVar1 == 0) {
        func_0x014388e4();
      }
    ...
    while( true ) {
      ...
      if (*(int *)(iVar2 + 0x24) <= param_2) {
        ...
        if (iVar2 == 0) {
          ...
          func_0x024f05ac(iVar2,uVar9,**(undefined4 **)(_UNK_018cc4f8 + 0x18cc3bc));
        }
      }
      iVar8 = iVar8 + 1;
    }
    ...
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018cc500 + 0x18cc3fc));
    piVar7 = *(int **)(_UNK_018cc504 + 0x18cc410);
    iVar8 = *piVar7;
    if (*(int *)(iVar8 + 0x74) == 0) {
      func_0x014387a4();
      iVar8 = *piVar7;
    }
    iVar6 = **(int **)(_UNK_018cc508 + 0x18cc430);
