...
int FUN_017562ec(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_01756420 + 0x1756300);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01756424 + 0x1756314));
    func_0x01438628(*(undefined4 *)(_UNK_01756428 + 0x1756320));
    *pcVar4 = '\x01';
  }
  iVar7 = 0;
  iVar1 = func_0x02953fd4(0x8cd5,0);
  if (iVar1 != 0) {
    iVar7 = func_0x029540a4(0x8cd5,0);
    if (iVar7 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = 1;
  puVar8 = *(undefined4 **)(_UNK_0175642c + 0x1756380);
  while( true ) {
