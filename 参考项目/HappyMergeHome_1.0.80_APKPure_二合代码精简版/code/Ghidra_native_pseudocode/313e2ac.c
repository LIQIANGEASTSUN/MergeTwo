...
undefined4 FUN_0314e2ac(undefined4 param_1,int param_2)

{
  ...
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0314ea6c + 0x314e2dc));
  ...
  if (iVar1 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      *piVar14 = iVar3;
      ...
      iVar3 = FUN_03146980(param_1);
      uVar2 = *(undefined4 *)(param_2 + 8);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      func_0x046ce3e4(iVar3,uVar2,&iStack_28,**(undefined4 **)(_UNK_0314eae8 + 0x314e598));
      iVar3 = iStack_28;
      if (iStack_28 == 0) {
        func_0x014388e4();
      }
      ...
      iVar3 = func_0x014388d4(**(undefined4 **)(_UNK_0314eaf8 + 0x314e71c));
      func_0x03bbd054(iVar3,**(undefined4 **)(_UNK_0314eafc + 0x314e730));
      ...
      *piVar7 = iVar3;
      ...
      if (0 < *(int *)(iVar3 + 0xc)) {
        ...
        iVar3 = FUN_03143658();
        if (iVar3 != 0) {
          func_0x03157904(iVar3,0);
        }
        if (*(int *)(**(int **)(_UNK_0314eb04 + 0x314e7a4) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_0314eb08 + 0x314e7c4));
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        ...
        while( true ) {
          ...
          func_0x020257a4(iVar10,0x291,uVar2,uVar4,0,0,0);
          iVar3 = iVar3 + 1;
        }
        if (*(int *)(**(int **)(_UNK_0314eb14 + 0x314e960) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar3 = func_0x03b2c734(**(undefined4 **)(_UNK_0314eb18 + 0x314e97c));
        iVar9 = *piVar14;
        if (*(int *)(**(int **)(_UNK_0314eb1c + 0x314e990) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar10 = func_0x04e4a028(**(undefined4 **)(_UNK_0314eb20 + 0x314e9b0));
        if (iVar10 == 0) {
          func_0x014388e4();
        }
        ...
        func_0x02b75870(iVar3,iVar9,uVar4,1,0xb1,0,0,0,0,0,0,0,uVar2,0,0);
        iVar1 = *piVar7;
        if (iVar1 == 0) {
          func_0x014388e4();
        }
