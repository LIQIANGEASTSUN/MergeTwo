...
uint FUN_02fce5ec(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_02fce6d4 + 0x2fce60c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fce6d8 + 0x2fce620));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x70f1,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x70f1,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_02fce6dc + 0x2fce69c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_02fc8d20();
  if (iVar2 == 0) {
  ...
  pcVar11 = (char *)(_UNK_02fcdec4 + 0x2fcddbc);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fcdec8 + 0x2fcddd0));
    func_0x01438628(*(undefined4 *)(_UNK_02fcdecc + 0x2fcdddc));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x70ed,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_02fcded0 + 0x2fcde38) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_02fcded4 + 0x2fcde54));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_02fd785c + 0x2fd7628);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_02fd7860 + 0x2fd763c));
      func_0x01438628(*(undefined4 *)(_UNK_02fd7864 + 0x2fd7648));
      func_0x01438628(*(undefined4 *)(_UNK_02fd7868 + 0x2fd7654));
      func_0x01438628(*(undefined4 *)(_UNK_02fd786c + 0x2fd7660));
      func_0x01438628(*(undefined4 *)(_UNK_02fd7870 + 0x2fd766c));
      func_0x01438628(*(undefined4 *)(_UNK_02fd7874 + 0x2fd7678));
      func_0x01438628(*(undefined4 *)(_UNK_02fd7878 + 0x2fd7684));
      *pcVar11 = '\x01';
    }
    iVar1 = func_0x02953fd4(0x70cd,0);
    if (iVar1 == 0) {
      iVar1 = func_0x02fd1858(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x046c26fc(iVar1,param_3,**(undefined4 **)(_UNK_02fd787c + 0x2fd7700));
      if (iVar1 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x04f6b198(**(undefined4 **)(_UNK_02fd7880 + 0x2fd7764),uVar10,
                                 **(undefined4 **)(_UNK_02fd7884 + 0x2fd7770),0);
        if (*(int *)(**(int **)(_UNK_02fd7888 + 0x2fd7784) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_3,**(undefined4 **)(_UNK_02fd7890 + 0x2fd77b8));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_02fd788c + 0x2fd7734));
        }
        func_0x03b70fe4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_02fd7894 + 0x2fd77dc));
        iVar1 = func_0x02fd1858(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_02fd7898 + 0x2fd780c));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x02fd1858(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_02fd789c + 0x2fd784c);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x70cd,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x70ed,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
