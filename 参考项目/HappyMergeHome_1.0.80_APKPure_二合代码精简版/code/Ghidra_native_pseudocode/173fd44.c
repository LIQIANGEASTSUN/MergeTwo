...
undefined4 FUN_0174fd44(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_0174fe30 + 0x174fd58);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0174fe34 + 0x174fd6c));
    func_0x01438628(*(undefined4 *)(_UNK_0174fe38 + 0x174fd78));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8cff,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8cff,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0174fe3c + 0x174fdd0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0174fe40 + 0x174fdec));
  iVar6 = FUN_0174edb4(param_1);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
