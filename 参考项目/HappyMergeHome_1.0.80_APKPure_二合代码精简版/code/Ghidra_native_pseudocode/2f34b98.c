...

{
  ...
  pcVar4 = (char *)(_UNK_02f44c44 + 0x2f44ba8);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f44c48 + 0x2f44bbc));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x6dfd,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x6dfd,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f44c4c + 0x2f44c10) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_02f3dd38();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
