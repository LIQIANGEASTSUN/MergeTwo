...
int FUN_0313fa50(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_0313fbcc + 0x313fa64);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0313fbd0 + 0x313fa78));
    func_0x01438628(*(undefined4 *)(_UNK_0313fbd4 + 0x313fa84));
    func_0x01438628(*(undefined4 *)(_UNK_0313fbd8 + 0x313fa90));
    func_0x01438628(*(undefined4 *)(_UNK_0313fbdc + 0x313fa9c));
    *pcVar7 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x79c1,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x79c1,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0313fbe0 + 0x313faf4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_0313fbe4 + 0x313fb10));
  piVar8 = *(int **)(_UNK_0313fbe8 + 0x313fb24);
  iVar6 = *piVar8;
  if (*(int *)(iVar6 + 0x74) == 0) {
    func_0x014387a4();
    iVar6 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_0313fbec + 0x313fb44);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar6 + 0x5c) + 0x794);
  if (iVar4 == 0) {
