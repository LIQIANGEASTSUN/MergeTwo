...

{
  ...
  pcVar7 = (char *)(_UNK_02f9b378 + 0x2f9b2e4);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f9b37c + 0x2f9b2f8));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x6f88,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x6f88,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar6 = **(int **)(_UNK_02f9b380 + 0x2f9b36c);
