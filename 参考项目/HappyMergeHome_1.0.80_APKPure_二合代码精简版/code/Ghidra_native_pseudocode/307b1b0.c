...
undefined4 FUN_0308b1b0(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_0308b28c + 0x308b1c4);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0308b290 + 0x308b1d8));
    func_0x01438628(*(undefined4 *)(_UNK_0308b294 + 0x308b1e4));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x75bc,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_0308b298 + 0x308b23c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_0308b29c + 0x308b258));
    uVar7 = func_0x0308b2a0(param_1);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = func_0x029540a4(0x75bc,0);
  if (iVar3 == 0) {
    func_0x014388e4();
  }
