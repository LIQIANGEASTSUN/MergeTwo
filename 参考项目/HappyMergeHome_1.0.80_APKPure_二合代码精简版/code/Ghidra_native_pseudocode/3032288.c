...
uint FUN_03042288(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar2 = func_0x02953fd4(0x73fd,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_030423b4 + 0x304231c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_030423b8 + 0x3042338));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x02953fd4(0x73d1,0);
    if (iVar2 == 0) {
      iVar2 = func_0x03045d3c(param_1);
      if (iVar2 == 0) {
        func_0x014388e4();
      }
      iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_0304bd64 + 0x304bbe8));
      if (iVar2 == 0) {
        ...
        if (iVar2 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_0304bd78 + 0x304bca0));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar2,param_2,**(undefined4 **)(_UNK_0304bd74 + 0x304bc1c));
        }
        func_0x03b70fe4(iVar2,param_2,iVar9 + -1,**(undefined4 **)(_UNK_0304bd7c + 0x304bcc4));
        iVar2 = func_0x03045d3c(param_1);
        if (iVar2 == 0) {
          func_0x014388e4();
        }
        uVar1 = func_0x03b70fac(iVar2,param_2,**(undefined4 **)(_UNK_0304bd80 + 0x304bcf4));
        if ((int)uVar1 < 1) {
          iVar2 = func_0x03045d3c(param_1);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar9 = **(int **)(_UNK_0304bd84 + 0x304bd34);
...
LAB_046c3e4c:
    ...
    iVar2 = func_0x029540a4(0x73d1,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar2 = func_0x029540a4(0x73fd,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
