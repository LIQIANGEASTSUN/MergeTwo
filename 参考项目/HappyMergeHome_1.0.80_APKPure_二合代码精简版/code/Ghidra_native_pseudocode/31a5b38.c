...
void FUN_031b5b38(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  pcVar4 = (char *)(_UNK_031b5c24 + 0x31b5b58);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031b5c28 + 0x31b5b78));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7ccf,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7ccf,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    iStack_34 = param_5;
  ...
  if (*(int *)(**(int **)(_UNK_031b5c2c + 0x31b5be8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_031b08c8();
  if (iVar1 == 0) {
  ...
  uStack_2c = uStack_3c;
  iStack_28 = iStack_44;
  iVar2 = func_0x02953fd4(0x7cd0,0);
  if (iVar2 == 0) {
    ...
    *puVar3 = uStack_58;
    ...
    iVar2 = func_0x029540a4(0x7cd0,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
