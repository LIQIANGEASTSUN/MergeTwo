...
int FUN_01af751c(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0xd31,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xd31,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = FUN_01af6f10(param_1);
  if (iVar1 == 0) {
    return 0;
  }
  pcVar6 = (char *)(_UNK_01b3b630 + 0x1b3b4cc);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01b3b634 + 0x1b3b4e0));
    func_0x01438628(*(undefined4 *)(_UNK_01b3b638 + 0x1b3b4ec));
    func_0x01438628(*(undefined4 *)(_UNK_01b3b63c + 0x1b3b4f8));
    func_0x01438628(*(undefined4 *)(_UNK_01b3b640 + 0x1b3b504));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xd37,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xd37,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_01b3b644 + 0x1b3b558) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01b3b648 + 0x1b3b574));
  piVar7 = *(int **)(_UNK_01b3b64c + 0x1b3b588);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_01b3b650 + 0x1b3b5a8);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0x158);
  if (iVar2 == 0) {
