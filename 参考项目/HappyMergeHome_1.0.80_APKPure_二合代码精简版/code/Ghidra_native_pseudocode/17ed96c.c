...
void FUN_017fd96c(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_017fda24 + 0x17fd980);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017fda28 + 0x17fd994));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x907c,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x907c,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x01810474(param_1);
  iVar7 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_017fda2c + 0x17fd9fc) + 0x74) == 0) {
    func_0x014387a4();
  }
