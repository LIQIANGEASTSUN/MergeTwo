...

{
  ...
  pcVar9 = (char *)(_UNK_0192a0e4 + 0x1929f70);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0192a0e8 + 0x1929f84));
    func_0x01438628(*(undefined4 *)(_UNK_0192a0ec + 0x1929f90));
    func_0x01438628(*(undefined4 *)(_UNK_0192a0f0 + 0x1929f9c));
    func_0x01438628(*(undefined4 *)(_UNK_0192a0f4 + 0x1929fa8));
    func_0x01438628(*(undefined4 *)(_UNK_0192a0f8 + 0x1929fb4));
    func_0x01438628(*(undefined4 *)(_UNK_0192a0fc + 0x1929fc0));
    *pcVar9 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x97a0,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x97a0,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0192a100 + 0x192a024) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0192a104 + 0x192a040));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar1 = func_0x036c7bec(iVar1,**(undefined4 **)(_UNK_0192a108 + 0x192a060));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar1 + 0x3ac) != 0) {
    func_0x024f04d0(*(int *)(iVar1 + 0x3ac),**(undefined4 **)(_UNK_0192a10c + 0x192a090));
  }
  if (*(int *)(**(int **)(_UNK_0192a110 + 0x192a0a0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0192a114 + 0x192a0bc));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  pcVar9 = (char *)(_UNK_02be82b0 + 0x2be8170);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x5e,0);
  ...
  if (iVar10 != 0) {
    ...
    uStack_38 = 0;
    uStack_28 = 0;
    func_0x024f56c0(&uStack_50,0,0x5e,0);
    uStack_38 = uStack_50;
    iStack_34 = uStack_4c;
    uStack_30 = uStack_48;
    uStack_2c = iStack_44;
    ...
    func_0x01523a2c(&uStack_38,0x5e,0);
    iVar11 = *(int *)(iVar10 + 8);
  ...
  iVar1 = func_0x046ccb14(uVar3,0x5e,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar1 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar2 = (*(code *)*puVar4)(piVar8,0x5e,puVar4[1]);
      uVar3 = uStack_30;
    }
    iVar10 = *(int *)(uVar3 + 8);
    iVar1 = iVar10;
