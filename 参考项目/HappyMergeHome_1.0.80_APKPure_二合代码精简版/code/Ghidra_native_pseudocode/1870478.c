...
void FUN_01880478(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_01880634 + 0x1880490);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01880638 + 0x18804a4));
    func_0x01438628(*(undefined4 *)(_UNK_0188063c + 0x18804b0));
    func_0x01438628(*(undefined4 *)(_UNK_01880640 + 0x18804bc));
    func_0x01438628(*(undefined4 *)(_UNK_01880644 + 0x18804c8));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x29e2,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x29e2,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar2 = func_0x024f0540(iVar2,param_2,**(undefined4 **)(_UNK_01880648 + 0x1880560));
  iVar5 = FUN_01873864(param_1);
  if (iVar5 == 0) {
    func_0x014388e4();
  }
  ...
  if (iVar5 == 0) {
    func_0x014388e4();
    if (iVar2 == 0) goto LAB_01880614;
    iVar2 = func_0x024f05d4(0,param_2,**(undefined4 **)(_UNK_0188064c + 0x18805e4));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_01880614:
      iVar2 = **(int **)(_UNK_01880658 + 0x1880628);
      iStack_18 = unaff_r4;
      if (iVar5 == 0) {
        func_0x024f83d4();
      }
    ...
    iVar2 = func_0x024f05d4(iVar5,param_2,**(undefined4 **)(_UNK_01880650 + 0x18805b8));
  }
  unaff_r7 = iVar2 + 1;
  unaff_r5 = **(int **)(_UNK_01880654 + 0x1880608);
  iStack_1c = unaff_r7;
  if (iVar5 == 0) {
    func_0x024f83d4();
  }
