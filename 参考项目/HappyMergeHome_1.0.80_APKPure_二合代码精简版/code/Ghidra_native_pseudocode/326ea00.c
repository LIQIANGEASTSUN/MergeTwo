...
int FUN_0327ea00(undefined4 param_1,int param_2)

{
  ...
  pcVar5 = (char *)(_UNK_0327ee18 + 0x327ea1c);
  if (*pcVar5 == '\0') {
  ...
  iVar2 = func_0x02953fd4(0x1f54,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x1f54,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  puVar10 = *(undefined4 **)(_UNK_0327ee44 + 0x327eb3c);
  iVar2 = func_0x04cd2d7c(iVar2,param_2,*puVar10);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_0327ee48 + 0x327eb5c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0327ee4c + 0x327eb78));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iVar2 = *(int *)(iVar2 + 0x2c);
    iVar7 = 0;
    puVar11 = *(undefined4 **)(_UNK_0327ee50 + 0x327eba0);
    do {
      if (iVar2 == 0) {
        func_0x014388e4();
      }
    ...
    while( true ) {
      ...
      if (*(int *)(iVar3 + 0x24) <= param_2) {
        ...
        if (iVar3 == 0) {
          ...
          func_0x03b75ba0(iVar3,uVar9,**(undefined4 **)(_UNK_0327ee54 + 0x327ed18));
        }
      }
      iVar7 = iVar7 + 1;
    }
    ...
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0327ee5c + 0x327ed58));
    ...
    iVar6 = **(int **)(_UNK_0327ee64 + 0x327ed8c);
