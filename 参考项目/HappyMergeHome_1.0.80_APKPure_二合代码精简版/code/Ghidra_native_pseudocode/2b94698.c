...
undefined4 FUN_02ba4698(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0xfd8,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xfd8,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    uVar5 = func_0x024f56d0(iVar3,uVar5,&uStack_30,uVar2,0,0);
    return uVar5;
  }
  func_0x02baa958(param_1);
