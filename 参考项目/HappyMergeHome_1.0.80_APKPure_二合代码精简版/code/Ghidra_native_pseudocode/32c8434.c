...
/* WARNING: Possible PIC construction at 0x032d85b4: Changing call to branch */
/* WARNING: Possible PIC construction at 0x032d85dc: Changing call to branch */
/* WARNING: Possible PIC construction at 0x032d8604: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x032d85e0) */
/* WARNING: Removing unreachable block (ram,0x032d85f4) */
/* WARNING: Removing unreachable block (ram,0x032d85f8) */
/* WARNING: Removing unreachable block (ram,0x032d85b8) */
/* WARNING: Removing unreachable block (ram,0x032d85cc) */
/* WARNING: Removing unreachable block (ram,0x032d85d0) */
/* WARNING: Removing unreachable block (ram,0x032d8608) */
/* WARNING: Removing unreachable block (ram,0x032d861c) */
/* WARNING: Removing unreachable block (ram,0x032d8620) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_032d8434(int param_1)

{
  ...
  pcVar11 = (char *)(_UNK_032d8634 + 0x32d8448);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032d8638 + 0x32d845c));
    func_0x01438628(*(undefined4 *)(_UNK_032d863c + 0x32d8468));
    func_0x01438628(*(undefined4 *)(_UNK_032d8640 + 0x32d8474));
    func_0x01438628(*(undefined4 *)(_UNK_032d8644 + 0x32d8480));
    func_0x01438628(*(undefined4 *)(_UNK_032d8648 + 0x32d848c));
    func_0x01438628(*(undefined4 *)(_UNK_032d864c + 0x32d8498));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x83bd,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x83bd,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_032d8650 + 0x32d84fc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_032d8654 + 0x32d8518));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = func_0x036c7bec(iVar3,**(undefined4 **)(_UNK_032d8658 + 0x32d8538));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar3 + 0x32c) != 0) {
    func_0x03b73ab8(*(int *)(iVar3 + 0x32c),**(undefined4 **)(_UNK_032d865c + 0x32d8568));
  }
  if (*(int *)(**(int **)(_UNK_032d8660 + 0x32d8578) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar12 = *(undefined4 **)(_UNK_032d8664 + 0x32d8594);
  ...
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x2d,0);
  ...
  if (iVar3 != 0) {
    ...
    puStack_30 = puVar4;
    puStack_2c = puVar12;
    func_0x024f56c0(&uStack_60,0,0x2d,0);
    ...
    func_0x01523a2c(&puStack_48,0x2d,0);
    iVar10 = *(int *)(iVar3 + 8);
    uVar13 = *(undefined4 *)(iVar3 + 0xc);
    iVar3 = *(int *)(iVar3 + 0x10);
    if (iVar10 == 0) {
  ...
  iVar10 = func_0x046ccb14(iVar3,0x2d,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar10 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar1 = (*(code *)*puVar4)(piVar9,0x2d,puVar4[1]);
      iVar3 = iStack_40;
    }
    iVar10 = *(int *)(iVar3 + 8);
    iVar3 = iVar10;
