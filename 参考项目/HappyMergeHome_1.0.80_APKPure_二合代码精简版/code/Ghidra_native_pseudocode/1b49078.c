...

{
  ...
  pcVar6 = (char *)(_UNK_01b59128 + 0x1b5908c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01b5912c + 0x1b590a0));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0xa683,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0xa683,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (param_1 != 0 && iVar2 != 0) {
    ...
    iVar7 = **(int **)(_UNK_01b59130 + 0x1b5911c);
