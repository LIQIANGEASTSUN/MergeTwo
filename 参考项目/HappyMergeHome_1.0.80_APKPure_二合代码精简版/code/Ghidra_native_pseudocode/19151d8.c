...
uint FUN_019251d8(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_019252c0 + 0x19251f8);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_019252c4 + 0x192520c));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9788,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9788,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_019252c8 + 0x1925288) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_01920184();
  if (iVar1 == 0) {
  ...
  pcVar11 = (char *)(_UNK_019253ec + 0x19252e4);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_019253f0 + 0x19252f8));
    func_0x01438628(*(undefined4 *)(_UNK_019253f4 + 0x1925304));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x9789,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_019253f8 + 0x1925360) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_019253fc + 0x192537c));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_0192dd78 + 0x192db44);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_0192dd7c + 0x192db58));
      func_0x01438628(*(undefined4 *)(_UNK_0192dd80 + 0x192db64));
      func_0x01438628(*(undefined4 *)(_UNK_0192dd84 + 0x192db70));
      func_0x01438628(*(undefined4 *)(_UNK_0192dd88 + 0x192db7c));
      func_0x01438628(*(undefined4 *)(_UNK_0192dd8c + 0x192db88));
      func_0x01438628(*(undefined4 *)(_UNK_0192dd90 + 0x192db94));
      func_0x01438628(*(undefined4 *)(_UNK_0192dd94 + 0x192dba0));
      *pcVar11 = '\x01';
    }
    iVar3 = func_0x02953fd4(0x9771,0);
    if (iVar3 == 0) {
      iVar3 = func_0x01927e84(iVar1);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x024f0540(iVar3,param_3,**(undefined4 **)(_UNK_0192dd98 + 0x192dc1c));
      if (iVar3 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x024eee28(**(undefined4 **)(_UNK_0192dd9c + 0x192dc80),uVar10,
                                 **(undefined4 **)(_UNK_0192dda0 + 0x192dc8c),0);
        if (*(int *)(**(int **)(_UNK_0192dda4 + 0x192dca0) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar3 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_3,**(undefined4 **)(_UNK_0192ddac + 0x192dcd4));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar3,param_3,**(undefined4 **)(_UNK_0192dda8 + 0x192dc50));
        }
        func_0x024f10d4(iVar3,param_3,iVar9 + -1,**(undefined4 **)(_UNK_0192ddb0 + 0x192dcf8));
        iVar3 = func_0x01927e84(iVar1);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x024f05d4(iVar3,param_3,**(undefined4 **)(_UNK_0192ddb4 + 0x192dd28));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x01927e84(iVar1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar3 = **(int **)(_UNK_0192ddb8 + 0x192dd68);
...
LAB_046c3e4c:
    ...
    iVar3 = func_0x029540a4(0x9771,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar3 = func_0x029540a4(0x9789,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
