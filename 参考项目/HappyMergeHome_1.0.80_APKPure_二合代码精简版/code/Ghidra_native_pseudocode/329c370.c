...

{
  ...
  pcVar7 = (char *)(_UNK_032ac418 + 0x32ac384);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032ac41c + 0x32ac398));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8287,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8287,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar6 = **(int **)(_UNK_032ac420 + 0x32ac40c);
