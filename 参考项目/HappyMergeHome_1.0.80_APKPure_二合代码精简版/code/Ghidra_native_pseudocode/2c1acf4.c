...
undefined4 FUN_02c2acf4(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2aeb4 + 0x2c2ad08);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2aeb8 + 0x2c2ad1c));
    func_0x01438628(*(undefined4 *)(_UNK_02c2aebc + 0x2c2ad28));
    func_0x01438628(*(undefined4 *)(_UNK_02c2aec0 + 0x2c2ad34));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d89,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d89,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2aec4 + 0x2c2ae5c));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2aec8 + 0x2c2ae78),0);
  if (*(int *)(**(int **)(_UNK_02c2aecc + 0x2c2ae8c) + 0x74) == 0) {
    func_0x014387a4();
  }
