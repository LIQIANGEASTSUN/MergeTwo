...
void FUN_01678f40(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_01678ff8 + 0x1678f54);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01678ffc + 0x1678f68));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8756,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8756,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x0168c60c(param_1);
  iVar7 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_01679000 + 0x1678fd0) + 0x74) == 0) {
    func_0x014387a4();
  }
