...
undefined4
FUN_017d3eac(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  pcVar7 = (char *)(_UNK_017d40a4 + 0x17d3ecc);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017d40a8 + 0x17d3eec));
    func_0x01438628(*(undefined4 *)(_UNK_017d40ac + 0x17d3ef8));
    func_0x01438628(*(undefined4 *)(_UNK_017d40b0 + 0x17d3f04));
    func_0x01438628(*(undefined4 *)(_UNK_017d40b4 + 0x17d3f10));
    func_0x01438628(*(undefined4 *)(_UNK_017d40b8 + 0x17d3f1c));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8f8d,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8f8d,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_34 = param_5;
  ...
  if (*(int *)(**(int **)(_UNK_017d40bc + 0x17d3f8c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_017d0b50();
  if (iVar1 == 0) {
  ...
  func_0x017d40d0(iVar1,param_4,param_6);
  iVar1 = FUN_017d0b50();
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  func_0x017d41e4(iVar1);
  piVar6 = *(int **)(_UNK_017d40c0 + 0x17d3fe8);
  iVar1 = *piVar6;
  if (*(int *)(iVar1 + 0x74) == 0) {
    func_0x014387a4();
    iVar1 = *piVar6;
  ...
  if (iVar5 == 0) {
    ...
    iVar5 = func_0x014388d4(**(undefined4 **)(_UNK_017d40c4 + 0x17d4030));
    func_0x0152e3ec(iVar5,uVar2,**(undefined4 **)(_UNK_017d40c8 + 0x17d4050),0);
    piVar6 = (int *)(*(int *)(*piVar6 + 0x5c) + 4);
    *piVar6 = iVar5;
    func_0x014385cc(piVar6,iVar5);
  }
  if (*(int *)(**(int **)(_UNK_017d40cc + 0x17d4078) + 0x74) == 0) {
    func_0x014387a4();
  }
  ...
  if (iVar1 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      if (iVar5 != 0 && iVar3 != 0) {
        ...
        uVar2 = (*(code *)&UNK_05d3fe88)(iVar1,iVar5,0);
        return uVar2;
      }
      return 0;
    }
    ...
    func_0x024f56d0(iVar5,uVar2,&uStack_38,uVar4,0,0);
  ...
  uVar2 = func_0x024f56d0(iVar5,uVar2,&uStack_38,uVar4,0,0);
  return uVar2;
}
