...
void FUN_02ebde80(undefined4 param_1)

{
  ...
  iVar3 = func_0x02953fd4(0x480d,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x480d,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  pcVar6 = (char *)(_UNK_026c2ba0 + 0x26c2b18);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_026c2ba4 + 0x26c2b2c),1,0);
    func_0x01438628(*(undefined4 *)(_UNK_026c2ba8 + 0x26c2b38));
    *pcVar6 = '\x01';
  }
  if (*(char *)(iVar3 + 0x30) == '\x01') {
    return;
  }
  ...
  *(undefined1 *)(iVar3 + 0x30) = 1;
  ...
  iVar3 = func_0x014e9518(**(undefined4 **)(_UNK_026c2bb0 + 0x26c2b78));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
