...

{
  ...
  pcVar4 = (char *)(_UNK_0310c158 + 0x310c0bc);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0310c15c + 0x310c0d0));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x788c,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x788c,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0310c160 + 0x310c124) + 0x74) == 0) {
    func_0x014387a4();
  }
