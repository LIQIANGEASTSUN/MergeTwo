...
undefined4 FUN_02c2ccc8(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2ce88 + 0x2c2ccdc);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2ce8c + 0x2c2ccf0));
    func_0x01438628(*(undefined4 *)(_UNK_02c2ce90 + 0x2c2ccfc));
    func_0x01438628(*(undefined4 *)(_UNK_02c2ce94 + 0x2c2cd08));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5dab,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5dab,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2ce98 + 0x2c2ce30));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2ce9c + 0x2c2ce4c),0);
  if (*(int *)(**(int **)(_UNK_02c2cea0 + 0x2c2ce60) + 0x74) == 0) {
    func_0x014387a4();
  }
