...
undefined4 FUN_019364a0(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar5 = (char *)(_UNK_019365dc + 0x19364b8);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_019365e0 + 0x19364cc));
    func_0x01438628(*(undefined4 *)(_UNK_019365e4 + 0x19364d8));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x97c6,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x97c6,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_019365e8 + 0x1936570));
  if (iVar1 != 0) {
    iVar1 = FUN_01926264(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_019365ec + 0x19365c8);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
