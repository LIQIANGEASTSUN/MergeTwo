...

{
  ...
  if (iVar3 == 0) {
    ...
    if (iVar3 == 0) {
      ...
      if (*(int *)(param_1 + 0xc) == 0) goto LAB_032855e8;
    }
  }
  else {
    iVar8 = *(int *)(iVar3 + 8);
...
LAB_032855e8:
        ...
        uVar11 = 0x32855ec;
        pcVar1 = (char *)(_UNK_03285730 + 0x3285604);
        if (*pcVar1 == '\0') {
        ...
        iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_03285748 + 0x328566c));
        ...
        iVar10 = func_0x04e4a028(**(undefined4 **)(_UNK_03285750 + 0x32856e4));
        if (iVar10 == 0) {
          func_0x014388e4();
        }
