...
uint FUN_01d39bc4(int param_1,int param_2)

{
  ...
  pcVar10 = (char *)(_UNK_01d39c8c + 0x1d39bdc);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01d39c90 + 0x1d39bf0));
    *pcVar10 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x1af6,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_01d39c94 + 0x1d39c4c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x02c35d10(0x44,0);
    if (iVar3 == 0) {
      return 0;
    }
    ...
    iVar3 = func_0x029540a4(0x1af6,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
