...
int FUN_02fd1a00(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_02fd1acc + 0x2fd1a14);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fd1ad0 + 0x2fd1a28));
    func_0x01438628(*(undefined4 *)(_UNK_02fd1ad4 + 0x2fd1a34));
    *pcVar9 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7104,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7104,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02fd1ad8 + 0x2fd1a8c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_02fd1adc + 0x2fd1aa8));
  if (iVar2 == 0) {
    func_0x014388e4();
  }
