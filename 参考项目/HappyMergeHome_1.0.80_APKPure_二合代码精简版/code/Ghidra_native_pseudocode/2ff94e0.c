...
uint FUN_030094e0(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_030095c8 + 0x3009500);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030095cc + 0x3009514));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7274,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7274,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_030095d0 + 0x3009590) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_03003ba4();
  if (iVar2 == 0) {
  ...
  pcVar11 = (char *)(_UNK_03008e0c + 0x3008d04);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03008e10 + 0x3008d18));
    func_0x01438628(*(undefined4 *)(_UNK_03008e14 + 0x3008d24));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7270,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_03008e18 + 0x3008d80) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x04e4a028(**(undefined4 **)(_UNK_03008e1c + 0x3008d9c));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_03011798 + 0x3011564);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_0301179c + 0x3011578));
      func_0x01438628(*(undefined4 *)(_UNK_030117a0 + 0x3011584));
      func_0x01438628(*(undefined4 *)(_UNK_030117a4 + 0x3011590));
      func_0x01438628(*(undefined4 *)(_UNK_030117a8 + 0x301159c));
      func_0x01438628(*(undefined4 *)(_UNK_030117ac + 0x30115a8));
      func_0x01438628(*(undefined4 *)(_UNK_030117b0 + 0x30115b4));
      func_0x01438628(*(undefined4 *)(_UNK_030117b4 + 0x30115c0));
      *pcVar11 = '\x01';
    }
    iVar1 = func_0x02953fd4(0x7258,0);
    if (iVar1 == 0) {
      iVar1 = func_0x0300b8a4(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x046c26fc(iVar1,param_3,**(undefined4 **)(_UNK_030117b8 + 0x301163c));
      if (iVar1 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x04f6b198(**(undefined4 **)(_UNK_030117bc + 0x30116a0),uVar10,
                                 **(undefined4 **)(_UNK_030117c0 + 0x30116ac),0);
        if (*(int *)(**(int **)(_UNK_030117c4 + 0x30116c0) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_3,**(undefined4 **)(_UNK_030117cc + 0x30116f4));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_030117c8 + 0x3011670));
        }
        func_0x03b70fe4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_030117d0 + 0x3011718));
        iVar1 = func_0x0300b8a4(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x03b70fac(iVar1,param_3,**(undefined4 **)(_UNK_030117d4 + 0x3011748));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x0300b8a4(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_030117d8 + 0x3011788);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x7258,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x7270,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
