...
uint FUN_01803064(int param_1,int param_2)

{
  ...
  pcVar10 = (char *)(_UNK_0180312c + 0x180307c);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01803130 + 0x1803090));
    *pcVar10 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x13a3,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_01803134 + 0x18030ec) + 0x74) == 0) {
      func_0x014387a4();
    }
    ...
    iVar3 = func_0x029540a4(0x13a3,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
