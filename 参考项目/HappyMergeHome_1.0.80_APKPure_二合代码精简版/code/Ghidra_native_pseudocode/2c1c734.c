...
undefined4 FUN_02c2c734(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2c8f4 + 0x2c2c748);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2c8f8 + 0x2c2c75c));
    func_0x01438628(*(undefined4 *)(_UNK_02c2c8fc + 0x2c2c768));
    func_0x01438628(*(undefined4 *)(_UNK_02c2c900 + 0x2c2c774));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5da5,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5da5,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2c904 + 0x2c2c89c));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2c908 + 0x2c2c8b8),0);
  if (*(int *)(**(int **)(_UNK_02c2c90c + 0x2c2c8cc) + 0x74) == 0) {
    func_0x014387a4();
  }
