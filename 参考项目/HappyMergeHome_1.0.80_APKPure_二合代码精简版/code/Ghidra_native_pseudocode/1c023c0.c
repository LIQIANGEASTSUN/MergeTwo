...
undefined4 FUN_01c123c0(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar5 = (char *)(_UNK_01c124dc + 0x1c123d8);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01c124e0 + 0x1c123ec));
    func_0x01438628(*(undefined4 *)(_UNK_01c124e4 + 0x1c123f8));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x34eb,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x34eb,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_01c124e8 + 0x1c12480));
  if (iVar1 != 0) {
    iVar1 = FUN_01c0e5e0(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_01c124ec + 0x1c124c8);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
