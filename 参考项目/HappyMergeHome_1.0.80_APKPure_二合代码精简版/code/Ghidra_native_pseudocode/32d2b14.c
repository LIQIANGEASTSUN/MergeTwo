...
undefined4 FUN_032e2b14(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_032e2c50 + 0x32e2b2c);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032e2c54 + 0x32e2b40));
    func_0x01438628(*(undefined4 *)(_UNK_032e2c58 + 0x32e2b4c));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x83e2,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x83e2,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x046c26fc(iVar1,param_2,**(undefined4 **)(_UNK_032e2c5c + 0x32e2be4));
  if (iVar1 != 0) {
    iVar1 = FUN_032d4694(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_032e2c60 + 0x32e2c3c);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
