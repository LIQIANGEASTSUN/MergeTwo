...

{
  ...
  pcVar4 = (char *)(_UNK_03275bbc + 0x3275b20);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03275bc0 + 0x3275b34));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x814f,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x814f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03275bc4 + 0x3275b88) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_03271308();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
