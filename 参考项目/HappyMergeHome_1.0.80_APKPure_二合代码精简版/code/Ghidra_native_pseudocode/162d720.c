...
void FUN_0163d720(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar8 = (char *)(_UNK_0163d7e4 + 0x163d738);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0163d7e8 + 0x163d74c));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x85c6,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x85c6,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x0164f998(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_0163d7ec + 0x163d7bc) + 0x74) == 0) {
    func_0x014387a4();
  }
