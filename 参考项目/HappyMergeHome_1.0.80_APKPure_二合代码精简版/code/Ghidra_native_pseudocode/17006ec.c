...
void FUN_017106ec(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar8 = (char *)(_UNK_017107b0 + 0x1710704);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017107b4 + 0x1710718));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8b36,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8b36,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x01721788(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_017107b8 + 0x1710788) + 0x74) == 0) {
    func_0x014387a4();
  }
