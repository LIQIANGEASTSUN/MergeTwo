...
void FUN_02fa631c(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar7 = (char *)(_UNK_02fa64d8 + 0x2fa6334);
  if (*pcVar7 == '\0') {
  ...
  iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_02fa64ec + 0x2fa6404));
  ...
  if (iVar5 == 0) {
    ...
    iVar2 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_02fa64f0 + 0x2fa6488));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_02fa64b8:
    ...
    iVar2 = func_0x03b70fac(iVar5,param_2,**(undefined4 **)(_UNK_02fa64f4 + 0x2fa645c));
  }
  unaff_r7 = iVar2 + 1;
