...
int FUN_0167e518(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_0167e5e4 + 0x167e52c);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0167e5e8 + 0x167e540));
    func_0x01438628(*(undefined4 *)(_UNK_0167e5ec + 0x167e54c));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8796,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8796,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0167e5f0 + 0x167e5a4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0167e5f4 + 0x167e5c0));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
