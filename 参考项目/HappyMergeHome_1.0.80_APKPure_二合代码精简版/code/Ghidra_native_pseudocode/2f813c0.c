...
int FUN_02f913c0(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_02f9153c + 0x2f913d4);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f91540 + 0x2f913e8));
    func_0x01438628(*(undefined4 *)(_UNK_02f91544 + 0x2f913f4));
    func_0x01438628(*(undefined4 *)(_UNK_02f91548 + 0x2f91400));
    func_0x01438628(*(undefined4 *)(_UNK_02f9154c + 0x2f9140c));
    *pcVar7 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x6f37,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x6f37,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f91550 + 0x2f91464) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02f91554 + 0x2f91480));
  piVar8 = *(int **)(_UNK_02f91558 + 0x2f91494);
  iVar6 = *piVar8;
  if (*(int *)(iVar6 + 0x74) == 0) {
    func_0x014387a4();
    iVar6 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_02f9155c + 0x2f914b4);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar6 + 0x5c) + 0x944);
  if (iVar4 == 0) {
