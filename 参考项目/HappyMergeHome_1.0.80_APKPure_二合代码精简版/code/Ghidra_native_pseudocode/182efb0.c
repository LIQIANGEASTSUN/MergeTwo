...
int FUN_0183efb0(int *param_1,int param_2,int param_3)

{
  ...
  pcVar10 = (char *)(_UNK_0183f184 + 0x183efd0);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0183f188 + 0x183efe4));
    func_0x01438628(*(undefined4 *)(_UNK_0183f18c + 0x183eff0));
    func_0x01438628(*(undefined4 *)(_UNK_0183f190 + 0x183effc));
    *pcVar10 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9215,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9215,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0183f194 + 0x183f064) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0183f198 + 0x183f080));
  uVar2 = (**(code **)(*param_1 + 0x1a0))(param_1,*(undefined4 *)(*param_1 + 0x1a4));
  piVar3 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_0183f19c + 0x183f0b0),2);
  if (piVar3 == (int *)0x0) {
    func_0x014388e4();
  }
  if ((param_2 != 0) &&
