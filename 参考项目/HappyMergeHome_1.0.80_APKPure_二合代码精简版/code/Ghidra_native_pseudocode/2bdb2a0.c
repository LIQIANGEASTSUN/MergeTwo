...
/* WARNING: Possible PIC construction at 0x02beb444: Changing call to branch */
/* WARNING: Possible PIC construction at 0x02beb4a4: Changing call to branch */
/* WARNING: Possible PIC construction at 0x02beb504: Changing call to branch */
/* WARNING: Possible PIC construction at 0x02beb580: Changing call to branch */
/* WARNING: Possible PIC construction at 0x02beb5e0: Changing call to branch */
/* WARNING: Possible PIC construction at 0x02beb63c: Changing call to branch */
/* WARNING: Possible PIC construction at 0x02beb690: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x02beb640) */
/* WARNING: Removing unreachable block (ram,0x02beb67c) */
/* WARNING: Removing unreachable block (ram,0x02beb680) */
/* WARNING: Removing unreachable block (ram,0x02beb5e4) */
/* WARNING: Removing unreachable block (ram,0x02beb628) */
/* WARNING: Removing unreachable block (ram,0x02beb62c) */
/* WARNING: Removing unreachable block (ram,0x02beb584) */
/* WARNING: Removing unreachable block (ram,0x02beb5cc) */
/* WARNING: Removing unreachable block (ram,0x02beb5d0) */
/* WARNING: Removing unreachable block (ram,0x02beb508) */
/* WARNING: Removing unreachable block (ram,0x02beb52c) */
/* WARNING: Removing unreachable block (ram,0x02beb534) */
/* WARNING: Removing unreachable block (ram,0x02beb56c) */
/* WARNING: Removing unreachable block (ram,0x02beb570) */
/* WARNING: Removing unreachable block (ram,0x02beb4a8) */
/* WARNING: Removing unreachable block (ram,0x02beb4f0) */
/* WARNING: Removing unreachable block (ram,0x02beb4f4) */
/* WARNING: Removing unreachable block (ram,0x02beb448) */
/* WARNING: Removing unreachable block (ram,0x02beb490) */
/* WARNING: Removing unreachable block (ram,0x02beb494) */
/* WARNING: Removing unreachable block (ram,0x02beb694) */
/* WARNING: Removing unreachable block (ram,0x02beb6dc) */
/* WARNING: Removing unreachable block (ram,0x02beb6e0) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_02beb2a0(int param_1)

{
  ...
  pcVar11 = (char *)(_UNK_02beb6fc + 0x2beb2b8);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02beb700 + 0x2beb2cc));
    func_0x01438628(*(undefined4 *)(_UNK_02beb704 + 0x2beb2d8));
    func_0x01438628(*(undefined4 *)(_UNK_02beb708 + 0x2beb2e4));
    func_0x01438628(*(undefined4 *)(_UNK_02beb70c + 0x2beb2f0));
    func_0x01438628(*(undefined4 *)(_UNK_02beb710 + 0x2beb2fc));
    func_0x01438628(*(undefined4 *)(_UNK_02beb714 + 0x2beb308));
    func_0x01438628(*(undefined4 *)(_UNK_02beb718 + 0x2beb314));
    func_0x01438628(*(undefined4 *)(_UNK_02beb71c + 0x2beb320));
    func_0x01438628(*(undefined4 *)(_UNK_02beb720 + 0x2beb32c));
    func_0x01438628(*(undefined4 *)(_UNK_02beb724 + 0x2beb338));
    func_0x01438628(*(undefined4 *)(_UNK_02beb728 + 0x2beb344));
    func_0x01438628(*(undefined4 *)(_UNK_02beb72c + 0x2beb350));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x5edc,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x5edc,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02beb730 + 0x2beb3ac) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar14 = *(undefined4 **)(_UNK_02beb734 + 0x2beb3c8);
  iVar3 = func_0x014e9518(*puVar14);
  piVar15 = *(int **)(_UNK_02beb738 + 0x2beb3dc);
  iVar9 = *piVar15;
  if (*(int *)(iVar9 + 0x74) == 0) {
    func_0x014387a4();
    iVar9 = *piVar15;
  }
  puVar16 = *(undefined4 **)(_UNK_02beb73c + 0x2beb400);
  piVar13 = *(int **)(*(int *)(iVar9 + 0x5c) + 0x38);
  uVar12 = func_0x014388d4(*puVar16);
  func_0x038ec9e8(uVar12,param_1,**(undefined4 **)(_UNK_02beb740 + 0x2beb420),0);
  if (iVar3 == 0) {
    func_0x014388e4();
  }
