...
void FUN_03051598(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar7 = (char *)(_UNK_03051754 + 0x30515b0);
  if (*pcVar7 == '\0') {
  ...
  iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_03051768 + 0x3051680));
  iVar5 = FUN_0304411c(param_1);
  if (iVar5 == 0) {
    func_0x014388e4();
  }
  ...
  if (iVar5 == 0) {
    ...
    iVar2 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_0305176c + 0x3051704));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_03051734:
      ...
      uVar6 = *(undefined4 *)(*(int *)(*(int *)(iVar2 + 0x10) + 0x60) + 0x28);
      goto SUB_03b70bb0;
    }
    iVar2 = func_0x03b70fac(iVar5,param_2,**(undefined4 **)(_UNK_03051770 + 0x30516d8));
  }
  unaff_r7 = iVar2 + 1;
  ...
  if (iVar2 != 0) {
    ...
    uVar6 = func_0x024f83c4(*(undefined4 *)(*(int *)(*(int *)(unaff_r5 + 0x10) + 0x60) + 0x20),
                            &uStack_20);
  ...
  uVar6 = *(undefined4 *)(*(int *)(*(int *)(unaff_r5 + 0x10) + 0x60) + 0x28);
  unaff_lr = 0x3b710c8;
  iStack_18 = iVar5;
  unaff_r6 = param_2;
...
SUB_03b70bb0:
  ...
  *(int *)((int)register0x00000054 + -0x18) = iStack_18;
  ...
  if (*pcVar7 == '\0') {
    func_0x024f83cc(*(undefined4 *)(_UNK_03b70cc0 + 0x3b70bd8),uVar6);
