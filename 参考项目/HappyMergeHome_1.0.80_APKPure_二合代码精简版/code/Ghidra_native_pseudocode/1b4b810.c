...
undefined4 FUN_01b5b810(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_01b5b8b0 + 0x1b5b824);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01b5b8b4 + 0x1b5b838));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5a8b,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5a8b,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  piVar3 = *(int **)(_UNK_01b5b8b8 + 0x1b5b890);
  iVar1 = *piVar3;
  if (*(int *)(iVar1 + 0x74) == 0) {
    func_0x014387a4();
    iVar1 = *piVar3;
