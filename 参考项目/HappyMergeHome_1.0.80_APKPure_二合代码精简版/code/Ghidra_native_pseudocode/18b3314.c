...
int * FUN_018c3314(undefined4 param_1)

{
  ...
  pcVar11 = (char *)(_UNK_018c33f4 + 0x18c3328);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018c33f8 + 0x18c333c));
    func_0x01438628(*(undefined4 *)(_UNK_018c33fc + 0x18c3348));
    func_0x01438628(*(undefined4 *)(_UNK_018c3400 + 0x18c3354));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9526,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9526,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    pcVar11 = (char *)(_UNK_02929a3c + 0x292995c);
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_02929a40 + 0x2929970),param_1,0);
      *pcVar11 = '\x01';
    }
    ...
    piVar2 = (int *)func_0x035daef8(&uStack_30,0,**(undefined4 **)(_UNK_02929a44 + 0x2929a2c));
    return piVar2;
  }
  if (*(int *)(**(int **)(_UNK_018c3404 + 0x18c33ac) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018c3408 + 0x18c33c8));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar12 = **(int **)(_UNK_018c340c + 0x18c33e8);
  puVar15 = auStack_20;
