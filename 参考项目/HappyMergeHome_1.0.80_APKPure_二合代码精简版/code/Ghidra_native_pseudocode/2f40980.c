...
void FUN_02f50980(int param_1,undefined4 param_2)

{
  ...
  iVar3 = func_0x02953fd4(0x6e20,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x6e20,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (iVar3 != 0) {
    iVar3 = FUN_02f506e0(param_1,param_2);
    if (iVar3 != 0) {
      return;
    }
    iVar3 = FUN_02f50538(param_1,param_2);
    if (iVar3 != 0) {
