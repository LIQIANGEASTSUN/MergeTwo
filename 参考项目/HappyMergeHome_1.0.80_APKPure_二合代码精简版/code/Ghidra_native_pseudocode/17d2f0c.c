...

{
  ...
  pcVar1 = (char *)(_UNK_017e2fa4 + 0x17e2f20);
  if (*pcVar1 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017e2fa8 + 0x17e2f34));
    *pcVar1 = '\x01';
  }
  ...
  *puVar2 = uStack_38;
  ...
  func_0x035d3218(puVar2,&uStack_28,**(undefined4 **)(_UNK_017e2fac + 0x17e2f8c));
  return;
}
