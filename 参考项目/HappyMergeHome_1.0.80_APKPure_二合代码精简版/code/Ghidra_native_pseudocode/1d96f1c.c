...
void FUN_01da6f1c(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  pcVar1 = (char *)(_UNK_01da6f78 + 0x1da6f30);
  if (*pcVar1 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01da6f7c + 0x1da6f44));
    *pcVar1 = '\x01';
    param_3 = extraout_r2;
    param_4 = extraout_r3;
  }
  if (*(int *)(**(int **)(_UNK_01da6f80 + 0x1da6f58) + 0x74) == 0) {
    func_0x014387a4();
