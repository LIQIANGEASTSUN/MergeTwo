...

{
  ...
  pcVar7 = (char *)(_UNK_03204964 + 0x3204818);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03204968 + 0x320482c));
    func_0x01438628(*(undefined4 *)(_UNK_0320496c + 0x3204838));
    func_0x01438628(*(undefined4 *)(_UNK_03204970 + 0x3204844));
    *pcVar7 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x29b4,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x29b4,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03204974 + 0x320489c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_03204978 + 0x32048b8));
  uVar9 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar10 = **(int **)(_UNK_0320497c + 0x32048e4);
