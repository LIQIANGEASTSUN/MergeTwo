...
uint FUN_017137bc(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_017138dc + 0x17137d4);
  if (*pcVar10 == '\0') {
  ...
  if (iVar1 == 0) {
    ...
    pcVar10 = (char *)(_UNK_0171c268 + 0x171c034);
    uStack_1c = param_2;
    if (*pcVar10 == '\0') {
    ...
    if (iVar1 == 0) {
      iVar1 = func_0x01716374(param_1);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_0171c288 + 0x171c10c));
      if (iVar1 == 0) {
        uVar11 = func_0x01524ffc(&uStack_1c,0);
        uVar11 = func_0x024eee28(**(undefined4 **)(_UNK_0171c28c + 0x171c170),uVar11,
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_2,**(undefined4 **)(_UNK_0171c29c + 0x171c1c4));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar1,param_2,**(undefined4 **)(_UNK_0171c298 + 0x171c140));
        }
        func_0x024f10d4(iVar1,param_2,iVar9 + -1,**(undefined4 **)(_UNK_0171c2a0 + 0x171c1e8));
        iVar1 = func_0x01716374(param_1);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x024f05d4(iVar1,param_2,**(undefined4 **)(_UNK_0171c2a4 + 0x171c218));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x01716374(param_1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar9 = **(int **)(_UNK_0171c2a8 + 0x171c258);
