...
uint FUN_02fd18c4(int param_1,int param_2)

{
  ...
  pcVar12 = (char *)(_UNK_02fd198c + 0x2fd18dc);
  if (*pcVar12 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fd1990 + 0x2fd18f0));
    *pcVar12 = '\x01';
  }
  iVar6 = func_0x02953fd4(0x1564,0);
  if (iVar6 == 0) {
    if (*(int *)(**(int **)(_UNK_02fd1994 + 0x2fd194c) + 0x74) == 0) {
      func_0x014387a4();
    }
    ...
    iVar6 = func_0x029540a4(0x1564,0);
    if (iVar6 == 0) {
      func_0x014388e4();
    }
  }
