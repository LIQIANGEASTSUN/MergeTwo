...
undefined4 FUN_03146148(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_031461f8 + 0x3146160);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031461fc + 0x3146174));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(6000,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(6000,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x031470a0(param_1);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar4 = **(int **)(_UNK_03146200 + 0x31461ec);
