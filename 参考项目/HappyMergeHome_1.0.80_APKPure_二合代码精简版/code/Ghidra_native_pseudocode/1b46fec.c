...
uint FUN_01b56fec(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_01b5708c + 0x1b57000);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01b57090 + 0x1b57014));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0xa66f,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xa66f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01b57094 + 0x1b5706c) + 0x74) == 0) {
    func_0x014387a4();
  }
  ...
  if (iVar1 != 0) {
    ...
    func_0x01523a2c(&uStack_30,0x53,0);
    iVar5 = *(int *)(iVar1 + 8);
    uVar6 = *(undefined4 *)(iVar1 + 0xc);
    iVar1 = *(int *)(iVar1 + 0x10);
    if (iVar5 == 0) {
