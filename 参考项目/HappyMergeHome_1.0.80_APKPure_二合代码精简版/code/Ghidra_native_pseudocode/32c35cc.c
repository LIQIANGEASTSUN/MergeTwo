...
void FUN_032d35cc(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  pcVar2 = (char *)(_UNK_032d3710 + 0x32d35ec);
  if (*pcVar2 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032d3714 + 0x32d3604));
    *pcVar2 = '\x01';
  }
  ...
  uStack_38 = uStack_58;
  uStack_34 = uStack_54;
  iVar1 = func_0x02953fd4(0x8365,0);
  if (iVar1 == 0) {
    ...
    *puVar3 = uStack_70;
    ...
    uStack_44 = param_3;
    uStack_40 = param_4;
    func_0x035ca960(puVar3,&uStack_60,**(undefined4 **)(_UNK_032d3718 + 0x32d36f8));
  }
  else {
    iVar1 = func_0x029540a4(0x8365,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
