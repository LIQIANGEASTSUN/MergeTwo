...
/* WARNING: Possible PIC construction at 0x0164657c: Changing call to branch */
/* WARNING: Possible PIC construction at 0x016465a4: Changing call to branch */
/* WARNING: Possible PIC construction at 0x016465cc: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x016465a8) */
/* WARNING: Removing unreachable block (ram,0x016465bc) */
/* WARNING: Removing unreachable block (ram,0x016465c0) */
/* WARNING: Removing unreachable block (ram,0x01646580) */
/* WARNING: Removing unreachable block (ram,0x01646594) */
/* WARNING: Removing unreachable block (ram,0x01646598) */
/* WARNING: Removing unreachable block (ram,0x016465d0) */
/* WARNING: Removing unreachable block (ram,0x016465e4) */
/* WARNING: Removing unreachable block (ram,0x016465e8) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

uint FUN_016463fc(int param_1)

{
  ...
  pcVar10 = (char *)(_UNK_016465fc + 0x1646410);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01646600 + 0x1646424));
    func_0x01438628(*(undefined4 *)(_UNK_01646604 + 0x1646430));
    func_0x01438628(*(undefined4 *)(_UNK_01646608 + 0x164643c));
    func_0x01438628(*(undefined4 *)(_UNK_0164660c + 0x1646448));
    func_0x01438628(*(undefined4 *)(_UNK_01646610 + 0x1646454));
    func_0x01438628(*(undefined4 *)(_UNK_01646614 + 0x1646460));
    *pcVar10 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8621,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8621,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01646618 + 0x16464c4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0164661c + 0x16464e0));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  iVar1 = func_0x024f04cc(iVar1,**(undefined4 **)(_UNK_01646620 + 0x1646500));
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar1 + 0x3a4) != 0) {
    func_0x024f04d0(*(int *)(iVar1 + 0x3a4),**(undefined4 **)(_UNK_01646624 + 0x1646530));
  }
  if (*(int *)(**(int **)(_UNK_01646628 + 0x1646540) + 0x74) == 0) {
    func_0x014387a4();
  }
  puVar11 = *(undefined4 **)(_UNK_0164662c + 0x164655c);
  ...
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x55,0);
  ...
  if (iVar1 != 0) {
    ...
    puStack_30 = puVar2;
    puStack_2c = puVar11;
    func_0x024f56c0(&uStack_60,0,0x55,0);
    ...
    func_0x01523a2c(&puStack_48,0x55,0);
    iVar12 = *(int *)(iVar1 + 8);
    uVar13 = *(undefined4 *)(iVar1 + 0xc);
    iVar1 = *(int *)(iVar1 + 0x10);
    if (iVar12 == 0) {
  ...
  iVar12 = func_0x046ccb14(iVar1,0x55,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar12 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar3 = (*(code *)*puVar2)(piVar9,0x55,puVar2[1]);
      iVar1 = iStack_40;
    }
    iVar12 = *(int *)(iVar1 + 8);
    iVar1 = iVar12;
