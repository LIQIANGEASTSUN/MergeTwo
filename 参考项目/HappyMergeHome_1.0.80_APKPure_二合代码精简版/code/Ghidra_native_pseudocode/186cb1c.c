...
int FUN_0187cb1c(undefined4 param_1,int param_2)

{
  ...
  pcVar5 = (char *)(_UNK_0187cf34 + 0x187cb38);
  if (*pcVar5 == '\0') {
  ...
  iVar1 = func_0x02953fd4(0x1e12,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x1e12,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  puVar10 = *(undefined4 **)(_UNK_0187cf60 + 0x187cc58);
  iVar1 = func_0x024f0f34(iVar1,param_2,*puVar10);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_0187cf64 + 0x187cc78) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0187cf68 + 0x187cc94));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    iVar1 = *(int *)(iVar1 + 0x30);
    iVar8 = 0;
    puVar11 = *(undefined4 **)(_UNK_0187cf6c + 0x187ccbc);
    do {
      if (iVar1 == 0) {
        func_0x014388e4();
      }
    ...
    while( true ) {
      ...
      if (*(int *)(iVar2 + 0x1c) <= param_2) {
        ...
        if (iVar2 == 0) {
          ...
          func_0x024f05ac(iVar2,uVar9,**(undefined4 **)(_UNK_0187cf70 + 0x187ce34));
        }
      }
      iVar8 = iVar8 + 1;
    }
    ...
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0187cf78 + 0x187ce74));
    piVar7 = *(int **)(_UNK_0187cf7c + 0x187ce88);
    iVar8 = *piVar7;
    if (*(int *)(iVar8 + 0x74) == 0) {
      func_0x014387a4();
      iVar8 = *piVar7;
    }
    iVar6 = **(int **)(_UNK_0187cf80 + 0x187cea8);
