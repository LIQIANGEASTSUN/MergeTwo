...

{
  ...
  pcVar3 = (char *)(_UNK_02c4476c + 0x2c446cc);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c44770 + 0x2c446e0));
    func_0x01438628(*(undefined4 *)(_UNK_02c44774 + 0x2c446ec));
    *pcVar3 = '\x01';
  }
  iVar4 = *(int *)(param_1 + 8);
  ...
  iVar2 = *(int *)(iVar2 + 8) + -1;
  if (iVar4 == iVar2) {
    if (*(int *)(**(int **)(_UNK_02c44778 + 0x2c44724) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_02c4477c + 0x2c44740));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
