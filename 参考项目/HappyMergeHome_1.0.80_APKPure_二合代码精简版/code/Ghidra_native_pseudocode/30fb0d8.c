...
uint FUN_0310b0d8(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_0310b1c0 + 0x310b0f8);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0310b1c4 + 0x310b10c));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7880,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7880,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0310b1c8 + 0x310b188) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_03105aec();
  if (iVar1 == 0) {
  ...
  pcVar11 = (char *)(_UNK_0310b2ec + 0x310b1e4);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0310b2f0 + 0x310b1f8));
    func_0x01438628(*(undefined4 *)(_UNK_0310b2f4 + 0x310b204));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7881,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_0310b2f8 + 0x310b260) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_0310b2fc + 0x310b27c));
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    iVar3 = FUN_029a6fa8(iVar3,param_3,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uVar2 = *(uint *)(iVar3 + 0x30);
    iVar3 = func_0x0310c978(iVar1);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_03113c7c + 0x3113a48);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_03113c80 + 0x3113a5c));
      func_0x01438628(*(undefined4 *)(_UNK_03113c84 + 0x3113a68));
      func_0x01438628(*(undefined4 *)(_UNK_03113c88 + 0x3113a74));
      func_0x01438628(*(undefined4 *)(_UNK_03113c8c + 0x3113a80));
      func_0x01438628(*(undefined4 *)(_UNK_03113c90 + 0x3113a8c));
      func_0x01438628(*(undefined4 *)(_UNK_03113c94 + 0x3113a98));
      func_0x01438628(*(undefined4 *)(_UNK_03113c98 + 0x3113aa4));
      *pcVar11 = '\x01';
    }
    iVar3 = func_0x02953fd4(0x7869,0);
    if (iVar3 == 0) {
      iVar3 = func_0x0310dd84(iVar1);
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar3 = func_0x046c26fc(iVar3,param_3,**(undefined4 **)(_UNK_03113c9c + 0x3113b20));
      if (iVar3 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x04f6b198(**(undefined4 **)(_UNK_03113ca0 + 0x3113b84),uVar10,
                                 **(undefined4 **)(_UNK_03113ca4 + 0x3113b90),0);
        if (*(int *)(**(int **)(_UNK_03113ca8 + 0x3113ba4) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar3 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_3,**(undefined4 **)(_UNK_03113cb0 + 0x3113bd8));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar3,param_3,**(undefined4 **)(_UNK_03113cac + 0x3113b54));
        }
        func_0x03b70fe4(iVar3,param_3,iVar9 + -1,**(undefined4 **)(_UNK_03113cb4 + 0x3113bfc));
        iVar3 = func_0x0310dd84(iVar1);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        uVar2 = func_0x03b70fac(iVar3,param_3,**(undefined4 **)(_UNK_03113cb8 + 0x3113c2c));
        if ((int)uVar2 < 1) {
          iVar1 = func_0x0310dd84(iVar1);
          if (iVar1 == 0) {
            func_0x014388e4();
          }
          iVar3 = **(int **)(_UNK_03113cbc + 0x3113c6c);
...
LAB_046c3e4c:
    ...
    iVar3 = func_0x029540a4(0x7869,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar3 = func_0x029540a4(0x7881,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
