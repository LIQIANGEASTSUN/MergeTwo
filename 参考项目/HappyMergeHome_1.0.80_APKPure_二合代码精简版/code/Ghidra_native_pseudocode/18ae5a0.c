...
int FUN_018be5a0(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_018be71c + 0x18be5b4);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018be720 + 0x18be5c8));
    func_0x01438628(*(undefined4 *)(_UNK_018be724 + 0x18be5d4));
    func_0x01438628(*(undefined4 *)(_UNK_018be728 + 0x18be5e0));
    func_0x01438628(*(undefined4 *)(_UNK_018be72c + 0x18be5ec));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x94e7,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x94e7,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_018be730 + 0x18be644) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018be734 + 0x18be660));
  piVar7 = *(int **)(_UNK_018be738 + 0x18be674);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_018be73c + 0x18be694);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0x87c);
  if (iVar2 == 0) {
