...
int FUN_01967dfc(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_01967f30 + 0x1967e10);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01967f34 + 0x1967e24));
    func_0x01438628(*(undefined4 *)(_UNK_01967f38 + 0x1967e30));
    *pcVar4 = '\x01';
  }
  iVar7 = 0;
  iVar1 = func_0x02953fd4(0x98f3,0);
  if (iVar1 != 0) {
    iVar7 = func_0x029540a4(0x98f3,0);
    if (iVar7 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = 1;
  puVar8 = *(undefined4 **)(_UNK_01967f3c + 0x1967e90);
  while( true ) {
