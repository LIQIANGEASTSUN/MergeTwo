...
void FUN_0195b0cc(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar8 = (char *)(_UNK_0195b190 + 0x195b0e4);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0195b194 + 0x195b0f8));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x98cb,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x98cb,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x0196d344(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_0195b198 + 0x195b168) + 0x74) == 0) {
    func_0x014387a4();
  }
