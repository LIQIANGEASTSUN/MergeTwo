...
/* WARNING: Possible PIC construction at 0x0304c3e0: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x0304c3e4) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0304cb54(int param_1)

{
  ...
  iVar2 = func_0x02953fd4(0x73e7,0);
  if (iVar2 == 0) {
    ...
    iVar2 = FUN_0304be6c(param_1);
    if (iVar2 <= iVar3) {
      return;
    }
    pcVar5 = (char *)(_UNK_0304c660 + 0x304c304);
    if (*pcVar5 == '\0') {
    ...
    uStack_30 = 0;
    iVar2 = func_0x02953fd4(0x73ea,0);
    if (iVar2 == 0) {
      if (*(int *)(**(int **)(_UNK_0304c690 + 0x304c3f4) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0304c694 + 0x304c410));
      if (iVar2 == 0) {
        func_0x014388e4();
      }
      iVar2 = func_0x036c7bec(iVar2,**(undefined4 **)(_UNK_0304c698 + 0x304c430));
      if (iVar2 == 0) {
        func_0x014388e4();
      }
      iVar3 = *(int *)(iVar2 + 8);
      ...
      uVar7 = FUN_0304be04(param_1,*(undefined4 *)(iVar2 + 0x74));
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar2 = func_0x03b72148(iVar3,uVar7,**(undefined4 **)(_UNK_0304c69c + 0x304c490));
      if (iVar2 != 0) {
        iVar3 = *(int *)(iVar2 + 0x10);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        func_0x04cfe6f4(&uStack_40,iVar3,**(undefined4 **)(_UNK_0304c6a0 + 0x304c4c8));
        uStack_30 = uStack_40;
        uStack_2c = uStack_3c;
        uStack_28 = uStack_38;
        iStack_24 = iStack_34;
        puVar6 = *(undefined4 **)(_UNK_0304c6a4 + 0x304c4e4);
        puVar8 = *(undefined4 **)(_UNK_0304c6a8 + 0x304c4ec);
        ...
        func_0x03b776fc(iVar2,**(undefined4 **)(_UNK_0304c6b4 + 0x304c594));
        if (*(int *)(**(int **)(_UNK_0304c6b8 + 0x304c5a8) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar2 = FUN_03041d88();
        if (iVar2 != 0) {
          func_0x0306c28c(iVar2,0);
        }
      }
      return;
    }
    iVar2 = func_0x029540a4(0x73ea,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    unaff_lr = 0x304c3e4;
    ...
    iVar2 = func_0x029540a4(0x73e7,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
