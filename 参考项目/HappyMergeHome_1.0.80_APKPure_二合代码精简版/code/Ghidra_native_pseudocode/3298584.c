...

{
  ...
  pcVar4 = (char *)(_UNK_032a8630 + 0x32a8594);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032a8634 + 0x32a85a8));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8279,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8279,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_032a8638 + 0x32a85fc) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_032a3fc4();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
