...
void FUN_0303ed58(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_0303ee1c + 0x303ed70);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0303ee20 + 0x303ed84));
    *pcVar10 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x73b3,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x73b3,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x03050e70(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_0303ee24 + 0x303edf4) + 0x74) == 0) {
    func_0x014387a4();
  }
