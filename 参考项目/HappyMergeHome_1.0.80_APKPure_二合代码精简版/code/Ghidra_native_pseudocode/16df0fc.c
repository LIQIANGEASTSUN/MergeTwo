...
void FUN_016ef0fc(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  pcVar1 = (char *)(_UNK_016ef158 + 0x16ef110);
  if (*pcVar1 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016ef15c + 0x16ef124));
    *pcVar1 = '\x01';
    param_3 = extraout_r2;
    param_4 = extraout_r3;
  }
  if (*(int *)(**(int **)(_UNK_016ef160 + 0x16ef138) + 0x74) == 0) {
    func_0x014387a4();
