...
/* WARNING: Possible PIC construction at 0x01642f04: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x01642f08) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_01642eb0(undefined4 param_1)

{
  ...
  iVar1 = func_0x02953fd4(0x1676,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x1676,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_30 = 0;
