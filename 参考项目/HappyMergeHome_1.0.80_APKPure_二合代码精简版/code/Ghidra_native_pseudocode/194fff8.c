...

{
  ...
  pcVar3 = (char *)(_UNK_019600a4 + 0x1960008);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_019600a8 + 0x196001c));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x991a,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x991a,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_019600ac + 0x1960070) + 0x74) == 0) {
    func_0x014387a4();
  }
