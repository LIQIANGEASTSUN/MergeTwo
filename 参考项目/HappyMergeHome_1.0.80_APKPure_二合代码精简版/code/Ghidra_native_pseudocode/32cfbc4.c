...
int FUN_032dfbc4(undefined4 param_1)

{
  ...
  pcVar9 = (char *)(_UNK_032dfce4 + 0x32dfbd8);
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032dfce8 + 0x32dfbec));
    func_0x01438628(*(undefined4 *)(_UNK_032dfcec + 0x32dfbf8));
    func_0x01438628(*(undefined4 *)(_UNK_032dfcf0 + 0x32dfc04));
    func_0x01438628(*(undefined4 *)(_UNK_032dfcf4 + 0x32dfc10));
    *pcVar9 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x1ef4,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x1ef4,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_032dfcf8 + 0x32dfc68) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_032dfcfc + 0x32dfc84));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  ...
  iVar3 = func_0x04cfd760(iVar3,*(int *)(iVar3 + 0xc) + -1,
                          **(undefined4 **)(_UNK_032dfd00 + 0x32dfcb4));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = *(int *)(iVar3 + 0x24);
  pcVar9 = (char *)(_UNK_032de848 + 0x32de44c);
  iStack_24 = unaff_r4;
  if (*pcVar9 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032de84c + 0x32de460));
    func_0x01438628(*(undefined4 *)(_UNK_032de850 + 0x32de46c));
    func_0x01438628(*(undefined4 *)(_UNK_032de854 + 0x32de478));
    func_0x01438628(*(undefined4 *)(_UNK_032de858 + 0x32de484));
    func_0x01438628(*(undefined4 *)(_UNK_032de85c + 0x32de490));
    func_0x01438628(*(undefined4 *)(_UNK_032de860 + 0x32de49c));
    func_0x01438628(*(undefined4 *)(_UNK_032de864 + 0x32de4a8));
    func_0x01438628(*(undefined4 *)(_UNK_032de868 + 0x32de4b4));
    func_0x01438628(*(undefined4 *)(_UNK_032de86c + 0x32de4c0));
    func_0x01438628(*(undefined4 *)(_UNK_032de870 + 0x32de4cc));
    *pcVar9 = '\x01';
  }
  iVar6 = func_0x02953fd4(0x1ef5,0);
  if (iVar6 == 0) {
    iVar6 = FUN_032d4694(param_1);
    if (iVar6 == 0) {
      func_0x014388e4();
    }
    ...
    puVar11 = *(undefined4 **)(_UNK_032de874 + 0x32de56c);
    iVar6 = func_0x04cd2d7c(iVar6,iVar3,*puVar11);
    if (iVar6 == 0) {
      if (*(int *)(**(int **)(_UNK_032de878 + 0x32de58c) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar6 = func_0x04e4a028(**(undefined4 **)(_UNK_032de87c + 0x32de5a8));
      if (iVar6 == 0) {
        func_0x014388e4();
      }
      iVar6 = *(int *)(iVar6 + 0x38);
      iVar7 = 0;
      puVar12 = *(undefined4 **)(_UNK_032de880 + 0x32de5d0);
      while( true ) {
        if (iVar6 == 0) {
          func_0x014388e4();
        }
          ...
          while( true ) {
            ...
            if (*(int *)(iVar2 + 0x24) <= iVar3) {
              ...
              if (iVar2 == 0) {
                ...
                func_0x03b75ba0(iVar2,uVar10,**(undefined4 **)(_UNK_032de884 + 0x32de748));
              }
            }
            iVar7 = iVar7 + 1;
          }
          func_0x032dfe88(param_1);
          if (*(int *)(**(int **)(_UNK_032de888 + 0x32de76c) + 0x74) == 0) {
            func_0x014387a4();
          }
          iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_032de88c + 0x32de788));
          piVar8 = *(int **)(_UNK_032de890 + 0x32de79c);
          iVar6 = *piVar8;
          if (*(int *)(iVar6 + 0x74) == 0) {
            func_0x014387a4();
            iVar6 = *piVar8;
          }
          iVar2 = **(int **)(_UNK_032de894 + 0x32de7bc);
  ...
  iVar6 = func_0x029540a4(0x1ef5,0);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
  puStack_20 = (undefined4 *)iStack_24;
