...
void FUN_02fcfa80(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  pcVar3 = (char *)(_UNK_02fcfae4 + 0x2fcfa94);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fcfae8 + 0x2fcfaa8));
    *pcVar3 = '\x01';
    param_4 = extraout_r3;
  }
  piVar1 = *(int **)(_UNK_02fcfaec + 0x2fcfac0);
