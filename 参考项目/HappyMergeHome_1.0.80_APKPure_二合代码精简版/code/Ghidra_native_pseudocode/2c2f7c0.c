...

{
  ...
  pcVar5 = (char *)(_UNK_02c3f84c + 0x2c3f7d0);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c3f850 + 0x2c3f7e4));
    func_0x01438628(*(undefined4 *)(_UNK_02c3f854 + 0x2c3f7f0));
    *pcVar5 = '\x01';
  }
  if (*(int *)(**(int **)(_UNK_02c3f858 + 0x2c3f804) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x014e9518(**(undefined4 **)(_UNK_02c3f85c + 0x2c3f820));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
