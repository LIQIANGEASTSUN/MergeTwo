...
undefined4 FUN_02fa1a24(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_02fa1b00 + 0x2fa1a38);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fa1b04 + 0x2fa1a4c));
    func_0x01438628(*(undefined4 *)(_UNK_02fa1b08 + 0x2fa1a58));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x6f9a,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_02fa1b0c + 0x2fa1ab0) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02fa1b10 + 0x2fa1acc));
    uVar7 = func_0x02fa1b14(param_1);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = func_0x029540a4(0x6f9a,0);
  if (iVar3 == 0) {
    func_0x014388e4();
  }
