...
int * FUN_0314540c(undefined4 param_1)

{
  ...
  pcVar17 = (char *)(_UNK_031454ec + 0x3145420);
  if (*pcVar17 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031454f0 + 0x3145434));
    func_0x01438628(*(undefined4 *)(_UNK_031454f4 + 0x3145440));
    func_0x01438628(*(undefined4 *)(_UNK_031454f8 + 0x314544c));
    *pcVar17 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x7a0f,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x7a0f,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
    pcVar17 = (char *)(_UNK_0291b3b8 + 0x291b2d8);
    if (*pcVar17 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_0291b3bc + 0x291b2ec),param_1,0);
      *pcVar17 = '\x01';
    }
    ...
    piVar3 = (int *)func_0x035daef8(&uStack_30,0,**(undefined4 **)(_UNK_0291b3c0 + 0x291b3a8));
    return piVar3;
  }
  if (*(int *)(**(int **)(_UNK_031454fc + 0x31454a4) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x04e4a028(**(undefined4 **)(_UNK_03145500 + 0x31454c0));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  iVar16 = **(int **)(_UNK_03145504 + 0x31454e0);
  puVar21 = auStack_20;
