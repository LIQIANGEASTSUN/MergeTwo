...
void FUN_017d2348(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar8 = (char *)(_UNK_017d240c + 0x17d2360);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017d2410 + 0x17d2374));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8f81,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8f81,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x017df75c(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_017d2414 + 0x17d23e4) + 0x74) == 0) {
    func_0x014387a4();
  }
