...
uint FUN_01873228(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_01873310 + 0x1873248);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01873314 + 0x187325c));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x93b3,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x93b3,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_01873318 + 0x18732d8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_0186d4b8();
  if (iVar2 == 0) {
  ...
  pcVar11 = (char *)(_UNK_01872b54 + 0x1872a4c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01872b58 + 0x1872a60));
    func_0x01438628(*(undefined4 *)(_UNK_01872b5c + 0x1872a6c));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x93af,0);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_01872b60 + 0x1872ac8) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01872b64 + 0x1872ae4));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    ...
    pcVar11 = (char *)(_UNK_0187b3e8 + 0x187b1b4);
    uStack_1c = param_3;
    if (*pcVar11 == '\0') {
      func_0x01438628(*(undefined4 *)(_UNK_0187b3ec + 0x187b1c8));
      func_0x01438628(*(undefined4 *)(_UNK_0187b3f0 + 0x187b1d4));
      func_0x01438628(*(undefined4 *)(_UNK_0187b3f4 + 0x187b1e0));
      func_0x01438628(*(undefined4 *)(_UNK_0187b3f8 + 0x187b1ec));
      func_0x01438628(*(undefined4 *)(_UNK_0187b3fc + 0x187b1f8));
      func_0x01438628(*(undefined4 *)(_UNK_0187b400 + 0x187b204));
      func_0x01438628(*(undefined4 *)(_UNK_0187b404 + 0x187b210));
      *pcVar11 = '\x01';
    }
    iVar1 = func_0x02953fd4(0x9392,0);
    if (iVar1 == 0) {
      iVar1 = func_0x01875484(iVar2);
      if (iVar1 == 0) {
        func_0x014388e4();
      }
      iVar1 = func_0x024f0540(iVar1,param_3,**(undefined4 **)(_UNK_0187b408 + 0x187b28c));
      if (iVar1 == 0) {
        uVar10 = func_0x01524ffc(&uStack_1c,0);
        uVar10 = func_0x024eee28(**(undefined4 **)(_UNK_0187b40c + 0x187b2f0),uVar10,
                                 **(undefined4 **)(_UNK_0187b410 + 0x187b2fc),0);
        if (*(int *)(**(int **)(_UNK_0187b414 + 0x187b310) + 0x74) == 0) {
          func_0x014387a4();
        }
        ...
        if (iVar1 == 0) {
          func_0x014388e4();
          iVar9 = func_0x024f05d4(0,param_3,**(undefined4 **)(_UNK_0187b41c + 0x187b344));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x024f05d4(iVar1,param_3,**(undefined4 **)(_UNK_0187b418 + 0x187b2c0));
        }
        func_0x024f10d4(iVar1,param_3,iVar9 + -1,**(undefined4 **)(_UNK_0187b420 + 0x187b368));
        iVar1 = func_0x01875484(iVar2);
        if (iVar1 == 0) {
          func_0x014388e4();
        }
        uVar3 = func_0x024f05d4(iVar1,param_3,**(undefined4 **)(_UNK_0187b424 + 0x187b398));
        if ((int)uVar3 < 1) {
          iVar2 = func_0x01875484(iVar2);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar1 = **(int **)(_UNK_0187b428 + 0x187b3d8);
...
LAB_046c3e4c:
    ...
    iVar1 = func_0x029540a4(0x9392,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar1 = func_0x029540a4(0x93af,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  }
