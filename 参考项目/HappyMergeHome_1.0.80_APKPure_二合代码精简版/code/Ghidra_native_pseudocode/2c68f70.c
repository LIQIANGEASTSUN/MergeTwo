...

{
  ...
  pcVar5 = (char *)(_UNK_02c79024 + 0x2c78f84);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c79028 + 0x2c78f98));
    *pcVar5 = '\x01';
  }
  iVar6 = **(int **)(**(int **)(_UNK_02c7902c + 0x2c78fac) + 0x5c);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
  ...
  iVar6 = FUN_02beba7c(iVar6,uVar3,0);
  if (iVar6 == 0) {
    func_0x014388e4();
  }
  iVar6 = *(int *)(iVar6 + 0xc);
  ...
  pcVar5 = (char *)(_UNK_02c1b1a8 + 0x2c1afb4);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c1b1ac + 0x2c1afc8),1,0);
  ...
  if (iVar1 != 0) {
    ...
    func_0x024f56d0(iVar4,uVar3,&uStack_38,uVar2,0,0);
    return;
  }
  iVar1 = func_0x024eecb8(iVar6,0);
  pcVar5 = (char *)(_UNK_02c1b1b4 + 0x2c1b044);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c1b1b8 + 0x2c1b058));
    *pcVar5 = '\x01';
  }
  iVar4 = *(int *)(**(int **)(_UNK_02c1b1bc + 0x2c1b070) + 0x5c);
  ...
  uStack_28 = 0;
  func_0x024ef328(iVar1,uVar2,uVar3,uVar7);
  FUN_02c1b1d0(iVar6);
  iVar1 = FUN_02c195e4(iVar6);
  if (iVar1 != -1) {
  ...
  uVar3 = FUN_02c19900(iVar6);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  FUN_02bd2354(iVar1,uVar2,uVar3,0);
  FUN_02c1b844(iVar6);
  FUN_02c1c0e4(iVar6);
  FUN_02c1c20c(iVar6);
  ...
  if (iVar1 == 0) {
    func_0x024f1038(iVar6,**(undefined4 **)(_UNK_02c1c70c + 0x2c1c3b8),0);
    func_0x024f1038(iVar6,**(undefined4 **)(_UNK_02c1c710 + 0x2c1c3d0),0);
    func_0x024f1038(iVar6,**(undefined4 **)(_UNK_02c1c714 + 0x2c1c3e8),0);
    FUN_02c24960(iVar6);
  ...
  func_0x01523a6c(&uStack_30,iVar6,0);
  iVar4 = *(int *)(iVar1 + 8);
  uVar3 = *(undefined4 *)(iVar1 + 0xc);
  iVar6 = *(int *)(iVar1 + 0x10);
  if (iVar4 == 0) {
  ...
  uStack_50 = 0;
  uStack_4c = 0;
  func_0x024f56d0(iVar4,uVar3,&uStack_30,uVar2);
  return;
}
