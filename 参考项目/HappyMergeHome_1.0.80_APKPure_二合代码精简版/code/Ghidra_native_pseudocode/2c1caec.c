...
undefined4 FUN_02c2caec(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2ccac + 0x2c2cb00);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2ccb0 + 0x2c2cb14));
    func_0x01438628(*(undefined4 *)(_UNK_02c2ccb4 + 0x2c2cb20));
    func_0x01438628(*(undefined4 *)(_UNK_02c2ccb8 + 0x2c2cb2c));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5da9,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5da9,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2ccbc + 0x2c2cc54));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2ccc0 + 0x2c2cc70),0);
  if (*(int *)(**(int **)(_UNK_02c2ccc4 + 0x2c2cc84) + 0x74) == 0) {
    func_0x014387a4();
  }
