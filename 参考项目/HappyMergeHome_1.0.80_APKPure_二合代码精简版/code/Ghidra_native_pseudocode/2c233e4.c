...
undefined4 FUN_02c333e4(int param_1,undefined4 param_2)

{
  ...
  pcVar6 = (char *)(_UNK_02c33568 + 0x2c333fc);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c3356c + 0x2c33410));
    func_0x01438628(*(undefined4 *)(_UNK_02c33570 + 0x2c3341c));
    func_0x01438628(*(undefined4 *)(_UNK_02c33574 + 0x2c33428));
    func_0x01438628(*(undefined4 *)(_UNK_02c33578 + 0x2c33434));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5e0a,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5e0a,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x014388d4(**(undefined4 **)(_UNK_02c3357c + 0x2c33490));
  func_0x02c47ddc(iVar1,0);
  if (iVar1 == 0) {
    func_0x014388e4();
  }
  *(int *)(iVar1 + 8) = param_1;
  ...
  *(undefined4 *)(iVar1 + 0xc) = param_2;
  ...
  uVar5 = func_0x014388d4(**(undefined4 **)(_UNK_02c33580 + 0x2c33514));
  func_0x0152e3ec(uVar5,iVar1,**(undefined4 **)(_UNK_02c33584 + 0x2c33530),0);
  if (*(int *)(**(int **)(_UNK_02c33588 + 0x2c33544) + 0x74) == 0) {
    func_0x014387a4();
  }
