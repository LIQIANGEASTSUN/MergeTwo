...
void FUN_031b3208(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_031b32c0 + 0x31b321c);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031b32c4 + 0x31b3230));
    *pcVar8 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x7cc5,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x7cc5,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x031c48e0(param_1);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_031b32c8 + 0x31b3298) + 0x74) == 0) {
    func_0x014387a4();
  }
