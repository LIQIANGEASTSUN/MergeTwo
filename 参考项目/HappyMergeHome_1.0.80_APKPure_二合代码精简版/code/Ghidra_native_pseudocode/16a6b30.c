...

{
  ...
  pcVar3 = (char *)(_UNK_016b6bdc + 0x16b6b40);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016b6be0 + 0x16b6b54));
    *pcVar3 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8919,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8919,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_016b6be4 + 0x16b6ba8) + 0x74) == 0) {
    func_0x014387a4();
  }
