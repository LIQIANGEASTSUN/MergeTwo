...
void FUN_030cf494(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_030cf54c + 0x30cf4a8);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030cf550 + 0x30cf4bc));
    *pcVar8 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x76d9,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x76d9,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x030e2b64(param_1);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_030cf554 + 0x30cf524) + 0x74) == 0) {
    func_0x014387a4();
  }
