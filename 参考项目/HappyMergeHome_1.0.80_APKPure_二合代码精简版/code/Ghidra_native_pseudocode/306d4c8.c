...
uint FUN_0307d4c8(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar2 = func_0x02953fd4(0x7585,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_0307d5f4 + 0x307d55c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0307d5f8 + 0x307d578));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    iVar2 = func_0x02953fd4(0x7565,0);
    if (iVar2 == 0) {
      iVar2 = func_0x03080f7c(param_1);
      if (iVar2 == 0) {
        func_0x014388e4();
      }
      iVar2 = func_0x046c26fc(iVar2,param_2,**(undefined4 **)(_UNK_03086fa4 + 0x3086e28));
      if (iVar2 == 0) {
        ...
        if (iVar2 == 0) {
          func_0x014388e4();
          iVar9 = func_0x03b70fac(0,param_2,**(undefined4 **)(_UNK_03086fb8 + 0x3086ee0));
          func_0x014388e4();
        }
        else {
          iVar9 = func_0x03b70fac(iVar2,param_2,**(undefined4 **)(_UNK_03086fb4 + 0x3086e5c));
        }
        func_0x03b70fe4(iVar2,param_2,iVar9 + -1,**(undefined4 **)(_UNK_03086fbc + 0x3086f04));
        iVar2 = func_0x03080f7c(param_1);
        if (iVar2 == 0) {
          func_0x014388e4();
        }
        uVar1 = func_0x03b70fac(iVar2,param_2,**(undefined4 **)(_UNK_03086fc0 + 0x3086f34));
        if ((int)uVar1 < 1) {
          iVar2 = func_0x03080f7c(param_1);
          if (iVar2 == 0) {
            func_0x014388e4();
          }
          iVar9 = **(int **)(_UNK_03086fc4 + 0x3086f74);
...
LAB_046c3e4c:
    ...
    iVar2 = func_0x029540a4(0x7565,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
  else {
    iVar2 = func_0x029540a4(0x7585,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
