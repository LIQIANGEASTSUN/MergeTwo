...
int FUN_0192a8c0(int *param_1,int param_2,int param_3)

{
  ...
  pcVar10 = (char *)(_UNK_0192aa94 + 0x192a8e0);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0192aa98 + 0x192a8f4));
    func_0x01438628(*(undefined4 *)(_UNK_0192aa9c + 0x192a900));
    func_0x01438628(*(undefined4 *)(_UNK_0192aaa0 + 0x192a90c));
    *pcVar10 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9785,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9785,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0192aaa4 + 0x192a974) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0192aaa8 + 0x192a990));
  uVar2 = (**(code **)(*param_1 + 0x1a0))(param_1,*(undefined4 *)(*param_1 + 0x1a4));
  piVar3 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_0192aaac + 0x192a9c0),2);
  if (piVar3 == (int *)0x0) {
    func_0x014388e4();
  }
  if ((param_2 != 0) &&
