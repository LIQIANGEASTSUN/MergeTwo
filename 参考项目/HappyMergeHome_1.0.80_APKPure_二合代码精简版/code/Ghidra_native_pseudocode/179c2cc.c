...
int FUN_017ac2cc(undefined4 param_1,int param_2)

{
  ...
  pcVar5 = (char *)(_UNK_017ac6e4 + 0x17ac2e8);
  if (*pcVar5 == '\0') {
  ...
  iVar1 = func_0x02953fd4(0x1e98,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x1e98,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  puVar10 = *(undefined4 **)(_UNK_017ac710 + 0x17ac408);
  iVar1 = func_0x024f0f34(iVar1,param_2,*puVar10);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_017ac714 + 0x17ac428) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_017ac718 + 0x17ac444));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    iVar1 = *(int *)(iVar1 + 0x30);
    iVar8 = 0;
    puVar11 = *(undefined4 **)(_UNK_017ac71c + 0x17ac46c);
    do {
      if (iVar1 == 0) {
        func_0x014388e4();
      }
    ...
    while( true ) {
      ...
      if (*(int *)(iVar2 + 0x1c) <= param_2) {
        ...
        if (iVar2 == 0) {
          ...
          func_0x024f05ac(iVar2,uVar9,**(undefined4 **)(_UNK_017ac720 + 0x17ac5e4));
        }
      }
      iVar8 = iVar8 + 1;
    }
    ...
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_017ac728 + 0x17ac624));
    piVar7 = *(int **)(_UNK_017ac72c + 0x17ac638);
    iVar8 = *piVar7;
    if (*(int *)(iVar8 + 0x74) == 0) {
      func_0x014387a4();
      iVar8 = *piVar7;
    }
    iVar6 = **(int **)(_UNK_017ac730 + 0x17ac658);
