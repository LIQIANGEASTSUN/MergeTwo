...

{
  ...
  pcVar11 = (char *)(_UNK_0310ffe4 + 0x310fe70);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0310ffe8 + 0x310fe84));
    func_0x01438628(*(undefined4 *)(_UNK_0310ffec + 0x310fe90));
    func_0x01438628(*(undefined4 *)(_UNK_0310fff0 + 0x310fe9c));
    func_0x01438628(*(undefined4 *)(_UNK_0310fff4 + 0x310fea8));
    func_0x01438628(*(undefined4 *)(_UNK_0310fff8 + 0x310feb4));
    func_0x01438628(*(undefined4 *)(_UNK_0310fffc + 0x310fec0));
    *pcVar11 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7898,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x7898,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03110000 + 0x310ff24) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03110004 + 0x310ff40));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  iVar3 = func_0x036c7bec(iVar3,**(undefined4 **)(_UNK_03110008 + 0x310ff60));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  if (*(int *)(iVar3 + 0x360) != 0) {
    func_0x03b73ab8(*(int *)(iVar3 + 0x360),**(undefined4 **)(_UNK_0311000c + 0x310ff90));
  }
  if (*(int *)(**(int **)(_UNK_03110010 + 0x310ffa0) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03110014 + 0x310ffbc));
  if (iVar3 == 0) {
    func_0x014388e4();
  }
  pcVar11 = (char *)(_UNK_02be82b0 + 0x2be8170);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02be82b4 + 0x2be8184),0x36,0);
  ...
  if (iVar9 != 0) {
    ...
    uStack_38 = 0;
    uStack_28 = 0;
    func_0x024f56c0(&uStack_50,0,0x36,0);
    uStack_38 = uStack_50;
    iStack_34 = uStack_4c;
    uStack_30 = uStack_48;
    uStack_2c = iStack_44;
    ...
    func_0x01523a2c(&uStack_38,0x36,0);
    iVar10 = *(int *)(iVar9 + 8);
  ...
  iVar3 = func_0x046ccb14(uVar2,0x36,**(undefined4 **)(_UNK_02be82d4 + 0x2be8280));
  if (iVar3 == 0) {
    return 0;
  }
...
LAB_046ce140:
      uVar1 = (*(code *)*puVar4)(piVar8,0x36,puVar4[1]);
      uVar2 = uStack_30;
    }
    iVar9 = *(int *)(uVar2 + 8);
    iVar3 = iVar9;
