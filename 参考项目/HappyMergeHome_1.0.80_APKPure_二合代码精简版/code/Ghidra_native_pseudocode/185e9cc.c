...
int FUN_0186e9cc(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_0186eb48 + 0x186e9e0);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0186eb4c + 0x186e9f4));
    func_0x01438628(*(undefined4 *)(_UNK_0186eb50 + 0x186ea00));
    func_0x01438628(*(undefined4 *)(_UNK_0186eb54 + 0x186ea0c));
    func_0x01438628(*(undefined4 *)(_UNK_0186eb58 + 0x186ea18));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9371,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9371,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0186eb5c + 0x186ea70) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_0186eb60 + 0x186ea8c));
  piVar7 = *(int **)(_UNK_0186eb64 + 0x186eaa0);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_0186eb68 + 0x186eac0);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0x76c);
  if (iVar2 == 0) {
