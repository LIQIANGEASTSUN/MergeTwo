...
uint FUN_032d371c(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_032d3804 + 0x32d373c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032d3808 + 0x32d3750));
    *pcVar11 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x83a7,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x83a7,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_032d380c + 0x32d37cc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_032d2dac();
  if (iVar1 == 0) {
