...
int FUN_032dc874(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_032dc9a8 + 0x32dc888);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032dc9ac + 0x32dc89c));
    func_0x01438628(*(undefined4 *)(_UNK_032dc9b0 + 0x32dc8a8));
    *pcVar4 = '\x01';
  }
  iVar7 = 0;
  iVar1 = func_0x02953fd4(0x838a,0);
  if (iVar1 != 0) {
    iVar7 = func_0x029540a4(0x838a,0);
    if (iVar7 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = 1;
  puVar8 = *(undefined4 **)(_UNK_032dc9b4 + 0x32dc908);
  while( true ) {
