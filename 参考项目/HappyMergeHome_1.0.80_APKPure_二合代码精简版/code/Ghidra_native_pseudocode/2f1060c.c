...
void FUN_02f2060c(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_02f206d0 + 0x2f20624);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f206d4 + 0x2f20638));
    *pcVar10 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x6cf0,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x6cf0,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x02f2c4a0(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_02f206d8 + 0x2f206a8) + 0x74) == 0) {
    func_0x014387a4();
  }
