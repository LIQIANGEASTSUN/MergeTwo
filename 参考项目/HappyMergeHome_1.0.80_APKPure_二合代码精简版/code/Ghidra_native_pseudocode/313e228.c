...
/* WARNING: Possible PIC construction at 0x0314dab4: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x0314dab8) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_0314e228(int param_1)

{
  ...
  iVar2 = func_0x02953fd4(0x79ec,0);
  if (iVar2 == 0) {
    ...
    iVar2 = FUN_0314d540(param_1);
    if (iVar2 <= iVar3) {
      return;
    }
    pcVar5 = (char *)(_UNK_0314dd34 + 0x314d9d8);
    if (*pcVar5 == '\0') {
    ...
    uStack_30 = 0;
    iVar2 = func_0x02953fd4(0x79ef,0);
    if (iVar2 == 0) {
      if (*(int *)(**(int **)(_UNK_0314dd64 + 0x314dac8) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_0314dd68 + 0x314dae4));
      if (iVar2 == 0) {
        func_0x014388e4();
      }
      iVar2 = func_0x036c7bec(iVar2,**(undefined4 **)(_UNK_0314dd6c + 0x314db04));
      if (iVar2 == 0) {
        func_0x014388e4();
      }
      iVar3 = *(int *)(iVar2 + 8);
      ...
      uVar7 = FUN_0314d4d8(param_1,*(undefined4 *)(iVar2 + 0x74));
      if (iVar3 == 0) {
        func_0x014388e4();
      }
      iVar2 = func_0x03b72148(iVar3,uVar7,**(undefined4 **)(_UNK_0314dd70 + 0x314db64));
      if (iVar2 != 0) {
        iVar3 = *(int *)(iVar2 + 0x10);
        if (iVar3 == 0) {
          func_0x014388e4();
        }
        func_0x04cfe6f4(&uStack_40,iVar3,**(undefined4 **)(_UNK_0314dd74 + 0x314db9c));
        uStack_30 = uStack_40;
        uStack_2c = uStack_3c;
        uStack_28 = uStack_38;
        iStack_24 = iStack_34;
        puVar6 = *(undefined4 **)(_UNK_0314dd78 + 0x314dbb8);
        puVar8 = *(undefined4 **)(_UNK_0314dd7c + 0x314dbc0);
        ...
        func_0x03b776fc(iVar2,**(undefined4 **)(_UNK_0314dd88 + 0x314dc68));
        if (*(int *)(**(int **)(_UNK_0314dd8c + 0x314dc7c) + 0x74) == 0) {
          func_0x014387a4();
        }
        iVar2 = FUN_03143658();
        if (iVar2 != 0) {
          func_0x0316c854(iVar2,0);
        }
      }
      return;
    }
    iVar2 = func_0x029540a4(0x79ef,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    unaff_lr = 0x314dab8;
    ...
    iVar2 = func_0x029540a4(0x79ec,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  }
