...
int FUN_0314d540(undefined4 param_1)

{
  ...
  pcVar4 = (char *)(_UNK_0314d674 + 0x314d554);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0314d678 + 0x314d568));
    func_0x01438628(*(undefined4 *)(_UNK_0314d67c + 0x314d574));
    *pcVar4 = '\x01';
  }
  iVar7 = 0;
  iVar1 = func_0x02953fd4(0x79ed,0);
  if (iVar1 != 0) {
    iVar7 = func_0x029540a4(0x79ed,0);
    if (iVar7 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = 1;
  puVar8 = *(undefined4 **)(_UNK_0314d680 + 0x314d5d4);
  while( true ) {
