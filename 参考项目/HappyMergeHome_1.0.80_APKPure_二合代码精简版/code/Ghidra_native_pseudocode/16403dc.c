...
undefined4 FUN_016503dc(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar5 = (char *)(_UNK_01650518 + 0x16503f4);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0165051c + 0x1650408));
    func_0x01438628(*(undefined4 *)(_UNK_01650520 + 0x1650414));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8646,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8646,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_01650524 + 0x16504ac));
  if (iVar1 != 0) {
    iVar1 = FUN_01642704(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_01650528 + 0x1650504);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
