...
int FUN_01748b9c(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_01748d18 + 0x1748bb0);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01748d1c + 0x1748bc4));
    func_0x01438628(*(undefined4 *)(_UNK_01748d20 + 0x1748bd0));
    func_0x01438628(*(undefined4 *)(_UNK_01748d24 + 0x1748bdc));
    func_0x01438628(*(undefined4 *)(_UNK_01748d28 + 0x1748be8));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8caa,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8caa,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01748d2c + 0x1748c40) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01748d30 + 0x1748c5c));
  piVar7 = *(int **)(_UNK_01748d34 + 0x1748c70);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_01748d38 + 0x1748c90);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0xa0c);
  if (iVar2 == 0) {
