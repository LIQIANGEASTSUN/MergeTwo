...

{
  ...
  pcVar7 = (char *)(_UNK_02f4a140 + 0x2f4a0ac);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f4a144 + 0x2f4a0c0));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x6e0b,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x6e0b,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar6 = **(int **)(_UNK_02f4a148 + 0x2f4a134);
