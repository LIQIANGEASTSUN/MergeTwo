...
undefined4 FUN_02c2a370(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2a530 + 0x2c2a384);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2a534 + 0x2c2a398));
    func_0x01438628(*(undefined4 *)(_UNK_02c2a538 + 0x2c2a3a4));
    func_0x01438628(*(undefined4 *)(_UNK_02c2a53c + 0x2c2a3b0));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d7f,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d7f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2a540 + 0x2c2a4d8));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2a544 + 0x2c2a4f4),0);
  if (*(int *)(**(int **)(_UNK_02c2a548 + 0x2c2a508) + 0x74) == 0) {
    func_0x014387a4();
  }
