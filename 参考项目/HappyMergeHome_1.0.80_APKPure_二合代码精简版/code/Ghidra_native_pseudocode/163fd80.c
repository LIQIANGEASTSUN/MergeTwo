...
void FUN_0164fd80(undefined4 param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  pcVar7 = (char *)(_UNK_01650180 + 0x164fda8);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01650184 + 0x164fdbc));
    func_0x01438628(*(undefined4 *)(_UNK_01650188 + 0x164fdc8));
    func_0x01438628(*(undefined4 *)(_UNK_0165018c + 0x164fdd4));
    func_0x01438628(*(undefined4 *)(_UNK_01650190 + 0x164fde0));
    func_0x01438628(*(undefined4 *)(_UNK_01650194 + 0x164fdec));
    func_0x01438628(*(undefined4 *)(_UNK_01650198 + 0x164fdf8));
    func_0x01438628(*(undefined4 *)(_UNK_0165019c + 0x164fe04));
    func_0x01438628(*(undefined4 *)(_UNK_016501a0 + 0x164fe10));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x16a2,0);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_016501a4 + 0x164fe74) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_016501a8 + 0x164fe90));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    ...
    if ((int)(iVar6 - (iVar2 + (uint)bVar12)) < 0 !=
      ...
      func_0x024f0570(iVar5,**(undefined4 **)(_UNK_016501ac + 0x165001c));
      uVar15 = FUN_01642704(param_1);
      ...
      if (*(int *)(**(int **)(_UNK_016501b0 + 0x1650070) + 0x74) == 0) {
        func_0x014387a4();
      }
      iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_016501b4 + 0x165008c));
      piVar10 = *(int **)(_UNK_016501b8 + 0x16500a0);
      iVar5 = *piVar10;
      if (*(int *)(iVar5 + 0x74) == 0) {
        func_0x014387a4();
        iVar5 = *piVar10;
      ...
      piVar10 = (int *)func_0x014386f0(**(undefined4 **)(_UNK_016501bc + 0x16500c4),1);
      uStack_54 = 0;
      iVar5 = func_0x014387ac(**(undefined4 **)(_UNK_016501c0 + 0x16500e4),&uStack_54);
      if (piVar10 == (int *)0x0) {
        func_0x014388e4();
      }
      if ((iVar5 != 0) &&
    ...
    iVar2 = func_0x029540a4(0x16a2,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
