...
void FUN_03107d1c(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_03107de0 + 0x3107d34);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03107de4 + 0x3107d48));
    *pcVar10 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x784b,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x784b,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x03118c58(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_03107de8 + 0x3107db8) + 0x74) == 0) {
    func_0x014387a4();
  }
