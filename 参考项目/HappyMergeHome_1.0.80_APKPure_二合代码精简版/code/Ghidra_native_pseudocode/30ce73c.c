...
undefined4 FUN_030de73c(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_030de818 + 0x30de750);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_030de81c + 0x30de764));
    func_0x01438628(*(undefined4 *)(_UNK_030de820 + 0x30de770));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7734,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_030de824 + 0x30de7c8) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_030de828 + 0x30de7e4));
    uVar7 = func_0x030de82c(param_1);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = func_0x029540a4(0x7734,0);
  if (iVar3 == 0) {
    func_0x014388e4();
  }
