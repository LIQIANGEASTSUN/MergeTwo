...

{
  ...
  iVar1 = func_0x02953fd4(0xa67b,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0xa67b,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if ((iVar1 == 0) && (iVar1 = FUN_01b572ec(param_1), iVar1 != 0)) {
    ...
    uStack_28 = 0;
    func_0x026bed3c((int)uVar6,uVar4,uVar2,uVar5);
    uVar6 = FUN_01b572ec(param_1);
    uVar4 = (undefined4)((ulonglong)uVar6 >> 0x20);
    ...
    uStack_28 = 0;
    func_0x026bee0c((int)uVar6,uVar4,uVar5,uVar2);
  }
  return;
}
