...
uint FUN_0174d75c(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_0174d844 + 0x174d77c);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0174d848 + 0x174d790));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8cf2,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8cf2,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_0174d84c + 0x174d80c) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_01747688();
  if (iVar2 == 0) {
