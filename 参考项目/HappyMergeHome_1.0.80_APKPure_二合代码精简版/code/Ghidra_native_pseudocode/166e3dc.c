...
uint FUN_0167e3dc(int param_1,int param_2)

{
  ...
  pcVar10 = (char *)(_UNK_0167e4a4 + 0x167e3f4);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0167e4a8 + 0x167e408));
    *pcVar10 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x15f4,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_0167e4ac + 0x167e464) + 0x74) == 0) {
      func_0x014387a4();
    }
    ...
    iVar3 = func_0x029540a4(0x15f4,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  }
