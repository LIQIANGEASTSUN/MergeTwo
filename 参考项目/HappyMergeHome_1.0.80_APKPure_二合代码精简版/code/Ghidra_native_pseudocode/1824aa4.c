...
int FUN_01834aa4(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_01834c20 + 0x1834ab8);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01834c24 + 0x1834acc));
    func_0x01438628(*(undefined4 *)(_UNK_01834c28 + 0x1834ad8));
    func_0x01438628(*(undefined4 *)(_UNK_01834c2c + 0x1834ae4));
    func_0x01438628(*(undefined4 *)(_UNK_01834c30 + 0x1834af0));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x91ec,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x91ec,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_01834c34 + 0x1834b48) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_01834c38 + 0x1834b64));
  piVar7 = *(int **)(_UNK_01834c3c + 0x1834b78);
  iVar8 = *piVar7;
  if (*(int *)(iVar8 + 0x74) == 0) {
    func_0x014387a4();
    iVar8 = *piVar7;
  }
  iVar9 = **(int **)(_UNK_01834c40 + 0x1834b98);
  iVar2 = *(int *)(iVar9 + 0x1c);
  uVar10 = *(undefined4 *)(*(int *)(iVar8 + 0x5c) + 0x808);
  if (iVar2 == 0) {
