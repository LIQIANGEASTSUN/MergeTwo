...
void FUN_017134b0(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  pcVar4 = (char *)(_UNK_0171359c + 0x17134d0);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017135a0 + 0x17134f0));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x8b44,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x8b44,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    iStack_34 = param_5;
  ...
  if (*(int *)(**(int **)(_UNK_017135a4 + 0x1713560) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = FUN_0170e674();
  if (iVar1 == 0) {
  ...
  uStack_2c = uStack_3c;
  iStack_28 = iStack_44;
  iVar2 = func_0x02953fd4(0x8b45,0);
  if (iVar2 == 0) {
    ...
    *puVar3 = uStack_58;
    ...
    iVar2 = func_0x029540a4(0x8b45,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
