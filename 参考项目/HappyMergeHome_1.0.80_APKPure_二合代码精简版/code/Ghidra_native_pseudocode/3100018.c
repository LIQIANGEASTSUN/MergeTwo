...

{
  ...
  pcVar7 = (char *)(_UNK_03110204 + 0x3110030);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03110208 + 0x3110044));
    func_0x01438628(*(undefined4 *)(_UNK_0311020c + 0x3110050));
    func_0x01438628(*(undefined4 *)(_UNK_03110210 + 0x311005c));
    func_0x01438628(*(undefined4 *)(_UNK_03110214 + 0x3110068));
    *pcVar7 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x7899,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x7899,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03110218 + 0x3110140) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar4 = func_0x04e4a028(**(undefined4 **)(_UNK_0311021c + 0x311015c));
  if (iVar4 == 0) {
    func_0x014388e4();
  }
  ...
  if ((iVar4 != 0) && (0 < *(int *)(iVar4 + 0xc))) {
    ...
    iVar4 = func_0x04cfd760(iVar4,0,**(undefined4 **)(_UNK_03110220 + 0x31101b0));
    if (iVar4 == 0) {
      func_0x014388e4();
    }
