...
void FUN_01aea594(int param_1,undefined4 param_2,int param_3)

{
  ...
  iVar5 = func_0x02953fd4(0xa4a5,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0xa4a5,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
    func_0x028849f0(iVar5,param_1,param_2,param_3);
    return;
  }
  iVar5 = FUN_01ae9bb0(param_1,param_2,param_3);
  if (iVar5 != 0) {
    return;
  }
  iVar5 = FUN_01ae9c4c(param_1,param_2);
  if (iVar5 == 0) {
    return;
  }
  if (param_3 == 0) {
    func_0x026eca5c(iVar5,1,0);
  }
  else {
    func_0x026ec9a0();
  }
