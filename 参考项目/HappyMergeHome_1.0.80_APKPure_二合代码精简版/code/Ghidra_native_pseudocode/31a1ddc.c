...
int FUN_031b1ddc(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_031b1f58 + 0x31b1df0);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031b1f5c + 0x31b1e04));
    func_0x01438628(*(undefined4 *)(_UNK_031b1f60 + 0x31b1e10));
    func_0x01438628(*(undefined4 *)(_UNK_031b1f64 + 0x31b1e1c));
    func_0x01438628(*(undefined4 *)(_UNK_031b1f68 + 0x31b1e28));
    *pcVar7 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7cbd,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x7cbd,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_031b1f6c + 0x31b1e80) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_031b1f70 + 0x31b1e9c));
  piVar8 = *(int **)(_UNK_031b1f74 + 0x31b1eb0);
  iVar6 = *piVar8;
  if (*(int *)(iVar6 + 0x74) == 0) {
    func_0x014387a4();
    iVar6 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_031b1f78 + 0x31b1ed0);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar6 + 0x5c) + 0x7bc);
  if (iVar4 == 0) {
