...
int FUN_01844154(undefined4 param_1,int param_2)

{
  ...
  pcVar5 = (char *)(_UNK_0184456c + 0x1844170);
  if (*pcVar5 == '\0') {
  ...
  iVar1 = func_0x02953fd4(0x1e2f,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x1e2f,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  puVar10 = *(undefined4 **)(_UNK_01844598 + 0x1844290);
  iVar1 = func_0x024f0f34(iVar1,param_2,*puVar10);
  if (iVar1 == 0) {
    if (*(int *)(**(int **)(_UNK_0184459c + 0x18442b0) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018445a0 + 0x18442cc));
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    iVar1 = *(int *)(iVar1 + 0x38);
    iVar8 = 0;
    puVar11 = *(undefined4 **)(_UNK_018445a4 + 0x18442f4);
    do {
      if (iVar1 == 0) {
        func_0x014388e4();
      }
    ...
    while( true ) {
      ...
      if (*(int *)(iVar2 + 0x24) <= param_2) {
        ...
        if (iVar2 == 0) {
          ...
          func_0x024f05ac(iVar2,uVar9,**(undefined4 **)(_UNK_018445a8 + 0x184446c));
        }
      }
      iVar8 = iVar8 + 1;
    }
    ...
    iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_018445b0 + 0x18444ac));
    piVar7 = *(int **)(_UNK_018445b4 + 0x18444c0);
    iVar8 = *piVar7;
    if (*(int *)(iVar8 + 0x74) == 0) {
      func_0x014387a4();
      iVar8 = *piVar7;
    }
    iVar6 = **(int **)(_UNK_018445b8 + 0x18444e0);
