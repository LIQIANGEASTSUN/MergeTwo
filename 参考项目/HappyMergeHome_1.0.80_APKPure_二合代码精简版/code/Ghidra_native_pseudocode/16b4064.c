...
void FUN_016c4064(undefined4 param_1,undefined4 param_2)

{
  ...
  iVar2 = func_0x024f0540(iVar2,param_2,**(undefined4 **)(_UNK_016c4234 + 0x16c414c));
  ...
  if (iVar5 == 0) {
    ...
    iVar2 = func_0x024f05d4(0,param_2,**(undefined4 **)(_UNK_016c4238 + 0x16c41d0));
    func_0x014388e4();
  }
  else {
    if (iVar2 == 0) {
LAB_016c4200:
    ...
    iVar2 = func_0x024f05d4(iVar5,param_2,**(undefined4 **)(_UNK_016c423c + 0x16c41a4));
  }
  unaff_r7 = iVar2 + 1;
