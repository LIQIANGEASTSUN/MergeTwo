...

{
  ...
  pcVar4 = (char *)(_UNK_02f122a0 + 0x2f12204);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f122a4 + 0x2f12218));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x6c9b,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x6c9b,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f122a8 + 0x2f1226c) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_02f09f10();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
