...
undefined4 FUN_032819c4(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_03281aa0 + 0x32819d8);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03281aa4 + 0x32819ec));
    func_0x01438628(*(undefined4 *)(_UNK_03281aa8 + 0x32819f8));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x816f,0);
  if (iVar3 == 0) {
    if (*(int *)(**(int **)(_UNK_03281aac + 0x3281a50) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03281ab0 + 0x3281a6c));
    uVar7 = func_0x03281ab4(param_1);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = func_0x029540a4(0x816f,0);
  if (iVar3 == 0) {
    func_0x014388e4();
  }
