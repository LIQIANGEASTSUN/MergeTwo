...

{
  ...
  pcVar7 = (char *)(_UNK_02fd5128 + 0x2fd5094);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fd512c + 0x2fd50a8));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x710d,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x710d,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar6 = **(int **)(_UNK_02fd5130 + 0x2fd511c);
