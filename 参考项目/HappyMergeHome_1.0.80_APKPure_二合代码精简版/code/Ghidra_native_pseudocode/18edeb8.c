...

{
  ...
  pcVar6 = (char *)(_UNK_018fdf60 + 0x18fdecc);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_018fdf64 + 0x18fdee0));
    *pcVar6 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x9686,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x9686,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar7 = **(int **)(_UNK_018fdf68 + 0x18fdf54);
