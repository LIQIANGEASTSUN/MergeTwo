...
uint FUN_016b5da4(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_016b5e8c + 0x16b5dc4);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_016b5e90 + 0x16b5dd8));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x890f,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x890f,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_016b5e94 + 0x16b5e54) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_016af738();
  if (iVar2 == 0) {
