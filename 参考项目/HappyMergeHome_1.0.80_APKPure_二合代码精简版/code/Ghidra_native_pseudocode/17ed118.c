...
void FUN_017fd118(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar8 = (char *)(_UNK_017fd1dc + 0x17fd130);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_017fd1e0 + 0x17fd144));
    *pcVar8 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x9077,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x9077,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
    pcVar8 = (char *)(_UNK_0286bb58 + 0x286ba64);
    if (*pcVar8 == '\0') {
  ...
  uVar14 = func_0x0180da10(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_017fd1e4 + 0x17fd1b4) + 0x74) == 0) {
    func_0x014387a4();
  }
  ...
  if (iVar2 != 0) {
    ...
    uStack_38 = 0;
    uStack_34 = 0;
    func_0x0288f430((int)uVar14,uVar9,iVar1,iVar6);
    return;
  }
  if ((int)-(iVar6 + (uint)(iVar1 != 0)) < 0 ==
      (SBORROW4(0,iVar6) != SBORROW4(-iVar6,(uint)(iVar1 != 0)))) {
    uVar14 = 0;
  }
...
LAB_02af2708:
  if (uVar11 == 0) {
    ...
    auStack_24[0] = uVar7;
    uVar9 = func_0x014387ac(*puVar12,auStack_24);
    uStack_28 = uVar10;
    ...
    if (uVar7 == 0) {
      if (uVar10 < 0x1e) {
        uVar9 = func_0x014387ac(**(undefined4 **)(_UNK_02af2928 + 0x2af28b0),auStack_24);
