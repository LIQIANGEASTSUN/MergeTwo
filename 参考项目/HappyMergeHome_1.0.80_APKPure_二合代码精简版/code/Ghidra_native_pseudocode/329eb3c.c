...
uint FUN_032aeb3c(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_032aebdc + 0x32aeb50);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_032aebe0 + 0x32aeb64));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x8291,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x8291,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_032aebe4 + 0x32aebbc) + 0x74) == 0) {
    func_0x014387a4();
  }
