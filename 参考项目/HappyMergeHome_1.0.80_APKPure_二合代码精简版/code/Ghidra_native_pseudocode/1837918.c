...
undefined4 FUN_01847918(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar5 = (char *)(_UNK_01847a54 + 0x1847930);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_01847a58 + 0x1847944));
    func_0x01438628(*(undefined4 *)(_UNK_01847a5c + 0x1847950));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x926e,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x926e,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  iVar1 = func_0x024f0540(iVar1,param_2,**(undefined4 **)(_UNK_01847a60 + 0x18479e8));
  if (iVar1 != 0) {
    iVar1 = FUN_0183a850(param_1);
    if (iVar1 == 0) {
      func_0x014388e4();
    ...
    iVar4 = **(int **)(_UNK_01847a64 + 0x1847a40);
    if (iVar1 == 0) {
      func_0x024f83d4();
    }
