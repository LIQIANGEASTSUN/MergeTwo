...
int FUN_03079958(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_03079ad4 + 0x307996c);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03079ad8 + 0x3079980));
    func_0x01438628(*(undefined4 *)(_UNK_03079adc + 0x307998c));
    func_0x01438628(*(undefined4 *)(_UNK_03079ae0 + 0x3079998));
    func_0x01438628(*(undefined4 *)(_UNK_03079ae4 + 0x30799a4));
    *pcVar7 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x7545,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x7545,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_03079ae8 + 0x30799fc) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_03079aec + 0x3079a18));
  piVar8 = *(int **)(_UNK_03079af0 + 0x3079a2c);
  iVar6 = *piVar8;
  if (*(int *)(iVar6 + 0x74) == 0) {
    func_0x014387a4();
    iVar6 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_03079af4 + 0x3079a4c);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar6 + 0x5c) + 0x96c);
  if (iVar4 == 0) {
