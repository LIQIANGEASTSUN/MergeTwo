...

{
  ...
  pcVar7 = (char *)(_UNK_019597cc + 0x1959680);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_019597d0 + 0x1959694));
    func_0x01438628(*(undefined4 *)(_UNK_019597d4 + 0x19596a0));
    func_0x01438628(*(undefined4 *)(_UNK_019597d8 + 0x19596ac));
    *pcVar7 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x2c62,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x2c62,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_019597dc + 0x1959704) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar1 = func_0x014e9518(**(undefined4 **)(_UNK_019597e0 + 0x1959720));
  uVar10 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar9 = **(int **)(_UNK_019597e4 + 0x195974c);
