...
void FUN_0195b904(undefined4 param_1)

{
  ...
  pcVar6 = (char *)(_UNK_0195b9bc + 0x195b918);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0195b9c0 + 0x195b92c));
    *pcVar6 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x98d0,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x98d0,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x0196d484(param_1);
  iVar7 = (int)((ulonglong)uVar14 >> 0x20);
  iVar1 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_0195b9c4 + 0x195b994) + 0x74) == 0) {
    func_0x014387a4();
  }
