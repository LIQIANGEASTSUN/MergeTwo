...
uint FUN_031b6db4(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  pcVar11 = (char *)(_UNK_031b6e9c + 0x31b6dd4);
  if (*pcVar11 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031b6ea0 + 0x31b6de8));
    *pcVar11 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7d06,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7d06,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    uStack_20 = 0;
  ...
  if (*(int *)(**(int **)(_UNK_031b6ea4 + 0x31b6e64) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar2 = FUN_031b08c8();
  if (iVar2 == 0) {
