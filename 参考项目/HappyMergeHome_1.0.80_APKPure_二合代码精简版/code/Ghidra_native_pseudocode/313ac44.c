...

{
  ...
  pcVar7 = (char *)(_UNK_0314acec + 0x314ac58);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0314acf0 + 0x314ac6c));
    *pcVar7 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x7a22,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x7a22,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  iVar6 = **(int **)(_UNK_0314acf4 + 0x314ace0);
