...
int FUN_03187b44(undefined4 param_1,int param_2)

{
  ...
  pcVar5 = (char *)(_UNK_03187f5c + 0x3187b60);
  if (*pcVar5 == '\0') {
  ...
  iVar2 = func_0x02953fd4(0x2034,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x2034,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  puVar10 = *(undefined4 **)(_UNK_03187f88 + 0x3187c80);
  iVar2 = func_0x04cd2d7c(iVar2,param_2,*puVar10);
  if (iVar2 == 0) {
    if (*(int *)(**(int **)(_UNK_03187f8c + 0x3187ca0) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_03187f90 + 0x3187cbc));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
    iVar2 = *(int *)(iVar2 + 0x30);
    iVar7 = 0;
    puVar11 = *(undefined4 **)(_UNK_03187f94 + 0x3187ce4);
    do {
      if (iVar2 == 0) {
        func_0x014388e4();
      }
    ...
    while( true ) {
      ...
      if (*(int *)(iVar3 + 0x24) <= param_2) {
        ...
        if (iVar3 == 0) {
          ...
          func_0x03b75ba0(iVar3,uVar9,**(undefined4 **)(_UNK_03187f98 + 0x3187e5c));
        }
      }
      iVar7 = iVar7 + 1;
    }
    ...
    iVar2 = func_0x04e4a028(**(undefined4 **)(_UNK_03187fa0 + 0x3187e9c));
    ...
    iVar6 = **(int **)(_UNK_03187fa8 + 0x3187ed0);
