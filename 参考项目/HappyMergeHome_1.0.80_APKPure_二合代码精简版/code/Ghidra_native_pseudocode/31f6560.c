...
void FUN_03206560(undefined4 param_1,undefined4 param_2)

{
  ...
  pcVar10 = (char *)(_UNK_03206624 + 0x3206578);
  if (*pcVar10 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_03206628 + 0x320658c));
    *pcVar10 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x7e45,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x7e45,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x032164e0(param_1,param_2);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_0320662c + 0x32065fc) + 0x74) == 0) {
    func_0x014387a4();
  }
