...
int FUN_0303e180(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_0303e2fc + 0x303e194);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_0303e300 + 0x303e1a8));
    func_0x01438628(*(undefined4 *)(_UNK_0303e304 + 0x303e1b4));
    func_0x01438628(*(undefined4 *)(_UNK_0303e308 + 0x303e1c0));
    func_0x01438628(*(undefined4 *)(_UNK_0303e30c + 0x303e1cc));
    *pcVar7 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x73b0,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x73b0,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_0303e310 + 0x303e224) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_0303e314 + 0x303e240));
  piVar8 = *(int **)(_UNK_0303e318 + 0x303e254);
  iVar6 = *piVar8;
  if (*(int *)(iVar6 + 0x74) == 0) {
    func_0x014387a4();
    iVar6 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_0303e31c + 0x303e274);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar6 + 0x5c) + 0x8f4);
  if (iVar4 == 0) {
