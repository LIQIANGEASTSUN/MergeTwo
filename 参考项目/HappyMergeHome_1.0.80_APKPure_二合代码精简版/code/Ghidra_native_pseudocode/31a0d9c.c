...

{
  ...
  pcVar7 = (char *)(_UNK_031b0efc + 0x31b0db0);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031b0f00 + 0x31b0dc4));
    func_0x01438628(*(undefined4 *)(_UNK_031b0f04 + 0x31b0dd0));
    func_0x01438628(*(undefined4 *)(_UNK_031b0f08 + 0x31b0ddc));
    *pcVar7 = '\x01';
  }
  iVar5 = func_0x02953fd4(0x2a16,0);
  if (iVar5 != 0) {
    iVar5 = func_0x029540a4(0x2a16,0);
    if (iVar5 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_031b0f0c + 0x31b0e34) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar5 = func_0x04e4a028(**(undefined4 **)(_UNK_031b0f10 + 0x31b0e50));
  uVar9 = (**(code **)(*param_1 + 400))(param_1,*(undefined4 *)(*param_1 + 0x194));
  iVar10 = **(int **)(_UNK_031b0f14 + 0x31b0e7c);
