...

{
  ...
  pcVar4 = (char *)(_UNK_031b7b7c + 0x31b7ae0);
  if (*pcVar4 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_031b7b80 + 0x31b7af4));
    *pcVar4 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x7d10,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x7d10,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_031b7b84 + 0x31b7b48) + 0x74) == 0) {
    func_0x014387a4();
  }
  piVar2 = (int *)FUN_031b08c8();
  if (piVar2 == (int *)0x0) {
    func_0x014388e4();
  }
