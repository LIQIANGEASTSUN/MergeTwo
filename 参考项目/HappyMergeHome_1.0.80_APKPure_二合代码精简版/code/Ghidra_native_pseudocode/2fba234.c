...
int FUN_02fca234(undefined4 param_1)

{
  ...
  pcVar7 = (char *)(_UNK_02fca3b0 + 0x2fca248);
  if (*pcVar7 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fca3b4 + 0x2fca25c));
    func_0x01438628(*(undefined4 *)(_UNK_02fca3b8 + 0x2fca268));
    func_0x01438628(*(undefined4 *)(_UNK_02fca3bc + 0x2fca274));
    func_0x01438628(*(undefined4 *)(_UNK_02fca3c0 + 0x2fca280));
    *pcVar7 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x70ad,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x70ad,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02fca3c4 + 0x2fca2d8) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02fca3c8 + 0x2fca2f4));
  piVar8 = *(int **)(_UNK_02fca3cc + 0x2fca308);
  iVar6 = *piVar8;
  if (*(int *)(iVar6 + 0x74) == 0) {
    func_0x014387a4();
    iVar6 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_02fca3d0 + 0x2fca328);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar6 + 0x5c) + 0x9bc);
  if (iVar4 == 0) {
