...

{
  ...
  pcVar3 = (char *)(_UNK_02c446a4 + 0x2c445e4);
  if (*pcVar3 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c446a8 + 0x2c445f8));
    func_0x01438628(*(undefined4 *)(_UNK_02c446ac + 0x2c44604));
    *pcVar3 = '\x01';
  }
  iVar4 = *(int *)(param_1 + 8);
  ...
  if (iVar4 == iVar2) {
    if (*(int *)(**(int **)(_UNK_02c446b0 + 0x2c4465c) + 0x74) == 0) {
      func_0x014387a4();
    }
    iVar2 = func_0x014e9518(**(undefined4 **)(_UNK_02c446b4 + 0x2c44678));
    if (iVar2 == 0) {
      func_0x014388e4();
    }
