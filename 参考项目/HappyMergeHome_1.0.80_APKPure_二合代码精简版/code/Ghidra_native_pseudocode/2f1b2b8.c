...
uint FUN_02f2b2b8(undefined4 param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02f2b358 + 0x2f2b2cc);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02f2b35c + 0x2f2b2e0));
    *pcVar5 = '\x01';
  }
  iVar2 = func_0x02953fd4(0x6d42,0);
  if (iVar2 != 0) {
    iVar2 = func_0x029540a4(0x6d42,0);
    if (iVar2 == 0) {
      func_0x014388e4();
    }
  ...
  if (*(int *)(**(int **)(_UNK_02f2b360 + 0x2f2b338) + 0x74) == 0) {
    func_0x014387a4();
  }
