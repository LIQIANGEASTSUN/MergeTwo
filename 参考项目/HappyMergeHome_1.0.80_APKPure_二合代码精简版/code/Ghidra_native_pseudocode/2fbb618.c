...
int FUN_02fcb618(undefined4 param_1)

{
  ...
  iVar3 = func_0x02953fd4(0x70b7,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x70b7,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
  ...
  iVar3 = FUN_02fc9070(param_1);
  if (iVar3 == 0) {
    return 0;
  }
  pcVar6 = (char *)(_UNK_02ffd56c + 0x2ffd408);
  if (*pcVar6 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02ffd570 + 0x2ffd41c));
    func_0x01438628(*(undefined4 *)(_UNK_02ffd574 + 0x2ffd428));
    func_0x01438628(*(undefined4 *)(_UNK_02ffd578 + 0x2ffd434));
    func_0x01438628(*(undefined4 *)(_UNK_02ffd57c + 0x2ffd440));
    *pcVar6 = '\x01';
  }
  iVar3 = func_0x02953fd4(0x1595,0);
  if (iVar3 != 0) {
    iVar3 = func_0x029540a4(0x1595,0);
    if (iVar3 == 0) {
      func_0x014388e4();
    }
    uStack_2c = *(undefined4 *)((undefined1  [16])0x0 + (undefined1  [16])0x4);
  ...
  if (*(int *)(**(int **)(_UNK_02ffd580 + 0x2ffd494) + 0x74) == 0) {
    func_0x014387a4();
  }
  iVar3 = func_0x04e4a028(**(undefined4 **)(_UNK_02ffd584 + 0x2ffd4b0));
  piVar8 = *(int **)(_UNK_02ffd588 + 0x2ffd4c4);
  iVar7 = *piVar8;
  if (*(int *)(iVar7 + 0x74) == 0) {
    func_0x014387a4();
    iVar7 = *piVar8;
  }
  iVar10 = **(int **)(_UNK_02ffd58c + 0x2ffd4e4);
  iVar4 = *(int *)(iVar10 + 0x1c);
  uVar9 = *(undefined4 *)(*(int *)(iVar7 + 0x5c) + 0x9c0);
  if (iVar4 == 0) {
