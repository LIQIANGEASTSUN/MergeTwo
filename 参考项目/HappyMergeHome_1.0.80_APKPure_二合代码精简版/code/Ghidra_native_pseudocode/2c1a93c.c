...
undefined4 FUN_02c2a93c(int param_1)

{
  ...
  pcVar5 = (char *)(_UNK_02c2aafc + 0x2c2a950);
  if (*pcVar5 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02c2ab00 + 0x2c2a964));
    func_0x01438628(*(undefined4 *)(_UNK_02c2ab04 + 0x2c2a970));
    func_0x01438628(*(undefined4 *)(_UNK_02c2ab08 + 0x2c2a97c));
    *pcVar5 = '\x01';
  }
  iVar1 = func_0x02953fd4(0x5d85,0);
  if (iVar1 != 0) {
    iVar1 = func_0x029540a4(0x5d85,0);
    if (iVar1 == 0) {
      func_0x014388e4();
    }
  ...
  uVar6 = func_0x014388d4(**(undefined4 **)(_UNK_02c2ab0c + 0x2c2aaa4));
  func_0x0152e3ec(uVar6,param_1,**(undefined4 **)(_UNK_02c2ab10 + 0x2c2aac0),0);
  if (*(int *)(**(int **)(_UNK_02c2ab14 + 0x2c2aad4) + 0x74) == 0) {
    func_0x014387a4();
  }
