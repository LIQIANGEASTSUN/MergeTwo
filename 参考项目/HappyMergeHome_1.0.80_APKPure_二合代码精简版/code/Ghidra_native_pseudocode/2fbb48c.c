...
void FUN_02fcb48c(undefined4 param_1)

{
  ...
  pcVar8 = (char *)(_UNK_02fcb544 + 0x2fcb4a0);
  if (*pcVar8 == '\0') {
    func_0x01438628(*(undefined4 *)(_UNK_02fcb548 + 0x2fcb4b4));
    *pcVar8 = '\x01';
  }
  iVar4 = func_0x02953fd4(0x70b5,0);
  if (iVar4 != 0) {
    iVar4 = func_0x029540a4(0x70b5,0);
    if (iVar4 == 0) {
      func_0x014388e4();
    }
  ...
  uVar14 = func_0x02fdd00c(param_1);
  iVar6 = (int)((ulonglong)uVar14 >> 0x20);
  iVar4 = (int)uVar14;
  if (*(int *)(**(int **)(_UNK_02fcb54c + 0x2fcb51c) + 0x74) == 0) {
    func_0x014387a4();
  }
